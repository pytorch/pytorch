...
from . import H, V, FusedLinearCrossEntropyOperator
import torch
...
class Operator(FusedLinearCrossEntropyOperator):
    ...
    def __init__(self, benchmark_config: BenchmarkConfig):
        ...
        self.operator = TorchLMHeadCECompiled(H=H, V=V, dtype=self.benchmark_config.dtype).to(self.benchmark_config.device.value)
