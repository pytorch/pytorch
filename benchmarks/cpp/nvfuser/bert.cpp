...
static void MagicScheduler_fp16_DivMaxSoftDropFwd(benchmark::State& benchmark_state) {
  MagicScheduler_DivMaxSoftDropFwd(benchmark_state, DataType::Half);
}

static void MagicScheduler_fp16_DivMaxSoftDropBwd(benchmark::State& benchmark_state) {
...
static void setupBiasDropoutAddLayernormFwd(
    Fusion* fusion,
    DataType dtype) {
...
static void MagicScheduler_BiasDropoutAddLayernormFwd(benchmark::State& benchmark_state,
  DataType dtype) {
  Fusion fusion;
  FusionGuard fg(&fusion);
...
static void MagicScheduler_fp32_BiasDropoutAddLayernormFwd(benchmark::State& benchmark_state) {
  MagicScheduler_BiasDropoutAddLayernormFwd(benchmark_state, DataType::Float);
}

static void setupBiasDropoutAddLayernormBwd1(
    Fusion* fusion,
    DataType dtype) {
...
static void MagicScheduler_BiasDropoutAddLayernormBwd1(benchmark::State& benchmark_state,
  DataType dtype) {
  Fusion fusion;
  FusionGuard fg(&fusion);
...
static void MagicScheduler_fp32_BiasDropoutAddLayernormBwd1(benchmark::State& benchmark_state) {
  MagicScheduler_BiasDropoutAddLayernormBwd1(benchmark_state, DataType::Float);
}
static void MagicScheduler_tf32_BiasDropoutAddLayernormBwd1(benchmark::State& benchmark_state) {
  MagicScheduler_BiasDropoutAddLayernormBwd1(benchmark_state, DataType::Float);
}
...
static void MagicScheduler_BiasDropoutAddLayernormBwd2(benchmark::State& benchmark_state,
  DataType dtype) {
  Fusion fusion;
  FusionGuard fg(&fusion);
...
static void MagicScheduler_fp32_BiasDropoutAddLayernormBwd2(benchmark::State& benchmark_state) {
...
static void MagicScheduler_BiasDropoutAddLayernormBwd3(benchmark::State& benchmark_state,
  DataType dtype) {
  Fusion fusion;
  FusionGuard fg(&fusion);
...
static void MagicScheduler_fp32_BiasDropoutAddLayernormBwd3(benchmark::State& benchmark_state) {
