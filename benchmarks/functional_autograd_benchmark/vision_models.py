...
def get_detr(device):
    ...
    model = DETR(num_classes=num_classes, hidden_dim=hidden_dim, nheads=nheads,
    ...
    criterion = SetCriterion(num_classes=num_classes, matcher=matcher, weight_dict=weight_dict, eos_coef=eos_coef, losses=losses)
