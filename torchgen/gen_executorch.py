...
from torchgen.executorch.custom_ops import gen_custom_ops
...
def static_dispatch(
    ...
    if len(backends) == 1:
        ...
        if backend_metadata:
            native_sig = NativeSignature(func=f.func, symint=False)
...
def compute_native_function_declaration(
    ...
    sig = NativeSignature(func=g.func, symint=False)
