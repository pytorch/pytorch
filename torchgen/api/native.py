...
def argumenttype_type(
    t: Type, *, mutable: bool, binds: ArgName, structured_type_override: bool
) -> NamedCType:
    if str(t) == "Tensor?":
...
def argument(
    ...
    *,
    ...
    if isinstance(a, Argument):
        ...
        return [
            Binding(
                nctype=argument_type(
                    a, binds=a.name, structured_type_override=structured_type_override
                ),
                name=a.name,
                default=default,
                argument=a,
        ...
        return argument(
            a.argument, is_out=is_out, structured_type_override=structured_type_override
        )
