...
class DispatchKey(Enum):
    ...
    def parse(value: str) -> "DispatchKey":
        value = value.replace(PrivateUse1Name.custom_name, "PrivateUse1")
...
class PrivateUse1Name:
    """
    User can rename DispatchKey.PrivateUse1 to custom device rather than 'PrivateUse1'.
    For example:
    >>>from torchgen.model import DispatchKey, PrivateUse1Name
    >>>PrivateUse1Name.set_custom_name("FOO")
    >>>str(DispatchKey.PrivateUse1) # "FOO"
    >>>DispatchKey.parse("FOO") # DispatchKey.PrivateUse1
    """

    custom_name = "PrivateUse1"

    @staticmethod
    def set_custom_name(custom_name: str) -> None:
        if custom_name in DispatchKey.__members__:
            raise AssertionError(
                f"already existed dispatch key {custom_name} in DispatchKey"
            )
        PrivateUse1Name.custom_name = custom_name
