...
class Unboxing:
    ...
    def convert_arguments(self, args: Sequence[Binding]) -> Tuple[List[Binding], List[str]]:
        ...
        for arg in args:
            ...
            unboxed_name, _, code, decl = self.argumenttype_ivalue_convert(
    ...
    def _gen_code_optional_type(
        ...
        res_name, base_type, res_code, decl = self.argumenttype_ivalue_convert(t.elem, in_name)
        return (
            f"""
    ...
    def _gen_code_list_type(
        ...
        code = []
        res_name, res_ctype, res_code, decl = self.argumenttype_ivalue_convert(t.elem, elem_name)
