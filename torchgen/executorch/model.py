...
class ETKernelIndex:
    ...
    @staticmethod
    def grow_from_backend_indices(kernel_index: Dict[OperatorName, Dict[ETKernelKey, BackendMetadata]], backend_indices: Dict[DispatchKey, Dict[OperatorName, BackendMetadata]]):
    ...
    def _to_backend_index(self) -> BackendIndex:
        ...
        """
        index = defaultdict(BackendMetadata)
