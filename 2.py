...
def partition_0(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf25 = buf24 # Error here: buf25[0] = 1.+0.j
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        buf30 = torch.ops.aten.copy_.default(buf29, buf27) # after this line, buf25 changed
        del buf27
        del buf28
        del buf29
        buf7 = buf6
        ...
        del buf10
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.mm]
        buf16 = torch.ops.aten.mm.default(buf15, buf11) # buf11, buf15, buf16 all match
        del buf11
        del buf12
        del buf13
        del buf14
        ...
        buf32 = torch.ops.aten.div.Tensor(buf19, buf25) ## buf19, buf25 matches
        del buf19
        del buf25
        buf33 = buf32
        ...
        breakpoint()
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.mm]
        buf42 = torch.ops.aten.mm.default(buf33, buf41) # buf 33 does not match
        del buf38
        del buf39
        del buf40
        del buf41
        ...
        del buf42
        # Topologically Sorted Source Nodes: [], Original ATen: []
        buf36 = torch.ops.aten.copy_.default(buf35, tangents_1) ### buf35 does not match anymore. so buf33 does not match any more
        del buf33
        del buf34
        del buf35
        del tangents_1
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    torch.manual_seed(0)
    getitem_1 = torch.randn((5,5), device='cuda:0', dtype=torch.complex128)
    _conj_2 = torch.randn((5, ), device='cuda:0', dtype=torch.complex128)
    tangents_1 = torch.randn((5, ), device='cuda:0', dtype=torch.complex128)
    tangents_2 = torch.randn((5, 5), device='cuda:0', dtype=torch.complex128)
