...
def eager_flash_decoder(query, key, value, score_mod, Bc=None):
    """
    Returns O [B, H, N, d]
    """
    ...
    scores_exp = torch.exp2(scores - score_rowmax) # [B, H, N/Bc, Q, Bc], broadcast rowmax for all elements on the same CTA in the same row. (Bc)
