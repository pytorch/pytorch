...
symbolic_aot_autograd_failures = {
    ...
    xfail('_masked.mean', ''),  # ones() received an invalid combination of arguments - got (torch.Size, device=t...
    xfail('_masked.median', ''),  # Cannot call sizes() on tensor with symbolic sizes/strides
    ...
    xfail('_masked.sum', ''),  # Cannot call sizes() on tensor with symbolic sizes/strides
    xfail('_masked.var', ''),  # ones() received an invalid combination of arguments - got (torch.Size, device=to...
