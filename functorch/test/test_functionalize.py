...
FunctionalizeTestPythonKeyAOT = make_functionalize_test(test_aotdispatcher.TestAOTAutograd)
FunctionalizeTestPythonKeyPartitioning = make_functionalize_test(test_aotdispatcher.TestPartitioning)
