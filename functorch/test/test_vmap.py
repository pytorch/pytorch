...
class TestVmapOperatorsOpInfo(TestCase):
    ...
    @skipOps('TestVmapOperatorsOpInfo', 'test_op_has_batch_rule', vmap_fail.union({
        ...
        xfail('special.complete_legendre_elliptic_integral_e'),
        xfail('special.complete_legendre_elliptic_integral_k'),
        xfail('special.complete_legendre_elliptic_integral_d'),
        xfail('special.cos_pi'),
        xfail('special.cosh_pi'),
        xfail('special.ln_gamma_sign'),
        xfail('special.sin_pi'),
        xfail('special.sinh_pi'),
        xfail('special.tan_pi'),
        xfail('special.tanh_pi'),
        xfail('special.bernoulli_number'),
        xfail('special.factorial'),
        xfail('special.harmonic_number'),
