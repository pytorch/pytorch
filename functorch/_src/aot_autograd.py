...
def aot_dispatch_autograd(flat_fn, flat_args: List[Tensor], aot_config: AOTConfig):
    ...
    # Fastpath
    if not dropped_args:
        return maybe_wrap_debug(
            aot_dispatch_deduplicated_autograd(flat_fn, flat_args, aot_config)
        )
    ...
    compiled_fn = aot_dispatch_deduplicated_autograd(
        wrapped_flat_fn, deduped_flat_args, aot_config
    )
...
def aot_dispatch_deduplicated_autograd(
