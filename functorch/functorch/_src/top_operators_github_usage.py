...
top_nn_module = [
    ("nn.Module", 927129),
    ("nn.Linear", 530688),
    ("nn.Sequential", 384968),
    ("nn.Conv2d", 383320),
    ("nn.ReLU", 318877),
    ("nn.BatchNorm2d", 233265),
    ("nn.Dropout", 179268),
    ("nn.ModuleList", 171225),
    ("nn.Parameter", 153291),
    ("nn.CrossEntropyLoss", 152696),
    ("nn.MaxPool2d", 138619),
    ("nn.Embedding", 111844),
    ("nn.DataParallel", 104238),
    ("nn.MSELoss", 82954),
    ("nn.Sigmoid", 75810),
    ("nn.LeakyReLU", 65632),
    ("nn.BatchNorm1d", 65374),
    ("nn.Softmax", 65114),
    ("nn.Tanh", 59445),
    ("nn.AdaptiveAvgPool2d", 59071),
    ("nn.AvgPool2d", 58377),
    ("nn.ConvTranspose2d", 57524),
    ("nn.LSTM", 57411),
    ("nn.Conv1d", 41108),
    ("nn.LayerNorm", 36089),
    ("nn.BCELoss", 34005),
    ("nn.Upsample", 32527),
    ("nn.BCEWithLogitsLoss", 29944),
    ("nn.GRU", 25421),
    ("nn.Dropout2d", 23512),
    ("nn.LogSoftmax", 22897),
    ("nn.L1Loss", 22778),
    ...
    ("nn.Conv3d", 20874),
    ("nn.Identity", 17911),
    ("nn.InstanceNorm2d", 16426),
    ("nn.BatchNorm3d", 16378),
    ("nn.PReLU", 13472),
    ("nn.ReLU6", 12622),
    ("nn.ELU", 12508),
    ("nn.LSTMCell", 10885),
    ("nn.Flatten", 10384),
    ("nn.ModuleDict", 10255),
    ("nn.ReflectionPad2d", 9954),
    ("nn.MaxPool3d", 9526),
    ("nn.MaxPool1d", 9154),
    ("nn.RNN", 9154),
    ("nn.ZeroPad2d", 8847),
    ("nn.ParameterList", 7702),
    ("nn.SyncBatchNorm", 6814),
    ("nn.PixelShuffle", 6571),
    ("nn.SmoothL1Loss", 6517),
    ("nn.Hardswish", 6458),
    ("nn.AdaptiveMaxPool2d", 6071),
    ("nn.SELU", 6043),
    ("nn.ConvTranspose3d", 6039),
    ("nn.GRUCell", 5840),
    ("nn.ReplicationPad2d", 5600),
    ("nn.KLDivLoss", 5541),
    ("nn.ConvTranspose1d", 5183),
    ("nn.Softplus", 5120),
    ("nn.SiLU", 4895),
    ("nn.AvgPool3d", 4523),
    ("nn.CosineSimilarity", 4058),
    ("nn.GELU", 3932),
    ("nn.UpsamplingBilinear2d", 3673),
    ("nn.InstanceNorm1d", 3658),
    ("nn.Transformer", 3604),
    ("nn.MultiheadAttention", 3435),
    ("nn.AvgPool1d", 3195),
    ("nn.Dropout3d", 2964),
    ("nn.AdaptiveAvgPool3d", 2915),
    ("nn.InstanceNorm3d", 2893),
    ("nn.Hardtanh", 2613),
    ("nn.MarginRankingLoss", 2568),
    ("nn.GLU", 2526),
    ("nn.AdaptiveAvgPool1d", 2481),
    ("nn.EmbeddingBag", 2344),
    ("nn.TransformerEncoderLayer", 2292),
    ("nn.TransformerEncoder", 2091),
    ("nn.MaxUnpool2d", 2031),
    ("nn.UpsamplingNearest2d", 2004),
    ("nn.ConstantPad1d", 1904),
    ("nn.ConstantPad2d", 1791),
    ("nn.CTCLoss", 1789),
    ("nn.AdaptiveMaxPool1d", 1713),
    ("nn.AdaptiveLogSoftmaxWithLoss", 1665),
    ("nn.Bilinear", 1664),
    ("nn.RNNCell", 1653),
    ("nn.MultiLabelSoftMarginLoss", 1624),
    ("nn.Unfold", 1452),
    ("nn.RReLU", 1431),
    ("nn.CosineEmbeddingLoss", 1357),
    ("nn.LocalResponseNorm", 1331),
    ("nn.Softmax2d", 1300),
    ("nn.PairwiseDistance", 1241),
    ("nn.LogSigmoid", 1235),
    ("nn.TripletMarginLoss", 1230),
    ("nn.RNNBase", 1133),
    ("nn.Threshold", 1043),
    ("nn.AdaptiveMaxPool3d", 1025),
    ("nn.CELU", 1018),
    ("nn.NLLLoss2d", 966),
    ("nn.Softsign", 877),
    ("nn.ReplicationPad1d", 862),
    ("nn.SoftMarginLoss", 856),
    ("nn.ParameterDict", 742),
    ("nn.ReflectionPad1d", 731),
    ("nn.Softshrink", 713),
    ("nn.AlphaDropout", 710),
    ("nn.Tanhshrink", 681),
    ("nn.PoissonNLLLoss", 676),
    ("nn.MaxUnpool3d", 660),
    ("nn.Fold", 630),
    ("nn.MultiMarginLoss", 622),
    ("nn.TransformerDecoderLayer", 614),
    ("nn.TransformerDecoder", 607),
    ("nn.Hardshrink", 592),
    ("nn.ConstantPad3d", 582),
    ("nn.MultiLabelMarginLoss", 580),
    ("nn.LPPool2d", 550),
    ("nn.Softmin", 537),
    ("nn.MaxUnpool1d", 518),
    ("nn.FractionalMaxPool2d", 484),
    ("nn.Hardsigmoid", 477),
    ("nn.ReplicationPad3d", 470),
    ("nn.HingeEmbeddingLoss", 442),
    ("nn.LPPool1d", 386),
    ("nn.FractionalMaxPool3d", 252),
    ("nn.Container", 217),
    ("nn.Unflatten", 206),
    ("nn.FeatureAlphaDropout", 136),
    ("nn.TripletMarginWithDistanceLoss", 107),
    ("nn.ChannelShuffle", 90),
    ("nn.RNNCellBase", 88),
    ("nn.LazyLinear", 81),
    ("nn.UninitializedParameter", 60),
    ("nn.CrossMapLRN2d", 59),
    ("nn.GaussianNLLLoss", 55),
    ("nn.PixelUnshuffle", 45),
    ("nn.Mish", 31),
    ("nn.ReflectionPad3d", 22),
    ("nn.HuberLoss", 18),
    ("nn.LazyConv2d", 15),
    ("nn.LazyConv1d", 9),
    ("nn.LazyConv3d", 8),
    ("nn.LazyConvTranspose1d", 8),
    ("nn.LazyConvTranspose2d", 8),
    ("nn.LazyConvTranspose3d", 8),
    ("nn.LazyBatchNorm1d", 3),
    ("nn.LazyBatchNorm2d", 3),
    ("nn.LazyBatchNorm3d", 3),
    ("nn.UninitializedBuffer", 3),
]
