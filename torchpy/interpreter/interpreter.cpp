...
#define DECLARE_LIBRARY_INIT(name) \
...
#define APPEND_INIT(name) \
    PyImport_AppendInittab(#name, PyInit_##name);
    FOREACH_LIBRARY(APPEND_INIT)
#undef APPEND_INIT
    // PyImport_AppendInittab("torch._C", initModule);
    Py_Initialize();
    // PyRun_SimpleString("import sys; sys.path = ['', '/scratch/zdevito/miniconda3/envs/hidden/lib/python37.zip', '/scratch/zdevito/miniconda3/envs/hidden/lib/python3.7', '/scratch/zdevito/miniconda3/envs/hidden/lib/python3.7/lib-dynload', '/scratch/zdevito/miniconda3/envs/hidden/lib/python3.7/site-packages', '/scratch/zdevito/pytorch']");
