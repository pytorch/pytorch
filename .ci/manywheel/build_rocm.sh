...
OS_SO_PATHS=($LIBGOMP_PATH $LIBNUMA_PATH $LIBELF_PATH $LIBTINFO_PATH $LIBDRM_PATH $LIBDRM_AMDGPU_PATH $LIBSUITESPARSE_CONFIG_PATH $LIBCHOLMOD_PATH $LIBAMD_PATH $LIBCAMD_PATH $LIBCCOLAMD_PATH $LIBCOLAMD_PATH $LIBSATLAS_PATH $LIBGFORTRAN_PATH $LIBQUADMATH_PATH $LIBMETIS_PATH $LIBLAPACK_PATH $LIBBLAS_PATH)
OS_SO_FILES=()
