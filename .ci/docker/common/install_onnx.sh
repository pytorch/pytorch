...
as_jenkins echo 'import transformers; transformers.AutoModel.from_pretrained("bigscience/bloom-560m").to("cpu"); transformers.AutoTokenizer.from_pretrained("bigscience/bloom-560m");' \
