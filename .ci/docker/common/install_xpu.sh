...
if [[ "$XPU_VERSION" == "2026.1" ]]; then
    XPU_PACKAGES_URL="https://registrationcenter-download.intel.com/akdlm/IRC_NAS/185b3f71-836d-43fa-8afa-bd6bf08b3441/intel-deep-learning-essentials-2026.1.0.197_offline.sh"
else
