...
echo Run nn tests
python run_test.py --exclude-jit-executor --exclude-distributed-tests --exclude inductor/test_torchinductor_opinfo --shard "%SHARD_NUMBER%" "%NUM_TEST_SHARDS%" -k "not dynamo" --verbose
if ERRORLEVEL 1 goto fail
