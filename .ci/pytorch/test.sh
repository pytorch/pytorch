...
test_inductor_aoti() {
  ...
  /usr/bin/env "${TEST_ENVS[@]}" python test/run_test.py --cpp --verbose -i cpp/test_aoti_abi_check cpp/test_aoti_inference cpp/test_vec_half_AVX2 cpp/test_vec_half_AVX512 cpp/test_vec_half_DEFAULT -dist=loadfile
}
