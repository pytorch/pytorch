...
test_python_shard() {
  ...
  time python test/run_test.py --exclude-jit-executor --continue-through-error --exclude-distributed-tests $INCLUDE_CLAUSE --shard "$1" "$NUM_TEST_SHARDS" --verbose $PYTHON_TEST_EXTRA_OPTION
