...
test_python_smoke_b200() {
  ...
  time python test/run_test.py --include inductor/test_static_triton_launcher -k "test_static_launch_sm100" $PYTHON_TEST_EXTRA_OPTION --upload-artifacts-while-running
  assert_git_not_dirty
}
