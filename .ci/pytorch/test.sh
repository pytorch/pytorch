...
if [[ "$BUILD_ENVIRONMENT" == *asan* ]]; then
    export ASAN_OPTIONS=detect_leaks=1:symbolize=1:detect_stack_use_after_return=1:strict_init_order=true:detect_odr_violation=0:detect_container_overflow=0
