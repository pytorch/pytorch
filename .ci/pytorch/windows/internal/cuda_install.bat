...
set CUDNN_FOLDER=cudnn-windows-x86_64-9.24.0.43_cuda12-archive
goto cuda_download

:cuda130
set CUDA_INSTALL_EXE=cuda_13.0.0_windows.exe
set "ARGS="
set CUDNN_FOLDER=cudnn-windows-x86_64-9.24.0.43_cuda13-archive
goto cuda_download
...
set "ARGS="
set CUDNN_FOLDER=cudnn-windows-x86_64-9.25.0.15_cuda13-archive
goto cuda_download
...
if %CUDA_VER% EQU 134 (
    set CUDNN_FOLDER=cudnn-windows-x86_64-9.25.0.15_cuda13-archive
    set EXPECTED_CUDNN_VERSION=9.25.0
)
set "CUDNN_INSTALL_ZIP=%CUDNN_FOLDER%.zip"
