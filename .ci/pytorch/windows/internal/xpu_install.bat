...
if not [%XPU_VERSION%]==[] if [%XPU_VERSION%]==[2025.1] (
    set XPU_BUNDLE_URL=https://registrationcenter-download.intel.com/akdlm/IRC_NAS/728d56a8-cbf3-4288-b818-28f20b156575/intel-deep-learning-essentials-2025.2.0.559_offline.exe
    set XPU_BUNDLE_VERSION=2025.2.0+548
)
