...
WHEEL_CONTAINER_IMAGES = {
    **{
        gpu_arch: f"manylinux2_28-builder:cuda{gpu_arch}"
    ...
    **{
        gpu_arch: f"manylinux2_28-builder:rocm{gpu_arch}"
        for gpu_arch in ROCM_ARCHES
    },
    "xpu": f"manylinux2_28-builder:xpu",
    "cpu": f"manylinux2_28-builder:cpu",
    "cpu-aarch64": f"manylinux2_28_aarch64-builder:cpu-aarch64",
    "cpu-s390x": f"pytorch/manylinuxs390x-builder:cpu-s390x",
}
...
LIBTORCH_CONTAINER_IMAGES: dict[str, str] = {
    **{
        gpu_arch: f"libtorch-cxx11-builder:cuda{gpu_arch}"
        for gpu_arch in CUDA_ARCHES
    },
    **{
        gpu_arch: f"libtorch-cxx11-builder:rocm{gpu_arch}"
        for gpu_arch in ROCM_ARCHES
    },
    "cpu": f"libtorch-cxx11-builder:cpu",
}
                ...
                ret.append(
                    {
                        ...
                        "container_image_tag_prefix": WHEEL_CONTAINER_IMAGES[arch_version].split(":")[1],
