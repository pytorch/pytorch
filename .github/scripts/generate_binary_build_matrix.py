...
DEFAULT_TAG = "bd600335dc532c0faf8704027946c2ab86fe271f"
...
WHEEL_CONTAINER_IMAGES = {
    ...
    **{
        gpu_arch: f"308535385114.dkr.ecr.us-east-1.amazonaws.com/pytorch/manylinux-builder-rocm{gpu_arch}:{DEFAULT_TAG}"
