...
with open('.github/scripts/runner_determinator.py', 'r') as script_file:
    script_content = script_file.read()

# Indent the script content by 10 spaces to match destination indentation
indented_script_content = '\n'.join([' ' * 10 + line if line else line for line in script_content.splitlines()])

# Read the contents of _runner-determinator.yml
with open('.github/workflows/_runner-determinator.yml', 'r') as yml_file:
