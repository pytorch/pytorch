...
from label_utils import gh_remove_label
from gitutils import get_git_remote_name, get_git_repo_dir, GitRepo
from scripts.trymerge import GitHubPR, MERGE_IN_PROGRESS_LABEL
...
def main() -> None:
    ...
    GitHubPR(org, project, args.pr_num).remove_label(MERGE_IN_PROGRESS_LABEL)
