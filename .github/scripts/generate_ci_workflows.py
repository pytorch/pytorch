...
# Linux binary builds are now generated by generate_linux_binary_build_workflow.py.
...
def main() -> None:
    ...
    # Linux binary builds are generated by generate_linux_binary_build_workflow.py
