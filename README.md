...
PyTorch has 3 releases a year (major releases). Please let us know if you encounter a bug by [filing an issue](https://github.com/pytorch/pytorch/issues).
...
To learn more about making a contribution to Pytorch, please see our [Contribution page](CONTRIBUTING.md). For release related information consult [Release page](RELEASE.md).
