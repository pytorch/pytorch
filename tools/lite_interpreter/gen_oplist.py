...
import yaml
from tools.code_analyzer.gen_op_registration_allowlist import canonical_name
...
def gen_supported_mobile_models(model_dicts, output_dir: str) -> None:
...
"""
    ...
    for model_dict in model_dicts:
        # print("model_dict debug_info :", model_dict["debug_info"][0])
        debug_info = {"is_new_style_rule": False}
...
def main(argv):
    ...
    model_dicts = []
    model_dict = yaml.safe_load(open(options.yaml_file_path))
    model_dicts.append(model_dict)
    print("model_dict: ")
    print(model_dict)
    print("options.yaml_file_path: ", options.yaml_file_path)
