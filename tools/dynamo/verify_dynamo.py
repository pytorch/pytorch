...
def check_rocm():
    ...
    # Compare SDK to SDK when both sides have it. Fall back to HIP-to-HIP
    # when rocm_version.h is missing or torch.version.rocm is unset (older
    # wheels / consumer HIP SDKs).
