...
FROM_IVALUE = {
    'Device': '{}.toDevice()',
    'IntListRef': '{}.toIntListRef()->elements()',
    'Layout': '{}.toLayout()',
    'Scalar': '{}.toScalar()',
...
def is_sized_intlist_arg(arg):
    """Returns True for arguments declared as IntListRef[k], but False for IntListRef."""
    return (arg['simple_type'] == 'IntListRef') and ('size' in arg)
...
def gen_jit_dispatch(declarations, out, template_path):
    ...
    def expand_options(decl, i, arg):
        ...
        return [
            ...
            # device is specified as an IntListRef of { at::Device::Type, device_id }
