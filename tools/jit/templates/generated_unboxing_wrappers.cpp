...
public:
  Registerer&& op(const std::string& schemaStr, KernelFunction::InternalBoxedKernelFunction* boxed_kernel_wrapper_) && {
    ...
    dispatcher.setManuallyBoxedKernelFor_(op, boxed_kernel_wrapper_);
