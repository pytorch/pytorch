...
auto ${inp}_t = (${inp}_t_raw.defined() || !${inp}_tensor.defined())? ${inp}_t_raw : at::${zeros_fn}(${inp}_tensor.sizes(), ${inp}_tensor.options());
""")
...
def emit_body(fn: NativeFunctionWithDifferentiabilityInfo) -> List[str]:
    ...
    def emit_fw_derivatives() -> List[str]:
        ...
        for derivative in fw_derivatives:
            ...
            zeros_fn = "zeros" if inplace else "_efficientzerotensor"
            unpacked_arguments = ""
