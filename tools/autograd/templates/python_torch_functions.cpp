...
static PyObject * THPVariable_arange(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    if (r.isNone(1)) {
      ...
      check_out_type_matches(r.tensor(1), r.scalartypeOptional(2), r.layout(3), r.device(4), r.isNone(4));
    ...
    if (r.isNone(3)) {
      ...
      check_out_type_matches(r.tensor(3), r.scalartypeOptional(4), r.layout(5), r.device(6), r.isNone(6));
...
static PyObject * THPVariable_full(PyObject* self, PyObject* args, PyObject* kwargs) {
  ...
  if (r.idx == 0) {
    ...
    check_out_type_matches(result, r.scalartypeOptional(3), r.layout(4), r.device(5), r.isNone(5));
...
static PyObject * THPVariable_randint(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    ...
    if (r.isNone(4)) {
      ...
      check_out_type_matches(r.tensor(4), r.scalartypeOptional(5), r.layout(6), r.device(7), r.isNone(7));
...
static PyObject * THPVariable_linspace(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (_r.isNone(3)) {
    ...
    check_out_type_matches(_r.tensor(3), _r.scalartypeOptional(4), _r.layoutOptional(5), _r.device(6), _r.isNone(6));
...
static PyObject * THPVariable_logspace(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (_r.isNone(4)) {
    ...
    check_out_type_matches(_r.tensor(4), _r.scalartypeOptional(5), _r.layoutOptional(6), _r.device(7), _r.isNone(7));
