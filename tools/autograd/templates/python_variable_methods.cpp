...
static PyObject * THPVariable_new_empty(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  OptionalDeviceGuard device_guard(device_of(self_));
  return THPVariable_Wrap(torch::utils::new_empty(legacyExtractTypeId(self_), self_.scalar_type(), args, kwargs));
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_new_full(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  OptionalDeviceGuard device_guard(device_of(self_));
  return THPVariable_Wrap(torch::utils::new_full(legacyExtractTypeId(self_), self_.scalar_type(), args, kwargs));
  END_HANDLE_TH_ERRORS
}
