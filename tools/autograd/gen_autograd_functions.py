...
def gen_autograd_functions_lib(
    ...
    for suffix in [".h", ".cpp"]:
        ...
        fm.write_with_template(
            ...
            lambda: {
                "generated_comment": "@"
                + f"generated from {_get_gen_source_path(fm.template_dir)}/" + fname,
...
def gen_autograd_functions_python(
    ...
    fm.write(
        "python_functions.h",
        lambda: {
            "generated_comment": f"@generated from {_get_gen_source_path(fm.template_dir)}/python_functions.h",
    ...
    fm.write_sharded(
        ...
        base_env={
            "generated_comment": f"@generated from {_get_gen_source_path(fm.template_dir)}/python_functions.cpp",
        },
