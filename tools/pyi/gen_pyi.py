...
def gen_pyi(native_yaml_path: str, deprecated_yaml_path: str, fm: FileManager) -> None:
    ...
    unsorted_function_hints.update({
        ...
        'sparse_csr_tensor' : ['def sparse_csr_tensor(crow_indices: Union[Tensor, List], col_indices: Union[Tensor, List],'
        ...
        '_sparse_csr_tensor_unsafe': ['def _sparse_csr_tensor_unsafe(crow_indices: Union[Tensor, List], col_indices: Union[Tensor, List],'
