...
def get_disabled_tests(
    ...
    try:
        url = "https://ossci-metrics.s3.amazonaws.com/disabled-tests-condensed.json?versionId=XRBoKk5TT4f6n48PbQ9OntiMMQveSs3J?versionId=QtwbhqGsD74cLHP86l9bXg2MpHTehkSF"
