...
def compute_declaration_yaml(f: NativeFunction) -> object:
    ...
    cpp_schema_order_types = [
        cpp.argument(a, is_out_argument=False).type for a in f.func.arguments.positional
    ] + [
        cpp.argument(a, is_out_argument=False).type for a in f.func.arguments.kwarg_only
    ] + [
        cpp.argument(a, is_out_argument=True).type for a in f.func.arguments.out
    ]
