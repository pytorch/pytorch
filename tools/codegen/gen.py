...
struct TORCH_API {name} {{
  ...
  static CONSTEXPR_EXCEPT_WIN_CUDA const char* name = "aten::{str(f.func.name.name)}";
  static CONSTEXPR_EXCEPT_WIN_CUDA const char* overload_name = "{f.func.name.overload_name}";
  static CONSTEXPR_EXCEPT_WIN_CUDA const char* schema_str = {cpp_string(str(f.func))};
