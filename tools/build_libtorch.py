...
if __name__ == '__main__':
    ...
    parser.add_argument('--android-abi', type=str,
                        help='build libtroch for android arch ("x86" or "armeabi-v7a with NEON")')
    options = parser.parse_args()

    build_caffe2(version=None, cmake_python_library=None,
                 build_python=False, rerun_cmake=True, build_dir='.', android_abi=options.android_abi)
