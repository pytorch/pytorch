...
if __name__ == "__main__":
    ...
    parser.add_argument("--hipblaslt-version", "--hipblaslt_version", type=str)
    ...
    with open(version_path, "w") as f:
        ...
        f.write(
            "__all__ = ['__version__', 'debug', 'cuda', 'git_version', 'hip', 'hipblaslt', 'rocm', 'xpu']\n"
        )
        ...
        f.write(f"hipblaslt: Optional[str] = {repr(args.hipblaslt_version)}\n")
