...
load("@fbsource//tools/build_defs:merge_dictionaries.bzl", "merge_dictionaries")
load("@fbsource//tools/build_defs:platform_defs.bzl", "ANDROID", "APPLE", "APPLETVOS", "CXX", "IOS", "MACOSX", "WINDOWS")
load("@fbsource//tools/build_defs:target_defs.bzl", "define_target_with_dictionay")
...
_XNNPACK_WINDOWS_AVX512F_ENABLED = read_config_bool("xnnpack", "windows_avx512f_enabled", True)
...
] if _XNNPACK_WINDOWS_AVX512F_ENABLED else [])
...
def define_xnnpack_targets():
    fb_xplat_cxx_library(
        ...
        exported_deps = [
            ...
            "//xplat/third-party/pthreadpool:pthreadpool_header",
        ],
    )
    ...
    fb_xplat_cxx_library(
        ...
        deps = [
            ...
            "//xplat/third-party/FXdiv:FXdiv",
            "//xplat/third-party/clog:clog",
        ],
    )
        ...
        merge_dictionaries(
            {
                ...
                "deps": [
                    ...
                    "ovr_config//os:windows": [":x86_and_x86_64_lib_ovr_win32"] if _XNNPACK_WINDOWS_AVX512F_ENABLED else [
                        ":arm_lib",
                        ":x86_and_x86_64_lib",
                    ],
            ...
            },
            {
                ...
                "windows_clang_compiler_flags_override": WINDOWS_FLAGS,
            },
        ),
    )
