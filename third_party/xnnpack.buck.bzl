...
def define_xnnpack(third_party, labels = [], XNNPACK_WINDOWS_AVX512F_ENABLED = False):
    ...
    fb_xplat_cxx_library(
        ...
        platform_srcs = [
            (
                "(arm64|aarch64)",
                PROD_NEON_MICROKERNEL_SRCS + PROD_NEON_AARCH64_MICROKERNEL_SRCS,
            )
        ],
        visibility = ["PUBLIC"],
        windows_clang_compiler_flags_override = WINDOWS_FLAGS + WINDOWS_CLANG_COMPILER_FLAGS,
    ...
    fb_xplat_cxx_library(
        name = "ukernels_neon_fp16arith_aarch32",
        headers = subdir_glob([
            ("XNNPACK/src", "**/*.c"),
            ("XNNPACK/src", "**/*.h"),
        ]),
    ...
    fb_xplat_cxx_library(
        ...
        deps = [
            ...
            ":ukernels_neon_fma",
            ":ukernels_neon_fp16",
            ":ukernels_neon_fp16arith_aarch32",
            ":ukernels_neon_fp16arith_aarch64",
            ":ukernels_neon_v8",
            ":ukernels_neonfma_aarch64",
            ":ukernels_neonfma_i8mm",
