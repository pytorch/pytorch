...
struct UserDefinedFusionSchedule {
  //! Scheduled Fusion IR
  std::unique_ptr<Nvf::Fusion> schedule;
  //! Generated kernel container
  std::unique_ptr<Nvf::FusionExecutor> executor;
};
...
struct FusionSchedules {
  ...
  std::unique_ptr<Nvf::FusionExecutorCache> auto_gen_schedules;
...
class TORCH_CUDA_CU_API FusionCache {
 ...
 private:
  ...
  Nvf::InputsIdLookup user_defined_input_encodings_;
};
