...
TH_API at::LongStorageImpl *THCSTensor_(newSizeOf)(THCState *state, THCSTensor *self);
...
TH_API THCSTensor *THCSTensor_(newWithTensorAndSizeUnsafe)(THCState *state, THCIndexTensor *indices, THCTensor *values, at::LongStorageImpl *sizes);
TH_API THCSTensor *THCSTensor_(newWithTensorAndSize)(THCState *state, THCIndexTensor *indices, THCTensor *values, at::LongStorageImpl *sizes);

TH_API THCSTensor *THCSTensor_(newWithSize)(THCState *state, at::LongStorageImpl *size_, at::LongStorageImpl *_ignored);
...
TH_API THCSTensor *THCSTensor_(resize)(THCState *state, THCSTensor *self, at::LongStorageImpl *size);
