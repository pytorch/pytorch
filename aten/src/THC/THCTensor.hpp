...
THC_API void THCTensor_resize(THCState *state, THCTensor *tensor, at::IntListRef size, at::IntListRef stride);
...
THC_API void THCTensor_setStorage(THCState *state, THCTensor *self, THCStorage *storage_, ptrdiff_t storageOffset_, at::IntListRef size_, at::IntListRef stride_);
