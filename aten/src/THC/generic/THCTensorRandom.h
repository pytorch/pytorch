...
THC_API void THCTensor_(rand)(THCState *state, THCTensor *r_, at::LongStorageImpl *size);
THC_API void THCTensor_(randn)(THCState *state, THCTensor *r_, at::LongStorageImpl *size);
