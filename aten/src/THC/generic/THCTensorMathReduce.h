...
THC_API void THCTensor_(std)(THCState *state, THCTensor *self, THCTensor *src, int dim, bool biased, int keepdim);
THC_API void THCTensor_(norm)(THCState *state, THCTensor* self, THCTensor* src, scalar_t value, int dimension, int keepdim);
THC_API void THCTensor_(var)(THCState *state, THCTensor *self, THCTensor *src, int dim, bool biased, int keepdim);

THC_API accreal THCTensor_(stdall)(THCState *state, THCTensor *self, bool biased);
THC_API accreal THCTensor_(normall)(THCState *state, THCTensor *self, scalar_t value);
THC_API accreal THCTensor_(varall)(THCState *state, THCTensor *self, bool biased);
