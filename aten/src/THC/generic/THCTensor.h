...
/**** access methods ****/
THC_API at::CUDAStorageImpl* THCTensor_(storage)(THCState *state, const THCTensor *self);
...
THC_API at::LongStorageImpl *THCTensor_(newSizeOf)(THCState *state, THCTensor *self);
THC_API at::LongStorageImpl *THCTensor_(newStrideOf)(THCState *state, THCTensor *self);
...
THC_API THCTensor *THCTensor_(newWithStorage)(THCState *state, at::CUDAStorageImpl *storage_, ptrdiff_t storageOffset_, at::LongStorageImpl *size_, at::LongStorageImpl *stride_);
THC_API THCTensor *THCTensor_(newWithStorage1d)(THCState *state, at::CUDAStorageImpl *storage_, ptrdiff_t storageOffset_,
                                int64_t size0_, int64_t stride0_);
THC_API THCTensor *THCTensor_(newWithStorage2d)(THCState *state, at::CUDAStorageImpl *storage_, ptrdiff_t storageOffset_,
                                int64_t size0_, int64_t stride0_,
                                int64_t size1_, int64_t stride1_);
THC_API THCTensor *THCTensor_(newWithStorage3d)(THCState *state, at::CUDAStorageImpl *storage_, ptrdiff_t storageOffset_,
                                int64_t size0_, int64_t stride0_,
                                int64_t size1_, int64_t stride1_,
                                int64_t size2_, int64_t stride2_);
THC_API THCTensor *THCTensor_(newWithStorage4d)(THCState *state, at::CUDAStorageImpl *storage_, ptrdiff_t storageOffset_,
                                int64_t size0_, int64_t stride0_,
                                int64_t size1_, int64_t stride1_,
                                int64_t size2_, int64_t stride2_,
...
/* stride might be NULL */
THC_API THCTensor *THCTensor_(newWithSize)(THCState *state, at::LongStorageImpl *size_, at::LongStorageImpl *stride_);
...
THC_API THCTensor *THCTensor_(newView)(THCState *state, THCTensor *tensor, at::LongStorageImpl *size);
...
THC_API void THCTensor_(resize)(THCState *state, THCTensor *tensor, at::LongStorageImpl *size, at::LongStorageImpl *stride);
...
THC_API void THCTensor_(setStorage)(THCState *state, THCTensor *self, at::CUDAStorageImpl *storage_, ptrdiff_t storageOffset_, at::LongStorageImpl *size_, at::LongStorageImpl *stride_);
THC_API void THCTensor_(setStorageNd)(THCState *state, THCTensor *self, at::CUDAStorageImpl *storage, ptrdiff_t storageOffset, int nDimension, int64_t *size, int64_t *stride);
THC_API void THCTensor_(setStorage1d)(THCState *state, THCTensor *self, at::CUDAStorageImpl *storage_, ptrdiff_t storageOffset_,
                                    int64_t size0_, int64_t stride0_);
THC_API void THCTensor_(setStorage2d)(THCState *state, THCTensor *self, at::CUDAStorageImpl *storage_, ptrdiff_t storageOffset_,
                                    int64_t size0_, int64_t stride0_,
                                    int64_t size1_, int64_t stride1_);
THC_API void THCTensor_(setStorage3d)(THCState *state, THCTensor *self, at::CUDAStorageImpl *storage_, ptrdiff_t storageOffset_,
                                    int64_t size0_, int64_t stride0_,
                                    int64_t size1_, int64_t stride1_,
                                    int64_t size2_, int64_t stride2_);
THC_API void THCTensor_(setStorage4d)(THCState *state, THCTensor *self, at::CUDAStorageImpl *storage_, ptrdiff_t storageOffset_,
                                    int64_t size0_, int64_t stride0_,
                                    int64_t size1_, int64_t stride1_,
                                    int64_t size2_, int64_t stride2_,
                                    int64_t size3_, int64_t stride3_);
...
THC_API int THCTensor_(isSize)(THCState *state, const THCTensor *self, const at::LongStorageImpl *dims);
