...
THC_API void THCTensor_(zeros)(THCState *state, THCTensor *r_, at::LongStorageImpl *size);
THC_API void THCTensor_(zerosLike)(THCState *state, THCTensor *r_, THCTensor* input);
THC_API void THCTensor_(ones)(THCState *state, THCTensor *r_, at::LongStorageImpl *size);
THC_API void THCTensor_(onesLike)(THCState *state, THCTensor *r_, THCTensor* input);
THC_API void THCTensor_(reshape)(THCState *state, THCTensor *r_, THCTensor *t, at::LongStorageImpl *size);
