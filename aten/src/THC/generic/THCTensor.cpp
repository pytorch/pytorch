...
/* Storage init */
THCTensor *THCTensor_(newWithStorage)(THCState *state, THCStorage *storage, ptrdiff_t storageOffset, at::IntListRef sizes, at::IntListRef strides) {
  if (strides.data()) {
...
THCTensor *THCTensor_(newWithSize)(THCState *state, at::IntListRef size, at::IntListRef stride)
{
...
THCTensor *THCTensor_(newView)(THCState *state, THCTensor *tensor, at::IntListRef size)
{
...
/* Resize */
void THCTensor_(resize)(THCState *state, THCTensor *self, at::IntListRef size, at::IntListRef stride)
{
...
void THCTensor_(setStorage)(THCState *state, THCTensor *self, THCStorage *storage_, ptrdiff_t storageOffset_, at::IntListRef size_, at::IntListRef stride_) {
