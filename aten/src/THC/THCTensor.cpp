...
void THCTensor_resize(THCState *state, THCTensor *self, at::IntListRef size, at::IntListRef stride) {
  if(stride.data()) {
...
void THCTensor_setStorage(THCState *state, THCTensor *self, THCStorage *storage_, ptrdiff_t storageOffset_, at::IntListRef size_, at::IntListRef stride_)
{
  if (stride_.data()) {
