...
AT_FORALL_SCALAR_TYPES_EXCEPT_QINT(AXPY_SPECIALIZATION)
...
AT_FORALL_SCALAR_TYPES_EXCEPT_QINT(COPY_SPECIALIZATION)
...
AT_FORALL_SCALAR_TYPES_EXCEPT_QINT(DOT_SPECIALIZATION)
