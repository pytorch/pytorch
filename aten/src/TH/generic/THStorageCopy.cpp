...
// NOTE: for performance, these macros generally use the raw data pointer in the
// inner loops, rather than repeated THStorage_(data) calls.
...
IMPLEMENT_THStorage_COPY(Byte) IMPLEMENT_THStorage_COPY(Char)
    IMPLEMENT_THStorage_COPY(Short) IMPLEMENT_THStorage_COPY(Int)
        IMPLEMENT_THStorage_COPY(Long) IMPLEMENT_THStorage_COPY(Float)
            IMPLEMENT_THStorage_COPY(Double) IMPLEMENT_THStorage_COPY(Half)
...
#endif
#else
IMPLEMENT_THStorage_COPY(ComplexFloat) IMPLEMENT_THStorage_COPY(ComplexDouble)
#endif
