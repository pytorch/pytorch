...
{
  return c10::make_intrusive<at::TensorImpl, at::UndefinedTensorImpl>(THStorage_(new)(), at::CPUTensorId(), at::TensorImplOptions()).release();
}

/* Pointer-copy init */
THTensor *THTensor_(newWithTensor)(THTensor *tensor)
{
  THTensor *self = c10::make_intrusive<at::TensorImpl, at::UndefinedTensorImpl>(THStorage_(new)(), at::CPUTensorId(), at::TensorImplOptions()).release();
