...
/* Storage init */
THTensor *THTensor_(newWithStorage)(THStorage *storage, ptrdiff_t storageOffset, at::IntListRef sizes, at::IntListRef strides) {
  if (strides.data()) {
...
THTensor *THTensor_(newWithSize)(at::IntListRef size, at::IntListRef stride)
{
...
THTensor *THTensor_(newView)(THTensor *tensor, at::IntListRef size)
{
...
/* Resize */
void THTensor_(resize)(THTensor *self, at::IntListRef size, at::IntListRef stride)
{
...
void THTensor_(setStorage)(THTensor *self, THStorage *storage_, ptrdiff_t storageOffset_, at::IntListRef size_, at::IntListRef stride_)
{
