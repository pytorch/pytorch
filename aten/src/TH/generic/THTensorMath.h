...
TH_API void THTensor_(iv)(THTensor *r_, THTensor *v, THTensor *t);
TH_API void THTensor_(i0)(THTensor *r_, THTensor *t);
TH_API void THTensor_(i1)(THTensor *r_, THTensor *t);
