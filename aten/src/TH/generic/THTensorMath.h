...
TH_API void THTensor_(zeros)(THTensor *r_, at::LongStorageImpl *size);
TH_API void THTensor_(zerosLike)(THTensor *r_, THTensor *input);
TH_API void THTensor_(ones)(THTensor *r_, at::LongStorageImpl *size);
...
TH_API void THTensor_(reshape)(THTensor *r_, THTensor *t, at::LongStorageImpl *size);
...
TH_API void THTensor_(rand)(THTensor *r_, THGenerator *_generator, at::LongStorageImpl *size);
TH_API void THTensor_(randn)(THTensor *r_, THGenerator *_generator, at::LongStorageImpl *size);
