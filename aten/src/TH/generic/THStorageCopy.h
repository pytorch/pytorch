...
TH_API void THStorage_(
    copyShort)(THStorage* storage, struct THShortStorage* src);
...
TH_API void THStorage_(
    copyFloat)(THStorage* storage, struct THFloatStorage* src);
TH_API void THStorage_(
    copyDouble)(THStorage* storage, struct THDoubleStorage* src);
...
TH_API void THStorage_(
    copyBFloat16)(THStorage* storage, struct THBFloat16Storage* src);
#ifdef THQUINT8
TH_API void THStorage_(
    copyQUInt8)(THStorage* storage, struct THQUInt8Storage* src);
#endif
#ifdef THQINT8
TH_API void THStorage_(
    copyQInt8)(THStorage* storage, struct THQInt8Storage* src);
#endif
#ifdef THQINT32
TH_API void THStorage_(
    copyQInt32)(THStorage* storage, struct THQInt32Storage* src);
#endif
#else
TH_API void THStorage_(
    copyComplexFloat)(THStorage* storage, struct THComplexFloatStorage* src);
TH_API void THStorage_(
    copyComplexDouble)(THStorage* storage, struct THComplexDoubleStorage* src);
#endif
