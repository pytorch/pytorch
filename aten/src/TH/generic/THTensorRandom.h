...
TH_API void THTensor_(standard_gamma)(THTensor *self, THGenerator *_generator, double alpha);
TH_API void THTensor_(standard_gamma_alpha)(THTensor *self, THGenerator *_generator, THTensor *alpha);
