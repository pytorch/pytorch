...
TH_API void THTensor_(random_gamma)(THTensor *self, THGenerator *_generator, double alpha, double beta);
TH_API void THTensor_(random_gamma_alpha)(THTensor *self, THGenerator *_generator, THTensor *alpha, double beta);
TH_API void THTensor_(random_gamma_beta)(THTensor *self, THGenerator *_generator, double alpha, THTensor *beta);
TH_API void THTensor_(random_gamma_alpha_beta)(THTensor *self, THGenerator *_generator, THTensor *alpha, THTensor *beta);
