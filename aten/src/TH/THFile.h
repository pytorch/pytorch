...
TH_API at::Half THFile_readHalfScalar(THFile *self);
TH_API void THFile_writeHalfScalar(THFile *self, at::Half scalar);
...
TH_API size_t THFile_readHalfRaw(THFile *self, at::Half* data, size_t size);
TH_API size_t THFile_writeHalfRaw(THFile *self, at::Half* data, size_t size);
