...
inline void THTensor_resizeSize(THTensor* tensor, int64_t new_size) {
  tensor->size.resize(new_size);
}

inline void THTensor_setSize(THTensor* tensor, std::vector<int64_t>&& new_size) {
