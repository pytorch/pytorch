...
void nnapi_wrapper_load(struct nnapi_wrapper** nnapi, struct nnapi_wrapper** check_nnapi) {
  ...
  if (!loaded) {
    ...
    *reinterpret_cast<void**>(&nnapi_._getDeviceCount) = dlsym(handle, "ANeuralNetworks_getDeviceCount");
    check_nnapi_._getDeviceCount = check__getDeviceCount;
    *reinterpret_cast<void**>(&nnapi_._getDevice) = dlsym(handle, "ANeuralNetworks_getDevice");
    check_nnapi_._getDevice = check__getDevice;
    *reinterpret_cast<void**>(&nnapi_.Device_getName) = dlsym(handle, "ANeuralNetworksDevice_getName");
    check_nnapi_.Device_getName = check_Device_getName;
    *reinterpret_cast<void**>(&nnapi_.Device_getVersion) = dlsym(handle, "ANeuralNetworksDevice_getVersion");
    check_nnapi_.Device_getVersion = check_Device_getVersion;
    *reinterpret_cast<void**>(&nnapi_.Device_getFeatureLevel) = dlsym(handle, "ANeuralNetworksDevice_getFeatureLevel");
    check_nnapi_.Device_getFeatureLevel = check_Device_getFeatureLevel;
    *reinterpret_cast<void**>(&nnapi_.Model_getSupportedOperationsForDevices) = dlsym(handle, "ANeuralNetworksModel_getSupportedOperationsForDevices");
    check_nnapi_.Model_getSupportedOperationsForDevices = check_Model_getSupportedOperationsForDevices;
    *reinterpret_cast<void**>(&nnapi_.Compilation_createForDevices) = dlsym(handle, "ANeuralNetworksCompilation_createForDevices");
    check_nnapi_.Compilation_createForDevices = check_Compilation_createForDevices;
    *reinterpret_cast<void**>(&nnapi_.Execution_compute) = dlsym(handle, "ANeuralNetworksExecution_compute");
    check_nnapi_.Execution_compute = check_Execution_compute;
    *reinterpret_cast<void**>(&nnapi_.Memory_createFromFd) = dlsym(handle, "ANeuralNetworksMemory_createFromFd");
    check_nnapi_.Memory_createFromFd = check_Memory_createFromFd;
    *reinterpret_cast<void**>(&nnapi_.Memory_free) = dlsym(handle, "ANeuralNetworksMemory_free");
    check_nnapi_.Memory_free = check_Memory_free;
    *reinterpret_cast<void**>(&nnapi_.Model_create) = dlsym(handle, "ANeuralNetworksModel_create");
    check_nnapi_.Model_create = check_Model_create;
    *reinterpret_cast<void**>(&nnapi_.Model_free) = dlsym(handle, "ANeuralNetworksModel_free");
    check_nnapi_.Model_free = check_Model_free;
    *reinterpret_cast<void**>(&nnapi_.Model_finish) = dlsym(handle, "ANeuralNetworksModel_finish");
    check_nnapi_.Model_finish = check_Model_finish;
    *reinterpret_cast<void**>(&nnapi_.Model_addOperand) = dlsym(handle, "ANeuralNetworksModel_addOperand");
    check_nnapi_.Model_addOperand = check_Model_addOperand;
    *reinterpret_cast<void**>(&nnapi_.Model_setOperandValue) = dlsym(handle, "ANeuralNetworksModel_setOperandValue");
    check_nnapi_.Model_setOperandValue = check_Model_setOperandValue;
    *reinterpret_cast<void**>(&nnapi_.Model_setOperandValueFromMemory) = dlsym(handle, "ANeuralNetworksModel_setOperandValueFromMemory");
    check_nnapi_.Model_setOperandValueFromMemory = check_Model_setOperandValueFromMemory;
    *reinterpret_cast<void**>(&nnapi_.Model_addOperation) = dlsym(handle, "ANeuralNetworksModel_addOperation");
    check_nnapi_.Model_addOperation = check_Model_addOperation;
    *reinterpret_cast<void**>(&nnapi_.Model_identifyInputsAndOutputs) = dlsym(handle, "ANeuralNetworksModel_identifyInputsAndOutputs");
    check_nnapi_.Model_identifyInputsAndOutputs = check_Model_identifyInputsAndOutputs;
    *reinterpret_cast<void**>(&nnapi_.Model_relaxComputationFloat32toFloat16) = dlsym(handle, "ANeuralNetworksModel_relaxComputationFloat32toFloat16");
    check_nnapi_.Model_relaxComputationFloat32toFloat16 = check_Model_relaxComputationFloat32toFloat16;
    *reinterpret_cast<void**>(&nnapi_.Compilation_create) = dlsym(handle, "ANeuralNetworksCompilation_create");
    check_nnapi_.Compilation_create = check_Compilation_create;
    *reinterpret_cast<void**>(&nnapi_.Compilation_free) = dlsym(handle, "ANeuralNetworksCompilation_free");
    check_nnapi_.Compilation_free = check_Compilation_free;
    *reinterpret_cast<void**>(&nnapi_.Compilation_setPreference) = dlsym(handle, "ANeuralNetworksCompilation_setPreference");
    check_nnapi_.Compilation_setPreference = check_Compilation_setPreference;
    *reinterpret_cast<void**>(&nnapi_.Compilation_finish) = dlsym(handle, "ANeuralNetworksCompilation_finish");
    check_nnapi_.Compilation_finish = check_Compilation_finish;
    *reinterpret_cast<void**>(&nnapi_.Execution_create) = dlsym(handle, "ANeuralNetworksExecution_create");
    check_nnapi_.Execution_create = check_Execution_create;
    *reinterpret_cast<void**>(&nnapi_.Execution_free) = dlsym(handle, "ANeuralNetworksExecution_free");
    check_nnapi_.Execution_free = check_Execution_free;
    *reinterpret_cast<void**>(&nnapi_.Execution_setInput) = dlsym(handle, "ANeuralNetworksExecution_setInput");
    check_nnapi_.Execution_setInput = check_Execution_setInput;
    *reinterpret_cast<void**>(&nnapi_.Execution_setInputFromMemory) = dlsym(handle, "ANeuralNetworksExecution_setInputFromMemory");
    check_nnapi_.Execution_setInputFromMemory = check_Execution_setInputFromMemory;
    *reinterpret_cast<void**>(&nnapi_.Execution_setOutput) = dlsym(handle, "ANeuralNetworksExecution_setOutput");
    check_nnapi_.Execution_setOutput = check_Execution_setOutput;
    *reinterpret_cast<void**>(&nnapi_.Execution_setOutputFromMemory) = dlsym(handle, "ANeuralNetworksExecution_setOutputFromMemory");
    check_nnapi_.Execution_setOutputFromMemory = check_Execution_setOutputFromMemory;
    *reinterpret_cast<void**>(&nnapi_.Execution_startCompute) = dlsym(handle, "ANeuralNetworksExecution_startCompute");
    check_nnapi_.Execution_startCompute = check_Execution_startCompute;
    *reinterpret_cast<void**>(&nnapi_.Event_wait) = dlsym(handle, "ANeuralNetworksEvent_wait");
    check_nnapi_.Event_wait = check_Event_wait;
    *reinterpret_cast<void**>(&nnapi_.Event_free) = dlsym(handle, "ANeuralNetworksEvent_free");
    check_nnapi_.Event_free = check_Event_free;
    *reinterpret_cast<void**>(&nnapi_.Execution_getOutputOperandRank) = dlsym(handle, "ANeuralNetworksExecution_getOutputOperandRank");
    check_nnapi_.Execution_getOutputOperandRank = check_Execution_getOutputOperandRank;
    *reinterpret_cast<void**>(&nnapi_.Execution_getOutputOperandDimensions) = dlsym(handle, "ANeuralNetworksExecution_getOutputOperandDimensions");
