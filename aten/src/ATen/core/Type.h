...
struct CAFFE2_API Type {
  ...
  virtual Tensor numpy_repeat(const Tensor & repeats) const = 0;
  virtual Tensor numpy_repeat(const Tensor & self, const Tensor & repeats, c10::optional<int64_t> dim) const = 0;
  virtual Tensor numpy_repeat(const Tensor & self, int64_t repeats, c10::optional<int64_t> dim) const = 0;
