...
struct CAFFE2_API Type {
  ...
  virtual Tensor as_strided(const Tensor & self, IntListRef size, IntListRef stride, c10::optional<int64_t> storage_offset) const = 0;
  virtual Tensor & as_strided_(Tensor & self, IntListRef size, IntListRef stride, c10::optional<int64_t> storage_offset) const = 0;
  ...
  virtual Tensor & resize_(Tensor & self, IntListRef size) const = 0;
  ...
  virtual Tensor expand(const Tensor & self, IntListRef size, bool implicit) const = 0;
  ...
  virtual Tensor irfft(const Tensor & self, int64_t signal_ndim, bool normalized, bool onesided, IntListRef signal_sizes) const = 0;
  ...
  virtual Tensor mean(const Tensor & self, IntListRef dim, bool keepdim, ScalarType dtype) const = 0;
  virtual Tensor mean(const Tensor & self, IntListRef dim, bool keepdim) const = 0;
  virtual Tensor mean(const Tensor & self, IntListRef dim, ScalarType dtype) const = 0;
  ...
  virtual Tensor permute(const Tensor & self, IntListRef dims) const = 0;
  virtual Tensor pin_memory(const Tensor & self) const = 0;
  virtual Tensor pinverse(const Tensor & self, double rcond) const = 0;
  virtual Tensor repeat(const Tensor & self, IntListRef repeats) const = 0;
  virtual Tensor reshape(const Tensor & self, IntListRef shape) const = 0;
  ...
  virtual std::vector<Tensor> split_with_sizes(const Tensor & self, IntListRef split_sizes, int64_t dim) const = 0;
  ...
  virtual Tensor sum(const Tensor & self, IntListRef dim, bool keepdim, ScalarType dtype) const = 0;
  virtual Tensor sum(const Tensor & self, IntListRef dim, bool keepdim) const = 0;
  virtual Tensor sum(const Tensor & self, IntListRef dim, ScalarType dtype) const = 0;
  virtual Tensor sum_to_size(const Tensor & self, IntListRef size) const = 0;
  ...
  virtual Tensor std(const Tensor & self, IntListRef dim, bool unbiased, bool keepdim) const = 0;
  ...
  virtual Tensor flip(const Tensor & self, IntListRef dims) const = 0;
  virtual Tensor roll(const Tensor & self, IntListRef shifts, IntListRef dims) const = 0;
  virtual Tensor rot90(const Tensor & self, int64_t k, IntListRef dims) const = 0;
  ...
  virtual Tensor var(const Tensor & self, IntListRef dim, bool unbiased, bool keepdim) const = 0;
  ...
  virtual Tensor norm(const Tensor & self, c10::optional<Scalar> p, IntListRef dim, bool keepdim, ScalarType dtype) const = 0;
  virtual Tensor norm(const Tensor & self, c10::optional<Scalar> p, IntListRef dim, bool keepdim) const = 0;
  ...
  virtual Tensor & sparse_resize_(Tensor & self, IntListRef size, int64_t sparse_dim, int64_t dense_dim) const = 0;
  virtual Tensor & sparse_resize_and_clear_(Tensor & self, IntListRef size, int64_t sparse_dim, int64_t dense_dim) const = 0;
  ...
  virtual Tensor & set_(Tensor & self, Storage source, int64_t storage_offset, IntListRef size, IntListRef stride) const = 0;
  ...
  virtual Tensor view(const Tensor & self, IntListRef size) const = 0;
