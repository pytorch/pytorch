...
struct CAFFE2_API Type {
  ...
  virtual Tensor cumprod(const Tensor & self, int64_t dim, c10::optional<ScalarType> dtype) const = 0;
  ...
  virtual Tensor mean(const Tensor & self, IntArrayRef dim, bool keepdim, c10::optional<ScalarType> dtype) const = 0;
  ...
  virtual Tensor sum(const Tensor & self, IntArrayRef dim, bool keepdim, c10::optional<ScalarType> dtype) const = 0;
  ...
  virtual Tensor prod(const Tensor & self, c10::optional<ScalarType> dtype) const = 0;
  virtual Tensor prod(const Tensor & self, int64_t dim, bool keepdim, c10::optional<ScalarType> dtype) const = 0;
