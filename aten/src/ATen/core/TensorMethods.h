...
inline Tensor Tensor::unflatten(Dimname dim, IntArrayRef sizes, DimnameList names) const {
    ...
    return table->getOp<Tensor (const Tensor &, Dimname, IntArrayRef, DimnameList)>(tensorTypeIdToBackend(type_id()), is_variable())(const_cast<Tensor&>(*this), dim, sizes, names);
#endif
}
#endif
#ifdef BUILD_NAMEDTENSOR
inline Tensor Tensor::unflatten(int64_t dim, IntArrayRef sizes, DimnameList names) const {
    ...
    return table->getOp<Tensor (const Tensor &, int64_t, IntArrayRef, DimnameList)>(tensorTypeIdToBackend(type_id()), is_variable())(const_cast<Tensor&>(*this), dim, sizes, names);
#endif
}
#endif
...
inline std::vector<Tensor> Tensor::unbind(Dimname dim) const {
    ...
    return table->getOp<std::vector<Tensor> (const Tensor &, Dimname)>(tensorTypeIdToBackend(type_id()), is_variable())(const_cast<Tensor&>(*this), dim);
#endif
}
#endif
