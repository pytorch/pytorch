...
inline Tensor Tensor::fake_quantize_per_tensor_affine(double scale, int64_t zero_point, int64_t quant_min, int64_t quant_max, int64_t quant_delay, int64_t iter) const {
    static auto table = globalATenDispatch().getOpTable("aten::fake_quantize_per_tensor_affine(Tensor self, float scale, int zero_point, int quant_min, int quant_max, int quant_delay, int iter) -> Tensor");
    return table->getOp<Tensor (const Tensor &, double, int64_t, int64_t, int64_t, int64_t, int64_t)>(tensorTypeIdToBackend(type_id()), is_variable())(*this, scale, zero_point, quant_min, quant_max, quant_delay, iter);
}
inline Tensor Tensor::fake_quantize_per_tensor_affine_backward(const Tensor & grad, double scale, int64_t zero_point, int64_t quant_min, int64_t quant_max, int64_t quant_delay, int64_t iter) const {
    static auto table = globalATenDispatch().getOpTable("aten::fake_quantize_per_tensor_affine_backward(Tensor grad, Tensor self, float scale, int zero_point, int quant_min, int quant_max, int quant_delay, int iter) -> Tensor");
    return table->getOp<Tensor (const Tensor &, const Tensor &, double, int64_t, int64_t, int64_t, int64_t, int64_t)>(tensorTypeIdToBackend(type_id()), is_variable())(grad, *this, scale, zero_point, quant_min, quant_max, quant_delay, iter);
}
