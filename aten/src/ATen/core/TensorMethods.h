...
#ifdef BUILD_NAMEDTENSOR
inline Tensor & Tensor::names_(c10::optional<DimnameList> names) {
...
inline Tensor Tensor::log_softmax(Dimname dim, c10::optional<ScalarType> dtype) const {
    ...
    return table->getOp<Tensor (const Tensor &, Dimname, c10::optional<ScalarType>)>(tensorTypeIdToBackend(type_id()), is_variable())(*this, dim, dtype);
}
#endif
