...
inline Tensor Tensor::as_strided(IntListRef size, IntListRef stride, c10::optional<int64_t> storage_offset) const {
    return type().as_strided(*this, size, stride, storage_offset);
}
inline Tensor & Tensor::as_strided_(IntListRef size, IntListRef stride, c10::optional<int64_t> storage_offset) {
...
inline Tensor & Tensor::resize_(IntListRef size) {
...
inline Tensor Tensor::expand(IntListRef size, bool implicit) const {
...
inline Tensor Tensor::irfft(int64_t signal_ndim, bool normalized, bool onesided, IntListRef signal_sizes) const {
...
inline Tensor Tensor::mean(IntListRef dim, bool keepdim, ScalarType dtype) const {
    return type().mean(*this, dim, keepdim, dtype);
}
inline Tensor Tensor::mean(IntListRef dim, bool keepdim) const {
    return type().mean(*this, dim, keepdim);
}
inline Tensor Tensor::mean(IntListRef dim, ScalarType dtype) const {
...
inline Tensor Tensor::permute(IntListRef dims) const {
...
inline Tensor Tensor::repeat(IntListRef repeats) const {
    return type().repeat(*this, repeats);
}
inline Tensor Tensor::reshape(IntListRef shape) const {
...
inline std::vector<Tensor> Tensor::split_with_sizes(IntListRef split_sizes, int64_t dim) const {
...
inline Tensor Tensor::sum(IntListRef dim, bool keepdim, ScalarType dtype) const {
    return type().sum(*this, dim, keepdim, dtype);
}
inline Tensor Tensor::sum(IntListRef dim, bool keepdim) const {
    return type().sum(*this, dim, keepdim);
}
inline Tensor Tensor::sum(IntListRef dim, ScalarType dtype) const {
    return type().sum(*this, dim, dtype);
}
inline Tensor Tensor::sum_to_size(IntListRef size) const {
...
inline Tensor Tensor::std(IntListRef dim, bool unbiased, bool keepdim) const {
...
inline Tensor Tensor::flip(IntListRef dims) const {
    return type().flip(*this, dims);
}
inline Tensor Tensor::roll(IntListRef shifts, IntListRef dims) const {
    return type().roll(*this, shifts, dims);
}
inline Tensor Tensor::rot90(int64_t k, IntListRef dims) const {
...
inline Tensor Tensor::var(IntListRef dim, bool unbiased, bool keepdim) const {
...
inline Tensor Tensor::norm(c10::optional<Scalar> p, IntListRef dim, bool keepdim, ScalarType dtype) const {
    return type().norm(*this, p, dim, keepdim, dtype);
}
inline Tensor Tensor::norm(c10::optional<Scalar> p, IntListRef dim, bool keepdim) const {
...
inline Tensor & Tensor::sparse_resize_(IntListRef size, int64_t sparse_dim, int64_t dense_dim) {
    return type().sparse_resize_(*this, size, sparse_dim, dense_dim);
}
inline Tensor & Tensor::sparse_resize_and_clear_(IntListRef size, int64_t sparse_dim, int64_t dense_dim) {
...
inline Tensor & Tensor::set_(Storage source, int64_t storage_offset, IntListRef size, IntListRef stride) {
...
inline Tensor Tensor::view(IntListRef size) const {
