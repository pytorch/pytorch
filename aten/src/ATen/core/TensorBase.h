...
class TORCH_API TensorBase {
 ...
 public:
  ...
  TensorBase& operator=(TensorBase&& x) &  = default;
  ...
  const TensorBase& grad() const {
    const TensorBase& maybe_grad = impl_->grad();
  ...
  const TensorBase& _fw_grad(uint64_t level) const {
