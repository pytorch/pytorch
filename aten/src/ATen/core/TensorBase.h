...
class TORCH_API TensorBase {
 ...
 protected:
  ...
  explicit TensorBase(unsafe_borrow_t, const TensorBase& rhs)
      : impl_(c10::intrusive_ptr<at::TensorImpl, UndefinedTensorImpl>::reclaim(
            rhs.impl_.get())) {}
 ...
 public:
  ...
  using hook_return_void_t = std::enable_if_t<
      std::is_void<typename std::result_of<T&(TensorBase)>::type>::value,
      unsigned>;
  template <typename T>
  using hook_return_var_t = std::enable_if_t<
      std::is_same<typename std::result_of<T&(TensorBase)>::type, TensorBase>::
          value,
      unsigned>;
...
auto TensorBase::register_hook(T&& hook) const
  ...
  static_assert(
      std::is_same<decltype(hook(TensorBase())), void>::value,
