...
_(aten, naive_conv_dilated2d) \
_(aten, naive_conv_dilated2d_backward) \
_(aten, naive_conv_dilated3d) \
_(aten, naive_conv_dilated3d_backward) \
_(aten, naive_conv_transpose2d) \
_(aten, naive_conv_transpose2d_backward) \
_(aten, naive_conv_transpose3d) \
_(aten, naive_conv_transpose3d_backward) \
_(aten, threshold) \
