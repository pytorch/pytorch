...
class CAFFE2_API Tensor {
 ...
 public:
  ...
  Tensor numpy_repeat(const Tensor & repeats, c10::optional<int64_t> dim=c10::nullopt) const;
  Tensor numpy_repeat(int64_t repeats, c10::optional<int64_t> dim=c10::nullopt) const;
