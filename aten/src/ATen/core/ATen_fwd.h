...
// Forward declaration for removed named tensor functionality
// TODO: Remove all references to this type from the codebase
struct Dimname; // Forward declaration
struct Generator;
using TensorList = c10::ArrayRef<Tensor>;
using ITensorListRef = c10::IListRef<Tensor>;
using IOptTensorListRef = c10::IListRef<OptionalTensorRef>;
using DimnameList = c10::ArrayRef<Dimname>; // Dummy type - TODO: Remove
