...
static torch::CppFunction autogradFallback() {
  return torch::CppFunction::makeFromBoxedFunction<&autogradFallback>();
}

#define AUTOGRAD_FALLBACK autogradFallback()
