...
// one.
void fallthrough_kernel(const OperatorHandle&, DispatchKeySet, Stack*) {
...
void ambiguous_autogradother_kernel(const OperatorHandle& op, DispatchKeySet, Stack*) {
  TORCH_INTERNAL_ASSERT(0,
...
void named_not_supported_kernel(const OperatorHandle& op, DispatchKeySet, Stack*) {
