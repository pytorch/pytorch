...
TEST(OperatorRegistrationTest, testAvailableArgTypes) {
  ...
  testArgTypes<Tensor>::test(
    dummyTensor(c10::TensorTypeId::CPUTensorId), [] (const Tensor& v) {EXPECT_EQ(c10::TensorTypeSet(c10::TensorTypeId::CPUTensorId), v.type_set());},
    dummyTensor(c10::TensorTypeId::CUDATensorId), [] (const IValue& v) {EXPECT_EQ(c10::TensorTypeSet(c10::TensorTypeId::CUDATensorId), v.toTensor().type_set());},
    "(Tensor a) -> Tensor");
  ...
  testArgTypes<c10::optional<Tensor>>::test(
    c10::optional<Tensor>(dummyTensor(c10::TensorTypeId::CPUTensorId)), [] (const c10::optional<Tensor>& v) {EXPECT_EQ(c10::TensorTypeSet(c10::TensorTypeId::CPUTensorId), v.value().type_set());},
    c10::optional<Tensor>(dummyTensor(c10::TensorTypeId::CUDATensorId)), [] (const IValue& v) {EXPECT_EQ(c10::TensorTypeSet(c10::TensorTypeId::CUDATensorId), v.toTensor().type_set());},
    "(Tensor? a) -> Tensor?");
  ...
  testArgTypes<c10::List<Tensor>>::test(
    c10::List<Tensor>({dummyTensor(c10::TensorTypeId::CPUTensorId), dummyTensor(c10::TensorTypeId::CUDATensorId)}), [] (const c10::List<Tensor>& v) {
      EXPECT_EQ(2, v.size());
      EXPECT_EQ(c10::TensorTypeSet(c10::TensorTypeId::CPUTensorId), v.get(0).type_set());
      EXPECT_EQ(c10::TensorTypeSet(c10::TensorTypeId::CUDATensorId), v.get(1).type_set());
    },
    c10::List<Tensor>({dummyTensor(c10::TensorTypeId::CUDATensorId), dummyTensor(c10::TensorTypeId::CPUTensorId)}), [] (const IValue& v) {
      ...
      EXPECT_EQ(c10::TensorTypeSet(c10::TensorTypeId::CUDATensorId), v.to<c10::List<at::Tensor>>().get(0).type_set());
      EXPECT_EQ(c10::TensorTypeSet(c10::TensorTypeId::CPUTensorId), v.to<c10::List<at::Tensor>>().get(1).type_set());
    },
    "(Tensor[] a) -> Tensor[]");
  ...
  testArgTypes<std::vector<Tensor>>::test<TestLegacyAPI>(
    std::vector<Tensor>({dummyTensor(c10::TensorTypeId::CPUTensorId), dummyTensor(c10::TensorTypeId::CUDATensorId)}), [] (const std::vector<Tensor>& v) {
      EXPECT_EQ(2, v.size());
      // TBH, I think this test is pretty dumb
      EXPECT_EQ(c10::TensorTypeSet(c10::TensorTypeId::CPUTensorId), v.at(0).type_set());
      EXPECT_EQ(c10::TensorTypeSet(c10::TensorTypeId::CUDATensorId), v.at(1).type_set());
    },
  ...
  testArgTypes<c10::Dict<int64_t, Tensor>>::test(
    tensor_dict, [] (c10::Dict<int64_t, Tensor> v) {
      EXPECT_EQ(2, v.size());
      EXPECT_EQ(c10::TensorTypeSet(c10::TensorTypeId::CPUTensorId), v.at(1).type_set());
      EXPECT_EQ(c10::TensorTypeSet(c10::TensorTypeId::CUDATensorId), v.at(2).type_set());
    },
    tensor_dict, [] (const IValue& v) {
      c10::Dict<int64_t, Tensor> dict = c10::impl::toTypedDict<int64_t, Tensor>(v.toGenericDict());
      EXPECT_EQ(2, dict.size());
      EXPECT_EQ(c10::TensorTypeSet(c10::TensorTypeId::CPUTensorId), dict.at(1).type_set());
      EXPECT_EQ(c10::TensorTypeSet(c10::TensorTypeId::CUDATensorId), dict.at(2).type_set());
    },
