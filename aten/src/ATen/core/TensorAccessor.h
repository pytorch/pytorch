...
// to functions and types available there (e.g. IntListRef isn't).
...
public:
  ...
  C10_HOST IntListRef sizes() const {
    return IntListRef(sizes_,N);
  }
  C10_HOST IntListRef strides() const {
    return IntListRef(strides_,N);
  }
