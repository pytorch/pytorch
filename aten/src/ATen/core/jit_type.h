...
struct CAFFE2_API FunctionType : public Type {
  static FunctionTypePtr create(torch::jit::script::Function* function) {
  ...
  torch::jit::script::Function* function() const {
    return function_;
  }
...
private:
  FunctionType(torch::jit::script::Function* function)
  : Type(TypeKind::FunctionType)
  , function_(function) {}

  torch::jit::script::Function* function_;
};
