...
struct CAFFE2_API CompleteTensorType : public TensorType {
  ...
  static CompleteTensorTypePtr create(at::ScalarType scalar_type, at::Device device, at::IntListRef sizes) {
    return CompleteTensorTypePtr(new CompleteTensorType(scalar_type, device, sizes)); // NOLINT(modernize-make-shared)
  }
  static CompleteTensorTypePtr create(at::ScalarType scalar_type, at::Device device, at::IntListRef sizes, at::IntListRef strides) {
  ...
  TypePtr withSizesStrides(at::IntListRef sizes, at::IntListRef strides) const {
    return CompleteTensorType::create(scalar_type_, device_, sizes, strides);
  }

  TypePtr withSizes(at::IntListRef sizes) const {
...
private:
  ...
  CompleteTensorType(at::ScalarType scalar_type, at::Device device, at::IntListRef sizes, bool requires_grad=true)
    : CompleteTensorType(scalar_type, device, sizes, CompleteTensorType::contiguousStridesOf(sizes), requires_grad) {}
  CompleteTensorType(at::ScalarType scalar_type, at::Device device, at::IntListRef sizes, at::IntListRef strides, bool requires_grad=true)
    : TensorType(scalar_type, device, sizes.size(), requires_grad, TypeKind::CompleteTensorType)
    , sizes_(sizes.vec())
    , strides_(strides.vec()) {}

  static std::vector<int64_t> contiguousStridesOf(at::IntListRef sizes) {
