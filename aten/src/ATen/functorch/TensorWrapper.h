...
struct TORCH_API TensorWrapper : public c10::TensorImpl {
  explicit TensorWrapper(
      ...
      bool alias_of_unwrapped = false,  // if true, this came from an operation that aliases an unwrapped tensor
  ...
  bool alias_of_unwrapped() const {
    return alias_of_unwrapped_;
  }
  bool is_alive() const;
...
TORCH_API Tensor makeTensorWrapper(const Tensor& tensor, int64_t level, bool alias_of_unwrapped=false);
