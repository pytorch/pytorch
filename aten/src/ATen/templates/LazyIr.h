...
// to differentiate between HASH(nullopt, something) and HASH(something,
// nullopt), and using kNullValue in the hash function in the order of arguments
// serves this purpose.
