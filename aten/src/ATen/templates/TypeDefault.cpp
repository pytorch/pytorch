...
static std::vector<int64_t> defaultStrides(IntListRef sizes) {
...
static int64_t computeStorageSize(IntListRef sizes, IntListRef strides) {
...
Tensor TypeDefault::tensorFromBlob(void * data, IntListRef sizes, const std::function<void(void*)> & deleter) const {
  return tensorFromBlob(data, sizes, defaultStrides(sizes), deleter);
}
Tensor TypeDefault::tensorFromBlob(void * data, IntListRef sizes, IntListRef strides, const std::function<void(void*)> & deleter) const {
...
Tensor TypeDefault::tensorWithAllocator(IntListRef sizes, Allocator* allocator) const {
  return tensorWithAllocator(sizes, defaultStrides(sizes), std::move(allocator));
}
Tensor TypeDefault::tensorWithAllocator(IntListRef sizes, IntListRef strides, Allocator* allocator) const {
