...
inline bool variable_excluded_from_dispatch() {
  ...
  return true;
#else
  TORCH_INTERNAL_ASSERT_DEBUG_ONLY(!c10::impl::LocalDispatchKeySetWrapper(c10::impl::_get_thread_local_state()).excluded().has(DispatchKey::Autograd));
  return c10::impl::LocalDispatchKeySetWrapper(c10::impl::_get_thread_local_state()).excluded().isSupersetOf(c10::autograd_dispatch_keyset);
#endif
}
}
