...
inline LongTensor flatten_indices(const Tensor& indices, IntListRef full_size, bool force_clone = false) {
...
inline LongTensor flatten_indices_by_dims(const LongTensor& indices, const IntListRef& sizes, const IntListRef& dims_to_flatten){
