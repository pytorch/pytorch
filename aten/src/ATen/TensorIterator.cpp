...
TensorIterator TensorIterator::unary_float_op_slow(Tensor& out, const Tensor& a, ScalarType common_dtype) {
  // Slow path for unary ops to support more functionality like
  // specifying computation dtype, etc.
  return TensorIteratorConfig()
    .set_check_mem_overlap(true)
    .add_output(out)
    .add_input(a)
