...
TYPE_INTERNAL_INTERFACE_H = CodeTemplate.from_file(TEMPLATE_PATH + "/TypeInternalInterface.h")
...
# outputs
def declare_outputs():
    files = ['Declarations.yaml', 'Type.h', 'TypeInternalInterface.h', 'TypeDefault.cpp', 'TypeDefault.h', 'Tensor.h',
...
def generate_outputs():
    ...
    file_manager.write('TypeInternalInterface.h', TYPE_INTERNAL_INTERFACE_H, top_env)
