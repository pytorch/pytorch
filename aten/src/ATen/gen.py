...
core_file_manager = FileManager('core')
...
def generate_outputs():
    ...
    core_file_manager.write('Type.h', TYPE_H, top_env)
    core_file_manager.write('Tensor.h', TENSOR_H, top_env)
    core_file_manager.write('TensorMethods.h', TENSOR_METHODS_H, top_env)
