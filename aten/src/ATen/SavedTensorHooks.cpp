...
void SavedTensorDefaultHooks::push_hooks(
    PyObject* pack_hook,
...
std::stack<std::pair<PyObject*, PyObject*>> SavedTensorDefaultHooks::
    get_stack() {
  return stack;
}

void SavedTensorDefaultHooks::set_stack(
    std::stack<std::pair<PyObject*, PyObject*>> stack_) {
  stack = stack_;
}
