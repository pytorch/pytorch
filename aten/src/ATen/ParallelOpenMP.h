...
inline void parallel_for(
  ...
  // returns false when max_n == 1 inside nested "omp parallel"
  // See issue gh-32284
  int64_t max_n = omp_get_max_threads();

#pragma omp parallel if (max_n > 1 && !omp_in_parallel() && ((end - begin) > grain_size))
  {
