    ...
    for path in paths:
        for func in parse_native_yaml(path):
            ...
            try:
                ...
                declaration['use_c10_dispatcher'] = func.get('use_c10_dispatcher', 'with_codegenerated_boxing_wrapper')
                assert declaration['use_c10_dispatcher'] in ['unboxed_only', 'with_codegenerated_boxing_wrapper', 'full']
