...
TORCH_IMPL_FUNC(upsample_nearest1d_out_cpu) (
  ...
  upsample_nearest1d_kernel(kCPU, output, input, scales, exact);
}
...
TORCH_IMPL_FUNC(upsample_nearest1d_backward_out_cpu) (
  ...
  grad_input.zero_();
  upsample_nearest1d_backward_kernel(kCPU, grad_input, grad_output, scales, exact);
}
...
Tensor upsample_nearest1d(
  ...
  return at::upsample_nearest1d(input, osize, scale_w, exact);
}
...
Tensor upsample_nearest1d_backward(
  ...
  auto scale_w = get_scale_value(scale_factors, 0);
  return at::upsample_nearest1d_backward(grad_output, osize, input_size, scale_w, exact);
}
