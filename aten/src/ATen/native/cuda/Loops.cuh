...
template<int N>
static OffsetCalculator<N>* make_input_offset_calculator_ptr(const TensorIteratorBase& iter) {
  ...
  return new OffsetCalculator<N>(iter.ndim(), iter.shape().data(), strides.data(), element_sizes);
}
