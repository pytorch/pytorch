...
void logical_xor_inplace_kernel_cuda(TensorIterator& iter) {
  AT_DISPATCH_ALL_TYPES_AND(kBool, iter.dtype(), "logical_xor_cuda", [&]() {
...
REGISTER_DISPATCH(logical_xor_inplace_stub, &logical_xor_inplace_kernel_cuda);
