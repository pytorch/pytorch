...
void clamp_kernel_impl(TensorIteratorBase& iter) {
  AT_DISPATCH_ALL_TYPES_AND2_AND_BOOL(kHalf, kBFloat16, iter.common_dtype(), "clamp_cuda", [&] {
...
void inline launch_clamp_scalar(TensorIteratorBase& iter, Scalar lim0, Scalar lim1, at::native::detail::ClampLimits minmax){
  AT_DISPATCH_ALL_TYPES_AND2_AND_BOOL(kHalf, kBFloat16, iter.common_dtype(), "clamp_scalar_cuda", [&] {
