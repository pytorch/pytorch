...
namespace at::native {
  ...
  struct MediumRadixSort {};
    ...
    template<int N, int WARP_SIZE> struct WarpMergeSort {};
  #endif
#endif
...
void sortCommon(
    ...
    #define DECLARE_WARP_SORT_IF_ENABLED(TYPE) \
      extern template void sortCommon<TYPE>(WarpMergeSort<128, 32>, const TensorBase&, const TensorBase&, int, bool); \
      extern template void sortCommon<TYPE>(WarpMergeSort<128, 64>, const TensorBase&, const TensorBase&, int, bool);
  #else
    #define DECLARE_WARP_SORT_IF_ENABLED(TYPE) \
      extern template void sortCommon<TYPE>(WarpMergeSort<128, C10_WARP_SIZE>, const TensorBase&, const TensorBase&, int, bool);
  #endif
#else
