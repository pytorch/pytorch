...
struct static_unroll<func, end, end> {
  template<typename... Args>
  static inline C10_HOST_DEVICE void with_args(Args... args [[maybe_unused]]) {}
};
...
struct can_vectorize_up_to_helper {
  ...
  static C10_HOST_DEVICE void apply(int &result, array_t pointers, traits _ [[maybe_unused]]) {
