    ...
    AT_DISPATCH_FLOATING_TYPES_AND2(
        ...
        [&] {
          at::cuda::blas::gemm_and_bias<scalar_t>(
              ...
              // Have observed accuracy issues with GELU epilogue in
              // 11.4; bumping requirement to 11.6 as a first guess.
...
#if defined(CUDA_VERSION) && CUDA_VERSION >= 11000 && CUDA_VERSION < 11060 && !defined(_MSC_VER)
