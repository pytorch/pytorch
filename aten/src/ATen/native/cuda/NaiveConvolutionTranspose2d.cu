...
static inline void naive_conv_transpose2d_shape_check(
    const Tensor& input,
...
void naive_conv_transpose2d_out_cuda_template(
    Tensor& output,
    const Tensor& input_,
  ...
  checkAllSameGPU(
      "naive_conv_transpose2d_out_cuda",
  ...
  naive_conv_transpose2d_shape_check(
      input_,
      Tensor(),
      weight_,
      bias_,
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      input.scalar_type(), "naive_conv_transpose2d_out_cuda", [&] {
...
static void naive_conv_transpose2d_backward_out_cuda_template(
    const Tensor& input_,
  ...
  checkAllSameGPU(
      "naive_conv_transpose2d_backward_out_cuda",
      {input_arg,
       grad_output_arg,
       weight_arg,
       grad_columns_arg,
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      grad_output.scalar_type(), "naive_conv_transpose2d_backward_out_cuda", [&] {
        // Helpers
...
void naive_conv_transpose2d_acc_grad_parameters_cuda_template(
    const Tensor& input_,
    const Tensor& grad_output_,
    Tensor& grad_weight,
    Tensor& grad_bias,
  ...
  checkAllSameGPU(
      "naive_conv_transpose2d_acc_grad_parameters_cuda",
      {input_arg,
       grad_output_arg,
       grad_weight_arg,
       grad_bias_arg,
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      input.scalar_type(), "naive_conv_transpose2d_acc_grad_parameters_cuda", [&] {
        // Helpers
...
Tensor& naive_conv_transpose2d_out_cuda(
    Tensor& output,
    const Tensor& input,
    const Tensor& weight,
    IntArrayRef kernel_size,
  ...
  naive_conv_transpose2d_out_cuda_template(
      output,
      input,
      weight,
      kernel_size,
...
Tensor naive_conv_transpose2d_cuda(
    const Tensor& input,
    const Tensor& weight,
    IntArrayRef kernel_size,
    const Tensor& bias,
...
std::tuple<Tensor&, Tensor&, Tensor&> naive_conv_transpose2d_backward_out_cuda(
    Tensor& grad_input,
    Tensor& grad_weight,
    Tensor& grad_bias,
    const Tensor& grad_output,
  ...
  if (grad_input.defined()) {
    naive_conv_transpose2d_backward_out_cuda_template(
        input,
        grad_output,
        grad_input,
        weight,
  ...
  if (grad_weight.defined() || grad_bias.defined()) {
    naive_conv_transpose2d_acc_grad_parameters_cuda_template(
        input,
        grad_output,
        grad_weight,
        grad_bias,
...
std::tuple<Tensor, Tensor, Tensor> naive_conv_transpose2d_backward_cuda(
    const Tensor& grad_output,
    const Tensor& input,
    const Tensor& weight,
    IntArrayRef kernel_size,
