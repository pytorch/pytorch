...
#ifdef USE_ROCM
extern template void sortCommon<uint8_t>(WarpMergeSort<128, 32> sorter, const TensorBase &key, const TensorBase &value, int dim, bool descending);
extern template void sortCommon<uint16_t>(WarpMergeSort<128, 32> sorter, const TensorBase &key, const TensorBase &value, int dim, bool descending);
extern template void sortCommon<uint32_t>(WarpMergeSort<128, 32> sorter, const TensorBase &key, const TensorBase &value, int dim, bool descending);
extern template void sortCommon<uint64_t>(WarpMergeSort<128, 32> sorter, const TensorBase &key, const TensorBase &value, int dim, bool descending);
extern template void sortCommon<uint8_t>(WarpMergeSort<128, 64> sorter, const TensorBase &key, const TensorBase &value, int dim, bool descending);
extern template void sortCommon<uint16_t>(WarpMergeSort<128, 64> sorter, const TensorBase &key, const TensorBase &value, int dim, bool descending);
extern template void sortCommon<uint32_t>(WarpMergeSort<128, 64> sorter, const TensorBase &key, const TensorBase &value, int dim, bool descending);
extern template void sortCommon<uint64_t>(WarpMergeSort<128, 64> sorter, const TensorBase &key, const TensorBase &value, int dim, bool descending);
#else
extern template void sortCommon<uint8_t>(WarpMergeSort<128, C10_WARP_SIZE> sorter, const TensorBase &key, const TensorBase &value, int dim, bool descending);
extern template void sortCommon<uint16_t>(WarpMergeSort<128, C10_WARP_SIZE> sorter, const TensorBase &key, const TensorBase &value, int dim, bool descending);
extern template void sortCommon<uint32_t>(WarpMergeSort<128, C10_WARP_SIZE> sorter, const TensorBase &key, const TensorBase &value, int dim, bool descending);
extern template void sortCommon<uint64_t>(WarpMergeSort<128, C10_WARP_SIZE> sorter, const TensorBase &key, const TensorBase &value, int dim, bool descending);
#endif
#endif
