...
Tensor& max_unpooling2d_forward_out_cuda(
  ...
  AT_DISPATCH_ALL_TYPES_AND(at::ScalarType::Half, "max_unpooling2d_forward_kernel", ([&] {
...
Tensor& max_unpooling3d_forward_out_cuda(
  ...
  AT_DISPATCH_ALL_TYPES_AND(at::ScalarType::Half, "max_unpooling3d_forward_kernel", ([&] {
        while (totalZ > 0) {
          dim3 grid(
...
at::Tensor& max_unpooling2d_backward_out_cuda(
  ...
  AT_DISPATCH_ALL_TYPES_AND(at::ScalarType::Half, "max_unpooling2d_backward_kernel", ([&] {
...
at::Tensor& max_unpooling3d_backward_out_cuda(
  ...
  AT_DISPATCH_ALL_TYPES_AND(at::ScalarType::Half,, "max_unpooling3d_backward_kernel", ([&] {
        while (totalZ > 0) {
          dim3 grid(
              ceilDiv(inputWidth, static_cast<int64_t>(block.x)),
              ceilDiv(inputHeight, static_cast<int64_t>(block.y)),
