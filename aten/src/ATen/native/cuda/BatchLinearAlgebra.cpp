...
//   int n = sizeof(crow_indices_data_ptr)/sizeof(crow_indices_data_ptr[0]) - 1;
//   int nnzA = input._nnz();
//   float tol = 0;
//   int reorder = 1;
//   scalar_t *x = result.data_ptr<scalar_t>();
//   int singularity = _singularity;
//   at::cuda::sparse::linear_solve(_handle, n, nnzA, descrA, values_data_ptr, crow_indices_data_ptr, col_indices_data_ptr, tol, reorder, x, &singularity);  
// }
...
// REGISTER_CUDA_DISPATCH(linalg_solve_sparse_csr_kernel, &linalg_solve_sparse_csr_stub);
