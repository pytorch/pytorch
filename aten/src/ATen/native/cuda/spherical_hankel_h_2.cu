...
const auto spherical_hankel_h_2_string = jiterator_stringify(
  ...
  T1 spherical_hankel_h_2(T1 n, T1 z) {
    return n;
  } // T1 spherical_hankel_h_2(T1 n, T1 z)
...
void spherical_hankel_h_2_kernel_cuda(TensorIteratorBase& iterator) {
#if AT_USE_JITERATOR()
  AT_DISPATCH_FLOATING_TYPES(iterator.common_dtype(), "spherical_hankel_h_2_cuda", [&]() {
...
REGISTER_DISPATCH(spherical_hankel_h_2_stub, &spherical_hankel_h_2_kernel_cuda);
} // namespace native
} // namespace at
