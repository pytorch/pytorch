...
void uniform_kernel_cuda(TensorIterator& iter, double from_, double to_, GeneratorHolder gen_) {
...
Tensor& uniform_cuda_(Tensor& self, double from, double to, GeneratorHolder gen) {
