...
const auto bessel_y_0_string = bessel_j_0_string + jiterator_stringify(
    ...
    T bessel_y_0_forward(T x) {
        ...
        if (x <= T(5.0)) {
            ...
            return yp / yq + (T(0.636619772367581343075535053490057448) * log(x) * bessel_j_0_forward(x));
        }
