...
Tensor bmm_cuda(const Tensor& self, const Tensor& mat2, optional<bool> deterministic_opt) {
  return legacy::cuda::_th_bmm(self, mat2);
}

Tensor& bmm_out_cuda(Tensor &result, const Tensor& batch1, const Tensor& batch2, optional<bool> deterministic_opt) {
