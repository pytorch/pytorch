...
Tensor& addmm_out_cuda_impl(Tensor& result, const Tensor& self, const Tensor& mat1, const Tensor& mat2, Scalar beta, Scalar alpha) {
  ...
  AT_DISPATCH_FLOATING_TYPES(
    result_.scalar_type(), "addmm_cuda", [&] {
      ...
      /*
      std::cout << "mat1_ = " << std::endl;
      std::cout << mat1_ << std::endl;
      std::cout << "mat2_ = " << std::endl;
      std::cout << mat2_ << std::endl;
      std::cout << "result_ = " << std::endl;
      std::cout << result_ << std::endl;
      std::cout << "transpose_mat1 = " << transpose_mat1 << std::endl;
      std::cout << "transpose_mat2 = " << transpose_mat1 << std::endl;
      std::cout << "transpose_result = " << transpose_result << std::endl;
      std::cout << "m = " << m << std::endl;
      std::cout << "n = " << n << std::endl;
      std::cout << "k = " << k << std::endl;
      std::cout << "mat1_ld = " << mat1_ld << std::endl;
      std::cout << "mat2_ld = " << mat2_ld << std::endl;
      std::cout << "result_ld = " << result_ld << std::endl;
      */
