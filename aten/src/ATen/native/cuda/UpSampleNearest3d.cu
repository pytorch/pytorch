...
__global__ void upsample_nearest3d_backward_out_frame(
  ...
  int src_z = nearest_neighbor_bw_compute_source_index(depth_scale, dst_z, src_dim_d+1);
  ...
  // intentionally want to skip in case of scale_factor < 1.0
  int src_y = nearest_neighbor_bw_compute_source_index(height_scale, dst_y, src_dim_h+1);
  ...
  // intentionally want to skip in case of scale_factor < 1.0
  int src_x = nearest_neighbor_bw_compute_source_index(width_scale, dst_x, src_dim_w+1);
