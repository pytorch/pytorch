...
namespace at {
    namespace native {
        namespace {
            const char scaled_modified_bessel_i1_name[] = "scaled_modified_bessel_i1_forward";
            ...
            void scaled_modified_bessel_i1_kernel_cuda(TensorIteratorBase& iterator) {
                ...
                AT_DISPATCH_FLOATING_TYPES(iterator.common_dtype(), "scaled_modified_bessel_i1_cuda", [&]() {
                    gpu_kernel(iterator, []GPU_LAMBDA(scalar_t a) -> scalar_t {
                        return scaled_modified_bessel_i1_forward(a);
                    });
                });
        ...
        REGISTER_DISPATCH(special_scaled_modified_bessel_i1_stub, &scaled_modified_bessel_i1_kernel_cuda);
    } // namespace native
} // namespace at
