...
void cdist_kernel_impl(
  ...
  AT_DISPATCH_FLOATING_TYPES(x1.scalar_type(), "cdist_cuda", [&] {
    if (p == 0.0) {
      cdist_kernel_cuda_impl<scalar_t, dists<scalar_t>::zero>
      ...
      cdist_kernel_cuda_impl<scalar_t, dists<scalar_t>::one>
          <<<grid, block, 0, at::cuda::getCurrentCUDAStream()>>>(
              result.data_ptr<scalar_t>(),
              x1.data_ptr<scalar_t>(),
              x2.data_ptr<scalar_t>(),
      ...
      cdist_kernel_cuda_impl<scalar_t, dists<scalar_t>::two>
          <<<grid, block, 0, at::cuda::getCurrentCUDAStream()>>>(
              result.data_ptr<scalar_t>(),
              x1.data_ptr<scalar_t>(),
              x2.data_ptr<scalar_t>(),
      ...
      cdist_kernel_cuda_impl<scalar_t, dists<scalar_t>::inf>
          <<<grid, block, 0, at::cuda::getCurrentCUDAStream()>>>(
              result.data_ptr<scalar_t>(),
              x1.data_ptr<scalar_t>(),
              x2.data_ptr<scalar_t>(),
      ...
      cdist_kernel_cuda_impl<scalar_t, dists<scalar_t>::p>
          <<<grid, block, 0, at::cuda::getCurrentCUDAStream()>>>(
              result.data_ptr<scalar_t>(),
              x1.data_ptr<scalar_t>(),
              x2.data_ptr<scalar_t>(),
...
void pdist_forward_kernel_impl(Tensor& result, const Tensor& self, double p) {
  ...
  AT_DISPATCH_FLOATING_TYPES(self.scalar_type(), "pdist_cuda", [&] {
    if (p == 0.0) {
      pdist_kernel_cuda_impl<scalar_t, dists<scalar_t>::zero>
          <<<grid, block, 0, at::cuda::getCurrentCUDAStream()>>>(
              result.data_ptr<scalar_t>(),
      ...
      pdist_kernel_cuda_impl<scalar_t, dists<scalar_t>::one>
          <<<grid, block, 0, at::cuda::getCurrentCUDAStream()>>>(
              result.data_ptr<scalar_t>(),
              self.data_ptr<scalar_t>(),
              n,
      ...
      pdist_kernel_cuda_impl<scalar_t, dists<scalar_t>::two>
          <<<grid, block, 0, at::cuda::getCurrentCUDAStream()>>>(
              result.data_ptr<scalar_t>(),
              self.data_ptr<scalar_t>(),
              n,
      ...
      pdist_kernel_cuda_impl<scalar_t, dists<scalar_t>::inf>
          <<<grid, block, 0, at::cuda::getCurrentCUDAStream()>>>(
              result.data_ptr<scalar_t>(),
              self.data_ptr<scalar_t>(),
              n,
      ...
      pdist_kernel_cuda_impl<scalar_t, dists<scalar_t>::p>
          <<<grid, block, 0, at::cuda::getCurrentCUDAStream()>>>(
              result.data_ptr<scalar_t>(),
              self.data_ptr<scalar_t>(),
              n,
...
void pdist_backward_kernel_impl(
  ...
  // NB: be careful with changing block_y; as it's currently written, grid_y is
  // limited to be 2^16. block_y of 64 gives us max pdist dim1 of 2**24
