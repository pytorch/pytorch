      ...
      [&] {
        ...
        gpu_kernel_multiple_outputs(
            ...
            [=] GPU_LAMBDA(
                ...
                scalar_t running_var) -> thrust::tuple<scalar_t, scalar_t> {
...
std::tuple<Tensor&, Tensor&, Tensor&> batch_norm_cuda_out(
    const Tensor& self,
    const c10::optional<Tensor>& weight_opt,
    const c10::optional<Tensor>& bias_opt,
...
std::tuple<Tensor, Tensor, Tensor> batch_norm_cuda(
    const Tensor& self,
    const c10::optional<Tensor>& weight_opt,
    const c10::optional<Tensor>& bias_opt,
    const c10::optional<Tensor>& running_mean_opt,
...
std::tuple<Tensor, Tensor, Tensor> batch_norm_backward_cuda(
  ...
  return AT_DISPATCH_FLOATING_TYPES_AND2(
      ...
      [&] {
        ...
        TORCH_CHECK(
            mean_st == var_st,
            "running_mean and running_var need to have the same data types");
        bool is_half_float =
        ...
        if (cuda::detail::canUse32BitIndexMath(self)) {
          if (is_half_float || is_bfloat16_float) {
            return batch_norm_backward_cuda_template<scalar_t, float, int32_t>(
                grad_out,
                self,
                weight,
                running_mean,
            ...
            return batch_norm_backward_cuda_template<
                scalar_t,
                scalar_t,
                int32_t>(
                grad_out,
          ...
          if (is_half_float || is_bfloat16_float) {
            return batch_norm_backward_cuda_template<scalar_t, float, int64_t>(
                grad_out,
                self,
                weight,
                running_mean,
...
std::tuple<Tensor, Tensor> batch_norm_stats_cuda(
    const Tensor& self,
    double epsilon) {
  auto options = self.options().dtype(
      at::toAccumulateType(self.scalar_type(), /*is_cuda=*/true));
...
Tensor& batch_norm_elemt_cuda_out(
    const Tensor& self,
    const c10::optional<Tensor>& weight_opt,
    const c10::optional<Tensor>& bias_opt,
    const Tensor& mean,
...
std::tuple<Tensor, Tensor> batch_norm_gather_stats_with_counts_cuda(
  ...
  return AT_DISPATCH_FLOATING_TYPES_AND2(
      ...
      [&] {
        ...
        if (cuda::detail::canUse32BitIndexMath(self)) {
          return batch_norm_gather_stats_cuda_template<
              scalar_t,
              accscalar_t,
              int32_t>(
              mean,
...
std::tuple<Tensor, Tensor, Tensor, Tensor> batch_norm_backward_reduce_cuda(
  ...
  if (at::cuda::detail::canUse32BitIndexMath(self) &&
    ...
    return batch_norm_backward_reduce_cuda_channels_last_template(
        self, input, mean, invstd, weight, input_g, weight_g, bias_g);
  }
  ...
  return AT_DISPATCH_FLOATING_TYPES_AND2(
      ...
      [&] {
        ...
        if (cuda::detail::canUse32BitIndexMath(self)) {
          if (is_half_float || is_bfloat16_float) {
            return batch_norm_backward_reduce_cuda_template<
                scalar_t,
                float,
                int32_t>(
                self, input, mean, invstd, weight, input_g, weight_g, bias_g);
...
Tensor batch_norm_backward_elemt_cuda(
  ...
  return AT_DISPATCH_FLOATING_TYPES_AND2(
      ...
      [&] {
        ...
        if (cuda::detail::canUse32BitIndexMath(self)) {
          if (is_half_float || is_bfloat16_float) {
            return batch_norm_backward_elemt_cuda_template<
                scalar_t,
                float,
                int32_t>(
                self, input, mean, invstd, weight, sum_dy, sum_dy_xmu, count);
