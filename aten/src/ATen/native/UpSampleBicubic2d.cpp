...
Tensor upsample_bicubic2d(
  ...
  return at::upsample_bicubic2d(input, output_size, align_corners, scale_factors, false);
}
...
Tensor _upsample_bicubic2d_aa(
    ...
    bool align_corners,
    c10::optional<ArrayRef<double>> scale_factors) {
  return at::_upsample_bicubic2d_aa(input, output_size, align_corners, scale_factors, false);
}
