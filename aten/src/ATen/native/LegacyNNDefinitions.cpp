...
Tensor & adaptive_avg_pool2d_out(Tensor & output, const Tensor & self, IntList output_size) {
  return at::legacy::th::_thnn_adaptive_avg_pool2d_forward_out(output, self, output_size);
}

Tensor adaptive_avg_pool2d(const Tensor & self, IntList output_size) {
  return at::legacy::th::_thnn_adaptive_avg_pool2d_forward(self, output_size);
}
