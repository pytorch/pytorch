...
TORCH_IMPL_FUNC(upsample_nearest2d_out_cpu) (
  ...
  upsample_nearest2d_kernel(kCPU, output, input, scales_h, scales_w, exact);
}
...
TORCH_IMPL_FUNC(upsample_nearest2d_backward_out_cpu) (
  ...
  grad_input.zero_();
  upsample_nearest2d_backward_kernel(kCPU, grad_input, grad_output, scales_h, scales_w, exact);
}
...
Tensor upsample_nearest2d(
  ...
  return at::upsample_nearest2d(input, osize, scale_h, scale_w, exact);
}
...
Tensor upsample_nearest2d_backward(
  ...
  auto scale_h = get_scale_value(scale_factors, 0);
  auto scale_w = get_scale_value(scale_factors, 1);
  return at::upsample_nearest2d_backward(grad_output, osize, input_size, scale_h, scale_w, exact);
}
