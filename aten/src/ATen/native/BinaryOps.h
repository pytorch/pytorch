...
DECLARE_DISPATCH(structured_binary_fn, logical_xor_stub);
DECLARE_DISPATCH(structured_binary_fn, logical_and_stub);
DECLARE_DISPATCH(structured_binary_fn, logical_or_stub);
