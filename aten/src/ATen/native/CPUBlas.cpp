...
#define ONEDNN_UKERNEL_1 \
  (IDEEP_VERSION_MAJOR == 3 && IDEEP_VERSION_MINOR == 5)

#define ONEDNN_UKERNEL_2 \
  (IDEEP_VERSION_MAJOR >= 3 && IDEEP_VERSION_MINOR >= 6)

#define ONEDNN_UKERNEL_ENABLED                               \
  ((ONEDNN_UKERNEL_1 || ONEDNN_UKERNEL_2) && \
   (defined(__x86_64__) || (defined(_M_X64) && !defined(_M_ARM64EC))))
#else
#define ONEDNN_UKERNEL_ENABLED 0
#endif

#if ONEDNN_UKERNEL_ENABLED
