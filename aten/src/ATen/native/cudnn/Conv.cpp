...
// Note [denylist fft algorithms for strided dgrad]
...
// See Note [denylist fft algorithms for strided dgrad]
#if CUDNN_VERSION < 7500
  bool denylist = std::is_same<decltype(perfResults[0].algo), cudnnConvolutionBwdDataAlgo_t>::value;
  int stride_dim = args.input.dim() - 2;
  denylist &= std::any_of(std::begin(args.params.stride),
