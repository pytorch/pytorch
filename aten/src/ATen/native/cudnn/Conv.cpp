...
at::Tensor cudnn_convolution(
    ...
    IntListRef padding, IntListRef stride, IntListRef dilation,
    int64_t groups, bool benchmark, bool deterministic) {
  AT_ERROR("cudnn_convolution: ATen not compiled with cuDNN support");
}

at::Tensor cudnn_convolution_backward_input(
    IntListRef input_size, const at::Tensor& grad_output, const at::Tensor& weight,
    IntListRef padding, IntListRef stride, IntListRef dilation, int64_t groups,
...
at::Tensor cudnn_convolution_backward_weight(
    IntListRef weight_size, const at::Tensor& grad_output, const at::Tensor& input,
    IntListRef padding, IntListRef stride, IntListRef dilation, int64_t groups,
    bool benchmark, bool deterministic) {
...
at::Tensor cudnn_convolution_transpose(
    const at::Tensor& input, const at::Tensor& weight, const at::Tensor& bias /* optional */,
    IntListRef padding, IntListRef output_padding, IntListRef stride, IntListRef dilation,
    int64_t groups, bool benchmark, bool deterministic) {
...
std::tuple<at::Tensor,at::Tensor,at::Tensor> cudnn_convolution_transpose_backward(
    const at::Tensor& input, const at::Tensor& grad_output, const at::Tensor& weight,
    IntListRef padding, IntListRef output_padding, IntListRef stride, IntListRef dilation, int64_t groups,
    bool benchmark, bool deterministic, std::array<bool,3> output_mask) {
  AT_ERROR("cudnn_convolution_transpose_backward: ATen not compiled with cuDNN support");
}
...
static std::vector<int64_t> conv_output_size(
    IntListRef input_size, IntListRef weight_size,
    IntListRef padding, IntListRef stride, IntListRef dilation, int64_t groups
) {
...
std::vector<int64_t> conv_input_size(
    IntListRef output_size, IntListRef weight_size,
    IntListRef padding, IntListRef output_padding, IntListRef stride, IntListRef dilation, int64_t groups
) {
...
std::vector<int64_t> conv_weight_size(
    IntListRef input_size, IntListRef output_size,
    IntListRef padding, IntListRef output_padding, IntListRef stride, IntListRef dilation, int64_t groups
) {
  auto dim = input_size.size();
...
static void check_args(CheckedFrom c, IntListRef args, size_t expected_size, const char* arg_name)
{
...
Tensor cudnn_convolution_backward_input(
    CheckedFrom c,
    IntListRef input_size, const TensorArg& grad_output, const TensorArg& weight,
    IntListRef padding, IntListRef stride, IntListRef dilation, int64_t groups,
    bool benchmark, bool deterministic)
{
...
Tensor cudnn_convolution_backward_input(
    IntListRef input_size, const Tensor& grad_output_t, const Tensor& weight_t,
    IntListRef padding, IntListRef stride, IntListRef dilation, int64_t groups,
    bool benchmark, bool deterministic)
{
  TensorArg grad_output{ grad_output_t, "grad_output", 1 },
...
Tensor cudnn_convolution_backward_weight(
    CheckedFrom c,
    IntListRef weight_size, const TensorArg& grad_output, const TensorArg& input,
    IntListRef padding, IntListRef stride, IntListRef dilation, int64_t groups,
    bool benchmark, bool deterministic)
{
