...
std::tuple<Tensor, Tensor> _cudnn_ctc_loss(const Tensor& log_probs, const Tensor& targets, IntListRef input_lengths, IntListRef target_lengths, int64_t BLANK, bool deterministic) {
...
std::tuple<Tensor, Tensor> _cudnn_ctc_loss(const Tensor& log_probs_t, const Tensor& targets_t, IntListRef input_lengths_, IntListRef target_lengths_, int64_t BLANK, bool deterministic) {
