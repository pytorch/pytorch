...
std::tuple<Tensor, Tensor, Tensor, Tensor, Tensor> _cudnn_rnn(
    ...
    bool fn_train, bool fn_bidirectional, IntListRef fn_batch_sizes,
...
std::tuple<Tensor, Tensor, Tensor, std::vector<Tensor>> _cudnn_rnn_backward(
    ...
    bool train, bool bidirectional, IntListRef batch_sizes,
...
namespace {
  ...
  std::vector<TensorDescriptor> rnn_descriptor_sequence(const Tensor& tensor, IntListRef batch_sizes) {
  ...
  struct TensorDescriptorListParams {
    IntListRef batch_sizes;
    int64_t seq_length;
    int64_t mini_batch;
    // NB: this is not input.size(), which is an IntListRef; instead, this
    ...
    void set(IntListRef input_sizes, IntListRef batch_sizes_, bool batch_first) {
...
std::tuple<Tensor, Tensor, Tensor, Tensor, Tensor> _cudnn_rnn(
  ...
  AT_CHECK(!cx.defined() || cx.sizes().equals(hidden_size),
           "Expected cell size ", IntListRef{hidden_size}, ", got ", cx.sizes());
...
std::tuple<Tensor, Tensor, Tensor> _cudnn_rnn_backward_input(
  ...
  AT_CHECK(input.sizes().equals(input_size),
           "Expected input size ", IntListRef{input_size}, ", got ", input.sizes());
  AT_CHECK(output.sizes().equals(output_size),
           "Expected output size ", IntListRef{output_size}, ", got ", output.sizes());

  AT_CHECK(!hx.defined() || hx.sizes().equals(hidden_size),
           "Expected hidden size ", IntListRef{hidden_size}, ", got ", hx.sizes());
  AT_CHECK(!cx.defined() || cx.sizes().equals(hidden_size),
           "Expected cell size ", IntListRef{hidden_size}, ", got ", cx.sizes());
  AT_CHECK(!dhy.defined() || dhy.sizes().equals(hidden_size),
           "Expected d_hidden size ", IntListRef{hidden_size}, ", got ", dhy.sizes());
  AT_CHECK(!dcy.defined() || dcy.sizes().equals(hidden_size),
           "Expected d_cell size ", IntListRef{hidden_size}, ", got ", dcy.sizes());
...
std::pair<Tensor, hidden_type> _cudnn_impl(
  ...
  IntListRef batch_sizes { _batch_sizes.data<int64_t>(), static_cast<size_t>(_batch_sizes.size(0)) };
