...
C10_METAL_CONSTEXPR uint32_t kGroupedMMGemvMaxRows = 32;
C10_METAL_CONSTEXPR uint32_t kGroupedMMGemvSimdgroups = 16;
C10_METAL_CONSTEXPR uint32_t kGroupedMMGemvLaneChunk = 16;
