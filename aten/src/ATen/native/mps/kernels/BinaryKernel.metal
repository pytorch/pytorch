...
REGISTER_BINARY_SCALAR_OP(add, long, long);
REGISTER_BINARY_SCALAR_OP(add, int, int);
REGISTER_BINARY_SCALAR_OP(add, float, float);
REGISTER_BINARY_SCALAR_OP(add, half, half);
REGISTER_BINARY_SCALAR_OP(add, short, short);
REGISTER_BINARY_SCALAR_OP(add, uchar, uchar);
REGISTER_BINARY_SCALAR_OP(add, char, char);
REGISTER_BINARY_SCALAR_OP(add, bool, bool);
...
REGISTER_BINARY_SCALAR_OP(sub, long, long);
REGISTER_BINARY_SCALAR_OP(sub, int, int);
REGISTER_BINARY_SCALAR_OP(sub, float, float);
REGISTER_BINARY_SCALAR_OP(sub, half, half);
REGISTER_BINARY_SCALAR_OP(sub, short, short);
REGISTER_BINARY_SCALAR_OP(sub, uchar, uchar);
REGISTER_BINARY_SCALAR_OP(sub, char, char);
REGISTER_BINARY_SCALAR_OP(sub, bool, bool);
...
REGISTER_BINARY_SCALAR_ALPHA_OP(add_alpha, long, long);
REGISTER_BINARY_SCALAR_ALPHA_OP(add_alpha, int, int);
REGISTER_BINARY_SCALAR_ALPHA_OP(add_alpha, float, float);
REGISTER_BINARY_SCALAR_ALPHA_OP(add_alpha, half, half);
REGISTER_BINARY_SCALAR_ALPHA_OP(add_alpha, short, short);
REGISTER_BINARY_SCALAR_ALPHA_OP(add_alpha, uchar, uchar);
REGISTER_BINARY_SCALAR_ALPHA_OP(add_alpha, char, char);
REGISTER_BINARY_SCALAR_ALPHA_OP(add_alpha, bool, bool);
...
REGISTER_BINARY_SCALAR_ALPHA_OP(sub_alpha, long, long);
REGISTER_BINARY_SCALAR_ALPHA_OP(sub_alpha, int, int);
REGISTER_BINARY_SCALAR_ALPHA_OP(sub_alpha, float, float);
REGISTER_BINARY_SCALAR_ALPHA_OP(sub_alpha, half, half);
REGISTER_BINARY_SCALAR_ALPHA_OP(sub_alpha, short, short);
REGISTER_BINARY_SCALAR_ALPHA_OP(sub_alpha, uchar, uchar);
REGISTER_BINARY_SCALAR_ALPHA_OP(sub_alpha, char, char);
REGISTER_BINARY_SCALAR_ALPHA_OP(sub_alpha, bool, bool);
...
REGISTER_BINARY_SCALAR_ALPHA_OP(lerp_alpha, long, long);
REGISTER_BINARY_SCALAR_ALPHA_OP(lerp_alpha, int, int);
REGISTER_BINARY_SCALAR_ALPHA_OP(lerp_alpha, float, float);
REGISTER_BINARY_SCALAR_ALPHA_OP(lerp_alpha, half, half);
REGISTER_BINARY_SCALAR_ALPHA_OP(lerp_alpha, short, short);
REGISTER_BINARY_SCALAR_ALPHA_OP(lerp_alpha, uchar, uchar);
REGISTER_BINARY_SCALAR_ALPHA_OP(lerp_alpha, char, char);
REGISTER_BINARY_SCALAR_ALPHA_OP(lerp_alpha, bool, bool);
...
REGISTER_BINARY_SCALAR_OP(hermite_polynomial_he, bfloat, bfloat);
REGISTER_BINARY_SCALAR_OP(add, bfloat, bfloat);
REGISTER_BINARY_SCALAR_OP(sub, bfloat, bfloat);
REGISTER_BINARY_SCALAR_ALPHA_OP(add_alpha, bfloat, bfloat);
REGISTER_BINARY_SCALAR_ALPHA_OP(sub_alpha, bfloat, bfloat);
REGISTER_BINARY_SCALAR_ALPHA_OP(lerp_alpha, bfloat, bfloat);
#endif
...
REGISTER_BINARY_SCALAR_ALPHA_OP(add_alpha, float2, float2);
REGISTER_BINARY_SCALAR_ALPHA_OP(add_alpha, half2, half2);
REGISTER_BINARY_SCALAR_ALPHA_OP(sub_alpha, float2, float2);
REGISTER_BINARY_SCALAR_ALPHA_OP(sub_alpha, half2, half2);
REGISTER_BINARY_SCALAR_ALPHA_OP(lerp_alpha, float2, float2);
REGISTER_BINARY_SCALAR_ALPHA_OP(lerp_alpha, half2, half2);
