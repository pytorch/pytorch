...
REGISTER_ARCH_DISPATCH(avg_pool3d_kernel, DEFAULT, &avg_pool3d_kernel_impl);
...
// Register the kernel implementation
REGISTER_ARCH_DISPATCH(avg_pool3d_backward_kernel, DEFAULT, &avg_pool3d_backward_kernel_impl);
} // anonymous namespace
