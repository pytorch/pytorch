...
static void addc_mul_div_out_mps(const Tensor& self,
  ...
  @autoreleasepool {
    ...
    Placeholder tensor2Placeholder = Placeholder(cachedGraph->secondTensor, tensor2, nil, executeGatherOpOnSecondTensor);
    Placeholder outputPlaceholder = Placeholder(cachedGraph->outputTensor, executeGatherOpOnSelf ? output_ : output, nil, false);
