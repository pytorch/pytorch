...
Tensor& _fft_r2c_mps(int64_t n, Tensor& result) {
  // the default value of `m` equals to `n`
  return _fft_r2c_mps(n, n, result);
}

using namespace mps;

Tensor& _fft_r2c_mps(int64_t n, int64_t m, Tensor& result) {
  ...
  @autoreleasepool {
    ...
    string key = "_fft_r2c_mps:" + getTensorsStringKey({result});
