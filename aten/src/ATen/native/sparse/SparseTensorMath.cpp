...
Tensor _sparse_sum(const SparseTensor& input, IntListRef dims_to_sum, ScalarType dtype) {
  return at::_sparse_sum(input.to(dtype), dims_to_sum);
}

Tensor _sparse_sum(const SparseTensor& input, IntListRef dims_to_sum) {
...
// --------------------------------------------------------------------
Tensor _sparse_sum_backward_cpu(const Tensor& grad_, const SparseTensor& input_, IntListRef dims_to_sum) {
  ...
  IntListRef input_sizes = input.sizes();
