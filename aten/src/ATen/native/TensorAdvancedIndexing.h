...
using index_put_accum_fn = void(*)(Tensor &, torch::List<c10::optional<Tensor>> , const Tensor &, bool unsafe);
...
TORCH_API Tensor& index_out(Tensor& result, const Tensor & self, c10::List<c10::optional<at::Tensor>> indices);
