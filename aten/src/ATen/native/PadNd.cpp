...
Tensor constant_pad_nd(
  ...
  if (self.is_quantized()) {
    ...
    TORCH_CHECK(
        qscheme == kPerTensorAffine || qscheme == kPerTensorSymmetric,
...
Tensor _pad_enum(
  ...
  if (pad.size() == 2 && (input_dim == 2 || input_dim == 3)) {
    switch (mode) {
      case at::padding_mode::reflect:
        return at::reflection_pad1d(self, pad);
      case at::padding_mode::replicate:
        return at::replication_pad1d(self, pad);
      case at::padding_mode::circular:
        return at::_pad_circular(self, pad);
      default: {
      }
    }
    ...
    switch (mode) {
      case at::padding_mode::reflect:
        return at::reflection_pad2d(self, pad);
      case at::padding_mode::replicate:
        return at::replication_pad2d(self, pad);
      case at::padding_mode::circular:
        return at::_pad_circular(self, pad);
      default: {
      }
    ...
    switch (mode) {
      case at::padding_mode::reflect:
        return at::reflection_pad3d(self, pad);
      case at::padding_mode::replicate:
        return at::replication_pad3d(self, pad);
      case at::padding_mode::circular:
        return at::_pad_circular(self, pad);
      default: {
      }
...
Tensor pad(
  ...
  const auto mode_enum = [&] {
    ...
    C10_THROW_ERROR(
        NotImplementedError, c10::str("Unrecognised padding mode ", mode));
  }();
  return at::native::_pad_enum(
      self, pad, static_cast<int64_t>(mode_enum), value);
}
