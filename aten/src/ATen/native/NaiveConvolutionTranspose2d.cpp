...
void naive_conv_transpose2d_out_cpu_template(
    Tensor& output,
    const Tensor& input_,
  ...
  AT_DISPATCH_FLOATING_TYPES_AND(at::ScalarType::Long,
      input.scalar_type(), "naive_conv_transpose2d_out_cpu", [&] {
...
static void naive_conv_transpose2d_backward_out_cpu_template(
    const Tensor& input_,
  ...
  AT_DISPATCH_FLOATING_TYPES(
      grad_output.scalar_type(), "naive_conv_transpose2d_backward_out_cpu", [&] {
        // Helpers
...
void naive_conv_transpose2d_acc_grad_parameters_cpu(
    const Tensor& input_,
    const Tensor& grad_output_,
    Tensor& grad_weight,
    Tensor& grad_bias,
  ...
  AT_DISPATCH_FLOATING_TYPES(
      input.scalar_type(), "naive_conv_transpose2d_acc_grad_parameters_cpu", [&] {
        // Helpers
...
Tensor& naive_conv_transpose2d_out_cpu(
    Tensor& output,
    const Tensor& input,
    const Tensor& weight,
    IntArrayRef kernel_size,
  ...
  naive_conv_transpose2d_out_cpu_template(
      output,
      input,
      weight,
      kernel_size,
...
Tensor naive_conv_transpose2d_cpu(
    const Tensor& input,
    const Tensor& weight,
    IntArrayRef kernel_size,
    const Tensor& bias,
...
std::tuple<Tensor&, Tensor&, Tensor&> naive_conv_transpose2d_backward_out_cpu(
    Tensor& grad_input,
    Tensor& grad_weight,
    Tensor& grad_bias,
    const Tensor& grad_output,
  ...
  if (grad_input.defined()) {
    naive_conv_transpose2d_backward_out_cpu_template(
        input,
        grad_output,
        grad_input,
        weight,
  ...
  if (grad_weight.defined() || grad_bias.defined()) {
    naive_conv_transpose2d_acc_grad_parameters_cpu(
        input,
        grad_output,
        grad_weight,
        grad_bias,
...
std::tuple<Tensor, Tensor, Tensor> naive_conv_transpose2d_backward_cpu(
    const Tensor& grad_output,
    const Tensor& input,
    const Tensor& weight,
    IntArrayRef kernel_size,
