...
Tensor& special_beta_out                                    (const Scalar &b,   const Tensor &a, Tensor &out) { return at::special_beta_out                                   (out, wrapped_scalar_tensor(b), a);                           }
Tensor& special_beta_out                                    (const Tensor &b,   const Scalar &a, Tensor &out) { return at::special_beta_out                                   (out, b,                        wrapped_scalar_tensor(a));    }
...
Tensor& special_binomial_coefficient_out                    (const Scalar &n,   const Tensor &m, Tensor &out) { return at::special_binomial_coefficient_out                   (out, wrapped_scalar_tensor(n), m);                           }
Tensor& special_binomial_coefficient_out                    (const Tensor &n,   const Scalar &m, Tensor &out) { return at::special_binomial_coefficient_out                   (out, n,                        wrapped_scalar_tensor(m));    }
...
Tensor& special_falling_factorial_out                       (const Scalar &n,   const Tensor &x, Tensor &out) { return at::special_falling_factorial_out                      (out, wrapped_scalar_tensor(n), x);                           }
Tensor& special_falling_factorial_out                       (const Tensor &n,   const Scalar &x, Tensor &out) { return at::special_falling_factorial_out                      (out, n,                        wrapped_scalar_tensor(x));    }
...
Tensor& special_ln_binomial_coefficient_out                 (const Scalar &n,   const Tensor &m, Tensor &out) { return at::special_ln_binomial_coefficient_out                (out, wrapped_scalar_tensor(n), m);                           }
Tensor& special_ln_binomial_coefficient_out                 (const Tensor &n,   const Scalar &m, Tensor &out) { return at::special_ln_binomial_coefficient_out                (out, n,                        wrapped_scalar_tensor(m));    }
...
Tensor& special_ln_falling_factorial_out                    (const Scalar &n,   const Tensor &x, Tensor &out) { return at::special_ln_falling_factorial_out                   (out, wrapped_scalar_tensor(n), x);                           }
Tensor& special_ln_falling_factorial_out                    (const Tensor &n,   const Scalar &x, Tensor &out) { return at::special_ln_falling_factorial_out                   (out, n,                        wrapped_scalar_tensor(x));    }
...
Tensor& special_ln_rising_factorial_out                     (const Scalar &n,   const Tensor &x, Tensor &out) { return at::special_ln_rising_factorial_out                    (out, wrapped_scalar_tensor(n), x);                           }
Tensor& special_ln_rising_factorial_out                     (const Tensor &n,   const Scalar &x, Tensor &out) { return at::special_ln_rising_factorial_out                    (out, n,                        wrapped_scalar_tensor(x));    }
...
Tensor& special_lower_incomplete_gamma_out                  (const Scalar &z,   const Tensor &a, Tensor &out) { return at::special_lower_incomplete_gamma_out                 (out, wrapped_scalar_tensor(z), a);                           }
Tensor& special_lower_incomplete_gamma_out                  (const Tensor &z,   const Scalar &a, Tensor &out) { return at::special_lower_incomplete_gamma_out                 (out, z,                        wrapped_scalar_tensor(a));    }
...
Tensor& special_rising_factorial_out                        (const Scalar &n,   const Tensor &x, Tensor &out) { return at::special_rising_factorial_out                       (out, wrapped_scalar_tensor(n), x);                           }
Tensor& special_rising_factorial_out                        (const Tensor &n,   const Scalar &x, Tensor &out) { return at::special_rising_factorial_out                       (out, n,                        wrapped_scalar_tensor(x));    }
...
Tensor& special_bulirsch_elliptic_integral_el1_out          (const Scalar &k_c, const Tensor &x, Tensor &out) { return at::special_bulirsch_elliptic_integral_el1_out         (out, wrapped_scalar_tensor(k_c), x);                         }
Tensor& special_bulirsch_elliptic_integral_el1_out          (const Tensor &k_c, const Scalar &x, Tensor &out) { return at::special_bulirsch_elliptic_integral_el1_out         (out, k_c,                        wrapped_scalar_tensor(x));  }
...
Tensor& special_carlson_elliptic_r_c_out                    (const Scalar &y,   const Tensor &x, Tensor &out) { return at::special_carlson_elliptic_r_c_out                   (out, wrapped_scalar_tensor(y), x);                           }
Tensor& special_carlson_elliptic_r_c_out                    (const Tensor &y,   const Scalar &x, Tensor &out) { return at::special_carlson_elliptic_r_c_out                   (out, y,                        wrapped_scalar_tensor(x));    }
...
Tensor& special_complete_carlson_elliptic_r_f_out           (const Scalar &y,   const Tensor &x, Tensor &out) { return at::special_complete_carlson_elliptic_r_f_out          (out, wrapped_scalar_tensor(y), x);                           }
Tensor& special_complete_carlson_elliptic_r_f_out           (const Tensor &y,   const Scalar &x, Tensor &out) { return at::special_complete_carlson_elliptic_r_f_out          (out, y,                        wrapped_scalar_tensor(x));    }
...
Tensor& special_complete_carlson_elliptic_r_g_out           (const Scalar &y,   const Tensor &x, Tensor &out) { return at::special_complete_carlson_elliptic_r_g_out          (out, wrapped_scalar_tensor(y), x);                           }
Tensor& special_complete_carlson_elliptic_r_g_out           (const Tensor &y,   const Scalar &x, Tensor &out) { return at::special_complete_carlson_elliptic_r_g_out          (out, y,                        wrapped_scalar_tensor(x));    }
...
Tensor& special_complete_legendre_elliptic_integral_pi_out  (const Scalar &k,   const Tensor &n, Tensor &out) { return at::special_complete_legendre_elliptic_integral_pi_out (out, wrapped_scalar_tensor(k), n);                           }
Tensor& special_complete_legendre_elliptic_integral_pi_out  (const Tensor &k,   const Scalar &n, Tensor &out) { return at::special_complete_legendre_elliptic_integral_pi_out (out, k,                        wrapped_scalar_tensor(n));    }
...
Tensor& special_incomplete_legendre_elliptic_integral_d_out (const Scalar &phi, const Tensor &k, Tensor &out) { return at::special_incomplete_legendre_elliptic_integral_d_out (out, wrapped_scalar_tensor(phi), k);                        }
Tensor& special_incomplete_legendre_elliptic_integral_d_out (const Tensor &phi, const Scalar &k, Tensor &out) { return at::special_incomplete_legendre_elliptic_integral_d_out (out, phi,                        wrapped_scalar_tensor(k)); }
...
Tensor& special_incomplete_legendre_elliptic_integral_e_out (const Scalar &phi, const Tensor &k, Tensor &out) { return at::special_incomplete_legendre_elliptic_integral_e_out (out, wrapped_scalar_tensor(phi), k);                        }
Tensor& special_incomplete_legendre_elliptic_integral_e_out (const Tensor &phi, const Scalar &k, Tensor &out) { return at::special_incomplete_legendre_elliptic_integral_e_out (out, phi,                        wrapped_scalar_tensor(k)); }
...
Tensor& special_incomplete_legendre_elliptic_integral_f_out (const Scalar &phi, const Tensor &k, Tensor &out) { return at::special_incomplete_legendre_elliptic_integral_f_out (out, wrapped_scalar_tensor(phi), k);                        }
Tensor& special_incomplete_legendre_elliptic_integral_f_out (const Tensor &phi, const Scalar &k, Tensor &out) { return at::special_incomplete_legendre_elliptic_integral_f_out (out, phi,                        wrapped_scalar_tensor(k)); }
...
Tensor& special_upper_incomplete_gamma_out                  (const Scalar &z,   const Tensor &a, Tensor &out) { return at::special_upper_incomplete_gamma_out                  (out, wrapped_scalar_tensor(z), a);                          }
Tensor& special_upper_incomplete_gamma_out                  (const Tensor &z,   const Scalar &a, Tensor &out) { return at::special_upper_incomplete_gamma_out                  (out, z,                        wrapped_scalar_tensor(a));   }
} // namespace native
} // namespace at
