...
Tensor _cudnn_rnn_flatten_weight(
  ...
  throw std::runtime_error("_cudnn_rnn_flatten_weight: ATen not compiled with MIOpen support");
}
...
std::tuple<Tensor, Tensor, Tensor, Tensor, Tensor> _cudnn_rnn(
  ...
  throw std::runtime_error("_cudnn_rnn: ATen not compiled with MIOpen support");
}
...
std::tuple<Tensor, Tensor, Tensor, std::vector<Tensor>> _cudnn_rnn_backward(
  ...
  throw std::runtime_error("_cudnn_rnn_backward: ATen not compiled with MIOpen support");
}

Tensor _cudnn_init_dropout_state(const Type& ty, double dropout, bool train, int64_t dropout_seed) {
  throw std::runtime_error("_cudnn_init_dropout_state: ATen not compiled with MIOpen support");
}
