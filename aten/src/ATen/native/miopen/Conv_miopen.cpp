...
miopen_convolution_transpose_backward(
  ...
  if (output_mask[0]) {
    grad_input = at::miopen_convolution_transpose_backward_input(
        grad_output,
        weight,
        padding,
        stride,
  ...
  if (output_mask[1]) {
    grad_weight = at::miopen_convolution_transpose_backward_weight(
        weight.sizes(),
        grad_output,
        input,
        padding,
...
std::tuple<at::Tensor, at::Tensor, at::Tensor> miopen_convolution_backward(
  ...
  Tensor grad_input, grad_weight, grad_bias;
  if (output_mask[0]) {
    grad_input = at::miopen_convolution_backward_input(
        input.sizes(),
        grad_output,
        weight,
        padding,
  ...
  if (output_mask[1]) {
    grad_weight = at::miopen_convolution_backward_weight(
        weight.sizes(),
        grad_output,
        input,
        padding,
...
miopen_depthwise_convolution_backward(
  ...
  Tensor grad_input, grad_weight, grad_bias;
  if (output_mask[0]) {
    grad_input = at::miopen_depthwise_convolution_backward_input(
        input.sizes(),
        grad_output,
        weight,
        padding,
  ...
  if (output_mask[1]) {
    grad_weight = at::miopen_depthwise_convolution_backward_weight(
        weight.sizes(),
        grad_output,
        input,
        padding,
...
Tensor miopen_convolution_backward_bias(const Tensor& grad_output_t) {
  ...
  TensorDescriptor bdesc{
      grad_bias->expand({1, grad_bias->size(0)}),
  ...
  MIOPEN_CHECK(miopenConvolutionBackwardBias(
      handle,
      &one,
      odesc.desc(),
      grad_output->data_ptr(),
