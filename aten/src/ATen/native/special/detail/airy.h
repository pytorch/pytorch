  ...
  if (std::isnan(z)) {
    ...
    if (z > T1(0)) {
      ...
      if (exp) {
        ...
        const auto bi_derivative = +z * (modified_bessel_2_3_k / pi_v + modified_bessel_2_3_i_sqrt3_v_2) / exp_2_abs_z_sqrt_abs_z_3;

        const auto ai = sqrt_abs_z * modified_bessel_1_3_k / sqrt3_v_pi_v * exp_2_abs_z_sqrt_abs_z_3;
        const auto bi = sqrt_abs_z * (modified_bessel_1_3_k_pi_v + T1(2) * modified_bessel_1_3_i / sqrt3_v) / exp_2_abs_z_sqrt_abs_z_3;
      ...
      const auto bessel_1_3 = bessel(T1(1) / T1(3), abs_z_2_sqrt_abs_z_3);
      const auto bessel_2_3 = bessel(T1(2) / T1(3), abs_z_2_sqrt_abs_z_3);
