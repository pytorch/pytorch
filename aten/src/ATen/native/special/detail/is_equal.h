...
#include <ATen/native/special/detail/max_abs.h>
...
inline constexpr
bool
is_equal(const c10::complex<T1> &a, const c10::complex<T1> &b, T1 m = T1(1))
noexcept {
...
inline constexpr
bool
is_equal(const c10::complex<T1> &a, T1 b, T1 m = T1(1))
noexcept {
...
inline constexpr
bool
is_equal(const T1 a, c10::complex<T1> &b, T1 m = T1(1))
noexcept {
