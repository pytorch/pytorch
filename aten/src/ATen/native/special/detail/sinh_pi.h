...
sinh_pi(c10::complex<T1> z) {
  ...
  const auto cosh_pi_real_z_sin_pi_imag_z = cosh_pi_real_z * sin_pi_imag_z;
  const auto sinh_pi_real_z_cos_pi_imag_z = sinh_pi_real_z * cos_pi_imag_z;

  return sinh_pi_real_z_cos_pi_imag_z + c10::complex<T1>(0, 1) * cosh_pi_real_z_sin_pi_imag_z;
}
}
}
}
