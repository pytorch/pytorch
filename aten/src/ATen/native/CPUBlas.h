...
void gemm_batched(
    ...
    int64_t k,
    scalar_t alpha,
    const scalar_t* const* a,
    int64_t lda,
    const scalar_t* const* b,
    int64_t ldb,
    const scalar_t beta,
    scalar_t* const* c,
    int64_t ldc);
...
void axpy(
  ...
  axpy_stub(
      kCPU, c10::CppTypeToScalarType<scalar_t>::value, n, a, x, incx, y, incy);
}
...
void copy(
  ...
  copy_stub(
      kCPU, c10::CppTypeToScalarType<scalar_t>::value, n, x, incx, y, incy);
}
