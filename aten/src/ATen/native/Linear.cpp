...
static Tensor sumproduct_pair(const Tensor& left_, const Tensor& right_, IntListRef sum_dims_, bool keepdim) {
...
Tensor _trilinear(const Tensor& i1_, const Tensor& i2_, const Tensor& i3_,
		  IntListRef expand1_, IntListRef expand2_, IntListRef expand3_,
		  IntListRef sumdim_, int64_t unroll_dim) {
...
Tensor tensordot(const Tensor& input1, const Tensor& input2, IntListRef dims1, IntListRef dims2) {
