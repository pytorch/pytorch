...
Tensor index_put(const Tensor & self, TensorList indices, const Tensor & value, bool accumulate) {
  return self.clone(MemoryFormat::Contiguous).index_put_(indices, value, accumulate);
}
...
Tensor index_copy(const Tensor & self, int64_t dim, const Tensor & index, const Tensor & source) {
  return self.clone(MemoryFormat::Contiguous).index_copy_(dim, index, source);
}

Tensor index_add(const Tensor & self, int64_t dim, const Tensor & index, const Tensor & source) {
  return self.clone(MemoryFormat::Contiguous).index_add_(dim, index, source);
}

Tensor index_fill(const Tensor & self, int64_t dim, const Tensor & index, Scalar source) {
  return self.clone(MemoryFormat::Contiguous).index_fill_(dim, index, source);
}
...
Tensor scatter(const Tensor & self, int64_t dim, const Tensor & index, const Tensor & source) {
  return self.clone(MemoryFormat::Contiguous).scatter_(dim, index, source);
}
...
Tensor scatter_add(const Tensor & self, int64_t dim, const Tensor & index, const Tensor & source) {
  return self.clone(MemoryFormat::Contiguous).scatter_add_(dim, index, source);
}
