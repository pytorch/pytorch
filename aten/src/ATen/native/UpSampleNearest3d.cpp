...
TORCH_META_FUNC(upsample_nearest_exact3d) (
  const Tensor& input,
  IntArrayRef output_size,
  c10::optional<double> scales_d,
  c10::optional<double> scales_h,
...
TORCH_META_FUNC(upsample_nearest_exact3d_backward) (
  const Tensor& grad_output,
  IntArrayRef output_size,
  IntArrayRef input_size,
  c10::optional<double> scales_d,
...
TORCH_IMPL_FUNC(upsample_nearest_exact3d_out_cpu) (
    const Tensor& input,
    IntArrayRef output_size,
    c10::optional<double> scales_d,
    c10::optional<double> scales_h,
  ...
  upsample_nearest_exact3d_kernel(kCPU, output, input, scales_d, scales_h, scales_w);
}
...
TORCH_IMPL_FUNC(upsample_nearest_exact3d_backward_out_cpu) (
    const Tensor& grad_output,
    IntArrayRef output_size,
    IntArrayRef input_size,
    c10::optional<double> scales_d,
    ...
    const Tensor& grad_input) {
  grad_input.zero_();
  upsample_nearest_exact3d_backward_kernel(kCPU, grad_input, grad_output, scales_d, scales_h, scales_w);
}
...
Tensor upsample_nearest_exact3d_cpu(
    const Tensor& input,
    c10::optional<IntArrayRef> output_size,
    c10::optional<ArrayRef<double>> scale_factors) {
  auto osize = compute_output_size(input.sizes(), output_size, scale_factors);
...
Tensor upsample_nearest_exact3d_backward_cpu(
    const Tensor& grad_output,
    c10::optional<IntArrayRef> output_size,
    IntArrayRef input_size,
    c10::optional<ArrayRef<double>> scale_factors) {
...
DEFINE_DISPATCH(upsample_nearest_exact3d_kernel);
DEFINE_DISPATCH(upsample_nearest3d_backward_kernel);
DEFINE_DISPATCH(upsample_nearest_exact3d_backward_kernel);
