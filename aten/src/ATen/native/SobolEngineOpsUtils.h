...
/// Function to return the minimum of number of bits to represent the integer
/// `n`
...
/// Function to get the position of the rightmost zero in the bit representation
/// of an integer This value is the zero-indexed position
...
/// Function to get a subsequence of bits in the representation of an integer
/// starting from `pos` and of length `length`
inline int64_t bitsubseq(
    const int64_t n,
    const int64_t pos,
...
/// Function to perform the inner product between a batched square matrix and a
/// power of 2 vector
