...
// symmetric padding
DECLARE_DISPATCH(padding_fn, symmetric_pad1d_kernel)
DECLARE_DISPATCH(padding_fn, symmetric_pad1d_backward_kernel)
DECLARE_DISPATCH(padding_fn, symmetric_pad2d_kernel)
DECLARE_DISPATCH(padding_fn, symmetric_pad2d_backward_kernel)
DECLARE_DISPATCH(padding_fn, symmetric_pad3d_kernel)
DECLARE_DISPATCH(padding_fn, symmetric_pad3d_backward_kernel)
