...
at::Tensor convolution(
  ...
  std::cout<<"aten/src/ATen/native/Convolution.cpp 1180 "<<ctx.allowTF32CuDNN()<<"\n";
...
ConvBackend select_conv_backend(
  ...
  std::cout<<"aten/src/ATen/native/Convolution.cpp 1327 "<<params.allow_tf32<<"\n";
    ...
    bool benchmark, bool deterministic, bool cudnn_enabled)
{
  ...
  std::cout<<"aten/src/ATen/native/Convolution.cpp 1713 "<<at::globalContext().allowTF32CuDNN()<<"\n";
...
std::tuple<Tensor, Tensor, Tensor> convolution_backward(
  ...
  params.cudnn_enabled = ctx.userEnabledCuDNN();
  params.allow_tf32 = ctx.allowTF32CuDNN();
  std::cout<<"aten/src/ATen/native/Convolution.cpp 2011 "<<params.allow_tf32<<"\n";
