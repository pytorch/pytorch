...
Tensor& mul_(Tensor& self, const Tensor& other) {
  return native::mul_out(self, other, self);
}
...
Tensor& sub_out(const Tensor& self, const Tensor& other, const Scalar& alpha, Tensor& result) {
...
Tensor& sub_(Tensor& self, const Tensor& other, const Scalar& alpha) {
  return native::sub_out(self, other, alpha, self);
}
