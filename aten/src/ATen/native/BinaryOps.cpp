...
Tensor& lt_out(const Tensor& self, const Tensor& other, Tensor& result) {
...
Tensor& lt_out(const Tensor& self, const Scalar& other, Tensor& result) {
...
Tensor& le_out(const Tensor& self, const Tensor& other, Tensor& result) {
...
Tensor& le_out(const Tensor& self, const Scalar& other, Tensor& result) {
  return comparison_op_out(
...
Tensor& gt_out(const Tensor& self, const Tensor& other, Tensor& result) {
...
Tensor& gt_out(const Tensor& self, const Scalar& other, Tensor& result) {
  return comparison_op_out(
...
Tensor& ge_out(const Tensor& self, const Tensor& other, Tensor& result) {
...
Tensor& ge_out(const Tensor& self, const Scalar& other, Tensor& result) {
  return comparison_op_out(
...
Tensor& eq_out(const Tensor& self, const Tensor& other, Tensor& result) {
...
Tensor& eq_out(const Tensor& self, const Scalar& other, Tensor& result) {
  return comparison_op_out(
...
Tensor& ne_out(const Tensor& self, const Tensor& other, Tensor& result) {
...
Tensor& ne_out(const Tensor& self, const Scalar& other, Tensor& result) {
  return comparison_op_out(
...
Tensor& heaviside_out(
    const Tensor& self,
    const Tensor& values,
    Tensor& result) {
  TORCH_CHECK(
      !self.is_complex() && !result.is_complex() && !values.is_complex(),
      "heaviside is not yet implemented for complex tensors.");
  TORCH_CHECK(
      self.dtype() == values.dtype() && result.dtype() == self.dtype(),
