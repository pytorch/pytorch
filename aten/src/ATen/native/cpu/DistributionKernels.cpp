...
// these kernels are slower with AVX512
REGISTER_NO_AVX512_DISPATCH(uniform_stub);
REGISTER_NO_AVX512_DISPATCH(random_from_to_stub);
REGISTER_NO_AVX512_DISPATCH(random_full_64_bits_range_stub);
REGISTER_NO_AVX512_DISPATCH(random_stub);
#else
