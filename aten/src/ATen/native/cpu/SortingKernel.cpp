  ...
  _dim_apply(
      ...
      [&](auto* values,
        ...
        auto composite_accessor = CompositeRandomAccessorCPU<
            ...
            decltype(indices_accessor)>(values_accessor, indices_accessor);
        ...
        if (largest) {
          std::partial_sort(
              ...
              [](const elem_t& x, const elem_t& y) -> bool {
                return (
                    (_isnan<scalar_t>(x.first) && !_isnan<scalar_t>(y.first)) ||
                    (x.first > y.first));
              });
        } else {
          std::partial_sort(
        ...
        if (largest) {
          ...
          if (sorted) {
            std::sort(
                ...
                [](const elem_t& x, const elem_t& y) -> bool {
                  return (
                      (_isnan<scalar_t>(x.first) &&
                       !_isnan<scalar_t>(y.first)) ||
                      (x.first > y.first));
                });
          }
        } else {
