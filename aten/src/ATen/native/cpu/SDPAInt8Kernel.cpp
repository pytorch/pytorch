...
// template <typename scalar_t>
// inline void do_transpose_with_pad(
//     scalar_t* src,
//     scalar_t* dst,
//     int rows,
//     int cols,
...
//   auto prsize = prows - rows;
//   auto pcsize = pcols - cols;
//   int c = 0;
//   for (; c < cols; c++) {
...
//     if (prsize > 0) {
//       int r = 0;
//       for (; r < prsize - (prsize % vec_size); r += vec_size) {
//         pad.store(dst + c * ldo + rows + r);
//       }
//       if (r < prsize) {
//         pad.store(dst + c * ldo + rows + r, prsize - r);
//       }
//     }
//   }
//   if (pcsize > 0) {
//     for (; c < pcols; c++) {
//       int r = 0;
//       for (; r < prows - (prows % vec_size); r += vec_size) {
//         pad.store(dst + c * ldo + r);
//       }
//       if (r < prows) {
//         pad.store(dst + c * ldo + r, prows - r);
//       }
//     }
//   }
// }
