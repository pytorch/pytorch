...
void direct_copy_kernel(TensorIteratorBase &iter) {
  ...
  if (isQIntType(dtype)) {
    ...
    AT_DISPATCH_ALL_TYPES_AND_COMPLEX_AND5(
        kBool, kHalf, kBFloat16, kFloat8_e5m2, kFloat8_e4m3, dtype, "copy_kernel", [&] {
      cpu_kernel_vec(
          iter,
          [=](scalar_t a) -> scalar_t { return a; },
          [=](Vectorized<scalar_t> a) -> Vectorized<scalar_t> { return a; });
...
void copy_kernel(TensorIterator& iter, bool /*non_blocking*/) {
  ...
  if (dtype == iter.dtype(1)) {
    ...
    AT_DISPATCH_ALL_TYPES_AND_COMPLEX_AND6(ScalarType::ComplexHalf, ScalarType::Half, ScalarType::Bool, ScalarType::BFloat16, ScalarType::Float8_e5m2, ScalarType::Float8_e4m3, dtype, "copy_", [&] {
      using dest_t = scalar_t;
      AT_DISPATCH_ALL_TYPES_AND_COMPLEX_AND6(ScalarType::ComplexHalf, ScalarType::Half, ScalarType::Bool, ScalarType::BFloat16, ScalarType::Float8_e5m2, ScalarType::Float8_e4m3, iter.dtype(1), "copy_", [&] {
