            ...
            static void scaled_modified_bessel_i1_kernel(TensorIteratorBase& iterator) {
                ...
                AT_DISPATCH_FLOATING_TYPES(iterator.common_dtype(), "scaled_modified_bessel_i1_cpu", [&]() {
                    cpu_kernel(iterator, [](scalar_t x) {
                        return scaled_modified_bessel_i1_forward(x);
                    });
                });
            } // scaled_modified_bessel_i1_kernel(TensorIteratorBase& iterator)
        } // namespace CPU_CAPABILITY

        REGISTER_DISPATCH(special_scaled_modified_bessel_i1_stub, &CPU_CAPABILITY::scaled_modified_bessel_i1_kernel);
    } // namespace native
} // namespace at
