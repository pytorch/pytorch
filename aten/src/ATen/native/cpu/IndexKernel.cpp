...
struct Indexer {
  Indexer(int64_t num_indexers, char** indexers, const int64_t* indexer_strides,
          IntListRef original_sizes, IntListRef original_strides)
...
void cpu_index_kernel(TensorIterator& iter, IntListRef index_size, IntListRef index_stride,
...
void index_kernel(TensorIterator& iter, IntListRef index_size, IntListRef index_stride) {
...
void index_put_kernel(TensorIterator& iter, IntListRef index_size, IntListRef index_stride, bool accumulate) {
