...
void index_put_kernel(TensorIterator& iter, IntArrayRef index_size, IntArrayRef index_stride, bool accumulate) {
  ...
  AT_DISPATCH_ALL_TYPES_AND_COMPLEX_AND4(kComplexHalf, ScalarType::Half, ScalarType::Bool, ScalarType::BFloat16,
...
void masked_fill_kernel(TensorIterator& iter, const Scalar& value) {
  AT_DISPATCH_ALL_TYPES_AND_COMPLEX_AND4(kComplexHalf, ScalarType::Bool, ScalarType::BFloat16, ScalarType::Half,
