...
void cpu_adaptive_max_pool2d_channels_last(
    const Tensor& output_,
    const Tensor& indices_,
    const Tensor& input_,
    IntArrayRef output_size) {
...
template <>
void cpu_adaptive_max_pool2d_channels_last<BFloat16>(
    const Tensor& output_,
    const Tensor& indices_,
    const Tensor& input_,
    IntArrayRef output_size) {
    ...
    case at::MemoryFormat::Contiguous: {
      AT_DISPATCH_FLOATING_TYPES_AND(ScalarType::BFloat16, input.scalar_type(), "adaptive_max_pool2d", [&] {
        if (input.scalar_type() == ScalarType::BFloat16) {
          cpu_adaptive_max_pool2d<BFloat16, /*accscalar_t*/float>(output, indices, input, output_size);
        } else {
          cpu_adaptive_max_pool2d<scalar_t, scalar_t>(output, indices, input, output_size);
        }
      });
      break;
    }
...
template <typename scalar_t>
void cpu_adaptive_max_pool3d_channels_last(
    const Tensor& output_,
    const Tensor& indices_,
    const Tensor& input_,
    IntArrayRef output_size) {
...
template <>
void cpu_adaptive_max_pool3d_channels_last<BFloat16>(
    const Tensor& output_,
    const Tensor& indices_,
    const Tensor& input_,
    IntArrayRef output_size) {
...
void adaptive_max_pool3d_kernel_impl(
  ...
  switch (input.suggest_memory_format()) {
    case at::MemoryFormat::Contiguous: {
      AT_DISPATCH_FLOATING_TYPES_AND(ScalarType::BFloat16, input.scalar_type(), "adaptive_max_pool3d", [&] {
        if (input.scalar_type() == ScalarType::BFloat16) {
          cpu_adaptive_max_pool3d<BFloat16, /*accscalar_t*/float>(output, indices, input, output_size);
        } else {
          cpu_adaptive_max_pool3d<scalar_t, scalar_t>(output, indices, input, output_size);
        }
      });
      break;
    }
    case at::MemoryFormat::ChannelsLast3d: {
      AT_DISPATCH_FLOATING_TYPES_AND(ScalarType::BFloat16, input.scalar_type(), "adaptive_max_pool3d_channels_last", [&]{
...
void adaptive_max_pool3d_backward_kernel_impl(
  ...
  switch (grad_input.suggest_memory_format()) {
    case at::MemoryFormat::Contiguous: {
      AT_DISPATCH_FLOATING_TYPES_AND(ScalarType::BFloat16, grad_output.scalar_type(), "adaptive_max_pool3d_backward", [&] {
        cpu_adaptive_max_pool3d_backward<scalar_t>(grad_input, grad_output, indices);
      });
      break;
    }
    case at::MemoryFormat::ChannelsLast3d: {
      AT_DISPATCH_FLOATING_TYPES_AND(ScalarType::BFloat16, grad_output.scalar_type(), "adaptive_max_pool3d_backward_channels_last", [&]{
