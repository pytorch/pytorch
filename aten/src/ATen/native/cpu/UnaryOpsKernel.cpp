...
static void special_harmonic_number_cpu_kernel(TensorIteratorBase &iterator) {
...
REGISTER_DISPATCH(special_harmonic_number_stub, &CPU_CAPABILITY::special_harmonic_number_cpu_kernel);
