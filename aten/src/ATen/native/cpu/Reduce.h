...
template <typename func_t, typename vec_func_t, typename scalar_t = double>
void binary_kernel_reduce_vec(TensorIterator& iter, func_t op, vec_func_t vop, scalar_t ident = 0) {
