...
#else
REGISTER_NO_AVX512_DISPATCH(threshold_stub);
REGISTER_NO_AVX512_DISPATCH(leaky_relu_stub);
REGISTER_NO_AVX512_DISPATCH(leaky_relu_backward_stub);
REGISTER_NO_AVX512_DISPATCH(prelu_stub);
REGISTER_NO_AVX512_DISPATCH(prelu_backward_stub);
REGISTER_NO_AVX512_DISPATCH(glu_stub);
REGISTER_NO_AVX512_DISPATCH(glu_backward_stub);
REGISTER_NO_AVX512_DISPATCH(glu_jvp_stub);
#endif
