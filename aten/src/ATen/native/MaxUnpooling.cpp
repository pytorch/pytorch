...
Tensor& max_unpooling2d_forward_out_cpu(
  ...
  max_unpooling2d_shape_check(
    self_, Tensor(), indices_, output_size, stride, padding, "max_unpooling2d_forward_out_cpu()");
...
Tensor max_unpooling2d_forward_cpu(
  ...
  at::native::max_unpooling2d_forward_out_cpu(self, indices, output_size, stride, padding, output);
  return output;
}
