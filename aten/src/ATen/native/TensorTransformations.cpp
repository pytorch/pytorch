...
Tensor flip_cpu(const Tensor& self, IntListRef dims) {
  auto in_tensor = self;
...
Tensor roll_cpu(const Tensor& self, IntListRef shifts, IntListRef dims) {
...
Tensor rot90(const Tensor& self, int64_t k, IntListRef dims) {
