...
REGISTER_NEON_DISPATCH(cholesky_stub, &cholesky_kernel);
...
REGISTER_NEON_DISPATCH(cholesky_inverse_stub, &cholesky_inverse_kernel_impl);
...
REGISTER_NEON_DISPATCH(linalg_eig_stub, &linalg_eig_kernel);
...
REGISTER_NEON_DISPATCH(linalg_eigh_stub, &linalg_eigh_kernel);
...
REGISTER_NEON_DISPATCH(geqrf_stub, &geqrf_kernel);
...
REGISTER_NEON_DISPATCH(orgqr_stub, &orgqr_kernel_impl);
...
REGISTER_NEON_DISPATCH(ormqr_stub, &ormqr_kernel);
...
REGISTER_NEON_DISPATCH(lstsq_stub, &lstsq_kernel);
...
REGISTER_NEON_DISPATCH(triangular_solve_stub, &triangular_solve_kernel);
...
REGISTER_NEON_DISPATCH(lu_factor_stub, &lu_factor_kernel);
...
REGISTER_NEON_DISPATCH(ldl_factor_stub, &ldl_factor_kernel);
...
REGISTER_NEON_DISPATCH(ldl_solve_stub, &ldl_solve_kernel);
...
REGISTER_NEON_DISPATCH(lu_solve_stub, &lu_solve_kernel);
...
REGISTER_NEON_DISPATCH(svd_stub, &svd_kernel);
...
REGISTER_NEON_DISPATCH(unpack_pivots_stub, &unpack_pivots_cpu_kernel);
