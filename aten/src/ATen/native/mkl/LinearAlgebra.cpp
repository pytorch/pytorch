...
static inline void gemm_batched(
    const CBLAS_TRANSPOSE trans_A,
    const CBLAS_TRANSPOSE trans_B,
...
static inline void baddbmm_mkl_template(
    const Tensor& res,
    const Tensor& mat1,
    const Tensor& mat2,
    const Scalar& beta_,
  ...
  const bool canAvoidTensorAccessor =
      mat1_strides[0] == mat1_sizes[1] * mat1_sizes[2] &&
