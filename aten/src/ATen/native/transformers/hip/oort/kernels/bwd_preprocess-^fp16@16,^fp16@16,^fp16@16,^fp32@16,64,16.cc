...
INCBIN(bwd_preprocess__Pfp16A16_Pfp16A16_Pfp16A16_Pfp32A16_64_16, "/docker_m/oort/build/bwd_preprocess-^fp16@16,^fp16@16,^fp16@16,^fp32@16,64,16.hsaco");

namespace oort {

template<> hipError_t
bwd_preprocess<64 /* BLOCK_M */,
               16 /* D_HEAD */
  ...
  static oort::OortKernel kernel("bwd_preprocess_0d1d2d3d",
                                 g_oort_kernel_for_shim_bwd_preprocess__Pfp16A16_Pfp16A16_Pfp16A16_Pfp32A16_64_16_data,
                                 256);
