...
static DimMask make_dim_mask(IntListRef dims, int ndim) {
  auto mask = DimMask();
  if (dims.empty()) {
    mask.flip();
  } else {
...
static std::unique_ptr<TensorIterator> make_reduction(
    const char* name, Tensor& result, const Tensor& self, IntListRef dim,
...
static inline int64_t n_dim_size(const Tensor& self, IntListRef dim) {
  int64_t numel = 1;
  for (auto d : dim) {
    numel *= self.size(d);
  }
...
static Tensor& sum_out(Tensor& result, const Tensor& self, IntListRef dim,
...
static Tensor sum(const Tensor& self, IntListRef dim, bool keepdim, optional<ScalarType> dtype) {
  Tensor result;
...
static Tensor& prod_out(Tensor& result, const Tensor& self, IntListRef dim,
                        bool keepdim, optional<ScalarType> opt_dtype) {
  ScalarType dtype = get_dtype(result, self, opt_dtype, true);
...
static Tensor prod(const Tensor& self, IntListRef dim, bool keepdim, optional<ScalarType> dtype) {
  Tensor result;
...
static inline Tensor &mean_out(Tensor &result, const Tensor &self, IntListRef dim,
                 bool keepdim, optional<ScalarType> opt_dtype) {
...
Tensor& mean_out(Tensor& result, const Tensor& self, IntListRef dim, bool keepdim, ScalarType dtype) {
  return at::native::mean_out(
      result, self, dim, keepdim, c10::optional<ScalarType>(dtype));
}
Tensor& mean_out(Tensor& result, const Tensor& self, IntListRef dim, bool keepdim) {
  return at::native::mean_out(result, self, dim, keepdim, c10::nullopt);
}

Tensor& mean_out(Tensor& result, const Tensor& self, IntListRef dim, ScalarType dtype) {
  return at::native::mean_out(result, self, dim, false, dtype);
}

static inline Tensor mean(const Tensor &self, IntListRef dim, bool keepdim, optional<ScalarType> dtype) {
  Tensor result;
...
Tensor& sum_out(Tensor& result, const Tensor& self, IntListRef dim, bool keepdim, ScalarType dtype) {
  return at::native::sum_out(
      result, self, dim, keepdim, c10::optional<ScalarType>(dtype));
}

Tensor& sum_out(Tensor& result, const Tensor& self, IntListRef dim, bool keepdim) {
  return at::native::sum_out(result, self, dim, keepdim, c10::nullopt);
}

Tensor& sum_out(Tensor& result, const Tensor& self, IntListRef dim, ScalarType dtype) {
...
Tensor mean(const Tensor& self, IntListRef dim, bool keepdim, ScalarType dtype) {
  return at::native::mean(self, dim, keepdim, c10::optional<ScalarType>(dtype));
}

Tensor mean(const Tensor& self, IntListRef dim, bool keepdim) {
  return at::native::mean(self, dim, keepdim, c10::nullopt);
}

Tensor mean(const Tensor& self, IntListRef dim, ScalarType dtype) {
  return at::native::mean(self, dim, false, dtype);
}

Tensor sum(const Tensor& self, IntListRef dim, bool keepdim, ScalarType dtype) {
  return at::native::sum(self, dim, keepdim, c10::optional<ScalarType>(dtype));
}

Tensor sum(const Tensor& self, IntListRef dim, bool keepdim) {
  return at::native::sum(self, dim, keepdim, c10::nullopt);
}

Tensor sum(const Tensor& self, IntListRef dim, ScalarType dtype) {
...
static Tensor& norm_out(Tensor &result, const Tensor &self, optional<Scalar> opt_p,
                               IntListRef dim, bool keepdim, optional<ScalarType> opt_dtype) {
...
Tensor &norm_out(Tensor& result, const Tensor& self, optional<Scalar> p, IntListRef dim, bool keepdim, ScalarType dtype) {
  return at::native::norm_out(result, self, p, dim, keepdim, optional<ScalarType>(dtype));
}

Tensor &norm_out(Tensor& result, const Tensor& self, optional<Scalar> p, IntListRef dim, bool keepdim) {
  return at::native::norm_out(result, self, p, dim, keepdim, c10::nullopt);
}

static Tensor norm(const Tensor& self, optional<Scalar> p, IntListRef dim, bool keepdim,
            optional<ScalarType> opt_dtype) {
  Tensor result;
  return at::native::norm_out(result, self, p, dim, keepdim, opt_dtype);
}

Tensor norm(const Tensor& self, optional<Scalar> p, IntListRef dim, bool keepdim, ScalarType dtype) {
...
Tensor norm(const Tensor& self, optional<Scalar> p, IntListRef dim, bool keepdim) {
...
static Tensor &std_var_out(Tensor &result, const Tensor &self, IntListRef dim, bool unbiased, bool keepdim, bool take_sqrt) {
  AT_CHECK(self.type().backend() == Backend::CPU || self.type().backend() == Backend::CUDA,
...
Tensor var(const Tensor& self, IntListRef dim, bool unbiased, bool keepdim) {
  Tensor result = at::empty({0}, self.options());
  return at::native::var_out(result, self, dim, unbiased, keepdim);
}

Tensor &var_out(Tensor &result, const Tensor &self, IntListRef dim, bool unbiased, bool keepdim) {
...
Tensor std(const Tensor& self, IntListRef dim, bool unbiased, bool keepdim) {
  Tensor result = at::empty({0}, self.options());
  return at::native::std_out(result, self, dim, unbiased, keepdim);
}

Tensor &std_out(Tensor &result, const Tensor &self, IntListRef dim, bool unbiased, bool keepdim) {
