...
void swap(ShaderLayout& lhs, ShaderLayout& rhs) {
...
size_t ShaderLayout::Hasher::operator()(
    const ShaderLayout::Signature& signature) const {
  size_t hashed = 0u;
...
size_t ShaderModule::Hasher::operator()(
