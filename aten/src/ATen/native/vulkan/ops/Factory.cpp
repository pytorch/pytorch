...
TORCH_LIBRARY_IMPL(aten, Vulkan, m) {
  m.impl(TORCH_SELECTIVE_NAME("empty.memory_format"), at::native::vulkan::ops::empty_memory_format);
  m.impl(TORCH_SELECTIVE_NAME("empty_strided"), TORCH_FN(at::native::vulkan::ops::empty_strided));
}
