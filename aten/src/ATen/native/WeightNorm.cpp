...
std::tuple<Tensor,Tensor> weight_norm_cpu(
  ...
  weight_norm_stub.call_with_known_device_type<kCPU>(w, norm, v, g, dim);
...
std::tuple<Tensor, Tensor> weight_norm_backward_cpu(
  ...
  weight_norm_backward_stub.call_with_known_device_type<kCPU>(grad_v, grad_g, grad_w, saved_v, saved_g, saved_norm, dim);
