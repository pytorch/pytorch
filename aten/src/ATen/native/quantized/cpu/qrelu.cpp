...
class QReluInt8 final : public c10::OperatorKernel {
 public:
  QTensor operator()(const at::QTensor& qx) {
    QTensor qy = at::empty_affine_quantized(qx.sizes(),
...
static auto registry = c10::RegisterOperators().op(
    c10::FunctionSchema(
        "quantized::relu",
        "",
        std::vector<c10::Argument>{c10::Argument("qx", TensorType::get())},
        std::vector<c10::Argument>{c10::Argument("qy", TensorType::get())}
    ),
