...
SmallVector<int64_t, 4> convOutputShape(
    ...
    const torch::ListPtr<int64_t>& stride,
    const torch::ListPtr<int64_t>& padding,
    const torch::ListPtr<int64_t>& dilation) {
...
class QConv2dInt8 final : public c10::OperatorKernel {
 public:
  ...
  Tensor operator()(
      ...
      Tensor bias,
      torch::ListPtr<int64_t> stride,
      torch::ListPtr<int64_t> padding,
      torch::ListPtr<int64_t> dilation,
      int64_t groups,
      double output_scale,
  ...
  Tensor operator()(
      ...
      torch::ListPtr<int64_t> /* padding */,
      torch::ListPtr<int64_t> /* dilation */,
      torch::ListPtr<int64_t> /* output padding */,
      int64_t /* groups */,
      double /* output scale */,
      int64_t /* output_zero_point */) {
    TORCH_CHECK(
