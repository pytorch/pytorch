...
#if defined(_WIN32) && defined(CPU_CAPABILITY_AVX512)
...
// These kernels can be enabled for both AVX2 and AVX512
...
ALSO_REGISTER_AVX512_DISPATCH(dequantize_tensor_per_channel_affine_stub,
                  &dequantize_tensor_per_channel_affine_cpu);
ALSO_REGISTER_AVX512_DISPATCH(dequantize_tensor_per_tensor_affine_stub,
                  &dequantize_tensor_per_tensor_affine_cpu);
ALSO_REGISTER_AVX512_DISPATCH(dequantize_tensor_per_channel_float_qparams_stub,
                  &dequantize_tensor_per_channel_float_qparams_cpu);
ALSO_REGISTER_AVX512_DISPATCH(fake_quant_grad_learnable_tensor_stub,
                  &fake_quantize_learnable_tensor_grad_kernel_cpu);
ALSO_REGISTER_AVX512_DISPATCH(fake_quant_per_channel_cachemask_stub, &fake_quant_per_channel_cachemask_cpu);
ALSO_REGISTER_AVX512_DISPATCH(fake_quant_tensor_cachemask_stub,
                  &fake_quantize_tensor_cachemask_kernel);
ALSO_REGISTER_AVX512_DISPATCH(fake_quant_tensor_cachemask_tensor_qparams_stub,
                  &fake_quantize_tensor_cachemask_tensor_qparams_kernel);
ALSO_REGISTER_AVX512_DISPATCH(qadaptive_avg_pool2d_nhwc_stub,
                  &qadaptive_avg_pool2d_nhwc_kernel);
ALSO_REGISTER_AVX512_DISPATCH(qadaptive_avg_pool3d_ndhwc_stub,
                  &qadaptive_avg_pool3d_ndhwc_kernel);
ALSO_REGISTER_AVX512_DISPATCH(qadd_stub, &qadd_kernel<false>);
ALSO_REGISTER_AVX512_DISPATCH(qadd_relu_stub, &qadd_kernel<true>);
...
ALSO_REGISTER_AVX512_DISPATCH(qadd_scalar_relu_stub, &qadd_scalar_kernel<true>);
ALSO_REGISTER_AVX512_DISPATCH(qbatch_norm_relu_stub, &q_batch_norm_kernel<true>);
ALSO_REGISTER_AVX512_DISPATCH(qcat_nhwc_stub, &qcat_nhwc_kernel<false>);
ALSO_REGISTER_AVX512_DISPATCH(qcat_relu_nhwc_stub, &qcat_nhwc_kernel<true>);
ALSO_REGISTER_AVX512_DISPATCH(qelu_stub, &qelu_kernel);
ALSO_REGISTER_AVX512_DISPATCH(qmaxpool_2d_nhwc_stub, &qmaxpool_2d_nhwc_kernel);
ALSO_REGISTER_AVX512_DISPATCH(qmaxpool_3d_nthwc_stub, &qmaxpool_3d_nthwc_kernel);
ALSO_REGISTER_AVX512_DISPATCH(qmul_relu_stub, &qmul_kernel<true>);
ALSO_REGISTER_AVX512_DISPATCH(qgelu_stub, &qgelu_kernel);
ALSO_REGISTER_AVX512_DISPATCH(qsigmoid_stub, &qsigmoid_kernel);
ALSO_REGISTER_AVX512_DISPATCH(qtanh_stub, &qtanh_kernel);
ALSO_REGISTER_AVX512_DISPATCH(fake_quant_grad_learnable_channel_stub,
                  &fake_quantize_learnable_channel_grad_kernel_cpu);
...
ALSO_REGISTER_AVX512_DISPATCH(
    quantize_tensor_per_channel_float_qparams_stub,
    &quantize_tensor_per_channel_float_qparams_cpu);
ALSO_REGISTER_AVX512_DISPATCH(quantized_groupnorm_nhwc_stub, &quantized_groupnorm_nhwc_kernel);
ALSO_REGISTER_AVX512_DISPATCH(qupsample_bilinear2d_nhwc_stub,
                  &qupsample_bilinear2d_nhwc_kernel);
ALSO_REGISTER_AVX512_DISPATCH(
    quantize_tensor_per_tensor_affine_sub_byte_stub,
    &quantize_tensor_per_tensor_affine_sub_byte_cpu);
ALSO_REGISTER_AVX512_DISPATCH(
    dequantize_tensor_per_tensor_affine_sub_byte_stub,
    &dequantize_tensor_per_tensor_affine_sub_byte_cpu);
#endif // NOT CPU_CAPABILITY_AVX512 && _WIN32
