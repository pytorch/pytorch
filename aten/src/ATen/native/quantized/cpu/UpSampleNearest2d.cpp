...
static Tensor _upsample_nearest_exact2d_quantized_cpu(
    ...
    at::OptionalIntArrayRef output_size,
    c10::optional<ArrayRef<double>> scale_factors) {
  return upsample_nearest2d_quantized_cpu(input, output_size, scale_factors, false);
}
...
Tensor _upsample_nearest_exact2d_quantized_cpu(
    ...
    at::OptionalIntArrayRef output_size,
    c10::optional<ArrayRef<double>> scale_factors) {
  return _upsample_nearest_exact2d_quantized_cpu(input, output_size, scale_factors, false);
}
