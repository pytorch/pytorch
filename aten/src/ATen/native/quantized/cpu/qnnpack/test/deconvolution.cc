...
TEST(DECONVOLUTION_OP, zero_batch_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(5, 5)
      .kernelSize(1, 1)
      .groupInputChannels(2)
...
TEST(DECONVOLUTION_OP, 1x1_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(27, 29)
      .kernelSize(1, 1)
      .groupInputChannels(23)
...
TEST(DECONVOLUTION_OP, 1x1_with_qmin_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(27, 29)
      .kernelSize(1, 1)
      .groupInputChannels(23)
...
TEST(DECONVOLUTION_OP, 1x1_with_qmax_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(27, 29)
      .kernelSize(1, 1)
      .groupInputChannels(23)
...
TEST(DECONVOLUTION_OP, 1x1_with_input_stride_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(27, 29)
      .kernelSize(1, 1)
      .inputPixelStride(28)
...
TEST(DECONVOLUTION_OP, 1x1_with_output_stride_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(27, 29)
      .kernelSize(1, 1)
      .outputPixelStride(29)
...
TEST(DECONVOLUTION_OP, 1x1_with_batch_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(13, 14)
      .kernelSize(1, 1)
      .batchSize(3)
...
TEST(DECONVOLUTION_OP, grouped_1x1_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(24, 25)
      .kernelSize(1, 1)
      .groups(2)
...
TEST(DECONVOLUTION_OP, 1x3_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(20, 19)
      .paddingWidth(1)
      .kernelSize(1, 3)
...
TEST(DECONVOLUTION_OP, grouped_1x3_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(20, 19)
      .paddingWidth(1)
      .kernelSize(1, 3)
...
TEST(DECONVOLUTION_OP, 3x1_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(19, 20)
      .paddingHeight(1)
      .kernelSize(3, 1)
...
TEST(DECONVOLUTION_OP, grouped_3x1_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(19, 20)
      .paddingHeight(1)
      .kernelSize(3, 1)
...
TEST(DECONVOLUTION_OP, 3x3_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(13, 12)
      .padding(1)
      .kernelSize(3, 3)
...
TEST(DECONVOLUTION_OP, 3x3_with_input_stride_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(13, 12)
      .padding(1)
      .kernelSize(3, 3)
...
TEST(DECONVOLUTION_OP, 3x3_with_output_stride_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(13, 12)
      .padding(1)
      .kernelSize(3, 3)
...
TEST(DECONVOLUTION_OP, 3x3_with_batch_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(10, 9)
      .padding(1)
      .kernelSize(3, 3)
...
TEST(DECONVOLUTION_OP, grouped_3x3_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(10, 11)
      .padding(1)
      .kernelSize(3, 3)
...
TEST(DECONVOLUTION_OP, 3x3s2_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(19, 21)
      .padding(1)
      .kernelSize(3, 3)
...
TEST(DECONVOLUTION_OP, 3x3s1x2_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(13, 13)
      .padding(1)
      .kernelSize(3, 3)
...
TEST(DECONVOLUTION_OP, 3x3s2x1_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(13, 13)
      .padding(1)
      .kernelSize(3, 3)
...
TEST(DECONVOLUTION_OP, 3x3d2_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(13, 14)
      .padding(2)
      .kernelSize(3, 3)
...
TEST(DECONVOLUTION_OP, 3x3d1x2_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(14, 15)
      .padding(1, 2)
      .kernelSize(3, 3)
...
TEST(DECONVOLUTION_OP, 3x3d2x1_per_channel) {
  DeconvolutionOperatorTester()
      .inputSize(15, 14)
      .padding(2, 1)
      .kernelSize(3, 3)
