...
#define TEST_PACKED_ROW_BLOCK_SIZEXCOL_BLOCK_SIZE_SPARSE_OP(                       \
    MR, NR, row_block_size, col_block_size, prepacking_kernel, compute_kernel)     \
  TEST(                                                                            \
      Q8GEMM__##MR##x##NR##c##row_block_size##x##col_block_size##__AARCH3232_NEON, \
      packedA_k_lt_4) {                                                            \
    ...
    GemmBlockSparseMicrokernelTester()                                             \
        ...
        .test_packed(prepacking_kernel, compute_kernel);                           \
  }                                                                                \
                                                                                   \
  TEST(                                                                            \
      Q8GEMM__##MR##x##NR##c##row_block_size##x##col_block_size##__AARCH3232_NEON, \
      packedA_k_lt_4_strided_a) {                                                  \
    TEST_REQUIRES_ARM_NEON;                                                        \
    GemmBlockSparseMicrokernelTester()                                             \
        .mr(MR)                                                                    \
        .nr(NR)                                                                    \
...
#define TEST_PACKED_1x4_SPARSE_OP(MR, NR, prepacking_kernel, compute_kernel) \
  TEST_PACKED_ROW_BLOCK_SIZEXCOL_BLOCK_SIZE_SPARSE_OP(                       \
      MR, NR, 1, 4, prepacking_kernel, compute_kernel)
#define TEST_PACKED_8x1_SPARSE_OP(MR, NR, prepacking_kernel, compute_kernel) \
  TEST_PACKED_ROW_BLOCK_SIZEXCOL_BLOCK_SIZE_SPARSE_OP(                       \
      MR, NR, 8, 1, prepacking_kernel, compute_kernel)
