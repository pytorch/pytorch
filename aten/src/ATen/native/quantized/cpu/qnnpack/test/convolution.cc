...
_STATIC_TEST(
    CONVOLUTION_OP,
    1x1_with_input_stride_per_channel,
    ConvolutionOperatorTester()
        .inputSize(27, 29)
        .kernelSize(1, 1)
        .inputPixelStride(28)
...
_STATIC_TEST(
    CONVOLUTION_OP,
    1x1_with_output_stride_per_channel,
    ConvolutionOperatorTester()
        .inputSize(27, 29)
        .kernelSize(1, 1)
        .outputPixelStride(29)
...
_STATIC_AND_RUNTIME_TEST(
    CONVOLUTION_OP,
    3x3_without_padding_per_channel,
    ConvolutionOperatorTester()
        .inputSize(13, 12)
        .kernelSize(3, 3)
        .groupInputChannels(15)
...
_STATIC_AND_RUNTIME_TEST(
    CONVOLUTION_OP,
    3x3_with_left_padding_per_channel,
    ConvolutionOperatorTester()
        .inputSize(13, 12)
        .paddingLeft(1)
        .kernelSize(3, 3)
...
_STATIC_AND_RUNTIME_TEST(
    CONVOLUTION_OP,
    3x3_with_right_padding_per_channel,
    ConvolutionOperatorTester()
        .inputSize(13, 12)
        .paddingRight(1)
        .kernelSize(3, 3)
...
_STATIC_AND_RUNTIME_TEST(
    CONVOLUTION_OP,
    3x3_with_top_padding_per_channel,
    ConvolutionOperatorTester()
        .inputSize(13, 12)
        .paddingTop(1)
        .kernelSize(3, 3)
...
_STATIC_AND_RUNTIME_TEST(
    CONVOLUTION_OP,
    3x3_with_bottom_padding_per_channel,
    ConvolutionOperatorTester()
        .inputSize(13, 12)
        .paddingBottom(1)
        .kernelSize(3, 3)
...
_STATIC_TEST(
    CONVOLUTION_OP,
    3x3_with_input_stride_per_channel,
    ConvolutionOperatorTester()
        .inputSize(13, 12)
        .padding(1)
        .kernelSize(3, 3)
...
_STATIC_TEST(
    CONVOLUTION_OP,
    3x3_with_output_stride_per_channel,
    ConvolutionOperatorTester()
        .inputSize(13, 12)
        .padding(1)
        .kernelSize(3, 3)
