...
TEST(X8ZIP_X2__VSX, n_eq_16) {
  TEST_REQUIRES_VSX;
  ZipMicrokernelTester().n(16).g(2).test(pytorch_qnnp_x8zip_x2__vsx);
}

TEST(X8ZIP_X2__VSX, n_div_16) {
  TEST_REQUIRES_VSX;
  for (size_t n = 16; n < 256; n += 16) {
    ZipMicrokernelTester().n(n).g(2).test(pytorch_qnnp_x8zip_x2__vsx);
  }
}

TEST(X8ZIP_X2__VSX, n_gt_16) {
  TEST_REQUIRES_VSX;
  for (size_t n = 17; n < 32; n++) {
    ZipMicrokernelTester().n(n).g(2).test(pytorch_qnnp_x8zip_x2__vsx);
  }
...
TEST(X8ZIP_X3__VSX, n_eq_16) {
  TEST_REQUIRES_VSX;
  ZipMicrokernelTester().n(16).g(3).test(pytorch_qnnp_x8zip_x3__vsx);
}

TEST(X8ZIP_X3__VSX, n_div_16) {
  TEST_REQUIRES_VSX;
  for (size_t n = 16; n < 256; n += 16) {
    ZipMicrokernelTester().n(n).g(3).test(pytorch_qnnp_x8zip_x3__vsx);
  }
}

TEST(X8ZIP_X3__VSX, n_gt_16) {
  TEST_REQUIRES_VSX;
  for (size_t n = 17; n < 32; n++) {
    ZipMicrokernelTester().n(n).g(3).test(pytorch_qnnp_x8zip_x3__vsx);
  }
...
TEST(X8ZIP_X4__VSX, n_eq_16) {
  TEST_REQUIRES_VSX;
  ZipMicrokernelTester().n(16).g(4).test(pytorch_qnnp_x8zip_x4__vsx);
}

TEST(X8ZIP_X4__VSX, n_div_16) {
  TEST_REQUIRES_VSX;
  for (size_t n = 16; n < 256; n += 16) {
    ZipMicrokernelTester().n(n).g(4).test(pytorch_qnnp_x8zip_x4__vsx);
  }
}

TEST(X8ZIP_X4__VSX, n_gt_16) {
  TEST_REQUIRES_VSX;
  for (size_t n = 17; n < 32; n++) {
    ZipMicrokernelTester().n(n).g(4).test(pytorch_qnnp_x8zip_x4__vsx);
  }
...
TEST(X8ZIP_XM__VSX, n_eq_8_m_eq_4) {
  TEST_REQUIRES_VSX;
  ZipMicrokernelTester().n(8).g(4).test(pytorch_qnnp_x8zip_xm__vsx);
}

TEST(X8ZIP_XM__VSX, n_eq_8_m_div_4) {
  TEST_REQUIRES_VSX;
  for (size_t g = 4; g < 32; g += 4) {
    ZipMicrokernelTester().n(8).g(g).test(pytorch_qnnp_x8zip_xm__vsx);
  }
}

TEST(X8ZIP_XM__VSX, n_eq_8_m_gt_4) {
  TEST_REQUIRES_VSX;
  for (size_t g = 5; g < 8; g++) {
    ZipMicrokernelTester().n(8).g(g).test(pytorch_qnnp_x8zip_xm__vsx);
  }
...
TEST(X8ZIP_XM__VSX, n_eq_16_m_eq_4) {
  TEST_REQUIRES_VSX;
  ZipMicrokernelTester().n(16).g(4).test(pytorch_qnnp_x8zip_xm__vsx);
}

TEST(X8ZIP_XM__VSX, n_eq_16_m_div_4) {
  TEST_REQUIRES_VSX;
  for (size_t g = 4; g < 32; g += 4) {
    ZipMicrokernelTester().n(16).g(g).test(pytorch_qnnp_x8zip_xm__vsx);
  }
}

TEST(X8ZIP_XM__VSX, n_eq_16_m_gt_4) {
  TEST_REQUIRES_VSX;
  for (size_t g = 5; g < 8; g++) {
    ZipMicrokernelTester().n(16).g(g).test(pytorch_qnnp_x8zip_xm__vsx);
  }
...
TEST(X8ZIP_XM__VSX, n_div_16_m_eq_4) {
  TEST_REQUIRES_VSX;
  for (size_t n = 16; n < 256; n += 16) {
    ZipMicrokernelTester().n(n).g(4).test(pytorch_qnnp_x8zip_xm__vsx);
  }
}

TEST(X8ZIP_XM__VSX, n_div_16_m_div_4) {
  TEST_REQUIRES_VSX;
  for (size_t n = 16; n < 256; n += 16) {
    for (size_t g = 4; g < 32; g += 4) {
      ZipMicrokernelTester().n(n).g(g).test(pytorch_qnnp_x8zip_xm__vsx);
    }
  }
}

TEST(X8ZIP_XM__VSX, n_div_16_m_gt_4) {
  TEST_REQUIRES_VSX;
  for (size_t n = 16; n < 256; n += 16) {
    for (size_t g = 5; g < 8; g++) {
      ZipMicrokernelTester().n(n).g(g).test(pytorch_qnnp_x8zip_xm__vsx);
...
TEST(X8ZIP_XM__VSX, n_gt_16_m_eq_4) {
  TEST_REQUIRES_VSX;
  for (size_t n = 17; n < 32; n++) {
    ZipMicrokernelTester().n(n).g(4).test(pytorch_qnnp_x8zip_xm__vsx);
  }
...
TEST(X8ZIP_XM__VSX, n_gt_16_m_div_4) {
  TEST_REQUIRES_VSX;
  for (size_t n = 17; n < 32; n++) {
    for (size_t g = 4; g < 32; g += 4) {
      ZipMicrokernelTester().n(n).g(g).test(pytorch_qnnp_x8zip_xm__vsx);
...
TEST(X8ZIP_XM__VSX, n_gt_16_m_gt_4) {
  TEST_REQUIRES_VSX;
  for (size_t n = 17; n < 32; n++) {
    for (size_t g = 5; g < 8; g++) {
      ZipMicrokernelTester().n(n).g(g).test(pytorch_qnnp_x8zip_xm__vsx);
