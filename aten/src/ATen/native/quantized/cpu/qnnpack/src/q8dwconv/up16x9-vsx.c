...
void pytorch_q8dwconv_ukernel_up16x9__vsx(
    size_t channels,
    size_t output_width,
    const uint8_t** input,
    const void* weights,
  ...
  do {
    ...
    for (; c >= 16; c -= 16) {
      ...
      /* [1/9] Load 16 input elements over the channels, add zero point to
      ...
      const vector short vxk0_hi =
          vec_sub((vector short)vec_mergeh(vk0, vzero), vkernel_zero_point);
      const vector short vxk0_lo =
          vec_sub((vector short)vec_mergel(vk0, vzero), vkernel_zero_point);
      vacc_hi_hi = vec_add(
      ...
      const vector short vxk1_hi =
          vec_sub((vector short)vec_mergeh(vk1, vzero), vkernel_zero_point);
      const vector short vxk1_lo =
          vec_sub((vector short)vec_mergel(vk1, vzero), vkernel_zero_point);
      vacc_hi_hi = vec_add(
      ...
      const vector short vxk2_hi =
          vec_sub((vector short)vec_mergeh(vk2, vzero), vkernel_zero_point);
      const vector short vxk2_lo =
          vec_sub((vector short)vec_mergel(vk2, vzero), vkernel_zero_point);
      vacc_hi_hi = vec_add(
      ...
      const vector short vxk3_hi =
          vec_sub((vector short)vec_mergeh(vk3, vzero), vkernel_zero_point);
      const vector short vxk3_lo =
          vec_sub((vector short)vec_mergel(vk3, vzero), vkernel_zero_point);
      vacc_hi_hi = vec_add(
      ...
      const vector short vxk4_hi =
          vec_sub((vector short)vec_mergeh(vk4, vzero), vkernel_zero_point);
      const vector short vxk4_lo =
          vec_sub((vector short)vec_mergel(vk4, vzero), vkernel_zero_point);
      vacc_hi_hi = vec_add(
      ...
      const vector short vxk5_hi =
          vec_sub((vector short)vec_mergeh(vk5, vzero), vkernel_zero_point);
      const vector short vxk5_lo =
          vec_sub((vector short)vec_mergel(vk5, vzero), vkernel_zero_point);
      vacc_hi_hi = vec_add(
      ...
      const vector short vxk6_hi =
          vec_sub((vector short)vec_mergeh(vk6, vzero), vkernel_zero_point);
      const vector short vxk6_lo =
          vec_sub((vector short)vec_mergel(vk6, vzero), vkernel_zero_point);
      vacc_hi_hi = vec_add(
      ...
      const vector short vxk7_hi =
          vec_sub((vector short)vec_mergeh(vk7, vzero), vkernel_zero_point);
      const vector short vxk7_lo =
          vec_sub((vector short)vec_mergel(vk7, vzero), vkernel_zero_point);
      vacc_hi_hi = vec_add(
      ...
      const vector short vxk8_hi =
          vec_sub((vector short)vec_mergeh(vk8, vzero), vkernel_zero_point);
      const vector short vxk8_lo =
          vec_sub((vector short)vec_mergel(vk8, vzero), vkernel_zero_point);
      vacc_hi_hi = vec_add(
