...
// This function was adapated from pytorch_q8dwconv_ukernel_mp8x27__sse2
void pytorch_q8dwconv_ukernel_mp16x27__vsx(
  ...
  const int16_t input_zero_point =
      quantization_params->vsx.input_zero_point;
  const uint8_t* kernel_zero_points =
      quantization_params->vsx.kernel_zero_points;
  const float* requantization_scales =
      quantization_params->vsx.requantization_scales;
  const int16_t output_zero_point =
      quantization_params->vsx.output_zero_point;
  const uint8_t output_min = quantization_params->vsx.output_min;
  const uint8_t output_max = quantization_params->vsx.output_max;
