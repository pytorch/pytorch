...
void pytorch_q8dwconv_ukernel_up8x9_per_channel__sse2(
  ...
  do {
    ...
    for (; c >= 8; c -= 8) {
      ...
      const __m128i vxk0 = _mm_sub_epi16(
      ...
      const __m128i vxk1 = _mm_sub_epi16(
      ...
      const __m128i vxk2 = _mm_sub_epi16(
      ...
      const __m128i vxk3 = _mm_sub_epi16(
      ...
      const __m128i vxk4 = _mm_sub_epi16(
      ...
      const __m128i vxk5 = _mm_sub_epi16(
      ...
      const __m128i vxk6 = _mm_sub_epi16(
      ...
      const __m128i vxk7 = _mm_sub_epi16(
      ...
      const __m128i vxk8 = _mm_sub_epi16(
      ...
      vacc_lo =
          _mm_cvtps_epi32(_mm_mul_ps(_mm_cvtepi32_ps(vacc_lo), vmultiplier_lo));
      vacc_hi =
          _mm_cvtps_epi32(_mm_mul_ps(_mm_cvtepi32_ps(vacc_hi), vmultiplier_hi));
