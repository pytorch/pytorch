...
BOOL CALLBACK
pytorch_qnnp_init_win(PINIT_ONCE InitOnce, PVOID Parameter, PVOID* lpContex);
#else
...
static void init(void) {
  ...
  pytorch_qnnp_params.q8gemm_sparse_c1x4 =
  ...
  pytorch_qnnp_params.q8gemm_sparse_c8x1 =
      (struct pytorch_q8gemm_sparse_parameters){
          .gemm_dq = NULL,
          .packedA_gemm_dq =
          ...
          .mr = 4,
          .nr = 8,
          .kr = 4, // kr is really 1 but we set it to 4 because we resuse 4x4
                   // prepacking kernel
          .log2_mr = 2,
