...
enum pytorch_qnnp_status pytorch_qnnp_create_fully_connected_sparse_dq_nc_q8(
  ...
  switch (kernel_indices_dtype) {
    ...
    case pytorch_qnnp_sparse_matrix_indices_dtype_uint16_t:
      fully_connected->sparse_matrix.col_indices_w16 = (const uint16_t*)kernel_col_indices;
      fully_connected->sparse_matrix.row_values_w16 = (const uint16_t*)kernel_row_values;
      break;
    case pytorch_qnnp_sparse_matrix_indices_dtype_uint8_t:
      fully_connected->sparse_matrix.col_indices_w8 = (const uint8_t*)kernel_col_indices;
      fully_connected->sparse_matrix.row_values_w8 = (const uint8_t*)kernel_row_values;
      break;
