...
void pytorch_q8gemm_dq_ukernel_4x8__neon(
  ...
  const uint8x8_t vb_zero_point =
      vld1_u8((const uint8_t*)&quantization_params
  ...
  float32x4_t vout0[] = {
      vaddq_f32(
          vmulq_f32(vmultiplier_c0123, vcvtq_f32_s32(vacc0x0123)), vbias[0]),
      vaddq_f32(
          vmulq_f32(vmultiplier_c4567, vcvtq_f32_s32(vacc0x4567)), vbias[1]),
  };
  float32x4_t vout1[] = {
      vaddq_f32(
          vmulq_f32(vmultiplier_c0123, vcvtq_f32_s32(vacc1x0123)), vbias[0]),
      vaddq_f32(
          vmulq_f32(vmultiplier_c4567, vcvtq_f32_s32(vacc1x4567)), vbias[1]),
  };
  float32x4_t vout2[] = {
      vaddq_f32(
          vmulq_f32(vmultiplier_c0123, vcvtq_f32_s32(vacc2x0123)), vbias[0]),
      vaddq_f32(
          vmulq_f32(vmultiplier_c4567, vcvtq_f32_s32(vacc2x4567)), vbias[1]),
  };
  float32x4_t vout3[] = {
      vaddq_f32(
          vmulq_f32(vmultiplier_c0123, vcvtq_f32_s32(vacc3x0123)), vbias[0]),
      vaddq_f32(
          vmulq_f32(vmultiplier_c4567, vcvtq_f32_s32(vacc3x4567)), vbias[1]),
  };
