...
TORCH_LIBRARY(quantized, m) {
  ...
  // conv_prepack for inductor path
  ...
  m.def(TORCH_SELECTIVE_SCHEMA("quantized::conv_unary.tensor(Tensor qx, float input_scale, int input_zero_point, Tensor qw, Tensor weight_scale, Tensor weight_zero_point, int w_axis, Tensor? bias, int[] stride, int[] padding, int[] dilation, int groups, float output_scale, int output_zero_point, str unary_post_op) -> Tensor"));
  m.def(TORCH_SELECTIVE_SCHEMA("quantized::conv_binary.tensor(Tensor qx, float input_scale, int input_zero_point, Tensor qaccum, float accum_scale, int accum_zp, Tensor qw, Tensor weight_scale, Tensor weight_zero_point, int w_axis, Tensor? bias, int[] stride, int[] padding, int[] dilation, int groups, float output_scale, int output_zero_point, str binary_post_op) -> Tensor"));
