...
TORCH_LIBRARY(quantized, m) {
  ...
  m.def(TORCH_SELECTIVE_SCHEMA("quantized::conv2d_unpack_sizes(__torch__.torch.classes.quantized.Conv2dPackedParamsBase packed_weights) -> ((int[], int[]?, int[], int[], int[], int))"));
