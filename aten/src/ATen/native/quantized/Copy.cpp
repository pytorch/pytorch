...
// This means that assignment of a non-contiguous quantized subtensor is
// currently not supported in pytorch e.g., Consider a 2x2 quantized tensor qt1
// and a non-quantized tensor t2. The operation `qt1[:, 0] = t2[:, 0]` would
// trigger the exception b/c neither the LHS nor RHS is contiguous
