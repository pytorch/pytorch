...
void singleCheckErrors(int64_t info, const c10::string_view name, int64_t batch_id) {
 ...
 */
void batchCheckErrors(const std::vector<int64_t>& infos, const c10::string_view name) {
 ...
 */
void batchCheckErrors(const Tensor& infos, const c10::string_view name) {
