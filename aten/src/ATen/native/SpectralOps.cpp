...
Tensor fft_r2c(c10::string_view function_name,
               Tensor out, Tensor input, c10::optional<c10::SymInt> n_opt,
               int64_t unwrapped_dim, c10::optional<c10::string_view> norm_str,
...
Tensor fft_fft_symint(const Tensor& self, c10::optional<c10::SymInt> n, int64_t dim,
...
Tensor& fft_fft_out(const Tensor& self, c10::optional<c10::SymInt> n,
...
Tensor fft_ifft_symint(const Tensor& self, c10::optional<c10::SymInt> n, int64_t dim,
                c10::optional<c10::string_view> norm) {
  return self.is_complex() ?
...
Tensor& fft_ifft_out(const Tensor& self, c10::optional<c10::SymInt> n,
                     int64_t dim, c10::optional<c10::string_view> norm, Tensor& out) {
  if (self.is_complex()) {
...
Tensor fft_rfft_symint(const Tensor& self, c10::optional<c10::SymInt> n, int64_t dim,
                c10::optional<c10::string_view> norm) {
  return fft_r2c("rfft", {}, self, n, dim, norm, /*forward=*/true, /*onesided=*/true);
}

Tensor& fft_rfft_out(const Tensor& self, c10::optional<c10::SymInt> n,
                     int64_t dim, c10::optional<c10::string_view> norm, Tensor& out) {
  fft_r2c("rfft", out, self, n, dim, norm, /*forward=*/true, /*onesided=*/true);
  return out;
}

Tensor fft_irfft_symint(const Tensor& self, c10::optional<c10::SymInt> n, int64_t dim,
                 c10::optional<c10::string_view> norm) {
  return fft_c2r("irfft", {}, self, n, dim, norm, /*forward=*/false);
}

Tensor& fft_irfft_out(const Tensor& self, c10::optional<c10::SymInt> n,
                  int64_t dim, c10::optional<c10::string_view> norm, Tensor& out) {
  fft_c2r("irfft", out, self, n, dim, norm, /*forward=*/false);
  return out;
}

Tensor fft_hfft_symint(const Tensor& self, c10::optional<c10::SymInt> n, int64_t dim,
                c10::optional<c10::string_view> norm) {
  return fft_c2r("hfft", {}, self, n, dim, norm, /*forward=*/true);
}

Tensor& fft_hfft_out(const Tensor& self, c10::optional<c10::SymInt> n,
                     int64_t dim, c10::optional<c10::string_view> norm, Tensor& out) {
  fft_c2r("hfft", out, self, n, dim, norm, /*forward=*/true);
  return out;
}

Tensor fft_ihfft_symint(const Tensor& self, c10::optional<c10::SymInt> n, int64_t dim,
                 c10::optional<c10::string_view> norm) {
  return fft_r2c("ihfft", {}, self, n, dim, norm, /*forward=*/false, /*onesided=*/true);
}

Tensor& fft_ihfft_out(const Tensor& self, c10::optional<c10::SymInt> n,
                     int64_t dim, c10::optional<c10::string_view> norm, Tensor& out) {
...
Tensor& fft_fft2_out(const Tensor& self, at::OptionalSymIntArrayRef s,
...
Tensor& fft_ifft2_out(const Tensor& self, at::OptionalSymIntArrayRef s,
                      IntArrayRef dim, c10::optional<c10::string_view> norm, Tensor& out) {
...
Tensor& fft_rfft2_out(const Tensor& self, at::OptionalSymIntArrayRef s,
                      IntArrayRef dim, c10::optional<c10::string_view> norm, Tensor& out) {
...
Tensor& fft_irfft2_out(const Tensor& self, at::OptionalSymIntArrayRef s,
                       IntArrayRef dim, c10::optional<c10::string_view> norm, Tensor& out) {
...
Tensor fft_hfft2(const Tensor& self, at::OptionalSymIntArrayRef s,
                 IntArrayRef dim, c10::optional<c10::string_view> norm) {
...
Tensor fft_ihfft2(const Tensor& self, at::OptionalSymIntArrayRef s,
                  IntArrayRef dim, c10::optional<c10::string_view> norm) {
...
Tensor fft_fftshift_symint(const Tensor& x, at::OptionalIntArrayRef dim_opt) {
