...
std::tuple<Tensor, Tensor> ctc_loss_cpu_template(const Tensor& log_probs, const Tensor& targets, IntListRef input_lengths, IntListRef target_lengths, int64_t BLANK) {
...
template<typename scalar_t, ScalarType target_scalar_type>
Tensor ctc_loss_backward_cpu_template(const Tensor& grad_out, const Tensor& log_probs, const Tensor& targets, IntListRef input_lengths, IntListRef target_lengths,
...
std::tuple<Tensor, Tensor> ctc_loss_cpu(const Tensor& log_probs, const Tensor& targets, IntListRef input_lengths, IntListRef target_lengths, int64_t BLANK) {
...
Tensor ctc_loss_backward_cpu(const Tensor& grad, const Tensor& log_probs, const Tensor& targets, IntListRef input_lengths, IntListRef target_lengths,
                             const Tensor& neg_log_likelihood, const Tensor& log_alpha, int64_t BLANK) {
...
Tensor ctc_loss(const Tensor& log_probs, const Tensor& targets, IntListRef input_lengths, IntListRef target_lengths, int64_t BLANK, int64_t reduction) {
...
Tensor ctc_loss(const Tensor& log_probs, const Tensor& targets, const Tensor& input_lengths, const Tensor& target_lengths, int64_t BLANK, int64_t reduction) {
  ...
  IntListRef il(ilc.data<int64_t>(), ilc.numel());
  IntListRef tl(tlc.data<int64_t>(), tlc.numel());
