...
Tensor& masked_fill__cpu(Tensor& self, const Tensor& mask, Scalar value) {
  // As we dispatch on self and TH is type-checked, we need different
  // definitions. This can be fixed by moving to ATen.
...
Tensor& lt_out_cpu(Tensor& result, const Tensor& self, const Tensor& other) {
  if (result.dtype() == at::ScalarType::Byte) {
    AT_WARN(
        "torch.lt received 'out' parameter with dtype torch.uint8, this behavior is now deprecated,"
...
Tensor& le_out_cpu(Tensor& result, const Tensor& self, const Tensor& other) {
  if (result.dtype() == at::ScalarType::Byte) {
    AT_WARN(
        "torch.le received 'out' parameter with dtype torch.uint8, this behavior is now deprecated,"
        "please use 'out' parameter with dtype torch.bool instead.");
...
Tensor& gt_out_cpu(Tensor& result, const Tensor& self, const Tensor& other) {
  if (result.dtype() == at::ScalarType::Byte) {
    AT_WARN(
        "torch.gt received 'out' parameter with dtype torch.uint8, this behavior is now deprecated,"
        "please use 'out' parameter with dtype torch.bool instead.");
...
Tensor& ge_out_cpu(Tensor& result, const Tensor& self, const Tensor& other) {
  if (result.dtype() == at::ScalarType::Byte) {
    AT_WARN(
        "torch.ge received 'out' parameter with dtype torch.uint8, this behavior is now deprecated,"
        "please use 'out' parameter with dtype torch.bool instead.");
...
Tensor& eq_out_cpu(Tensor& result, const Tensor& self, const Tensor& other) {
  if (result.dtype() == at::ScalarType::Byte) {
    AT_WARN(
        "torch.eq received 'out' parameter with dtype torch.uint8, this behavior is now deprecated,"
        "please use 'out' parameter with dtype torch.bool instead.");
...
Tensor& ne_out_cpu(Tensor& result, const Tensor& self, const Tensor& other) {
  if (result.dtype() == at::ScalarType::Byte) {
    AT_WARN(
        "torch.ne received 'out' parameter with dtype torch.uint8, this behavior is now deprecated,"
        "please use 'out' parameter with dtype torch.bool instead.");
