...
Tensor eye(int64_t n, int64_t m,
  ...
  auto tensor = at::empty({0, 0}, options); // to be resized
...
Tensor& eye_out_cpu(int64_t n, int64_t m, Tensor& result) {
  ...
  AT_DISPATCH_ALL_TYPES_AND_COMPLEX_AND3(at::ScalarType::Half, at::ScalarType::BFloat16, at::ScalarType::Bool, result.scalar_type(), "eye", [&]() -> void {
