...
Tensor global_average_pool(const Tensor& input) {
  ...
  void* maybe_aligned_workspace =
      malloc(workspace_size + workspace_alignment + 16);
  void* aligned_workspace =
      (void*)((size_t)maybe_aligned_workspace + workspace_alignment - (size_t)maybe_aligned_workspace % workspace_alignment);
