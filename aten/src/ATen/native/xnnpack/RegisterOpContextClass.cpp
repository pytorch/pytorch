...
TORCH_LIBRARY(prepacked, m) {
  ...
  m.def(TORCH_SELECTIVE_SCHEMA("prepacked::unpack_prepacked_sizes_conv2d(__torch__.torch.classes.xnnpack.Conv2dOpContext W_prepack) -> (int[], int[], int[], int[], int[], int)"));
}
