...
CREATE_UNARY_FLOAT_META_FUNC(special_bessel_k0)
CREATE_UNARY_FLOAT_META_FUNC(special_bessel_k0e)
CREATE_UNARY_FLOAT_META_FUNC(special_bessel_k1)
CREATE_UNARY_FLOAT_META_FUNC(special_bessel_k1e)
...
CREATE_UNARY_TORCH_IMPL_FUNC(special_bessel_k0_out, special_bessel_k0_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_bessel_k0e_out, special_bessel_k0e_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_bessel_k1_out, special_bessel_k1_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_bessel_k1e_out, special_bessel_k1e_stub)
...
DEFINE_DISPATCH(special_bessel_k0_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_bessel_k0e_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_bessel_k1_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_bessel_k1e_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
