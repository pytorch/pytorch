...
CREATE_UNARY_TORCH_IMPL_FUNC(special_airy_ai_out, special_special_airy_ai_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_airy_bi_out, special_special_airy_bi_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_airy_derivative_ai_out, special_special_airy_derivative_ai_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_airy_derivative_bi_out, special_special_airy_derivative_bi_stub)
...
CREATE_UNARY_TORCH_IMPL_FUNC(special_spherical_bessel_j0_out, special_special_spherical_bessel_j0_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_spherical_bessel_j1_out, special_special_spherical_bessel_j1_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_spherical_bessel_y0_out, special_special_spherical_bessel_y0_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_spherical_bessel_y1_out, special_special_spherical_bessel_y1_stub)
