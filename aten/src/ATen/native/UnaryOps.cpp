...
CREATE_UNARY_FLOAT_META_FUNC(special_airy_bi)
CREATE_UNARY_FLOAT_META_FUNC(special_airy_derivative_ai)
CREATE_UNARY_FLOAT_META_FUNC(special_airy_derivative_bi)
...
CREATE_UNARY_FLOAT_META_FUNC(special_complete_elliptic_integral_e)
CREATE_UNARY_FLOAT_META_FUNC(special_complete_elliptic_integral_k)
CREATE_UNARY_FLOAT_META_FUNC(special_gamma_sign)
CREATE_UNARY_FLOAT_META_FUNC(special_hyperbolic_integral_chi)
CREATE_UNARY_FLOAT_META_FUNC(special_hyperbolic_integral_shi)
...
CREATE_UNARY_FLOAT_META_FUNC(special_scaled_modified_bessel_i0)
CREATE_UNARY_FLOAT_META_FUNC(special_scaled_modified_bessel_i1)
...
CREATE_UNARY_FLOAT_META_FUNC(special_spence)
...
CREATE_UNARY_FLOAT_META_FUNC(special_trigonometric_integral_ci)
CREATE_UNARY_FLOAT_META_FUNC(special_trigonometric_integral_si)
...
CREATE_UNARY_TORCH_IMPL_FUNC(special_airy_bi_out, special_airy_bi_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_airy_derivative_ai_out, special_airy_derivative_ai_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_airy_derivative_bi_out, special_airy_derivative_bi_stub)
...
CREATE_UNARY_TORCH_IMPL_FUNC(special_complete_elliptic_integral_e_out, special_complete_elliptic_integral_e_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_complete_elliptic_integral_k_out, special_complete_elliptic_integral_k_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_gamma_sign_out, special_gamma_sign_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_hyperbolic_integral_chi_out, special_hyperbolic_integral_chi_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_hyperbolic_integral_shi_out, special_hyperbolic_integral_shi_stub)
...
CREATE_UNARY_TORCH_IMPL_FUNC(special_scaled_modified_bessel_i0_out, special_scaled_modified_bessel_i0_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_scaled_modified_bessel_i1_out, special_scaled_modified_bessel_i1_stub)
...
CREATE_UNARY_TORCH_IMPL_FUNC(special_spence_out, special_spence_stub)
...
CREATE_UNARY_TORCH_IMPL_FUNC(special_trigonometric_integral_ci_out, special_trigonometric_integral_ci_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_trigonometric_integral_si_out, special_trigonometric_integral_si_stub)
...
DEFINE_DISPATCH(special_airy_bi_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_airy_derivative_ai_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_airy_derivative_bi_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
...
DEFINE_DISPATCH(special_complete_elliptic_integral_e_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_complete_elliptic_integral_k_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_gamma_sign_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_hyperbolic_integral_chi_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_hyperbolic_integral_shi_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
...
DEFINE_DISPATCH(special_scaled_modified_bessel_i0_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_scaled_modified_bessel_i1_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
...
DEFINE_DISPATCH(special_spence_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
...
DEFINE_DISPATCH(special_trigonometric_integral_ci_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_trigonometric_integral_si_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
} // namespace native
} // namespace at
