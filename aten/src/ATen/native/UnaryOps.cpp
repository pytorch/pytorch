...
CREATE_UNARY_FLOAT_META_FUNC(special_dawson)
...
CREATE_UNARY_TORCH_IMPL_FUNC(special_dawson_out, special_dawson_stub)
...
DEFINE_DISPATCH(special_dawson_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
