...
CREATE_UNARY_FLOAT_META_FUNC(special_complete_elliptic_integral_k_e)
CREATE_UNARY_FLOAT_META_FUNC(special_complete_elliptic_integral_k_k)
CREATE_UNARY_FLOAT_META_FUNC(special_complete_elliptic_integral_m_e)
CREATE_UNARY_FLOAT_META_FUNC(special_complete_elliptic_integral_m_k)
...
CREATE_UNARY_TORCH_IMPL_FUNC(special_complete_elliptic_integral_m_e_out, special_complete_elliptic_integral_m_e_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_complete_elliptic_integral_m_k_out, special_complete_elliptic_integral_m_k_stub)
...
DEFINE_DISPATCH(special_complete_elliptic_integral_m_e_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_complete_elliptic_integral_m_k_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
