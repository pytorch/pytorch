...
CREATE_UNARY_FLOAT_META_FUNC(special_logerfcx)
CREATE_UNARY_FLOAT_META_FUNC(special_logerfc)
...
CREATE_UNARY_TORCH_IMPL_FUNC(special_logerfcx_out, special_logerfcx_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_logerfc_out, special_logerfc_stub)
...
DEFINE_DISPATCH(special_logerfcx_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_logerfc_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
