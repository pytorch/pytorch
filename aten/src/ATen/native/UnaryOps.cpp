...
CREATE_UNARY_FLOAT_META_FUNC(special_bessel_j_0)
CREATE_UNARY_FLOAT_META_FUNC(special_bessel_j_1)
CREATE_UNARY_FLOAT_META_FUNC(special_bessel_y_0)
CREATE_UNARY_FLOAT_META_FUNC(special_bessel_y_1)
CREATE_UNARY_FLOAT_META_FUNC(special_cos_pi)
CREATE_UNARY_FLOAT_META_FUNC(special_cosh_pi)
CREATE_UNARY_FLOAT_META_FUNC(special_exp_modified_bessel_k_0)
CREATE_UNARY_FLOAT_META_FUNC(special_exp_modified_bessel_k_1)
CREATE_UNARY_FLOAT_META_FUNC(special_modified_bessel_i_0)
CREATE_UNARY_FLOAT_META_FUNC(special_modified_bessel_i_1)
CREATE_UNARY_FLOAT_META_FUNC(special_modified_bessel_k_0)
CREATE_UNARY_FLOAT_META_FUNC(special_modified_bessel_k_1)
CREATE_UNARY_FLOAT_META_FUNC(special_sin_pi)
CREATE_UNARY_FLOAT_META_FUNC(special_sinc)
CREATE_UNARY_FLOAT_META_FUNC(special_sinc_pi)
CREATE_UNARY_FLOAT_META_FUNC(special_sinh_pi)
CREATE_UNARY_FLOAT_META_FUNC(special_sinhc)
CREATE_UNARY_FLOAT_META_FUNC(special_sinhc_pi)
CREATE_UNARY_FLOAT_META_FUNC(special_spherical_bessel_j_0)
CREATE_UNARY_FLOAT_META_FUNC(special_tan_pi)
CREATE_UNARY_FLOAT_META_FUNC(special_tanh_pi)
...
CREATE_UNARY_TORCH_IMPL_FUNC(special_bessel_j_0_out, special_bessel_j_0_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_bessel_j_1_out, special_bessel_j_1_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_bessel_y_0_out, special_bessel_y_0_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_bessel_y_1_out, special_bessel_y_1_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_cos_pi_out, special_cos_pi_stub);
CREATE_UNARY_TORCH_IMPL_FUNC(special_cosh_pi_out, special_cosh_pi_stub);
CREATE_UNARY_TORCH_IMPL_FUNC(special_exp_modified_bessel_k_0_out, special_exp_modified_bessel_k_0_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_exp_modified_bessel_k_1_out, special_exp_modified_bessel_k_1_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_modified_bessel_i_0_out, special_modified_bessel_i_0_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_modified_bessel_i_1_out, special_modified_bessel_i_1_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_modified_bessel_k_0_out, special_modified_bessel_k_0_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_modified_bessel_k_1_out, special_modified_bessel_k_1_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_sin_pi_out, special_sin_pi_stub);
CREATE_UNARY_TORCH_IMPL_FUNC(special_sinc_out, special_sinc_stub);
CREATE_UNARY_TORCH_IMPL_FUNC(special_sinc_pi_out, special_sinc_pi_stub);
CREATE_UNARY_TORCH_IMPL_FUNC(special_sinh_pi_out, special_sinh_pi_stub);
CREATE_UNARY_TORCH_IMPL_FUNC(special_sinhc_out, special_sinhc_stub);
CREATE_UNARY_TORCH_IMPL_FUNC(special_sinhc_pi_out, special_sinhc_pi_stub);
CREATE_UNARY_TORCH_IMPL_FUNC(special_spherical_bessel_j_0_out, special_spherical_bessel_j_0_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_tan_pi_out, special_tan_pi_stub);
CREATE_UNARY_TORCH_IMPL_FUNC(special_tanh_pi_out, special_tanh_pi_stub);
...
DEFINE_DISPATCH(special_bessel_j_0_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_bessel_j_1_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_bessel_y_0_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_bessel_y_1_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_cos_pi_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_cosh_pi_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_exp_modified_bessel_k_0_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_exp_modified_bessel_k_1_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_modified_bessel_i_0_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_modified_bessel_i_1_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_modified_bessel_k_0_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_modified_bessel_k_1_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_sin_pi_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_sinc_pi_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_sinc_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_sinh_pi_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_sinhc_pi_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_sinhc_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_spherical_bessel_j_0_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_tan_pi_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_tanh_pi_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
