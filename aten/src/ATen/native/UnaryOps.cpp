...
CREATE_UNARY_FLOAT_META_FUNC(special_ellipe)
CREATE_UNARY_FLOAT_META_FUNC(special_ellipk)
...
CREATE_UNARY_TORCH_IMPL_FUNC(special_ellipe_out, special_ellpe_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_ellipk_out, special_ellpk_stub)
...
DEFINE_DISPATCH(special_ellpe_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_ellpk_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
