...
CREATE_UNARY_FLOAT_META_FUNC(special_prime_number)
...
CREATE_UNARY_TORCH_IMPL_FUNC(special_prime_number_out, special_prime_number_stub)
...
DEFINE_DISPATCH(special_prime_number_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
