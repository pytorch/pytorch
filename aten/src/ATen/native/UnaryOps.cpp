...
DEFINE_DISPATCH(i1_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(i1e_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
