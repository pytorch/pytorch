...
CREATE_UNARY_TORCH_IMPL_FUNC(special_hyperbolic_integral_chi_out, special_special_hyperbolic_integral_chi_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_hyperbolic_integral_shi_out, special_special_hyperbolic_integral_shi_stub)
...
CREATE_UNARY_TORCH_IMPL_FUNC(special_trigonometric_integral_ci_out, special_special_trigonometric_integral_ci_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_trigonometric_integral_si_out, special_special_trigonometric_integral_si_stub)
