...
CREATE_UNARY_FLOAT_META_FUNC(special_exponential_integral_e1)
CREATE_UNARY_FLOAT_META_FUNC(special_exponential_integral_ei)
...
CREATE_UNARY_TORCH_IMPL_FUNC(special_exponential_integral_e1_out, special_exponential_integral_e1_stub)
CREATE_UNARY_TORCH_IMPL_FUNC(special_exponential_integral_ei_out, special_exponential_integral_ei_stub)
...
DEFINE_DISPATCH(special_exponential_integral_e1_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
DEFINE_DISPATCH(special_exponential_integral_ei_stub); // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
