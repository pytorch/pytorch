...
static inline void flip_check_errors(int64_t total_dims, int64_t flip_dims_size, IntListRef dims) {
...
static inline Tensor roll_common(const Tensor& self, IntListRef shifts, IntListRef dims) {
