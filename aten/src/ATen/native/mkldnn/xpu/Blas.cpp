...
Tensor& _int_mm_out_xpu(const Tensor& self, const Tensor& mat2, Tensor& result) {
  ...
  TORCH_CHECK(self.dtype() == at::kChar, ": Expected self dtype to be of type int8 but got ", self.dtype());
  TORCH_CHECK(mat2.dtype() == at::kChar, ": Expected mat2 dtype to be of type int8 but got ", mat2.dtype());
