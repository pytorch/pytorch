...
at::Tensor mkldnn_convolution_backward_input(
    ...
    IntListRef padding, IntListRef stride, IntListRef dilation, int64_t groups, bool bias_defined) {
...
std::tuple<at::Tensor,at::Tensor,at::Tensor> mkldnn_convolution_backward(
    ...
    IntListRef padding, IntListRef stride, IntListRef dilation, int64_t groups, std::array<bool,3> output_mask) {
