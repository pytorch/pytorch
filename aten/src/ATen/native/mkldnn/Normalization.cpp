...
std::tuple<Tensor, Tensor, Tensor> mkldnn_batch_norm_legit(
    ...
    double momentum,
    double eps) {
  TORCH_CHECK(false, "mkldnn_batch_norm_legit: ATen not compiled with MKLDNN support");
}


std::tuple<Tensor, Tensor, Tensor> mkldnn_batch_norm_legit_no_stats(
