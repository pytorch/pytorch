...
#endif
  Tensor serialized_md = at::from_blob(reinterpret_cast<void*>(serialized_wei_desc.data()), {static_cast<int64_t>(serialized_wei_desc.size())}, at::TensorOptions(at::kByte));
