...
This will assume that the func syntax follows the JIT IR. This is a temporary
attribute and doesn't need to be set by developers outside the core team. 
Remove it if you trigger asserts and add cpuhrsch to your PR. It serves as
a means of tracking an ongoing schema unification with the goal of aligning
func syntax with other components of PyTorch in order to reduce overall
complexity and match coverage of different function descriptions.
