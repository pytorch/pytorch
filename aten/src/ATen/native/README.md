...
generate a DeviceGuard invocation, which will ensure that input tenros are all on the common device and
kernel code will run with the current device set
...
`common_device_guard: False` to your function definition.
