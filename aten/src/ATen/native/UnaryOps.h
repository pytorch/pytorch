...
DECLARE_DISPATCH(unary_fn, special_bessel_k0_stub);
DECLARE_DISPATCH(unary_fn, special_bessel_k0e_stub);
DECLARE_DISPATCH(unary_fn, special_bessel_k1_stub);
DECLARE_DISPATCH(unary_fn, special_bessel_k1e_stub);
