...
DECLARE_DISPATCH(
    void (*)(Tensor&, const Tensor&, c10::optional<Generator>),
    bernoulli_tensor_stub);
DECLARE_DISPATCH(
    void (*)(Tensor&, const double, c10::optional<Generator>),
...
DECLARE_DISPATCH(
    ...
    uniform_stub);
DECLARE_DISPATCH(
    void (*)(Tensor&, const double, const double, c10::optional<Generator>),
    normal_stub);
DECLARE_DISPATCH(
    void (*)(
        TensorIteratorBase&,
