...
DECLARE_DISPATCH(unary_fn, special_airy_bi_stub);
DECLARE_DISPATCH(unary_fn, special_airy_derivative_ai_stub);
DECLARE_DISPATCH(unary_fn, special_airy_derivative_bi_stub);
...
DECLARE_DISPATCH(unary_fn, special_complete_elliptic_integral_e_stub);
DECLARE_DISPATCH(unary_fn, special_complete_elliptic_integral_k_stub);
DECLARE_DISPATCH(unary_fn, special_gamma_sign_stub);
DECLARE_DISPATCH(unary_fn, special_hyperbolic_integral_chi_stub);
DECLARE_DISPATCH(unary_fn, special_hyperbolic_integral_shi_stub);
...
DECLARE_DISPATCH(unary_fn, special_scaled_modified_bessel_i0_stub);
DECLARE_DISPATCH(unary_fn, special_scaled_modified_bessel_i1_stub);
...
DECLARE_DISPATCH(unary_fn, special_spence_stub);
DECLARE_DISPATCH(unary_fn, special_spherical_bessel_j0_stub);
DECLARE_DISPATCH(unary_fn, special_spherical_bessel_j1_stub);
DECLARE_DISPATCH(unary_fn, special_spherical_bessel_y0_stub);
DECLARE_DISPATCH(unary_fn, special_spherical_bessel_y1_stub);
DECLARE_DISPATCH(unary_fn, special_trigonometric_integral_ci_stub);
DECLARE_DISPATCH(unary_fn, special_trigonometric_integral_si_stub);
