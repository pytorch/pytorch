...
DECLARE_DISPATCH(structured_unary_fn, special_i0e_stub);
DECLARE_DISPATCH(structured_unary_fn, special_i1_stub);
DECLARE_DISPATCH(structured_unary_fn, special_i1e_stub);
