...
DECLARE_DISPATCH(unary_fn, special_complete_elliptic_integral_k_e_stub);
DECLARE_DISPATCH(unary_fn, special_complete_elliptic_integral_k_k_stub);
DECLARE_DISPATCH(unary_fn, special_complete_elliptic_integral_m_e_stub);
DECLARE_DISPATCH(unary_fn, special_complete_elliptic_integral_m_k_stub);
