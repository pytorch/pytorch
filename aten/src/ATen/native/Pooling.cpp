...
Tensor adaptive_avg_pool1d(const Tensor & self, IntListRef output_size) {
...
std::tuple<Tensor,Tensor> adaptive_max_pool1d(const Tensor & self, IntListRef output_size) {
