...
Tensor onednn_max_pool2d(
    ...
    bool ceil_mode) {
  TORCH_CHECK(false, "onednn_max_pool2d: ATen not compiled with MKLDNN support");
}
...
Tensor onednn_max_pool3d(
    ...
    IntArrayRef dilation,
    bool ceil_mode) {
  TORCH_CHECK(false, "onednn_max_pool3d: ATen not compiled with MKLDNN support");
}
...
Tensor onednn_avg_pool2d(
  ...
  TORCH_CHECK(false, "onednn_avg_pool2d: ATen not compiled with MKLDNN support");
}
...
Tensor& onednn_avg_pool2d_out(const Tensor& self,
    ...
    std::optional<int64_t> divisor_override,
    Tensor& output) {
  TORCH_CHECK(false, "onednn_avg_pool2d_out: ATen not compiled with MKLDNN support");
}
...
Tensor onednn_avg_pool3d(
    ...
    bool count_include_pad,
    std::optional<int64_t> divisor_override) {
  TORCH_CHECK(false, "onednn_avg_pool3d: ATen not compiled with MKLDNN support");
}
...
Tensor& onednn_avg_pool3d_out(const Tensor& self,
    ...
    std::optional<int64_t> divisor_override,
    Tensor& output) {
  TORCH_CHECK(false, "onednn_avg_pool3d_out: ATen not compiled with MKLDNN support");
}

Tensor onednn_adaptive_avg_pool2d(Tensor const& input, IntArrayRef output_size) {
  TORCH_CHECK(false, "onednn_adaptive_avg_pool2d: ATen not compiled with MKLDNN support");
}

Tensor& onednn_adaptive_avg_pool2d_out_stub(const Tensor& input,
    IntArrayRef output_size,
    Tensor& output) {
  TORCH_CHECK(false, "onednn_adaptive_avg_pool2d_out_stub: ATen not compiled with MKLDNN support");
}

Tensor& onednn_adaptive_avg_pool2d_out(const Tensor& input,
    IntArrayRef output_size,
    Tensor& output) {
  TORCH_CHECK(false, "onednn_adaptive_avg_pool2d_out: ATen not compiled with MKLDNN support");
}
...
Tensor onednn_max_pool2d_backward(
    ...
    IntArrayRef dilation,
    bool ceil_mode) {
  TORCH_CHECK(false, "onednn_max_pool2d_backward: ATen not compiled with MKLDNN support");
}
...
Tensor onednn_max_pool3d_backward(
    ...
    IntArrayRef dilation,
    bool ceil_mode) {
  TORCH_CHECK(false, "onednn_max_pool3d_backward: ATen not compiled with MKLDNN support");
}
...
Tensor& onednn_avg_pool2d_backward_out(const Tensor & grad_output,
    ...
    std::optional<int64_t> divisor_override,
    Tensor & grad_input) {
  TORCH_CHECK(false, "onednn_avg_pool2d_backward_out: ATen not compiled with MKLDNN support");
}
...
Tensor onednn_avg_pool2d_backward(
    ...
    bool count_include_pad,
    std::optional<int64_t> divisor_override) {
  TORCH_CHECK(false, "onednn_avg_pool2d_backward: ATen not compiled with MKLDNN support");
}
...
Tensor& onednn_avg_pool3d_backward_out(const Tensor & grad_output,
    ...
    std::optional<int64_t> divisor_override,
    Tensor & grad_input) {
  TORCH_CHECK(false, "onednn_avg_pool3d_backward_out: ATen not compiled with MKLDNN support");
}
...
Tensor onednn_avg_pool3d_backward(
    ...
    bool count_include_pad,
    std::optional<int64_t> divisor_override) {
  TORCH_CHECK(false, "onednn_avg_pool3d_backward: ATen not compiled with MKLDNN support");
}

Tensor onednn_adaptive_avg_pool2d_backward(
    const Tensor& grad_output,
    const Tensor& input) {
  TORCH_CHECK(false, "onednn_adaptive_avg_pool2d_backward: ATen not compiled with MKLDNN support");
}
...
Tensor& onednn_avg_pool2d_out(const Tensor& input,
    ...
    std::optional<int64_t> divisor_override,
    Tensor& output) {
  TORCH_CHECK(false, "onednn_avg_pool2d_out: in-place mkldnn operations are not supported yet");
}
...
Tensor& onednn_avg_pool3d_out(const Tensor& input,
    ...
    std::optional<int64_t> divisor_override,
    Tensor& output) {
  TORCH_CHECK(false, "onednn_avg_pool3d_out: in-place mkldnn operations are not supported yet");
}
...
Tensor& onednn_adaptive_avg_pool2d_out_stub(const Tensor& input,
    IntArrayRef output_size,
    Tensor& output) {
  TORCH_CHECK(false, "onednn_adaptive_avg_pool2d_out_stub: in-place mkldnn operations are not supported yet");
}
...
Tensor& onednn_avg_pool2d_backward_out(const Tensor & grad_output,
    ...
    std::optional<int64_t> divisor_override,
    Tensor & grad_input) {
  TORCH_CHECK(false, "onednn_avg_pool2d_backward_out: in-place mkldnn operations are not supported yet");
}
...
Tensor& onednn_avg_pool3d_backward_out(const Tensor & grad_output,
    ...
    std::optional<int64_t> divisor_override,
    Tensor & grad_input) {
  TORCH_CHECK(false, "onednn_avg_pool3d_backward_out: in-place mkldnn operations are not supported yet");
}
