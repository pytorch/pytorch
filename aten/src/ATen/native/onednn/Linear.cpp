...
static bool use_mkldnn_bf32_linear() {
  return at::globalContext().float32Precision(at::Float32Backend::ONEDNN, at::Float32Op::MATMUL) == at::Float32Precision::BF16 &&
      onednn_bf16_device_check();
}

static bool use_mkldnn_tf32_linear() {
#if defined(__x86_64__) || defined(_M_X64)
    return at::globalContext().float32Precision(at::Float32Backend::ONEDNN, at::Float32Op::MATMUL) == at::Float32Precision::TF32 &&
