...
Tensor onednn_linear(
  ...
  TORCH_CHECK(false, "onednn_linear: ATen not compiled with MKLDNN support");
}
Tensor onednn_linear_backward_input(
    IntArrayRef input_size, const Tensor& grad_output, const Tensor& weight) {
  TORCH_CHECK(false, "onednn_linear_backward_input: ATen not compiled with MKLDNN support");
}
...
std::tuple<Tensor, Tensor> onednn_linear_backward_weights(
  ...
  TORCH_CHECK(false, "onednn_linear_backward_weights: ATen not compiled with MKLDNN support");
}
...
std::tuple<Tensor, Tensor, Tensor> onednn_linear_backward(
  ...
  TORCH_CHECK(false, "onednn_linear_backward: ATen not compiled with MKLDNN support");
}
...
Tensor onednn_linear(
  ...
  TORCH_CHECK(self.is_mkldnn(),
      "onednn_linear: input needs to be mkldnn layout");
...
Tensor onednn_linear_backward_input(
  ...
  TORCH_CHECK(grad_output.is_mkldnn(),
      "onednn_linear_backward: grad_output needs to be mkldnn layout");
...
std::tuple<Tensor, Tensor> onednn_linear_backward_weights(
  ...
  TORCH_CHECK(grad_output.is_mkldnn() && input.is_mkldnn(),
      "onednn_linear_backward: grad_output and input needs to be mkldnn layout");
...
static Tensor onednn_linear_pointwise_binary(
  ...
  if (onednn_bias.has_value()) {
    ...
    ideep::inner_product_forward::compute_binary</*reorder_src=*/false, /*reorder_weight=*/false>(
        onednn_input, onednn_other, w, onednn_output, op_attr);
  }
