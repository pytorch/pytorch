...
Tensor onednn_sigmoid(const Tensor& self) {
  TORCH_CHECK(false, "onednn_sigmoid: ATen not compiled with MKLDNN support");
}

Tensor& onednn_sigmoid_(Tensor& self) {
  TORCH_CHECK(false, "onednn_sigmoid_: ATen not compiled with MKLDNN support");
}

Tensor onednn_tanh(const Tensor& self) {
  TORCH_CHECK(false, "onednn_tanh: ATen not compiled with MKLDNN support");
}

Tensor& onednn_tanh_(Tensor& self) {
  TORCH_CHECK(false, "onednn_tanh_: ATen not compiled with MKLDNN support");
}
