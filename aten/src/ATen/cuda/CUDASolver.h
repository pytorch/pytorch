...
#define CUSOLVER_LSVLU_ARGTYPES(scalar_t, value_t)                         \
...
inline void lsvlu(CUSOLVER_LSVLU_ARGTYPES(scalar_t, value_t)) {
...
template <>
void lsvlu<float, float>(CUSOLVER_LSVLU_ARGTYPES(float, float));
template <>
