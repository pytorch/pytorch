...
// Callback to initialize Magma, which is set by torch_cuda_cu. This
// indirection is required so magma_init is called in the same library
// where Magma will be used.
TORCH_CUDA_CPP_API extern std::function<void()> magma_init_fn;
