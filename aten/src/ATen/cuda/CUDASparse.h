...
// ROCm is not enabled
    ...
    ((CUSPARSE_VERSION >= 10300) ||                         \
     (CUSPARSE_VERSION >= 11000 && defined(_WIN32)))
...
#if defined(CUDART_VERSION) && defined(CUSPARSE_VERSION) && \
    (CUSPARSE_VERSION >= 11600)
#define AT_USE_CUSPARSE_GENERIC_SPSM() 1
#else
#define AT_USE_CUSPARSE_GENERIC_SPSM() 0
#endif

// cuSparse Generic API sddmm function was added in CUDA 11.2.1 (cuSparse
// version 11400)
#if defined(CUDART_VERSION) && defined(CUSPARSE_VERSION) && \
...
#if defined(CUDART_VERSION) || (defined(USE_ROCM) && ROCM_VERSION >= 40500)
