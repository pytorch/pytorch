...
static inline void sort_keys(
  ...
  if (descending) {
    CUB_WRAPPER(
        NO_ROCM(detail)::cub::DeviceRadixSort::SortKeysDescending,
        keys_in_,
        keys_out_,
        n,
        begin_bit,
    ...
    CUB_WRAPPER(
        NO_ROCM(detail)::cub::DeviceRadixSort::SortKeys,
        keys_in_,
        keys_out_,
        n,
        begin_bit,
...
static inline void sort_pairs(
  ...
  if (descending) {
    CUB_WRAPPER(
        NO_ROCM(detail)::cub::DeviceRadixSort::SortPairsDescending,
        keys_in_,
        keys_out_,
        values_in_,
        values_out_,
    ...
    CUB_WRAPPER(
        NO_ROCM(detail)::cub::DeviceRadixSort::SortPairs,
        keys_in_,
        keys_out_,
        values_in_,
        values_out_,
...
static inline void segmented_sort_pairs(
  ...
  if (descending) {
    CUB_WRAPPER(
        NO_ROCM(detail)::cub::DeviceSegmentedRadixSort::SortPairsDescending,
        keys_in_,
        keys_out_,
        values_in_,
        values_out_,
    ...
    CUB_WRAPPER(
        NO_ROCM(detail)::cub::DeviceSegmentedRadixSort::SortPairs,
        keys_in_,
        keys_out_,
        values_in_,
        values_out_,
