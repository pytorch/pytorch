...
AT_FORALL_SCALAR_TYPES_AND2(Bool, Half, AT_INSTANTIATE_SORT_PAIRS_4)
AT_INSTANTIATE_SORT_PAIRS(uint16_t, 4)
AT_INSTANTIATE_SORT_PAIRS(uint32_t, 4)
AT_INSTANTIATE_SORT_PAIRS(uint64_t, 4)
...
AT_FORALL_SCALAR_TYPES_AND2(Bool, Half, AT_INSTANTIATE_SORT_PAIRS_2)
AT_INSTANTIATE_SORT_PAIRS(uint16_t, 2)
AT_INSTANTIATE_SORT_PAIRS(uint32_t, 2)
AT_INSTANTIATE_SORT_PAIRS(uint64_t, 2)
...
AT_FORALL_SCALAR_TYPES_AND2(Bool, Half, AT_INSTANTIATE_SORT_PAIRS_1)
AT_INSTANTIATE_SORT_PAIRS(uint16_t, 1)
AT_INSTANTIATE_SORT_PAIRS(uint32_t, 1)
AT_INSTANTIATE_SORT_PAIRS(uint64_t, 1)
