...
#if !defined(__HIP_PLATFORM_HCC__) || \
    (defined(__HIP_PLATFORM_HCC__) && HIP_VERSION >= 210)
template <>
...
void gemv<c10::complex<float>>(CUDABLAS_GEMV_ARGTYPES(c10::complex<float>)) {
  ...
  TORCH_CUDABLAS_CHECK(cublasCgemv(
      handle,
      op,
      m,
      n,
...
void dot<c10::complex<double>>(CUDABLAS_DOT_ARGTYPES(c10::complex<double>)) {
  TORCH_CUDABLAS_CHECK(cublasZdotu(
      handle,
      n,
      reinterpret_cast<const cuDoubleComplex*>(x),
      incx,
...
void dot<c10::complex<float>>(CUDABLAS_DOT_ARGTYPES(c10::complex<float>)) {
  TORCH_CUDABLAS_CHECK(cublasCdotu(
      handle,
      n,
      reinterpret_cast<const cuComplex*>(x),
      incx,
...
void vdot<c10::complex<float>>(CUDABLAS_DOT_ARGTYPES(c10::complex<float>)) {
  TORCH_CUDABLAS_CHECK(cublasCdotc(
      handle,
      n,
      reinterpret_cast<const cuComplex*>(x),
      incx,
...
void vdot<c10::complex<double>>(CUDABLAS_DOT_ARGTYPES(c10::complex<double>)) {
  TORCH_CUDABLAS_CHECK(cublasZdotc(
      handle,
      n,
      reinterpret_cast<const cuDoubleComplex*>(x),
      incx,
...
// This guards blocks use of geqrfBatched, getrfBatched, getriBatched on
// platforms other than cuda
