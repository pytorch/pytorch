...
void CPUGeneratorImpl::set_state(const c10::TensorImpl& new_state) {
  ...
  static_assert(c10::is_pod_v<CPUGeneratorImplStateLegacy>, "CPUGeneratorImplStateLegacy is not a PODType");
  static_assert(c10::is_pod_v<CPUGeneratorImplState>, "CPUGeneratorImplState is not a PODType");
