...
TORCH_LIBRARY_IMPL(aten, Autocast, m) {
  ...
  KERNEL(ADD_NS(addmm), "addmm", Tensor (const Tensor &, const Tensor &, const Tensor &, const Scalar&, const Scalar&, c10::optional<ScalarType>), lower_precision_fp)
  ...
  KERNEL(ADD_NS(matmul), "matmul", Tensor (const Tensor &, const Tensor &, c10::optional<ScalarType>), lower_precision_fp)
  KERNEL(ADD_NS(mm), "mm", Tensor (const Tensor &, const Tensor &, c10::optional<ScalarType>), lower_precision_fp)
  ...
  KERNEL(ADD_NS(baddbmm), "baddbmm", Tensor (const Tensor &, const Tensor &, const Tensor &, const Scalar&, const Scalar&, c10::optional<ScalarType>), lower_precision_fp)
  KERNEL(ADD_NS(bmm), "bmm", Tensor (const Tensor &, const Tensor &, c10::optional<ScalarType>), lower_precision_fp)
...
TORCH_LIBRARY_IMPL(aten, AutocastCPU, m) {
  ...
  KERNEL_CPU(ADD_NS(bmm), "bmm", Tensor (const Tensor &, const Tensor &, c10::optional<ScalarType>), lower_precision_fp)
  KERNEL_CPU(ADD_NS(mm), "mm", Tensor (const Tensor &, const Tensor &, c10::optional<ScalarType>), lower_precision_fp)
  KERNEL_CPU(ADD_NS(baddbmm), "baddbmm", Tensor (const Tensor &, const Tensor &, const Tensor &, const Scalar&, const Scalar&, c10::optional<ScalarType>), lower_precision_fp)
  KERNEL_CPU(ADD_NS(addmm), "addmm", Tensor (const Tensor &, const Tensor &, const Tensor &, const Scalar&, const Scalar&, c10::optional<ScalarType>), lower_precision_fp)
