...
TORCH_LIBRARY_IMPL(aten, Autocast, m) {
  ...
  KERNEL_CUDA(upsample_nearest1d, fp32)
  KERNEL_CUDA(_upsample_nearest_exact1d, fp32)
  KERNEL_CUDA(upsample_nearest2d, fp32)
  KERNEL_CUDA(_upsample_nearest_exact2d, fp32)
  KERNEL_CUDA(upsample_nearest3d, fp32)
  KERNEL_CUDA(_upsample_nearest_exact3d, fp32)
  KERNEL_CUDA(upsample_linear1d, fp32)
  KERNEL_CUDA(upsample_bilinear2d, fp32)
  KERNEL_CUDA(_upsample_bilinear2d_aa, fp32)
  KERNEL_CUDA(upsample_trilinear3d, fp32)
  KERNEL_CUDA(upsample_bicubic2d, fp32)
  KERNEL_CUDA(_upsample_bicubic2d_aa, fp32)
  // fp32_set_opt_dtype
