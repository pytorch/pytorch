...
TORCH_LIBRARY_IMPL(aten, Autocast, m) {
  ...
  m.impl("binary_cross_entropy",
    c10::impl::hacky_wrapper_for_legacy_signatures<Tensor(const Tensor &, const Tensor &, c10::optional<Tensor>, int64_t)>(TORCH_FN((&at::autocast::binary_cross_entropy_banned))));
}
