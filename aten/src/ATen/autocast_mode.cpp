...
void set_xpu_enabled(bool new_enabled) {
  c10::impl::tls_set_dispatch_key_excluded(
      DispatchKey::AutocastXPU, !new_enabled);
}
...
// Move cast_cache to an inline function in a header with cached_casts declared
// as extern thread_local in the header.
Tensor cached_cast(
...
TORCH_LIBRARY_IMPL(aten, Autocast, m) {
  ...
  KERNEL(
      ADD_NS(einsum),
      "einsum",
      Tensor(c10::string_view, TensorList),
      lower_precision_fp)
  KERNEL(
      ADD_NS(mm),
      "mm",
  ...
  // write them manually
  m.impl(
      TORCH_SELECTIVE_NAME("aten::_thnn_fused_lstm_cell"),
  ...
  m.impl(
      "rnn_tanh_cell", // tanh unary op is executed as a cuda math library call.
      TORCH_FN((&WrapFunction<
                CastPolicy::lower_precision_fp,
                DeviceType::CUDA,
                Tensor(
  ...
  KERNEL(
      ADD_NS(prod),
      "prod",
      Tensor(const Tensor&, c10::optional<ScalarType>),
      fp32_set_opt_dtype)
  KERNEL(
      ADD_NS(prod),
      "prod.dim_int",
      Tensor(const Tensor&, int64_t, bool, c10::optional<ScalarType>),
      fp32_set_opt_dtype)
  KERNEL(
      ADD_NS(prod),
      "prod.dim_Dimname",
      Tensor(const Tensor&, Dimname, bool, c10::optional<ScalarType>),
      fp32_set_opt_dtype)
  KERNEL(
      ADD_NS(softmax),
      "softmax.int",
  ...
  // KERNEL(ADD_NS(norm), "norm.ScalarOpt_dtype", Tensor (const Tensor &,
  // c10::optional<Scalar>, ScalarType), fp32_set_opt_dtype)
  // KERNEL(ADD_NS(norm), "norm.ScalarOpt_dim_dtype", Tensor (const Tensor &,
  // c10::optional<Scalar>, IntArrayRef, bool, ScalarType), fp32_set_opt_dtype)
  // KERNEL(ADD_NS(norm), "norm.names_ScalarOpt_dim_dtype", Tensor (const Tensor
  // &, c10::optional<Scalar>, DimnameList, bool, ScalarType),
  // fp32_set_opt_dtype)
  KERNEL(
      ADD_NS(sum),
      "sum",
  ...
  KERNEL(
      ADD_NS(sum),
      "sum.dim_IntList",
      Tensor(const Tensor&, IntArrayRef, bool, c10::optional<ScalarType>),
      fp32_set_opt_dtype)
  KERNEL(
      ADD_NS(sum),
      "sum.dim_DimnameList",
      Tensor(const Tensor&, DimnameList, bool, c10::optional<ScalarType>),
      fp32_set_opt_dtype)
  // fp32_append_dtype
...
TORCH_LIBRARY_IMPL(aten, AutocastCPU, m) {
  ...
  KERNEL_CPU(
      ADD_NS(view_as_complex), "view_as_complex", Tensor(const Tensor&), fp32)
  ...
  KERNEL_CPU(
      ...
      fp32)
  KERNEL_CPU(
      ADD_NS(matrix_rank), "matrix_rank", Tensor(const Tensor&, bool), fp32)
  ...
  KERNEL_CPU(
      ...
      "max_unpool3d",
      Tensor(
          const Tensor&, const Tensor&, IntArrayRef, IntArrayRef, IntArrayRef),
      fp32)
  KERNEL_CPU(
  ...
  KERNEL_CPU(
      ...
      "linalg_svdvals",
      Tensor(const Tensor&, c10::optional<c10::string_view>),
      fp32)
  KERNEL_CPU(
      ADD_NS(linalg_eigvals), "linalg_eigvals", Tensor(const Tensor&), fp32)
  KERNEL_CPU(
  ...
  KERNEL_CPU(
      ...
      "linalg_tensorsolve",
      Tensor(const Tensor&, const Tensor&, at::OptionalIntArrayRef),
      fp32)
  KERNEL_CPU(
  ...
  m.impl(
      TORCH_SELECTIVE_NAME("aten::geqrf"),
      TORCH_FN((&WrapFunction<
                CastPolicy::fp32,
                DeviceType::CPU,
  ...
  m.impl(
      TORCH_SELECTIVE_NAME("aten::lstsq"),
      TORCH_FN((&WrapFunction<
                CastPolicy::fp32,
                DeviceType::CPU,
  ...
  m.impl(
      TORCH_SELECTIVE_NAME("aten::_lu_with_info"),
      TORCH_FN((&WrapFunction<
                CastPolicy::fp32,
                DeviceType::CPU,
  ...
  m.impl(
      TORCH_SELECTIVE_NAME("aten::symeig"),
      TORCH_FN((&WrapFunction<
                CastPolicy::fp32,
                DeviceType::CPU,
  ...
  m.impl(
      TORCH_SELECTIVE_NAME("aten::triangular_solve"),
      TORCH_FN((&WrapFunction<
                CastPolicy::fp32,
                DeviceType::CPU,
                std::tuple<Tensor, Tensor>(
                    const Tensor&, const Tensor&, bool, bool, bool),
                std::tuple<Tensor, Tensor>(
                    const Tensor&, const Tensor&, bool, bool, bool),
                &ADD_NS(triangular_solve)>::type::call)));

  m.impl(
      TORCH_SELECTIVE_NAME("aten::fractional_max_pool2d"),
      TORCH_FN((&WrapFunction<
                CastPolicy::fp32,
                DeviceType::CPU,
                std::tuple<Tensor, Tensor>(
                    const Tensor&, IntArrayRef, IntArrayRef, const Tensor&),
                std::tuple<Tensor, Tensor>(
                    const Tensor&, IntArrayRef, IntArrayRef, const Tensor&),
                &ADD_NS(fractional_max_pool2d)>::type::call)));

  m.impl(
      TORCH_SELECTIVE_NAME("aten::fractional_max_pool3d"),
      TORCH_FN((&WrapFunction<
                CastPolicy::fp32,
                DeviceType::CPU,
                std::tuple<Tensor, Tensor>(
  ...
  m.impl(
      TORCH_SELECTIVE_NAME("aten::adaptive_max_pool3d"),
      TORCH_FN((&WrapFunction<
                CastPolicy::fp32,
                DeviceType::CPU,
  ...
  m.impl(
      TORCH_SELECTIVE_NAME("aten::multilabel_margin_loss_forward"),
      TORCH_FN(
          (&WrapFunction<
              CastPolicy::fp32,
              DeviceType::CPU,
  ...
  m.impl(
      TORCH_SELECTIVE_NAME("aten::linalg_qr"),
      TORCH_FN((&WrapFunction<
                CastPolicy::fp32,
                DeviceType::CPU,
  ...
  m.impl(
      TORCH_SELECTIVE_NAME("aten::linalg_cholesky_ex"),
      TORCH_FN((&WrapFunction<
                CastPolicy::fp32,
                DeviceType::CPU,
                std::tuple<Tensor, Tensor>(const Tensor&, bool, bool),
  ...
  m.impl(
      TORCH_SELECTIVE_NAME("aten::linalg_svd"),
      TORCH_FN((&WrapFunction<
                CastPolicy::fp32,
                DeviceType::CPU,
                std::tuple<Tensor, Tensor, Tensor>(
                    const Tensor&, bool, c10::optional<c10::string_view>),
                std::tuple<Tensor, Tensor, Tensor>(
                    const Tensor&, bool, c10::optional<c10::string_view>),
                &ADD_NS(linalg_svd)>::type::call)));

  m.impl(
      TORCH_SELECTIVE_NAME("aten::linalg_eig"),
      TORCH_FN((&WrapFunction<
                CastPolicy::fp32,
                DeviceType::CPU,
                std::tuple<Tensor, Tensor>(const Tensor&),
  ...
  m.impl(
      TORCH_SELECTIVE_NAME("aten::linalg_eigh"),
      TORCH_FN((&WrapFunction<
                CastPolicy::fp32,
                DeviceType::CPU,
                std::tuple<Tensor, Tensor>(const Tensor&, c10::string_view),
  ...
  m.impl(
      TORCH_SELECTIVE_NAME("aten::linalg_lstsq"),
      TORCH_FN((&WrapFunction<
                CastPolicy::fp32,
                DeviceType::CPU,
  ...
  m.impl(
      TORCH_SELECTIVE_NAME("aten::linalg_inv_ex"),
      TORCH_FN((&WrapFunction<
                CastPolicy::fp32,
                DeviceType::CPU,
                std::tuple<Tensor, Tensor>(const Tensor&, bool),
