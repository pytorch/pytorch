...
TORCH_LIBRARY_IMPL(aten, AutocastCPU, m) {
  ...
  KERNEL_CPU(ADD_NS(searchsorted), "searchsorted.Tensor", Tensor(const Tensor &, const Tensor &, bool, bool, c10::string_view, const c10::optional<Tensor> &), fp32)
  KERNEL_CPU(ADD_NS(searchsorted), "searchsorted.Scalar", Tensor(const Tensor &, const at::Scalar &, bool, bool, c10::string_view, const c10::optional<Tensor> &), fp32)
