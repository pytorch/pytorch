...
I'm copying the pattern used in core/boxing/impl/wrap_function_into_functor.h to extract args and return type.
...
// Wrapper to infer return_type and parameter_types for WrapFunction_ (imitating core/boxing/wrap_function_into_functor.h)
