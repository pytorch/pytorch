...
KERNEL_XLA(max_pool3d, fp32)
KERNEL_XLA(max_unpool2d, fp32)
KERNEL_XLA(max_unpool3d, fp32)
KERNEL_XLA(adaptive_avg_pool3d, fp32)
...
KERNEL_XLA(fractional_max_pool2d, fp32)
KERNEL_XLA(fractional_max_pool3d, fp32)
KERNEL_XLA(adaptive_max_pool3d, fp32)
