...
template <>
class Vec256<c10::complex<double>> {
 private:
  __m256d values;
 ...
 public:
  ...
  static Vec256<c10::complex<double>> blend(
      const Vec256<c10::complex<double>>& a,
      const Vec256<c10::complex<double>>& b) {
  ...
  static Vec256<c10::complex<double>> blendv(
      const Vec256<c10::complex<double>>& a,
      const Vec256<c10::complex<double>>& b,
  ...
  static Vec256<c10::complex<double>> arange(
      c10::complex<double> base = 0.,
      step_t step = static_cast<step_t>(1)) {
    return Vec256<c10::complex<double>>(base, base + step);
  }
  static Vec256<c10::complex<double>> set(
      const Vec256<c10::complex<double>>& a,
      const Vec256<c10::complex<double>>& b,
      int64_t count = size()) {
    switch (count) {
  ...
  static Vec256<c10::complex<double>> loadu(
      const void* ptr,
      int64_t count = size()) {
    if (count == size())
  ...
  Vec256<c10::complex<double>> map(
      c10::complex<double> (*f)(const c10::complex<double>&)) const {
  ...
  Vec256<c10::complex<double>> atan2(
      const Vec256<c10::complex<double>>& b) const {
    AT_ERROR("not supported for complex numbers");
  }
  ...
  Vec256<c10::complex<double>> hypot(
      const Vec256<c10::complex<double>>& b) const {
    AT_ERROR("not supported for complex numbers");
  }
  Vec256<c10::complex<double>> igamma(
      const Vec256<c10::complex<double>>& x) const {
    AT_ERROR("not supported for complex numbers");
  }
  Vec256<c10::complex<double>> igammac(
      const Vec256<c10::complex<double>>& x) const {
    AT_ERROR("not supported for complex numbers");
  }
  ...
  Vec256<c10::complex<double>> nextafter(
      const Vec256<c10::complex<double>>& b) const {
    AT_ERROR("not supported for complex numbers");
  }
  ...
  Vec256<c10::complex<double>> pow(
      const Vec256<c10::complex<double>>& exp) const {
  ...
  Vec256<c10::complex<double>> operator==(
      const Vec256<c10::complex<double>>& other) const {
  ...
  Vec256<c10::complex<double>> eq(
      const Vec256<c10::complex<double>>& other) const;
  Vec256<c10::complex<double>> ne(
      const Vec256<c10::complex<double>>& other) const;
  Vec256<c10::complex<double>> lt(
      const Vec256<c10::complex<double>>& other) const {
    TORCH_CHECK(false, "not supported for complex numbers");
  }
  Vec256<c10::complex<double>> le(
      const Vec256<c10::complex<double>>& other) const {
    TORCH_CHECK(false, "not supported for complex numbers");
  }
  Vec256<c10::complex<double>> gt(
      const Vec256<c10::complex<double>>& other) const {
    TORCH_CHECK(false, "not supported for complex numbers");
  }
  Vec256<c10::complex<double>> ge(
      const Vec256<c10::complex<double>>& other) const {
    TORCH_CHECK(false, "not supported for complex numbers");
  }
};
...
template <>
Vec256<c10::complex<double>> inline operator+(
    const Vec256<c10::complex<double>>& a,
    const Vec256<c10::complex<double>>& b) {
...
template <>
Vec256<c10::complex<double>> inline maximum(
    const Vec256<c10::complex<double>>& a,
    const Vec256<c10::complex<double>>& b) {
  auto abs_a = a.abs_2_();
  auto abs_b = b.abs_2_();
...
template <>
Vec256<c10::complex<double>> inline minimum(
    const Vec256<c10::complex<double>>& a,
    const Vec256<c10::complex<double>>& b) {
  auto abs_a = a.abs_2_();
  auto abs_b = b.abs_2_();
...
Vec256<c10::complex<double>> Vec256<c10::complex<double>>::eq(
    const Vec256<c10::complex<double>>& other) const {
  return (*this == other) & Vec256<c10::complex<double>>(_mm256_set1_pd(1.0));
}

Vec256<c10::complex<double>> Vec256<c10::complex<double>>::ne(
    const Vec256<c10::complex<double>>& other) const {
  return (*this != other) & Vec256<c10::complex<double>>(_mm256_set1_pd(1.0));
}
