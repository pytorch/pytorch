...
Vec256<T> inline int_elementwise_binary_256(
    const Vec256<T>& a,
    const Vec256<T>& b,
    Op op) {
...
template <>
Vec256<int64_t> inline clamp(
    const Vec256<int64_t>& a,
    const Vec256<int64_t>& min_val,
    const Vec256<int64_t>& max_val) {
  return emulate(
      a,
      min_val,
      max_val,
...
template <>
Vec256<int32_t> inline clamp(
    const Vec256<int32_t>& a,
    const Vec256<int32_t>& min_val,
    const Vec256<int32_t>& max_val) {
  return _mm256_min_epi32(max_val, _mm256_max_epi32(a, min_val));
}

template <>
Vec256<int16_t> inline clamp(
    const Vec256<int16_t>& a,
    const Vec256<int16_t>& min_val,
    const Vec256<int16_t>& max_val) {
  return _mm256_min_epi16(max_val, _mm256_max_epi16(a, min_val));
}

template <>
Vec256<int8_t> inline clamp(
    const Vec256<int8_t>& a,
    const Vec256<int8_t>& min_val,
    const Vec256<int8_t>& max_val) {
  return _mm256_min_epi8(max_val, _mm256_max_epi8(a, min_val));
}

template <>
Vec256<int64_t> inline clamp_max(
    const Vec256<int64_t>& a,
    const Vec256<int64_t>& max_val) {
...
template <>
Vec256<int32_t> inline clamp_max(
    const Vec256<int32_t>& a,
    const Vec256<int32_t>& max_val) {
...
template <>
Vec256<int16_t> inline clamp_max(
    const Vec256<int16_t>& a,
    const Vec256<int16_t>& max_val) {
...
template <>
Vec256<int8_t> inline clamp_max(
    const Vec256<int8_t>& a,
    const Vec256<int8_t>& max_val) {
...
template <>
Vec256<int64_t> inline clamp_min(
    const Vec256<int64_t>& a,
    const Vec256<int64_t>& min_val) {
...
template <>
Vec256<int32_t> inline clamp_min(
    const Vec256<int32_t>& a,
    const Vec256<int32_t>& min_val) {
...
template <>
Vec256<int16_t> inline clamp_min(
    const Vec256<int16_t>& a,
    const Vec256<int16_t>& min_val) {
...
template <>
Vec256<int8_t> inline clamp_min(
    const Vec256<int8_t>& a,
    const Vec256<int8_t>& min_val) {
...
template <
    class T,
    typename std::enable_if_t<std::is_base_of<Vec256i, Vec256<T>>::value, int> =
        0>
