...
struct Vectorizei {};  // dummy definition to make Vectorizei always defined
...
template <>
class Vectorize<int64_t> : public Vectorizei {
private:
  static const Vectorize<int64_t> ones;
public:
  ...
  using Vectorizei::Vectorizei;
  Vectorize() {}
  Vectorize(int64_t v) { values = _mm256_set1_epi64x(v); }
  Vectorize(int64_t val1, int64_t val2, int64_t val3, int64_t val4) {
  ...
  static Vectorize<int64_t> arange(int64_t base = 0, step_t step = static_cast<step_t>(1)) {
    return Vectorize<int64_t>(base, base + step, base + 2 * step, base + 3 * step);
  }
  static Vectorize<int64_t>
  set(Vectorize<int64_t> a, Vectorize<int64_t> b, int64_t count = size()) {
    switch (count) {
      case 0:
        return a;
      case 1:
  ...
  static Vectorize<int64_t> loadu(const void* ptr) {
    return _mm256_loadu_si256(reinterpret_cast<const __m256i*>(ptr));
  }
  static Vectorize<int64_t> loadu(const void* ptr, int64_t count) {
    __at_align32__ int64_t tmp_values[size()];
  ...
  Vectorize<int64_t> frac() const;
  Vectorize<int64_t> neg() const;
  Vectorize<int64_t> operator==(const Vectorize<int64_t>& other) const {
  ...
  Vectorize<int64_t> eq(const Vectorize<int64_t>& other) const;
  Vectorize<int64_t> ne(const Vectorize<int64_t>& other) const;
  Vectorize<int64_t> gt(const Vectorize<int64_t>& other) const;
  Vectorize<int64_t> ge(const Vectorize<int64_t>& other) const;
  Vectorize<int64_t> lt(const Vectorize<int64_t>& other) const;
  Vectorize<int64_t> le(const Vectorize<int64_t>& other) const;
};

template <>
class Vectorize<int32_t> : public Vectorizei {
private:
  static const Vectorize<int32_t> ones;
public:
  ...
  using Vectorizei::Vectorizei;
  Vectorize() {}
  Vectorize(int32_t v) { values = _mm256_set1_epi32(v); }
  Vectorize(int32_t val1, int32_t val2, int32_t val3, int32_t val4,
  ...
  template <typename step_t>
  static Vectorize<int32_t> arange(int32_t base = 0, step_t step = static_cast<step_t>(1)) {
    return Vectorize<int32_t>(
      base,            base +     step, base + 2 * step, base + 3 * step,
      base + 4 * step, base + 5 * step, base + 6 * step, base + 7 * step);
  }
  static Vectorize<int32_t>
  set(Vectorize<int32_t> a, Vectorize<int32_t> b, int32_t count = size()) {
    switch (count) {
      case 0:
        return a;
      case 1:
  ...
  static Vectorize<int32_t> loadu(const void* ptr) {
    return _mm256_loadu_si256(reinterpret_cast<const __m256i*>(ptr));
  }
  static Vectorize<int32_t> loadu(const void* ptr, int32_t count) {
  ...
  Vectorize<int32_t> frac() const;
  Vectorize<int32_t> neg() const;
  Vectorize<int32_t> operator==(const Vectorize<int32_t>& other) const {
  ...
  Vectorize<int32_t> eq(const Vectorize<int32_t>& other) const;
  Vectorize<int32_t> ne(const Vectorize<int32_t>& other) const;
  Vectorize<int32_t> gt(const Vectorize<int32_t>& other) const;
  Vectorize<int32_t> ge(const Vectorize<int32_t>& other) const;
  Vectorize<int32_t> lt(const Vectorize<int32_t>& other) const;
  Vectorize<int32_t> le(const Vectorize<int32_t>& other) const;
};
...
# pragma unroll
#endif
  for (i = 0; i <= (n - Vectorize<int32_t>::size()); i += Vectorize<int32_t>::size()) {
...
template <>
class Vectorize<int16_t> : public Vectorizei {
private:
  static const Vectorize<int16_t> ones;
public:
  ...
  using Vectorizei::Vectorizei;
  Vectorize() {}
  Vectorize(int16_t v) { values = _mm256_set1_epi16(v); }
  Vectorize(int16_t val1, int16_t val2, int16_t val3, int16_t val4,
  ...
  template <typename step_t>
  static Vectorize<int16_t> arange(int16_t base = 0, step_t step = static_cast<step_t>(1)) {
  ...
  static Vectorize<int16_t>
  set(Vectorize<int16_t> a, Vectorize<int16_t> b, int16_t count = size()) {
    switch (count) {
      case 0:
        return a;
      case 1:
  ...
  static Vectorize<int16_t> loadu(const void* ptr) {
    return _mm256_loadu_si256(reinterpret_cast<const __m256i*>(ptr));
  }
  static Vectorize<int16_t> loadu(const void* ptr, int16_t count) {
    __at_align32__ int16_t tmp_values[size()];
    // Ensure uninitialized memory does not change the output value See https://github.com/pytorch/pytorch/issues/32502
    // for more details. We do not initialize arrays to zero using "={0}" because gcc would compile it to two
    // instructions while a loop would be compiled to one instruction.
  ...
  Vectorize<int16_t> frac() const;
  Vectorize<int16_t> neg() const;
  Vectorize<int16_t> operator==(const Vectorize<int16_t>& other) const {
  ...
  Vectorize<int16_t> eq(const Vectorize<int16_t>& other) const;
  Vectorize<int16_t> ne(const Vectorize<int16_t>& other) const;
  Vectorize<int16_t> gt(const Vectorize<int16_t>& other) const;
  Vectorize<int16_t> ge(const Vectorize<int16_t>& other) const;
  Vectorize<int16_t> lt(const Vectorize<int16_t>& other) const;
  Vectorize<int16_t> le(const Vectorize<int16_t>& other) const;
};

template <>
class Vectorize<int8_t> : public Vectorizei {
private:
  static const Vectorize<int8_t> ones;
public:
  ...
  using Vectorizei::Vectorizei;
  Vectorize() {}
  Vectorize(int8_t v) { values = _mm256_set1_epi8(v); }
  Vectorize(int8_t val1, int8_t val2, int8_t val3, int8_t val4,
  ...
  template <typename step_t>
  static Vectorize<int8_t> arange(int8_t base = 0, step_t step = static_cast<step_t>(1)) {
    return Vectorize<int8_t>(
      base,             base +      step, base +  2 * step, base +  3 * step,
      base +  4 * step, base +  5 * step, base +  6 * step, base +  7 * step,
      base +  8 * step, base +  9 * step, base + 10 * step, base + 11 * step,
      base + 12 * step, base + 13 * step, base + 14 * step, base + 15 * step,
  ...
  static Vectorize<int8_t>
  set(Vectorize<int8_t> a, Vectorize<int8_t> b, int8_t count = size()) {
    switch (count) {
      case 0:
        return a;
      case 1:
  ...
  static Vectorize<int8_t> loadu(const void* ptr) {
    return _mm256_loadu_si256(reinterpret_cast<const __m256i*>(ptr));
  }
  static Vectorize<int8_t> loadu(const void* ptr, int8_t count) {
    __at_align32__ int8_t tmp_values[size()];
    // Ensure uninitialized memory does not change the output value See https://github.com/pytorch/pytorch/issues/32502
    // for more details. We do not initialize arrays to zero using "={0}" because gcc would compile it to two
    // instructions while a loop would be compiled to one instruction.
  ...
  Vectorize<int8_t> abs() const {
    return _mm256_abs_epi8(values);
  }
  Vectorize<int8_t> real() const {
    return *this;
  }
  Vectorize<int8_t> imag() const {
    return _mm256_set1_epi8(0);
  }
  Vectorize<int8_t> conj() const {
    return *this;
  }
  Vectorize<int8_t> frac() const;
  Vectorize<int8_t> neg() const;
  Vectorize<int8_t> operator==(const Vectorize<int8_t>& other) const {
  ...
  Vectorize<int8_t> eq(const Vectorize<int8_t>& other) const;
  Vectorize<int8_t> ne(const Vectorize<int8_t>& other) const;
  Vectorize<int8_t> gt(const Vectorize<int8_t>& other) const;
  Vectorize<int8_t> ge(const Vectorize<int8_t>& other) const;
  Vectorize<int8_t> lt(const Vectorize<int8_t>& other) const;
  Vectorize<int8_t> le(const Vectorize<int8_t>& other) const;
};

template <>
Vectorize<int64_t> inline operator+(const Vectorize<int64_t>& a, const Vectorize<int64_t>& b) {
  return _mm256_add_epi64(a, b);
}

template <>
Vectorize<int32_t> inline operator+(const Vectorize<int32_t>& a, const Vectorize<int32_t>& b) {
  return _mm256_add_epi32(a, b);
}

template <>
Vectorize<int16_t> inline operator+(const Vectorize<int16_t>& a, const Vectorize<int16_t>& b) {
  return _mm256_add_epi16(a, b);
}

template <>
Vectorize<int8_t> inline operator+(const Vectorize<int8_t>& a, const Vectorize<int8_t>& b) {
...
Vectorize<int64_t> Vectorize<int64_t>::neg() const {
  return Vectorize<int64_t>(0) - *this;
}

Vectorize<int32_t> Vectorize<int32_t>::neg() const {
  return Vectorize<int32_t>(0) - *this;
}

Vectorize<int16_t> Vectorize<int16_t>::neg() const {
  return Vectorize<int16_t>(0) - *this;
}

Vectorize<int8_t> Vectorize<int8_t>::neg() const {
  return Vectorize<int8_t>(0) - *this;
}
...
Vectorize<int64_t> inline emulate(const Vectorize<int64_t>& a, const Vectorize<int64_t>& b, const op_t& op) {
...
template <typename op_t>
Vectorize<int64_t> inline emulate(const Vectorize<int64_t>& a, const Vectorize<int64_t>& b, const Vectorize<int64_t>& c, const op_t& op) {
  int64_t a0 = _mm256_extract_epi64(a, 0);
  int64_t a1 = _mm256_extract_epi64(a, 1);
  int64_t a2 = _mm256_extract_epi64(a, 2);
  int64_t a3 = _mm256_extract_epi64(a, 3);
...
Vectorize<T> inline int_elementwise_binary_256(const Vectorize<T>& a, const Vectorize<T>& b, Op op) {
  T values_a[Vectorize<T>::size()];
  T values_b[Vectorize<T>::size()];
  a.store(values_a);
  b.store(values_b);
  for (int i = 0; i != Vectorize<T>::size(); i++) {
    values_a[i] = op(values_a[i], values_b[i]);
  }
  return Vectorize<T>::loadu(values_a);
}
...
template <>
Vectorize<int64_t> inline minimum(const Vectorize<int64_t>& a, const Vectorize<int64_t>& b) {
  return emulate(a, b, [](int64_t a_point, int64_t b_point) {return std::min(a_point, b_point);});
}

template <>
Vectorize<int32_t> inline minimum(const Vectorize<int32_t>& a, const Vectorize<int32_t>& b) {
  return _mm256_min_epi32(a, b);
}

template <>
Vectorize<int16_t> inline minimum(const Vectorize<int16_t>& a, const Vectorize<int16_t>& b) {
  return _mm256_min_epi16(a, b);
}

template <>
Vectorize<int8_t> inline minimum(const Vectorize<int8_t>& a, const Vectorize<int8_t>& b) {
  return _mm256_min_epi8(a, b);
}

template <>
Vectorize<int64_t> inline maximum(const Vectorize<int64_t>& a, const Vectorize<int64_t>& b) {
  return emulate(a, b, [](int64_t a_point, int64_t b_point) {return std::max(a_point, b_point);});
}

template <>
Vectorize<int32_t> inline maximum(const Vectorize<int32_t>& a, const Vectorize<int32_t>& b) {
  return _mm256_max_epi32(a, b);
}

template <>
Vectorize<int16_t> inline maximum(const Vectorize<int16_t>& a, const Vectorize<int16_t>& b) {
  return _mm256_max_epi16(a, b);
}

template <>
Vectorize<int8_t> inline maximum(const Vectorize<int8_t>& a, const Vectorize<int8_t>& b) {
  return _mm256_max_epi8(a, b);
}

template <>
Vectorize<int64_t> inline clamp(const Vectorize<int64_t>& a, const Vectorize<int64_t>& min_val, const Vectorize<int64_t>& max_val) {
...
template <>
Vectorize<int32_t> inline clamp(const Vectorize<int32_t>& a, const Vectorize<int32_t>& min_val, const Vectorize<int32_t>& max_val) {
  return _mm256_min_epi32(max_val, _mm256_max_epi32(a, min_val));
}

template <>
Vectorize<int16_t> inline clamp(const Vectorize<int16_t>& a, const Vectorize<int16_t>& min_val, const Vectorize<int16_t>& max_val) {
  return _mm256_min_epi16(max_val, _mm256_max_epi16(a, min_val));
}

template <>
Vectorize<int8_t> inline clamp(const Vectorize<int8_t>& a, const Vectorize<int8_t>& min_val, const Vectorize<int8_t>& max_val) {
  return _mm256_min_epi8(max_val, _mm256_max_epi8(a, min_val));
}

template <>
Vectorize<int64_t> inline clamp_max(const Vectorize<int64_t>& a, const Vectorize<int64_t>& max_val) {
  return emulate(a, max_val, [](int64_t a_point, int64_t max_point) {return std::min(max_point, a_point);});
}

template <>
Vectorize<int32_t> inline clamp_max(const Vectorize<int32_t>& a, const Vectorize<int32_t>& max_val) {
  return _mm256_min_epi32(max_val, a);
}

template <>
Vectorize<int16_t> inline clamp_max(const Vectorize<int16_t>& a, const Vectorize<int16_t>& max_val) {
  return _mm256_min_epi16(max_val, a);
}

template <>
Vectorize<int8_t> inline clamp_max(const Vectorize<int8_t>& a, const Vectorize<int8_t>& max_val) {
  return _mm256_min_epi8(max_val, a);
}

template <>
Vectorize<int64_t> inline clamp_min(const Vectorize<int64_t>& a, const Vectorize<int64_t>& min_val) {
  return emulate(a, min_val, [](int64_t a_point, int64_t min_point) {return std::max(min_point, a_point);});
}

template <>
Vectorize<int32_t> inline clamp_min(const Vectorize<int32_t>& a, const Vectorize<int32_t>& min_val) {
  return _mm256_max_epi32(min_val, a);
}

template <>
Vectorize<int16_t> inline clamp_min(const Vectorize<int16_t>& a, const Vectorize<int16_t>& min_val) {
  return _mm256_max_epi16(min_val, a);
}

template <>
Vectorize<int8_t> inline clamp_min(const Vectorize<int8_t>& a, const Vectorize<int8_t>& min_val) {
  return _mm256_max_epi8(min_val, a);
}

template<typename T>
Vectorize<int32_t> inline convert_to_int32(const T* ptr) {
  return Vectorize<int32_t>::loadu(ptr);
}

template<>
Vectorize<int32_t> inline convert_to_int32<int8_t>(const int8_t* ptr) {
  return _mm256_cvtepi8_epi32(_mm_loadl_epi64(reinterpret_cast<const __m128i*>(ptr)));
}

template<>
Vectorize<int32_t> inline convert_to_int32<uint8_t>(const uint8_t* ptr) {
...
Vectorize<int64_t> Vectorize<int64_t>::eq(const Vectorize<int64_t>& other) const {
  return (*this == other) & Vectorize<int64_t>(1);
}

Vectorize<int64_t> Vectorize<int64_t>::ne(const Vectorize<int64_t>& other) const {
  return (*this != other) & Vectorize<int64_t>(1);
}

Vectorize<int64_t> Vectorize<int64_t>::gt(const Vectorize<int64_t>& other) const {
  return (*this > other) & Vectorize<int64_t>(1);
}

Vectorize<int64_t> Vectorize<int64_t>::ge(const Vectorize<int64_t>& other) const {
  return (*this >= other) & Vectorize<int64_t>(1);
}

Vectorize<int64_t> Vectorize<int64_t>::lt(const Vectorize<int64_t>& other) const {
  return (*this < other) & Vectorize<int64_t>(1);
}

Vectorize<int64_t> Vectorize<int64_t>::le(const Vectorize<int64_t>& other) const {
  return (*this <= other) & Vectorize<int64_t>(1);
}

Vectorize<int32_t> Vectorize<int32_t>::eq(const Vectorize<int32_t>& other) const {
  return (*this == other) & Vectorize<int32_t>(1);
}

Vectorize<int32_t> Vectorize<int32_t>::ne(const Vectorize<int32_t>& other) const {
  return (*this != other) & Vectorize<int32_t>(1);
}

Vectorize<int32_t> Vectorize<int32_t>::gt(const Vectorize<int32_t>& other) const {
  return (*this > other) & Vectorize<int32_t>(1);
}

Vectorize<int32_t> Vectorize<int32_t>::ge(const Vectorize<int32_t>& other) const {
  return (*this >= other) & Vectorize<int32_t>(1);
}

Vectorize<int32_t> Vectorize<int32_t>::lt(const Vectorize<int32_t>& other) const {
  return (*this < other) & Vectorize<int32_t>(1);
}

Vectorize<int32_t> Vectorize<int32_t>::le(const Vectorize<int32_t>& other) const {
  return (*this <= other) & Vectorize<int32_t>(1);
}

Vectorize<int16_t> Vectorize<int16_t>::eq(const Vectorize<int16_t>& other) const {
  return (*this == other) & Vectorize<int16_t>(1);
}

Vectorize<int16_t> Vectorize<int16_t>::ne(const Vectorize<int16_t>& other) const {
  return (*this != other) & Vectorize<int16_t>(1);
}

Vectorize<int16_t> Vectorize<int16_t>::gt(const Vectorize<int16_t>& other) const {
  return (*this > other) & Vectorize<int16_t>(1);
}

Vectorize<int16_t> Vectorize<int16_t>::ge(const Vectorize<int16_t>& other) const {
  return (*this >= other) & Vectorize<int16_t>(1);
}

Vectorize<int16_t> Vectorize<int16_t>::lt(const Vectorize<int16_t>& other) const {
  return (*this < other) & Vectorize<int16_t>(1);
}

Vectorize<int16_t> Vectorize<int16_t>::le(const Vectorize<int16_t>& other) const {
  return (*this <= other) & Vectorize<int16_t>(1);
}

Vectorize<int8_t> Vectorize<int8_t>::eq(const Vectorize<int8_t>& other) const {
  return (*this == other) & Vectorize<int8_t>(1);
}

Vectorize<int8_t> Vectorize<int8_t>::ne(const Vectorize<int8_t>& other) const {
  return (*this != other) & Vectorize<int8_t>(1);
}

Vectorize<int8_t> Vectorize<int8_t>::gt(const Vectorize<int8_t>& other) const {
  return (*this > other) & Vectorize<int8_t>(1);
}

Vectorize<int8_t> Vectorize<int8_t>::ge(const Vectorize<int8_t>& other) const {
  return (*this >= other) & Vectorize<int8_t>(1);
}

Vectorize<int8_t> Vectorize<int8_t>::lt(const Vectorize<int8_t>& other) const {
  return (*this < other) & Vectorize<int8_t>(1);
}

Vectorize<int8_t> Vectorize<int8_t>::le(const Vectorize<int8_t>& other) const {
  return (*this <= other) & Vectorize<int8_t>(1);
}
