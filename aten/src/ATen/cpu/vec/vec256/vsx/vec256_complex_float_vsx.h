...
class Vectorize<ComplexFlt> {
 ...
 public:
  ...
  C10_ALWAYS_INLINE Vectorize(vfloat32 v) : _vec0{v}, _vec1{v} {}
  C10_ALWAYS_INLINE Vectorize(vbool32 vmask) : _vecb0{vmask}, _vecb1{vmask} {}
  C10_ALWAYS_INLINE Vectorize(vfloat32 v1, vfloat32 v2) : _vec0{v1}, _vec1{v2} {}
  C10_ALWAYS_INLINE Vectorize(vbool32 v1, vbool32 v2) : _vecb0{v1}, _vecb1{v2} {}

  Vectorize(ComplexFlt val) {
  ...
  Vectorize(ComplexFlt val1, ComplexFlt val2, ComplexFlt val3, ComplexFlt val4) {
    _vec0 = vfloat32{val1.real(), val1.imag(), val2.real(), val2.imag()};
    _vec1 = vfloat32{val3.real(), val3.imag(), val4.real(), val4.imag()};
  }

  template <uint64_t mask>
  static std::enable_if_t<blendChoiceComplex(mask) == 0, Vectorize<ComplexFlt>>
      C10_ALWAYS_INLINE
      blend(const Vectorize<ComplexFlt>& a, const Vectorize<ComplexFlt>& b) {
    return a;
  }

  template <uint64_t mask>
  static std::enable_if_t<blendChoiceComplex(mask) == 1, Vectorize<ComplexFlt>>
      C10_ALWAYS_INLINE
      blend(const Vectorize<ComplexFlt>& a, const Vectorize<ComplexFlt>& b) {
    return b;
  }
  ...
  template <uint64_t mask>
  static std::enable_if_t<blendChoiceComplex(mask) == 2, Vectorize<ComplexFlt>>
      C10_ALWAYS_INLINE
      blend(const Vectorize<ComplexFlt>& a, const Vectorize<ComplexFlt>& b) {
  ...
  template <uint64_t mask>
  static std::enable_if_t<blendChoiceComplex(mask) == 3, Vectorize<ComplexFlt>>
      C10_ALWAYS_INLINE
      blend(const Vectorize<ComplexFlt>& a, const Vectorize<ComplexFlt>& b) {
  ...
  template <uint64_t mask>
  static std::enable_if_t<blendChoiceComplex(mask) == 4, Vectorize<ComplexFlt>>
      C10_ALWAYS_INLINE
      blend(const Vectorize<ComplexFlt>& a, const Vectorize<ComplexFlt>& b) {
  ...
  template <uint64_t mask>
  static std::enable_if_t<blendChoiceComplex(mask) == 5, Vectorize<ComplexFlt>>
      C10_ALWAYS_INLINE
      blend(const Vectorize<ComplexFlt>& a, const Vectorize<ComplexFlt>& b) {
    const vbool32 mask_1st = VsxComplexMask1(mask);
  ...
  template <uint64_t mask>
  static std::enable_if_t<blendChoiceComplex(mask) == 6, Vectorize<ComplexFlt>>
      C10_ALWAYS_INLINE
      blend(const Vectorize<ComplexFlt>& a, const Vectorize<ComplexFlt>& b) {
  ...
  template <uint64_t mask>
  static std::enable_if_t<blendChoiceComplex(mask) == 7, Vectorize<ComplexFlt>>
      C10_ALWAYS_INLINE
      blend(const Vectorize<ComplexFlt>& a, const Vectorize<ComplexFlt>& b) {
    const vbool32 mask_2nd = VsxComplexMask2(mask);
    // generated masks
  ...
  template <uint64_t mask>
  static std::enable_if_t<blendChoiceComplex(mask) == 8, Vectorize<ComplexFlt>>
      C10_ALWAYS_INLINE
      blend(const Vectorize<ComplexFlt>& a, const Vectorize<ComplexFlt>& b) {
    const vbool32 mask_1st = VsxComplexMask1(mask);
    const vbool32 mask_2nd = VsxComplexMask2(mask);
  ...
  static Vectorize<ComplexFlt> C10_ALWAYS_INLINE
  el_blend(const Vectorize<ComplexFlt>& a, const Vectorize<ComplexFlt>& b) {
  ...
  static Vectorize<ComplexFlt> blendv(
      const Vectorize<ComplexFlt>& a,
      const Vectorize<ComplexFlt>& b,
      const Vectorize<ComplexFlt>& mask) {
    // convert std::complex<V> index mask to V index mask: xy -> xxyy
    auto mask_complex = Vectorize<ComplexFlt>(
  ...
  static Vectorize<ComplexFlt> elwise_blendv(
      const Vectorize<ComplexFlt>& a,
      const Vectorize<ComplexFlt>& b,
      const Vectorize<ComplexFlt>& mask) {
    return {
  ...
  static Vectorize<ComplexFlt> arange(
      ComplexFlt base = 0.,
      step_t step = static_cast<step_t>(1)) {
    return Vectorize<ComplexFlt>(
        base,
        base + step,
        base + ComplexFlt(2) * step,
        base + ComplexFlt(3) * step);
  }
  static Vectorize<ComplexFlt> set(
      const Vectorize<ComplexFlt>& a,
      const Vectorize<ComplexFlt>& b,
      int64_t count = size()) {
    switch (count) {
  ...
  Vectorize<ComplexFlt> map(ComplexFlt (*f)(ComplexFlt)) const {
  ...
  Vectorize<ComplexFlt> map(ComplexFlt (*f)(const ComplexFlt&)) const {
    __at_align32__ ComplexFlt tmp[size()];
    store(tmp);
    for (int i = 0; i < size(); i++) {
      tmp[i] = f(tmp[i]);
  ...
  static Vectorize<ComplexFlt> horizontal_add_permD8(
      Vectorize<ComplexFlt>& first,
      Vectorize<ComplexFlt>& second) {
  ...
  static Vectorize<ComplexFlt> horizontal_sub_permD8(
      Vectorize<ComplexFlt>& first,
      Vectorize<ComplexFlt>& second) {
    // we will simulate it differently with 6 instructions total
    // lets permute second so that we can add it getting horizontal sums
  ...
  Vectorize<ComplexFlt> abs_2_() const {
  ...
  Vectorize<ComplexFlt> abs_() const {
    auto ret = abs_2_();
    return ret.elwise_sqrt();
  }

  Vectorize<ComplexFlt> abs() const {
    return abs_() & real_mask;
  }

  Vectorize<ComplexFlt> real_() const {
    return *this & real_mask;
  }
  Vectorize<ComplexFlt> real() const {
    return *this & real_mask;
  }
  Vectorize<ComplexFlt> imag_() const {
    return *this & imag_mask;
  }
  Vectorize<ComplexFlt> imag() const {
  ...
  Vectorize<ComplexFlt> angle_() const {
    // angle = atan2(b/a)
  ...
  Vectorize<ComplexFlt> angle() const {
    auto a = angle_().el_swapped();
    return a & real_mask;
  }

  Vectorize<ComplexFlt> sin() const {
    return map(std::sin);
  }
  Vectorize<ComplexFlt> sinh() const {
    return map(std::sinh);
  }
  Vectorize<ComplexFlt> cos() const {
    return map(std::cos);
  }
  Vectorize<ComplexFlt> cosh() const {
    return map(std::cosh);
  }
  Vectorize<ComplexFlt> ceil() const {
    return {vec_ceil(_vec0), vec_ceil(_vec1)};
  }
  Vectorize<ComplexFlt> floor() const {
    return {vec_floor(_vec0), vec_floor(_vec1)};
  }
  Vectorize<ComplexFlt> neg() const {
    auto z = Vectorize<ComplexFlt>(zero);
    return z - *this;
  }
  Vectorize<ComplexFlt> round() const {
    return {vec_round(_vec0), vec_round(_vec1)};
  }
  Vectorize<ComplexFlt> tan() const {
    return map(std::tan);
  }
  Vectorize<ComplexFlt> tanh() const {
    return map(std::tanh);
  }
  Vectorize<ComplexFlt> trunc() const {
    return {vec_trunc(_vec0), vec_trunc(_vec1)};
  }

  Vectorize<ComplexFlt> elwise_sqrt() const {
  ...
  Vectorize<ComplexFlt> sqrt() const {
    return map(std::sqrt);
  }

  Vectorize<ComplexFlt> reciprocal() const {
    // re + im*i = (a + bi)  / (c + di)
  ...
  Vectorize<ComplexFlt> rsqrt() const {
    return sqrt().reciprocal();
  }

  Vectorize<ComplexFlt> pow(const Vectorize<ComplexFlt>& exp) const {
  ...
  Vectorize<ComplexFlt> atan() const {
    // atan(x) = i/2 * ln((i + z)/(i - z))
    auto ione = Vectorize(imag_one);
    auto sum = ione + *this;
    auto sub = ione - *this;
  ...
  Vectorize<ComplexFlt> acos() const {
    // acos(x) = pi/2 - asin(x)
    return Vectorize(pi_2) - asin();
  }

  Vectorize<ComplexFlt> inline operator*(const Vectorize<ComplexFlt>& b) const {
  ...
  Vectorize<ComplexFlt> asin() const {
    // asin(x)
    // = -i*ln(iz + sqrt(1 -z^2))
    ...
    re = Vectorize<ComplexFlt>(one) - re;
  ...
  Vectorize<ComplexFlt> exp() const {
    return map(std::exp);
  }

  Vectorize<ComplexFlt> eq(const Vectorize<ComplexFlt>& other) const {
    auto ret = (*this == other);
    return ret & one;
  }
  Vectorize<ComplexFlt> ne(const Vectorize<ComplexFlt>& other) const {
    auto ret = (*this != other);
    return ret & one;
  }

  Vectorize<ComplexFlt> sgn() const {
    return map(at::native::sgn_impl);
  }

  Vectorize<ComplexFlt> hypot(const Vectorize<ComplexFlt>& b) const {
      TORCH_CHECK(false, "not supported for complex numbers");
  }

  Vectorize<ComplexFlt> nextafter(const Vectorize<ComplexFlt>& b) const {
      TORCH_CHECK(false, "not supported for complex numbers");
  }

  Vectorize<ComplexFlt> igamma(const Vectorize<ComplexFlt>& x) const {
    TORCH_CHECK(false, "not supported for complex numbers");
  }

  Vectorize<ComplexFlt> igammac(const Vectorize<ComplexFlt>& x) const {
    TORCH_CHECK(false, "not supported for complex numbers");
  }

  Vectorize<ComplexFlt> atan2(const Vectorize<ComplexFlt>& b) const {
    TORCH_CHECK(false,"not supported for complex numbers");
  }
  Vectorize<ComplexFlt> erf() const {
    TORCH_CHECK(false,"not supported for complex numbers");
  }
  Vectorize<ComplexFlt> erfc() const {
    TORCH_CHECK(false,"not supported for complex numbers");
  }

  Vectorize<ComplexFlt> log1p() const {
    TORCH_CHECK(false,"not supported for complex numbers");
  }

  Vectorize<ComplexFlt> expm1() const {
    TORCH_CHECK(false,"not supported for complex numbers");
  }

  Vectorize<ComplexFlt> operator<(const Vectorize<ComplexFlt>& other) const {
    TORCH_CHECK(false, "not supported for complex numbers");
  }
  ...
  Vectorize<ComplexFlt> lt(const Vectorize<ComplexFlt>& other) const {
    TORCH_CHECK(false, "not supported for complex numbers");
  }

  Vectorize<ComplexFlt> le(const Vectorize<ComplexFlt>& other) const {
    TORCH_CHECK(false, "not supported for complex numbers");
  }

  Vectorize<ComplexFlt> gt(const Vectorize<ComplexFlt>& other) const {
    TORCH_CHECK(false, "not supported for complex numbers");
  }

  Vectorize<ComplexFlt> ge(const Vectorize<ComplexFlt>& other) const {
    TORCH_CHECK(false, "not supported for complex numbers");
  }
...
template <>
Vectorize<ComplexFlt> inline maximum(
    const Vectorize<ComplexFlt>& a,
    const Vectorize<ComplexFlt>& b) {
  auto abs_a = a.abs_2_();
  auto abs_b = b.abs_2_();
  ...
  auto max = Vectorize<ComplexFlt>::elwise_blendv(a, b, mask);
...
template <>
Vectorize<ComplexFlt> inline minimum(
    const Vectorize<ComplexFlt>& a,
    const Vectorize<ComplexFlt>& b) {
  auto abs_a = a.abs_2_();
  auto abs_b = b.abs_2_();
  ...
  auto min = Vectorize<ComplexFlt>::elwise_blendv(a, b, mask);
  return min;
  // Exploit the fact that all-ones is a NaN.
  // auto isnan = _mm256_cmp_ps(abs_a, abs_b, _CMP_UNORD_Q);
