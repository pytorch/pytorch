...
class Vectorize<int16_t> {
 ...
 public:
  ...
  Vectorize() {}
  C10_ALWAYS_INLINE Vectorize(vint16 v) : _vec0{v}, _vec1{v} {}
  C10_ALWAYS_INLINE Vectorize(vbool16 vmask) : _vecb0{vmask}, _vecb1{vmask} {}
  C10_ALWAYS_INLINE Vectorize(vint16 v1, vint16 v2) : _vec0{v1}, _vec1{v2} {}
  C10_ALWAYS_INLINE Vectorize(vbool16 v1, vbool16 v2) : _vecb0{v1}, _vecb1{v2} {}
  C10_ALWAYS_INLINE Vectorize(int16_t scalar)
  ...
  static std::enable_if_t<mask == 0, Vectorize<int16_t>> C10_ALWAYS_INLINE
  blend(const Vectorize<int16_t>& a, const Vectorize<int16_t>& b) {
    return a;
  }

  template <uint64_t mask>
  static std::enable_if_t<(mask & 65535) == 65535, Vectorize<int16_t>>
      C10_ALWAYS_INLINE blend(const Vectorize<int16_t>& a, const Vectorize<int16_t>& b) {
    return b;
  }

  template <uint64_t mask>
  static std::enable_if_t<mask == 255, Vectorize<int16_t>> C10_ALWAYS_INLINE
  blend(const Vectorize<int16_t>& a, const Vectorize<int16_t>& b) {
    return {b._vec0, a._vec1};
  }

  template <uint64_t mask>
  static std::enable_if_t<(mask > 0 && mask < 255), Vectorize<int16_t>>
      C10_ALWAYS_INLINE blend(const Vectorize<int16_t>& a, const Vectorize<int16_t>& b) {
  ...
  static Vectorize<int16_t> C10_ALWAYS_INLINE blendv(
      const Vectorize<int16_t>& a,
      const Vectorize<int16_t>& b,
  ...
  static Vectorize<int16_t> arange(int16_t base = 0, int16_t step = 1) {
    return Vectorize<int16_t>(
        base,
        base + step,
        base + 2 * step,
        base + 3 * step,
  ...
  Vectorize<int16_t> angle() const {
    return Vectorize<int16_t>{0};
  }
  Vectorize<int16_t> real() const {
    return *this;
  }
  Vectorize<int16_t> imag() const {
    return Vectorize<int16_t>{0};
  }
  Vectorize<int16_t> conj() const {
    return *this;
  }

  Vectorize<int16_t> C10_ALWAYS_INLINE abs() const {
    return {vec_abs(_vec0), vec_abs(_vec1)};
  }

  Vectorize<int16_t> C10_ALWAYS_INLINE neg() const {
...
template <>
Vectorize<int16_t> inline maximum(
    const Vectorize<int16_t>& a,
    const Vectorize<int16_t>& b) {
  return a.maximum(b);
}
...
template <>
Vectorize<int16_t> inline minimum(
    const Vectorize<int16_t>& a,
    const Vectorize<int16_t>& b) {
  return a.minimum(b);
}
