...
public:
  ...
  Vectorize<BFloat16> map(const __m256 (*vop)(__m256)) const {
    __m256 lo, hi;
...
Vectorize<BFloat16> static inline bfloat16_binary_op_as_fp32(const Vectorize<BFloat16>& a, const Vectorize<BFloat16>& b, Op op) {
  __m256 a_lo, a_hi;
  __m256 b_lo, b_hi;
...
template<typename Op>
Vectorize<BFloat16> static inline bfloat16_compare_as_fp32(const Vectorize<BFloat16>& a, const Vectorize<BFloat16>& b, Op op) {
  __m256 a_lo, a_hi;
  __m256 b_lo, b_hi;
  cvtbf16_fp32(__m256i(a), a_lo, a_hi);
  cvtbf16_fp32(__m256i(b), b_lo, b_hi);
