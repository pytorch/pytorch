...
inline void convert(const int64_t* src, float* dst, int64_t n) {
  ...
  for (uint64_t iters = count / fourRegsElemCount; iters > 0; --iters) {
    ...
    auto convertedVec1 = vreinterpretq_u64_f32(vcvtq_f32_s32(vreinterpretq_s32_s64(vec1)));
    auto convertedVec2 = vreinterpretq_u64_f32(vcvtq_f32_s32(vreinterpretq_s32_s64(vec2)));
    auto convertedVec3 = vreinterpretq_u64_f32(vcvtq_f32_s32(vreinterpretq_s32_s64(vec3)));
    auto convertedVec4 = vreinterpretq_u64_f32(vcvtq_f32_s32(vreinterpretq_s32_s64(vec4)));
    svst1w_u64(ptrue, dstPtr, svset_neonq(svundef_u64(), convertedVec1));
    svst1w_u64(ptrue, dstPtr + oneRegElemCount, svset_neonq(svundef_u64(), convertedVec2));
    svst1w_u64(ptrue, dstPtr + twoRegsElemCount, svset_neonq(svundef_u64(), convertedVec3));
    svst1w_u64(ptrue, dstPtr + (twoRegsElemCount + oneRegElemCount), svset_neonq(svundef_u64(), convertedVec4));
