...
public:
  ...
  Vectorize() {}
  Vectorize(int64_t v) { values = _mm512_set1_epi64(v); }
...
public:
  ...
  using Vectorizei::Vectorizei;
  Vectorize() {}
  Vectorize(int32_t v) { values = _mm512_set1_epi32(v); }
...
public:
  ...
  using Vectorizei::Vectorizei;
  Vectorize() {}
  Vectorize(int16_t v) { values = _mm512_set1_epi16(v); }
...
public:
  ...
  using Vectorizei::Vectorizei;
  Vectorize() {}
  Vectorize(int8_t v) { values = _mm512_set1_epi8(v); }
...
Vectorize<T> inline int_elementwise_binary_512(const Vectorize<T>& a, const Vectorize<T>& b, Op op) {
