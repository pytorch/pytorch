...
public:
  ...
  Vectorized(Half val1, Half val2, Half val3, Half val4,
         ...
         Half val17, Half val18, Half val19, Half val20,
         Half val21, Half val22, Half val23, Half val24,
         Half val25, Half val26, Half val27, Half val28,
         Half val29, Half val30, Half val31, Half val32) {
  ...
  Vectorized<Half> map(const __m512 (*const vop)(__m512)) const {
    __m512 lo, hi;
...
Vectorized<Half> static inline fp16_binary_op_as_fp32(const Vectorized<Half>& a,
                                                              const Vectorized<Half>& b, Op op) {
  __m512 a_lo, a_hi;
  __m512 b_lo, b_hi;
...
Vectorized<Half> inline Vectorized<Half>::operator>(const Vectorized<Half>& other) const {
  return fp16_binary_op_as_fp32(*this, other, [](__m512 x, __m512 y) {
...
Vectorized<Half> inline operator+(const Vectorized<Half>& a, const Vectorized<Half>& b) {
  return fp16_binary_op_as_fp32(a, b, [](const __m512& x, const __m512& y) { return _mm512_add_ps(x, y); });
}
Vectorized<Half> inline operator-(const Vectorized<Half>& a, const Vectorized<Half>& b) {
  return fp16_binary_op_as_fp32(a, b, [](const __m512& x, const __m512& y) { return _mm512_sub_ps(x, y); });
}
Vectorized<Half> inline operator*(const Vectorized<Half>& a, const Vectorized<Half>& b) {
  return fp16_binary_op_as_fp32(a, b, [](const __m512& x, const __m512& y) { return _mm512_mul_ps(x, y); });
}
Vectorized<Half> inline operator/(const Vectorized<Half>& a, const Vectorized<Half>& b) {
  return fp16_binary_op_as_fp32(a, b, [](const __m512& x, const __m512& y) { return _mm512_div_ps(x, y); });
}
