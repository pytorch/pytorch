...
class Vectorized<float> {
 ...
 public:
  ...
  static Vectorized<float> loadu(const void* ptr, int64_t count = size()) {
    ...
    if (count == size()) {
      return __riscv_vle32_v_f32m2(
          reinterpret_cast<const float*>(ptr), VFLOAT32_VL);
    } else {
      vfloat32m2_t zero_vec = __riscv_vfmv_v_f_f32m2(0.f, VFLOAT32_VL);
      return __riscv_vle32_v_f32m2_tu(
          zero_vec, reinterpret_cast<const float*>(ptr), count);
    }
#else
  ...
  Vectorized<float> isnan() const {
    ...
    vuint32m2_t vec_u32 =
        __riscv_vmerge_vxm_u32m2(zero_vec, 0xFFFFFFFF, isNaN, VFLOAT32_VL);
  ...
  Vectorized<float> sqrt() const {
    vfloat32m2_t values = __riscv_vle32_v_f32m2(this->values, VFLOAT32_VL);
    return Vectorized<float>(__riscv_vfsqrt_v_f32m2(values, VFLOAT32_VL));
  }
  Vectorized<float> reciprocal() const {
    vfloat32m2_t values = __riscv_vle32_v_f32m2(this->values, VFLOAT32_VL);
    vfloat32m2_t res = __riscv_vfdiv_vv_f32m2(
        __riscv_vfmv_v_f_f32m2(1.0f, VFLOAT32_VL), values, VFLOAT32_VL);
  ...
  Vectorized<float> operator!=(const Vectorized<float>& other) const {
    ...
    vuint32m2_t merge_res = __riscv_vmerge_vvm_u32m2(
        ...
        cmp_res,
        VFLOAT32_VL);
    vfloat32m2_t res = __riscv_vreinterpret_v_u32m2_f32m2(
        __riscv_vnot_v_u32m2(merge_res, VFLOAT32_VL));
    return Vectorized<float>(res);
  }
...
Vectorized<float> inline maximum(
  ...
  vfloat32m2_t res = __riscv_vmerge_vvm_f32m2(
      __riscv_vfmv_v_f_f32m2(NAN, VFLOAT32_VL), max_res, mask, VFLOAT32_VL);
  return Vectorized<float>(res);
}
...
Vectorized<float> inline minimum(
  ...
  vfloat32m2_t res = __riscv_vmerge_vvm_f32m2(
      __riscv_vfmv_v_f_f32m2(NAN, VFLOAT32_VL), min_res, mask, VFLOAT32_VL);
  return Vectorized<float>(res);
}
  ...
  for (i = 0; i <= (n - Vectorized<float>::size());
    ...
    __riscv_vse32_v_i32m2(
        ...
        __riscv_vfcvt_rtz_x_f_v_i32m2(
            __riscv_vle32_v_f32m2(src + i, VFLOAT32_VL), VFLOAT32_VL),
        VFLOAT32_VL);
  }
#ifndef __msvc_cl__
#pragma unroll
  ...
  for (i = 0; i <= (n - Vectorized<float>::size());
    ...
    __riscv_vse32_v_f32m2(
        ...
        __riscv_vfcvt_f_x_v_f32m2(
            __riscv_vle32_v_i32m2(src + i, VFLOAT32_VL), VFLOAT32_VL),
        VFLOAT32_VL);
  }
#ifndef __msvc_cl__
#pragma unroll
