...
struct Vectorized<c10::qint32> {
 ...
 public:
  ...
  Vectorized<c10::qint32> relu6(
    ...
    vint32m2_t vals = __riscv_vle32_v_i32m2(this->vals, VQINT32_VL);
    vint32m2_t zero_point_vals =
        __riscv_vle32_v_i32m2(zero_point.vals, VQINT32_VL);
  ...
  static Vectorized<c10::qint32> requantize_from_int(
    ...
    vfloat32m2_t scaled = __riscv_vfmul_vv_f32m2(
        __riscv_vfcvt_f_x_v_f32m2(inp[0], VQINT32_VL),
        multiplier_v,
        VQINT32_VL);
