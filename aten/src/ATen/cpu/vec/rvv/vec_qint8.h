...
struct Vectorized<c10::qint8> {
 ...
 public:
  ...
  static Vectorized<c10::qint8> loadu(const void* ptr, int count = size()) {
    ...
    return __riscv_vle8_v_i8m2_tu(
        zero_vec, reinterpret_cast<const value_type*>(ptr), count);
  }
 ...
 public:
  float_vec_return_type dequantize(
    ...
    vfloat32m2_t float_val0 = __riscv_vfcvt_f_x_v_f32m2(
        __riscv_vsext_vf4_i32m2(__riscv_vlmul_trunc_v_i8m2_i8mf2(i8_val0), 8),
        8);
    vfloat32m2_t float_val1 = __riscv_vfcvt_f_x_v_f32m2(
        __riscv_vsext_vf4_i32m2(__riscv_vlmul_trunc_v_i8m2_i8mf2(i8_val1), 8),
        8);
    vfloat32m2_t float_val2 = __riscv_vfcvt_f_x_v_f32m2(
        __riscv_vsext_vf4_i32m2(__riscv_vlmul_trunc_v_i8m2_i8mf2(i8_val2), 8),
        8);
    vfloat32m2_t float_val3 = __riscv_vfcvt_f_x_v_f32m2(
        __riscv_vsext_vf4_i32m2(__riscv_vlmul_trunc_v_i8m2_i8mf2(i8_val3), 8),
        8);
  ...
  static Vectorized<c10::qint8> quantize(
    ...
    vecf0 = __riscv_vfcvt_f_x_v_f32m2(
        __riscv_vfcvt_x_f_v_i32m2_rm(vecf0, __RISCV_FRM_RNE, 8), 8);
    vecf1 = __riscv_vfcvt_f_x_v_f32m2(
        __riscv_vfcvt_x_f_v_i32m2_rm(vecf1, __RISCV_FRM_RNE, 8), 8);
    vecf2 = __riscv_vfcvt_f_x_v_f32m2(
        __riscv_vfcvt_x_f_v_i32m2_rm(vecf2, __RISCV_FRM_RNE, 8), 8);
    vecf3 = __riscv_vfcvt_f_x_v_f32m2(
        __riscv_vfcvt_x_f_v_i32m2_rm(vecf3, __RISCV_FRM_RNE, 8), 8);
    ...
    vint8m2_t vec0 = __riscv_vlmul_ext_v_i8mf2_i8m2(
        __riscv_vnclip_wx_i8mf2(vecshi0, 0, __RISCV_VXRM_RDN, 8));
    vint8m2_t vec1 = __riscv_vlmul_ext_v_i8mf2_i8m2(
        __riscv_vnclip_wx_i8mf2(vecshi1, 0, __RISCV_VXRM_RDN, 8));
    vint8m2_t vec2 = __riscv_vlmul_ext_v_i8mf2_i8m2(
        __riscv_vnclip_wx_i8mf2(vecshi2, 0, __RISCV_VXRM_RDN, 8));
    vint8m2_t vec3 = __riscv_vlmul_ext_v_i8mf2_i8m2(
        __riscv_vnclip_wx_i8mf2(vecshi3, 0, __RISCV_VXRM_RDN, 8));
  ...
  int_vec_return_type widening_subtract(Vectorized<c10::qint8> b) const {
    ...
    vint32m2_t int32_val0 =
        __riscv_vsext_vf4_i32m2(__riscv_vlmul_trunc_v_i8m2_i8mf2(i8_val0), 8);
    vint32m2_t int32_val1 =
        __riscv_vsext_vf4_i32m2(__riscv_vlmul_trunc_v_i8m2_i8mf2(i8_val1), 8);
    vint32m2_t int32_val2 =
        __riscv_vsext_vf4_i32m2(__riscv_vlmul_trunc_v_i8m2_i8mf2(i8_val2), 8);
    vint32m2_t int32_val3 =
        __riscv_vsext_vf4_i32m2(__riscv_vlmul_trunc_v_i8m2_i8mf2(i8_val3), 8);
    ...
    vint32m2_t int32_b0 =
        __riscv_vsext_vf4_i32m2(__riscv_vlmul_trunc_v_i8m2_i8mf2(i8_b0), 8);
    vint32m2_t int32_b1 =
        __riscv_vsext_vf4_i32m2(__riscv_vlmul_trunc_v_i8m2_i8mf2(i8_b1), 8);
    vint32m2_t int32_b2 =
        __riscv_vsext_vf4_i32m2(__riscv_vlmul_trunc_v_i8m2_i8mf2(i8_b2), 8);
    vint32m2_t int32_b3 =
        __riscv_vsext_vf4_i32m2(__riscv_vlmul_trunc_v_i8m2_i8mf2(i8_b3), 8);
