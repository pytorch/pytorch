 ...
 public:
  float_vec_return_type dequantize(
    ...
    vfloat32m2_t float_val0 = __riscv_vfcvt_f_x_v_f32m2(
        __riscv_vreinterpret_v_u32m2_i32m2(__riscv_vzext_vf4_u32m2(
            __riscv_vlmul_trunc_v_u8m2_u8mf2(u8_val0), 8)),
        8);
    vfloat32m2_t float_val1 = __riscv_vfcvt_f_x_v_f32m2(
        __riscv_vreinterpret_v_u32m2_i32m2(__riscv_vzext_vf4_u32m2(
            __riscv_vlmul_trunc_v_u8m2_u8mf2(u8_val1), 8)),
        8);
    vfloat32m2_t float_val2 = __riscv_vfcvt_f_x_v_f32m2(
        __riscv_vreinterpret_v_u32m2_i32m2(__riscv_vzext_vf4_u32m2(
            __riscv_vlmul_trunc_v_u8m2_u8mf2(u8_val2), 8)),
        8);
    vfloat32m2_t float_val3 = __riscv_vfcvt_f_x_v_f32m2(
        __riscv_vreinterpret_v_u32m2_i32m2(__riscv_vzext_vf4_u32m2(
            __riscv_vlmul_trunc_v_u8m2_u8mf2(u8_val3), 8)),
        8);
  ...
  static Vectorized<c10::quint8> quantize(
    ...
    vuint16m1_t vecshi0 = __riscv_vreinterpret_v_i16m1_u16m1(
        __riscv_vnclip_wx_i16m1(veci0, 0, __RISCV_VXRM_RDN, 8));
    vuint16m1_t vecshi1 = __riscv_vreinterpret_v_i16m1_u16m1(
        __riscv_vnclip_wx_i16m1(veci1, 0, __RISCV_VXRM_RDN, 8));
    vuint16m1_t vecshi2 = __riscv_vreinterpret_v_i16m1_u16m1(
        __riscv_vnclip_wx_i16m1(veci2, 0, __RISCV_VXRM_RDN, 8));
    vuint16m1_t vecshi3 = __riscv_vreinterpret_v_i16m1_u16m1(
        __riscv_vnclip_wx_i16m1(veci3, 0, __RISCV_VXRM_RDN, 8));

    vuint8m2_t vec0 = __riscv_vlmul_ext_v_u8mf2_u8m2(
        __riscv_vnclipu_wx_u8mf2(vecshi0, 0, __RISCV_VXRM_RDN, 8));
    vuint8m2_t vec1 = __riscv_vlmul_ext_v_u8mf2_u8m2(
        __riscv_vnclipu_wx_u8mf2(vecshi1, 0, __RISCV_VXRM_RDN, 8));
    vuint8m2_t vec2 = __riscv_vlmul_ext_v_u8mf2_u8m2(
        __riscv_vnclipu_wx_u8mf2(vecshi2, 0, __RISCV_VXRM_RDN, 8));
    vuint8m2_t vec3 = __riscv_vlmul_ext_v_u8mf2_u8m2(
        __riscv_vnclipu_wx_u8mf2(vecshi3, 0, __RISCV_VXRM_RDN, 8));
  ...
  Vectorized<c10::quint8> relu6(
    ...
    vuint8m2_t vals = __riscv_vle8_v_u8m2(this->vals, VQUINT8_VL);
    vuint8m2_t zero_point_vals =
        __riscv_vle8_v_u8m2(zero_point.vals, VQUINT8_VL);
  ...
  int_vec_return_type widening_subtract(Vectorized<c10::quint8> b) const {
    ...
    vint32m2_t int32_val0 = __riscv_vreinterpret_v_u32m2_i32m2(
        __riscv_vzext_vf4_u32m2(__riscv_vlmul_trunc_v_u8m2_u8mf2(u8_val0), 8));
    vint32m2_t int32_val1 = __riscv_vreinterpret_v_u32m2_i32m2(
        __riscv_vzext_vf4_u32m2(__riscv_vlmul_trunc_v_u8m2_u8mf2(u8_val1), 8));
    vint32m2_t int32_val2 = __riscv_vreinterpret_v_u32m2_i32m2(
        __riscv_vzext_vf4_u32m2(__riscv_vlmul_trunc_v_u8m2_u8mf2(u8_val2), 8));
    vint32m2_t int32_val3 = __riscv_vreinterpret_v_u32m2_i32m2(
        __riscv_vzext_vf4_u32m2(__riscv_vlmul_trunc_v_u8m2_u8mf2(u8_val3), 8));
    ...
    vint32m2_t int32_b0 = __riscv_vreinterpret_v_u32m2_i32m2(
        __riscv_vzext_vf4_u32m2(__riscv_vlmul_trunc_v_u8m2_u8mf2(u8_b0), 8));
    vint32m2_t int32_b1 = __riscv_vreinterpret_v_u32m2_i32m2(
        __riscv_vzext_vf4_u32m2(__riscv_vlmul_trunc_v_u8m2_u8mf2(u8_b1), 8));
    vint32m2_t int32_b2 = __riscv_vreinterpret_v_u32m2_i32m2(
        __riscv_vzext_vf4_u32m2(__riscv_vlmul_trunc_v_u8m2_u8mf2(u8_b2), 8));
    vint32m2_t int32_b3 = __riscv_vreinterpret_v_u32m2_i32m2(
        __riscv_vzext_vf4_u32m2(__riscv_vlmul_trunc_v_u8m2_u8mf2(u8_b3), 8));
  ...
  static Vectorized<c10::quint8> requantize_from_int(
    ...
    vuint16m1_t vecu0 = __riscv_vreinterpret_v_i16m1_u16m1(
        __riscv_vmerge_vxm_i16m1(vecshi0, 0, neg_mask0, 8));
    vuint16m1_t vecu1 = __riscv_vreinterpret_v_i16m1_u16m1(
        __riscv_vmerge_vxm_i16m1(vecshi1, 0, neg_mask1, 8));
    vuint16m1_t vecu2 = __riscv_vreinterpret_v_i16m1_u16m1(
        __riscv_vmerge_vxm_i16m1(vecshi2, 0, neg_mask2, 8));
    vuint16m1_t vecu3 = __riscv_vreinterpret_v_i16m1_u16m1(
        __riscv_vmerge_vxm_i16m1(vecshi3, 0, neg_mask3, 8));

    vuint8m2_t vec0 = __riscv_vlmul_ext_v_u8mf2_u8m2(
        __riscv_vnclipu_wx_u8mf2(vecu0, 0, __RISCV_VXRM_RDN, 8));
    vuint8m2_t vec1 = __riscv_vlmul_ext_v_u8mf2_u8m2(
        __riscv_vnclipu_wx_u8mf2(vecu1, 0, __RISCV_VXRM_RDN, 8));
    vuint8m2_t vec2 = __riscv_vlmul_ext_v_u8mf2_u8m2(
        __riscv_vnclipu_wx_u8mf2(vecu2, 0, __RISCV_VXRM_RDN, 8));
    vuint8m2_t vec3 = __riscv_vlmul_ext_v_u8mf2_u8m2(
        __riscv_vnclipu_wx_u8mf2(vecu3, 0, __RISCV_VXRM_RDN, 8));
