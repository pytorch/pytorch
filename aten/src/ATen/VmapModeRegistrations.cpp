...
// Whenever we're inside a vmap, all Tensors dispatch on this key. At the
// moment, this key is used to disable random operations inside of vmap. If you
// are looking for Batching Rules, those are registered with
// DispatchKey::Batched instead.
//
...
TORCH_LIBRARY_IMPL(aten, VmapMode, m) {
  ...
  // CppFunction::makeNamedNotSupported() to avoid listing out the types of
  // everything. However, registering e.g. CppFunction::makeNamedNotSupported()
  // as an implementation only works for operators that support boxing.
#define TENSOROPTIONS                                         \
  c10::optional<c10::ScalarType>, c10::optional<c10::Layout>, \
      c10::optional<c10::Device>, c10::optional<bool>

  // random operations (out-of-place)
  m.impl("bernoulli", unsupportedRandomOp<const Tensor&, optional<Generator>>);
  m.impl(
      "bernoulli.out",
      unsupportedRandomOp_<const Tensor&, optional<Generator>, Tensor&>);
  m.impl(
      "bernoulli.p",
      unsupportedRandomOp<const Tensor&, double, optional<Generator>>);
  m.impl(
      "bernoulli_.Tensor",
      unsupportedRandomOp_<Tensor&, const Tensor&, optional<Generator>>);
  m.impl(
      "bernoulli_.float",
      unsupportedRandomOp_<Tensor&, double, optional<Generator>>);

  m.impl(
      "cauchy_",
      unsupportedRandomOp_<Tensor&, double, double, optional<Generator>>);
  m.impl(
      "exponential_",
      unsupportedRandomOp_<Tensor&, double, optional<Generator>>);
  m.impl(
      "geometric_", unsupportedRandomOp_<Tensor&, double, optional<Generator>>);
  m.impl(
      "log_normal_",
      unsupportedRandomOp_<Tensor&, double, double, optional<Generator>>);
  m.impl(
      "multinomial",
      unsupportedRandomOp<const Tensor&, int64_t, bool, optional<Generator>>);
  m.impl(
      "multinomial.out",
  ...
  m.impl(
      "normal.float_Tensor",
      unsupportedRandomOp<double, const Tensor&, optional<Generator>>);
  m.impl(
      "normal.Tensor_Tensor",
      unsupportedRandomOp<const Tensor&, const Tensor&, optional<Generator>>);
  m.impl(
  ...
  m.impl(
      "random_.to",
      unsupportedRandomOp_<Tensor&, int64_t, optional<Generator>>);
  ...
  m.impl(
      "rand.generator",
      unsupportedRandomOp<IntArrayRef, optional<Generator>, TENSOROPTIONS>);
  m.impl(
      "rand.names",
      unsupportedRandomOp<IntArrayRef, optional<DimnameList>, TENSOROPTIONS>);
  m.impl(
      "rand.generator_with_names",
      unsupportedRandomOp<
          IntArrayRef,
          optional<Generator>,
          optional<DimnameList>,
          TENSOROPTIONS>);
  m.impl("rand.out", unsupportedRandomOp_<IntArrayRef, Tensor&>);
  m.impl(
      "rand.generator_out",
      unsupportedRandomOp_<IntArrayRef, optional<Generator>, Tensor&>);
  ...
  m.impl(
      "randperm.generator",
      unsupportedRandomOp<int64_t, optional<Generator>, TENSOROPTIONS>);
  m.impl("randperm.out", unsupportedRandomOp_<int64_t, Tensor&>);
  m.impl(
      "randperm.generator_out",
      unsupportedRandomOp_<int64_t, optional<Generator>, Tensor&>);
  ...
  m.impl(
      "randint.low",
      unsupportedRandomOp<int64_t, int64_t, IntArrayRef, TENSOROPTIONS>);
  m.impl(
  ...
  m.impl(
      ...
      unsupportedRandomOp_<int64_t, IntArrayRef, optional<Generator>, Tensor&>);
  m.impl(
      "randint.low_out",
      unsupportedRandomOp_<int64_t, int64_t, IntArrayRef, Tensor&>);
  m.impl(
