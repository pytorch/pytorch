...
public:
  ...
  void raw_resize_(int64_t sparse_dim, int64_t dense_dim, IntListRef size) {
  ...
  void resize_(int64_t sparse_dim, int64_t dense_dim, IntListRef size) {
...
2. If you need to resize this tensor, you have the following options:\n\
  ...
  void resize_and_clear_(int64_t sparse_dim, int64_t dense_dim, IntListRef size) {
