...
template <> struct AccumulateType<c10::complex<Half>, false> { using type = c10::complex<float>; };
...
template <> struct AccumulateType<c10::complex<Half>, true> { using type = c10::complex<float>; };
