...
void propagate_names_for_addmm(
  ...
  auto mm_outnames = compute_mm_outnames(impl::get_opt_names(m1), impl::get_opt_names(m2));
  auto add_outnames = unify_from_right(mm_outnames, impl::get_opt_names(bias));
