...
Tensor FunctionalInverses::_nested_view_from_jagged_inverse(const Tensor& base, const Tensor& mutated_view, InverseReturnMode inverse_return_mode, const Tensor& offsets, const Tensor& dummy, const Tensor& dummy_entry, const std::optional<Tensor>& lengths, int64_t ragged_idx, const std::optional<Tensor>& min_seqlen, const std::optional<Tensor>& max_seqlen) {
...
Tensor FunctionalInverses::_nested_get_values_inverse(const Tensor& base, const Tensor& mutated_view, InverseReturnMode inverse_return_mode) {
  ...
  auto dummy_entry = at::_nested_get_jagged_dummy_entry(base);
  ...
  auto nt = at::_nested_view_from_jagged(
      mutated_view, offsets, dummy, dummy_entry, lengths, ragged_idx,
