...
static void conv2ddw_op_benchmark(benchmark::State& state) {
  ...
  at::native::vulkan::api::context()->querypool().extract_results();
  at::native::vulkan::api::context()->querypool().print_results();
  state.SetIterationTime(at::native::vulkan::api::context()->querypool().get_time("conv2d_dw"));
#endif
}
...
static void conv2ddw_op_q_benchmark(benchmark::State& state) {
  ...
  at::native::vulkan::api::context()->querypool().extract_results();
  at::native::vulkan::api::context()->querypool().print_results();
  state.SetIterationTime(at::native::vulkan::api::context()->querypool().get_time("quantized_conv2d_dw"));
#endif
}
...
static void sub_op_benchmark(benchmark::State& state) {
  ...
  at::native::vulkan::api::context()->querypool().extract_results();
  at::native::vulkan::api::context()->querypool().print_results();
  state.SetIterationTime(at::native::vulkan::api::context()->querypool().get_time("sub"));
#endif
}
...
static void sub_op_q_benchmark(benchmark::State& state) {
  ...
  at::native::vulkan::api::context()->querypool().extract_results();
  at::native::vulkan::api::context()->querypool().print_results();
  state.SetIterationTime(at::native::vulkan::api::context()->querypool().get_time("quantized_sub"));
#endif
}
...
static void mul_op_benchmark(benchmark::State& state) {
  ...
  at::native::vulkan::api::context()->querypool().extract_results();
  at::native::vulkan::api::context()->querypool().print_results();
  state.SetIterationTime(at::native::vulkan::api::context()->querypool().get_time("mul"));
#endif
}
...
static void mul_op_q_benchmark(benchmark::State& state) {
  ...
  at::native::vulkan::api::context()->querypool().extract_results();
  at::native::vulkan::api::context()->querypool().print_results();
  state.SetIterationTime(at::native::vulkan::api::context()->querypool().get_time("quantized_mul"));
#endif
}
...
static void div_op_benchmark(benchmark::State& state) {
  ...
  at::native::vulkan::api::context()->querypool().extract_results();
  at::native::vulkan::api::context()->querypool().print_results();
  state.SetIterationTime(at::native::vulkan::api::context()->querypool().get_time("div"));
#endif
}
...
static void div_op_q_benchmark(benchmark::State& state) {
  ...
  at::native::vulkan::api::context()->querypool().extract_results();
  at::native::vulkan::api::context()->querypool().print_results();
  state.SetIterationTime(at::native::vulkan::api::context()->querypool().get_time("quantized_div"));
#endif
}
