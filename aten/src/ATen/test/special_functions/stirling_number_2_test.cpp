...
struct stirling_number_2_fixture {
  T1 f0;
  unsigned int n;
  unsigned int m;
  T1 f;
...
const stirling_number_2_fixture<double> fixture_0001[11] = {
...
const stirling_number_2_fixture<double> fixture_0002[11] = {
...
const stirling_number_2_fixture<double> fixture_0003[11] = {
...
const stirling_number_2_fixture<double> fixture_0004[11] = {
...
const stirling_number_2_fixture<double> fixture_0005[11] = {
...
const stirling_number_2_fixture<double> fixture_0006[11] = {
...
const stirling_number_2_fixture<double> fixture_0007[11] = {
...
const stirling_number_2_fixture<double> fixture_0008[11] = {
...
const stirling_number_2_fixture<double> fixture_0009[11] = {
...
const stirling_number_2_fixture<double> fixture_0010[11] = {
...
const stirling_number_2_fixture<double> fixture_0011[11] = {
...
void
test(const stirling_number_2_fixture<T1>(&fixtures)[T2], T1 tolerance) {
  ...
  for (auto fixture: fixtures) {
    const T1 g = aten::native::special_functions::stirling_number_2<T1>(fixture.n, fixture.m);
