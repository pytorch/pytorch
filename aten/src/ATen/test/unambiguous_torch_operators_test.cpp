...
#include <ATen/ATen.h>
#include <ATen/UnambiguousTorchOperators.h>
...
TEST(UnambiguousTorchOperatorsTest, TestFunctionDecltype) {
...
TEST(UnambiguousTorchOperatorsTest, TestMethodOnlyDecltype) {
  Tensor a = at::randn({5, 5});
  Tensor b = at::randn({5, 5});
  auto expected = a * b;
...
TEST(UnambiguousTorchOperatorsTest, Test_ATEN_FN) {
...
TEST(UnambiguousTorchOperatorsTest, TestOutVariantIsFaithful) {
  Tensor a = at::rand({5, 5});
