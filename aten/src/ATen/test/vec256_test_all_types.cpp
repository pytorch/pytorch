...
using FloatTestedTypes =
    ::testing::Types<vfloat, vdouble, vcomplex, vcomplexDbl>;
using ALLTestedTypes = ::testing::Types<
    vfloat,
    vdouble,
    vcomplex,
    vlong,
...
using FloatIntTestedTypes = ::testing::
    Types<vfloat, vdouble, vcomplex, vcomplexDbl, vlong, vint, vshort>;
...
TYPED_TEST(Hyperbolic, Sinh) {
  ...
  auto test_case = TestingCase<vec>::getBuilder()
                       .addDomain(CheckWithinDomains<UVT>{
                           {{-88, 88}}, true, getDefaultTolerance<UVT>()})
                       .setTrialCount(65536)
                       .setTestSeed(TestSeed());
  test_unary<vec>(
      NAME_INFO(sinh),
...
TYPED_TEST(InverseTrigonometric, Asin) {
  ...
  auto test_case =
      TestingCase<vec>::getBuilder()
          .addDomain(CheckWithinDomains<UVT>{
              {{-10, 10}}, checkRelativeErr, getDefaultTolerance<UVT>()})
...
TYPED_TEST(InverseTrigonometric, ATan) {
  ...
  auto test_case =
      TestingCase<vec>::getBuilder()
          .addDomain(CheckWithinDomains<UVT>{
              {{-100, 100}}, checkRelativeErr, getDefaultTolerance<UVT>()})
          .setTrialCount(65536)
          .setTestSeed(TestSeed());
  test_unary<vec>(
      NAME_INFO(atan),
...
TYPED_TEST(LogarithmReals, Log1p) {
  ...
  auto test_case = TestingCase<vec>::getBuilder()
                       .addDomain(CheckWithinDomains<UVT>{
                           {{-1, 1000}}, true, getDefaultTolerance<UVT>()})
                       .addDomain(CheckWithinDomains<UVT>{
                           {{1000, 1.e+30}}, true, getDefaultTolerance<UVT>()})
                       .setTrialCount(65536)
                       .setTestSeed(TestSeed());
  test_unary<vec>(
      NAME_INFO(log1p),
...
TYPED_TEST(LGamma, LGamma) {
  ...
  TestingCase<vec> testCase =
      TestingCase<vec>::getBuilder()
          .addDomain(
              CheckWithinDomains<UVT>{{{(UVT)-100, (UVT)0}}, true, tolerance})
          .addDomain(
              CheckWithinDomains<UVT>{{{(UVT)0, (UVT)1000}}, true, tolerance})
          .addDomain(CheckWithinDomains<UVT>{
              {{(UVT)1000, maxCorrect}}, true, tolerance})
          .setTestSeed(TestSeed());
  test_unary<vec>(
      NAME_INFO(lgamma),
...
TYPED_TEST(InverseTrigonometricReal, ATan2) {
  ...
  test_binary<vec>(
      ...
      [](vec v0, vec v1) { return v0.atan2(v1); },
      createDefaultBinaryTestCase<vec>(TestSeed()));
}
// NOLINTNEXTLINE(cppcoreguidelines-avoid-non-const-global-variables)
TYPED_TEST(Pow, Pow) {
...
TYPED_TEST(Interleave, Interleave) {
  ...
  AssertVec256<vec>(
      NAME_INFO(Interleave FirstHalf), std::get<0>(cc), vec::loadu(interleaved))
      .check(true);
  AssertVec256<vec>(
      NAME_INFO(Interleave SecondHalf),
      std::get<1>(cc),
      vec::loadu(interleaved + vec::size()))
      .check(true);
}
// NOLINTNEXTLINE(cppcoreguidelines-avoid-non-const-global-variables)
TYPED_TEST(Interleave, DeInterleave) {
  ...
  AssertVec256<vec>(
      NAME_INFO(DeInterleave FirstHalf), std::get<0>(cc), vec::loadu(vals))
      .check(true);
  AssertVec256<vec>(
      NAME_INFO(DeInterleave SecondHalf),
      std::get<1>(cc),
      vec::loadu(vals + vec::size()))
      .check(true);
}
// NOLINTNEXTLINE(cppcoreguidelines-avoid-non-const-global-variables)
TYPED_TEST(Arithmetics, Plus) {
  ...
  test_binary<vec>(
      NAME_INFO(plus),
      std::plus<VT>(),
      [](const vec& v0, const vec& v1) -> vec { return v0 + v1; },
      createDefaultBinaryTestCase<vec>(TestSeed()),
...
TYPED_TEST(Comparison, Equal) {
  ...
  test_binary<vec>(
      ...
      [](const VT& v1, const VT& v2) {
        return func_cmp(std::equal_to<VT>(), v1, v2);
      },
      [](const vec& v0, const vec& v1) { return v0 == v1; },
      createDefaultBinaryTestCase<vec>(TestSeed(), true));
}
...
TYPED_TEST(Comparison, NotEqual) {
  ...
  test_binary<vec>(
      NAME_INFO(!=),
      [](const VT& v1, const VT& v2) {
        return func_cmp(std::not_equal_to<VT>(), v1, v2);
      },
      [](const vec& v0, const vec& v1) { return v0 != v1; },
      createDefaultBinaryTestCase<vec>(TestSeed(), true));
}
...
TYPED_TEST(Comparison, Greater) {
  ...
  test_binary<vec>(
      NAME_INFO(>),
      [](const VT& v1, const VT& v2) {
        return func_cmp(std::greater<VT>(), v1, v2);
      },
      [](const vec& v0, const vec& v1) { return v0 > v1; },
      createDefaultBinaryTestCase<vec>(TestSeed(), true));
}
...
TYPED_TEST(Comparison, Less) {
  ...
  test_binary<vec>(
      NAME_INFO(<),
      [](const VT& v1, const VT& v2) {
        return func_cmp(std::less<VT>(), v1, v2);
      },
      [](const vec& v0, const vec& v1) { return v0 < v1; },
      createDefaultBinaryTestCase<vec>(TestSeed(), true));
}
...
TYPED_TEST(Comparison, GreaterEqual) {
  ...
  test_binary<vec>(
      NAME_INFO(>=),
      [](const VT& v1, const VT& v2) {
        return func_cmp(std::greater_equal<VT>(), v1, v2);
      },
      [](const vec& v0, const vec& v1) { return v0 >= v1; },
      createDefaultBinaryTestCase<vec>(TestSeed(), true));
}
...
TYPED_TEST(Comparison, LessEqual) {
  ...
  test_binary<vec>(
      NAME_INFO(<=),
      [](const VT& v1, const VT& v2) {
        return func_cmp(std::less_equal<VT>(), v1, v2);
      },
      [](const vec& v0, const vec& v1) { return v0 <= v1; },
      createDefaultBinaryTestCase<vec>(TestSeed(), true));
}
...
TYPED_TEST(MinMax, Minimum) {
  ...
  test_binary<vec>(
      NAME_INFO(minimum),
      minimum<VT>,
      [](const vec& v0, const vec& v1) { return minimum(v0, v1); },
      createDefaultBinaryTestCase<vec>(TestSeed()));
}
// NOLINTNEXTLINE(cppcoreguidelines-avoid-non-const-global-variables)
TYPED_TEST(MinMax, Maximum) {
  ...
  test_binary<vec>(
      NAME_INFO(maximum),
      maximum<VT>,
      [](const vec& v0, const vec& v1) { return maximum(v0, v1); },
      createDefaultBinaryTestCase<vec>(TestSeed()));
}
// NOLINTNEXTLINE(cppcoreguidelines-avoid-non-const-global-variables)
TYPED_TEST(MinMax, ClampMin) {
  ...
  test_binary<vec>(
      NAME_INFO(clamp min),
      clamp_min<VT>,
      [](const vec& v0, const vec& v1) { return clamp_min(v0, v1); },
      createDefaultBinaryTestCase<vec>(TestSeed()));
}
// NOLINTNEXTLINE(cppcoreguidelines-avoid-non-const-global-variables)
TYPED_TEST(MinMax, ClampMax) {
  ...
  test_binary<vec>(
      NAME_INFO(clamp max),
      clamp_max<VT>,
      [](const vec& v0, const vec& v1) { return clamp_max(v0, v1); },
      createDefaultBinaryTestCase<vec>(TestSeed()));
}
// NOLINTNEXTLINE(cppcoreguidelines-avoid-non-const-global-variables)
...
TYPED_TEST(BitwiseFloatsAdditional, Convert) {
  ...
  if (AssertVec256<VecType<IntVT>>(
          NAME_INFO(test_convert_to_int), expected1, actual1)
          .check()) {
    return;
  }
  ...
  AssertVec256<vec>(NAME_INFO(test_convert_to_float), expected2, actual2)
      .check();
}
// NOLINTNEXTLINE(cppcoreguidelines-avoid-non-const-global-variables)
  ...
  auto test_case = TestingCase<vec>::getBuilder()
                       .addDomain(CheckWithinDomains<VT>{
                           {{(VT)-1000, (VT)1000},
                            ...
                            {(VT)-1000, (VT)1000}},
                           true,
                           getDefaultTolerance<VT>()})
                       .setTestSeed(TestSeed());

  test_ternary<vec>(
      NAME_INFO(clamp),
      RESOLVE_OVERLOAD(local_fmadd),
      [](const vec& v0, const vec& v1, const vec& v2) {
...
test_blend(VT expected_val[vec::size()], VT a[vec::size()], VT b[vec::size()]) {
  ...
  if (AssertVec256<vec>(
          std::string(NAME_INFO(test_blend)) + mask_str, expected, actual)
          .check())
    return;
...
test_blendv(
  ...
  if (AssertVec256<vec>(
          std::string(NAME_INFO(test_blendv)) + mask_str, expected, actual)
          .check()) {
    return false;
  }
  return true;
...
test_blendv(
  ...
  VT m = mask[idx];
  if (!test_blendv<vec, VT, idx + 1, N>(expected_val, a, b, mask))
    return false;
  if (m != (VT)0) {
    mask[idx] = (VT)0;
  } else {
...
template <>
// NOLINTNEXTLINE(cppcoreguidelines-avoid-c-arrays,modernize-avoid-c-arrays)
void blend_init<Complex<float>, 4>(
    Complex<float> (&a)[4],
    Complex<float> (&b)[4]) {
...
template <>
// NOLINTNEXTLINE(cppcoreguidelines-avoid-c-arrays,modernize-avoid-c-arrays)
void blend_init<Complex<double>, 2>(
    Complex<double> (&a)[2],
    Complex<double> (&b)[2]) {
...
void test_set(
  ...
  if (AssertVec256<vec>(
          std::string(NAME_INFO(test_set)) + count_str, expected, actual)
          .check()) {
    return;
  }
...
template <typename T>
std::enable_if_t<!is_complex<T>::value, void> arange_init(T& base, T& step) {
  base = (T)5.0;
  step = (T)2.0;
}
template <typename T>
...
TYPED_TEST(QuantizationTests, Quantize) {
  ...
  for (int i = 0; i < trials; i++) {
    ...
    if (AssertVec256<vec>(NAME_INFO(Quantize), expected, actual).check())
      return;
  } // trials;
}
// NOLINTNEXTLINE(cppcoreguidelines-avoid-non-const-global-variables)
TYPED_TEST(QuantizationTests, DeQuantize) {
  ...
  constexpr int trials =
      is_large ? 4000 : std::numeric_limits<underlying>::max() / 2;
  constexpr int min_val =
      is_large ? -2190 : std::numeric_limits<underlying>::min();
  constexpr int max_val =
      is_large ? 2199 : std::numeric_limits<underlying>::max();
  // NOLINTNEXTLINE(cppcoreguidelines-avoid-c-arrays,modernize-avoid-c-arrays)
  ...
  std::cout << "Dequant will be tested with relative error " << 1.e-3f
            << std::endl;
#endif
  auto seed = TestSeed();
...
#if defined(CHECK_DEQUANT_WITH_LOW_PRECISION)
      if (AssertVec256<vfloat>(NAME_INFO(DeQuantize), seed, expected, actual)
              .check(false, true, 1.e-3f))
        return;
#else
      if (AssertVec256<vfloat>(NAME_INFO(DeQuantize), seed, expected, actual)
              .check())
  ...
  for (int i = 0; i < trials; i++) {
    ...
    for (int j = 0; j < vec::float_num_vecs(); j++) {
      ...
      for (auto& v : unit_int_vec) {
        ...
        expected_qint_vals[index] =
            requantize_from_int<underlying>(multiplier, zero_point_val, v.val_);
        index++;
      }
    ...
    if (AssertVec256<vec>(NAME_INFO(ReQuantizeFromInt), seed, expected, actual)
            .check()) {
      return;
    }
  } // trials;
...
TYPED_TEST(QuantizationTests, Relu) {
  ...
  constexpr VT fake_zp =
      sizeof(VT) > 1 ? static_cast<VT>(65535) : static_cast<VT>(47);
  auto test_case = TestingCase<vec>::getBuilder()
                       .addDomain(CheckWithinDomains<VT>{
  ...
  test_binary<vec>(
      ...
      [](const vec& v0, const vec& v1) { return v0.relu(v1); },
      test_case);
}
// NOLINTNEXTLINE(cppcoreguidelines-avoid-non-const-global-variables)
TYPED_TEST(QuantizationTests, Relu6) {
  ...
  constexpr VT fake_zp =
      sizeof(VT) > 1 ? static_cast<VT>(65535) : static_cast<VT>(47);
  constexpr VT temp =
      sizeof(VT) > 1 ? static_cast<VT>(12345) : static_cast<VT>(32);
