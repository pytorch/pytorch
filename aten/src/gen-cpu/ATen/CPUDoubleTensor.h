...
struct CPUDoubleTensor final : public TensorImpl {
public:
  explicit CPUDoubleTensor(Context* context);
  CPUDoubleTensor(Context* context, THDoubleTensor * tensor);
  virtual ~CPUDoubleTensor();
