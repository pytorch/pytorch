...
struct CPUCharTensor final : public TensorImpl {
public:
  explicit CPUCharTensor(Context* context);
  CPUCharTensor(Context* context, THCharTensor * tensor);
  virtual ~CPUCharTensor();
