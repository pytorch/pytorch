...
libtorch_nvfuser_runtime_sources = [
    ...
    "nvfuser/runtime/array_rocm.cu",
    "nvfuser/runtime/bf16_support.cu",
    "nvfuser/runtime/bf16_support_rocm.cu",
    "nvfuser/runtime/block_reduction.cu",
    "nvfuser/runtime/block_sync_atomic.cu",
    "nvfuser/runtime/block_sync_default.cu",
    "nvfuser/runtime/block_sync_default_rocm.cu",
    "nvfuser/runtime/broadcast.cu",
    "nvfuser/runtime/fp16_support.cu",
    "nvfuser/runtime/fused_reduction.cu",
    "nvfuser/runtime/fused_welford_helper.cu",
    "nvfuser/runtime/fused_welford_impl.cu",
    "nvfuser/runtime/grid_broadcast.cu",
    "nvfuser/runtime/grid_reduction.cu",
    "nvfuser/runtime/grid_sync.cu",
    "nvfuser/runtime/helpers.cu",
    "nvfuser/runtime/index_utils.cu",
    "nvfuser/runtime/memory.cu",
    "nvfuser/runtime/random_numbers.cu",
    "nvfuser/runtime/swizzle.cu",
    "nvfuser/runtime/tensor.cu",
    "nvfuser/runtime/tensorcore.cu",
    "nvfuser/runtime/tuple.cu",
    "nvfuser/runtime/type_traits.cu",
    "nvfuser/runtime/warp.cu",
    "nvfuser/runtime/warp_rocm.cu",
    "nvfuser/runtime/welford.cu",
