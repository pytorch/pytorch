...
jit_sources_full = [
    "third_party/nvfuser/interface.cpp",
...
libtorch_cuda_core_sources = [
    ...
    "third_party/nvfuser/arith.cpp",
    "third_party/nvfuser/compute_at.cpp",
    "third_party/nvfuser/inline_propagator.cpp",
    "third_party/nvfuser/compute_at_map.cpp",
    "third_party/nvfuser/codegen.cpp",
    "third_party/nvfuser/contiguity.cpp",
    "third_party/nvfuser/dispatch.cpp",
    "third_party/nvfuser/expr_evaluator.cpp",
    "third_party/nvfuser/executor.cpp",
    "third_party/nvfuser/executor_kernel_arg.cpp",
    "third_party/nvfuser/executor_launch_params.cpp",
    "third_party/nvfuser/evaluator_common.cpp",
    "third_party/nvfuser/executor_utils.cpp",
    "third_party/nvfuser/fusion.cpp",
    "third_party/nvfuser/graph_fuser.cpp",
    "third_party/nvfuser/grouped_reduction.cpp",
    "third_party/nvfuser/index_compute.cpp",
    "third_party/nvfuser/lower_index_compute.cpp",
    "third_party/nvfuser/instrumentation.cpp",
    "third_party/nvfuser/ir_base_nodes.cpp",
    "third_party/nvfuser/ir_builder.cpp",
    "third_party/nvfuser/ir_cloner.cpp",
    "third_party/nvfuser/ir_container.cpp",
    "third_party/nvfuser/ir_graphviz.cpp",
    "third_party/nvfuser/ir_nodes.cpp",
    "third_party/nvfuser/ir_iostream.cpp",
    "third_party/nvfuser/ir_utils.cpp",
    "third_party/nvfuser/iter_visitor.cpp",
    "third_party/nvfuser/kernel.cpp",
    "third_party/nvfuser/kernel_cache.cpp",
    "third_party/nvfuser/kernel_expr_evaluator.cpp",
    "third_party/nvfuser/kernel_ir.cpp",
    "third_party/nvfuser/kernel_ir_dispatch.cpp",
    "third_party/nvfuser/lower_alias_memory.cpp",
    "third_party/nvfuser/lower_allocation.cpp",
    "third_party/nvfuser/lower_double_buffer.cpp",
    "third_party/nvfuser/lower_expr_sort.cpp",
    "third_party/nvfuser/lower_fused_reduction.cpp",
    "third_party/nvfuser/lower_fusion_simplifier.cpp",
    "third_party/nvfuser/lower_index.cpp",
    "third_party/nvfuser/lower_index_hoist.cpp",
    "third_party/nvfuser/lower_insert_syncs.cpp",
    "third_party/nvfuser/lower_instrument.cpp",
    "third_party/nvfuser/lower_loops.cpp",
    "third_party/nvfuser/lower_magic_zero.cpp",
    "third_party/nvfuser/lower_misaligned_vectorization.cpp",
    "third_party/nvfuser/lower_predicate.cpp",
    "third_party/nvfuser/lower_predicate_elimination.cpp",
    "third_party/nvfuser/lower_replace_size.cpp",
    "third_party/nvfuser/lower_shift.cpp",
    "third_party/nvfuser/lower_sync_information.cpp",
    "third_party/nvfuser/lower_thread_predicate.cpp",
    "third_party/nvfuser/lower_trivial_broadcast.cpp",
    "third_party/nvfuser/lower_trivial_reductions.cpp",
    "third_party/nvfuser/lower_unroll.cpp",
    "third_party/nvfuser/lower_utils.cpp",
    "third_party/nvfuser/lower_validation.cpp",
    "third_party/nvfuser/lower_warp_reduce.cpp",
    "third_party/nvfuser/lower2device.cpp",
    "third_party/nvfuser/manager.cpp",
    "third_party/nvfuser/maxinfo_propagator.cpp",
    "third_party/nvfuser/mutator.cpp",
    "third_party/nvfuser/non_divisible_split.cpp",
    "third_party/nvfuser/ops/alias.cpp",
    "third_party/nvfuser/ops/composite.cpp",
    "third_party/nvfuser/ops/normalization.cpp",
    "third_party/nvfuser/parallel_dimension_map.cpp",
    "third_party/nvfuser/parallel_type_bitmap.cpp",
    "third_party/nvfuser/parser.cpp",
    "third_party/nvfuser/partial_split_map.cpp",
    "third_party/nvfuser/partition.cpp",
    "third_party/nvfuser/predicate_compute.cpp",
    "third_party/nvfuser/python_frontend/fusion_cache.cpp",
    "third_party/nvfuser/python_frontend/fusion_definition.cpp",
    "third_party/nvfuser/python_frontend/fusion_interface.cpp",
    "third_party/nvfuser/register_interface.cpp",
    "third_party/nvfuser/root_domain_map.cpp",
    "third_party/nvfuser/scheduler/pointwise.cpp",
    "third_party/nvfuser/scheduler/pointwise_utils.cpp",
    "third_party/nvfuser/scheduler/transpose.cpp",
    "third_party/nvfuser/scheduler/normalization.cpp",
    "third_party/nvfuser/scheduler/reduction.cpp",
    "third_party/nvfuser/scheduler/matmul.cpp",
    "third_party/nvfuser/scheduler/reduction_utils.cpp",
    "third_party/nvfuser/scheduler/registry.cpp",
    "third_party/nvfuser/scheduler/utils.cpp",
    "third_party/nvfuser/type_inference.cpp",
    "third_party/nvfuser/type_promotion.cpp",
    "third_party/nvfuser/fusion_segmenter.cpp",
    "third_party/nvfuser/tensor_view.cpp",
    "third_party/nvfuser/transform_iter.cpp",
    "third_party/nvfuser/transform_replay.cpp",
    "third_party/nvfuser/transform_rfactor.cpp",
    "third_party/nvfuser/transform_view.cpp",
    "third_party/nvfuser/type.cpp",
    "third_party/nvfuser/utils.cpp",
    "third_party/nvfuser/mma_type.cpp",
    "third_party/nvfuser/scheduler/mma_utils.cpp",
...
libtorch_python_core_sources = [
    ...
    "third_party/nvfuser/python_frontend/python_bindings.cpp",
