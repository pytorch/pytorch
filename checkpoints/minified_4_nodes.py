...
args = [((s1, s1), (s1, 1), torch.float32, 'cpu', False), ((s1, s1), (s1, 1), torch.float32, 'cpu', False)]
...
class Repro(torch.nn.Module):
    ...
    def forward(self, a : torch.Tensor, view):
        mm = torch.mm(a, a);  a = None
        return (mm,)
