...
The *viable/strict*-blocking set is drawn from the *trunk*, *pull*, *lint*, and *docs-build* workflows. Jobs that are part of these workflows should meet the following requirements:
