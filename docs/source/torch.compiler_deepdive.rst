...
::
   ...
   GUARDS:
   hasattr(L['a'], '_dynamo_dynamic_indices') == False           # _dynamo/variables/builder.py:1360 in wrap_fx_proxy_cls
   hasattr(L['b'], '_dynamo_dynamic_indices') == False           # _dynamo/variables/builder.py:1360 in wrap_fx_proxy_cls
   utils_device.CURRENT_DEVICE == None                           # _dynamo/output_graph.py:371 in init_ambient_guards
   ___skip_backend_check() or ___current_backend() == ___lookup_backend(140355900538256)  # _dynamo/output_graph.py:377 in init_ambient_guards
   check_tensor(L['a'], Tensor, DispatchKeySet(CPU, BackendSelect, ADInplaceOrView, AutogradCPU), torch.float32, device=None, requires_grad=False, size=[10], stride=[1])  # _dynamo/variables/builder.py:1360 in wrap_fx_proxy_cls
   check_tensor(L['b'], Tensor, DispatchKeySet(CPU, BackendSelect, ADInplaceOrView, AutogradCPU), torch.float32, device=None, requires_grad=False, size=[10], stride=[1])  # _dynamo/variables/builder.py:1360 in wrap_fx_proxy_cls
