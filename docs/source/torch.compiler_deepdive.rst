...
If you know python bytecode, you can understand the above output. There is also a nice tool "depyf" to convert the bytecode into human readable source code. To run the following code, please first run "pip install depyf".
