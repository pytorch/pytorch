...
| `TORCHINDUCTOR_CACHE_BACKEND` | Selects the local autotune/Python source cache backend: `file` (default) or `sqlite`. See [SQLite local cache](user_guide/torch_compiler/sqlite_cache.md). |
