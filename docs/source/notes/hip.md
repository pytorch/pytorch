...
(cuda-api-to_hip-api-mappings)=

## CUDA API to HIP API mappings in C++

Please refer to the [HIP API syntax](https://rocm.docs.amd.com/projects/HIP/en/latest/reference/api_syntax.html).
...
to implicitly exclude ROCm/HIP, use the following to not take the code path for ROCm/HIP:
