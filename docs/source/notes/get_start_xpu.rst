...
|                                       | Intel® Core™ Ultra Desktop Processors (Series 2) with Intel® Arc™ Graphics (CodeName: Arrow Lake)   |
|                                       | Intel® Core™ Ultra Mobile Processors (Series 2) with Intel® Arc™ Graphics (CodeName: Arrow Lake-H) |
+---------------------------------------+----------------------------------------------------------------------------------------------------+
| Windows 11 & Ubuntu 25.10             | Intel® Core™ Ultra Desktop Processors (Series 3) with Intel® Arc™ Graphics (CodeName: Panther Lake)|
+---------------------------------------+----------------------------------------------------------------------------------------------------+
