...
and *j* is a solution of the equation :math:`x^2 = −1`, as no real number satisfies this equation, i is called an imaginary number. Complex numbers frequently occur in mathematics and
