...
Features described in this documentation are classified by release status:
  ...
  *Beta:*  These features are tagged as Beta because the API may change based on
  ...
  coverage across operators is not yet complete. We are
  committing to seeing the feature through to the Stable classification for Beta features
  We are not, however, committing to backward compatibility.

  *Prototype:*  These features are typically not available as part of
  binary distributions like PyPI or Conda, except sometimes behind a run-time
