...
def setup(app):
    ...
    try:
        ...
        def extract_glossary_terms(app, doctree, docname):
            ...
            if docname != "_glossary":
                return

            # Initialize storage for glossary terms
        ...
        def write_glossary_tippy_js(app, pagename, templatename, context, doctree):
            ...
            # Parse the page body to find glossary links
            ...
            for anchor in soup.find_all("a", href=True):
                ...
                if match:
                    ...
                    if term_id in glossary_terms:
                        ...
                        if page_dir:
                            rel_glossary = posixpath.relpath("_glossary", page_dir)
                        else:
            ...
            # Get tippy config from app config
...
"""
        ...
        # sphinx-tippy not installed or missing dependencies
        pass
