...
class TorchAutosummary(Autosummary):
    # Special case the items that are double documented.

    def get_items(self, names):
        # Coerce the double-documented special cases to refer to the actual
        # documented instance.
        special_cases = {
        ...
        for n in names:
            if n in special_cases:
                final_names.append(special_cases[n])
            else:
                final_names.append(n)

        return super().get_items(final_names)
...
def setup(app):
    ...
    app.add_directive("torchsummary", TorchAutosummary)
