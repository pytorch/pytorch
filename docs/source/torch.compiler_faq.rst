...
`The torch.compile troubleshooting doc <https://pytorch.org/docs/main/torch.compiler_troubleshooting.html>`__
...
with a `minimal reproducer <https://pytorch.org/docs/main/torch.compiler_troubleshooting.html>`__.
