...
.. list-table::
  ...
  * - ``PYTORCH_ALLOC_CONF``
    - For a more in depth explanation of this environment variable, see :ref:`cuda-memory-management`. ``PYTORCH_CUDA_ALLOC_CONF`` is its aliases and is provided only for backward compatibility.
