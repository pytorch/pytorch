...
PyTorch FSDP2 (`RFC <https://github.com/pytorch/pytorch/issues/114299>`_) provides
...
- See the `Getting Started with FSDP2 <https://pytorch.org/tutorials/intermediate/FSDP_tutorial.html>`_
  tutorial for more information.

- If you are currently using FSDP1, consider migrating to FSDP2 using our
  `migration guide <https://docs.pytorch.org/tutorials/intermediate/FSDP_tutorial.html#fsdp1-to-fsdp2-migration-guide>`_.
