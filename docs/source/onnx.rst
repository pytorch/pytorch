...
This mode is used to export all operators as regular ONNX operators. This is the default ``operator_export_type`` mode. ::
  ...
  Example torch ir graph:
    ...
    graph(%0 : Float(2, strides=[1]2, 3:4, 4:1)):
      %3 : Float(2, strides=[1]2, 3:4, 4:1) = aten:exp(%0)
      %4 : Float(2, strides=[1]2, 3:4, 4:1) = aten:div(%0, %3)
      return (%4)

  Is exported as:

    graph(%0 : Float(2, strides=[1]2, 3:4, 4:1)):
      %1 : Float(2, strides=[1]2, 3:4, 4:1) = onnx:Exp(%0)
      %2 : Float(2, strides=[1]2, 3:4, 4:1) = onnx:Div(%0, %1)
      return (%2)
...
This mode is used to export all operators as ATen ops, and avoid conversion to ONNX. ::
  ...
  Is exported as:
    ...
    graph(%0 : Float(2, strides=[1]2, 3:4, 4:1)):
      %1 : Float(2, strides=[1]2, 3:4, 4:1) = aten::ATen[operator="exp"](%0)
      %2 : Float(2, strides=[1]2, 3:4, 4:1) = aten::ATen[operator="div"](%0, %1)
      return (%2)
...
enables users to register and implement the operator as part of their runtime backend. ::
  ...
  Example torch ir graph:
    ...
    graph(%0 : Float(2, strides=[1]2, 3:4, 4:1),
          %1 : Float(2, strides=[1]2, 3:4, 4:1)):
      %6 : Float(2, strides=[1]2, 3:4, 4:1) = foo_namespace::bar(%0, %1) # custom op
      %7 : Float(2, strides=[1]2, 3:4, 4:1) = aten::div(%6, %0) # registered op
      return (%7))
  ...
  is exported as:
    ...
    graph(%0 : Float(2, strides=[1]2, 3:4, 4:1),
          %1 : Float(2, strides=[1]2, 3:4, 4:1)):
      %2 : Float(2, strides=[1]2, 3:4, 4:1) = foo_namespace::bar(%0, %1) # custom op
      %3 : Float(2, strides=[1]2, 3:4, 4:1) = onnx::Div(%2, %0) # registered op
      return (%3
