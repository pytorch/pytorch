...
class TransformerBlockWithGraphBreak(nn.Module):
    """
...
class TransformerWithGraphBreak(nn.Module):
    """
    Transformer Module
    ...
    def __init__(self, model_args: ModelArgs):
        ...
        for layer_id in range(model_args.n_layers):
            self.layers.append(TransformerBlockWithGraphBreak(layer_id, model_args))
