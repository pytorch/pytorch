...
void THTensor_(randperm)(THGenerator *_generator, THTensor *r_, long n)
{
  real *r__data;
  long r__stride_0;
  long i;
...
void THTensor_(rand)(THGenerator *_generator, THTensor *r_, THLongStorage *size)
{
  THTensor_(resize)(r_, size, NULL);
  THTensor_(uniform)(_generator, r_, 0, 1);
}

void THTensor_(randn)(THGenerator *_generator, THTensor *r_, THLongStorage *size)
{
  THTensor_(resize)(r_, size, NULL);
  THTensor_(normal)(_generator, r_, 0, 1);
}
