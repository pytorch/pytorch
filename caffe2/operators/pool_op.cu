...
template <>
template <>
bool MaxPoolFunctor<CUDAContext>::Forward<float, StorageOrder::NCHW, 1>(
    const int N,
    const int C,
    const std::array<int, 1>& X_dims,
    const std::array<int, 1>& Y_dims,
...
template <>
template <>
bool MaxPoolFunctor<CUDAContext>::Forward<float, StorageOrder::NHWC, 1>(
    const int N,
    const int C,
    const std::array<int, 1>& X_dims,
    const std::array<int, 1>& Y_dims,
...
template <>
template <>
bool MaxPoolFunctor<CUDAContext>::Forward<float, StorageOrder::NCHW, 2>(
    const int N,
    const int C,
    const std::array<int, 2>& X_dims,
    const std::array<int, 2>& Y_dims,
...
template <>
template <>
bool MaxPoolFunctor<CUDAContext>::Forward<float, StorageOrder::NHWC, 2>(
    const int N,
    const int C,
    const std::array<int, 2>& X_dims,
    const std::array<int, 2>& Y_dims,
...
template <>
template <>
bool MaxPoolFunctor<CUDAContext>::Forward<float, StorageOrder::NCHW, 3>(
    const int N,
    const int C,
    const std::array<int, 3>& X_dims,
    const std::array<int, 3>& Y_dims,
...
template <>
template <>
bool MaxPoolFunctor<CUDAContext>::Forward<float, StorageOrder::NHWC, 3>(
    const int N,
    const int C,
    const std::array<int, 3>& X_dims,
    const std::array<int, 3>& Y_dims,
