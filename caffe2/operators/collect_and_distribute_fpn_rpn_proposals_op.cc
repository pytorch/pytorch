...
template <>
C10_EXPORT bool CollectAndDistributeFpnRpnProposalsOp<CPUContext>::RunOnDevice() {
...
template <>
C10_EXPORT bool CollectRpnProposalsOp<CPUContext>::RunOnDevice() {
  int num_rpn_lvls = rpn_max_level_ - rpn_min_level_ + 1;
  CAFFE_ENFORCE_EQ(InputSize(), 2 * num_rpn_lvls);
...
template <>
C10_EXPORT bool DistributeFpnProposalsOp<CPUContext>::RunOnDevice() {
  int num_roi_lvls = roi_max_level_ - roi_min_level_ + 1;
