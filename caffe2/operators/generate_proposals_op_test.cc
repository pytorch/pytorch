...
TEST(GenerateProposalsTest, TestRealDownSampledTFParams) {
  Workspace ws;
  OperatorDef def;
  def.set_name("test");
  def.set_type("GenerateProposals");
  ...
  ERMatXf rois_gt(12, 5);
  rois_gt <<         
        0.0f, 0.0f, 0.0f, 0.976862f, 0.983333f,
        0.0f, 0.0f, 0.23334f, 0.652466f, 0.646611f,
        0.0f, 0.311326f, 0.261249f, 0.976359f, 0.672959f,
        0.0f, 0.0f, 0.261214f, 0.848024f, 0.672595f,
        0.0f, 0.0403561f, 0.800649f, 0.699252f, 0.983333f,
        0.0f, 0.0f, 0.384913f, 0.644998f, 0.983333f,
        0.0f, 0.0f, 0.626022f, 0.651106f, 0.983333f,
        0.0f, 0.3072f, 0.499799f, 0.970816f, 0.983333f,
        0.0f, 0.0f, 0.662395f, 0.945398f, 0.983333f,
        0.0f, 0.164221f, 0.815532f, 0.9875f, 0.983333f,
        0.0f, 0.0f, 0.330916f, 0.844497f, 0.895449f,
        0.0f, 0.0f, 0.545096f, 0.750647f, 0.969576f;


  vector<float> rois_probs_gt{0.0266914f,
                              0.00544219f,
                              0.00120544f,
                              0.00119208f,
                              0.000802663f,
  ...
  def.add_arg()->CopyFrom(MakeArgument("nms_thresh", 0.7f));
  def.add_arg()->CopyFrom(MakeArgument("min_size", 16.0f));
  def.add_arg()->CopyFrom(MakeArgument("anchor_clip_pre_nms", true));
  def.add_arg()->CopyFrom(MakeArgument("normalized", true));
