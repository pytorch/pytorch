...
OPERATOR_SCHEMA(UniformFill).NumInputs(0, 1).NumOutputs(1);
OPERATOR_SCHEMA(UniformIntFill).NumInputs(0, 1).NumOutputs(1);
OPERATOR_SCHEMA(ConstantFill).NumInputs(0, 1).NumOutputs(1);
OPERATOR_SCHEMA(GivenTensorFill).NumInputs(0, 1).NumOutputs(1);
OPERATOR_SCHEMA(GaussianFill).NumInputs(0, 1).NumOutputs(1);
OPERATOR_SCHEMA(XavierFill).NumInputs(0, 1).NumOutputs(1);
OPERATOR_SCHEMA(MSRAFill).NumInputs(0, 1).NumOutputs(1);
OPERATOR_SCHEMA(RangeFill).NumInputs(0, 1).NumOutputs(1);
