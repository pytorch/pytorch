#ifndef CAFFE2_OPERATORS_QUANTIZED_INT8_AABB_ROI_PROPOSALS_OP_H_
#define CAFFE2_OPERATORS_QUANTIZED_INT8_AABB_ROI_PROPOSALS_OP_H_
...
class Int8AABBRoIProposalsOp final : public Operator<Context> {
 public:
  USE_OPERATOR_CONTEXT_FUNCTIONS;
  Int8AABBRoIProposalsOp(const OperatorDef& operator_def, Workspace* ws)
...
#endif // CAFFE2_OPERATORS_QUANTIZED_INT8_AABB_ROI_PROPOSALS_OP_H_
