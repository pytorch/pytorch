...
namespace {
void filler_init(
    const torch::ListPtr<at::Tensor>& inputs,
    const at::Tensor& output_,
    const torch::ListPtr<int64_t>& shape,
    const torch::ListPtr<int64_t>& extra_shape,
    bool input_as_shape) {
...
void given_tensor_fill_op_cpu_impl(
    ...
    const at::Tensor& output_,
    torch::ListPtr<int64_t> shape,
    torch::ListPtr<int64_t> extra_shape,
    bool input_as_shape,
