...
__global__ void ChannelShuffleKernel(const int N,
                                     const int S,
                                     const int C,
                                     const int G,
                                     const int K,
...
bool ChannelShuffleOp<HIPContext>::RunOnDeviceWithOrderNCHW()
{
    ...
    hipLaunchKernelGGL((ChannelShuffleKernel),
...
REGISTER_HIP_OPERATOR(ChannelShuffleGradient, ChannelShuffleGradientOp<HIPContext>);
}
