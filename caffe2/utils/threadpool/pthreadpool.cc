...
static void compute_1d_tiled(void* context_, size_t linear_index) {
  const struct compute_1d_tiled_context* context =
      (compute_1d_tiled_context*)context_;
...
void legacy_pthreadpool_compute_1d_tiled(
  ...
  if (threadpool == NULL) {
    ...
    legacy_pthreadpool_compute_1d(
        threadpool,
        (legacy_pthreadpool_function_1d_t)compute_1d_tiled,
        &context,
        tile_range);
  }
}
...
static void compute_2d(void* context_, size_t linear_index) {
  ...
  const struct compute_2d_context* context =
      static_cast<compute_2d_context*>(context_);
  int32_t q;
  int32_t r;
...
void legacy_pthreadpool_compute_2d(
  ...
  if (threadpool == NULL) {
    ...
    legacy_pthreadpool_compute_1d(
        threadpool,
        (legacy_pthreadpool_function_1d_t)compute_2d,
        &context,
        range_i * range_j);
  }
}
...
static void compute_2d_tiled(void* context_, size_t linear_index) {
  ...
  const struct compute_2d_tiled_context* context =
      static_cast<compute_2d_tiled_context*>(context_);
...
void legacy_pthreadpool_compute_2d_tiled(
  ...
  if (threadpool == NULL) {
    ...
    legacy_pthreadpool_compute_1d(
        threadpool,
        (legacy_pthreadpool_function_1d_t)compute_2d_tiled,
        &context,
        tile_range_i * tile_range_j);
  }
}
...
static void compute_3d_tiled(void* context_, size_t linear_index) {
  int32_t tile_index_ij, tile_index_k;
  const struct compute_3d_tiled_context* context =
      static_cast<compute_3d_tiled_context*>(context_);
...
static void compute_4d_tiled(void* context_, size_t linear_index) {
  int32_t tile_index_ij, tile_index_kl;
  const struct compute_4d_tiled_context* context =
      static_cast<compute_4d_tiled_context*>(context_);
