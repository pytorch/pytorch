...
static long long Fused8BitRowwiseEmbeddingLookup_int32_t_float_float__avx2_fma(
...
long long Fused8BitRowwiseEmbeddingLookup_int32_t_float_float_false__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
    ...
    bool normalize_by_lengths,
    float* out) {
  return Fused8BitRowwiseEmbeddingLookup_int32_t_float_float__avx2_fma<false>(
      block_size,
      output_size,
      index_size,
      data_size,
...
long long Fused8BitRowwiseEmbeddingLookup_int32_t_float_float_true__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
    ...
    bool normalize_by_lengths,
    float* out) {
  return Fused8BitRowwiseEmbeddingLookup_int32_t_float_float__avx2_fma<true>(
      block_size,
      output_size,
      index_size,
      data_size,
...
template <bool IS_WEIGHT_POSITIONAL>
static long long Fused8BitRowwiseEmbeddingLookup_int64_t_float_float__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
    ...
    bool normalize_by_lengths,
    float* out) {
  const long long prefdist_T0 = 16;
  const long long fused_block_size = block_size + 2;
  if (block_size == 128) {
    // unrolling 16 times
    long long dataInd = 0;
    for (long long rangeIndex = 0; rangeIndex < output_size; ++rangeIndex) {
      float* op = &out[rangeIndex * block_size];
      __m256 vop0 = _mm256_setzero_ps();
      __m256 vop8 = _mm256_setzero_ps();
      __m256 vop16 = _mm256_setzero_ps();
      ...
      __m256 vop112 = _mm256_setzero_ps();
      __m256 vop120 = _mm256_setzero_ps();
      for (long long start = dataInd; dataInd < start + lengths[rangeIndex];
           ++dataInd) {
        const long long idx = indices[dataInd];
        if (idx < 0 || idx >= data_size) {
          return rangeIndex;
        }
        float wgt = 1.f;
        ...
        __m256 vwgt = _mm256_set1_ps(wgt);
        const float* ip = &input[idx * fused_block_size];
        const long long next_T0 = (dataInd < index_size - prefdist_T0)
            ? (dataInd + prefdist_T0)
            : dataInd;
        const long long idx_pref_T0 = indices[next_T0];
        if (idx_pref_T0 < 0 || idx_pref_T0 >= data_size) {
          return rangeIndex;
        }
        const float* ip_next_T0 = &input[idx_pref_T0 * fused_block_size];
...
long long Fused8BitRowwiseEmbeddingLookup_int64_t_float_float_false__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
    ...
    bool normalize_by_lengths,
    float* out) {
  return Fused8BitRowwiseEmbeddingLookup_int64_t_float_float__avx2_fma<false>(
      block_size,
      output_size,
      index_size,
      data_size,
...
long long Fused8BitRowwiseEmbeddingLookup_int64_t_float_float_true__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
    ...
    bool normalize_by_lengths,
    float* out) {
  return Fused8BitRowwiseEmbeddingLookup_int64_t_float_float__avx2_fma<true>(
      block_size,
      output_size,
      index_size,
      data_size,
...
template <bool IS_WEIGHT_POSITIONAL>
static long long Fused8BitRowwiseEmbeddingLookup_int32_t_half_float__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
...
long long Fused8BitRowwiseEmbeddingLookup_int32_t_half_float_false__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
    ...
    bool normalize_by_lengths,
    float* out) {
  return Fused8BitRowwiseEmbeddingLookup_int32_t_half_float__avx2_fma<false>(
      block_size,
      output_size,
      index_size,
      data_size,
...
long long Fused8BitRowwiseEmbeddingLookup_int32_t_half_float_true__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
    ...
    bool normalize_by_lengths,
    float* out) {
  return Fused8BitRowwiseEmbeddingLookup_int32_t_half_float__avx2_fma<true>(
      block_size,
      output_size,
      index_size,
      data_size,
...
template <bool IS_WEIGHT_POSITIONAL>
static long long Fused8BitRowwiseEmbeddingLookup_int64_t_half_float__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
    ...
    float* out) {
  const long long prefdist_T0 = 16;
  const long long fused_block_size = block_size + 4;
  if (block_size == 128) {
    // unrolling 16 times
    long long dataInd = 0;
    for (long long rangeIndex = 0; rangeIndex < output_size; ++rangeIndex) {
...
long long Fused8BitRowwiseEmbeddingLookup_int64_t_half_float_false__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
    ...
    bool normalize_by_lengths,
    float* out) {
  return Fused8BitRowwiseEmbeddingLookup_int64_t_half_float__avx2_fma<false>(
      block_size,
      output_size,
      index_size,
      data_size,
...
long long Fused8BitRowwiseEmbeddingLookup_int64_t_half_float_true__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
    ...
    bool normalize_by_lengths,
    float* out) {
  return Fused8BitRowwiseEmbeddingLookup_int64_t_half_float__avx2_fma<true>(
      block_size,
      output_size,
      index_size,
      data_size,
...
template <bool IS_WEIGHT_POSITIONAL>
static long long
Fused8BitRowwiseEmbeddingLookup_int32_t_uint8_t_float__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
  ...
  if (block_size == 128) {
    ...
    for (int rangeIndex = 0; rangeIndex < output_size; ++rangeIndex) {
      ...
      for (int start = dataInd; dataInd < start + lengths[rangeIndex];
        ...
        __m256 vwgt = _mm256_set1_ps(wgt);
        const unsigned char* ip = &input[idx * fused_block_size];
        const int next_T0 = (dataInd < index_size - prefdist_T0)
            ? (dataInd + prefdist_T0)
            : dataInd;
        const int idx_pref_T0 = indices[next_T0];
        ...
        const unsigned char* ip_next_T0 =
...
long long Fused8BitRowwiseEmbeddingLookup_int32_t_uint8_t_float_false__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
    ...
    bool normalize_by_lengths,
    float* out) {
  return Fused8BitRowwiseEmbeddingLookup_int32_t_uint8_t_float__avx2_fma<false>(
      block_size,
      output_size,
      index_size,
      data_size,
...
long long Fused8BitRowwiseEmbeddingLookup_int32_t_uint8_t_float_true__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
    ...
    bool normalize_by_lengths,
    float* out) {
  return Fused8BitRowwiseEmbeddingLookup_int32_t_uint8_t_float__avx2_fma<true>(
      block_size,
      output_size,
      index_size,
      data_size,
...
template <bool IS_WEIGHT_POSITIONAL>
static long long
Fused8BitRowwiseEmbeddingLookup_int64_t_uint8_t_float__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
    ...
    float* out) {
  const long long prefdist_T0 = 16;
  const long long fused_block_size = block_size + 8;
  if (block_size == 128) {
    // unrolling 16 times
    long long dataInd = 0;
    for (long long rangeIndex = 0; rangeIndex < output_size; ++rangeIndex) {
...
long long Fused8BitRowwiseEmbeddingLookup_int64_t_uint8_t_float_false__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
    ...
    bool normalize_by_lengths,
    float* out) {
  return Fused8BitRowwiseEmbeddingLookup_int64_t_uint8_t_float__avx2_fma<false>(
      block_size,
      output_size,
      index_size,
      data_size,
...
long long Fused8BitRowwiseEmbeddingLookup_int64_t_uint8_t_float_true__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
    ...
    bool normalize_by_lengths,
    float* out) {
  return Fused8BitRowwiseEmbeddingLookup_int64_t_uint8_t_float__avx2_fma<true>(
      block_size,
      output_size,
      index_size,
      data_size,
