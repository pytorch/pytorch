...
static long long Fused8BitRowwiseEmbeddingLookupGenericSlow(
  ...
  const long long fused_block_size = block_size + scale_bias_offset;
  long long current = 0;
...
#define FUSED_8BIT_ROWWISE_EMBEDDING_SPECIALIZATION(                                     \
    IndexTypeName, IndexType, OutType)                                                   \
  long long                                                                              \
      Fused8BitRowwiseEmbeddingLookup_##IndexTypeName##_uint8_t_##OutType##_false__base( \
          const long long block_size,                                                    \
          const long long output_size,                                                   \
          const long long index_size,                                                    \
          const long long data_size,                                                     \
  ...
  long long                                                                              \
      Fused8BitRowwiseEmbeddingLookup_##IndexTypeName##_uint8_t_##OutType(               \
          const long long block_size,                                                    \
          const long long output_size,                                                   \
          const long long index_size,                                                    \
          const long long data_size,                                                     \
    ...
    AVX2_FMA_DO(                                                                         \
        Fused8BitRowwiseEmbeddingLookup_##IndexTypeName##_uint8_t_##OutType##_false,     \
        block_size,                                                                      \
        output_size,                                                                     \
        index_size,                                                                      \
        data_size,                                                                       \
  ...
  template <>                                                                            \
  void                                                                                   \
  Fused8BitRowwiseEmbeddingLookup<IndexTypeName, uint8_t, OutType, false>(               \
      const long long block_size,                                                        \
      const long long output_size,                                                       \
      const long long index_size,                                                        \
      const long long data_size,                                                         \
...
FUSED_8BIT_ROWWISE_EMBEDDING_SPECIALIZATION(int32_t, int, float);
FUSED_8BIT_ROWWISE_EMBEDDING_SPECIALIZATION(int64_t, long long, float);
