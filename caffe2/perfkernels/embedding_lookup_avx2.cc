...
static long long EmbeddingLookup_int32_t_float_float__avx2_fma(
...
long long EmbeddingLookup_int32_t_float_float_false__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
...
long long EmbeddingLookup_int32_t_float_float_true__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
...
template <bool IS_WEIGHT_POSITIONAL>
static long long EmbeddingLookup_int64_t_float_float__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
  ...
  const long long fused_block_size = block_size + 0;
  if (block_size == 128) {
    // unrolling 16 times
    long long dataInd = 0;
...
long long EmbeddingLookup_int64_t_float_float_false__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
...
long long EmbeddingLookup_int64_t_float_float_true__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
...
template <bool IS_WEIGHT_POSITIONAL>
static long long EmbeddingLookup_int32_t_half_float__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
...
long long EmbeddingLookup_int32_t_half_float_false__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
...
long long EmbeddingLookup_int32_t_half_float_true__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
...
template <bool IS_WEIGHT_POSITIONAL>
static long long EmbeddingLookup_int64_t_half_float__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
...
long long EmbeddingLookup_int64_t_half_float_false__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
...
long long EmbeddingLookup_int64_t_half_float_true__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
...
template <bool IS_WEIGHT_POSITIONAL>
static long long EmbeddingLookup_int32_t_uint8_t_float__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
...
long long EmbeddingLookup_int32_t_uint8_t_float_false__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
...
long long EmbeddingLookup_int32_t_uint8_t_float_true__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
...
template <bool IS_WEIGHT_POSITIONAL>
static long long EmbeddingLookup_int64_t_uint8_t_float__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
...
long long EmbeddingLookup_int64_t_uint8_t_float_false__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
...
long long EmbeddingLookup_int64_t_uint8_t_float_true__avx2_fma(
    const long long block_size,
    const long long output_size,
    const long long index_size,
    const long long data_size,
