...
def unroll(uf, IndexType, InType, OutType, use_weights, isa, fused):
    ...
    # code.append("      int end_offset = (rangeIndex == output_size - 1 ? index_size : offsets[rangeIndex + 1]);")
    # code.append("      int length = end_offset - offsets[rangeIndex];")
    code.append("""\
      int end_offset =
