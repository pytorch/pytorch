...
class HipAllreduceHalvingDoubling : public Algorithm {
 public:
  HipAllreduceHalvingDoubling(
  ...
  virtual ~HipAllreduceHalvingDoubling() = default;
 ...
 protected:
  ...
  std::vector<HipDevicePointer<T>> devicePtrsForFirstSend_;
  std::vector<HipDevicePointer<T>> devicePtrsForFirstRecv_;

  std::vector<typename W::Pointer> scratchPtrForBroadcast_;
  std::vector<std::vector<HipDevicePointer<T>>> devicePtrsForBroadcast_;
