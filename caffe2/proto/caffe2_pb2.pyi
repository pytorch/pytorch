...
class SerializationOptions(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        db_options : typing.Optional[bytes] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"db_options",b"db_options"]) -> bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"db_options",b"db_options",u"options",b"options"]) -> None: ...
