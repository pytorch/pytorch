...
class ModelInfo(google.protobuf.message.Message):
    ...
    MODELCLASS_FIELD_NUMBER: builtins.int
    VERSION_FIELD_NUMBER: builtins.int
    PREDICTORTYPE_FIELD_NUMBER: builtins.int
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"modelClass",b"modelClass",u"modelId",b"modelId",u"predictorType",b"predictorType",u"project",b"project",u"version",b"version"]) -> builtins.bool: ...
...
class MetaNetDef(google.protobuf.message.Message):
    ...
    MODELINFO_FIELD_NUMBER: builtins.int
    PLANS_FIELD_NUMBER: builtins.int
    APPLICATIONSPECIFICINFO_FIELD_NUMBER: builtins.int
    BLOBSORDER_FIELD_NUMBER: builtins.int
    PRELOADBLOBS_FIELD_NUMBER: builtins.int
    TENSORBOUNDSHAPES_FIELD_NUMBER: builtins.int
    REQUESTONLYEMBEDDINGS_FIELD_NUMBER: builtins.int
    AOTCONFIG_FIELD_NUMBER: builtins.int
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"aotConfig",b"aotConfig",u"modelInfo",b"modelInfo",u"tensorBoundShapes",b"tensorBoundShapes"]) -> builtins.bool: ...
