...
// IEEE FP16
template class FullyConnectedFakeLowpFPOp<fp32_to_fp16, CPUContext>;
template class FullyConnectedGradientFakeLowpFPOp<fp32_to_fp16, CPUContext>;

// BFLOAT 16
template class FullyConnectedFakeLowpFPOp<fp32_to_bfp16, CPUContext>;
template class FullyConnectedGradientFakeLowpFPOp<fp32_to_bfp16, CPUContext>;

// BFLOAT 24 (chop the least significant 8 bits)
template class FullyConnectedFakeLowpFPOp<fp32_to_bfp24, CPUContext>;
template class FullyConnectedGradientFakeLowpFPOp<fp32_to_bfp24, CPUContext>;

// BFLOAT 14 (chop 2 extra bits from BFLOAT 16)
template class FullyConnectedFakeLowpFPOp<fp32_to_bfp14, CPUContext>;
template class FullyConnectedGradientFakeLowpFPOp<fp32_to_bfp14, CPUContext>;

// BFLOAT16 with rounding
template class FullyConnectedFakeLowpFPOp<fp32_to_bfp16_round, CPUContext>;
template class FullyConnectedGradientFakeLowpFPOp<
    fp32_to_bfp16_round,
    CPUContext>;
