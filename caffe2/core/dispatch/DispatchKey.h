...
struct TensorParameterDispatchKey final {
  ...
  LayoutId layoutId;
  // TODO Move this at::DataType to c10 namespace
...
namespace std {
  ...
  struct hash<c10::details::TensorParameterDispatchKey> {
    ...
    size_t operator()(const c10::details::TensorParameterDispatchKey& obj) const {
      return std::hash<c10::DeviceTypeId>()(obj.deviceTypeId) ^ std::hash<c10::LayoutId>()(obj.layoutId) ^ std::hash<at::DataType>()(obj.dataType);
    }
  };
}  // namespace std
