...
class TestDB(unittest.TestCase):
    ...
    def testStructSubstraction(self):
        s1 = schema.Struct(
            ("a", schema.Scalar()), ("b", schema.Scalar()), ("c", schema.Scalar())
        )
    ...
    def testStructNestedSubstraction(self):
        ...
        s2 = schema.Struct(
            ("b", schema.Struct(("d", schema.Scalar()), ("e", schema.Scalar())))
        )
        s = s1 - s2
    ...
    def testStructNestedAddition(self):
        s1 = schema.Struct(
            ("a", schema.Scalar()), ("b", schema.Struct(("c", schema.Scalar())))
        )
    ...
    def testGetFieldByNestedName(self):
        st = schema.Struct(
            ("a", schema.Scalar()),
            ("b", schema.Struct(("c", schema.Struct(("d", schema.Scalar()))))),
        )
    ...
    def testAddFieldByNestedName(self):
        ...
        f_b = schema.Struct(
            ("c", schema.Struct(("d", schema.Scalar(blob=core.BlobReference("blob2")))))
        )
