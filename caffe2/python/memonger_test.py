...
class MemongerTest(hu.HypothesisTestCase):
    ...
    def test_memonger_mix_cpu_gpu(self):
        ...
        '''
        m = model_helper.ModelHelper()
        with core.DeviceScope(core.DeviceOption(caffe2_pb2.HIP if workspace.has_hip_support else caffe2_pb2.CUDA, 0)):
        ...
        device_crossers = device_blobs[caffe2_pb2.CPU].intersection(
            device_blobs[caffe2_pb2.HIP] if workspace.has_hip_support else device_blobs[caffe2_pb2.CUDA]
        )
