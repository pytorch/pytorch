...
class TestSparseFunHash(hu.HypothesisTestCase):
    @given(
    ...
    def test_sparse_funhash(
        self, n_out, n_in, n_data, n_weight, n_alpha, sparsity, gc, dc
    ):
        ...
        op = core.CreateOperator(
            'SparseFunHash', ['val', 'key', 'seg', 'weight', 'alpha'], ['out'],
            num_outputs=n_out
        )
        ...
        op2 = core.CreateOperator(
            'SparseFunHash', ['val', 'key', 'seg', 'weight'], ['out'],
            num_outputs=n_out
        )
