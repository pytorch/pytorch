...
class TestPutOps(TestCase):
    def test_default_value(self):
        ...
        workspace.FeedBlob("value", np.array([], dtype=np.float))  # type: ignore[attr-defined]
    ...
    def test_clamp(self):
        ...
        workspace.FeedBlob("value", np.array([put_value], dtype=np.float))  # type: ignore[attr-defined]
