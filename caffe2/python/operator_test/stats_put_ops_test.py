...
class TestPutOps(TestCase):
    ...
    def test_clamp(self):
        ...
        self.assertIn(stat_name + sum_postfix, stat_dict)
        self.assertIn(stat_name + count_postfix, stat_dict)
        self.assertEquals(stat_dict[stat_name + sum_postfix], 9223372036854775807)
        self.assertEquals(stat_dict[stat_name + count_postfix], 1)
    ...
    def test_avg_put_ops(self):
        ...
        self.assertIn(stat_name + count_postfix, stat_dict)
        self.assertEquals(
            stat_dict[stat_name + sum_postfix], put_value * magnitude_expand
        )
        self.assertEquals(stat_dict[stat_name + count_postfix], 1)
    ...
    def test_increment_put_ops(self):
        ...
        self.assertEquals(
            stat_dict[stat_name + member_postfix], put_value * magnitude_expand
        )
