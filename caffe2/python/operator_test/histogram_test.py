...
class TestHistogram(hu.HypothesisTestCase):
    ...
    @settings(deadline=10000)
    def test_histogram__valid_inputs_1(self, num_tensors, num_bin_edges) -> None:
    ...
    def test_histogram__empty_input_tensor(self) -> None:
        self._test_histogram([np.array([])], list(np.linspace(-2, 2, num=10)))

    def test_histogram__non_increasing_bin_edges(self) -> None:
