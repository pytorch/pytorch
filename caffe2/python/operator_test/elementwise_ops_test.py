...
class TestElementwiseOps(hu.HypothesisTestCase):
    ...
    def test_abs(self, X, gc, dc):
        ...
        self.assertReferenceChecks(
            device_option=gc, op=op, inputs=[X], reference=abs_ref
        )
    ...
    def test_exp(self, X, inplace, gc, dc):
        ...
        self.assertReferenceChecks(
            device_option=gc, op=op, inputs=[X], reference=exp_ref
        )
        self.assertDeviceChecks(dc, op, [X], [0])
        self.assertGradientChecks(gc, op, [X], 0, [0])
    ...
    def test_log(self, n, m, gc, dc, seed):
        ...
        self.assertReferenceChecks(
            device_option=gc, op=op, inputs=[X], reference=log_op
        )
    ...
    def test_sqr(self, n, m, gc, dc, seed):
        ...
        self.assertReferenceChecks(
            device_option=gc, op=op, inputs=[X], reference=sqr_op
        )
    ...
    def test_sqrt(self, X, inplace, gc, dc):
        ...
        self.assertReferenceChecks(
            device_option=gc, op=op, inputs=[X], reference=sqrt_op
        )
        self.assertDeviceChecks(dc, op, [X], [0])
    ...
    def test_softsign(self, X, inplace, gc, dc):
        ...
        self.assertReferenceChecks(
            device_option=gc, op=op, inputs=[X], reference=softsign_ref
        )
        self.assertDeviceChecks(dc, op, [X], [0])
        if not inplace:
            self.assertGradientChecks(gc, op, [X], 0, [0])
    ...
    def test_cbrt(self, X, in_place, gc, dc):
        ...
        self.assertReferenceChecks(
            device_option=gc, op=op, inputs=[X], reference=cbrt_ref
        )
    ...
    def test_swish(self, n, m, gc, dc, seed):
        ...
        self.assertReferenceChecks(device_option=gc, op=op, inputs=[X], reference=swish)
    ...
    def test_sigmoid(self, X, inplace, engine, gc, dc):
        ...
        self.assertReferenceChecks(
            device_option=gc, op=op, inputs=[X], reference=sigmoid_ref
        )
        self.assertDeviceChecks(dc, op, [X], [0])
        self.assertGradientChecks(gc, op, [X], 0, [0])
    ...
    def test_hard_sigmoid(self, X, inplace, alpha, beta, engine, gc, dc):
        ...
        self.assertReferenceChecks(
            device_option=gc, op=op, inputs=[X], reference=hard_sigmoid_ref
        )
        self.assertDeviceChecks(dc, op, [X], [0])
        self.assertGradientChecks(gc, op, [X], 0, [0], stepsize=1e-4, threshold=1e-2)
    ...
    def test_eq(self, n, m, gc, dc):
        ...
        self.assertReferenceChecks(device_option=gc, op=op, inputs=[X, Y], reference=eq)
    ...
    def test_reciprocal(self, X, inplace, gc, dc):
        ...
        self.assertReferenceChecks(
            device_option=gc, op=op, inputs=[X], reference=reciprocal_op
        )
        self.assertDeviceChecks(dc, op, [X], [0])
