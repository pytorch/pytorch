...
class ModelHelper(object):
    ...
    def AddGradientOperators(self, *args, **kwargs):
        ...
        for param, grad in list(self.param_to_grad.items()):
    ...
    def GetOptimizationParamInfo(self, params=None):
        ...
        return [
            ...
            for param, grad in viewitems(param_to_grad)
    ...
    def __dir__(self):
        return sorted(
            set(chain(dir(type(self)), viewkeys(self.__dict__), _known_working_ops))
        )
...
def ExtractPredictorNet(
    ...
    return (
        predict_net,
        list(set(predict_proto.external_input) - set(renamed_input_blobs)),
    )
