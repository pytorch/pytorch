...
class GradientClippingTest(unittest.TestCase):
    def test_gradient_clipping_by_norm(self):
        ...
        net_modifier = GradientClipping(
            grad_clip_method="by_norm", clip_norm_type="l2_norm", clip_threshold=0.1
        )
    ...
    def test_gradient_clipping_by_norm_l1_norm(self):
        ...
        net_modifier = GradientClipping(
            grad_clip_method="by_norm", clip_norm_type="l1_norm", clip_threshold=0.1
        )
    ...
    def test_gradient_clipping_by_value(self):
        ...
        clip_min = 0
        net_modifier = GradientClipping(
            grad_clip_method="by_value", clip_max=clip_max, clip_min=clip_min
        )
