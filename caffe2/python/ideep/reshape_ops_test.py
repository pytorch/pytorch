...
class TestReShapeOps(TestCase):
    def test_reshape_ops(self):
        ...
        with core.DeviceScope(device_opt):
            ...
            workspace.FeedBlob('shape', np.array([1, 4], dtype=np.int32), core.DeviceOption(caffe2_pb2.IDEEP, 0))
        ...
        with core.DeviceScope(device_opt):
            ...
            if arg_shape:
                ...
                op = core.CreateOperator('Reshape',
                                         [blob_in, 'new_shape'],
                                         [blob_out, 'old_shape'])
                workspace.FeedBlob('new_shape', np.asarray(new_shape, dtype = np.int32), core.DeviceOption(caffe2_pb2.CPU, 0))
