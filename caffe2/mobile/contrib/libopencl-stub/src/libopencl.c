...
static const char* default_so_paths[] = {"libOpenCL.so"};
...
static const char* default_so_paths[] = {"/usr/lib/libOpenCL.so",
...
cl_int clGetSupportedImageFormats(
  ...
  func = (f_clGetSupportedImageFormats)dlsym(
...
cl_program clCreateProgramWithSource(
  ...
  func = (f_clCreateProgramWithSource)dlsym(
...
cl_program clCreateProgramWithBinary(
  ...
  func = (f_clCreateProgramWithBinary)dlsym(
...
cl_int clUnloadPlatformCompiler(cl_platform_id platform) {
  ...
  func =
      (f_clUnloadPlatformCompiler)dlsym(so_handle, "clUnloadPlatformCompiler");
  if (func) {
...
cl_int clCreateKernelsInProgram(
  ...
  func =
      (f_clCreateKernelsInProgram)dlsym(so_handle, "clCreateKernelsInProgram");
  if (func) {
...
cl_int clGetKernelWorkGroupInfo(
  ...
  func =
      (f_clGetKernelWorkGroupInfo)dlsym(so_handle, "clGetKernelWorkGroupInfo");
  if (func) {
    return func(
        kernel,
        device,
...
cl_int clEnqueueWriteBufferRect(
  ...
  func =
      (f_clEnqueueWriteBufferRect)dlsym(so_handle, "clEnqueueWriteBufferRect");
  if (func) {
    return func(
        command_queue,
        buffer,
...
cl_int clEnqueueCopyImageToBuffer(
  ...
  func = (f_clEnqueueCopyImageToBuffer)dlsym(
...
cl_int clEnqueueCopyBufferToImage(
  ...
  func = (f_clEnqueueCopyBufferToImage)dlsym(
...
cl_int clEnqueueMigrateMemObjects(
  ...
  func = (f_clEnqueueMigrateMemObjects)dlsym(
...
cl_int clEnqueueMarkerWithWaitList(
  ...
  func = (f_clEnqueueMarkerWithWaitList)dlsym(
...
cl_mem clCreateFromGLRenderbuffer(
  ...
  func = (f_clCreateFromGLRenderbuffer)dlsym(
...
cl_int clEnqueueAcquireGLObjects(
  ...
  func = (f_clEnqueueAcquireGLObjects)dlsym(
...
cl_int clEnqueueReleaseGLObjects(
  ...
  func = (f_clEnqueueReleaseGLObjects)dlsym(
