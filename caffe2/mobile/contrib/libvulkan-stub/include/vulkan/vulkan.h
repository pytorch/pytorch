...
typedef PFN_vkVoidFunction(
    VKAPI_PTR* PFN_vkGetDeviceProcAddr)(VkDevice device, const char* pName);
...
typedef VkResult(VKAPI_PTR* PFN_vkMapMemory)(
    ...
    void** ppData);
typedef void(
    VKAPI_PTR* PFN_vkUnmapMemory)(VkDevice device, VkDeviceMemory memory);
...
typedef VkResult(
    VKAPI_PTR* PFN_vkGetFenceStatus)(VkDevice device, VkFence fence);
...
typedef void(VKAPI_PTR* PFN_vkDestroyEvent)(
    ...
    const VkAllocationCallbacks* pAllocator);
typedef VkResult(
    VKAPI_PTR* PFN_vkGetEventStatus)(VkDevice device, VkEvent event);
...
typedef enum VkDebugReportErrorEXT {
  ...
  VK_DEBUG_REPORT_ERROR_RANGE_SIZE_EXT =
      (VK_DEBUG_REPORT_ERROR_CALLBACK_REF_EXT - VK_DEBUG_REPORT_ERROR_NONE_EXT +
       1),
...
typedef enum VkValidationCheckEXT {
  ...
  VK_VALIDATION_CHECK_RANGE_SIZE_EXT =
      (VK_VALIDATION_CHECK_ALL_EXT - VK_VALIDATION_CHECK_ALL_EXT + 1),
