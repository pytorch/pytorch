...
def trainNtest(model_gen, args):
    ...
    data, label = AddInput(
        ...
        db=os.path.join('/home/wyiming/logs/convert_cifar10'),
        db_type='lmdb')
    ...
    epoch_iters = 1000
    record = 1000
    accuracy = np.zeros(epoch_num * epoch_iters / record)
    loss = np.zeros(epoch_num * epoch_iters / record)
    ...
    data, label = AddInput(
        ...
        db=os.path.join('/home/wyiming/logs/cifar-test-lmdb'),
        db_type='lmdb')
