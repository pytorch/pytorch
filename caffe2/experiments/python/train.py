...
from caffe2.python.fb.trainer.trainer import Trainer
...
fbdep.InitOpsLibrary('@/caffe2/caffe2/fb/data:reading_ops')
...
def NNLoaderData(args, model):
    ...
    model.net.NNLoaderRead([loader], fields, add_sparse_bias=1)
