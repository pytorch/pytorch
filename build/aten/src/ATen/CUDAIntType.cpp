...
Tensor & CUDAIntType::_th_set_(Tensor & self, Storage source, int64_t storage_offset, IntList size, IntList stride) const {
    // DeviceGuard omitted
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Int);
    auto source_ = checked_storage(source,"source",2, DeviceType::CUDA, at::scalarTypeToDataType(ScalarType::Int));
...
Tensor CUDAIntType::_th_view(const Tensor & self, IntList size) const {
    // DeviceGuard omitted
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Int);
...
Tensor & CUDAIntType::_th_range_out(Tensor & result, Scalar start, Scalar end, Scalar step) const {
    // DeviceGuard omitted
    auto result_ = checked_tensor_unwrap(result,"result",0, false, Backend::CUDA, ScalarType::Int);
    auto start_ = start.toLong();
    auto end_ = end.toLong();
    auto step_ = step.toLong();
    THCudaIntTensor_range(globalContext().getTHCState(), result_, start_, end_, step_);
    return result;
}
Tensor CUDAIntType::_th_range(Scalar start, Scalar end, Scalar step) const {
    // DeviceGuard omitted
    auto result_ = c10::make_intrusive<TensorImpl, UndefinedTensorImpl>(CUDATensorId(), caffe2::TypeMeta::Make<int>(), allocator(), false).release();
    auto result = Tensor(c10::intrusive_ptr<TensorImpl, UndefinedTensorImpl>::reclaim(result_));
    auto start_ = start.toLong();
...
Tensor & CUDAIntType::_th_arange_out(Tensor & result, Scalar start, Scalar end, Scalar step) const {
    // DeviceGuard omitted
    auto result_ = checked_tensor_unwrap(result,"result",0, false, Backend::CUDA, ScalarType::Int);
    auto start_ = start.toLong();
    auto end_ = end.toLong();
    auto step_ = step.toLong();
    THCudaIntTensor_arange(globalContext().getTHCState(), result_, start_, end_, step_);
    return result;
}
Tensor CUDAIntType::_th_arange(Scalar start, Scalar end, Scalar step) const {
    // DeviceGuard omitted
    auto result_ = c10::make_intrusive<TensorImpl, UndefinedTensorImpl>(CUDATensorId(), caffe2::TypeMeta::Make<int>(), allocator(), false).release();
    auto result = Tensor(c10::intrusive_ptr<TensorImpl, UndefinedTensorImpl>::reclaim(result_));
    auto start_ = start.toLong();
...
Tensor & CUDAIntType::_th_arange_out(Tensor & result, Scalar end) const {
    // DeviceGuard omitted
    auto result_ = checked_tensor_unwrap(result,"result",0, false, Backend::CUDA, ScalarType::Int);
    auto end_ = end.toLong();
    THCudaIntTensor_arange(globalContext().getTHCState(), result_, 0, end_, 1);
    return result;
}
Tensor CUDAIntType::_th_arange(Scalar end) const {
    // DeviceGuard omitted
    auto result_ = c10::make_intrusive<TensorImpl, UndefinedTensorImpl>(CUDATensorId(), caffe2::TypeMeta::Make<int>(), allocator(), false).release();
    auto result = Tensor(c10::intrusive_ptr<TensorImpl, UndefinedTensorImpl>::reclaim(result_));
    auto end_ = end.toLong();
...
Tensor & CUDAIntType::_th_tril_out(Tensor & result, const Tensor & self, int64_t diagonal) const {
    // DeviceGuard omitted
    auto result_ = checked_tensor_unwrap(result,"result",0, false, Backend::CUDA, ScalarType::Int);
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Int);
    THCudaIntTensor_tril(globalContext().getTHCState(), result_, self_, diagonal);
    result_->maybe_zero_dim(self_->dim() == 0);
    return result;
}
Tensor CUDAIntType::_th_tril(const Tensor & self, int64_t diagonal) const {
    // DeviceGuard omitted
    auto result_ = c10::make_intrusive<TensorImpl, UndefinedTensorImpl>(CUDATensorId(), caffe2::TypeMeta::Make<int>(), allocator(), false).release();
    auto result = Tensor(c10::intrusive_ptr<TensorImpl, UndefinedTensorImpl>::reclaim(result_));
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Int);
...
Tensor & CUDAIntType::_th_tril_(Tensor & self, int64_t diagonal) const {
    // DeviceGuard omitted
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Int);
    THCudaIntTensor_tril(globalContext().getTHCState(), self_, self_, diagonal);
    return self;
}
Tensor & CUDAIntType::_th_triu_out(Tensor & result, const Tensor & self, int64_t diagonal) const {
    // DeviceGuard omitted
    auto result_ = checked_tensor_unwrap(result,"result",0, false, Backend::CUDA, ScalarType::Int);
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Int);
    THCudaIntTensor_triu(globalContext().getTHCState(), result_, self_, diagonal);
    result_->maybe_zero_dim(self_->dim() == 0);
    return result;
}
Tensor CUDAIntType::_th_triu(const Tensor & self, int64_t diagonal) const {
    // DeviceGuard omitted
    auto result_ = c10::make_intrusive<TensorImpl, UndefinedTensorImpl>(CUDATensorId(), caffe2::TypeMeta::Make<int>(), allocator(), false).release();
    auto result = Tensor(c10::intrusive_ptr<TensorImpl, UndefinedTensorImpl>::reclaim(result_));
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Int);
...
Tensor & CUDAIntType::_th_triu_(Tensor & self, int64_t diagonal) const {
    // DeviceGuard omitted
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Int);
    THCudaIntTensor_triu(globalContext().getTHCState(), self_, self_, diagonal);
    return self;
}
...
Tensor CUDAIntType::_th_tensor(Storage storage, int64_t storageOffset, IntList size, IntList stride) const {
    // DeviceGuard omitted
    auto storage_ = checked_storage(storage,"storage",1, DeviceType::CUDA, at::scalarTypeToDataType(ScalarType::Int));
    return Tensor(c10::intrusive_ptr<TensorImpl, UndefinedTensorImpl>::reclaim((THCudaIntTensor_newWithStorage(globalContext().getTHCState(), storage_.unsafeGetStorageImpl(), storageOffset, size, stride))->maybe_zero_dim(size.size() == 0)));
}
Tensor CUDAIntType::_th_tensor(IntList size, IntList stride) const {
    // DeviceGuard omitted
    return Tensor(c10::intrusive_ptr<TensorImpl, UndefinedTensorImpl>::reclaim((THCudaIntTensor_newWithSize(globalContext().getTHCState(), size, stride))->maybe_zero_dim(size.size() == 0)));
}
...
std::tuple<Tensor,Tensor> CUDAIntType::_cudnn_ctc_loss(const Tensor & log_probs, const Tensor & targets, IntList input_lengths, IntList target_lengths, int64_t blank, bool deterministic) const {
...
Tensor & CUDAIntType::acos_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CUDAIntType::asin_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CUDAIntType::atan_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CUDAIntType::baddbmm_out(Tensor & result, const Tensor & self, const Tensor & batch1, const Tensor & batch2, Scalar beta, Scalar alpha) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CUDAIntType::clamp_out(Tensor & result, const Tensor & self, c10::optional<Scalar> min, c10::optional<Scalar> max) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CUDAIntType::cosh_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor CUDAIntType::cudnn_convolution(const Tensor & self, const Tensor & weight, const Tensor & bias, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
    const OptionalDeviceGuard device_guard(device_of(self));
    return at::native::cudnn_convolution(/* actuals */ self, weight, bias, padding, stride, dilation, groups, benchmark, deterministic);
}
Tensor CUDAIntType::cudnn_convolution_backward_input(IntList self_size, const Tensor & grad_output, const Tensor & weight, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
...
std::tuple<Tensor,Tensor,Tensor> CUDAIntType::cudnn_convolution_backward(const Tensor & self, const Tensor & grad_output, const Tensor & weight, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic, std::array<bool,3> output_mask) const {
    const OptionalDeviceGuard device_guard(device_of(self));
...
Tensor CUDAIntType::cudnn_convolution_backward_weight(IntList weight_size, const Tensor & grad_output, const Tensor & self, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
    const OptionalDeviceGuard device_guard(device_of(grad_output));
...
Tensor CUDAIntType::cudnn_convolution_transpose(const Tensor & self, const Tensor & weight, const Tensor & bias, IntList padding, IntList output_padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
    const OptionalDeviceGuard device_guard(device_of(self));
...
std::tuple<Tensor,Tensor,Tensor> CUDAIntType::cudnn_convolution_transpose_backward(const Tensor & self, const Tensor & grad_output, const Tensor & weight, IntList padding, IntList output_padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic, std::array<bool,3> output_mask) const {
    const OptionalDeviceGuard device_guard(device_of(self));
...
Tensor CUDAIntType::cudnn_convolution_transpose_backward_input(const Tensor & grad_output, const Tensor & weight, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
    const OptionalDeviceGuard device_guard(device_of(grad_output));
...
Tensor CUDAIntType::cudnn_convolution_transpose_backward_weight(IntList weight_size, const Tensor & grad_output, const Tensor & self, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
    const OptionalDeviceGuard device_guard(device_of(grad_output));
...
std::tuple<Tensor,Tensor> CUDAIntType::_ctc_loss(const Tensor & log_probs, const Tensor & targets, IntList input_lengths, IntList target_lengths, int64_t blank) const {
    const OptionalDeviceGuard device_guard(device_of(log_probs));
    return at::native::ctc_loss_gpu(/* actuals */ log_probs, targets, input_lengths, target_lengths, blank);
}
Tensor CUDAIntType::_ctc_loss_backward(const Tensor & grad, const Tensor & log_probs, const Tensor & targets, IntList input_lengths, IntList target_lengths, const Tensor & neg_log_likelihood, const Tensor & log_alpha, int64_t blank) const {
    const OptionalDeviceGuard device_guard(device_of(grad));
...
Tensor CUDAIntType::empty(IntList size, const TensorOptions & options) const {
    const DeviceGuard device_guard(options.device());
...
Tensor & CUDAIntType::erf_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CUDAIntType::erfc_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CUDAIntType::expm1_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
    return at::native::_expm1_out_cuda(/* actuals */ result, self);
}
Tensor & CUDAIntType::eye_out(Tensor & result, int64_t n) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CUDAIntType::linspace_out(Tensor & result, Scalar start, Scalar end, int64_t steps) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CUDAIntType::log10_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CUDAIntType::log1p_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CUDAIntType::log2_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor CUDAIntType::miopen_convolution(const Tensor & self, const Tensor & weight, const Tensor & bias, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
    const OptionalDeviceGuard device_guard(device_of(self));
    return at::native::miopen_convolution(/* actuals */ self, weight, bias, padding, stride, dilation, groups, benchmark, deterministic);
}
Tensor CUDAIntType::miopen_convolution_backward_input(IntList self_size, const Tensor & grad_output, const Tensor & weight, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
    const OptionalDeviceGuard device_guard(device_of(grad_output));
...
std::tuple<Tensor,Tensor,Tensor> CUDAIntType::miopen_convolution_backward(const Tensor & self, const Tensor & grad_output, const Tensor & weight, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic, std::array<bool,3> output_mask) const {
    const OptionalDeviceGuard device_guard(device_of(self));
...
Tensor CUDAIntType::miopen_convolution_backward_weight(IntList weight_size, const Tensor & grad_output, const Tensor & self, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
    const OptionalDeviceGuard device_guard(device_of(grad_output));
...
Tensor CUDAIntType::miopen_convolution_transpose(const Tensor & self, const Tensor & weight, const Tensor & bias, IntList padding, IntList output_padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
    const OptionalDeviceGuard device_guard(device_of(self));
...
std::tuple<Tensor,Tensor,Tensor> CUDAIntType::miopen_convolution_transpose_backward(const Tensor & self, const Tensor & grad_output, const Tensor & weight, IntList padding, IntList output_padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic, std::array<bool,3> output_mask) const {
    const OptionalDeviceGuard device_guard(device_of(self));
...
Tensor CUDAIntType::miopen_convolution_transpose_backward_input(const Tensor & grad_output, const Tensor & weight, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
    const OptionalDeviceGuard device_guard(device_of(grad_output));
...
Tensor CUDAIntType::miopen_convolution_transpose_backward_weight(IntList weight_size, const Tensor & grad_output, const Tensor & self, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
    const OptionalDeviceGuard device_guard(device_of(grad_output));
...
Tensor & CUDAIntType::randperm_out(Tensor & result, int64_t n, Generator * generator) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CUDAIntType::rsqrt_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CUDAIntType::sigmoid_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CUDAIntType::sinh_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CUDAIntType::_sparse_add_out(Tensor & result, const Tensor & self, const Tensor & other, Scalar alpha) const {
    AT_ERROR("_sparse_add_out not supported on CUDAIntType");
}
Tensor & CUDAIntType::_sparse_dense_add_out(Tensor & result, const Tensor & self, SparseTensorRef other, Scalar alpha) const {
    const OptionalDeviceGuard device_guard(device_of(result));
    return at::native::add_out_dense_sparse_cuda(/* actuals */ result, self, other, alpha);
}
Tensor & CUDAIntType::_sparse_div_zerodim_out(Tensor & result, const Tensor & self, const Tensor & other) const {
    AT_ERROR("_sparse_div_zerodim_out not supported on CUDAIntType");
}
Tensor & CUDAIntType::_sparse_div_scalar_out(Tensor & result, const Tensor & self, Scalar other) const {
    AT_ERROR("_sparse_div_scalar_out not supported on CUDAIntType");
}
Tensor & CUDAIntType::_sparse_mul_out(Tensor & result, const Tensor & self, const Tensor & other) const {
    AT_ERROR("_sparse_mul_out not supported on CUDAIntType");
}
Tensor & CUDAIntType::_sparse_mul_zerodim_out(Tensor & result, const Tensor & self, const Tensor & other) const {
    AT_ERROR("_sparse_mul_zerodim_out not supported on CUDAIntType");
}
Tensor & CUDAIntType::_sparse_mul_scalar_out(Tensor & result, const Tensor & self, Scalar other) const {
...
Tensor & CUDAIntType::tan_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CUDAIntType::tanh_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
    return at::native::_tanh_out_cuda(/* actuals */ result, self);
}
Tensor CUDAIntType::flip(const Tensor & self, IntList dims) const {
    const OptionalDeviceGuard device_guard(device_of(self));
    return at::native::flip_cuda(/* actuals */ self, dims);
}
Tensor CUDAIntType::roll(const Tensor & self, IntList shifts, IntList dims) const {
    const OptionalDeviceGuard device_guard(device_of(self));
...
Tensor CUDAIntType::_sparse_sum_backward(const Tensor & grad, const Tensor & self, IntList dim) const {
...
Tensor & CUDAIntType::native_pow_out(Tensor & result, const Tensor & self, Scalar exponent) const {
...
Tensor & CUDAIntType::s_native_addmm_out(Tensor & result, const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta, Scalar alpha) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor CUDAIntType::_sparse_coo_tensor_with_dims(int64_t sparse_dim, int64_t dense_dim, IntList size, const TensorOptions & options) const {
    AT_ERROR("_sparse_coo_tensor_with_dims not supported on CUDAIntType");
}
Tensor CUDAIntType::_sparse_coo_tensor_with_dims_and_tensors(int64_t sparse_dim, int64_t dense_dim, IntList size, const Tensor & indices, const Tensor & values, const TensorOptions & options) const {
    AT_ERROR("_sparse_coo_tensor_with_dims_and_tensors not supported on CUDAIntType");
}
Tensor & CUDAIntType::sparse_resize_(Tensor & self, IntList size, int64_t sparse_dim, int64_t dense_dim) const {
    AT_ERROR("sparse_resize_ not supported on CUDAIntType");
}
Tensor & CUDAIntType::sparse_resize_and_clear_(Tensor & self, IntList size, int64_t sparse_dim, int64_t dense_dim) const {
...
Tensor & CUDAIntType::hspmm_out(Tensor & result, const Tensor & mat1, const Tensor & mat2) const {
...
Tensor CUDAIntType::_potrs_helper(const Tensor & self, const Tensor & A, bool upper) const {
    const OptionalDeviceGuard device_guard(device_of(self));
    return at::native::_potrs_helper_cuda(/* actuals */ self, A, upper);
}
Tensor & CUDAIntType::adaptive_avg_pool2d_out(Tensor & output, const Tensor & self, IntList output_size) const {
...
Tensor CUDAIntType::adaptive_avg_pool2d(const Tensor & self, IntList output_size) const {
    const OptionalDeviceGuard device_guard(device_of(self));
    return at::native::adaptive_avg_pool2d_cuda(/* actuals */ self, output_size);
}
Tensor & CUDAIntType::adaptive_avg_pool2d_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self) const {
...
Tensor CUDAIntType::adaptive_avg_pool2d_backward(const Tensor & grad_output, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(grad_output));
    return at::native::adaptive_avg_pool2d_backward_cuda(/* actuals */ grad_output, self);
}
std::tuple<Tensor &,Tensor &> CUDAIntType::fractional_max_pool2d_out(Tensor & output, Tensor & indices, const Tensor & self, IntList kernel_size, IntList output_size, const Tensor & random_samples) const {
    const OptionalDeviceGuard device_guard(device_of(output));
    return at::native::fractional_max_pool2d_out(/* actuals */ output, indices, self, kernel_size, output_size, random_samples);
}
std::tuple<Tensor,Tensor> CUDAIntType::fractional_max_pool2d(const Tensor & self, IntList kernel_size, IntList output_size, const Tensor & random_samples) const {
    const OptionalDeviceGuard device_guard(device_of(self));
    return at::native::fractional_max_pool2d(/* actuals */ self, kernel_size, output_size, random_samples);
}
Tensor & CUDAIntType::fractional_max_pool2d_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, IntList kernel_size, IntList output_size, const Tensor & indices) const {
    const OptionalDeviceGuard device_guard(device_of(grad_input));
    return at::native::fractional_max_pool2d_backward_out(/* actuals */ grad_input, grad_output, self, kernel_size, output_size, indices);
}
Tensor CUDAIntType::fractional_max_pool2d_backward(const Tensor & grad_output, const Tensor & self, IntList kernel_size, IntList output_size, const Tensor & indices) const {
    const OptionalDeviceGuard device_guard(device_of(grad_output));
