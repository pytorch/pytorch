...
Tensor & CPULongType::_th_set_(Tensor & self, Storage source, int64_t storage_offset, IntList size, IntList stride) const {
    // DeviceGuard omitted
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CPU, ScalarType::Long);
    auto source_ = checked_storage(source,"source",2, DeviceType::CPU, at::scalarTypeToDataType(ScalarType::Long));
...
Tensor CPULongType::_th_view(const Tensor & self, IntList size) const {
    // DeviceGuard omitted
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CPU, ScalarType::Long);
...
Tensor & CPULongType::_th_range_out(Tensor & result, Scalar start, Scalar end, Scalar step) const {
    // DeviceGuard omitted
    auto result_ = checked_tensor_unwrap(result,"result",0, false, Backend::CPU, ScalarType::Long);
    auto start_ = start.toLong();
    auto end_ = end.toLong();
    auto step_ = step.toLong();
    THLongTensor_range(result_, start_, end_, step_);
    return result;
}
Tensor CPULongType::_th_range(Scalar start, Scalar end, Scalar step) const {
    // DeviceGuard omitted
    auto result_ = c10::make_intrusive<TensorImpl, UndefinedTensorImpl>(CPUTensorId(), caffe2::TypeMeta::Make<int64_t>(), allocator(), false).release();
    auto result = Tensor(c10::intrusive_ptr<TensorImpl, UndefinedTensorImpl>::reclaim(result_));
    auto start_ = start.toLong();
...
Tensor & CPULongType::_th_arange_out(Tensor & result, Scalar start, Scalar end, Scalar step) const {
    // DeviceGuard omitted
    auto result_ = checked_tensor_unwrap(result,"result",0, false, Backend::CPU, ScalarType::Long);
    auto start_ = start.toLong();
    auto end_ = end.toLong();
    auto step_ = step.toLong();
    THLongTensor_arange(result_, start_, end_, step_);
    return result;
}
Tensor CPULongType::_th_arange(Scalar start, Scalar end, Scalar step) const {
    // DeviceGuard omitted
    auto result_ = c10::make_intrusive<TensorImpl, UndefinedTensorImpl>(CPUTensorId(), caffe2::TypeMeta::Make<int64_t>(), allocator(), false).release();
    auto result = Tensor(c10::intrusive_ptr<TensorImpl, UndefinedTensorImpl>::reclaim(result_));
    auto start_ = start.toLong();
...
Tensor & CPULongType::_th_arange_out(Tensor & result, Scalar end) const {
    // DeviceGuard omitted
    auto result_ = checked_tensor_unwrap(result,"result",0, false, Backend::CPU, ScalarType::Long);
    auto end_ = end.toLong();
    THLongTensor_arange(result_, 0, end_, 1);
    return result;
}
Tensor CPULongType::_th_arange(Scalar end) const {
    // DeviceGuard omitted
    auto result_ = c10::make_intrusive<TensorImpl, UndefinedTensorImpl>(CPUTensorId(), caffe2::TypeMeta::Make<int64_t>(), allocator(), false).release();
    auto result = Tensor(c10::intrusive_ptr<TensorImpl, UndefinedTensorImpl>::reclaim(result_));
    auto end_ = end.toLong();
...
Tensor & CPULongType::_th_tril_out(Tensor & result, const Tensor & self, int64_t diagonal) const {
    // DeviceGuard omitted
    auto result_ = checked_tensor_unwrap(result,"result",0, false, Backend::CPU, ScalarType::Long);
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CPU, ScalarType::Long);
    THLongTensor_tril(result_, self_, diagonal);
    result_->maybe_zero_dim(self_->dim() == 0);
    return result;
}
Tensor CPULongType::_th_tril(const Tensor & self, int64_t diagonal) const {
    // DeviceGuard omitted
    auto result_ = c10::make_intrusive<TensorImpl, UndefinedTensorImpl>(CPUTensorId(), caffe2::TypeMeta::Make<int64_t>(), allocator(), false).release();
    auto result = Tensor(c10::intrusive_ptr<TensorImpl, UndefinedTensorImpl>::reclaim(result_));
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CPU, ScalarType::Long);
...
Tensor & CPULongType::_th_tril_(Tensor & self, int64_t diagonal) const {
    // DeviceGuard omitted
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CPU, ScalarType::Long);
    THLongTensor_tril(self_, self_, diagonal);
    return self;
}
Tensor & CPULongType::_th_triu_out(Tensor & result, const Tensor & self, int64_t diagonal) const {
    // DeviceGuard omitted
    auto result_ = checked_tensor_unwrap(result,"result",0, false, Backend::CPU, ScalarType::Long);
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CPU, ScalarType::Long);
    THLongTensor_triu(result_, self_, diagonal);
    result_->maybe_zero_dim(self_->dim() == 0);
    return result;
}
Tensor CPULongType::_th_triu(const Tensor & self, int64_t diagonal) const {
    // DeviceGuard omitted
    auto result_ = c10::make_intrusive<TensorImpl, UndefinedTensorImpl>(CPUTensorId(), caffe2::TypeMeta::Make<int64_t>(), allocator(), false).release();
    auto result = Tensor(c10::intrusive_ptr<TensorImpl, UndefinedTensorImpl>::reclaim(result_));
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CPU, ScalarType::Long);
...
Tensor & CPULongType::_th_triu_(Tensor & self, int64_t diagonal) const {
    // DeviceGuard omitted
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CPU, ScalarType::Long);
    THLongTensor_triu(self_, self_, diagonal);
    return self;
}
...
Tensor & CPULongType::_th_geometric_(Tensor & self, double p, Generator * generator) const {
    // DeviceGuard omitted
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CPU, ScalarType::Long);
    auto generator_ = check_generator<CPUGenerator>(generator, &globalContext().defaultGenerator(device_type()));
...
Tensor CPULongType::_th_tensor(Storage storage, int64_t storageOffset, IntList size, IntList stride) const {
    // DeviceGuard omitted
    auto storage_ = checked_storage(storage,"storage",1, DeviceType::CPU, at::scalarTypeToDataType(ScalarType::Long));
    return Tensor(c10::intrusive_ptr<TensorImpl, UndefinedTensorImpl>::reclaim((THLongTensor_newWithStorage(storage_.unsafeGetStorageImpl(), storageOffset, size, stride))->maybe_zero_dim(size.size() == 0)));
}
Tensor CPULongType::_th_tensor(IntList size, IntList stride) const {
    // DeviceGuard omitted
    return Tensor(c10::intrusive_ptr<TensorImpl, UndefinedTensorImpl>::reclaim((THLongTensor_newWithSize(size, stride))->maybe_zero_dim(size.size() == 0)));
}
...
std::tuple<Tensor,Tensor> CPULongType::_cudnn_ctc_loss(const Tensor & log_probs, const Tensor & targets, IntList input_lengths, IntList target_lengths, int64_t blank, bool deterministic) const {
...
Tensor & CPULongType::acos_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CPULongType::asin_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CPULongType::atan_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CPULongType::baddbmm_out(Tensor & result, const Tensor & self, const Tensor & batch1, const Tensor & batch2, Scalar beta, Scalar alpha) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CPULongType::clamp_out(Tensor & result, const Tensor & self, c10::optional<Scalar> min, c10::optional<Scalar> max) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CPULongType::cosh_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor CPULongType::cudnn_convolution(const Tensor & self, const Tensor & weight, const Tensor & bias, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
    AT_ERROR("cudnn_convolution not supported on CPULongType");
}
Tensor CPULongType::cudnn_convolution_backward_input(IntList self_size, const Tensor & grad_output, const Tensor & weight, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
    AT_ERROR("cudnn_convolution_backward_input not supported on CPULongType");
}
std::tuple<Tensor,Tensor,Tensor> CPULongType::cudnn_convolution_backward(const Tensor & self, const Tensor & grad_output, const Tensor & weight, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic, std::array<bool,3> output_mask) const {
...
Tensor CPULongType::cudnn_convolution_backward_weight(IntList weight_size, const Tensor & grad_output, const Tensor & self, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
    AT_ERROR("cudnn_convolution_backward_weight not supported on CPULongType");
}
Tensor CPULongType::cudnn_convolution_transpose(const Tensor & self, const Tensor & weight, const Tensor & bias, IntList padding, IntList output_padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
    AT_ERROR("cudnn_convolution_transpose not supported on CPULongType");
}
std::tuple<Tensor,Tensor,Tensor> CPULongType::cudnn_convolution_transpose_backward(const Tensor & self, const Tensor & grad_output, const Tensor & weight, IntList padding, IntList output_padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic, std::array<bool,3> output_mask) const {
...
Tensor CPULongType::cudnn_convolution_transpose_backward_input(const Tensor & grad_output, const Tensor & weight, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
    AT_ERROR("cudnn_convolution_transpose_backward_input not supported on CPULongType");
}
Tensor CPULongType::cudnn_convolution_transpose_backward_weight(IntList weight_size, const Tensor & grad_output, const Tensor & self, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
...
std::tuple<Tensor,Tensor> CPULongType::_ctc_loss(const Tensor & log_probs, const Tensor & targets, IntList input_lengths, IntList target_lengths, int64_t blank) const {
...
Tensor CPULongType::_ctc_loss_backward(const Tensor & grad, const Tensor & log_probs, const Tensor & targets, IntList input_lengths, IntList target_lengths, const Tensor & neg_log_likelihood, const Tensor & log_alpha, int64_t blank) const {
...
Tensor CPULongType::empty(IntList size, const TensorOptions & options) const {
...
Tensor & CPULongType::erf_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CPULongType::erfc_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CPULongType::expm1_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
    return at::native::_expm1_out_cpu(/* actuals */ result, self);
}
Tensor & CPULongType::eye_out(Tensor & result, int64_t n) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CPULongType::linspace_out(Tensor & result, Scalar start, Scalar end, int64_t steps) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CPULongType::log10_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CPULongType::log1p_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CPULongType::log2_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor CPULongType::miopen_convolution(const Tensor & self, const Tensor & weight, const Tensor & bias, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
    AT_ERROR("miopen_convolution not supported on CPULongType");
}
Tensor CPULongType::miopen_convolution_backward_input(IntList self_size, const Tensor & grad_output, const Tensor & weight, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
    AT_ERROR("miopen_convolution_backward_input not supported on CPULongType");
}
std::tuple<Tensor,Tensor,Tensor> CPULongType::miopen_convolution_backward(const Tensor & self, const Tensor & grad_output, const Tensor & weight, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic, std::array<bool,3> output_mask) const {
...
Tensor CPULongType::miopen_convolution_backward_weight(IntList weight_size, const Tensor & grad_output, const Tensor & self, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
    AT_ERROR("miopen_convolution_backward_weight not supported on CPULongType");
}
Tensor CPULongType::miopen_convolution_transpose(const Tensor & self, const Tensor & weight, const Tensor & bias, IntList padding, IntList output_padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
    AT_ERROR("miopen_convolution_transpose not supported on CPULongType");
}
std::tuple<Tensor,Tensor,Tensor> CPULongType::miopen_convolution_transpose_backward(const Tensor & self, const Tensor & grad_output, const Tensor & weight, IntList padding, IntList output_padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic, std::array<bool,3> output_mask) const {
    AT_ERROR("miopen_convolution_transpose_backward not supported on CPULongType");
}
Tensor CPULongType::miopen_convolution_transpose_backward_input(const Tensor & grad_output, const Tensor & weight, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
    AT_ERROR("miopen_convolution_transpose_backward_input not supported on CPULongType");
}
Tensor CPULongType::miopen_convolution_transpose_backward_weight(IntList weight_size, const Tensor & grad_output, const Tensor & self, IntList padding, IntList stride, IntList dilation, int64_t groups, bool benchmark, bool deterministic) const {
...
Tensor & CPULongType::rsqrt_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CPULongType::sigmoid_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CPULongType::sinh_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CPULongType::_sparse_add_out(Tensor & result, const Tensor & self, const Tensor & other, Scalar alpha) const {
    AT_ERROR("_sparse_add_out not supported on CPULongType");
}
Tensor & CPULongType::_sparse_dense_add_out(Tensor & result, const Tensor & self, SparseTensorRef other, Scalar alpha) const {
    const OptionalDeviceGuard device_guard(device_of(result));
    return at::native::add_out_dense_sparse_cpu(/* actuals */ result, self, other, alpha);
}
Tensor & CPULongType::_sparse_div_zerodim_out(Tensor & result, const Tensor & self, const Tensor & other) const {
    AT_ERROR("_sparse_div_zerodim_out not supported on CPULongType");
}
Tensor & CPULongType::_sparse_div_scalar_out(Tensor & result, const Tensor & self, Scalar other) const {
    AT_ERROR("_sparse_div_scalar_out not supported on CPULongType");
}
Tensor & CPULongType::_sparse_mul_out(Tensor & result, const Tensor & self, const Tensor & other) const {
    AT_ERROR("_sparse_mul_out not supported on CPULongType");
}
Tensor & CPULongType::_sparse_mul_zerodim_out(Tensor & result, const Tensor & self, const Tensor & other) const {
    AT_ERROR("_sparse_mul_zerodim_out not supported on CPULongType");
}
Tensor & CPULongType::_sparse_mul_scalar_out(Tensor & result, const Tensor & self, Scalar other) const {
...
Tensor & CPULongType::tan_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor & CPULongType::tanh_out(Tensor & result, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(result));
    return at::native::_tanh_out_cpu(/* actuals */ result, self);
}
Tensor CPULongType::flip(const Tensor & self, IntList dims) const {
    const OptionalDeviceGuard device_guard(device_of(self));
    return at::native::flip_cpu(/* actuals */ self, dims);
}
Tensor CPULongType::roll(const Tensor & self, IntList shifts, IntList dims) const {
    const OptionalDeviceGuard device_guard(device_of(self));
...
Tensor CPULongType::_sparse_sum_backward(const Tensor & grad, const Tensor & self, IntList dim) const {
...
Tensor & CPULongType::native_pow_out(Tensor & result, const Tensor & self, Scalar exponent) const {
...
Tensor & CPULongType::s_native_addmm_out(Tensor & result, const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta, Scalar alpha) const {
    const OptionalDeviceGuard device_guard(device_of(result));
...
Tensor CPULongType::_sparse_coo_tensor_with_dims(int64_t sparse_dim, int64_t dense_dim, IntList size, const TensorOptions & options) const {
    AT_ERROR("_sparse_coo_tensor_with_dims not supported on CPULongType");
}
Tensor CPULongType::_sparse_coo_tensor_with_dims_and_tensors(int64_t sparse_dim, int64_t dense_dim, IntList size, const Tensor & indices, const Tensor & values, const TensorOptions & options) const {
    AT_ERROR("_sparse_coo_tensor_with_dims_and_tensors not supported on CPULongType");
}
Tensor & CPULongType::sparse_resize_(Tensor & self, IntList size, int64_t sparse_dim, int64_t dense_dim) const {
    AT_ERROR("sparse_resize_ not supported on CPULongType");
}
Tensor & CPULongType::sparse_resize_and_clear_(Tensor & self, IntList size, int64_t sparse_dim, int64_t dense_dim) const {
...
Tensor & CPULongType::hspmm_out(Tensor & result, const Tensor & mat1, const Tensor & mat2) const {
...
Tensor CPULongType::_potrs_helper(const Tensor & self, const Tensor & A, bool upper) const {
    const OptionalDeviceGuard device_guard(device_of(self));
    return at::native::_potrs_helper_cpu(/* actuals */ self, A, upper);
}
Tensor & CPULongType::adaptive_avg_pool2d_out(Tensor & output, const Tensor & self, IntList output_size) const {
...
Tensor CPULongType::adaptive_avg_pool2d(const Tensor & self, IntList output_size) const {
    const OptionalDeviceGuard device_guard(device_of(self));
    return at::native::adaptive_avg_pool2d_cpu(/* actuals */ self, output_size);
}
Tensor & CPULongType::adaptive_avg_pool2d_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self) const {
...
Tensor CPULongType::adaptive_avg_pool2d_backward(const Tensor & grad_output, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(grad_output));
    return at::native::adaptive_avg_pool2d_backward_cpu(/* actuals */ grad_output, self);
}
std::tuple<Tensor &,Tensor &> CPULongType::fractional_max_pool2d_out(Tensor & output, Tensor & indices, const Tensor & self, IntList kernel_size, IntList output_size, const Tensor & random_samples) const {
    const OptionalDeviceGuard device_guard(device_of(output));
    return at::native::fractional_max_pool2d_out_cpu(/* actuals */ output, indices, self, kernel_size, output_size, random_samples);
}
std::tuple<Tensor,Tensor> CPULongType::fractional_max_pool2d(const Tensor & self, IntList kernel_size, IntList output_size, const Tensor & random_samples) const {
    const OptionalDeviceGuard device_guard(device_of(self));
    return at::native::fractional_max_pool2d_cpu(/* actuals */ self, kernel_size, output_size, random_samples);
}
Tensor & CPULongType::fractional_max_pool2d_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, IntList kernel_size, IntList output_size, const Tensor & indices) const {
    const OptionalDeviceGuard device_guard(device_of(grad_input));
...
Tensor CPULongType::fractional_max_pool2d_backward(const Tensor & grad_output, const Tensor & self, IntList kernel_size, IntList output_size, const Tensor & indices) const {
    const OptionalDeviceGuard device_guard(device_of(grad_output));
