...
static auto registerer = torch::RegisterOperators()
  .op(torch::RegisterOperators::options()
    ...
    .kernel<Tensor (const Tensor &, const Tensor &, Scalar)>(TensorTypeId::SparseCUDATensorId, &SparseCUDAType::add)
  ...
  .op(torch::RegisterOperators::options()
    ...
    .kernel<Tensor (const Tensor &, const Tensor &)>(TensorTypeId::SparseCUDATensorId, &SparseCUDAType::div)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
  ...
  .op(torch::RegisterOperators::options()
    ...
    .impl_unboxedOnlyKernel<Tensor (IntArrayRef, c10::optional<ScalarType>, c10::optional<Layout>, c10::optional<Device>, c10::optional<bool>, c10::optional<MemoryFormat>), &SparseCUDAType::empty>(TensorTypeId::SparseCUDATensorId)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
    .schema("aten::isnan(Tensor self) -> Tensor")
    .kernel<Tensor (const Tensor &)>(TensorTypeId::SparseCUDATensorId, &SparseCUDAType::isnan)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
  ...
  .op(torch::RegisterOperators::options()
    ...
    .kernel<Tensor (const Tensor &, const Tensor &)>(TensorTypeId::SparseCUDATensorId, &SparseCUDAType::mm)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
  ...
  .op(torch::RegisterOperators::options()
    ...
    .kernel<Tensor (const Tensor &, const Tensor &)>(TensorTypeId::SparseCUDATensorId, &SparseCUDAType::mul)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
  ...
  .op(torch::RegisterOperators::options()
    ...
    .kernel<Tensor (const Tensor &, int64_t, int64_t, int64_t)>(TensorTypeId::SparseCUDATensorId, &SparseCUDAType::narrow_copy)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
  ...
  .op(torch::RegisterOperators::options()
    ...
    .kernel<Tensor (const Tensor &, Scalar)>(TensorTypeId::SparseCUDATensorId, &SparseCUDAType::native_norm)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
  ...
  .op(torch::RegisterOperators::options()
    ...
    .impl_unboxedOnlyKernel<Tensor (const Tensor &, c10::optional<MemoryFormat>), &SparseCUDAType::clone>(TensorTypeId::SparseCUDATensorId)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
  ...
  .op(torch::RegisterOperators::options()
    ...
    .kernel<Tensor (const Tensor &, Scalar)>(TensorTypeId::SparseCUDATensorId, &SparseCUDAType::pow)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
  ...
  .op(torch::RegisterOperators::options()
    ...
    .kernel<Tensor (const Tensor &, const Tensor &, Scalar)>(TensorTypeId::SparseCUDATensorId, &SparseCUDAType::sub)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
  ...
  .op(torch::RegisterOperators::options()
    ...
    .kernel<Tensor (const Tensor &, const Tensor &, const Tensor &, Scalar, Scalar)>(TensorTypeId::SparseCUDATensorId, &SparseCUDAType::addmm)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
  ...
  .op(torch::RegisterOperators::options()
    ...
    .impl_unboxedOnlyKernel<Tensor (int64_t, int64_t, IntArrayRef, c10::optional<ScalarType>, c10::optional<Layout>, c10::optional<Device>, c10::optional<bool>), &SparseCUDAType::_sparse_coo_tensor_with_dims>(TensorTypeId::SparseCUDATensorId)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
    ...
    .impl_unboxedOnlyKernel<Tensor (int64_t, int64_t, IntArrayRef, const Tensor &, const Tensor &, ScalarType, Layout, Device, bool), &SparseCUDAType::_sparse_coo_tensor_with_dims_and_tensors>(TensorTypeId::SparseCUDATensorId)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
  ...
  .op(torch::RegisterOperators::options()
    ...
    .kernel<Tensor (const Tensor &, const Tensor &)>(TensorTypeId::SparseCUDATensorId, &SparseCUDAType::sparse_mask)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
    .schema("aten::to_dense(Tensor self) -> Tensor")
    .kernel<Tensor (const Tensor &)>(TensorTypeId::SparseCUDATensorId, &SparseCUDAType::to_dense)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
    .schema("aten::sparse_dim(Tensor self) -> int")
    .kernel<int64_t (const Tensor &)>(TensorTypeId::SparseCUDATensorId, &SparseCUDAType::sparse_dim)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
    .schema("aten::_dimI(Tensor self) -> int")
    .kernel<int64_t (const Tensor &)>(TensorTypeId::SparseCUDATensorId, &SparseCUDAType::_dimI)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
    .schema("aten::dense_dim(Tensor self) -> int")
    .kernel<int64_t (const Tensor &)>(TensorTypeId::SparseCUDATensorId, &SparseCUDAType::dense_dim)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
    .schema("aten::_dimV(Tensor self) -> int")
    .kernel<int64_t (const Tensor &)>(TensorTypeId::SparseCUDATensorId, &SparseCUDAType::_dimV)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
    .schema("aten::_nnz(Tensor self) -> int")
    .kernel<int64_t (const Tensor &)>(TensorTypeId::SparseCUDATensorId, &SparseCUDAType::_nnz)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
    .schema("aten::coalesce(Tensor self) -> Tensor")
    .kernel<Tensor (const Tensor &)>(TensorTypeId::SparseCUDATensorId, &SparseCUDAType::coalesce)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
    .schema("aten::is_coalesced(Tensor self) -> bool")
    .kernel<bool (const Tensor &)>(TensorTypeId::SparseCUDATensorId, &SparseCUDAType::is_coalesced)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
  ...
  .op(torch::RegisterOperators::options()
    ...
    .kernel<Tensor (const Tensor &, const Tensor &)>(TensorTypeId::SparseCUDATensorId, &SparseCUDAType::hspmm)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
  ...
  .op(torch::RegisterOperators::options()
    ...
    .kernel<Tensor (const Tensor &, int64_t, const Tensor &)>(TensorTypeId::SparseCUDATensorId, &SparseCUDAType::index_select)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
    .schema("aten::any(Tensor self) -> Tensor")
    .kernel<Tensor (const Tensor &)>(TensorTypeId::SparseCUDATensorId, &SparseCUDAType::any)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA));
}
#endif
