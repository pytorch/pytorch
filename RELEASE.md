...
* Resolve all outstanding issues in the milestones that are feature work (for example [release 2.10](https://github.com/pytorch/pytorch/milestone/57)) by running the [github-analytics-daily workflow](https://github.com/pytorch/test-infra/blob/main/.github/workflows/github-analytics-daily.yml)
