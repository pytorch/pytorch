...
from torch.testing._internal.inductor_utils import GPU_TYPE, HAS_CPU, HAS_CUDA_AND_TRITON, HAS_XPU
...
if HAS_XPU or (HAS_CUDA_AND_TRITON and PLATFORM_SUPPORTS_FUSED_ATTENTION):
