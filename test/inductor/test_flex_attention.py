...
class TestFlexAttention(InductorTestCase):
    ...
    def test_strided_inputs(self, device, dtype: torch.dtype, q_s, k_s, v_s, do_s):
        ...
        # TODO(nikhilap) For now the real use_triton_tma_template() utility function can't ensure base 16B alignment
        can_use_tma = all(offset == 0 for _, offset in [q_s, k_s, v_s])
        kernel_options = {"USE_TMA": can_use_tma}
