...
inductor_override_kwargs = {
    ...
    ("byte", "xpu", f16): {"atol": 1e-5, "rtol": 0.5},
    ("byte", "xpu", f32): {"atol": 1e-5, "rtol": 0.5},
    ...
    ("nn.functional.conv1d", "xpu", f16): {"atol": 1e-5, "rtol": 6e-3},
    ...
    ("nn.functional.softsign", "xpu", f16): {"atol": 1e-5, "rtol": 0.005},
    ...
    # Unreasonably high atol requirement:
    ("index_reduce.mean", "xpu", f16): {"check_gradient": False},
    ("index_reduce.mean", "xpu", f32): {"check_gradient": False},
    ("index_reduce.mean", "xpu", f64): {"check_gradient": False},
    # Gradient contains non-finite entries:
    ("index_reduce.amin", "xpu", f64): {"check_gradient": False},
    ("index_reduce.amin", "xpu", f32): {"check_gradient": False},
    ("index_reduce.amin", "xpu", f16): {"check_gradient": False},
    ("index_reduce.amax", "xpu", f64): {"check_gradient": False},
    ("index_reduce.amax", "xpu", f32): {"check_gradient": False},
    ("index_reduce.amax", "xpu", f16): {"check_gradient": False},
...
inductor_one_sample = {
    ...
    ("xlogy", "cuda"): {f16},
    ("__rdiv__", "xpu"): {f16},
    ("__rmod__", "xpu"): {f16, i64},
    ("__rmul__", "xpu"): {f16},
    ("__rpow__", "xpu"): {f16},
    ("_unsafe_masked_index", "xpu"): {f16},
    ("_unsafe_masked_index_put_accumulate", "xpu"): {f16},
    ("addcdiv", "xpu"): {f16},
    ("addcmul", "xpu"): {f16},
    ("atan2", "xpu"): {f16},
    ("cumsum", "xpu"): {f16},
    ("cumulative_trapezoid", "xpu"): {f16},
    ("dist", "xpu"): {f16},
    ("div.no_rounding_mode", "xpu"): {f16},
    ("fmod", "xpu"): {f16},
    ("grid_sampler_2d", "xpu"): {f16},
    ("index_fill", "xpu"): {f16, f32, f64},
    ("ldexp", "xpu"): {f16},
    ("lerp", "xpu"): {f16},
    ("linalg.householder_product", "xpu"): {f32},
    ("linalg.matrix_norm", "xpu"): {f16},
    ("linalg.vector_norm", "xpu"): {f16},
    ("logspace", "xpu"): {i32, i64},
    ("masked.cumsum", "xpu"): {f16},
    ("masked.logsumexp", "xpu"): {f16},
    ("masked.mean", "xpu"): {b8},
    ("masked.normalize", "xpu"): {f16},
    ("masked.prod", "xpu"): {f16},
    ("masked.std", "xpu"): {f16},
    ("masked.var", "xpu"): {f16},
    ("mul", "xpu"): {f16},
    ("nn.functional.alpha_dropout", "xpu"): {f16, f32, f64},
    ("nn.functional.avg_pool1d", "xpu"): {f16, f32, f64},
    ("nn.functional.avg_pool2d", "xpu"): {f16, f32, f64},
    ("nn.functional.avg_pool3d", "xpu"): {f16, f32, f64},
    ("nn.functional.binary_cross_entropy", "xpu"): {f16},
    ("nn.functional.binary_cross_entropy_with_logits", "xpu"): {f16},
    ("nn.functional.conv2d", "xpu"): {f16},
    ("nn.functional.cosine_embedding_loss", "xpu"): {f16},
    ("nn.functional.dropout2d", "xpu"): {f16, f32, f64},
    ("nn.functional.dropout3d", "xpu"): {f16, f32, f64},
    ("nn.functional.dropout", "xpu"): {f16, f32, f64},
    ("nn.functional.feature_alpha_dropout.with_train", "xpu"): {f16, f32, f64},
    ("nn.functional.fractional_max_pool2d", "xpu"): {f16, f32, f64},
    ("nn.functional.fractional_max_pool3d", "xpu"): {f16, f32, f64},
    ("nn.functional.grid_sample", "xpu"): {f16},
    ("nn.functional.group_norm", "xpu"): {f16},
    ("nn.functional.hinge_embedding_loss", "xpu"): {f16},
    # Enabling all tests for this test fails randomly
    # See https://github.com/pytorch/pytorch/issues/129238
    ("nn.functional.huber_loss", "xpu"): {f16},
    ("nn.functional.interpolate.bicubic", "xpu"): {f16},
    ("nn.functional.interpolate.bilinear", "xpu"): {f16},
    ("nn.functional.interpolate.trilinear", "xpu"): {f16},
    ("nn.functional.kl_div", "xpu"): {f16},
    ("nn.functional.margin_ranking_loss", "xpu"): {f16},
    ("nn.functional.max_pool1d", "xpu"): {f16, f32, f64},
    ("nn.functional.max_pool3d", "xpu"): {f16},
    ("nn.functional.mse_loss", "xpu"): {f16},
    ("nn.functional.multi_margin_loss", "xpu"): {f16},
    ("nn.functional.multilabel_margin_loss", "xpu"): {f16},
    ("nn.functional.multilabel_soft_margin_loss", "xpu"): {f16},
    ("nn.functional.normalize", "xpu"): {f16},
    ("nn.functional.pad.replicate", "xpu"): {f16, f32, f64},
    ("nn.functional.pad.reflect", "xpu"): {f16},
    ("nn.functional.pairwise_distance", "xpu"): {f16},
    ("nn.functional.poisson_nll_loss", "xpu"): {f16},
    ("nn.functional.rms_norm", "xpu"): {f16},
    ("norm", "xpu"): {f16},
    ("pow", "xpu"): {f16},
    ("prod", "xpu"): {f16},
    ("scatter_reduce.amax", "xpu"): {f16, f32, f64},
    ("scatter_reduce.amin", "xpu"): {f16, f32, f64},
    ("scatter_reduce.mean", "xpu"): {f16, f32, f64},
    ("special.xlog1py", "xpu"): {f16},
    ("std", "xpu"): {f16},
    ("std_mean", "xpu"): {f16},
    ("svd_lowrank", "xpu"): {f32, f64},
    ("trapezoid", "xpu"): {f16},
    ("trapz", "xpu"): {f16},
    ("true_divide", "xpu"): {f16},
    ("var", "xpu"): {f16},
