...
class TestPatternMatcher(TestCase):
    ...
    def test_fwd_only_preserves_clone_before_mutation(self):
        def fn(x):
            y = x.clone()
            y.add_(1)
            return x
    ...
    def test_fwd_only_preserves_auto_functionalized_clone(self):
    ...
    def test_fwd_only_preserves_clone_before_effectful_op(self):
    ...
    def test_fwd_only_preserves_clone_before_with_effects(self):
