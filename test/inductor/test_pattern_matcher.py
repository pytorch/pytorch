...
class TestPatternMatcherMps(TestCase):
...
class TestPatternMatcherXpu(TestCase):
...
instantiate_device_type_tests(
    TestPatternMatcherMps, globals(), only_for="mps", allow_mps=True
)
instantiate_device_type_tests(
    TestPatternMatcherXpu, globals(), only_for="xpu", allow_xpu=True
)
instantiate_device_type_tests(
