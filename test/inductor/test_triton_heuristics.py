...
class TestTritonHeuristics(TestCase):
    ...
    def test_rocm_prune_block_k_underfills_mfma(self, dtype_size):
        # gfx942: a config with block_k < kpack * kdim underfills the packed MFMA
        # operand and is miscompiled, so it must be pruned.
        ...
        # Plain GemmConfig lists (int8 / scaled_mm) never opt into the tunables
        # and must keep their full search space.
