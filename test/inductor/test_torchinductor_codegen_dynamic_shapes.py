...
test_failures = {
    ...
    "test_pointwise_bessel_j0_dynamic_shapes": TestFailure(("cuda",)),
    "test_pointwise_bessel_j1_dynamic_shapes": TestFailure(("cuda",)),
    "test_pointwise_bessel_y0_dynamic_shapes": TestFailure(("cuda",)),
    "test_pointwise_bessel_y1_dynamic_shapes": TestFailure(("cuda",)),
    "test_pointwise_erfcx_dynamic_shapes": TestFailure(("cuda",)),
    "test_pointwise_gammainc_dynamic_shapes": TestFailure(("cuda",)),
    "test_pointwise_gammaincc_dynamic_shapes": TestFailure(("cuda",)),
    "test_pointwise_i0_dynamic_shapes": TestFailure(("cuda",)),
    "test_pointwise_i1_dynamic_shapes": TestFailure(("cuda",)),
    "test_pointwise_i0e_dynamic_shapes": TestFailure(("cuda",)),
    "test_pointwise_i1e_dynamic_shapes": TestFailure(("cuda",)),
    "test_pointwise_modified_bessel_i0_dynamic_shapes": TestFailure(("cuda",)),
    "test_pointwise_modified_bessel_i1_dynamic_shapes": TestFailure(("cuda",)),
