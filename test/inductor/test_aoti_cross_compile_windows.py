...
instantiate_device_type_tests(TestAOTInductorWindowsCrossCompilation, globals(), only_for="cuda")
instantiate_device_type_tests(TestEnsureMingwCudartImportLib, globals(), only_for="cuda")
