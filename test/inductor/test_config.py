...
class TestInductorConfigCpu(TestInductorConfigBase):
...
class TestInductorConfigAccel(TestInductorConfigBase):
...
instantiate_device_type_tests(TestInductorConfigCpu, globals(), only_for="cpu")
instantiate_device_type_tests(
    TestInductorConfigAccel, globals(), allow_xpu=True, allow_mps=True, except_for="cpu"
)
