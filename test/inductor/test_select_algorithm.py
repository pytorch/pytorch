...
class TestTemplateRenderCpu(TestCase):
    hw_classification = HardwareClassification.CPU
...
instantiate_device_type_tests(TestTemplateRenderCpu, globals(), only_for="cpu")


if __name__ == "__main__":
    if IS_LINUX and torch.accelerator.is_available() and is_big_gpu():
        run_tests()
