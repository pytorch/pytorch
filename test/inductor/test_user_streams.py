...
class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[32, 32]", arg1_1: "f32[32, 32]", arg2_1: "f32[32, 32]"):
        ...
        control_deps_1 = torch.ops.higher_order.control_deps((mm_1,), subgraph_record_event_1, mm_1);  mm_1 = subgraph_record_event_1 = None
        ...
        control_deps_2 = torch.ops.higher_order.control_deps((control_deps, getitem, control_deps_1, getitem_1), subgraph_synchronize_stream, getitem, getitem_1);  control_deps = getitem = control_deps_1 = getitem_1 = subgraph_synchronize_stream = None

        # Annotation: {'stream': 1}
        getitem_3: "f32[32, 32]" = control_deps_2[2]

        # Annotation: {'stream': 1}
        getitem_2: "f32[32, 32]" = control_deps_2[1];  control_deps_2 = None
