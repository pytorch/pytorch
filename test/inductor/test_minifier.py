...
"""
    ...
    def _test_after_aot(self, device, bug_type, repro_level):
        ...
        isolate = False
        if device == "cuda" and bug_type == "runtime_error":
            # This config triggers a CUDA assert error which will
            # trash the process
            isolate = True
