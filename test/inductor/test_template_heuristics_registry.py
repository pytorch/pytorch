...
class TestTemplateHeuristicsRegistry(TestCase):
    ...
    def test_fallback_behavior(self, device):
        ...
        heuristic = get_template_heuristic("unknown_template", device_type, "unknown_op")
        self.assertIsInstance(heuristic, TemplateConfigHeuristics)
        ...
        heuristic2 = get_template_heuristic("unknown_template", device_type, "unknown_op")
        ...
        @register_template_heuristic("unknown_template", device_type, op_name="unknown_op")
        class _NewlyRegisteredHeuristic(TemplateConfigHeuristics):
            pass

        # Now should get the registered heuristic, not the fallback
        heuristic3 = get_template_heuristic("unknown_template", device_type, "unknown_op")
        ...
        heuristic4 = get_template_heuristic("unknown_template", device_type, "unknown_op")
