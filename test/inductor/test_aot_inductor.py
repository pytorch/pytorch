...
CPU_TEST_FAILURES = {
    ...
    # and terminal output say pass), but the process will segfault
    ...
    "test_output_missing": fail_stack_allocation(is_skip=True),
    ...
    "test_output_misaligned": fail_minimal_arrayref_interface(is_skip=True),
    ...
    "test_with_no_triton_profiler": fail_minimal_arrayref_interface(is_skip=True),
