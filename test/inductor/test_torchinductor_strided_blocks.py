...
class CommonTemplate:
    ...
    @parametrize(
        ...
        [
            subtest(
                (True, 2), decorators=[xfail_if_use_tma_api]
    ...
    @parametrize(
        ...
        [
            ...
            subtest(
                ((128, 128), 9, 2, False), decorators=[xfail_if_use_tma_api]
    ...
    @xfail_if_use_tma_api  # Cannot use TMA API for store with no x dimension.
