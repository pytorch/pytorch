...
class CompiledAutograd1(torch.nn.Module):
    def forward(self, inputs, sizes, scalars, hooks, packed_data):
        ...
        validate_outputs = torch__dynamo_compiled_autograd_ops_validate_outputs([getitem], [((None, None, device(type=\"""" + device + """\", index=0), 6, 0, None), [], False)]);  getitem = None
        ...
        validate_outputs_1 = torch__dynamo_compiled_autograd_ops_validate_outputs([getitem_6], [((None, None, device(type=\"""" + device + """\", index=0), 6, 0, None), [], False)]);  getitem_6 = None
        ...
        validate_outputs_2 = torch__dynamo_compiled_autograd_ops_validate_outputs([getitem_12], [((None, None, device(type=\"""" + device + """\", index=0), 6, 0, None), [getitem_3], False)]);  getitem_12 = getitem_3 = None
...
instantiate_device_type_tests(TestCompiledAutogradCudagraph, globals(), except_for="cpu")
