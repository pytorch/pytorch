...
class CompiledAutograd1(torch.nn.Module):
    def forward(self, inputs, sizes, scalars, hooks, packed_data):
        ...
        sum_backward0 = torch__dynamo_compiled_autograd_ops_SumBackward0([getitem_5], [True], 6, []);  getitem_5 = None
...
class CompiledAutograd1(torch.nn.Module):
    def forward(self, inputs, sizes, scalars, hooks, packed_data):
        ...
        sum_backward0 = torch__dynamo_compiled_autograd_ops_SumBackward0([getitem_4], [True], 6, []);  getitem_4 = None
