...
from . import test_onednn_pattern_matcher
import torch
...
try:
    try:
        ...
        import test_onednn_pattern_matcher
...
if RUN_CPU:
    ...
    for item in [
        ...
        BaseTest(
            ...
            "cpu",
            test_onednn_pattern_matcher.TestPatternMatcher(),
            condition=torch.backends.mkldnn.is_available(),
            func_inputs=[
                ["op_onednn__convolution_pointwise_binary.call"],
                ["op_onednn__convolution_pointwise__binary.call"],
            ],
        ),
        BaseTest(
        ...
        *[
        ...
        BaseTest(
            ...
            "cpu",
            test_onednn_pattern_matcher.TestDynamicPatternMatcher(),
            condition=torch.backends.mkldnn.is_available() and not IS_WINDOWS,
            func_inputs=[
                [
