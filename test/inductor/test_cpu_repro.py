...
class CPUReproTests(TestCase):
    ...
    def _check_out_variant_fallback_dispatch_runs_below_autograd(self, namespace):
        with torch.library._scoped_library(namespace, "FRAGMENT") as lib:
            lib.define("foo(Tensor x) -> Tensor")
            lib.define(
            ...
            calls = {"functional_autograd": 0, "out_autograd": 0, "out_cpu": 0}
            op = getattr(torch.ops, namespace).foo.default
            ...
            self.assertEqual(calls["out_cpu"], 1)
    ...
    def test_out_variant_fallback_dispatch_runs_below_autograd(self):
        self._check_out_variant_fallback_dispatch_runs_below_autograd("issue139629_out")
