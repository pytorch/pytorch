...
KERNEL_COUNT_OVERRIDES = {
    ...
    "test_adamw_tensor_lr_tensor_betas_amsgrad_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adamw_tensor_lr_tensor_betas_amsgrad_capturable_xpu": lambda x: assert_expected_inline(x, """6"""),
    "test_adamw_tensor_lr_tensor_betas_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adamw_tensor_lr_tensor_betas_capturable_xpu": lambda x: assert_expected_inline(x, """6"""),
    "test_adamw_tensor_lr_amsgrad_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adamw_tensor_lr_amsgrad_capturable_xpu": lambda x: assert_expected_inline(x, """6"""),
    "test_adam_tensor_lr_amsgrad_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adam_tensor_lr_amsgrad_capturable_xpu": lambda x: assert_expected_inline(x, """6"""),
    "test_adam_tensor_lr_tensor_betas_amsgrad_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adam_tensor_lr_tensor_betas_amsgrad_capturable_xpu": lambda x: assert_expected_inline(x, """6"""),
    "test_adam_tensor_lr_tensor_betas_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    ...
    "test_adadelta_tensor_lr_capturable_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_adadelta_tensor_lr_capturable_xpu": lambda x: assert_expected_inline(x, """6"""),
    "test_rmsprop_tensor_lr_capturable_cuda": lambda x: assert_expected_inline(x, """1"""),
    ...
    "test_sgd_momentum_dampening_foreach_cuda": lambda x: assert_expected_inline(x, """3"""),
    "test_sgd_momentum_dampening_foreach_xpu": lambda x: assert_expected_inline(x, """5"""),
    "test_sgd_momentum_foreach_cuda": lambda x: assert_expected_inline(x, """3"""),
    "test_sgd_momentum_foreach_xpu": lambda x: assert_expected_inline(x, """5"""),
    "test_sgd_weight_decay_maximize_cuda": lambda x: assert_expected_inline(x, """1"""),
    ...
    "test_sgd_weight_decay_cuda": lambda x: assert_expected_inline(x, """1"""),
    ...
    "test_sgd_cuda": lambda x: assert_expected_inline(x, """1"""),
    ...
    "test_adagrad_tensor_lr_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_adagrad_tensor_lr_xpu": lambda x: assert_expected_inline(x, """6"""),
    "test_adamax_tensor_lr_weight_decay_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adamax_tensor_lr_weight_decay_capturable_xpu": lambda x: assert_expected_inline(x, """6"""),
    "test_asgd_tensor_lr_weight_decay_maximize_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_asgd_tensor_lr_weight_decay_maximize_capturable_xpu": lambda x: assert_expected_inline(x, """5"""),
    "test_nadam_tensor_lr_weight_decay_momentum_decay_decoupled_weight_decay_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),  # noqa: B950
    ...
    "test_radam_tensor_lr_capturable_weight_decay_decoupled_weight_decay_cuda": lambda x: assert_expected_inline(x, """2"""),
    ...
    "test_sgd_tensor_lr_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_sgd_tensor_lr_xpu": lambda x: assert_expected_inline(x, """2"""),
    "test_rprop_tensor_lr_capturable_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_adadelta_capturable_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_adadelta_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_adadelta_maximize_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_adadelta_rho_weight_decay_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_adadelta_weight_decay_capturable_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_adadelta_weight_decay_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_adadelta_weight_decay_maximize_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_adagrad_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_adagrad_initial_accumulator_value_weight_decay_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_adagrad_lr_decay_weight_decay_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adagrad_weight_decay_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_adagrad_weight_decay_maximize_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_adam_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adam_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adam_weight_decay_amsgrad_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adam_weight_decay_amsgrad_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adam_weight_decay_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adam_weight_decay_maximize_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adamax_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adamax_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adamax_maximize_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adamax_weight_decay_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adamax_weight_decay_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adamax_weight_decay_maximize_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adamax_weight_decay_maximize_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adamw_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adamw_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adamw_weight_decay_amsgrad_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adamw_weight_decay_amsgrad_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adamw_weight_decay_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_adamw_weight_decay_maximize_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_asgd_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_asgd_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_asgd_lambd_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_asgd_maximize_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_asgd_maximize_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_asgd_recompile_single": lambda x: assert_expected_inline(x, """4"""),
    "test_asgd_t0_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_asgd_weight_decay_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_asgd_weight_decay_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_asgd_weight_decay_maximize_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_asgd_weight_decay_maximize_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_nadam_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_nadam_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_nadam_momentum_decay_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_nadam_weight_decay_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_nadam_weight_decay_maximize_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_nadam_weight_decay_momentum_decay_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_nadam_weight_decay_momentum_decay_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_nadam_weight_decay_momentum_decay_decoupled_weight_decay_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_nadam_weight_decay_momentum_decay_decoupled_weight_decay_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_radam_capturable_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_radam_capturable_weight_decay_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_radam_capturable_weight_decay_decoupled_weight_decay_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_radam_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_radam_eps_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_radam_weight_decay_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_radam_weight_decay_decoupled_weight_decay_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_radam_weight_decay_maximize_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_rmsprop_capturable_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_rmsprop_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_rmsprop_maximize_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_rmsprop_maximize_weight_decay_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_rmsprop_weight_decay_centered_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_rmsprop_weight_decay_centered_momentum_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_rmsprop_weight_decay_centered_momentum_maximize_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_rmsprop_weight_decay_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_rmsprop_weight_decay_maximize_capturable_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_rprop_capturable_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_rprop_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_rprop_etas_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_rprop_maximize_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_rprop_step_sizes_cuda": lambda x: assert_expected_inline(x, """1"""),
    "test_sgd_momentum_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_sgd_momentum_dampening_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_sgd_momentum_nesterov_weight_decay_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_sgd_momentum_weight_decay_cuda": lambda x: assert_expected_inline(x, """2"""),
    "test_sgd_recompile_single": lambda x: assert_expected_inline(x, """1"""),
}
# fmt: on
