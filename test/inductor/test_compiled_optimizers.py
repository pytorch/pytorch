...
KERNEL_COUNT_OVERRIDES = {
    ...
    "test_adamw_amsgrad_capturable_eps_foreach_cuda": 3,
    "test_adamw_amsgrad_capturable_eps_cuda": 6,
    "test_adamw_tensor_lr_amsgrad_capturable_eps_foreach_cuda": 3,
    "test_adamw_tensor_lr_amsgrad_capturable_eps_cuda": 6,
    "test_adam_tensor_lr_amsgrad_capturable_eps_cuda": 6,
    "test_adam_amsgrad_capturable_eps_cuda": 6,
