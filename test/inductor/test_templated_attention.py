...
class GraphModule(torch.nn.Module):
    def forward(self, L_args_0_: "f64[2, 2, 8, 4]", L_args_1_: "f64[2, 2, 8, 4]", L_args_2_: "f64[2, 2, 8, 4]"):
        ...
        templated_attention = torch.ops.higher_order.templated_attention(l_args_0_, l_args_1_, l_args_2_, templated_attention_0);  l_args_0_ = l_args_1_ = l_args_2_ = templated_attention_0 = None
        out: "f64[2, 2, 8, 4]" = templated_attention[0];  templated_attention = None
        return (out,)
