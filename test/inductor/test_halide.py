...
class HalideTests(TestCase):
    ...
    def test_codecache(self):
        fn = HalideCodeCache.generate_halide(
            HalideMeta(argtypes=[HalideInputSpec(ctype='float*', name='in_ptr0', numel='static_cast<long>(1024L)'),
                                  HalideInputSpec(ctype='float*', name='in_ptr1', numel='static_cast<long>(1024L)'),
                                  HalideInputSpec(ctype='float*', name='out_ptr0', numel='static_cast<long>(1024L)')],
                        scheduler='Mullapudi2016'), textwrap.dedent('''
