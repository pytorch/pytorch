...
class _NestedReductionBase:
    ...
    def test_producer_consumer_rejects_unprofitable_contiguous_sub_parent_source(self):
        import torch.nn.functional as F
    ...
    def test_producer_consumer_rejects_half_output_reduction_reader(self):
        import torch.nn.functional as F
...
def _capture_rmsnorm_chunk_swiglu_kernel_sources(
    batch_size: int,
    D: int = 1024,
    *,
    force_persistent_outer_reduction: bool | None = None,
...
def _capture_rmsnorm_chunk4_gating_kernel_sources(
    batch_size: int,
    D: int = 1024,
    *,
    force_persistent_outer_reduction: bool | None = None,
...
def _capture_rmsnorm_chunk_many_kernel_sources(
    batch_size: int,
    chunks: int,
    D: int = 1024,
    *,
...
class _InternalsBase:
    ...
    def test_rmsnorm_chunk_swiglu_kernel_form(self):
        ...
        self.assert_single_kernel_form(
            _capture_rmsnorm_chunk_swiglu_kernel_sources,
            128,
    ...
    def test_rmsnorm_chunk4_gating_kernel_form(self):
        ...
        self.assert_single_kernel_form(
            _capture_rmsnorm_chunk4_gating_kernel_sources,
            128,
            input_counts=self.looped_or_persistent(
                {0: 5, 1: 5, 2: 4},
                {0: 1, 1: 1, 2: 4},
    ...
    def assert_rmsnorm_chunk_many_kernel_form(self, chunks: int) -> None:
        ...
        self.assert_single_kernel_form(
            _capture_rmsnorm_chunk_many_kernel_sources,
            128,
            chunks,
            input_counts=self.looped_or_persistent(
