...
class TestCuteDSLTemplateGeneric(TestCase):
...
class TestCuteDSLTemplateCuda(TestCase):
    """CUDA end-to-end tests for CuteDSL template functionality."""
...
instantiate_device_type_tests(TestCuteDSLTemplateCuda, globals(), only_for="cuda")
