...
from torch.testing._internal.inductor_utils import GPU_TYPE, HAS_TRITON_CUDA
...
class TestDecomposeMemMM(TestCase):
    ...
    def test_decompose_bmm(self, b, m, n, k, should_decompose):
        ...
        expected_val = 1 if should_decompose and HAS_TRITON_CUDA else 0
        self.assertEqual(
        ...
        expected_val = 3 if should_decompose and HAS_TRITON_CUDA else 0
        self.assertEqual(
            counters["inductor"]["decompose_bmm"],
            expected_val,
        )
