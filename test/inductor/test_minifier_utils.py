...
# class Repro_true_graph_0(torch.nn.Module):
...
# class Repro_false_graph_0(torch.nn.Module):
#     def __init__(self) -> None:
#         super().__init__()
...
#     def __init__(self) -> None:
#         super().__init__()
#         self.true_graph_0 = Repro_true_graph_0()
#         self.false_graph_0 = Repro_false_graph_0()
