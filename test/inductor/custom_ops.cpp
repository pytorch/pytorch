...
Tensor fn_with_all_inputs_impl(
    ...
    const c10::List<c10::optional<Tensor>>& optional_tensors,
    const bool b8,
    ...
    const Device& device,
    // optional
    const c10::optional<Tensor>& o_tensor,
    const c10::optional<c10::List<Tensor>>& o_tensors,
    const c10::optional<bool>& o_b8,
    const c10::optional<c10::List<bool>>& o_b8s,
    const c10::optional<int64_t>& o_i64,
    const c10::optional<c10::List<int64_t>>& o_i64s,
    const c10::optional<int64_t>& o_symint,
    const c10::optional<IntArrayRef>& o_symints,
    const c10::optional<double>& o_f64,
    const c10::optional<c10::List<double>>& o_f64s,
    const c10::optional<at::Scalar>& o_scalar,
    const c10::optional<at::ArrayRef<at::Scalar>>& o_scalars,
    const c10::optional<std::string>& o_string,
    const c10::optional<std::vector<std::string>>& o_strings,
    const c10::optional<c10::ScalarType>& o_dtype,
    const c10::optional<MemoryFormat>& o_memory_format,
    const c10::optional<Layout>& o_layout,
    const c10::optional<Device>& o_device) {
...
Tensor fn_with_all_inputs_meta(
    ...
    const c10::optional<int64_t>& o_i64,
    const c10::optional<c10::List<int64_t>>& o_i64s,
    const c10::optional<c10::SymInt>& o_symint,
