...
def forward(self, arg0_1: "f32[s77, s77][s77, 1]cpu", arg1_1: "Sym(s77)"):
        slice_2: "f32[s77, Max(0, -Min(3, s77) + Min(4, s77))][s77, 1]cpu" = torch.ops.aten.slice.Tensor(arg0_1, 1, 3, 4)
        ...
        auto_functionalized_v2 = torch.ops.higher_order.auto_functionalized_v2(torch.ops.mylib.foo.default, _x_base_index = 0, _x_slice_dim = 0, _x_slice_start = floordiv, _x_slice_end = add_6, _y_base_index = 0, _y_slice_dim = 1, _y_slice_start = floordiv_1, _y_slice_end = add_7, _all_bases = [arg0_1]);  floordiv = add_6 = floordiv_1 = add_7 = None
...
def forward(self, arg0_1: "f32[s77, s77][s77, 1]cpu", arg1_1: "Sym(s77)"):
        ...
        slice_tensor_1: "f32[s77, Max(0, -Min(3, s77) + Min(4, s77))][s77, 1]cpu" = torch.ops.aten.slice.Tensor(arg0_1, 1, floordiv_1, add_7);  floordiv_1 = add_7 = None
        foo_default = torch.ops.mylib.foo.default(slice_tensor, slice_tensor_1);  slice_tensor = slice_tensor_1 = foo_default = None
        ...
        slice_4: "f32[s77, Max(0, -Min(3, s77) + Min(4, s77))][s77, 1]cpu" = torch.ops.aten.slice.Tensor(arg0_1, 1, 3, 4);  arg0_1 = None
        return (slice_3, slice_4)""",
                        ignore_comments=True,
                        ignore_empty_lines=True,
                    )
