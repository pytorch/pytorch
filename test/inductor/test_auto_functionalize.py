            ...
            if torch._dynamo.config.assume_static_by_default:
                if _dynamic:
                    self.assertExpectedInline(
                        post_grad_graphs,
                        """\
def forward(self, arg0_1: "f32[s72][1]cpu", arg1_1: "Sym(s72)", arg2_1: "f32[s77][1]cpu", arg3_1: "Sym(s77)", arg4_1: "f32[s10][1]cpu", arg5_1: "Sym(s10)", arg6_1: "f32[s42][1]cpu", arg7_1: "Sym(s42)", arg8_1: "f32[s68][1]cpu", arg9_1: "Sym(s68)"):
        foo_default = torch.ops.mylib.foo.default(arg2_1, [arg4_1, arg6_1], arg8_1, 2, arg0_1);  arg4_1 = arg6_1 = arg0_1 = foo_default = None
        copy_: "f32[s77][1]cpu" = torch.ops.aten.copy_.default(arg2_1, arg2_1);  arg2_1 = copy_ = None
        copy__1: "f32[s68][1]cpu" = torch.ops.aten.copy_.default(arg8_1, arg8_1);  arg8_1 = copy__1 = None
        return ()""",
                        ignore_comments=True,
            ...
            if torch._dynamo.config.assume_static_by_default:
                if _dynamic:
                    self.assertExpectedInline(
                        graph_aot,
                        """\
def forward(self, arg0_1: "f32[s17][1]cpu", arg1_1: "Sym(s17)", arg2_1: "f32[s17][1]cpu"):
        ...
        copy_: "f32[s17][1]cpu" = torch.ops.aten.copy_.default(arg0_1, getitem_1);  arg0_1 = getitem_1 = copy_ = None
        copy__1: "f32[s17][1]cpu" = torch.ops.aten.copy_.default(arg2_1, getitem_2);  arg2_1 = getitem_2 = copy__1 = None
        return (add,)""",
                        ignore_comments=True,
                        ignore_empty_lines=True,
                    )
...
def forward(self, arg0_1: "f32[s17][1]cpu", arg1_1: "Sym(s17)", arg2_1: "f32[s17][1]cpu"):
        ...
        add: "f32[s17][1]cpu" = torch.ops.aten.add.Tensor(arg0_1, arg2_1)
        copy_: "f32[s17][1]cpu" = torch.ops.aten.copy_.default(arg0_1, arg0_1);  arg0_1 = copy_ = None
            ...
            if torch._dynamo.config.assume_static_by_default:
                if _dynamic:
                    self.assertExpectedInline(
                        graph_aot,
                        """\
def forward(self, arg0_1: "f32[s77, 10][10, 1]cpu", arg1_1: "Sym(s77)"):
        ...
        copy_: "f32[s77, 10][10, 1]cpu" = torch.ops.aten.copy_.default(arg0_1, getitem_3);  arg0_1 = copy_ = None
            ...
            if torch._dynamo.config.assume_static_by_default:
                if _dynamic:
                    self.assertExpectedInline(
                        ...
                        """\
def forward(self, arg0_1: "f32[s77, 10][10, 1]cpu", arg1_1: "Sym(s77)"):
        slice_tensor: "f32[s77, 4][10, 1]cpu" = torch.ops.aten.slice.Tensor(arg0_1, 1, 0, 4)
        slice_tensor_1: "f32[s77, 6][10, 1]cpu" = torch.ops.aten.slice.Tensor(arg0_1, 1, 4, 10)
        foo_default = torch.ops.mylib.foo.default(slice_tensor, slice_tensor_1);  slice_tensor = slice_tensor_1 = foo_default = None
        copy_: "f32[s77, 10][10, 1]cpu" = torch.ops.aten.copy_.default(arg0_1, arg0_1);  copy_ = None
            ...
            if torch._dynamo.config.assume_static_by_default:
                if _dynamic:
                    self.assertExpectedInline(
                        graph_aot,
                        """\
def forward(self, arg0_1: "f32[s77, s27][s27, 1]cpu", arg1_1: "Sym(s77)", arg2_1: "Sym(s27)"):
        floordiv: "Sym(0)" = 0 // arg2_1;  arg2_1 = None
        ...
        getitem_1: "f32[s77, s27][s27, 1]cpu" = auto_functionalized_v2[1];  auto_functionalized_v2 = None
        copy_: "f32[s77, s27][s27, 1]cpu" = torch.ops.aten.copy_.default(arg0_1, getitem_1);  arg0_1 = copy_ = None
        slice_3: "f32[2, s27][s27, 1]cpu" = torch.ops.aten.slice.Tensor(getitem_1, 0, 0, 2)
        slice_4: "f32[s77, 1][s27, 1]cpu" = torch.ops.aten.slice.Tensor(getitem_1, 1, 3, 4);  getitem_1 = None
...
def forward(self, arg0_1: "f32[s77, s27][s27, 1]cpu", arg1_1: "Sym(s77)", arg2_1: "Sym(s27)"):
        ...
        slice_tensor: "f32[2, s27][s27, 1]cpu" = torch.ops.aten.slice.Tensor(arg0_1, 0, 0, 2)
        slice_tensor_1: "f32[s77, 1][s27, 1]cpu" = torch.ops.aten.slice.Tensor(arg0_1, 1, 3, 4)
        foo_default = torch.ops.mylib.foo.default(slice_tensor, slice_tensor_1);  slice_tensor = slice_tensor_1 = foo_default = None
        copy_: "f32[s77, s27][s27, 1]cpu" = torch.ops.aten.copy_.default(arg0_1, arg0_1);  copy_ = None
        slice_3: "f32[2, s27][s27, 1]cpu" = torch.ops.aten.slice.Tensor(arg0_1, 0, 0, 2)
        slice_4: "f32[s77, 1][s27, 1]cpu" = torch.ops.aten.slice.Tensor(arg0_1, 1, 3, 4);  arg0_1 = None
        return (slice_3, slice_4)""",
                        ignore_comments=True,
                        ignore_empty_lines=True,
                    )
