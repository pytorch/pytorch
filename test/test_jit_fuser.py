...
class TestFuser(JitTestCase):
    ...
    @unittest.skipIf(GRAPH_EXECUTOR != ProfilingMode.OFF, "no half support with profiling on")
    ...
    @unittest.skipIf(not RUN_CUDA, "fuser requires CUDA")
    @unittest.skipIf(GRAPH_EXECUTOR != ProfilingMode.OFF, "broken with profiling on")
    @_inline_everything
