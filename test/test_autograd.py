...
method_tests = [
    ...
    ('scatter', (M, S), (0, gather_variable((S, 1), 1, M), (S, S)), 'dim0_broadcast_index1', [0]),
    ('scatter', (M, S), (0, gather_variable((S, S), 1, M), (S,)), 'dim0_broadcast_src0', [0]),
    ('scatter', (M, S), (0, gather_variable((S, S), 1, M), (S, 1)), 'dim0_broadcast_src1', [0]),
    ('scatter', (M, S), (0, gather_variable((S, S), 1, M), ()), 'dim0_broadcast_src01', [0]),
    ('scatter', (M, S), (1, gather_variable((M, S // 2), 0, S), (M, S // 2)), 'dim1', [0]),
    ('scatter', (), (0, torch.tensor(0, dtype=torch.int64), ()), 'scalar_all_dim0', [0]),
    ('scatter_add', (M, S), (0, gather_variable((S, S), 1, M), (S, S)), 'dim0', [0]),
    ('scatter_add', (M, S), (0, gather_variable((S, 1), 1, M), (S, S)), 'dim0_broadcast_index1', [0]),
    ('scatter_add', (M, S), (0, gather_variable((S, S), 1, M), (S,)), 'dim0_broadcast_src0', [0]),
    ('scatter_add', (M, S), (0, gather_variable((S, S), 1, M), (S, 1)), 'dim0_broadcast_src1', [0]),
    ('scatter_add', (M, S), (0, gather_variable((S, S), 1, M), ()), 'dim0_broadcast_src01', [0]),
