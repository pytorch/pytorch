...
def uniform_scalar(offset=0, requires_grad=False):
    v = torch.tensor(0, dtype=torch.Tensor.dtype).uniform_(0, 1) + offset
    v.requires_grad = requires_grad
    return v


def normal_scalar_clamp(amin, amax, requires_grad=False):
    v = torch.tensor(0, dtype=torch.Tensor.dtype).normal_().clamp(amin, amax)
    v.requires_grad = requires_grad
    return v
...
method_tests = [
    ...
    ('prod', (torch.tensor(0, dtype=torch.Tensor.dtype, requires_grad=True)), NO_ARGS, 'scalar_zero'),
    ('prod', (torch.tensor(0, dtype=torch.Tensor.dtype, requires_grad=True)), (0,), 'scalar_dim_zero', [0]),
    ('prod', (torch.tensor(0, dtype=torch.Tensor.dtype, requires_grad=True)), (0, True,), 'scalar_keepdim_dim_zero', [0]),
    ('var', (S, S, S), NO_ARGS),
    ('var', (S, S, S), (1,), 'dim', [0]),
    ...
    ('cumprod', (), (0,), 'scalar'),
    ('cumprod', (torch.tensor(0, dtype=torch.Tensor.dtype, requires_grad=True)), (0,), 'scalar_zeros'),
    ...
    ('index_add', (), (0, torch.tensor([0], dtype=torch.int64), torch.tensor([2], dtype=torch.Tensor.dtype)), 'scalar_input_dim', [0]),
    ('index_add', (), (0, torch.tensor(0, dtype=torch.int64), torch.tensor(2, dtype=torch.Tensor.dtype)), 'scalar_all_dim', [0]),
    ('index_copy', (S, S), (0, index_perm_variable(2, S), (2, S)), 'dim', [0]),
    ('index_copy', (), (0, torch.tensor([0], dtype=torch.int64), torch.tensor([2], dtype=torch.Tensor.dtype)), 'scalar_input_dim', [0]),
    ('index_copy', (), (0, torch.tensor(0, dtype=torch.int64), torch.tensor(2, dtype=torch.Tensor.dtype)), 'scalar_all_dim', [0]),
    ...
    ('resize_as_', (), (non_differentiable(torch.tensor(5, dtype=torch.Tensor.dtype)),), 'scalar'),
