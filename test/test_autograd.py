...
"""
    ...
    def test_disabling_saved_tensor_hooks_with_message(self):
        ...
        self.assertFalse(torch._C._autograd._saved_tensors_hooks_is_disabled())
    ...
    def test_disabling_saved_tensor_hooks(self):
        with torch.autograd.graph._disable_saved_tensors_hooks():
