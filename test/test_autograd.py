...
class TestAutograd(TestCase):
    ...
    def test_chain_mm(self):
        ...
        gradcheck(torch.chain_mm, gen_matrices([5, 10, 15, 5]))
        gradcheck(torch.chain_mm, gen_matrices([3, 5, 2, 6]))
        gradgradcheck(torch.chain_mm, gen_matrices([5, 10, 15, 5]))
        gradgradcheck(torch.chain_mm, gen_matrices([3, 5, 2, 6]))
