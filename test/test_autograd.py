...
method_tests = [
    ...
    ('matrix_power', random_fullrank_matrix_distinct_singular_value(S), [-1], "n=-1", NOARGS, [skipIfNoLapack]),
    ('matrix_power', random_fullrank_matrix_distinct_singular_value(S), [-3], "n=-3", NOARGS, [skipIfNoLapack]),
    ('addcmul', (S, S), ((S, S), (S, S))),
