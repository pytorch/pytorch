...
method_tests = [
    ...
    ('symeig', lambda: random_symmetric_pd_matrix(S), (True, False), 'lower', NO_ARGS, [skipIfNoLapack]),
    ('symeig', lambda: random_symmetric_pd_matrix(S), (True, True), 'upper', NO_ARGS, [skipIfNoLapack]),
    ('symeig', lambda: random_symmetric_pd_matrix(S), (False, True), 'eigenvalues', NO_ARGS, [skipIfNoLapack]),
    ('symeig', lambda: random_symmetric_matrix(S), (True, True), 'symmetric', NO_ARGS, [skipIfNoLapack]),
