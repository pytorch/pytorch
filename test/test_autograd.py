...
complex_list = ['t', 'view', 'reshape', 'reshape_as', 'view_as', 'roll', 'clone',
                ...
                'exp', 'solve'] + separate_complex_tests

# this list corresponds to cases that are not currently implemented
skip_cuda_list = ['bmm_complex', 'matmul_4d_4d_complex', 'solve_batched_broadcast_A_complex',
                  'solve_batched_broadcast_b_complex', 'solve_batched_complex', 'solve_batched_dims_complex']
