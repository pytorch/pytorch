...
function_tests = [
    ...
    (Max, (), ((S, S, S), 1), 'dim', [1]),
    (Min, (), ((S, S, S), 1), 'dim', [1]),
    (Max, (), ((S, S, S), 1, True), 'keepdim_false_dim', [1]),
    (Min, (), ((S, S, S), 1, True), 'keepdim_false_dim', [1]),
    (Mode, (), ((S, S, S),),),
    (Mode, (), ((S, S, S), 1), 'dim', [1]),
    (Mode, (), ((S, S, S), 1, True), 'keepdim_false_dim', [1]),
    (Kthvalue, (), ((S, S, S), 2),),
    (Kthvalue, (), ((S, S, S), 2, 0), 'dim0'),
    (Kthvalue, (), ((S, S, S), 2, 0, True), "keepdim_false"),
    (Median, (), ((S, S, S),),),
    (Median, (), ((S, S, S), 0), 'dim0'),
    (Median, (), ((S, S, S), 0, True), "keepdim_false"),
    ...
    (Norm, (), (torch.rand(S, S, S), 1.5, 1, True), 'keepdim_false_1_5_dim', [2]),
    (Norm, (), ((S, S, S), 2, 1, True), 'keepdim_false_2_dim', [2]),
    (Norm, (), ((S, S, S), 3, 1, True), 'keepdim_false_3_dim', [2]),
    (Addcmul, (), ((S, S), (S, S), (S, S))),
