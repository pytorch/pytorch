...
def op_assert_ref(test_case, op, test_dtype, i, orig, decomp, ref, args, kwargs):
    ...
    tol_table = {
        ...
        (torch.float16, torch.ops.aten.reflection_pad1d_backward.default): 3e-2,
        (torch.bfloat16, torch.ops.aten.reflection_pad1d_backward.default): 3e-2,
        (torch.float16, torch.ops.aten.reflection_pad2d_backward.default): 3e-2,
        (torch.bfloat16, torch.ops.aten.reflection_pad2d_backward.default): 3e-2,
        (torch.float16, torch.ops.aten.reflection_pad3d_backward.default): 3e-2,
        (torch.bfloat16, torch.ops.aten.reflection_pad3d_backward.default): 3e-2,
