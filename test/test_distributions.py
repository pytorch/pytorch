...
class TestDistributions(TestCase):
    ...
    def test_mixture_same_family_log_prob(self):
        ...
        self._check_log_prob(MixtureSameFamily(
                Categorical(probs=probs), Normal(loc, scale)), ref_log_prob)
    ...
    def test_mixture_same_family_sample(self):
        ...
        self._check_sampler_sampler(MixtureSameFamily(
                Categorical(probs=probs), Normal(loc, scale)),
                ScipyMixtureNormal(probs.numpy(), loc.numpy(), scale.numpy()),
                'MixtureSameFamily(Categorical(probs={}), Normal(loc={}, scale={}))'.format(
                        probs, loc, scale))
