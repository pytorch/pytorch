...
def forward(self, arg0_1: "i64[2][1]cpu", arg1_1: "Sym(u2)", arg2_1: "Sym(u3)", arg3_1: "f32[u2, u3][1, u2]cpu"):
        ...
        mul_20: "f32[u0, u1][Max(1, u1), 1]cpu" = torch.ops.aten.mul.Tensor(view, 10);  view = None
        return (mul_20,)""",  # noqa: B950
            ignore_comments=True,
            ignore_empty_lines=True,
        )
    ...
    def test_unbacked_contiguous(self):
        ...
        mul_5: "f32[u0, u1][Max(1, u1), 1]cpu" = torch.ops.aten.mul.Tensor(add_3, 100);  add_3 = None
        ...
        mul_4: "f32[u0, u1][Max(1, u1), 1]cpu" = torch.ops.aten.mul.Tensor(add, 100);  add = None
        return (mul_4,)""",  # noqa: B950
            ignore_comments=True,
            ignore_empty_lines=True,
        )
