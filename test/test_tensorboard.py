...
import torch
# import torch.utils.tensorboard.proto
...
import pytest
import unittest
# import torch.utils.tensorboard.beholder as beholder_lib
# import torch.utils.tensorboard.beholder.file_system_tools as fio
...
class EmbeddingTest(unittest.TestCase):
    def test_embedding(self):
        w = SummaryWriter(tempfile.gettempdir())
...
class FigureTest(unittest.TestCase):
    def test_figure(self):
        writer = SummaryWriter(tempfile.gettempdir())
...
class NumpyTest(unittest.TestCase):
    ...
    def test_numpy_vid_uint8(self):
        ...
        # x2num.make_np(x, 'VID').shape[3] == 3import unittest
import torch
from torch.utils.tensorboard import SummaryWriter
...
#         with SummaryWriter(tempfile.gettempdir()) as w:
...
class PytorchGraphTest(unittest.TestCase):
    def test_pytorch_graph(self):
        ...
        with SummaryWriter(tempfile.gettempdir(), comment='LinearModel') as w:
    ...
    def test_wrong_input_size(self):
        ...
        with self.assertRaises(RuntimeError) as e_info:
            ...
            with SummaryWriter(tempfile.gettempdir(), comment='expect_error') as w:
...
class SummaryWriterTest(unittest.TestCase):
    def test_summary_writer_ctx(self):
        ...
        with SummaryWriter(tempfile.gettempdir(), filename_suffix='.test') as writer:
...
class WriterTest(unittest.TestCase):
    def test_writer(self):
        with SummaryWriter(tempfile.gettempdir()) as writer:
            sample_rate = 44100
