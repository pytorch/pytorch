...
new_module_tests = [
    ...
    dict(
        fullname='Conv3d_channelwise',
        constructor=lambda: nn.Conv3d(4, 4, kernel_size=3, groups=4),
        input_size=(2, 4, 4, 5, 6),
        cudnn=False,
        check_with_long_tensor=True,
    ),
    dict(
        fullname='Conv3d_channelwise_dilated',
        constructor=lambda: nn.Conv3d(4, 4, kernel_size=2, dilation=2),
        input_size=(2, 4, 4, 5, 6),
        cudnn=False,
        check_with_long_tensor=True,
    ),
    dict(
        fullname='Conv3d_channelwise_strided',
        constructor=lambda: nn.Conv3d(4, 4, kernel_size=2, stride=2),
        input_size=(2, 4, 4, 5, 6),
        cudnn=False,
        check_with_long_tensor=True,
    ),
    dict(
        fullname='Conv3d_channelwise_strided_dilated',
        constructor=lambda: nn.Conv3d(4, 4, kernel_size=2, dilation=2, stride=2),
        input_size=(2, 4, 4, 5, 6),
        cudnn=False,
        check_with_long_tensor=True,
    ),
