...
from torch.testing._internal.common_utils import \
    (TestCase, run_tests, TEST_SCIPY, IS_MACOS, IS_WINDOWS, slowTest,
     ...
     skipIfRocmArch, skipIfRocmVersionIn, setBlasBackendsToDefaultFinally, setLinalgBackendsToDefaultFinally, serialTest, skipIfRocm,
...
class TestLinalg(TestCase):
    ...
    @skipCUDAIfNoCusolver
    @skipCPUIfNoLapack
    # rocBLAS trsm large-batch regression; fixed after ROCm 10.0 (rocm-libraries#10503)
    @skipIfRocmVersionIn([(7, 14), (10, 0)])
    @dtypes(*floating_and_complex_types())
    @precisionOverride({torch.float32: 1e-3, torch.complex64: 1e-3,
                        torch.float64: 1e-8, torch.complex128: 1e-8})
