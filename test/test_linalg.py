...
from torch.testing._internal.common_cuda import BF16X9_SUPPORTED, CDNA2OrLater, CDNA5OrLater, IS_SM90, SM80OrLater, SM90OrLater, tf32_enabled, tf32_on_and_off, \
    _get_magma_version, _get_torch_cuda_version, TEST_MULTIGPU, blas_library_context, ROCM_VERSION
from torch.testing._internal.common_gpu import PLATFORM_SUPPORTS_FP8, PLATFORM_SUPPORTS_MX_GEMM
