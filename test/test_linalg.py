...
'''.format(tol, eq_err, eq_err_general, iters1, eq_err_scipy, eq_err_general_scipy, iters2, m, k, niter))
    ...
    @dtypes(*floating_types_and(torch.bfloat16))
    @tf32_on_and_off(0.05)
    def test_addmm_repro_possible_cublas_gelu_bug(self, device, dtype):
        # This test passes if the #ifdef to use the GELU bias epilogue
        # is disabled, but fails with it enabled.
        bias = torch.tensor([
            0.9792,
            -1.5497,
            -1.4769,
        ...
        mat1 = torch.tensor([
            1.3823, -1.3639,  1.4200,  0.4929, -1.5050, -1.4505, -1.3012, -0.1286,
            1.2077, -0.0709,  0.1329,  0.9212, -0.6697, -1.6641, -2.3635,  0.6918,
            1.1302,  0.7918,  1.6842,  2.6914, -0.7346, -1.3768, -0.5934, -1.1742,
            0.9110, -0.3267,  2.5872,  1.9408, -1.1110, -1.4197, -1.6170, -1.2221,
            1.2868,  0.2790,  2.1798,  2.5551, -0.9228, -1.5063, -1.7770, -0.7635,
            1.1717,  0.0635,  0.5071,  1.5369, -0.3351, -1.6895, -3.6997, -0.2716,
            1.0301, -0.5948,  1.8221,  0.7481, -1.3746, -1.4326, -0.1530, -0.0733,
            1.4095, -0.9677,  2.2628,  1.9212, -0.8621, -1.5419, -1.8570, -0.1906,
            1.0736,  0.1303,  1.6381,  1.3964, -1.2605, -1.4010,  0.2316, -0.1955,
            1.9689,  0.4325, -0.8178,  0.6939,  0.7593, -1.7340, -2.4097, -1.2778,
            0.4309, -0.3447,  2.2515,  1.6271, -1.1030, -1.3766, -0.9623, -0.6126,
            1.3695, -0.1105,  2.0452,  0.0115, -1.3007, -1.4227,  0.3144, -1.7494,
            0.7768, -1.4582,  1.3395,  0.2831, -1.3261, -1.4072, -1.1089,  0.0167,
            1.9013,  1.3156,  1.7492,  1.9640, -0.8119, -1.5644, -1.4675, -2.0496,
            1.9224,  0.5679, -1.5971,  0.5698,  0.9472, -1.6726, -2.7341, -1.8782,
            0.7896,  1.2770, -0.8521,  0.8345, -0.1404, -1.6508, -1.4782,  0.4983,
            1.8131,  1.4105, -1.6499,  1.2822,  0.3822, -1.5618, -3.2220, -2.5343,
            2.0078,  0.7820,  0.7522,  0.6847, -1.0304, -1.6639, -1.0173, -0.4359,
            0.6550, -0.8964,  1.6139,  0.3503, -1.1598, -1.4129,  0.0160,  0.0978,
            1.9069,  1.2797,  0.5966,  2.3077, -1.0873, -1.5464, -2.4120, -1.1471,
            2.0480,  1.9220,  0.1757,  1.2806,  0.4012, -1.6410, -0.7551, -2.3824,
            1.7300,  1.5651,  0.1630,  1.6338, -0.0075, -1.3761, -0.7499, -3.4137,
            1.9393,  1.5059,  0.5413,  1.4288, -1.0518, -1.6267, -1.6512, -0.9269,
            1.5247,  0.5469,  1.4450,  1.5663, -1.4359, -1.3586, -0.3819, -1.4396,
            1.4474,  0.5915,  1.5433,  1.1813, -1.1661, -1.6095, -0.8338, -0.0289,
            0.7761,  0.0273,  1.8650,  0.6585, -1.0968, -1.5456, -0.1409,  0.2763,
            2.0726,  1.5890, -1.0602,  1.0222,  0.5597, -1.6087, -2.1729, -2.8044,
            1.9056,  1.8065,  1.0627,  1.4742, -0.3171, -1.4743,  0.2075, -2.7368,
            0.7084, -0.4247,  1.7286,  0.6144, -1.2266, -1.4108,  0.2311, -0.0384,
            1.8620,  1.6980, -0.7573,  1.8219,  0.2394, -1.4630, -2.2529, -3.2298,
            1.0714, -0.3433,  2.0077,  0.9399, -1.4224, -1.4461, -0.2873, -0.2404,
            1.5618,  1.1989, -0.0914,  1.5106, -0.0937, -1.3095, -0.7619, -3.3176,
            2.3776, -0.4649,  1.1493,  0.9955, -1.0634, -1.6274, -2.9555, -1.4471,
            1.6617, -1.6800,  2.4838,  1.6128,  0.4322, -1.4761, -2.0195, -2.7806,
            1.6488, -0.5040,  1.9422,  2.8659,  0.3377, -1.5600, -2.9650, -1.8815,
            1.5497,  1.4457,  1.9420,  1.8966, -0.2177, -1.4830, -0.4789, -2.8719,
            2.2443, -1.3016,  0.5319,  1.8140, -0.8871, -1.5422, -2.9293, -0.1569,
            1.1451,  0.7530,  2.2904,  2.0330, -0.3549, -1.5327, -2.6601, -2.8090,
            1.5637,  0.8825,  1.7845,  1.6856, -0.1394, -1.4795, -1.9670, -3.6381,
            1.1505,  0.0381,  1.2294,  0.3571,  0.6899, -1.3827, -0.3191, -4.0176,
            1.5780,  0.0461,  1.2624,  0.8326, -1.7213, -1.4790, -0.6860, -0.2301,
            1.3447,  0.3854, -0.1324,  0.0463,  0.6085, -1.3431, -0.1347, -3.8304,
            1.4006, -1.3394,  2.1449,  1.9590, -0.5380, -1.5710, -2.6393, -0.3769,
            1.1425, -0.2528,  1.8158,  1.0044, -1.4692, -1.5333, -1.2558,  0.0543,
            2.6656, -0.4937,  1.9720,  1.6664, -0.3652, -1.5007, -1.2192, -2.7414,
            1.4208,  1.5453,  1.3053,  2.4152, -0.3110, -1.4163,  0.4245, -1.6042,
            1.4851, -1.1864,  1.9909,  2.1728, -0.4494, -1.5795, -2.6015, -0.2741,
            2.0711, -0.8318,  1.0838,  0.4081, -0.1080, -1.4701, -2.6821, -3.8916,
            2.3693,  0.7852, -0.2665,  2.7048,  1.0403, -1.5604, -0.3803, -1.1889,
            1.7359,  0.9164,  0.5823,  2.5687,  0.3492, -1.3456,  0.6303, -1.9830,
            2.0686,  0.4069, -0.3383,  2.4655,  0.5919, -1.6591, -2.1819, -0.3795,
            2.0501,  0.8462,  0.5194,  3.1793,  0.1639, -1.4289, -0.1699, -1.1200,
            1.2814,  0.5714,  1.3450,  0.9678, -1.1997, -1.3232,  0.3783, -1.7972,
            1.8805,  0.9031,  0.5854,  0.3763, -1.0881, -1.3915,  1.0909, -1.6842,
            1.8977,  0.6102,  1.0047,  2.9170,  0.0937, -1.3768,  0.3292, -1.4786,
            1.2137,  0.7985,  0.9864,  0.6699, -1.0286, -1.3122,  0.5703, -2.1094,
            1.4926,  1.7158, -0.1825,  0.0504, -0.6460, -1.3973,  0.4108, -2.6698,
            2.5352,  0.9374,  1.2990,  2.3044, -0.1309, -1.5872, -0.5561, -1.6799,
            0.7833,  0.0005,  1.5988,  0.2004, -1.7009, -1.4398, -0.6482, -0.5757,
            1.6870, -0.4905,  0.0582,  2.2115,  0.1871, -1.5386, -0.3114,  1.0216,
            0.6832,  0.0297,  1.5130,  0.6530, -1.1196, -1.3179,  0.5493, -1.0590,
            1.1347,  0.1106,  0.6034,  2.1367,  0.0618, -1.3220,  1.2517, -0.3440,
            1.5650, -0.0031,  0.0666,  2.0581,  0.1402, -1.2879,  1.1521, -0.8600,
            1.4488,  1.0169, -0.4640, -0.7683, -0.9674, -1.3931,  0.2433, -2.2551,
            1.1339, -0.2960,  1.2671,  1.6728, -0.5371, -1.3342,  1.0651, -0.2448,
            1.0664, -0.5835, -1.1089, -0.7242, -0.0849, -1.2924, -1.4109, -2.9916,
            0.2770, -0.9920,  0.2700, -0.7182,  0.4408, -1.2891, -0.1676, -2.7002,
            1.8328,  0.0987,  1.1468,  0.7768, -0.9557, -1.5547,  0.6530,  0.2039,
            1.0824,  0.7548,  0.5709,  1.2093, -0.0165, -1.2709, -0.0127, -3.1563,
            0.4960, -2.0787,  0.6487, -0.5328, -0.8463, -1.3490, -2.3606, -1.3761,
            1.7662, -0.3298,  1.6062,  1.7438, -0.4682, -1.3489,  1.1542, -1.0759,
            1.4738, -0.2784,  1.0989,  0.4295, -0.4096, -1.5423,  1.3906,  0.3918,
            2.0379, -0.3405,  1.3370,  2.2025, -0.7480, -1.3902,  0.3533, -0.4878,
            1.5137, -2.6805,  0.3495,  1.5989, -0.0980, -1.3953, -2.9885, -0.5483,
            1.0843, -1.3777,  0.1512, -0.4923,  0.0374, -1.6630, -1.3808,  0.4501,
            0.8607, -1.4404, -1.0157, -0.9525, -0.3049, -1.3033, -1.8481, -2.1491,
            1.2105, -1.2088, -1.7772, -0.9190,  0.6441, -1.5921, -3.0905, -1.3167,
            1.1288, -1.8636,  0.6566,  0.6820, -1.2571, -1.4294, -2.5929,  0.0579,
            1.5536, -0.2067, -1.3614, -0.5031, -0.1105, -1.2980, -0.7138, -2.8880,
            1.1445, -1.5251,  0.8198, -0.4048, -0.8895, -1.5272, -0.5432,  0.4671,
            1.6371,  1.1517,  0.8386,  2.0022,  0.3765, -1.3675,  1.0675, -2.3936,
            1.5051,  1.1473, -2.1966,  0.1506, -0.0456, -1.3545, -1.0444, -2.4937,
            1.6377, -0.7787,  0.3888,  1.8277, -1.0126, -1.4635, -1.2203,  0.8225,
            1.6157,  1.7312,  0.7855,  2.2049, -0.1715, -1.4139,  0.7140, -1.7564,
            1.4186,  1.0630,  0.6141,  1.5131,  0.2185, -1.3312,  1.4522, -2.2165,
            1.5905,  1.7206, -1.5094,  0.9335,  0.3396, -1.3836, -0.7634, -2.9871,
            1.6149,  0.4732,  0.5251,  2.5228, -0.7849, -1.5078, -1.0399,  0.4898,
            1.9722,  0.8586,  0.9822,  1.7231,  0.1209, -1.3674,  1.0390, -2.6066,
            1.7130,  0.2935,  0.5405,  2.6136, -0.9048, -1.4986, -1.5553,  0.3131,
            1.5227,  0.7974,  1.6079,  1.9129, -1.1410, -1.4969, -0.1534, -0.3042,
            1.6193,  0.0265,  2.2726,  1.9662, -0.9312, -1.5933, -1.9090, -0.8034,
            1.6051, -0.3549,  1.5465,  2.0858, -0.9729, -1.5104, -0.8538,  0.3541,
            1.6199,  1.4030,  0.8283,  2.1020,  0.0415, -1.3691,  0.7972, -2.2524,
            1.5541,  0.8304, -0.9061,  1.1543,  0.4335, -1.2831,  0.4896, -2.6130,
            1.8347,  0.4114,  0.0304,  2.7355, -0.7436, -1.4565, -1.2112,  0.2542,
            1.3155,  1.3256,  0.7504,  1.2264,  0.0843, -1.3913,  1.9355, -1.6282,
            0.6069, -1.1006,  1.8488,  1.0922, -1.0260, -1.3591, -0.4414, -0.1582,
            1.8536,  0.6632,  0.7708,  0.3314, -0.1794, -1.4419,  2.2244, -1.4822,
            1.9391,  0.5455,  0.0107,  0.2460,  0.4205, -1.5171,  2.2645, -0.8693,
            1.2257,  0.5957,  1.2618,  0.5045, -0.6941, -1.3744,  1.7472, -1.2915,
            1.2605, -0.5136,  0.1925,  0.3011,  0.7878, -1.3469,  2.2191, -1.3614,
            1.2954, -0.9328, -0.0661,  0.7937,  0.4795, -1.2340,  0.7620, -2.0623,
            0.8512, -0.8284,  0.0314, -0.3593,  0.2602, -1.3156,  1.7058, -1.0912,
            2.1054,  1.1541,  0.9956,  1.1894, -0.2574, -1.5331,  1.5601, -1.0619,
            1.2099,  1.2715,  1.3110,  0.7386, -1.5321, -1.4271, -0.1147, -1.4760,
            1.9399,  0.8300,  1.5030,  2.5314, -0.2481, -1.5495,  0.1161, -0.5536,
            1.3264, -1.1843,  0.7716,  0.3259,  0.1033, -1.4299,  1.7908,  0.1327,
            1.2600,  1.1480,  1.3588,  0.9015, -0.7326, -1.4082,  1.5057, -1.3428,
            1.1550,  0.8561,  1.2439,  0.3881, -1.7374, -1.4071, -0.6447, -1.6215,
            1.7221, -0.1389,  0.6328,  0.6569, -0.2974, -1.5150,  1.6435,  0.3743,
            0.6458, -0.8859,  1.3462, -0.1328, -0.9163, -1.3448,  0.7033, -0.6484,
            0.8708, -0.6023,  1.1945,  0.0552, -0.4475, -1.3541,  1.6917, -0.6623,
            1.8427,  0.3667,  1.5242,  1.9757, -0.6521, -1.6127, -0.6710,  0.0200,
            1.6611,  0.4187, -1.2533,  0.8334,  0.8141, -1.3031,  0.7179, -2.4799,
            1.6540,  0.1775,  1.5319,  1.8291, -0.8005, -1.5469,  0.0088,  0.3039,
            0.7604, -0.0367,  0.5657,  0.1940, -1.6598, -1.4473, -0.9063,  0.2462,
            1.1980,  0.2356, -2.5672, -0.0061, -0.6273, -1.4178, -2.9667, -1.0738,
            1.6551,  0.4536,  0.2532,  2.7961,  1.2043, -1.4041,  0.7193, -1.3731,
            1.5179, -0.6876,  1.5773,  3.1312,  0.6993, -1.5098, -0.7666, -0.3167,
            1.5910,  0.2137,  1.6235,  2.0851, -0.4006, -1.4356,  1.1191, -0.3093,
            2.6781,  0.2506,  0.1772,  2.4138, -0.2218, -1.4271,  0.4657, -0.8018,
            0.8211, -0.2118, -0.4066, -0.8078, -0.7324, -1.3822,  0.9733, -0.2834,
            1.4726,  0.3271,  2.0835,  0.9721, -1.1968, -1.5208,  0.3147, -0.5110,
            1.8729,  0.6425, -1.3511,  0.6566,  1.0154, -1.4443, -1.7598, -3.6983,
            1.3341,  0.5758,  1.1064,  2.2515, -0.8152, -1.4762, -0.0668,  0.3603,
            1.5364,  0.6187, -2.4560,  0.3824,  0.3732, -1.3286, -0.9341, -2.2751,
            0.8930, -0.0437,  0.0757, -0.4327, -1.5269, -1.4276, -0.2884, -0.0166,
            1.2839, -1.2283, -0.2849, -0.8090, -0.9513, -1.4367, -0.0482,  0.1318,
            1.4525, -0.2782,  0.4224,  1.7067, -0.9187, -1.3949,  0.1781,  0.6146,
            1.5435, -0.3114,  0.5879,  3.0748,  0.7925, -1.4796, -3.5893, -2.3718,
            1.1897, -0.2336,  1.5554,  2.7099, -0.8546, -1.4690, -1.8614,  0.0444,
            1.3464, -1.1594,  1.5443,  2.3520, -0.6475, -1.5139, -2.3315,  0.2454,
            1.3033, -0.3557,  1.4433,  2.3584, -0.8042, -1.4535, -0.6530,  0.4377,
            1.3002, -0.8132,  0.7886,  3.0990,  0.7033, -1.4649, -3.7684, -1.9119,
            1.0411, -0.2992,  1.4719,  2.8649, -0.5408, -1.4473, -1.3944,  0.2309,
            1.1159, -0.2517,  1.5304,  2.3046, -1.0715, -1.4303, -1.1403,  0.1851,
            1.9043, -0.1250,  0.7941,  2.1049, -0.5569, -1.4780,  0.3734,  0.5000,
            1.6565, -0.8342, -2.1257, -1.1297, -0.2642, -1.4168, -1.8759, -1.7979,
            1.5889, -0.7889, -0.5781,  2.0009,  1.3539, -1.6207, -3.8245, -1.4823,
            1.0364, -0.9981, -1.4502, -1.2461,  0.3513, -1.4050, -2.3208, -2.8756,
            0.8921,  0.1000,  1.7005,  2.6333, -0.9183, -1.4611, -1.8039, -0.0883,
            1.1199, -0.7044,  1.5802,  2.7114, -0.6507, -1.4708, -2.1038,  0.1402,
            1.6173,  0.4573,  0.2522,  3.5349,  0.5923, -1.4967, -1.5308, -0.4999,
            1.2404, -0.5195,  1.0462,  3.2712,  0.4818, -1.4528, -3.5140, -1.8305,
            1.4770,  0.3085, -0.9863, -0.7684,  0.2095, -1.5392, -2.9293, -3.5191,
            0.9456, -2.0565,  0.4261,  1.7017,  0.6428, -1.4983, -1.2632,  0.8859,
            1.8106, -0.3542,  1.1319,  0.5241, -1.5693, -1.5352, -3.3594, -1.9031,
            0.6837, -1.0654,  1.4963,  0.9644, -1.0284, -1.5093, -1.3890,  0.7245,
            2.3513, -0.0116,  0.0787,  2.3231,  0.6964, -1.6712, -2.6437, -1.1820,
            0.5798, -1.6501,  1.2697,  0.0796, -0.9286, -1.4469, -0.7757,  0.4192,
            1.8438, -0.5259,  1.2081,  1.3482, -0.8225, -1.6616, -3.1163, -0.5372,
            1.7905, -0.3746,  1.6405,  1.4133, -1.5456, -1.5359, -2.4393, -0.7679,
            2.2948,  0.7463,  0.1666,  1.8213,  0.3135, -1.5984, -3.1503, -3.0426,
            2.3355, -0.0834,  0.6950,  3.0342,  0.7454, -1.5791, -2.3367, -1.6951,
            1.9764,  0.3457,  0.2639,  2.8771,  1.0740, -1.6279, -2.2506, -1.3321,
            1.8279,  1.3134,  0.2459,  1.9365, -1.1068, -1.5629, -1.3737, -0.1931,
            2.3645, -0.0423,  0.8196,  2.8026,  0.3511, -1.6212, -2.5453, -1.3295,
            1.3399,  0.5612, -0.4135, -0.5662,  0.7295, -1.5422, -2.0349, -3.9095,
            2.1252,  1.1450, -0.3858,  2.1524, -0.8418, -1.5769, -2.6068, -0.7036,
            2.7859,  0.1571,  1.3746,  2.1612,  0.1874, -1.6059, -0.4825, -1.6051,
        ], device=device, dtype=dtype).reshape(160, 8)
        mat2 = torch.tensor([
            -0.7605,  0.3892, -0.2332,  0.1120, -0.9583,  2.2130,  0.2342, -0.3879, -0.5687,  1.4026, -0.5618, -0.2521, -0.2458,  1.2886, -0.3907, -0.2452,
            0.5663, -0.2740,  0.0997, -0.7308,  0.0374,  1.4162,  2.4705, -0.2424,  0.4712, -0.6053, -0.2968,  1.6477,  0.7054, -0.0432, -0.4007, -0.5039,
            1.5255, -0.3192, -1.2957,  1.0588, -0.2779,  0.1120, -2.1838,  0.3125,  1.0741,  0.4005, -1.2178, -0.1272, -0.1252,  0.7057,  0.0105, -0.5847,
            -0.3302, -0.5496,  0.2371, -1.2182,  0.6128,  1.6738, -0.4116, -2.6342, -0.5047,  0.4555,  0.4409,  1.4670, -0.6683, -0.3913, -0.0195, -0.8645,
            0.8774, -0.3078, -0.2793, -0.2552,  0.6209, -0.0540, -0.0740, -0.8900, -1.3758, -0.1428, -0.0050, -0.8950,  0.4793,  1.1070, -0.9087, -0.1804,
            1.6239, -0.4982, -1.3548,  0.3321, -0.0409,  0.5736,  0.5101,  0.4525,  0.5054,  0.0038,  1.6674, -0.1442, -1.0291,  0.2819,  0.5571,  0.0569,
            0.4283,  0.5344,  1.6941, -0.8386,  0.3573, -0.1761,  2.1533,  0.3615,  0.0727, -0.1051,  1.3064, -0.3554, -1.4283,  0.3616, -0.2448,  1.1947,
            0.0372, -0.8136,  0.4216, -1.6225,  0.5827,  0.9129,  0.7352,  0.8711,  0.0930,  0.1138,  0.9339,  0.3055, -1.0836,  0.6020,  0.6206, -0.3837
            ], device=device, dtype=dtype).reshape(8, 16)
        with_gelu_result = torch._addmm_activation(bias, mat1, mat2, use_gelu=True)
        addmm_result = torch.nn.functional.gelu(torch.addmm(bias, mat1, mat2))
        torch.testing.assert_close(with_gelu_result, addmm_result)
