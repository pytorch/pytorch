...
all_operators_with_namedtuple_return = {
    ...
    'frexp', 'lu_unpack', 'histogram', 'fake_quantize_per_tensor_affine_cachemask_tensor_qparams'
}
...
class TestNamedTupleAPI(TestCase):
    ...
    def test_namedtuple_return(self):
        ...
        operators = [
            ...
            op(operators=['fake_quantize_per_tensor_affine_cachemask_tensor_qparams'],
