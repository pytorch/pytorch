...
class TestNamedTupleAPI(TestCase):
        ...
        for f in yaml.safe_load(file.read()):
            ...
            for r in ret:
                ...
                self.assertEqual(
                    len(r.split()),
                    1,
                    "only allowlisted operators are allowed to have named return type, got "
                    + name,
                )
        file.close()
        self.assertEqual(
    ...
    def test_namedtuple_return(self):
        ...
        operators = [
            ...
            op(
                operators=["_det_lu_based_helper"],
                input=(),
                names=("det", "lu", "pivs"),
                hasout=False,
            ),
