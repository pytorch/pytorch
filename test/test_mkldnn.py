...
from torch.testing._internal.common_utils import TestCase, \
    ...
    expectedIfCppFakeTensor, skipIfTorchDynamo, xfailIfTorchDynamo, \
    recover_orig_fp32_precision, parametrize, instantiate_parametrized_tests, \
...
class TestMkldnn(TestCase):
    ...
    def test_sparse_to_dense_torch_func_vjp(self):
        root = torch.randn(4, 5, dtype=torch.float32).to_sparse()
