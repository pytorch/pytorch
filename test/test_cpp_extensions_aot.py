...
class TestCppExtensionAOTGeneric(common.TestCase):
    """Tests ahead-of-time cpp extensions (CPU-only / device-agnostic)
...
class TestCppExtensionAOTCUDA(common.TestCase):
    """Tests ahead-of-time cpp extensions requiring CUDA."""
...
class TestCppExtensionAOTMPS(common.TestCase):
    """Tests ahead-of-time cpp extensions requiring MPS."""
...
class TestCppExtensionAOTXPU(common.TestCase):
    """Tests ahead-of-time cpp extensions requiring XPU."""
