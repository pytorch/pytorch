...
WINDOWS_BLOCKLIST = [
    ...
    "distributed/_shard/sharded_tensor/_ops/test_embedding",
    "distributed/_shard/sharded_tensor/_ops/test_embedding_bag",
    "distributed/_shard/sharded_tensor/_ops/test_binary_cmp",
    "distributed/_shard/sharded_tensor/_ops/test_init",
    "distributed/_shard/sharded_tensor/_ops/test_linear",
