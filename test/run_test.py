...
WINDOWS_BLOCKLIST = [
    ...
    "distributed/shard/sharded_tensor/_ops/test_embedding",
    "distributed/shard/sharded_tensor/_ops/test_embedding_bag",
    "distributed/shard/sharded_tensor/_ops/test_binary_cmp",
    "distributed/shard/sharded_tensor/_ops/test_init",
    "distributed/shard/sharded_tensor/_ops/test_linear",
    "distributed/shard/sharded_optim/test_sharded_optim",
