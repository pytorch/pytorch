...
if TEST_WITH_ROCM:
    ...
    if "gfx12" in gcn_arch:
        NAVI_BLOCKLIST = [
            ...
            "inductor/test_aot_inductor_package.py",
            "inductor/test_aot_inductor_utils.py",
            "inductor/test_auto_functionalize.py",
            "inductor/test_autoheuristic.py",
            "inductor/test_b2b_gemm.py",
            "inductor/test_benchmark_fusion.py",
            "inductor/test_benchmarking.py",
            "inductor/test_binary_folding.py",
            "inductor/test_ck_backend.py",
            "inductor/test_codecache.py",
            "inductor/test_codegen_triton.py",
            "inductor/test_combo_kernels.py",
            "inductor/test_compile_worker.py",
            "inductor/test_compiled_autograd.py",
            "inductor/test_compiled_optimizers.py",
            "inductor/test_config.py",
            "inductor/test_control_flow.py",
            "inductor/test_coordinate_descent_tuner.py",
            "inductor/test_cpp_wrapper_hipify.py",
            "inductor/test_cpu_cpp_wrapper.py",
            "inductor/test_cpu_repro.py",
            "inductor/test_cpu_select_algorithm.py",
            ...
            "inductor/test_custom_lowering.py",
            "inductor/test_custom_post_grad_passes.py",
            "inductor/test_cutlass_backend.py",
            "inductor/test_debug_trace.py",
            "inductor/test_decompose_mem_bound_mm.py",
            "inductor/test_dependencies.py",
            "inductor/test_distributed_patterns.py",
            "inductor/test_efficient_conv_bn_eval.py",
            "inductor/test_extension_backend.py",
            "inductor/test_flex_attention.py",
            "inductor/test_flex_decoding.py",
            "inductor/test_foreach.py",
            "inductor/test_fp8.py",
            "inductor/test_fused_attention.py",
            "inductor/test_fx_fusion.py",
            "inductor/test_graph_transform_observer.py",
            "inductor/test_group_batch_fusion.py",
            "inductor/test_halide.py",
            "inductor/test_indexing.py",
            "inductor/test_inductor_freezing.py",
            ...
            "inductor/test_utils.py",
            "inductor/test_xpu_basic.py",
        ]
