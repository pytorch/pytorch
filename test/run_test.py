...
WINDOWS_BLOCKLIST = [
    ...
    "distributed/elastic/agent/server/test/api_test",
    "distributed/elastic/multiprocessing/api_test",
    "distributed/_sharded_tensor/test_megatron_prototype",
    "distributed/_sharded_tensor/test_sharded_tensor",
    "distributed/_sharded_tensor/test_sharded_tensor_reshard",
    "distributed/_sharded_tensor/test_partial_tensor",
    "distributed/_sharded_tensor/ops/test_elementwise_ops",
