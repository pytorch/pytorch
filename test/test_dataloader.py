...
from torch.testlib.common_utils import (TestCase, run_tests, TEST_NUMPY, IS_WINDOWS, PY3,
...
# We cannot import TEST_CUDA from torch.testlib.common_cuda here, because if we do that,
# the TEST_CUDNN line from torch.testlib.common_cuda will be executed multiple times
