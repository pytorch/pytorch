...
class TestFakeQuantizePerTensorAffine(TestCase):
    ...
    def test_forward(self, device, X):
        ...
        self.assertAlmostEqual(Y, Y_prime.cpu(), delta=tolerance)
    ...
    def test_backward(self, device, X):
        ...
        self.assertAlmostEqual(dX.cpu(), X.grad.cpu().detach().numpy(), delta=tolerance)
    ...
    def test_fq_module(self, device, X):
        ...
        self.assertAlmostEqual(Y.cpu().detach().numpy(), Y_prime.cpu().detach().numpy(), delta=tolerance)
