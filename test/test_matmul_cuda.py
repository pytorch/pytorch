...
if TEST_CUDA:
    ...
    _IS_SM12X = torch.cuda.get_device_capability(0)[0] == 12
...
class TestFP8Matmul(TestCase):
    ...
    @unittest.expectedFailure(not SM89OrLater or _IS_SM12X, "rowwise implementation is currently sm89-sm100 specific")
