...
def forward(self, arg0):
    view_copy = torch.ops.aten.view_copy.default(arg0, [1, 1024, 128, 128]);  arg0 = None
...
def forward(self, arg0):
    ...
    view_copy = torch.ops.aten.view_copy.default(arg0, [4, 2])
    ...
    copy_ = torch.ops.aten.copy_.default(arg0, view_copy_1);  arg0 = view_copy_1 = None
    return view_copy_2
    """)
...
def forward(self, arg0):
    ones = torch.ops.aten.ones.default([4, 2], device = device(type='cpu'), pin_memory = False)
    view = torch.ops.aten.view.default(arg0, [4, 2])
    ...
    copy_ = torch.ops.aten.copy_.default(arg0, view_1);  arg0 = view_1 = None
    return view_2
    """)
...
def forward(self, arg0):
    ones = torch.ops.aten.ones.default([4, 2], device = device(type='cpu'), pin_memory = False)
    view_copy = torch.ops.aten.view_copy.default(arg0, [4, 2]);  arg0 = None
...
def forward(self, arg0):
    ones = torch.ops.aten.ones.default([4, 2], device = device(type='cpu'), pin_memory = False)
    view = torch.ops.aten.view.default(arg0, [4, 2]);  arg0 = None
    empty = torch.ops.aten.empty.memory_format([], device = device(type='cpu'), pin_memory = False)
    add = torch.ops.aten.add.Tensor(view, ones);  view = ones = None
    mul = torch.ops.aten.mul.Tensor(add, add);  add = None
    return mul
...
def forward(self, arg0):
    ...
    aminmax = torch.ops.aten.aminmax.default(arg0, dim = 0);  arg0 = None
    getitem = aminmax[0]
...
def forward(self, arg0):
    ones = torch.ops.aten.ones.default([4, 2], device = device(type='cpu'), pin_memory = False)
    view_copy = torch.ops.aten.view_copy.default(arg0, [4, 2])
    add = torch.ops.aten.add.Tensor(arg0, ones);  ones = None
    copy_ = torch.ops.aten.copy_.default(arg0, add);  arg0 = None
    view_copy_1 = torch.ops.aten.view_copy.default(add, [4, 2]);  add = None
    return view_copy_1
    """)
...
def forward(self, arg0):
    _fused_moving_avg_obs_fq_helper_functional = torch.ops.aten._fused_moving_avg_obs_fq_helper_functional.default(arg0, arg0, arg0, arg0, arg0, arg0, arg0, 1.0, 0, 1, 0)
    ...
    copy_ = torch.ops.aten.copy_.default(arg0, getitem_5);  arg0 = getitem_5 = None
...
def forward(self, arg0):
    as_strided_copy = torch.ops.aten.as_strided_copy.default(arg0, [2], [2], 1)
    add = torch.ops.aten.add.Tensor(as_strided_copy, 1);  as_strided_copy = None
    as_strided_scatter = torch.ops.aten.as_strided_scatter.default(arg0, add, [2], [2], 1);  add = None
    as_strided_copy_1 = torch.ops.aten.as_strided_copy.default(as_strided_scatter, [2], [2], 1)
    copy_ = torch.ops.aten.copy_.default(arg0, as_strided_scatter);  arg0 = None
...
def forward(self, arg0):
    block_diag = torch.ops.aten.block_diag.default([arg0, arg0]);  arg0 = None
    return block_diag
    """)
...
def forward(self, arg0):
    ...
    cat = torch.ops.aten.cat.default([arg0]);  arg0 = None
    return cat
    """)
...
def forward(self, arg0):
    ...
    clone = torch.ops.aten.clone.default(arg0)
    ...
    mul = torch.ops.aten.mul.Tensor(arg0, arg0);  arg0 = None
    return mul
    """)
...
def forward(self, arg0):
    ones = torch.ops.aten.ones.default([2], device = device(type='cpu'), pin_memory = False)
    diagonal_copy = torch.ops.aten.diagonal_copy.default(arg0)
    add = torch.ops.aten.add.Tensor(diagonal_copy, ones);  diagonal_copy = ones = None
    diagonal_scatter = torch.ops.aten.diagonal_scatter.default(arg0, add);  add = None
    diagonal_copy_1 = torch.ops.aten.diagonal_copy.default(diagonal_scatter)
    copy_ = torch.ops.aten.copy_.default(arg0, diagonal_scatter);  arg0 = None
...
def forward(self, arg0):
    ones = torch.ops.aten.ones.default([2], device = device(type='cpu'), pin_memory = False)
    split_copy = torch.ops.aten.split_copy.Tensor(arg0, 2)
    ...
    add = torch.ops.aten.add.Tensor(diagonal_copy, ones);  diagonal_copy = ones = None
    split_copy_1 = torch.ops.aten.split_copy.Tensor(arg0, 2)
    ...
    slice_scatter = torch.ops.aten.slice_scatter.default(arg0, diagonal_scatter, 0, 2, 4);  diagonal_scatter = None
    ...
    copy_ = torch.ops.aten.copy_.default(arg0, slice_scatter);  arg0 = slice_scatter = None
...
def forward(self, arg0):
    ...
    transpose_copy = torch.ops.aten.transpose_copy.int(arg0, 1, 0)
    ...
    transpose_copy_1 = torch.ops.aten.transpose_copy.int(arg0, 1, 0);  arg0 = None
...
def forward(self, arg0):
    view_copy = torch.ops.aten.view_copy.default(arg0, [8])
...
def forward(self, arg0):
    clone = torch.ops.aten.clone.default(arg0);  arg0 = None
...
def forward(self, arg0):
    ...
    add = torch.ops.aten.add.Tensor(arg0, arg0);  arg0 = None
...
def forward(self, arg0):
    ...
    copy = torch.ops.aten.copy.default(diagonal_copy, arg0);  diagonal_copy = None
    diagonal_scatter = torch.ops.aten.diagonal_scatter.default(zeros, copy);  zeros = copy = None
    diagonal_copy_1 = torch.ops.aten.diagonal_copy.default(diagonal_scatter)
    add = torch.ops.aten.add.Tensor(diagonal_copy_1, arg0);  diagonal_copy_1 = arg0 = None
...
def forward(self, arg0):
    ...
    copy = torch.ops.aten.copy_.default(diagonal, arg0);  diagonal = None
    diagonal_1 = torch.ops.aten.diagonal.default(zeros)
    add = torch.ops.aten.add_.Tensor(diagonal_1, arg0);  diagonal_1 = arg0 = None
...
def forward(self, arg0):
    expand_copy = torch.ops.aten.expand_copy.default(arg0, [2, 2]);  arg0 = None
    return expand_copy
    """)
...
def forward(self, arg0):
    add = torch.ops.aten.add.Tensor(arg0, 1);  arg0 = None
...
def forward(self, arg0, arg1, arg2):
    repeat = torch.ops.aten.repeat.default(arg1, [20])
    repeat_1 = torch.ops.aten.repeat.default(arg2, [20])
    view_copy = torch.ops.aten.view_copy.default(arg0, [1, 2000, 35, 45]);  arg0 = None
    ...
    alias_copy = torch.ops.aten.alias_copy.default(arg1)
    ...
    alias_copy_3 = torch.ops.aten.alias_copy.default(arg2)
    ...
    copy_ = torch.ops.aten.copy_.default(arg1, alias_copy_1);  arg1 = alias_copy_1 = None
    copy__1 = torch.ops.aten.copy_.default(arg2, alias_copy_4);  arg2 = alias_copy_4 = None
    return view_copy_5
    """)  # noqa: B950
...
def forward(self, arg0, arg1, arg2):
    repeat = torch.ops.aten.repeat.default(arg1, [20])
    repeat_1 = torch.ops.aten.repeat.default(arg2, [20])
    view = torch.ops.aten.view.default(arg0, [1, 2000, 35, 45]);  arg0 = None
    empty = torch.ops.aten.empty.memory_format([0], dtype = torch.uint8, layout = torch.strided, device = device(type='cpu'))
    ...
    getitem_3 = _native_batch_norm_legit_functional[3]
    getitem_4 = _native_batch_norm_legit_functional[4];  _native_batch_norm_legit_functional = None
    alias = torch.ops.aten.alias.default(arg1)
    ...
    alias_3 = torch.ops.aten.alias.default(arg2)
    ...
    copy_ = torch.ops.aten.copy_.default(arg1, alias_1);  arg1 = alias_1 = None
    copy__1 = torch.ops.aten.copy_.default(arg2, alias_4);  arg2 = alias_4 = None
    return view_5
    """)  # noqa: B950
...
def forward(self, arg0, arg1, arg2):
    empty = torch.ops.aten.empty.memory_format([0], dtype = torch.uint8, layout = torch.strided, device = device(type='cpu'))
    _native_batch_norm_legit_functional = torch.ops.aten._native_batch_norm_legit_functional.default(arg0, None, None, arg1, arg2, False, 0.1, 1e-05);  arg0 = None
    getitem = _native_batch_norm_legit_functional[0]
    getitem_1 = _native_batch_norm_legit_functional[1]
    getitem_2 = _native_batch_norm_legit_functional[2]
    getitem_3 = _native_batch_norm_legit_functional[3]
    getitem_4 = _native_batch_norm_legit_functional[4];  _native_batch_norm_legit_functional = None
    copy_ = torch.ops.aten.copy_.default(arg1, getitem_3);  arg1 = getitem_3 = None
    copy__1 = torch.ops.aten.copy_.default(arg2, getitem_4);  arg2 = getitem_4 = None
    return getitem
    """)  # noqa: B950
