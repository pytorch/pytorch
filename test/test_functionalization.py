...
def forward(self, a_1):
    ones = torch.ops.aten.ones.memory_format([4, 2], device = device(type='cpu'), pin_memory = False)
...
def forward(self, a_1):
    ones = torch.ops.aten.ones.memory_format([2], device = device(type='cpu'), pin_memory = False)
...
def forward(self, a_1):
    ones = torch.ops.aten.ones.memory_format([4], device = device(type='cpu'), pin_memory = False)
...
def forward(self, a_1):
    ones = torch.ops.aten.ones.memory_format([2, 2], device = device(type='cpu'), pin_memory = False)
...
def forward(self, a_1):
    zeros = torch.ops.aten.zeros.memory_format([2, 2], device = device(type='cpu'), pin_memory = False)
...
def forward(self, a_1):
    zeros = torch.ops.aten.zeros.memory_format([10], device = device(type='cpu'), pin_memory = False)
