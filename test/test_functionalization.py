...
def forward(self, arg0_1):
    ...
    ones_like = torch.ops.aten.ones_like.default(sum_1, device = device(type='cpu'), dtype = torch.float32, layout = torch.strided, memory_format = torch.preserve_format, pin_memory = False);  sum_1 = None
