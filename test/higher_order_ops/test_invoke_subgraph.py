...
class GraphModule(torch.nn.Module):
    def forward(self, L_mod_buffers_buf_: "f32[8]", L_x_: "f32[8]", L_y_: "f32[8]"):
        ...
        getitem_3: "f32[8]" = invoke_subgraph_1[0];  invoke_subgraph_1 = None
        add: "f32[8]" = getitem_2 + getitem_3;  getitem_2 = getitem_3 = None
        return (add,)
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[8]"):
        ...
        getitem_1: "f32[8]" = invoke_subgraph[0];  invoke_subgraph = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[8]", L_y_: "f32[8]"):
        ...
        invoke_subgraph_1 = torch.ops.higher_order.invoke_subgraph(subgraph_1, 'subgraph_1', getitem_2, l_y_);  subgraph_1 = getitem_2 = l_y_ = None
        getitem_3: "f32[8]" = invoke_subgraph_1[0];  invoke_subgraph_1 = None
        return (getitem_3,)
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[8]", L_y_: "f32[8]"):
        ...
        invoke_subgraph = torch.ops.higher_order.invoke_subgraph(subgraph_0, 'subgraph_0', l_x_, l_y_);  subgraph_0 = l_x_ = None
        getitem_5: "f32[8]" = invoke_subgraph[0];  invoke_subgraph = None
        invoke_subgraph_1 = torch.ops.higher_order.invoke_subgraph(subgraph_1, 'subgraph_0', getitem_5, l_y_);  subgraph_1 = getitem_5 = None
        getitem_6: "f32[8]" = invoke_subgraph_1[0];  invoke_subgraph_1 = None
        invoke_subgraph_2 = torch.ops.higher_order.invoke_subgraph(subgraph_2, 'subgraph_0', getitem_6, l_y_);  subgraph_2 = getitem_6 = None
        getitem_7: "f32[8]" = invoke_subgraph_2[0];  invoke_subgraph_2 = None
        invoke_subgraph_3 = torch.ops.higher_order.invoke_subgraph(subgraph_3, 'subgraph_0', getitem_7, l_y_);  subgraph_3 = getitem_7 = None
        getitem_8: "f32[8]" = invoke_subgraph_3[0];  invoke_subgraph_3 = None
        invoke_subgraph_4 = torch.ops.higher_order.invoke_subgraph(subgraph_4, 'subgraph_0', getitem_8, l_y_);  subgraph_4 = getitem_8 = l_y_ = None
        getitem_9: "f32[8]" = invoke_subgraph_4[0];  invoke_subgraph_4 = None
        return (getitem_9,)
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[5]", L_y_: "f32[5]"):
        ...
        getitem_2: "f32[5]" = invoke_subgraph[0];  invoke_subgraph = None

        invoke_subgraph_1 = torch.ops.higher_order.invoke_subgraph(subgraph_1, 'subgraph_0', getitem_2, sin_1);  subgraph_1 = getitem_2 = sin_1 = None
        getitem_3: "f32[5]" = invoke_subgraph_1[0];  invoke_subgraph_1 = None
        return (getitem_3,)
