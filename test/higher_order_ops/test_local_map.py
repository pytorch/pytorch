...
class GraphModule(torch.nn.Module):
    def forward(self, L_self_modules_wq_parameters_weight_: "f32[6144, 6144]", L_x_: "f32[256, 256, 6144]", L_self_modules_wk_parameters_weight_: "f32[6144, 6144]", L_self_modules_wv_parameters_weight_: "f32[6144, 6144]", L_self_modules_wo_parameters_weight_: "f32[6144, 6144]", L_self_modules_w1_parameters_weight_: "f32[24576, 6144]", L_self_modules_w2_parameters_weight_: "f32[6144, 24576]"):
        ...
        q: "f32[256, 256, 6144]" = torch._C._nn.linear(l_x_, l_self_modules_wq_parameters_weight_, None);  l_self_modules_wq_parameters_weight_ = None

        k: "f32[256, 256, 6144]" = torch._C._nn.linear(l_x_, l_self_modules_wk_parameters_weight_, None);  l_self_modules_wk_parameters_weight_ = None

        v: "f32[256, 256, 6144]" = torch._C._nn.linear(l_x_, l_self_modules_wv_parameters_weight_, None);  l_self_modules_wv_parameters_weight_ = None

        unflatten: "f32[256, 256, 48, 128]" = q.unflatten(-1, (48, -1));  q = None
        q_1: "f32[256, 48, 256, 128]" = unflatten.permute(0, 2, 1, 3);  unflatten = None

        unflatten_1: "f32[256, 256, 48, 128]" = k.unflatten(-1, (48, -1));  k = None
        k_1: "f32[256, 48, 256, 128]" = unflatten_1.permute(0, 2, 1, 3);  unflatten_1 = None

        unflatten_2: "f32[256, 256, 48, 128]" = v.unflatten(-1, (48, -1));  v = None
        v_1: "f32[256, 48, 256, 128]" = unflatten_2.permute(0, 2, 1, 3);  unflatten_2 = None

        subgraph_0 = self.subgraph_0
        local_map_hop = torch.ops.higher_order.local_map_hop(subgraph_0, q_1, k_1, v_1);  subgraph_0 = q_1 = k_1 = v_1 = None
        o: "f32[256, 48, 256, 128]" = local_map_hop[0];  local_map_hop = None

        permute_3: "f32[256, 256, 48, 128]" = o.permute(0, 2, 1, 3);  o = None
        o_1: "f32[256, 256, 6144]" = permute_3.flatten(-2);  permute_3 = None

        o_2: "f32[256, 256, 6144]" = torch._C._nn.linear(o_1, l_self_modules_wo_parameters_weight_, None);  o_1 = l_self_modules_wo_parameters_weight_ = None

        o0: "f32[256, 256, 6144]" = o_2 + l_x_;  o_2 = l_x_ = None

        o_3: "f32[256, 256, 24576]" = torch._C._nn.linear(o0, l_self_modules_w1_parameters_weight_, None);  l_self_modules_w1_parameters_weight_ = None

        o_4: "f32[256, 256, 24576]" = torch.nn.functional.relu(o_3);  o_3 = None

        o_5: "f32[256, 256, 6144]" = torch._C._nn.linear(o_4, l_self_modules_w2_parameters_weight_, None);  o_4 = l_self_modules_w2_parameters_weight_ = None

        o_6: "f32[256, 256, 6144]" = o0 + o_5;  o0 = o_5 = None
        return (o_6,)

    class subgraph_0(torch.nn.Module):
        def forward(self, q_1: "f32[256, 48, 256, 128]", k_1: "f32[256, 48, 256, 128]", v_1: "f32[256, 48, 256, 128]"):
            out: "f32[256, 48, 256, 128]" = torch._C._nn.scaled_dot_product_attention(query = q_1, key = k_1, value = v_1, is_causal = False);  q_1 = k_1 = v_1 = None
            return (out,)
""",
            )
