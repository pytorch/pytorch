...
method_tests = [
    ...
    ('prod', prod_zeros(M, [0, 1]), NO_ARGS, 'zerodims2'),
    ('prod', prod_zeros(M, [0, 2]), NO_ARGS, 'zerodims1'),
    ('prod', prod_zeros(M, [1, 2]), NO_ARGS, 'zerodims0'),
    ('prod', prod_zeros(M, [0, 1]), (1,), 'zeros_dims2', [0]),
    ('prod', prod_zeros(M, [0, 2]), (1,), 'zeros_dims1', [0]),
    ('prod', prod_zeros(M, [1, 2]), (1,), 'zeros_dims0', [0]),
    ('prod', prod_zeros(M, [0, 1]), (1, True), 'keepdim_zeros_dims2', [0]),
    ('prod', prod_zeros(M, [0, 2]), (1, True), 'keepdim_zeros_dims1', [0]),
    ('prod', prod_zeros(M, [1, 2]), (1, True), 'keepdim_zeros_dims0', [0]),
    ...
    ('cumprod', prod_zeros(M, [0, 1]), (1,), 'zeros_dim2', [0]),
    ('cumprod', prod_zeros(M, [0, 2]), (1,), 'zeros_dim1', [0]),
    ('cumprod', prod_zeros(M, [1, 2]), (1,), 'zeros_dim0', [0]),
    ...
    ('gather', (L, M), (0, gather_variable((M, M), 1, L, True)), 'dim0', [0]),
    ('gather', (L, M), (1, gather_variable((L, M // 2), 0, M, True)), 'dim1', [0]),
