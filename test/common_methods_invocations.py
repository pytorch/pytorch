...
def method_tests():
    ...
    return [
        ...
        ('_var_mean', (S, S, S), NO_ARGS, ''),
        ('_var_mean', (S, S, S), (1,), 'dim', [0]),
        ('_var_mean', (S, S, S), (1, True, True), 'keepdim_dim', [0]),
        ('_var_mean', (S,), (0,), 'dim_1d', [0]),
        ('_var_mean', (S,), (0, True, True), 'keepdim_dim_1d', [0]),
        ('_std_mean', (S, S, S), NO_ARGS, ''),
        ('_std_mean', (S, S, S), (1,), 'dim', [0]),
        ('_std_mean', (S, S, S), (1, True, True), 'keepdim_dim', [0]),
        ('_std_mean', (S,), (0,), 'dim_1d', [0]),
        ('_std_mean', (S,), (0, True, True), 'keepdim_dim_1d', [0]),
...
def exclude_tensor_method(name, test_name):
    ...
    exclude_all_tensor_method_by_test_name = {
        ...
        'test__var_mean_keepdim_dim_1d',
        'test__var_mean_keepdim_dim',
        'test__var_mean_dim_1d',
        'test__var_mean_dim',
        'test__var_mean',
        'test__std_mean_keepdim_dim_1d',
        'test__std_mean_keepdim_dim',
        'test__std_mean_dim_1d',
        'test__std_mean_dim',
        'test__std_mean'
    }
