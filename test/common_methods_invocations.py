...
def method_tests():
    ...
    return [
        ...
        ('scatter', (M, S), (0, gather_variable((S, S), 1, M), ()), 'scalartensor_dim0', (), [0]),
        ('scatter', (M, S), (0, gather_variable((S, S), 1, M), 2.5), 'scalar_dim0', (), [0]),
        ...
        ('scatter_add', (M, S), (0, gather_variable((S, S), 1, M), ()), 'scalartensor_dim0', (), [0]),
        ('scatter_add', (M, S), (0, gather_variable((S, S), 1, M), 2.5), 'scalar_dim0', (), [0]),
        ('scatter_add', (M, S), (1, gather_variable((M, S // 2), 0, S), (M, S // 2)), 'dim1', (), [0]),
        ('scatter_add', (), (0, torch.tensor(0, dtype=torch.int64), ()), 'scalartensor_all_dim0', (), [0]),
        ('scatter_add', (), (0, torch.tensor(0, dtype=torch.int64), 2.5), 'scalar_all_dim0', (), [0]),
