...
def method_tests():
    ...
    return [
        ...
        ('gather', (M, 1), (0, gather_variable((S, S), 1, M, True)), 'dim0_broadcast_self', (), [0]),
        ('gather', (M, S), (0, gather_variable((S, 1), 1, M, True)), 'dim0_broadcast_index', (), [0]),
        ('gather', (M, S), (0, gather_variable((S, 1), 1, M, True).squeeze(1)), 'dim0_broadcast_index_lessdim', (), [0]),
        ('gather', (M, S), (1, gather_variable((M, S // 2), 0, S, True)), 'dim1', (), [0]),
        ('gather', (1, S), (1, gather_variable((M, S // 2), 0, S, True)), 'dim1_broadcast_self', (), [0]),
        ('gather', (M, S), (1, gather_variable((1, S // 2), 0, S, True)), 'dim1_broadcast_index', (), [0]),
        ...
        ('scatter', (M, 1), (0, gather_variable((S, S), 1, M), (S, S)), 'dim0_broadcast_self', (), [0]),
        ('scatter', (M, S), (0, gather_variable((S, S), 1, M), (S, 1)), 'dim0_broadcast_src', (), [0]),
        ('scatter', (M, 1), (0, gather_variable((S, S), 1, M), (S, 1)), 'dim0_broadcast_self_src', (), [0]),
        ('scatter', (M, S), (0, gather_variable((S, 1), 1, M), (S, S)), 'dim0_broadcast_index', (), [0]),
        ('scatter', (M, S), (0, gather_variable((S, 1), 1, M).squeeze(1), (S, S)), 'dim0_broadcast_index_lessdim', (), [0]),
        ('scatter', (M, S), (1, gather_variable((M, S // 2), 0, S), (M, S // 2)), 'dim1', (), [0]),
        ('scatter', (1, S), (1, gather_variable((M, S // 2), 0, S), (M, S // 2)), 'dim1_broadcast_self', (), [0]),
        ('scatter', (M, S), (1, gather_variable((M, S // 2), 0, S), (1, S // 2)), 'dim1_broadcast_src', (), [0]),
        ('scatter', (1, S), (1, gather_variable((M, S // 2), 0, S), (1, S // 2)), 'dim1_broadcast_self_src', (), [0]),
        ('scatter', (M, S), (1, gather_variable((1, S // 2), 0, S), (M, S // 2)), 'dim1_broadcast_index', (), [0]),
        ...
        ('scatter_add', (M, 1), (0, gather_variable((S, S), 1, M), (S, S)), 'dim0_broadcast_self', (), [0]),
        ('scatter_add', (M, S), (0, gather_variable((S, S), 1, M), (S, 1)), 'dim0_broadcast_src', (), [0]),
        ('scatter_add', (M, 1), (0, gather_variable((S, S), 1, M), (S, 1)), 'dim0_broadcast_self_src', (), [0]),
        ('scatter_add', (M, S), (0, gather_variable((S, 1), 1, M), (S, S)), 'dim0_broadcast_index', (), [0]),
        ('scatter_add', (M, S), (0, gather_variable((S, 1), 1, M).squeeze(1), (S, S)), 'dim0_broadcast_index_lessdim', (), [0]),
        ('scatter_add', (M, S), (1, gather_variable((M, S // 2), 0, S), (M, S // 2)), 'dim1', (), [0]),
        ('scatter_add', (1, S), (1, gather_variable((M, S // 2), 0, S), (M, S // 2)), 'dim1_broadcast_self', (), [0]),
        ('scatter_add', (M, S), (1, gather_variable((M, S // 2), 0, S), (1, S // 2)), 'dim1_broadcast_src', (), [0]),
        ('scatter_add', (1, S), (1, gather_variable((M, S // 2), 0, S), (1, S // 2)), 'dim1_broadcast_self_src', (), [0]),
        ('scatter_add', (M, S), (1, gather_variable((1, S // 2), 0, S), (M, S // 2)), 'dim1_broadcast_index', (), [0]),
