...
def method_tests():
    ...
    return [
        ...
        ('gather', (M, 1), (0, gather_variable((S, S), 1, M, True)), 'dim0_broadcast_lhs', (), [0]),
        ...
        ('gather', (1, S), (1, gather_variable((M, S // 2), 0, S, True)), 'dim1_broadcast_lhs', (), [0]),
        ...
        ('scatter', (M, 1), (0, gather_variable((S, S), 1, M), (S, S)), 'dim0_broadcast_lhs', (), [0]),
        ('scatter', (M, S), (0, gather_variable((S, S), 1, M), (S, 1)), 'dim0_broadcast_src', (), [0]),
        ('scatter', (M, 1), (0, gather_variable((S, S), 1, M), (S, 1)), 'dim0_broadcast_lhs_src', (), [0]),
        ...
        ('scatter', (1, S), (1, gather_variable((M, S // 2), 0, S), (M, S // 2)), 'dim1_broadcast_lhs', (), [0]),
        ('scatter', (M, S), (1, gather_variable((M, S // 2), 0, S), (1, S // 2)), 'dim1_broadcast_src', (), [0]),
        ('scatter', (1, S), (1, gather_variable((M, S // 2), 0, S), (1, S // 2)), 'dim1_broadcast_lhs_src', (), [0]),
        ...
        ('scatter_add', (M, 1), (0, gather_variable((S, S), 1, M), (S, S)), 'dim0_broadcast_lhs', (), [0]),
        ('scatter_add', (M, S), (0, gather_variable((S, S), 1, M), (S, 1)), 'dim0_broadcast_src', (), [0]),
        ('scatter_add', (M, 1), (0, gather_variable((S, S), 1, M), (S, 1)), 'dim0_broadcast_lhs_src', (), [0]),
        ...
        ('scatter_add', (1, S), (1, gather_variable((M, S // 2), 0, S), (M, S // 2)), 'dim1_broadcast_lhs', (), [0]),
        ('scatter_add', (M, S), (1, gather_variable((M, S // 2), 0, S), (1, S // 2)), 'dim1_broadcast_src', (), [0]),
        ('scatter_add', (1, S), (1, gather_variable((M, S // 2), 0, S), (1, S // 2)), 'dim1_broadcast_lhs_src', (), [0]),
