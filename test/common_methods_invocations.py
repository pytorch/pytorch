...
def method_tests():
    ...
    return [
        ...
        ('moments', (S, S, S), NO_ARGS, '', (True,)),
        ('moments', (S, S, S), (1,), 'dim', [0]),
        ('moments', (S, S, S), (1, True, True), 'keepdim_dim', [0]),
        ('moments', (S,), (0,), 'dim_1d', [0]),
        ('moments', (S,), (0, True, True), 'keepdim_dim_1d', [0]),
        ('std_mean', (S, S, S), NO_ARGS, '', (True,)),
