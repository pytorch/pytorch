...
method_tests = [
    ...
    ('matrix_power', lambda: random_fullrank_matrix_distinct_singular_value(S, S), [-2], "n=-2",
     NO_ARGS, [skipIfNoLapack]),
    ('mvlgamma', torch.empty(S,).uniform_(0, 1), [1], "p=1"),
    ('mvlgamma', torch.empty(S,).uniform_(0.5, 2), [2], "p=2"),
    ('mvlgamma', torch.empty(S, S).uniform_(1, 3), [3], "p=3"),
    ('mvlgamma', torch.empty(S, S).uniform_(2, 5), [5], "p=5"),
    ('addcmul', (S, S), ((S, S), (S, S))),
