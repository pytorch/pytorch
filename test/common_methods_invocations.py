...
def method_tests():
    ...
    return [
        ...
        ('var_mean', (S, S, S), (1,), 'dim', (True,), [0]),
        ('var_mean', (S, S, S), (1, True, True), 'keepdim_dim', (True,), [0]),
        ('var_mean', (S,), (0,), 'dim_1d', (True,), [0]),
        ('var_mean', (S,), (0, True, True), 'keepdim_dim_1d', (True,), [0]),
        ('std_mean', (S, S, S), (1,), 'dim', (True,), [0]),
        ('std_mean', (S, S, S), (1, True, True), 'keepdim_dim', (True,), [0]),
        ('std_mean', (S,), (0,), 'dim_1d', (True,), [0]),
        ('std_mean', (S,), (0, True, True), 'keepdim_dim_1d', (True,), [0]),
