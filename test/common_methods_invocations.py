...
def method_tests():
    ...
    return [
        ...
        ('pow', torch.rand(S, S, S) + 1e-3, (3.14,), 'constant', False),
        ('__rpow__', torch.rand(S, S, S) + 1e-3, (3.14,), 'constant', True),
        ('pow', uniform_scalar(1e-3, requires_grad=True), (3.14,), 'scalar_constant', False),
        ('__rpow__', uniform_scalar(1e-3, requires_grad=True), (3.14,), 'scalar_constant', True),
        ...
        ('fmod', (S, S, S), (non_differentiable(torch.rand(S, S, S) + 1.5),), 'tensor', False),
        ('fmod', (S,), (non_differentiable(torch.rand(S, S, S) + 1.5),), 'tensor_broadcast_lhs', False),
        ('fmod', (S, S, S), (non_differentiable(torch.rand(S) + 1.5),), 'tensor_broadcast_rhs', False),
        ('fmod', (S, 1, S), (non_differentiable(torch.rand(S, S) + 1.5),), 'tensor_broadcast_all', False),
        ('fmod', (), (non_differentiable(uniform_scalar(1.5)),), 'scalar_tensor', False),
        ('fmod', (), (non_differentiable(torch.rand(S, S, S) + 1.5),), 'scalar_tensor_broadcast_lhs', False),
        ('fmod', (S, S, S), (non_differentiable(uniform_scalar(1.5)),), 'scalar_tensor_broadcast_rhs', False),
        ('remainder', (S, S, S), (1.5,), '', True),
        ('remainder', (), (1.5,), 'scalar', True),
        ('remainder', (S, S, S), (non_differentiable(torch.rand(S, S, S) + 1.5),), 'tensor', False),
        ('remainder', (S,), (non_differentiable(torch.rand(S, S, S) + 1.5),), 'tensor_broadcast_lhs', False),
        ('remainder', (S, 1, S), (non_differentiable(torch.rand(S, S) + 1.5),), 'tensor_broadcast_all', False),
        ('remainder', (), (non_differentiable(uniform_scalar(1.5)),), 'scalar_tensor', False),
        ('remainder', (), (non_differentiable(torch.rand(S, S, S) + 1.5),), 'scalar_tensor_broadcast_lhs', False),
        ...
        ('max', (S, S, S), NO_ARGS, '', False),
        ('max', (S, S, S), (1,), 'dim', False, [0]),
        ('max', (S, S, S), (1, True,), 'keepdim_dim', False, [0]),
        ('max', (), NO_ARGS, 'scalar', False),
        ('max', (), (0,), 'scalar_dim', False, [0]),
        ('max', (), (0, True,), 'scalar_keepdim_dim', False, [0]),
        ...
        ('min', (S, S, S), NO_ARGS, '', False),
        ('min', (S, S, S), (1,), 'dim', False, [0]),
        ('min', (S, S, S), (1, True,), 'keepdim_dim', False, [0]),
        ('min', (), NO_ARGS, 'scalar', False),
        ('min', (), (0,), 'scalar_dim', False, [0]),
        ('min', (), (0, True,), 'scalar_keepdim_dim', False, [0]),
        ...
        ('kthvalue', (S, S, S), (2,)),
        ('kthvalue', (), (1,), 'scalar'),
        ('kthvalue', (S, S, S), (2, 1,), 'dim', False, [1]),
        ('kthvalue', (), (1, 0,), 'scalar_dim', False, [1]),
        ('kthvalue', (S, S, S), (2, 1, True,), 'keepdim_dim', False, [1]),
        ('kthvalue', (), (1, 0, True), 'scalar_keepdim_dim', False, [1]),
        ('kthvalue', (S,), (2, 0,), 'dim_1d', False, [1]),
        ('kthvalue', (S,), (2, 0, True,), 'keepdim_dim_1d', False, [1]),
        ('median', (S, S, S), NO_ARGS),
        ('median', (S, S, S), (1,), 'dim', False, [0]),
        ('median', (S, S, S), (1, True,), 'keepdim_dim', False, [0]),
        ('median', (), NO_ARGS, 'scalar'),
        ('median', (), (0,), 'scalar_dim', False, [0]),
        ('median', (), (0, True,), 'scalar_keepdim_dim', False, [0]),
        ('mode', (S, S, S), NO_ARGS),
        ('mode', (S, S, S), (1,), 'dim', False, [0]),
        ('mode', (S, S, S), (1, True,), 'keepdim_dim', False, [0]),
        ('mode', (), NO_ARGS, 'scalar'),
        ('mode', (), (0,), 'scalar_dim', False, [0]),
        ('mode', (), (0, True,), 'scalar_keepdim_dim', False, [0]),
        ('sum', (S, S, S), NO_ARGS),
        ('sum', (S, S, S), (1,), 'dim', False, [0]),
        ('sum', (S, S, S), (1, True,), 'keepdim_dim', False, [0]),
        ('sum', (), NO_ARGS, 'scalar'),
        ('sum', (), (0,), 'scalar_dim', False, [0]),
        ('sum', (), (0, True,), 'scalar_keepdim_dim', False, [0]),
        ('sum', (S, S, S), ([1, 2],), 'multi_dim'),
        ('sum', (S, S, S), ([1, 2], True,), 'multi_dim_keepdim'),
        ('prod', (S, S, S), NO_ARGS),
        ('prod', (S, S, S), (1,), 'dim', False, [0]),
        ('prod', (S, S, S), (1, True,), 'keepdim_dim', False, [0]),
        ('prod', (), NO_ARGS, 'scalar'),
        ('prod', (), (0,), 'scalar_dim', False, [0]),
        ('prod', (), (0, True,), 'scalar_keepdim_dim', False, [0]),
        ('prod', prod_zeros(S, [0, 1]), NO_ARGS, 'zerodims2'),
        ('prod', prod_zeros(S, [0, 2]), NO_ARGS, 'zerodims1'),
        ('prod', prod_zeros(S, [1, 2]), NO_ARGS, 'zerodims0'),
        ('prod', prod_zeros(S, [0, 1]), (1,), 'zeros_dims2', False, [0]),
        ('prod', prod_zeros(S, [0, 2]), (1,), 'zeros_dims1', False, [0]),
        ('prod', prod_zeros(S, [1, 2]), (1,), 'zeros_dims0', False, [0]),
        ('prod', prod_zeros(S, [0, 1]), (1, True), 'keepdim_zeros_dims2', False, [0]),
        ('prod', prod_zeros(S, [0, 2]), (1, True), 'keepdim_zeros_dims1', False, [0]),
        ('prod', prod_zeros(S, [1, 2]), (1, True), 'keepdim_zeros_dims0', False, [0]),
        ('prod', prod_single_zero(S), NO_ARGS, 'single_zero'),
        ('prod', (torch.tensor(0., requires_grad=True)), NO_ARGS, 'scalar_zero'),
        ('prod', (torch.tensor(0., requires_grad=True)), (0,), 'scalar_dim_zero', False, [0]),
        ('prod', (torch.tensor(0., requires_grad=True)), (0, True,), 'scalar_keepdim_dim_zero', False, [0]),
        ...
        ('renorm', (S, S, S), (2, 1, 0.5), 'dim', False, [1]),
        ...
        ('cumsum', (S, S, S), (0,), 'dim0', False, [0]),
        ('cumsum', (S, S, S), (1,), 'dim1', False, [0]),
        ('cumsum', (S, S, S), (1,), 'dim1_cast', False, [0], (), lambda x: x, {'dtype': torch.float64}),
        ('cumsum', (), (0,), 'dim0_scalar', False, [0]),
        ('cumprod', (S, S, S), (0,)),
        ('cumprod', (S, S, S), (1,), 'dim1', False, [0]),
        ('cumprod', (), (0,), 'scalar'),
        ('cumprod', (torch.tensor(0., requires_grad=True)), (0,), 'scalar_zeros'),
        ('cumprod', prod_zeros(S, [0, 1]), (1,), 'zeros_dim2', False, [0]),
        ('cumprod', prod_zeros(S, [0, 2]), (1,), 'zeros_dim1', False, [0]),
        ('cumprod', prod_zeros(S, [1, 2]), (1,), 'zeros_dim0', False, [0]),
        ('cumprod', prod_zeros(S, [1, 2]), (1,), 'zeros_dim0_cast', False, [0], (), lambda x: x, {'dtype': torch.float64}),
        ('unfold', (), (0, 1, 1), 'scalar', False, [0]),
        ('unfold', (S, S, S, S), (1, 3, 1), '', False, [0]),
        ('unfold', (S, S, S), (2, 3, 2), 'lastdim', False, [0]),
        ('addmm', (S, M), ((S, S), (S, M)), '', True),
        ('addmm', (1,), ((S, S), (S, M)), 'broadcast_lhs', True),
        ...
        ('addmm', (), ((S, S), (S, M)), 'scalar_broadcast_lhs', True),
        ('addmm', (), ((S, S), (S, M)), 'scalar_broadcast_lhs_coef', True, (), (), lambda x: x, {'beta': 0.2, 'alpha': 0.6}),
        ('addbmm', (S, M), ((S, S, S), (S, S, M)),),
        ('addbmm', (1,), ((S, S, S), (S, S, M)), 'broadcast_lhs'),
        ('addbmm', (S, M), ((S, S, S), (S, S, M)), 'coef', False, (), (), lambda x: x, {'beta': 0.2, 'alpha': 0.6}),
        ('addbmm', (1,), ((S, S, S), (S, S, M)), 'broadcast_lhs_coef', False,
         (), (), lambda x: x, {'beta': 0.2, 'alpha': 0.6}),
        ('addbmm', (), ((S, S, S), (S, S, M)), 'scalar_broadcast_lhs'),
        ('addbmm', (), ((S, S, S), (S, S, M)), 'scalar_broadcast_lhs_coef', False, (), (), lambda x: x,
         {'beta': 0.2, 'alpha': 0.6}),
        ('baddbmm', (S, S, M), ((S, S, S), (S, S, M)),),
        ('baddbmm', (1,), ((S, S, S), (S, S, M)), 'broadcast_lhs'),
        ('baddbmm', (S, S, M), ((S, S, S), (S, S, M)), 'coef', False, (), (), lambda x: x, {'beta': 0.2, 'alpha': 0.6}),
        ('baddbmm', (1,), ((S, S, S), (S, S, M)), 'broadcast_lhs_coef', False,
         (), (), lambda x: x, {'beta': 0.2, 'alpha': 0.6}),
        ('baddbmm', (), ((S, S, S), (S, S, M)), 'scalar_broadcast_lhs'),
        ('baddbmm', (), ((S, S, S), (S, S, M)), 'scalar_broadcast_lhs_coef', False, (), (), lambda x: x,
         {'beta': 0.2, 'alpha': 0.6}),
        ('addmv', (S,), ((S, M), (M,)),),
        ('addmv', (1,), ((S, M), (M,)), 'broadcast_lhs'),
        ('addmv', (S,), ((S, M), (M,)), 'coef', False, (), (), lambda x: x, {'beta': 0.2, 'alpha': 0.6}),
        ('addmv', (1,), ((S, M), (M,)), 'broadcast_lhs_coef', False, (), (), lambda x: x, {'beta': 0.2, 'alpha': 0.6}),
        ('addmv', (), ((S, M), (M,)), 'scalar_broadcast_lhs'),
        ('addmv', (), ((S, M), (M,)), 'scalar_broadcast_lhs_coef', False, (), (), lambda x: x, {'beta': 0.2, 'alpha': 0.6}),
        ('addr', (S, M), ((S,), (M,)),),
        ('addr', (), ((S,), (M,)), 'broadcast_lhs'),
        ('addr', (S, M), ((S,), (M,)), 'coef', False, (), (), lambda x: x, {'beta': 0.2, 'alpha': 0.6}),
        ('addr', (), ((S,), (M,)), 'broadcast_lhs_coef', False, (), (), lambda x: x, {'beta': 0.2, 'alpha': 0.6}),
        ('dot', (L,), ((L,),),),
        ('mm', (S, M), ((M, S),), '', True),
        ...
        ('matrix_power', lambda: random_fullrank_matrix_distinct_singular_value(S), [-1], "n=-1", False,
         NO_ARGS, [skipIfNoLapack]),
        ('matrix_power', lambda: random_fullrank_matrix_distinct_singular_value(S), [-3], "n=-3", False,
         NO_ARGS, [skipIfNoLapack]),
        ('matrix_power', lambda: random_fullrank_matrix_distinct_singular_value(S, S), [-2], "n=-2", False,
         NO_ARGS, [skipIfNoLapack]),
        ...
        ('addcmul', (S, S), ((S, S), (S, S)), 'scale', False, (), (), lambda x: x, {'value': 0.5}),
        ('addcmul', (S, S), ((S, 1), (1, S)), 'scale_broadcast_rhs', False, (), (), lambda x: x, {'value': 0.5}),
        ('addcmul', (1,), ((S, S, 1), (1, S)), 'scale_broadcast_all', False, (), (), lambda x: x, {'value': 0.5}),
        ('addcmul', (), ((), ()), 'scalar'),
        ('addcmul', (S, S), ((), ()), 'scalar_broadcast_rhs'),
        ('addcmul', (), ((S, S, 1), (1, S)), 'scalar_broadcast_lhs'),
        ('addcmul', (), ((), ()), 'scalar_scale', False, (), (), lambda x: x, {'value': 0.5}),
        ('addcmul', (S, S), ((), ()), 'scalar_scale_broadcast_rhs', False, (), (), lambda x: x, {'value': 0.5}),
        ('addcmul', (), ((S, S, 1), (1, S)), 'scalar_scale_broadcast_lhs', False, (), (), lambda x: x, {'value': 0.5}),
        ('addcdiv', (S, S), ((S, S), (S, S))),
        ('addcdiv', (S, S), ((S, 1), (1, S)), 'broadcast_rhs'),
        ('addcdiv', (1,), ((S, S, 1), (1, S)), 'broadcast_all'),
        ('addcdiv', (S, S), ((S, S), (S, S)), 'scale', False, (), (), lambda x: x, {'value': 0.5}),
        ('addcdiv', (S, S), ((S, 1), (1, S)), 'scale_broadcast_rhs', False, (), (), lambda x: x, {'value': 0.5}),
        ('addcdiv', (1,), ((S, S, 1), (1, S)), 'scale_broadcast_all', False, (), (), lambda x: x, {'value': 0.5}),
        ('addcdiv', (), ((), ()), 'scalar'),
        ('addcdiv', (S, S), ((), ()), 'scalar_broadcast_rhs'),
        ('addcdiv', (), ((S, S, 1), (1, S)), 'scalar_broadcast_lhs'),
        ('addcdiv', (), ((), ()), 'scalar_scale', False, (), (), lambda x: x, {'value': 0.5}),
        ('addcdiv', (S, S), ((), ()), 'scalar_scale_broadcast_rhs', False, (), (), lambda x: x, {'value': 0.5}),
        ('addcdiv', (), ((S, S, 1), (1, S)), 'scalar_scale_broadcast_lhs', False, (), (), lambda x: x, {'value': 0.5}),
        ('zero_', (S, S, S), NO_ARGS),
        ...
        ('norm', (S, S), ('nuc',), 'nuc', False, NO_ARGS, [skipIfNoLapack]),
        ('norm', (S, S), (-1,), 'neg_1'),
        ('norm', (S, S), (-2,), 'neg_2'),
        ('norm', (S, S), (-0.5,), 'neg_0_5'),
        ('norm', (S, S), (-1.5,), 'neg_1_5'),
        ('norm', (S, S), (-2, 1,), 'neg_2_2_dim', False, [1]),
        ('norm', (S, S), (-1, 1,), 'neg_1_2_dim', False, [1]),
        ('norm', (S, S), (0, 1,), '0_2_dim', False, [1]),
        ('norm', (S, S), (1, 1,), '1_2_dim', False, [1]),
        ('norm', (S, S), (2, 1,), '2_2_dim', False, [1]),
        ('norm', (S, S), (3, 1,), '3_2_dim', False, [1]),
        ('norm', (S, S), (inf, 1,), 'inf_2_dim'),
        ('norm', torch.rand(S, S, S) + 5e-2, (1.5,), '1_5_default'),
        ('norm', (S, S, S), (2, 1), '2_dim', False, [1]),
        ('norm', (S, S, S), (3, 1), '3_dim', False, [1]),
        ('norm', torch.rand(S, S, S) + 5e-2, (1.5, 1), '1_5_dim', False, [1]),
        ('norm', (S, S, S), (2, 1, True), 'keepdim_2_dim', False, [1]),
        ('norm', (S, S, S), (3, 1, True), 'keepdim_3_dim', False, [1]),
        ('norm', torch.rand(S, S, S) + 5e-2, (1.5, 1, True), 'keepdim_1_5_dim', False, [1]),
        ('norm', (), (2, 0), '2_dim_scalar', False, [1]),
        ('norm', (), (3, 0), '3_dim_scalar', False, [1]),
        ('norm', (), (2, 0, True), 'keepdim_2_dim_scalar', False, [1]),
        ('norm', (), (3, 0, True), 'keepdim_3_dim_scalar', False, [1]),
        ('clone', (S, M, S), NO_ARGS),
        ...
        ('index_select', (S, S, S), (0, index_variable(2, S)), 'dim', False, [0]),
        ('index_select', (), (0, torch.tensor([0], dtype=torch.int64)), 'scalar_mixed_dim', False, [0]),
        ('index_select', (), (0, torch.tensor(0, dtype=torch.int64)), 'scalar_dim', False, [0]),
        ('index_add', (S, S), (0, index_variable(2, S), (2, S)), 'dim', False, [0]),
        ('index_add', (), (0, torch.tensor([0], dtype=torch.int64), (1,)), 'scalar_input_dim', False, [0]),
        ('index_add', (), (0, torch.tensor(0, dtype=torch.int64), ()), 'scalar_all_dim', False, [0]),
        ('index_copy', (S, S), (0, index_perm_variable(2, S), (2, S)), 'dim', False, [0]),
        ('index_copy', (), (0, torch.tensor([0], dtype=torch.int64), (1,)), 'scalar_input_dim', False, [0]),
        ('index_copy', (), (0, torch.tensor(0, dtype=torch.int64), ()), 'scalar_all_dim', False, [0]),
        ('index_fill', (S, S), (0, index_variable(2, S), 2), 'dim', False, [0]),
        ('index_fill', (S, S), (0, index_variable(2, S), ()), 'variable_dim', False, [0]),
        ('index_fill', (S, S), (0, torch.tensor(0, dtype=torch.int64), 2), 'scalar_index_dim', False, [0]),
        ('index_fill', (), (0, torch.tensor([0], dtype=torch.int64), 2), 'scalar_input_dim', False, [0]),
        ('index_fill', (), (0, torch.tensor(0, dtype=torch.int64), 2), 'scalar_both_dim', False, [0]),
        ('inverse', lambda: random_fullrank_matrix_distinct_singular_value(S), NO_ARGS, '', False, NO_ARGS, [skipIfNoLapack]),
        ('inverse', lambda: random_fullrank_matrix_distinct_singular_value(S, 2, 3),
         NO_ARGS, 'batched', False, NO_ARGS, [skipIfNoLapack]),
        ('det', (S, S), NO_ARGS, '', False, NO_ARGS, [skipIfNoLapack]),
        ('det', (1, 1), NO_ARGS, '1x1', False, NO_ARGS, [skipIfNoLapack]),
        ('det', lambda: random_symmetric_matrix(S), NO_ARGS, 'symmetric', False, NO_ARGS, [skipIfNoLapack]),
        ('det', lambda: random_symmetric_psd_matrix(S), NO_ARGS, 'symmetric_psd', False, NO_ARGS, [skipIfNoLapack]),
        ('det', lambda: random_symmetric_pd_matrix(S), NO_ARGS, 'symmetric_pd', False, NO_ARGS, [skipIfNoLapack]),
        ('det', lambda: random_square_matrix_of_rank(S, S - 2), NO_ARGS, 'dim2_null', False, NO_ARGS, [skipIfNoLapack]),
        ('det', lambda: random_square_matrix_of_rank(S, 1), NO_ARGS, 'rank1', False, NO_ARGS, [skipIfNoLapack]),
        ('det', lambda: random_square_matrix_of_rank(S, 2), NO_ARGS, 'rank2', False, NO_ARGS, [skipIfNoLapack]),
        ('det', lambda: random_fullrank_matrix_distinct_singular_value(S), NO_ARGS,
         'distinct_singular_values', False, NO_ARGS, [skipIfNoLapack]),
        # For `logdet` and `slogdet`, the function at det=0 is not smooth.
        # We need to exclude tests with det=0 (e.g. dim2_null, rank1, rank2) and use
        # `make_nonzero_det` to make the random matrices have nonzero det. For
        # `logdet`, we also set `make_nonzero_det(matrix, sign=1)` to make the
        # matrix have positive det.
        ('logdet', lambda: make_nonzero_det(torch.randn(S, S), 1), NO_ARGS, '', False, NO_ARGS, [skipIfNoLapack]),
        ('logdet', lambda: make_nonzero_det(torch.randn(1, 1), 1), NO_ARGS, '1x1', False, NO_ARGS, [skipIfNoLapack]),
        ('logdet', lambda: make_nonzero_det(random_symmetric_matrix(S), 1), NO_ARGS,
         'symmetric', False, NO_ARGS, [skipIfNoLapack]),
        ('logdet', lambda: make_nonzero_det(random_symmetric_pd_matrix(S), 1), NO_ARGS,
         'symmetric_pd', False, NO_ARGS, [skipIfNoLapack]),
        ...
        ('slogdet', lambda: make_nonzero_det(torch.randn(1, 1), 1), NO_ARGS,
         '1x1_pos_det', False, NO_ARGS, [skipIfNoLapack], itemgetter(1)),
        ('slogdet', lambda: make_nonzero_det(torch.randn(1, 1), -1), NO_ARGS,
         '1x1_neg_det', False, NO_ARGS, [skipIfNoLapack], itemgetter(1)),
        ('slogdet', lambda: make_nonzero_det(torch.randn(S, S), 1), NO_ARGS,
         'pos_det', False, NO_ARGS, [skipIfNoLapack], itemgetter(1)),
        ('slogdet', lambda: make_nonzero_det(torch.randn(S, S), -1), NO_ARGS,
         'neg_det', False, NO_ARGS, [skipIfNoLapack], itemgetter(1)),
        ('slogdet', lambda: make_nonzero_det(random_symmetric_matrix(S)), NO_ARGS,
         'symmetric', False, NO_ARGS, [skipIfNoLapack], itemgetter(1)),
        ('slogdet', lambda: random_symmetric_pd_matrix(S), NO_ARGS,
         'symmetric_pd', False, NO_ARGS, [skipIfNoLapack], itemgetter(1)),
        ('slogdet', lambda: random_fullrank_matrix_distinct_singular_value(S), NO_ARGS,
         'distinct_singular_values', False, NO_ARGS, [skipIfNoLapack], itemgetter(1)),
        ('symeig', lambda: random_symmetric_matrix(S), (True, False), 'lower', False, NO_ARGS, [skipIfNoLapack]),
        ('symeig', lambda: random_symmetric_matrix(S), (True, True), 'upper', False, NO_ARGS, [skipIfNoLapack]),
        ('symeig', lambda: random_symmetric_matrix(M), (True, True), 'large', False, NO_ARGS, [skipIfNoLapack]),
        ('svd', lambda: random_fullrank_matrix_distinct_singular_value(S), NO_ARGS, '', False, NO_ARGS, [skipIfNoLapack]),
        ('svd', lambda: random_fullrank_matrix_distinct_singular_value(S)[:(S - 2)], NO_ARGS,
         'wide', False, NO_ARGS, [skipIfNoLapack]),
        ('svd', lambda: random_fullrank_matrix_distinct_singular_value(S)[:, :(S - 2)], NO_ARGS,
         'tall', False, NO_ARGS, [skipIfNoLapack]),
        ('svd', lambda: random_fullrank_matrix_distinct_singular_value(S)[:(S - 2)], (False,),
         'wide_all', False, NO_ARGS, [skipIfNoLapack], lambda usv: (usv[0], usv[1], usv[2][:, :(S - 2)])),
        ('svd', lambda: random_fullrank_matrix_distinct_singular_value(S)[:, :(S - 2)], (False,),
         'tall_all', False, NO_ARGS, [skipIfNoLapack], lambda usv: (usv[0][:, :(S - 2)], usv[1], usv[2])),
        ('svd', lambda: random_fullrank_matrix_distinct_singular_value(M), NO_ARGS,
         'large', False, NO_ARGS, [skipIfNoLapack]),
        ('solve', (S, S), (random_fullrank_matrix_distinct_singular_value(
            S, silent=True),), '', False, NO_ARGS, [skipIfNoLapack]),
        ('solve', (S, S, S), (random_fullrank_matrix_distinct_singular_value(S, S, silent=True),),
         'batched', False, NO_ARGS, [skipIfNoLapack]),
        ('solve', (2, 3, S, S), (random_fullrank_matrix_distinct_singular_value(S, 2, 3, silent=True),),
         'batched_dims', False, NO_ARGS, [skipIfNoLapack]),
        ('solve', (2, 2, S, S), (random_fullrank_matrix_distinct_singular_value(S, 1, silent=True),),
         'batched_broadcast_A', False, NO_ARGS, [skipIfNoLapack]),
        ...
        ('select', (S, S, S), (1, 2), 'dim', False, [0]),
        ('select', (S, S, S), (1, -1), 'wrap_dim', False, [0]),
        ('select', (S,), (0, 2), '1d'),
        ('narrow', (S, S, S), (1, 2, 2), 'dim', False, [0]),
        ('narrow', (S, S, S), (1, 0, 0), 'empty_dim', False, [0]),
        ...
        ('chunk', (S, S, S), (2,), '', True),
        ('chunk', (S, S, S), (S, 1), 'dim', True, [1]),
        ('split', (S, S, S), (2,)),
        ('split', (S, S, S), (S, 1), 'dim', False, [1]),
        ('split', (S, S, S), ([int(S / 3), S - int(S / 3) * 2, int(S / 3)],), 'size_list'),
        ('split', (S, S, S), ([int(S / 2), S - int(S / 2) * 2, int(S / 2)], 2), 'size_list_dim', False, [1]),
        ('gather', (M, S), (0, gather_variable((S, S), 1, M, True)), 'dim0', False, [0]),
        ('gather', (M, S), (1, gather_variable((M, S // 2), 0, S, True)), 'dim1', False, [0]),
        ('gather', (), (0, torch.tensor([0], dtype=torch.int64)), 'scalar_input', False, [0]),
        ('gather', (S,), (0, torch.tensor(0, dtype=torch.int64)), 'scalar_index', False, [0]),
        ('gather', (), (0, torch.tensor(0, dtype=torch.int64)), 'scalar_both', False, [0]),
        ('scatter', (M, S), (0, gather_variable((S, S), 1, M), (S, S)), 'dim0', False, [0]),
        ('scatter', (M, S), (1, gather_variable((M, S // 2), 0, S), (M, S // 2)), 'dim1', False, [0]),
        ('scatter', (), (0, torch.tensor(0, dtype=torch.int64), ()), 'scalartensor_all_dim0', False, [0]),
        ('scatter', (), (0, torch.tensor(0, dtype=torch.int64), 2.5), 'scalar_all_dim0', False, [0]),
        ('scatter_add', (M, S), (0, gather_variable((S, S), 1, M), (S, S)), 'dim0', False, [0]),
        ('scatter_add', (M, S), (1, gather_variable((M, S // 2), 0, S), (M, S // 2)), 'dim1', False, [0]),
        ('scatter_add', (), (0, torch.tensor(0, dtype=torch.int64), ()), 'scalar_all_dim0', False, [0]),
        ...
        ('topk', (S, M, S), (3,)),
        ('topk', (S, M, S), (3, 1), 'dim', False, [1]),
        ('topk', (S, M, S), (3, 1, True), 'dim_desc', False, [1]),
        ('topk', (S, M, S), (3, 1, True, True), 'dim_desc_sort', False, [1]),
        ('topk', (), (1,), 'scalar'),
        ('topk', (), (1, 0), 'dim_scalar', False, [1]),
        ('topk', (), (1, 0, True), 'dim_desc_scalar', False, [1]),
        ('topk', (), (1, 0, True, True), 'dim_desc_sort_scalar', False, [1]),
