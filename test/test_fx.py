...
class TestFX(JitTestCase):
    ...
    def test_module_qualname(self):
        ...
        def print_nodes(nodes : List[torch.fx.Node]):
            from tabulate import tabulate
            node_specs = [[n.op, n.name, n.target, n.module_qualname] for n in nodes]
            print(tabulate(node_specs, headers=['opcode', 'name', 'target', 'module qualname']))

        # print_nodes(traced.graph.nodes)
