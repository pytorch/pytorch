...
class TestFX(JitTestCase):
    ...
    def test_stack_traces(self):
        ...
        self.assertExpectedInline(
            stack_traces.strip(),
"""\
File "/data/users/angelayi/pytorch/test/test_fx.py", line 721, in forward
    c = a + b
File "/data/users/angelayi/pytorch/test/test_fx.py", line 722, in forward
    c = foo(a, c)
  File "/data/users/angelayi/pytorch/test/test_fx.py", line 713, in foo
    return a * b""",
        )
