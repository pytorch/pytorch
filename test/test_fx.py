...
class TestFX(JitTestCase):
    ...
    def user_friendly_call_provenance_with_function(self):
        ...
        with self.assertRaisesRegex(RuntimeError, "'wrapper_fn' is "
                                    ...
                                    " from 'nnModule_with_autogenerated"
                                    "_forward_wrapping_user_function_to"
                                    "_trace.forward'"):
            scripted = torch.jit.script(traced)

    def user_friendly_call_provenance_with_module(self):
        torch.fx.wrap('wrapper_fn')
