...
TEST_BINARY = "build/bin/kernel_function_legacy_test"


class TestOperatorRegistrationTest_LegacyFunctionBasedKernel(TestCase):
    cpp_name = "OperatorRegistrationTest_LegacyFunctionBasedKernel"
