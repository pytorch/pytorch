...
TEST_BINARY = "build/bin/kernel_lambda_test"


class TestOperatorRegistrationTest_LambdaBasedKernel(TestCase):
    cpp_name = "OperatorRegistrationTest_LambdaBasedKernel"
    ...
    def test_givenOutOfLineKernel_whenRegistered_thenCanBeCalled(self):
        run_cpp_test(
            TEST_BINARY,
            self.cpp_name,
