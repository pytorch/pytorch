...
TEST_F(ProcessGroupNCCLTest, CUDAEventCache) {
  ...
  auto event1 = c10d::ProcessGroupNCCL::CUDAEventCache::get().create(1, true);
  auto event2 = c10d::ProcessGroupNCCL::CUDAEventCache::get().create(1, false);
  ...
  auto event3 = c10d::ProcessGroupNCCL::CUDAEventCache::get().create(2, true);
  auto event4 = c10d::ProcessGroupNCCL::CUDAEventCache::get().create(2, false);
  // The cache has been used up, new events should be created.
  auto event5 = c10d::ProcessGroupNCCL::CUDAEventCache::get().create(1, true);
  auto event6 = c10d::ProcessGroupNCCL::CUDAEventCache::get().create(1, false);
  // The cache has been used up, new events should be created.
  auto event7 = c10d::ProcessGroupNCCL::CUDAEventCache::get().create(1, true);
  auto event8 = c10d::ProcessGroupNCCL::CUDAEventCache::get().create(1, false);
