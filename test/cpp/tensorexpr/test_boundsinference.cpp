...
void testBoundsInference_1() {
  ...
  ExprHandle n(100);
  ExternalTensor a(BufHandle("a", {n}, kFloat));
  Tensor* b =
...
void testBoundsInference_3() {
  ...
  KernelScope kernel_scope;
  ExprHandle n(100);
  ExternalTensor a(BufHandle("a", {n + 10}, kFloat));
  Tensor* b = Compute(
...
void testBoundsInference_4() {
  ...
  ExprHandle W(320);
  ExprHandle H(200);
  ExternalTensor a(BufHandle("a", {H, W}, kFloat));
  Tensor* b = Compute(
...
void testBoundsInferenceNonOverlapping() {
  KernelScope kernel_scope;
  ExprHandle H(3);
  ExternalTensor a(BufHandle("a", {10}, kFloat));
  Tensor* b =
...
void testBoundsInferenceAdjacent() {
  KernelScope kernel_scope;
  ExprHandle H(6);
  ExternalTensor a(BufHandle("a", {20}, kFloat));
  Tensor* b =
      Compute("b", {{H, "x"}}, [&](const VarHandle& x) { return a(x); });
  Tensor* c =
...
void testMergeInferred2DBounds() {
  KernelScope kernel_scope;
  ExternalTensor a(BufHandle("a", {10, 10}, kFloat));
