...
void testATen_cast_Float() {
  ...
  ExternalTensor a_buf(BufHandle("A", {ExprHandle(kTotalSize)}, kInt));
  ExternalTensor b_buf(BufHandle("B", {ExprHandle(kTotalSize)}, kFloat));
...
void testATennegInt() {
  ...
  const int kTotalSize = 128;
  ExternalTensor a_buf(BufHandle("A", {ExprHandle(kTotalSize)}, kInt));
  ExternalTensor b_buf(BufHandle("B", {ExprHandle(kTotalSize)}, kInt));
...
void testATennegFloat() {
  KernelScope kernel_scope;
  const int kTotalSize = 128;
  ExternalTensor a_buf(BufHandle("A", {ExprHandle(kTotalSize)}, kFloat));
  ExternalTensor b_buf(BufHandle("B", {ExprHandle(kTotalSize)}, kFloat));
...
void testATenaddInt() {
  ...
  ExternalTensor a_buf(BufHandle("A", {ExprHandle(kTotalSize)}, kInt));
  ExternalTensor b_buf(BufHandle("B", {ExprHandle(kTotalSize)}, kInt));
  ExternalTensor c_buf(BufHandle("C", {ExprHandle(kTotalSize)}, kInt));
  ExternalTensor d_buf(BufHandle("D", {ExprHandle(kTotalSize)}, kInt));
...
void testATenaddFloat() {
  ...
  ExternalTensor a_buf(BufHandle("A", {ExprHandle(kTotalSize)}, kFloat));
  ExternalTensor b_buf(BufHandle("B", {ExprHandle(kTotalSize)}, kFloat));
  ExternalTensor c_buf(BufHandle("C", {ExprHandle(kTotalSize)}, kFloat));
  ExternalTensor d_buf(BufHandle("D", {ExprHandle(kTotalSize)}, kFloat));
...
void testATenaddcmulInt() {
  ...
  ExternalTensor c_buf(BufHandle("C", {ExprHandle(kTotalSize)}, kInt));
  ExternalTensor d_buf(BufHandle("D", {ExprHandle(kTotalSize)}, kInt));
  ExternalTensor e_buf(BufHandle("E", {ExprHandle(kTotalSize)}, kInt));
...
void testATenaddcmulFloat() {
  ...
  ExternalTensor c_buf(BufHandle("C", {ExprHandle(kTotalSize)}, kFloat));
  ExternalTensor d_buf(BufHandle("D", {ExprHandle(kTotalSize)}, kFloat));
  ExternalTensor e_buf(BufHandle("E", {ExprHandle(kTotalSize)}, kFloat));
...
void testATeneqInt() {
  KernelScope kernel_scope;
  constexpr int N = 128;
  ExternalTensor a(BufHandle("A", {N}, kInt));
  ExternalTensor b(BufHandle("B", {N}, kInt));
  ExternalTensor c(BufHandle("C", {N}, kInt));
