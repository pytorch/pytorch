...
void testATen_cast_Float() {
  ...
  Buffer a_buf(BufHandle("A", kHandle, {ExprHandle(kTotalSize)}), kInt);
  Buffer b_buf(BufHandle("B", kHandle, {ExprHandle(kTotalSize)}), kFloat);
...
void testATennegInt() {
  ...
  const int kTotalSize = 128;
  Buffer a_buf(BufHandle("A", kHandle, {ExprHandle(kTotalSize)}), kInt);
  Buffer b_buf(BufHandle("B", kHandle, {ExprHandle(kTotalSize)}), kInt);
...
void testATenaddInt() {
  ...
  Buffer a_buf(BufHandle("A", kHandle, {ExprHandle(kTotalSize)}), kInt);
  Buffer b_buf(BufHandle("B", kHandle, {ExprHandle(kTotalSize)}), kInt);
  Buffer c_buf(BufHandle("C", kHandle, {ExprHandle(kTotalSize)}), kInt);
  Buffer d_buf(BufHandle("D", kHandle, {ExprHandle(kTotalSize)}), kInt);
...
void testATenaddFloat() {
  ...
  Buffer a_buf(BufHandle("A", kHandle, {ExprHandle(kTotalSize)}), kFloat);
  Buffer b_buf(BufHandle("B", kHandle, {ExprHandle(kTotalSize)}), kFloat);
  Buffer c_buf(BufHandle("C", kHandle, {ExprHandle(kTotalSize)}), kFloat);
  Buffer d_buf(BufHandle("D", kHandle, {ExprHandle(kTotalSize)}), kFloat);
...
void testATenaddcmulInt() {
  ...
  Buffer c_buf(BufHandle("C", kHandle, {ExprHandle(kTotalSize)}), kInt);
  Buffer d_buf(BufHandle("D", kHandle, {ExprHandle(kTotalSize)}), kInt);
  Buffer e_buf(BufHandle("E", kHandle, {ExprHandle(kTotalSize)}), kInt);
...
void testATenaddcmulFloat() {
  ...
  Buffer c_buf(BufHandle("C", kHandle, {ExprHandle(kTotalSize)}), kFloat);
  Buffer d_buf(BufHandle("D", kHandle, {ExprHandle(kTotalSize)}), kFloat);
  Buffer e_buf(BufHandle("E", kHandle, {ExprHandle(kTotalSize)}), kFloat);
