...
void testReduceSum1D() {
  ...
  ExternalTensor b(BufHandle("b", {10}, kFloat));
...
void testReduceSum2D() {
  ...
  ExternalTensor b(BufHandle("b", {m, n}, kFloat));
...
void testReduceSum3D() {
  ...
  ExternalTensor b(BufHandle("b", {2, 3, m}, kFloat));
  ...
  ExternalTensor c_buf(BufHandle(c->func_var()));
...
void testReduceSum10D() {
  ...
  ExternalTensor in_(BufHandle("in_", {2, 3, 2, 3, 2, 3, 2, 3, 2, 3}, kFloat));
  const int InputSize = 2 * 3 * 2 * 3 * 2 * 3 * 2 * 3 * 2 * 3;
  ExternalTensor out_(BufHandle("out_", {2, 3, 2, 3, 2}, kFloat));
...
void testReduceMax() {
  ...
  ExternalTensor in_(BufHandle("b", {10}, kFloat));
  ...
  ExternalTensor in2_(BufHandle("b", {2, 5}, kFloat));
...
void testReduceAnyAll() {
  ...
  ExternalTensor b(BufHandle("b", {4, 10}, kInt));
...
void testReduceMatmul2D() {
  ...
  ExternalTensor tA(BufHandle("tA", {3, 2}, kFloat));
  ExternalTensor tB(BufHandle("tB", {2, 3}, kFloat));
...
void testReduceRfactorLike() {
  ...
  ExternalTensor in(BufHandle("in", {10, 10}, kFloat));
  ...
  ExternalTensor in_rf(BufHandle(l1->func_var()));
...
void testReduceAsProducer() {
  ...
  ExternalTensor a(BufHandle("a", {2, 3}, kFloat));
  ExternalTensor b(BufHandle("b", {2, 3, m}, kFloat));
...
void testReduceAsConsumer() {
  ...
  ExternalTensor a(BufHandle("a", {2, 3, m}, kFloat));
  ExternalTensor b(BufHandle("b", {2, 3, m}, kFloat));
...
void testSplitReduceAxis() {
  ...
  ExternalTensor in(BufHandle("in", {16, 8}, kFloat));
...
void testReorderedReductionInitializer() {
  ...
  */
  ...
  ExternalTensor in(BufHandle("in", {1, 12, 6}, kFloat));
...
void testReduce3DRfactorInternal() {
  ...
  ExternalTensor b(BufHandle("b", {m, n, k}, kFloat));
...
void testReduce3DRfactorWithOuter() {
  ...
  ExternalTensor b(BufHandle("b", {l, m, n, k}, kFloat));
...
void testReduceRepeatedInternalRfactor() {
  ...
  ExternalTensor in_(BufHandle("in_", {2, 3, 4, 5, 6}, kFloat));
...
void testReduceOverSplitRfactor() {
  ...
  ExternalTensor b(BufHandle("b", {N, K}, kFloat));
...
void testReduceInlineReduction() {
  ...
  ExternalTensor a_buf("a", kFloat, {M});
  ExternalTensor b_buf("b", kFloat, {M, N, K});
...
void testReduceInlineConsumer() {
  ...
  ExternalTensor a_buf("a", kFloat, {M, N, K});
  ExternalTensor b_buf("b", kFloat, {M, N, K});
