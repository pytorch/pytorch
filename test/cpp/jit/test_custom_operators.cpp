...
void testTemplatedOperatorCreator() {
...

  {
    ...
    {OperatorGenerator<c10::impl::op_whitelist_contains(
      op_list, "foofoo::not_exist")>(
      "foofoo::not_exist(float a, Tensor b) -> Tensor",
      [](Stack* stack) {
        double a;
        at::Tensor b;
        pop(stack, a, b);
...

  {
    torch::jit::RegisterOperators reg(
    {OperatorGenerator<c10::impl::op_whitelist_contains(
      op_list, "foofoo::bar.template")>(
      "foofoo::bar.template(float a, Tensor b) -> Tensor",
      [](Stack* stack) {
        double a;
        at::Tensor b;
        pop(stack, a, b);
