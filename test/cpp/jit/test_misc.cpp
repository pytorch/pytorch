...
void testATenNativeBatchNorm() {
  ...
  at::Tensor running_mean_eager = running_mean.clone(MemoryFormat::Contiguous);
  at::Tensor running_var_eager = running_var.clone(MemoryFormat::Contiguous);
  at::Tensor running_mean_jit = running_mean.clone(MemoryFormat::Contiguous);
  at::Tensor running_var_jit = running_var.clone(MemoryFormat::Contiguous);
