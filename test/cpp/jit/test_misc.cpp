...
void testTHNNConv() {
  ...
  // make grad_outputs
  at::Tensor grad_output = torch::randn_like(
      output, at::MemoryFormat::Preserve, torch::MemoryFormat::Preserve);
  at::Tensor grad_finput = torch::zeros_like(
      finput, at::MemoryFormat::Preserve, torch::MemoryFormat::Preserve);
  at::Tensor grad_fgradinput = torch::zeros_like(
      fgradinput, at::MemoryFormat::Preserve, torch::MemoryFormat::Preserve);
...
void testATenNativeBatchNorm() {
  ...
  at::Tensor grad_output = torch::randn_like(
      output, at::MemoryFormat::Preserve, torch::MemoryFormat::Preserve);
  at::Tensor grad_savemean = torch::zeros_like(
      savemean, at::MemoryFormat::Preserve, torch::MemoryFormat::Preserve);
  at::Tensor grad_saveinvstd = torch::zeros_like(
      saveinvstd, at::MemoryFormat::Preserve, torch::MemoryFormat::Preserve);
...
void testRecordFunction() {
  ...
  t2.backward(torch::ones_like(
      t2, at::MemoryFormat::Preserve, torch::MemoryFormat::Preserve));
