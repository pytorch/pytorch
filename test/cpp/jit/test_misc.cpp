...
TEST(AutodiffNick, Basic) {

  {
    ...
    auto test1 = graph->copy();
    CreateAutodiffSubgraphs(test1, 1);

    testing::FileCheck().check("prim::DifferentiableGraph")->check("aten::relu")->check("aten::split_with_sizes")->run(*test1);
  }

  {
    ...
    testing::FileCheck().check("prim::DifferentiableGraph")->check("aten::relu")->check("prim::DifferentiableGraph")->check("aten::split_with_sizes")->run(*test1);
  }
