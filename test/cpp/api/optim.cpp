...
struct MyOptimizerOptions
 ...
 public:
  ...
  void serialize(torch::serialize::InputArchive& archive) override {
    // Simple test implementation - deserialize lr
    c10::IValue lr_val;
    if (archive.try_read("lr", lr_val)) {
      lr_ = lr_val.toDouble();
    }
    // Deserialize field tracking
  ...
  void serialize(torch::serialize::OutputArchive& archive) const override {
    // Simple test implementation - serialize lr
    archive.write("lr", lr_);
