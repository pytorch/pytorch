...
inline std::vector<std::vector<torch::Tensor>> NAdam() {
  return {
      {
          torch::tensor(
              {0.8455488600597577,
               ...
               1.7540081778389252}),
          torch::tensor(
              {0.9479193627461677, 0.7585031325924008, 1.7456530487827335}),
          torch::tensor(
              {-1.1072548852462731, -1.4505869402280274, -1.3407893679345066}),
          torch::tensor({-1.127589900843011}),
      },
      {
          torch::tensor(
              {3.808525334064568,
               ...
               3.3406243842498937}),
          torch::tensor(
              {4.213402859697652, 2.7297024233067124, 3.415611473576851}),
          torch::tensor(
              {-3.0797743371849706, -3.4264645282826143, -3.0373995980602637}),
          torch::tensor({-2.7151235743328304}),
      },
      {
          torch::tensor(
              {3.8145406690593253,
               ...
               3.3464757556522056}),
          torch::tensor(
              {4.224712237360104, 2.7430175192696122, 3.4241472631130754}),
          torch::tensor(
              {-3.1408313414540574, -3.490756898976124, -3.0726267993289147}),
          torch::tensor({-2.7403367574477024}),
      },
      {
          torch::tensor(
              {3.820918113526238,
               ...
               3.3527220805224145}),
          torch::tensor(
              {4.236900322977649, 2.7574265227006634, 3.4333295831399884}),
          torch::tensor(
              {-3.207388350781274, -3.5608655250635635, -3.1109723431027247}),
          torch::tensor({-2.767742025288963}),
      },
      {
          torch::tensor(
              {3.82728099476795,
               ...
               3.3589257546541433}),
          torch::tensor(
              {4.249074444247484, 2.771762018661165, 3.4424559296551975}),
          torch::tensor(
              {-3.273475939791809, -3.6304955279790727, -3.1490490237581827}),
          torch::tensor({-2.794953142799242}),
      },
      {
          torch::tensor(
              {3.8333923623944512,
               ...
               3.364859685647557}),
          torch::tensor(
              {4.260780267745115, 2.7854940749139327, 3.451191660417939}),
          torch::tensor(
              {-3.3366858463886393, -3.6971081599567444, -3.1854691801764106}),
          torch::tensor({-2.8209785957217006}),
      },
      {
          torch::tensor(
              {3.8391705126393236,
               ...
               3.370449764663232}),
          torch::tensor(
              {4.27185938703322, 2.7984454681523436, 3.4594266816806134}),
          torch::tensor(
              {-3.3962375389633683, -3.7598784713424425, -3.2197828537432565}),
          torch::tensor({-2.8454971409525833}),
      },
      {
          torch::tensor(
              {3.8446021640510644,
               ...
               3.3756880353048144}),
          torch::tensor(
              {4.282284274210901, 2.8105928886584852, 3.4671482305210484}),
          torch::tensor(
              {-3.452052104674049, -3.818720793011884, -3.2519443298107498}),
          torch::tensor({-2.8684764216185537}),
      },
      {
          torch::tensor(
              {3.8497028899894223,
               ...
               3.380593629085139}),
          torch::tensor(
              {4.292082910328713, 2.8219769121373974, 3.474383559648215}),
          torch::tensor(
              {-3.5043366947601395, -3.8738512624248376, -3.2820727499142954}),
          torch::tensor({-2.890001845151978}),
      },
      {
          torch::tensor(
              {3.854499078733169,
               ...
               3.3851952417323243}),
          torch::tensor(
              {4.301304323200461, 2.832661292229237, 3.4811741757322263}),
          torch::tensor(
              {-3.553398648131635, -3.925592019423143, -3.310345022353981}),
          torch::tensor({-2.910200047347327}),
      },
      {
          torch::tensor(
              {3.8590197932330357,
               ...
               3.389523393607582}),
          torch::tensor(
              {4.310002974299103, 2.8427147987262407, 3.4875644293687262}),
          torch::tensor(
              {-3.5995636766524894, -3.9742849444429504, -3.3369486785734623}),
          torch::tensor({-2.9292052086185825}),
      },
  };
}

inline std::vector<std::vector<torch::Tensor>> NAdam_with_weight_decay() {
  return {
      {
          torch::tensor(
              {0.8455506876221865,
               ...
               1.7540077113639883}),
          torch::tensor(
              {0.9479194963019781, 0.7585031394209457, 1.7456529989666612}),
          torch::tensor(
              {-1.1072548851831308, -1.4505869396635285, -1.340789367816735}),
          torch::tensor({-1.1275899008282597}),
      },
      {
          torch::tensor(
              {0.4864078847111789,
               ...
               0.5619280578114753}),
          torch::tensor(
              {0.9656077835206408, 0.8784254808292996, 0.9600561454653113}),
          torch::tensor(
              {-1.4285458012849412, -1.4790386151361834, -1.416041920254233}),
          torch::tensor({-2.2296202961418268}),
      },
      {
          torch::tensor(
              {0.483683247857017,
               ...
               0.5642629066564154}),
          torch::tensor(
              {0.9631785716529463, 0.9318275680444019, 0.9826363270120254}),
          torch::tensor(
              {-1.4900035845055009, -1.5134038329816053, -1.4531775989967415}),
          torch::tensor({-2.3022498667887774}),
      },
      {
          torch::tensor(
              {0.4789386305331415,
               ...
               0.5641854563334038}),
          torch::tensor(
              {0.9573630504065938, 0.9404703380904295, 0.9900639979386934}),
          torch::tensor(
              {-1.5425138904541824, -1.5579526432008222, -1.4928639617621482}),
          torch::tensor({-2.364522676455488}),
      },
      {
          torch::tensor(
              {0.47290310579981754,
               ...
               0.5604933850744296}),
          torch::tensor(
              {0.9494269011503664, 0.9379530050369606, 0.9898756100971756}),
          torch::tensor(
              {-1.585464032618443, -1.5969068999579314, -1.5305586295355658}),
          torch::tensor({-2.4152366299158317}),
      },
      {
          torch::tensor(
              {0.4666046085085464,
               ...
               0.554050639514934}),
          torch::tensor(
              {0.9413218400307958, 0.9328616717763942, 0.9841827528367978}),
          torch::tensor(
              {-1.6168519243593182, -1.6254356372167456, -1.5625831290648742}),
          torch::tensor({-2.4526353348914958}),
      },
      {
          torch::tensor(
              {0.4606399214429952,
               ...
               0.546293113620038}),
          torch::tensor(
              {0.934047240001613, 0.9276893637473594, 0.9754025454350912}),
          torch::tensor(
              {-1.6380092549921297, -1.644406910642449, -1.587800582272856}),
          torch::tensor({-2.4783307900172904}),
      },
      {
          torch::tensor(
              {0.45511956445550583,
               ...
               0.5382351143253414}),
          torch::tensor(
              {0.9276916952430735, 0.922898434495468, 0.9653578150514411}),
          torch::tensor(
              {-1.6515066067723672, -1.656271824596499, -1.6067898561769862}),
          torch::tensor({-2.495011920705406}),
      },
      {
          torch::tensor(
              {0.44997665561649564,
               ...
               0.5304133902312136}),
          torch::tensor(
              {0.9220322132116303, 0.9184116233000772, 0.9551275613986971}),
          torch::tensor(
              {-1.6596657514643394, -1.6632400907069462, -1.6206797545047984}),
          torch::tensor({-2.5050990081776194}),
      },
      {
          torch::tensor(
              {0.44512723827401923,
               ...
               0.523059968544636}),
          torch::tensor(
              {0.9168394592116772, 0.9140956768720228, 0.9452634086798475}),
          torch::tensor(
              {-1.6641937138172227, -1.6669073488993096, -1.6305861136363293}),
          torch::tensor({-2.510441342518952}),
      },
      {
          torch::tensor(
              {0.4405116315925978,
               ...
               0.5162455964031243}),
          torch::tensor(
              {0.911954434888466, 0.9098661205766535, 0.9360080906896674}),
          torch::tensor(
              {-1.6662596403305332, -1.668350177406427, -1.6374412905830076}),
          torch::tensor({-2.5123814291659747}),
      },
  };
}

inline std::vector<std::vector<torch::Tensor>>
NAdam_with_weight_decay_and_momentum_decay() {
  return {
      {
          torch::tensor(
              {0.8512485643006872,
               ...
               1.7597079002540847}),
          torch::tensor(
              {0.9536190821289361, 0.764202857625014, 1.7513527733060377}),
          torch::tensor(
              {-1.1129546109409603, -1.4562866659096467, -1.3464890937119767}),
          torch::tensor({-1.133289626653218}),
      },
      {
          torch::tensor(
              {3.702644743673464,
               ...
               3.728852740450963}),
          torch::tensor(
              {4.708054863502068, 3.268956328183281, 3.8969481939014865}),
          torch::tensor(
              {-3.5938215393986215, -3.939005632275755, -3.553693449549942}),
          torch::tensor({-3.2307816041043096}),
      },
      {
          torch::tensor(
              {2.4075779091772285,
               ...
               3.4519390995162156}),
          torch::tensor(
              {4.185040491642612, 3.208753285212733, 3.7812045467788638}),
          torch::tensor(
              {-3.5868825174648884, -3.9299476125748845, -3.549869225057226}),
          torch::tensor({-3.2287216933969503}),
      },
      {
          torch::tensor(
              {1.3533127899164648,
               ...
               3.1155971762512196}),
          torch::tensor(
              {3.58228940332175, 3.1305473483883293, 3.6329868432851713}),
          torch::tensor(
              {-3.577814806285718, -3.9181505353229555, -3.5447491316628317}),
          torch::tensor({-3.2258654768827144}),
      },
      {
          torch::tensor(
              {0.6803572226740746,
               ...
               2.7509187180843693}),
          torch::tensor(
              {2.980644271225906, 3.0387523875891116, 3.4615309181457197}),
          torch::tensor(
              {-3.5678894059145216, -3.9051497868638374, -3.5392240279982303}),
          torch::tensor({-3.2228960490750236}),
      },
      {
          torch::tensor(
              {0.3462496307178541,
               ...
               2.380706637303925}),
          torch::tensor(
              {2.452507445235617, 2.936540696719008, 3.2738602912845365}),
          torch::tensor(
              {-3.5583925903015596, -3.8927009777523485, -3.534214343360911}),
          torch::tensor({-3.2204712893710576}),
      },
      {
          torch::tensor(
              {0.2533392678373972,
               ...
               2.0230872965989826}),
          torch::tensor(
              {2.0615844343743674, 2.827037695271787, 3.076846654629609}),
          torch::tensor(
              {-3.550842913000194, -3.883018625145288, -3.530896456975855}),
          torch::tensor({-3.2194556243018413}),
      },
      {
          torch::tensor(
              {0.2871365371766481,
               ...
               1.6925612968378994}),
          torch::tensor(
              {1.8271496148359394, 2.713451342900924, 2.8777712112604097}),
          torch::tensor(
              {-3.546145407019255, -3.8774301276066545, -3.529961577013437}),
          torch::tensor({-3.220396027471372}),
      },
      {
          torch::tensor(
              {0.3478119295118012,
               ...
               1.4001027167244708}),
          torch::tensor(
              {1.7123261515739665, 2.5988783327316245, 2.6840563999010265}),
          torch::tensor(
              {-3.5443154075235275, -3.87570199656214, -3.531243397263812}),
          torch::tensor({-3.223251559957329}),
      },
      {
          torch::tensor(
              {0.3919433217266331,
               ...
               1.1532531990152166}),
          torch::tensor(
              {1.669038790845849, 2.48641304275178, 2.5029858685424076}),
          torch::tensor(
              {-3.545247515731621, -3.8772231426463675, -3.53436299400444}),
          torch::tensor({-3.2278471327305507}),
      },
      {
          torch::tensor(
              {0.41721782880314223,
               ...
               0.9560849329892752}),
          torch::tensor(
              {1.6645940368274674, 2.3792681540930998, 2.341209738215551}),
          torch::tensor(
              {-3.5490580710204003, -3.881694037765813, -3.5391153803146387}),
          torch::tensor({-3.2341411689429527}),
      },
  };
}
