...
a")
    ...
    def test_math_ops(self):
        ...
        for i in num_list_int:
            ...
            self.checkScript(test_log_int, (i,))
            self.checkScript(test_log1p_int, (i,))
            self.checkScript(test_log10_int, (i,))
            self.checkScript(test_exp_int, (i,))
            self.checkScript(test_sqrt_int, (i,))
            self.checkScript(test_pow_int, (2.0, i))
        ...
        for i in num_list_float:
            self.checkScript(test_floor, (i,))
            self.checkScript(test_ceil, (i,))
            self.checkScript(test_log_float, (i,))
            self.checkScript(test_log1p_float, (i,))
            self.checkScript(test_log10_float, (i,))
            self.checkScript(test_exp_float, (i,))
            self.checkScript(test_sqrt_float, (i,))
            self.checkScript(test_pow_float, (2.0, i))
