...
nn_functional_tests = [
    ...
    ('max_pool1d', (S, S, S), (2, None), 'stride_none'),
    ('max_pool1d', (S, S, S), (2, 1, 1, 1, False, True), 'with_indices'),
    ('max_pool2d', (S, S, S, S), (2, 1), '', (True, 'aten::max_pool2d_with_indices')),
    ('max_pool2d', (S, S, S, S), (2, None), 'stride_none', (True, 'aten::max_pool2d_with_indices')),
    ('max_pool2d', (S, S, S, S), (2, 1, 1, 1, False, True), 'with_indices', (True, 'aten::max_pool2d_with_indices')),
    ('max_pool2d', (S, S, S, S), (2, None, 0, 1, True), 'with_indices_stride_none', (True, 'aten::max_pool2d_with_indices')),
    ('max_pool3d', (S, S, S, S, S), (2, 1)),
    ('max_pool3d', (S, S, S, S, S), (2, None), 'stride_none'),
    ('max_unpool1d', torch.tensor([[[2., 4]]]), (torch.tensor([[[1, 3]]]), 2, 2, 0)),
    ('max_unpool2d', torch.tensor([[[[2., 4]]]]), (torch.tensor([[[[1, 3]]]]), 2, 2, 0)),
    ('max_unpool2d', torch.tensor([[[[2., 4]]]]), (torch.tensor([[[[1, 3]]]]), 2, None, 0), 'stride_none'),
    ('max_unpool3d', torch.tensor([[[[[2., 4]]]]]), (torch.tensor([[[[[1, 3]]]]]), 2, 2, 0)),
    ('max_unpool3d', torch.tensor([[[[[2., 4]]]]]), (torch.tensor([[[[[1, 3]]]]]), 2, None, 0), 'stride_none'),
    ('lp_pool1d', (S, S, S), (2., 3, 2,)),
    ('lp_pool1d', (S, S, S), (2., 3, None,), 'stride_none'),
    ('lp_pool2d', (S, S, S, S), (2., 3, 2,)),
    ('lp_pool2d', (S, S, S, S), (2., 3, None,), 'stride_none'),
