...
class TestRecursiveScript(JitTestCase):
    ...
    def test_error_stack_module(self):
        ...
        try:
            ...
            checker.check("it was called from \'b\'")
            checker.check("return c(x)")
            checker.check("it was called from \'__torch__.Submodule.forward\'")
            checker.check("return b(x)")
            checker.check("it was called from \'__torch__.M.some_method\'")
            checker.check("return y + self.submodule(y)")
            checker.check("it was called from \'__torch__.M.forward\'")
