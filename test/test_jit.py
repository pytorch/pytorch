...
graph(%Ra, %Rb):
  return (%Ra)""", graph)
    ...
    def test_mutable_default_values(self):
        with self.assertRaisesRegex(Exception, "Invalid default value for argument x"):
            @torch.jit.script
        ...
        with self.assertRaisesRegex(Exception, "Invalid default value for argument input"):
