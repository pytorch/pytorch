...
nn_functional_tests = [
    ...
    ('interpolate', torch.zeros(3, 3).view(1, 1, 3, 3), (2, None, 'nearest', None, True), 'nearest_4d_use_scale_factor', (True, 'aten::__interpolate')),
    ('interpolate', torch.randn(S, S, M, M), (4, None, 'nearest', None, True), 'nearest_4d_with_size_use_scale_factor', (True, 'aten::__interpolate')),
    ('interpolate', torch.randn(S, S, M, M), (None, 2., 'bilinear', None, True), 'bilinear_4d_with_scale_use_scale_factor', (True, 'aten::__interpolate')),
    ('interpolate', torch.randn(S, S, M, M), (4, None, 'bilinear', None, True), 'bilinear_4d_with_size_use_scale_factor', (True, 'aten::__interpolate')),
    ('interpolate', torch.randn(S, S, M, M), (None, 2., 'bicubic', None, True), 'bicubic_4d_with_scale_use_scale_factor', (True, 'aten::__interpolate')),
    ('interpolate', torch.randn(S, S, M, M), (4, None, 'bicubic', None, True), 'bicubic_4d_with_size_use_scale_factor', (True, 'aten::__interpolate')),
    ('interpolate', torch.randn(S, M, M), (None, 2., 'nearest', None, True), 'nearest_3d_with_scale_use_scale_factor', (True, 'aten::__interpolate')),
    ('interpolate', torch.randn(S, M, M), (4, None, 'nearest', None, True), 'nearest_3d_with_size_use_scale_factor', (True, 'aten::__interpolate')),
    ('interpolate', torch.randn(S, M, M), (None, 2., 'linear', None, True), 'linear_3d_with_scale_use_scale_factor', (True, 'aten::__interpolate')),
    ('interpolate', torch.randn(S, M, M), (4, None, 'linear', None, True), 'linear_3d_with_size_use_scale_factor', (True, 'aten::__interpolate')),
