...
class GraphModePostTrainingQuantTest(QuantizationTestCase):
    ...
    @unittest.skip("Temporarily skip the test since we don't have
    support for different quantization configurations for shared
    ClassType right now, sub1.fc and fc3 shares the ClassType but for sub1.fc qconfig is
    None, and fc3 is quantized with default_qconfig")
