...
class AnnotateTests(torch._dynamo.test_case.TestCase):
    ...
    def test_annotations(self):
        ...
        dynamo_metadata = fx_traceback.get_custom_metadata(backend.graphs[0])
        fw_metadata = fx_traceback.get_custom_metadata(backend.fw_graphs[0])
        bw_metadata = fx_traceback.get_custom_metadata(backend.bw_graphs[0])
