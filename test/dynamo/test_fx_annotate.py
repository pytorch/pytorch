...
('call_function', 'sub', {'pp_stage': 0, 'fdsp_bucket': 0})
('call_function', 'mul', {'pp_stage': 0, 'fdsp_bucket': 0, 'cuda_stream': 2, 'fsdp_bucket': 1})""",  # noqa: B950
        )
        self.assertExpectedInline(
            str(fw_metadata),
            """\
...
('call_function', 'mul', {'pp_stage': 0, 'fdsp_bucket': 0, 'cuda_stream': 2, 'fsdp_bucket': 1})""",  # noqa: B950
        ...
        self.assertExpectedInline(
            str(bw_metadata),
            """\
('call_function', 'mul_1', {'pp_stage': 0, 'fdsp_bucket': 0, 'cuda_stream': 2, 'fsdp_bucket': 1})
