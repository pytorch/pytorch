...
{'accumulated_cache_size': None,
 ...
 'triton_version': None}""",  # noqa: B950
    ...
    @inductor_config.patch({"trace.enabled": True, "trace.provenance_tracking_level": 1})
    def test_inductor_provenance(self):
        ...
        with mock.patch("torch._dynamo.utils.log_compilation_event") as log_event:
            ...
            compilation_events = [arg[0][0] for arg in log_event.call_args_list]
        self.assertEqual(compilation_events[0].inductor_provenance, {'{"extern_kernels.addmm:1": []}'})
