...
""",
            ...
            self.assertExpectedInline(
                ...
                """\
class GraphModule(torch.nn.Module):
    def forward(self, L_lambda0_keywords_y_: "f32[s9, s25]", s9: "Sym(s9)", s25: "Sym(s25)"):
        l_lambda0_keywords_y_ = L_lambda0_keywords_y_
...
class GraphModule(torch.nn.Module):
    def forward(self, L_lambda0_keywords_y_: "f32[s9, s25]", s9: "Sym(s9)", s25: "Sym(s25)"):
        ...
        add: "f32[s9, s25]" = l_lambda0_keywords_y_ + l_lambda0_keywords_y_

        mul: "f32[s9, s25]" = l_lambda0_keywords_y_ * l_lambda0_keywords_y_;  l_lambda0_keywords_y_ = None
