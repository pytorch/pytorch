...
"""Tests for nb_or (|), nb_subtract (-), nb_add (+), nb_lshift (<<), nb_rshift (>>) operators in PyTorch Dynamo."""
...
instantiate_parametrized_tests(TestNbLshift)
instantiate_parametrized_tests(TestNbRshift)
