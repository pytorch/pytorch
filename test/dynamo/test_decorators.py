...
class GraphModule(torch.nn.Module):
    def forward(self, tangents_1: "f32[3, 3]"):
        ...
        invoke_leaf_function_1 = torch.ops.higher_order.invoke_leaf_function(_tree_spec_constant3, _tree_spec_constant4, _tree_spec_constant5, tangents_1, requires_grad_indices = ());  _tree_spec_constant3 = _tree_spec_constant4 = _tree_spec_constant5 = tangents_1 = None
