...
from torch.utils.checkpoint import checkpoint, pt2_selective_checkpoint_context_fn_gen
...
class ActivationCheckpointingViaTagsTests(torch._dynamo.test_case.TestCase):
    ...
    def test_compile_selective_checkpoint_gemm_only(self):
        def selective_checkpointing_context_fn():
            ...
            return pt2_selective_checkpoint_context_fn_gen(
    ...
    def test_compile_selective_checkpoint_custom_rule(self):
        ...
        def selective_checkpointing_context_fn():
            meta = {}
            return pt2_selective_checkpoint_context_fn_gen(_get_custom_policy(meta))
