...
""",
    ...
    def test_register_subclass(self):
        ...
        with self.assertRaisesRegex(
            NotImplementedError,
            "no rule registered for HOP cond and subclass <class 'torch.testing._internal.two_tensor.TwoTensor'>",
        ):
    ...
    def test_register_mode(self):
        ...
        with self.assertRaisesRegex(
            NotImplementedError,
            "no rule registered for HOP cond and mode <dynamo.test_higher_order_ops.HigherOrderOpTests.test_register_mode.<locals>.MyMode",
        ):
            with MyMode():
