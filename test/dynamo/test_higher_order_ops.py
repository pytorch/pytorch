...
def forward(self, L_a_ : torch.SymInt, L_b_ : torch.SymInt, L_c_ : torch.SymInt, L_d_ : torch.SymInt):
    ...
    _vmap_increment_nesting_in_graph = torch._functorch.vmap._vmap_increment_nesting_in_graph(l_d_, 'error');  _vmap_increment_nesting_in_graph = None
    child = torch._functorch.vmap._add_batch_dim_in_graph(d, 0, 1);  d = None
    lazy_load_decompositions_1 = torch._functorch.vmap.lazy_load_decompositions();  lazy_load_decompositions_1 = None
    _vmap_increment_nesting_in_graph_1 = torch._functorch.vmap._vmap_increment_nesting_in_graph(l_c_, 'error');  _vmap_increment_nesting_in_graph_1 = None
    child_1 = torch._functorch.vmap._add_batch_dim_in_graph(c, 0, 2);  c = None
    lazy_load_decompositions_2 = torch._functorch.vmap.lazy_load_decompositions();  lazy_load_decompositions_2 = None
    _vmap_increment_nesting_in_graph_2 = torch._functorch.vmap._vmap_increment_nesting_in_graph(l_b_, 'error');  _vmap_increment_nesting_in_graph_2 = None
    child_2 = torch._functorch.vmap._add_batch_dim_in_graph(b, 0, 3);  b = None
    lazy_load_decompositions_3 = torch._functorch.vmap.lazy_load_decompositions();  lazy_load_decompositions_3 = None
    _vmap_increment_nesting_in_graph_3 = torch._functorch.vmap._vmap_increment_nesting_in_graph(l_a_, 'error');  _vmap_increment_nesting_in_graph_3 = None
    _add_batch_dim_in_graph_3 = torch._functorch.vmap._add_batch_dim_in_graph(a, 0, 4);  a = None
    add = _add_batch_dim_in_graph_3 + child_2;  _add_batch_dim_in_graph_3 = child_2 = None
    add_1 = add + child_1;  add = child_1 = None
    batched_outputs = add_1 + child;  add_1 = child = None
    batched_outputs_1 = torch._functorch.vmap._remove_batch_dim_in_graph(batched_outputs, 4, l_a_, 0);  batched_outputs = l_a_ = None
    ...
    batched_outputs_2 = torch._functorch.vmap._remove_batch_dim_in_graph(batched_outputs_1, 3, l_b_, 0);  batched_outputs_1 = l_b_ = None
    ...
    batched_outputs_3 = torch._functorch.vmap._remove_batch_dim_in_graph(batched_outputs_2, 2, l_c_, 0);  batched_outputs_2 = l_c_ = None
    _vmap_decrement_nesting_in_graph_2 = torch._functorch.vmap._vmap_decrement_nesting_in_graph();  _vmap_decrement_nesting_in_graph_2 = None
    _remove_batch_dim_in_graph_3 = torch._functorch.vmap._remove_batch_dim_in_graph(batched_outputs_3, 1, l_d_, 0);  batched_outputs_3 = l_d_ = None
    _vmap_decrement_nesting_in_graph_3 = torch._functorch.vmap._vmap_decrement_nesting_in_graph();  _vmap_decrement_nesting_in_graph_3 = None
    return (_remove_batch_dim_in_graph_3,)""",  # noqa: B950
            )
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]"):
        ...
        _vmap_increment_nesting_in_graph = torch._functorch.vmap._vmap_increment_nesting_in_graph(12, 'error');  _vmap_increment_nesting_in_graph = None

        child_1: "f32[4, 3]" = torch._functorch.vmap._add_batch_dim_in_graph(child, 0, 1);  child = None
        ...
        _vmap_increment_nesting_in_graph_1 = torch._functorch.vmap._vmap_increment_nesting_in_graph(12, 'error');  _vmap_increment_nesting_in_graph_1 = None

        _add_batch_dim_in_graph_1: "f32[4, 3]" = torch._functorch.vmap._add_batch_dim_in_graph(basis, 0, 3);  basis = None

        _autograd_grad = torch._functorch.eager_transforms._autograd_grad([primals_out], [diff_primals], [_add_batch_dim_in_graph_1], retain_graph = True, create_graph = True);  primals_out = diff_primals = _add_batch_dim_in_graph_1 = None
        batched_outputs: "f32[4, 3]" = _autograd_grad[0];  _autograd_grad = None

        chunked_result: "f32[12, 4, 3]" = torch._functorch.vmap._remove_batch_dim_in_graph(batched_outputs, 3, 12, 0);  batched_outputs = None
        ...
        results_1: "f32[12, 4, 3, 4, 3]" = torch._functorch.vmap._remove_batch_dim_in_graph(tangents_out_unflatten, 1, 12, 0);  tangents_out_unflatten = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]", L_y_: "f32[3, 4]"):
        ...
        child_1: "f32[3, 4]" = torch._functorch.vmap._add_batch_dim_in_graph(child, 0, 1);  child = None
        ...
        _autograd_grad = torch._functorch.eager_transforms._autograd_grad([primals_out], [child_4], [_add_batch_dim_in_graph_1], retain_graph = True, create_graph = True);  primals_out = child_4 = _add_batch_dim_in_graph_1 = None
        child_5: "f32[3, 4]" = _autograd_grad[0];  _autograd_grad = None

        child_6: "f32[12, 3, 4]" = torch._functorch.vmap._remove_batch_dim_in_graph(child_5, 3, 12, 0);  child_5 = None
        ...
        child_10: "f32[12, 4, 3, 3, 4]" = torch._functorch.vmap._remove_batch_dim_in_graph(child_9, 1, 12, 0);  child_9 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]"):
        ...
        _add_batch_dim_in_graph: "f32[4, 3]" = torch._functorch.vmap._add_batch_dim_in_graph(basis, 0, 1);  basis = None

        _autograd_grad = torch._functorch.eager_transforms._autograd_grad([primals_out], [diff_primals], [_add_batch_dim_in_graph], retain_graph = True, create_graph = True);  primals_out = diff_primals = _add_batch_dim_in_graph = None
        batched_outputs: "f32[4, 3]" = _autograd_grad[0];  _autograd_grad = None

        chunked_result: "f32[12, 4, 3]" = torch._functorch.vmap._remove_batch_dim_in_graph(batched_outputs, 1, 12, 0);  batched_outputs = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]", L_y_: "f32[3, 4]"):
        ...
        _add_batch_dim_in_graph: "f32[3, 4]" = torch._functorch.vmap._add_batch_dim_in_graph(basis, 0, 1);  basis = None

        _autograd_grad = torch._functorch.eager_transforms._autograd_grad([primals_out], [diff_primals], [_add_batch_dim_in_graph], retain_graph = True, create_graph = True);  primals_out = diff_primals = _add_batch_dim_in_graph = None
        batched_outputs: "f32[3, 4]" = _autograd_grad[0];  _autograd_grad = None

        chunked_result: "f32[12, 3, 4]" = torch._functorch.vmap._remove_batch_dim_in_graph(batched_outputs, 1, 12, 0);  batched_outputs = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]"):
        ...
        results: "f32[12, 4, 3]" = torch._functorch.vmap._remove_batch_dim_in_graph(tangents_out_unflatten, 1, 12, 0);  tangents_out_unflatten = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]", L_y_: "f32[3, 4]"):
        ...
        results: "f32[12, 3, 4]" = torch._functorch.vmap._remove_batch_dim_in_graph(tangents_out_unflatten, 1, 12, 0);  tangents_out_unflatten = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]", L_y_: "f32[3, 4]"):
        ...
        results: "f32[12, 3, 4]" = torch._functorch.vmap._remove_batch_dim_in_graph(tangents_out_unflatten, 1, 12, 0);  tangents_out_unflatten = None
        aux_2: "f32[12, 4, 3]" = torch._functorch.vmap._remove_batch_dim_in_graph(aux_1, 1, 12, 0);  aux_1 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]", L_y_: "f32[3, 4]"):
        ...
        _vmap_increment_nesting_in_graph = torch._functorch.vmap._vmap_increment_nesting_in_graph(12, 'same');  _vmap_increment_nesting_in_graph = None
        ...
        child_8: "f32[12, 3, 4]" = torch._functorch.vmap._remove_batch_dim_in_graph(child_6, 1, 12, 0);  child_6 = None
        child_9: "f32[12, 4, 3]" = torch._functorch.vmap._remove_batch_dim_in_graph(child_7, 1, 12, 0);  child_7 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[3, 3, 3]"):
        ...
        _vmap_increment_nesting_in_graph = torch._functorch.vmap._vmap_increment_nesting_in_graph(3, 'error');  _vmap_increment_nesting_in_graph = None

        _add_batch_dim_in_graph: "f32[3, 3]" = torch._functorch.vmap._add_batch_dim_in_graph(l_x_, 0, 1);  l_x_ = None

        sum_1: "f32[3]" = _add_batch_dim_in_graph.sum(0)
        sum_2: "f32[3]" = _add_batch_dim_in_graph.sum(1);  _add_batch_dim_in_graph = None
        batched_outputs: "f32[3]" = sum_1 + sum_2;  sum_1 = sum_2 = None

        _remove_batch_dim_in_graph: "f32[3, 3]" = torch._functorch.vmap._remove_batch_dim_in_graph(batched_outputs, 1, 3, 0);  batched_outputs = None

        _vmap_decrement_nesting_in_graph = torch._functorch.vmap._vmap_decrement_nesting_in_graph();  _vmap_decrement_nesting_in_graph = None
        return (_remove_batch_dim_in_graph,)
""",
        )
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[3, 3, 3]", L_y_: "f32[3, 3]"):
        ...
        _remove_batch_dim_in_graph: "f32[3, 3, 3]" = torch._functorch.vmap._remove_batch_dim_in_graph(batched_outputs, 1, 3, 0);  batched_outputs = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[3, 3, 3]", L_y_: "f32[3, 3]"):
        ...
        _add_batch_dim_in_graph: "f32[3, 3]" = torch._functorch.vmap._add_batch_dim_in_graph(l_x_, 0, 1);  l_x_ = None
        _add_batch_dim_in_graph_1: "f32[3]" = torch._functorch.vmap._add_batch_dim_in_graph(l_y_, 1, 1);  l_y_ = None

        sum_1: "f32[3]" = _add_batch_dim_in_graph.sum(0)
        sum_2: "f32[3]" = _add_batch_dim_in_graph.sum(1);  _add_batch_dim_in_graph = None
        add: "f32[3]" = sum_1 + sum_2;  sum_1 = sum_2 = None
        batched_outputs: "f32[3]" = add + _add_batch_dim_in_graph_1;  add = _add_batch_dim_in_graph_1 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[3, 3, 3]", L_y_: "f32[3, 3, 3]"):
        ...
        child: "f32[3, 3]" = torch._functorch.vmap._add_batch_dim_in_graph(l_x_, 0, 1);  l_x_ = None
        child_1: "f32[3, 3]" = torch._functorch.vmap._add_batch_dim_in_graph(l_y_, 0, 1);  l_y_ = None

        lazy_load_decompositions_1 = torch._functorch.vmap.lazy_load_decompositions();  lazy_load_decompositions_1 = None

        _vmap_increment_nesting_in_graph_1 = torch._functorch.vmap._vmap_increment_nesting_in_graph(3, 'error');  _vmap_increment_nesting_in_graph_1 = None

        _add_batch_dim_in_graph_2: "f32[3]" = torch._functorch.vmap._add_batch_dim_in_graph(child, 1, 2);  child = None
        _add_batch_dim_in_graph_3: "f32[3]" = torch._functorch.vmap._add_batch_dim_in_graph(child_1, 1, 2);  child_1 = None

        batched_outputs: "f32[3]" = _add_batch_dim_in_graph_2 + _add_batch_dim_in_graph_3;  _add_batch_dim_in_graph_2 = _add_batch_dim_in_graph_3 = None

        batched_outputs_1: "f32[3, 3]" = torch._functorch.vmap._remove_batch_dim_in_graph(batched_outputs, 2, 3, 0);  batched_outputs = None

        _vmap_decrement_nesting_in_graph = torch._functorch.vmap._vmap_decrement_nesting_in_graph();  _vmap_decrement_nesting_in_graph = None

        _remove_batch_dim_in_graph_1: "f32[3, 3, 3]" = torch._functorch.vmap._remove_batch_dim_in_graph(batched_outputs_1, 1, 3, 0);  batched_outputs_1 = None

        _vmap_decrement_nesting_in_graph_1 = torch._functorch.vmap._vmap_decrement_nesting_in_graph();  _vmap_decrement_nesting_in_graph_1 = None
        return (_remove_batch_dim_in_graph_1,)
""",
        )
...
class GraphModule(torch.nn.Module):
    def forward(self, L_y_: "f32[5, 3]", L_x_: "f32[2, 3]"):
        ...
        _vmap_increment_nesting_in_graph = torch._functorch.vmap._vmap_increment_nesting_in_graph(5, 'error');  _vmap_increment_nesting_in_graph = None

        child: "f32[3]" = torch._functorch.vmap._add_batch_dim_in_graph(l_y_, 0, 1);  l_y_ = None

        lazy_load_decompositions_1 = torch._functorch.vmap.lazy_load_decompositions();  lazy_load_decompositions_1 = None

        _vmap_increment_nesting_in_graph_1 = torch._functorch.vmap._vmap_increment_nesting_in_graph(3, 'error');  _vmap_increment_nesting_in_graph_1 = None

        _add_batch_dim_in_graph_1: "f32[]" = torch._functorch.vmap._add_batch_dim_in_graph(child, 0, 2);  child = None

        batched_outputs: "f32[2, 3]" = l_x_ * _add_batch_dim_in_graph_1;  l_x_ = _add_batch_dim_in_graph_1 = None

        batched_outputs_1: "f32[3, 2, 3]" = torch._functorch.vmap._remove_batch_dim_in_graph(batched_outputs, 2, 3, 0);  batched_outputs = None

        _vmap_decrement_nesting_in_graph = torch._functorch.vmap._vmap_decrement_nesting_in_graph();  _vmap_decrement_nesting_in_graph = None

        _remove_batch_dim_in_graph_1: "f32[5, 3, 2, 3]" = torch._functorch.vmap._remove_batch_dim_in_graph(batched_outputs_1, 1, 5, 0);  batched_outputs_1 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[2, 4, 3]"):
        ...
        _vmap_increment_nesting_in_graph = torch._functorch.vmap._vmap_increment_nesting_in_graph(2, 'error');  _vmap_increment_nesting_in_graph = None

        _add_batch_dim_in_graph: "f32[4, 3]" = torch._functorch.vmap._add_batch_dim_in_graph(l_x_, 0, 1);  l_x_ = None

        child: "f32[3]" = _add_batch_dim_in_graph.sum(0)
        child_1: "f32[4]" = _add_batch_dim_in_graph.sum(1);  _add_batch_dim_in_graph = None

        _remove_batch_dim_in_graph: "f32[2, 3]" = torch._functorch.vmap._remove_batch_dim_in_graph(child, 1, 2, 0);  child = None
        _remove_batch_dim_in_graph_1: "f32[2, 4]" = torch._functorch.vmap._remove_batch_dim_in_graph(child_1, 1, 2, 0);  child_1 = None

        _vmap_decrement_nesting_in_graph = torch._functorch.vmap._vmap_decrement_nesting_in_graph();  _vmap_decrement_nesting_in_graph = None
        return (_remove_batch_dim_in_graph, _remove_batch_dim_in_graph_1)
""",
        )
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[2, 4, 3]"):
        ...
        _remove_batch_dim_in_graph: "f32[3, 2]" = torch._functorch.vmap._remove_batch_dim_in_graph(child, 1, 2, 1);  child = None
        _remove_batch_dim_in_graph_1: "f32[2, 4]" = torch._functorch.vmap._remove_batch_dim_in_graph(child_1, 1, 2, 0);  child_1 = None
