...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]"):
        ...
        getitem_4: "f32[4, 3, 4, 3]" = _unpack_dual[1]
        getitem_5: "f32[4, 3, 4, 3]" = _unpack_dual[0];  _unpack_dual = None

        _unwrap_for_grad_1: "f32[4, 3, 4, 3]" = torch._functorch.predispatch._unwrap_for_grad(getitem_4, 2);  getitem_4 = None
        _unwrap_for_grad_2: "f32[4, 3, 4, 3]" = torch._functorch.predispatch._unwrap_for_grad(getitem_5, 2);  getitem_5 = _unwrap_for_grad_2 = None
        ...
        _remove_batch_dim_1: "f32[12, 4, 3, 4, 3]" = torch._functorch.predispatch._remove_batch_dim(_unwrap_for_grad_1, 1, 12, 0);  _unwrap_for_grad_1 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]"):
        ...
        getitem_1: "f32[4, 3]" = _unpack_dual[1]
        getitem_2: "f32[4, 3]" = _unpack_dual[0];  _unpack_dual = None

        _unwrap_for_grad: "f32[4, 3]" = torch._functorch.predispatch._unwrap_for_grad(getitem_1, 2);  getitem_1 = None
        _unwrap_for_grad_1: "f32[4, 3]" = torch._functorch.predispatch._unwrap_for_grad(getitem_2, 2);  getitem_2 = _unwrap_for_grad_1 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]", L_y_: "f32[3, 4]"):
        ...
        _unpack_dual = torch._functorch.predispatch._unpack_dual(sin, level = 0);  sin = None
        getitem_1: "f32[3, 4]" = _unpack_dual[1]
        getitem_2: "f32[3, 4]" = _unpack_dual[0];  _unpack_dual = None

        _unwrap_for_grad: "f32[3, 4]" = torch._functorch.predispatch._unwrap_for_grad(getitem_1, 2);  getitem_1 = None
        _unwrap_for_grad_1: "f32[3, 4]" = torch._functorch.predispatch._unwrap_for_grad(getitem_2, 2);  getitem_2 = _unwrap_for_grad_1 = None

        _exit_dual_level = torch._functorch.predispatch._exit_dual_level(level = 0);  _exit_dual_level = None
        _set_fwd_grad_enabled_1 = torch._C._set_fwd_grad_enabled(True);  _set_fwd_grad_enabled_1 = None
        _jvp_decrement_nesting = torch._functorch.predispatch._jvp_decrement_nesting();  _jvp_decrement_nesting = None

        _remove_batch_dim: "f32[12, 3, 4]" = torch._functorch.predispatch._remove_batch_dim(_unwrap_for_grad, 1, 12, 0);  _unwrap_for_grad = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]", L_y_: "f32[3, 4]"):
        ...
        getitem_3: "f32[4, 3]" = _remove_batch_dim_1[0];  _remove_batch_dim_1 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]", L_y_: "f32[3, 4]"):
        ...
        getitem_5: "f32[4, 3, 12]" = split_1[0];  split_1 = None

        unflatten: "f32[3, 4, 4, 3]" = getitem_4.unflatten(-1, (4, 3));  getitem_4 = None
        unflatten_1: "f32[4, 3, 4, 3]" = getitem_5.unflatten(-1, (4, 3));  getitem_5 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_v_: "f32[3, 3]", L_x_: "f32[3, 3]"):
        ...
        getitem: "f32[]" = _unpack_dual[1]
        getitem_1: "f32[]" = _unpack_dual[0];  _unpack_dual = None
        ...
        _set_fwd_grad_enabled_1 = torch._C._set_fwd_grad_enabled(True);  _set_fwd_grad_enabled_1 = None
        _jvp_decrement_nesting = torch._functorch.predispatch._jvp_decrement_nesting();  _jvp_decrement_nesting = None
        return (_unwrap_for_grad_1, _unwrap_for_grad)
""",
        )
...
class GraphModule(torch.nn.Module):
    def forward(self, L_v_: "f32[3, 3]", L_x_: "f32[3, 3]"):
        ...
        _set_fwd_grad_enabled_1 = torch._C._set_fwd_grad_enabled(True);  _set_fwd_grad_enabled_1 = None
        _jvp_decrement_nesting = torch._functorch.predispatch._jvp_decrement_nesting();  _jvp_decrement_nesting = None
        return (_unwrap_for_grad_2, _unwrap_for_grad_1, _unwrap_for_grad)
""",
        )
...
class GraphModule(torch.nn.Module):
    def forward(self, L_v_: "f32[3, 3]", L_x_: "f32[3, 3]", L_y_: "f32[3, 3]"):
        ...
        getitem: "f32[3, 3]" = _unpack_dual[1]
        getitem_1: "f32[3, 3]" = _unpack_dual[0];  _unpack_dual = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[3, 3, 3]"):
        ...
        _unpack_dual = torch._functorch.predispatch._unpack_dual(sin, level = 0);  sin = None
        getitem: "f32[3, 3, 3]" = _unpack_dual[1]
        getitem_1: "f32[3, 3, 3]" = _unpack_dual[0];  _unpack_dual = None
        ...
        getitem_2: "f32[3, 3, 3]" = _unpack_dual_1[1]
        getitem_3: "f32[3, 3, 3]" = _unpack_dual_1[0];  _unpack_dual_1 = None
        _unpack_dual_2 = torch._functorch.predispatch._unpack_dual(_unwrap_for_grad_1, level = 0);  _unwrap_for_grad_1 = None
        getitem_4: "f32[3, 3, 3]" = _unpack_dual_2[1]
        getitem_5: "f32[3, 3, 3]" = _unpack_dual_2[0];  _unpack_dual_2 = None
        ...
        return (_unwrap_for_grad_5, _unwrap_for_grad_3, _unwrap_for_grad_4, _unwrap_for_grad_2)
""",
        )
