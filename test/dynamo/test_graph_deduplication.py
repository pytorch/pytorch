...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[10, 10]", L_y_: "f32[10, 20]"):
        ...
        l_x_ = L_x_
        l_y_ = L_y_
        invoke_subgraph_1 = torch.ops.higher_order.invoke_subgraph(subgraph_1, 'subgraph_0', (l_x_, l_y_));  invoke_subgraph_1 = None

        o1_1: "f32[10, 20]" = torch.sin(l_y_)

        invoke_subgraph_2 = torch.ops.higher_order.invoke_subgraph(subgraph_1, 'subgraph_0', (l_x_, o1_1));  o1_1 = None

        getitem_1: "f32[]" = invoke_subgraph_2[0];  invoke_subgraph_2 = None

        invoke_subgraph_3 = torch.ops.higher_order.invoke_subgraph(subgraph_1, 'subgraph_0', (l_x_, l_y_));  subgraph_1 = l_x_ = l_y_ = None

        getitem_2: "f32[]" = invoke_subgraph_3[0];  invoke_subgraph_3 = None

        o4_1: "f32[]" = getitem_2 * getitem_2;  getitem_2 = None

        mul_1: "f32[]" = getitem_1 * o4_1;  getitem_1 = o4_1 = None
        return (mul_1,)
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[10, 10]"):
        ...
        x0_1: "f32[10, 10]" = l_x_ + 2;  l_x_ = None

        invoke_subgraph_1 = torch.ops.higher_order.invoke_subgraph(subgraph_1, 'subgraph_0', (x0_1,));  x0_1 = None

        getitem_1: "f32[10, 10]" = invoke_subgraph_1[0];  invoke_subgraph_1 = None

        o_1: "f32[10, 10]" = torch.cos(getitem_1);  getitem_1 = None

        invoke_subgraph_2 = torch.ops.higher_order.invoke_subgraph(subgraph_1, 'subgraph_0', (o_1,));  subgraph_1 = o_1 = None

        getitem_2: "f32[10, 10]" = invoke_subgraph_2[0];  invoke_subgraph_2 = None

        sin_1: "f32[10, 10]" = torch.sin(getitem_2);  getitem_2 = None
        return (sin_1,)
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[10, 10]", L_y_: "f32[10, 20]"):
        ...
        x0_1: "f32[10, 10]" = torch.cos(l_x_)

        y0_1: "f32[10, 20]" = torch.sin(l_y_)

        invoke_subgraph_1 = torch.ops.higher_order.invoke_subgraph(subgraph_1, 'subgraph_1', (x0_1, y0_1));  invoke_subgraph_1 = None
        invoke_subgraph_2 = torch.ops.higher_order.invoke_subgraph(subgraph_2, 'subgraph_0', (l_x_, l_y_))

        getitem_1: "f32[]" = invoke_subgraph_2[0];  invoke_subgraph_2 = None

        o1_1: "f32[]" = torch.sin(getitem_1);  getitem_1 = None

        invoke_subgraph_3 = torch.ops.higher_order.invoke_subgraph(subgraph_2, 'subgraph_0', (l_x_, y0_1))

        getitem_2: "f32[]" = invoke_subgraph_3[0];  invoke_subgraph_3 = None

        invoke_subgraph_4 = torch.ops.higher_order.invoke_subgraph(subgraph_1, 'subgraph_1', (x0_1, y0_1));  subgraph_1 = x0_1 = y0_1 = None

        getitem_3: "f32[10, 10]" = invoke_subgraph_4[0];  invoke_subgraph_4 = None

        invoke_subgraph_5 = torch.ops.higher_order.invoke_subgraph(subgraph_2, 'subgraph_0', (l_x_, l_y_));  subgraph_2 = l_x_ = l_y_ = None

        getitem_4: "f32[]" = invoke_subgraph_5[0];  invoke_subgraph_5 = None

        mul_1: "f32[]" = o1_1 * getitem_2;  o1_1 = getitem_2 = None
        mul_2: "f32[10, 10]" = mul_1 * getitem_3;  mul_1 = getitem_3 = None
        add_1: "f32[10, 10]" = mul_2 + getitem_4;  mul_2 = getitem_4 = None
        return (add_1,)
