...
class ReproTests(torch._dynamo.test_case.TestCase):
    ...
    def test_out_shape_change_schema_named_out_kwargs(self):
        # Out variants whose out arguments are not spelled "out" -- autogenerated
        # multi-output variants use out0/out1/..., aten.aminmax names them
        # min/max. These used to skip the resize check entirely, so the caller
        # silently saw the unresized tensor instead of a graph break.
        def numbered():
