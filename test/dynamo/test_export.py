...
def forward(self, pred, x):
    ...
    l_pred_ = arg0
    l_x_ = arg1
    a = torch.ones(6, 4, device = device(type='cpu'))
    b = torch.ones(6, 4, device = device(type='cpu'))
    c = torch.ones(6, 4, device = device(type='cpu'))
    d = torch.ones(6, 4, device = device(type='cpu'))
    cond_true_0 = self.cond_true_0
    cond_false_0 = self.cond_false_0
