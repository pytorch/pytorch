...
def forward(self, a, b, l_x_, d_true_branch, c_false_branch):
    ...
    b_1 = b
    l_x__1 = l_x_
    sym_size_int_2 = torch.ops.aten.sym_size.int(l_x__1, 0)
    sym_size_int_3 = torch.ops.aten.sym_size.int(l_x__1, 1)
    add = l_x__1 + l_x__1;  l_x__1 = None
    eq = sym_size_int_3 == 4;  sym_size_int_3 = None
    ...
    eq_1 = sym_size_int_2 == 6;  sym_size_int_2 = None
