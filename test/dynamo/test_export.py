...
def forward(self, x):
    ...
    slice_1 = torch.ops.aten.slice.Tensor(arg0_1, 0, None, sym_size_int)
    slice_2 = torch.ops.aten.slice.Tensor(slice_1, 1, 0, sym_size_int);  slice_1 = None
    slice_3 = torch.ops.aten.slice.Tensor(slice_2, 2, 0, 3);  slice_2 = None
    sub = sym_size_int - 1
    slice_4 = torch.ops.aten.slice.Tensor(arg0_1, 0, None, sub);  sub = None
    slice_5 = torch.ops.aten.slice.Tensor(slice_4, 1, 1, sym_size_int);  slice_4 = None
    slice_6 = torch.ops.aten.slice.Tensor(slice_5, 2, 1, 3);  slice_5 = None
    sub_1 = sym_size_int - 2
    slice_7 = torch.ops.aten.slice.Tensor(arg0_1, 0, None, sub_1);  sub_1 = None
    slice_8 = torch.ops.aten.slice.Tensor(slice_7, 1, 2, sym_size_int);  slice_7 = None
    slice_9 = torch.ops.aten.slice.Tensor(slice_8, 2, 2, 3);  slice_8 = None
    sub_2 = sym_size_int - 3
    slice_10 = torch.ops.aten.slice.Tensor(arg0_1, 0, None, sub_2);  arg0_1 = sub_2 = None
    slice_11 = torch.ops.aten.slice.Tensor(slice_10, 1, 3, sym_size_int);  slice_10 = sym_size_int = None
    slice_12 = torch.ops.aten.slice.Tensor(slice_11, 2, 3, 3);  slice_11 = None
    return pytree.tree_unflatten([slice_3, slice_6, slice_9, slice_12], self._out_spec)""",
        )
