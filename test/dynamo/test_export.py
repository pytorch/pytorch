...
def forward(self, pred, x):
    ...
    return pytree.tree_unflatten([cond], self._out_spec)""",  # noqa: B950,E122
        ...
        self.assertExpectedInline(
            ...
            """\
def forward(self, l_x_, a_0, b_0, d_0, c_0_false_branch, b_0_false_branch, a_0_false_branch):
    add = l_x_ + l_x_;  l_x_ = None
    cos = a_0.cos();  a_0 = None
    add_1 = add + cos;  add = cos = None
    cos_1 = b_0.cos();  b_0 = None
    add_2 = add_1 + cos_1;  add_1 = cos_1 = None
    cos_2 = d_0.cos();  d_0 = None
    ...
    return add_3""",
        ...
        self.assertExpectedInline(
            ...
            """\
def forward(self, l_x_, d_0_true_branch, b_0_true_branch, a_0_true_branch, a_0, b_0, c_0):
    mul = l_x_ * l_x_;  l_x_ = None
    sin = a_0.sin();  a_0 = None
    add = mul + sin;  mul = sin = None
    sin_1 = b_0.sin();  b_0 = None
    add_1 = add + sin_1;  add = sin_1 = None
    sin_2 = c_0.sin();  c_0 = None
