...
def forward(self, pred, x):
    ...
    cond_true_1 = self.cond_true_0
    cond_false_1 = self.cond_false_0
    cond_1 = torch.ops.higher_order.cond(l_pred_, cond_true_1, cond_false_1, [a_1, b_1, l_x_, d_1, c_1]);  l_pred_ = cond_true_1 = cond_false_1 = a_1 = b_1 = l_x_ = d_1 = c_1 = None
    getitem_1 = cond_1[0];  cond_1 = None
    return pytree.tree_unflatten([getitem_1], self._out_spec)""",  # noqa: B950,E122
        )
...
def forward(self, x):
    arg0, = fx_pytree.tree_flatten_spec(([x], {}), self._in_spec)
    l_x_ = arg0
    x_1 = torch.cos(l_x_);  l_x_ = None
    x_2 = torch.sin(x_1);  x_1 = None
    x_3 = torch.relu(x_2);  x_2 = None
    return pytree.tree_unflatten([x_3], self._out_spec)""",
        )
...
def forward(self, x):
    arg0, = fx_pytree.tree_flatten_spec(([x], {}), self._in_spec)
    l_x_ = arg0
    sin_1 = torch.sin(l_x_);  l_x_ = None
    return pytree.tree_unflatten([sin_1], self._out_spec)""",
        )
        self.assertExpectedInline(
            gm2.code.strip(),
            """\
...
def forward(self, x):
    arg0, = fx_pytree.tree_flatten_spec(([x], {}), self._in_spec)
    l_args_0_ = arg0
    _enter_inference_mode_1 = torch.autograd.grad_mode._enter_inference_mode(True)
    add_1 = l_args_0_ + 1;  l_args_0_ = None
    _exit_inference_mode_1 = torch.autograd.grad_mode._exit_inference_mode(_enter_inference_mode_1);  _enter_inference_mode_1 = _exit_inference_mode_1 = None
    return pytree.tree_unflatten([add_1], self._out_spec)""",  # NOQA: B950
        )
...
def forward(self, x):
    arg0, = fx_pytree.tree_flatten_spec(([x], {}), self._in_spec)
    l_args_0_ = arg0
    _enter_inference_mode_1 = torch.autograd.grad_mode._enter_inference_mode(False)
    add_1 = l_args_0_ + 1;  l_args_0_ = None
    _exit_inference_mode_1 = torch.autograd.grad_mode._exit_inference_mode(_enter_inference_mode_1);  _enter_inference_mode_1 = _exit_inference_mode_1 = None
    return pytree.tree_unflatten([add_1], self._out_spec)""",  # NOQA: B950
        )
...
def forward(self, x, b, y):
    ...
    x_1 = l_x_.clone();  l_x_ = None
    x_1[l_b_] = l_y_;  setitem_1 = x_1;  l_b_ = l_y_ = setitem_1 = None
    _set_grad_enabled_2 = torch._C._set_grad_enabled(True);  _set_grad_enabled_2 = None
    return pytree.tree_unflatten([x_1], self._out_spec)""",
        )
...
def forward(self, x, b, y):
    ...
    x_1[l_b_] = l_y_;  setitem_1 = x_1;  l_b_ = l_y_ = setitem_1 = None
    _exit_inference_mode_1 = torch.autograd.grad_mode._exit_inference_mode(_enter_inference_mode_1);  _enter_inference_mode_1 = _exit_inference_mode_1 = None
    return pytree.tree_unflatten([x_1], self._out_spec)""",  # NOQA: B950
        )
