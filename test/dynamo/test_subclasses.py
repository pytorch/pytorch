...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        view_1: "f32[s13, s21]" = torch.ops.aten.view.default(tangents_1, [primals_1, primals_2]);  tangents_1 = primals_1 = primals_2 = None
        return (
            None,  # None
            None,  # None
            view_1,  # GradAOTOutput(grad_of=PlainAOTInput(idx=2))
        )
""",
        )
