...
+- __SHAPE_GUARD__: (L['x'].size()[0] % 3) == 0  # if x.size(0) % 3 == 0:  # #:# in # #:# in #
+- __SHAPE_GUARD__: L['x'].size()[0] == 1 or L['x'].size()[0] == (2*L['y'].size()[0])  # return x + torch.cat([y, z])  # #:# in # #:# in #
+- __SHAPE_GUARD__: 1 <= L['x'].size()[0]  # x = x * 3  # #:# in # #:# in #
+- __SHAPE_GUARD__: 1 <= L['y'].size()[0]  # return x + torch.cat([y, z])  # #:# in # #:# in #""",
        )
...
+- __SHAPE_GUARD__: 1 <= L['y'].size()[0]  # return any([x.size(0) == y.size(0) * 2])  # #:# in # #:# in #""",
        )
