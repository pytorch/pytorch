...
==> var_to_range: values don't match.
  >  Left: {s0: ValueRanges(lower=2, upper=IntInfinity(), is_bool=False, is_int=True, is_float=False), s1: ValueRanges(lower=2, upper=IntInfinity(), is_bool=False, is_int=True, is_float=False)}
  > Right: {}
...
==> unbacked_symint_counter: values don't match.
  ...
  > Right: 0
==> var_to_range: values don't match.
  >  Left: {u0: ValueRanges(lower=NegativeIntInfinity(), upper=IntInfinity(), is_bool=False, is_int=True, is_float=False), u1: ValueRanges(lower=0, upper=1, is_bool=False, is_int=True, is_float=False), zuf0: ValueRanges(lower=-oo, upper=oo, is_bool=False, is_int=False, is_float=True)}
  > Right: {}
""",
        )
        self._replay_and_check(main)
...
==> replacements: values don't match.
  ...
  > Right: {}
==> var_to_range: values don't match.
  >  Left: {s0: ValueRanges(lower=3, upper=3, is_bool=False, is_int=True, is_float=False), s1: ValueRanges(lower=2, upper=IntInfinity(), is_bool=False, is_int=True, is_float=False)}
