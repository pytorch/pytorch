...
class MiscTests(torch._dynamo.test_case.TestCase):
    ...
    def test_list_mul(self):
        ...
        self.assertEqual(cnts.frame_count, ifdyn(1, 0))
        self.assertEqual(cnts.op_count, ifdyn(2, 0))
    ...
    def test_list_slice_mul(self):
        ...
        self.assertEqual(cnts.frame_count, ifdyn(1, 0))
        self.assertEqual(cnts.op_count, ifdyn(14, 0))
    ...
    def test_id_of_nn_module(self):
        ...
        self.assertEqual(cnts.op_count, ifdyn(2, 1))
