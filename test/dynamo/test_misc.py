...
""",
    ...
    @torch._dynamo.config.patch(enable_trace_load_build_class=True)
    def test___build_class___manual_user_function_body(self):
        def body():
            pass

        @torch.compile(backend="eager", fullgraph=True)
        def fn(t):
            builtins.__build_class__(body, "ManualClass")
            return t + 1

        t = torch.ones(())
        self.assertEqual(fn(t), t + 1)

    @torch._dynamo.config.patch(enable_trace_load_build_class=True)
    def test___build_class___source_backed_closure(self):
        class Holder:
            def __init__(self, value):
                self.value = value
        ...
        def fn(t, holder):
            ...
            return t + NonTensor().compute()

        t = torch.randn(2)
        holder = Holder(3)
        self.assertEqual(fn(t, holder), t + 3)
        holder.value = 5
        self.assertEqual(fn(t, holder), t + 5)
        self.assertGreaterEqual(counter.frame_count, 1)

    @torch._dynamo.config.patch(enable_trace_load_build_class=True)
    def test___build_class___source_backed_closure_with_mixed_freevars(self):
        class Holder:
            def __init__(self, value):
                self.value = value
        ...
        self.assertEqual(fn(t, holder), t + 5)
        holder.value = 5
        self.assertEqual(fn(t, holder), t + 7)
        self.assertGreaterEqual(counter.frame_count, 1)

    @torch._dynamo.config.patch(enable_trace_load_build_class=True)
    def test___build_class___source_backed_method_default(self):
        class Holder:
            def __init__(self, value):
                self.value = value
        ...
        with self.assertRaisesRegex(
            ...
            "Unsupported source-backed closure .*class body",
        ):
            fn(torch.ones(()), Holder(1))

    @torch._dynamo.config.patch(enable_trace_load_build_class=True)
    def test___build_class___source_backed_method_annotation(self):
        class Holder:
            def __init__(self, value):
                self.value = value
    ...
    @torch._dynamo.config.patch(enable_trace_load_build_class=True)
    def test___build_class___source_backed_closure_class_body_read(self):
        class Holder:
            def __init__(self, value):
                self.value = value
    ...
    @torch._dynamo.config.patch(enable_trace_load_build_class=True)
    def test___build_class___source_backed_closure_called_in_class_body(self):
        class Holder:
            def __init__(self, value):
                self.value = value
    ...
    @torch._dynamo.config.patch(enable_trace_load_build_class=True)
    def test___build_class___stored_source_backed_closure_called_in_class_body(self):
        class Holder:
            def __init__(self, value):
                self.value = value
    ...
    @torch._dynamo.config.patch(enable_trace_load_build_class=True)
    def test___build_class___source_backed_closure_called_through_locals(self):
        class Holder:
            def __init__(self, value):
                self.value = value
    ...
    @torch._dynamo.config.patch(enable_trace_load_build_class=True)
    def test___build_class___source_backed_closure_called_through_captured_locals(
        self,
    ):
        class Holder:
            def __init__(self, value):
    ...
    @torch._dynamo.config.patch(enable_trace_load_build_class=True)
    def test___build_class___source_backed_closure_called_through_eval(self):
        class Holder:
            def __init__(self, value):
                self.value = value
    ...
    @torch._dynamo.config.patch(enable_trace_load_build_class=True)
    def test___build_class___source_backed_closure_called_through_exec(self):
        class Holder:
            def __init__(self, value):
                self.value = value
    ...
    @torch._dynamo.config.patch(enable_trace_load_build_class=True)
    def test___build_class___source_backed_closure_called_through_builtins_eval(
        self,
    ):
        class Holder:
            def __init__(self, value):
    ...
    @torch._dynamo.config.patch(enable_trace_load_build_class=True)
    def test___build_class___source_backed_closure_called_through_builtins_locals(
        self,
    ):
        class Holder:
            def __init__(self, value):
    ...
    @torch._dynamo.config.patch(enable_trace_load_build_class=True)
    def test___build_class___source_backed_closure_called_through_imported_eval(
        self,
    ):
        class Holder:
            def __init__(self, value):
        ...
        def fn(t, holder):
            ...
            class NonTensor:
                ...
                y = getattr(__import__("builtins"), "eval")("helper()")
    ...
    @torch._dynamo.config.patch(enable_trace_load_build_class=True)
    def test___build_class___preexisting_source_backed_closure_called_in_class_body(
        self,
    ):
        class Holder:
            def __init__(self, value):
