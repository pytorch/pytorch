   ...
   File "test_error_messages.py", line N, in fn
    ...
    def test_optree_graph_break_message(self):
        ...
        self.assertExpectedInline(
            ...
            """\
Attempted to call function marked as skipped
  Explanation: Dynamo cannot trace optree C/C++ function optree._C.pybind11_detail_function_record.flatten.
  Hint: Consider using torch.utils._pytree - https://github.com/pytorch/pytorch/blob/main/torch/utils/_pytree.py

  Developer debug context: module: optree._C, qualname: pybind11_detail_function_record.flatten, skip reason: <missing reason>
