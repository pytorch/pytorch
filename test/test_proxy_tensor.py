...
symbolic_tensor_failures = {
    ...
    xfail('special.bernoulli_number', ''),  # aten.special_bernoulli_number.default - couldn't find symbolic meta fun...
    xfail('special.complete_legendre_elliptic_integral_e', ''),  # aten.special_complete_legendre_elliptic_integral_e.default - couldn't find symbolic meta fun...
    xfail('special.complete_legendre_elliptic_integral_k', ''),  # aten.special_complete_legendre_elliptic_integral_k.default - couldn't find symbolic meta fun...
    xfail('special.complete_legendre_elliptic_integral_d', ''),  # aten.special_complete_legendre_elliptic_integral_d.default - couldn't find symbolic meta fun...
    xfail('special.cos_pi', ''),  # aten.special_cos_pi.default - couldn't find symbolic meta fun...
    xfail('special.cosh_pi', ''),  # aten.special_cosh_pi.default - couldn't find symbolic meta fun...
    xfail('special.factorial', ''),  # aten.special_factorial.default - couldn't find symbolic meta fun...
    xfail('special.harmonic_number', ''),  # aten.special_harmonic_number.default - couldn't find symbolic meta fun...
    xfail('special.ln_gamma_sign', ''),  # aten.special_ln_gamma_sign.default - couldn't find symbolic meta fun...
    xfail('special.sin_pi', ''),  # aten.special_sin_pi.default - couldn't find symbolic meta fun...
    xfail('special.sinh_pi', ''),  # aten.special_sinh_pi.default - couldn't find symbolic meta fun...
    xfail('special.tan_pi', ''),  # aten.special_tan_pi.default - couldn't find symbolic meta fun...
    xfail('special.tanh_pi', ''),  # aten.special_tanh_pi.default - couldn't find symbolic meta fun..
