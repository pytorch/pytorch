...
symbolic_tensor_failures = {
    ...
    xfail('linalg.norm', ''),  # AssertionError: False != True - https://github.com/pytorch/pytorch/issues/113905
    xfail('linalg.norm', 'subgradients_at_zero'),  # https://github.com/pytorch/pytorch/issues/113905
