...
class TestSDPACudaOnly(NNTestCase):
    ...
    def test_cudnn_attention_varlen(self, dtype):
        ...
        default_tolerances = {
            ...
            torch.half: {"atol": 9e-3, "rtol": 5e-3},
        }
        ...
        class AttentionBlock(nn.Module):
            ...
            def forward_varlen(
                ...
                attn_out, _, _, _ = torch.ops.torch_attn._varlen_attn(q, k, v, cu_seq, cu_seq, max_len, max_len, is_causal)
        ...
        def test_varlen_vs_sdpa(device, dtype, is_causal):
            torch.manual_seed(42)
        ...
        test_varlen_vs_sdpa("cuda", dtype, is_causal=False)
