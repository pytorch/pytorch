...
class TestSDPA(NNTestCase):
    ...
    def test_scaled_dot_product_attention_math_with_negative_scale(self, device):
        ...
        ref_result = ref(x)
        sdp_math = torch.ops.aten._scaled_dot_product_attention_math(x, x, x, scale=-1.0 / 0.0001)[0]
