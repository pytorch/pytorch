...
instantiate_device_type_tests(TestCudaDeviceParametrized, globals(), only_for="cuda")
instantiate_device_type_tests(TestCudaGreenContexts, globals(), only_for="cuda")
