...
tests = [
    ...
    ('sort',          small_3d,           lambda t: [],                                                     ),
    ('sort',          small_3d,           lambda t: [1],                                    'dim'           ),
    ('sort',          small_3d,           lambda t: [1, True],                              'dim_descending'),
    ...
    ('topk',          small_3d,           lambda t: [2],                                                    ),
    ('topk',          small_3d,           lambda t: [2, 1],                                 'dim'           ),
    ('topk',          small_3d,           lambda t: [2, 1, True],                           'dim_desc'      ),
