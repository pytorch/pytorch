...
tests = [
    ('add', small_3d, lambda t: [number(3.14, 3, t)], '', types, False,
        "skipIfByteTensor;skipIfCharTensor;skipIfHalfTensor;skipIfShortTensor"),
    ...
    ('div', small_3d, lambda t: [number(3.14, 3, t)], '', types, False,
        "skipIfByteTensor;skipIfCharTensor;skipIfFloatTensor;skipIfHalfTensor;skipIfShortTensor"),
    ...
    ('pow', small_3d, lambda t: [number(-2., -2, t)], 'pow-2', float_types_no_half, False,
        "skipIfHalfTensor;skipIfFloatTensor"),
    ...
    ('addbmm', small_2d, lambda t: [number(0.4, 2, t), small_3d(t), small_3d(t)], 'scalar', types,
        False, "skipIfHalfTensor"),
    ('addbmm', small_2d, lambda t: [number(0.5, 3, t), number(0.4, 2, t), small_3d(t), small_3d(t)], 'two_scalars',
        types, False, "skipIfHalfTensor"),
    ...
    ('baddbmm', small_3d, lambda t: [number(0.4, 2, t), small_3d(t), small_3d(t)], 'scalar',
        types, False, "skipIfHalfTensor"),
    ('baddbmm', small_3d, lambda t: [number(0.5, 3, t), number(0.4, 2, t), small_3d(t), small_3d(t)],
        'two_scalars', types, False, "skipIfHalfTensor"),
    ...
    ('addcdiv', small_2d_lapack, lambda t: [number(2.8, 1, t), tensor_mul(small_2d_lapack(t), 2), small_2d_lapack(t)],
        'scalar', types, False, "skipIfHalfTensor"),
    ('addcmul', small_3d, lambda t: [small_3d(t), small_3d(t)], '', types, False, "skipIfHalfTensor"),
    ('addcmul', small_3d, lambda t: [number(0.4, 2, t), small_3d(t), small_3d(t)],
        'scalar', types, False, "skipIfHalfTensor"),
    ('addmm', medium_2d, lambda t: [medium_2d(t), medium_2d(t)], '', types, False, "skipIfHalfTensor"),
    ('addmm', medium_2d, lambda t: [number(0.4, 2, t), medium_2d(t), medium_2d(t)],
        'scalar', types, False, "skipIfHalfTensor"),
    ('addmm', medium_2d, lambda t: [number(0.5, 3, t), number(0.4, 2, t), medium_2d(t), medium_2d(t)],
        'two_scalars', types, False, "skipIfHalfTensor"),
    ('addmv', medium_1d, lambda t: [medium_2d(t), medium_1d(t)], '', types, False, "skipIfHalfTensor"),
    ('addmv', medium_1d, lambda t: [number(0.4, 2, t), medium_2d(t), medium_1d(t)],
        'scalar', types, False, "skipIfHalfTensor"),
    ('addmv', medium_1d, lambda t: [number(0.5, 3, t), number(0.4, 2, t), medium_2d(t), medium_1d(t)],
        'two_scalars', types, False, "skipIfHalfTensor"),
    ('addr', medium_2d, lambda t: [medium_1d(t), medium_1d(t)], '', types, False, "skipIfHalfTensor"),
    ('addr', medium_2d, lambda t: [number(0.4, 2, t), medium_1d(t), medium_1d(t)],
        'scalar', types, False, "skipIfHalfTensor"),
    ('addr', medium_2d, lambda t: [number(0.5, 3, t), number(0.4, 2, t), medium_1d(t), medium_1d(t)],
        'two_scalars', types, False, "skipIfHalfTensor"),
    ...
    ('max', small_3d_unique, lambda t: [1], 'dim', types, False,
        "skipIfByteTensor;skipIfCharTensor;skipIfDoubleTensor;skipIfFloatTensor;\
        skipIfHalfTensor;skipIfIntTensor;skipIfLongTensor;skipIfShortTensor"),
    ...
    ('mean', small_3d, lambda t: [-1], 'neg_dim', types, False,
        "skipIfDoubleTensor;skipIfFloatTensor;skipIfHalfTensor"),
    ...
    ('mode', small_3d, lambda t: [-1], 'neg_dim', types, False,
        "skipIfByteTensor;skipIfCharTensor;skipIfDoubleTensor;skipIfFloatTensor;\
        skipIfHalfTensor;skipIfIntTensor;skipIfLongTensor;skipIfShortTensor"),
    ('mvlgamma', lambda t: tensor_clamp(small_2d(t), 0.1, 10), lambda t: [1], '2d_p=1',
        float_types_no_half, False, "skipIfDoubleTensor;skipIfFloatTensor"),
    ('mvlgamma', lambda t: tensor_clamp(small_2d(t), 0.6, 10), lambda t: [2], '2d_p=2',
        float_types_no_half, False, "skipIfDoubleTensor;skipIfFloatTensor"),
    ...
    ('norm', small_3d, lambda t: [3, 0], '3_norm_dim', types, False,
        "skipIfHalfTensor;skipIfDoubleTensor;skipIfFloatTensor"),
    ('norm', small_3d, lambda t: [3, -2], '3_norm_neg_dim', types, False,
        "skipIfHalfTensor;skipIfDoubleTensor;skipIfFloatTensor"),
    ...
    ('sum', small_3d, lambda t: [-1], 'neg_dim', types, False,
        "skipIfByteTensor;skipIfCharTensor;skipIfDoubleTensor;skipIfFloatTensor;\
        skipIfHalfTensor;skipIfIntTensor;skipIfLongTensor;skipIfShortTensor"),
    ('renorm', small_3d, lambda t: [2, 1, 1], '2_norm', types, False,
        "skipIfHalfTensor;skipIfDoubleTensor;skipIfFloatTensor"),
    ('renorm', small_3d, lambda t: [2, -1, 1], '2_norm_neg_dim', types, False,
        "skipIfHalfTensor;skipIfDoubleTensor;skipIfFloatTensor"),
    ('renorm', small_3d, lambda t: [1.5, 1, 1], '1_5_norm', types, False,
        "skipIfHalfTensor;skipIfDoubleTensor;skipIfFloatTensor"),
    ...
    ('topk', small_3d_unique, lambda t: [2, 1, True, True], 'dim_desc_sort', types, False,
        "skipIfByteTensor;skipIfCharTensor;skipIfDoubleTensor;\
        skipIfHalfTensor;skipIfLongTensor;skipIfFloatTensor;skipIfIntTensor;skipIfShortTensor"),
