...
from torch.testing._internal.common_methods_invocations import (
    _compare_large_trilu_indices, _compare_trilu_indices, tri_large_tests_args,
    tri_tests_args)
from torch.testing._internal.common_utils import (IS_REMOTE_GPU, IS_SANDCASTLE,
                                                  IS_WINDOWS,
                                                  NO_MULTIPROCESSING_SPAWN,
                                                  TEST_NUMPY, TEST_WITH_ROCM,
                                                  TestCase, freeze_rng_state,
