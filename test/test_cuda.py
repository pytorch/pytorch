...
"""
    ...
    def test_graph_optims(self):
        ...
        cases = [
            ...
            for optimizer_ctor, foreach, amsgrad in product(
                (torch.optim.Adam, torch.optim.AdamW, torch.optim.NAdam), (False, True), (False, True),)
        ] + [
    ...
    def test_graph_optims_with_explicitly_capturable_param_groups(self):
        ...
        for optimizer, second_param_group_capturable in product((torch.optim.Adam, torch.optim.AdamW, torch.optim.NAdam), (True, False)):
