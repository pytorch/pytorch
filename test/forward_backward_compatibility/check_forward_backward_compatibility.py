...
ALLOW_LIST = [
    ...
    ("prim::CudaFusionIvalGuard", datetime.date(2023, 1, 1)),
    ("prim::CudaFusionGuard", datetime.date(2023, 1, 1)),
    ("prim::CudaFusionGroup", datetime.date(2023, 1, 1)),
    ("prim::CudaFusionViewGuard", datetime.date(2023, 1, 1)),
    ("prim::CudaFusionSizeEq", datetime.date(2023, 1, 1)),
    ("prim::transpose_copy.int", datetime.date(2023, 1, 1)),
    ("prim::expand_as_copy", datetime.date(2023, 1, 1)),
    ("prim::squeeze_copy", datetime.date(2023, 1, 1)),
    ("prim::squeeze_copy.dim", datetime.date(2023, 1, 1)),
    ("prim::unsqueeze_copy", datetime.date(2023, 1, 1)),
    ("prim::expand_copy", datetime.date(2023, 1, 1)),
    ("prim::flatten_copy", datetime.date(2023, 1, 1)),
    ("prim::add_optional", datetime.date(2023, 1, 1)),
    ("prim::reshape_copy", datetime.date(2023, 1, 1)),
    ("prim::permute_copy", datetime.date(2023, 1, 1)),
    ("prim::infer_unsqueeze_size", datetime.date(2023, 1, 1)),
    ("prim::t_copy", datetime.date(2023, 1, 1)),
    ("prim::view_copy", datetime.date(2023, 1, 1)),
]
