...
ALLOW_LIST = [
    ...
    ("aten::to_sparse.out", datetime.date(2023, 7, 1)),
    ("aten::to_sparse.sparse_dim_out", datetime.date(2023, 7, 1)),
    ("aten::to_sparse_bsc.out", datetime.date(2023, 7, 1)),
    ("aten::to_sparse_bsr.out", datetime.date(2023, 7, 1)),
    ("aten::to_sparse_csc.out", datetime.date(2023, 7, 1)),
    ("aten::to_sparse_csr.out", datetime.date(2023, 7, 1)),
