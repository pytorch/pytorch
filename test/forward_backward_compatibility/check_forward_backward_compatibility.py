...
ALLOW_LIST = [
    ...
    ("aten::_nested_from_padded_tensor", datetime.date(2025, 2, 31)),
    ("aten::_nested_get_jagged_dummy", datetime.date(2025, 2, 31)),
    ("aten::_nested_get_max_seqlen", datetime.date(2025, 2, 31)),
    ("aten::_nested_get_min_seqlen", datetime.date(2025, 2, 31)),
    ("aten::_nested_get_lengths", datetime.date(2025, 2, 31)),
    ("aten::_nested_get_offsets", datetime.date(2025, 2, 31)),
    ("aten::_nested_view_from_jagged", datetime.date(2025, 2, 31)),
    ("aten::_nested_view_from_jagged_copy", datetime.date(2025, 2, 31)),
    ("aten::_nested_view_from_jagged_copy.out", datetime.date(2025, 2, 31)),
