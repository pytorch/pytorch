...
class TestDistributions(TestCase):
    ...
    def test_cauchy(self):
        ...
        self.assertEqual(Cauchy(loc_1d, scale_1d).variance.item(), inf)
    ...
    def test_halfcauchy(self):
        ...
        self.assertEqual(HalfCauchy(scale_1d).variance.item(), inf)
    ...
    def test_pareto(self):
        ...
        self.assertEqual(Pareto(scale_1d, 0.5).mean.item(), inf)
        self.assertEqual(Pareto(scale_1d, 0.5).variance.item(), inf)
