...
class DistTensorOpsTest(DTensorOpTestBase):
    ...
    def test_aten_contiguous(self):
        ...
        mesh = self.build_device_mesh(self.device_type, list(range(self.world_size)))
        self._test_op(
            mesh,
    ...
    def test_detach(self):
        device_mesh = self.build_device_mesh(self.device_type, list(range(self.world_size)))
        shard_spec = [Shard(0)]
    ...
    @skip_if_lt_x_gpu(4)
    def test_stack(self):
        mesh_2d = self.build_device_mesh(
        ...
        mesh_1d = self.build_device_mesh(self.device_type, torch.arange(self.world_size))
    ...
    def test_index(self):
        meshes = [
            self.build_device_mesh(self.device_type, list(range(self.world_size))),  # 1D mesh
    ...
    def test_where_type_promotion(self):
        mesh = self.build_device_mesh(self.device_type, list(range(self.world_size)))  # 1D mesh
