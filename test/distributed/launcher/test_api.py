...
class LauncherApiTest(unittest.TestCase):
    ...
    def test_launch_agent_sets_signals_env_var(self, mock_get_handler, mock_agent):
        ...
        mock_agent_instance.run.return_value = MagicMock(is_failed=lambda: False, return_values={})
        ...
        self.assertEqual(os.environ["TORCHELASTIC_SIGNALS_TO_HANDLE"], "SIGTERM,SIGUSR1,SIGUSR2")
    ...
    def test_launch_agent_default_signals(self, mock_get_handler, mock_agent):
        ...
        self.assertEqual(os.environ["TORCHELASTIC_SIGNALS_TO_HANDLE"], "SIGTERM,SIGINT,SIGHUP,SIGQUIT")
