...
# To run:
# python test/distributed/test_p2p.py
...
@requires_cuda_p2p_access()
class P2PShareTest(MultiProcContinousTest):
    @classmethod
    def backend_str(cls):
        return "gloo"
    ...
    @skipIfRocm
    def test_p2p_share(self) -> None:
        """
        Test that the P2P share works, by reducing a tensor,
