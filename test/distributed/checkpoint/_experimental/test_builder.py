...
class TestMakeCheckpointer(TestCase):
    ...
    def test_make_sync_checkpointer(self):
        """Test creating a synchronous checkpointer using make_sync_checkpointer."""
        # Create sync checkpointer using factory function with default parameters
        checkpointer = make_sync_checkpointer(rank_info=self.rank_info)
    ...
    def test_make_sync_checkpointer_with_config_first(self):
        ...
        # Test that it works for sync operations
        checkpoint_path = os.path.join(self.temp_dir, "checkpoint_factory_sync_config_first")
        result = checkpointer.save(self.state_dict, checkpoint_path)
        self.assertIsNone(result)  # Sync mode returns None
    ...
    def test_make_sync_checkpointer_with_custom_config(self):
        ...
        # Test that it works for sync operations
        checkpoint_path = os.path.join(self.temp_dir, "checkpoint_factory_sync_custom_config")
        result = checkpointer.save(self.state_dict, checkpoint_path)
        self.assertIsNone(result)  # Sync mode returns None
    ...
    def test_make_async_checkpointer(self):
        ...
        try:
            ...
            stage_future, write_future = checkpointer.save(self.state_dict, checkpoint_path)
    ...
    def test_make_async_checkpointer_with_config_first(self):
        ...
        try:
            ...
            # Test that it works for async operations
            checkpoint_path = os.path.join(self.temp_dir, "checkpoint_factory_async_config_first")
            stage_future, write_future = checkpointer.save(self.state_dict, checkpoint_path)
    ...
    def test_make_async_checkpointer_with_custom_config(self):
        ...
        try:
            ...
            # Test that it works for async operations
            checkpoint_path = os.path.join(self.temp_dir, "checkpoint_factory_async_custom_config")
            stage_future, write_future = checkpointer.save(self.state_dict, checkpoint_path)
