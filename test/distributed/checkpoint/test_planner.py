...
from torch.distributed.checkpoint.default_planner import (
    ...
    CURRENT_DEFAULT_PLANNER_DCP_VERSION,
    DefaultLoadPlanner,
    DefaultSavePlanner,
)
from torch.distributed.checkpoint.filesystem import CURRENT_DEFAULT_WRITER_DCP_VERSION
...
class TestLoadPlanner(TestCase):
    ...
    def test_version_key_in_planner_data(self):
        ...
        self.assertEqual(
            planner.metadata.version_data,
            {
                "DefaultSavePlanner": CURRENT_DEFAULT_PLANNER_DCP_VERSION,
                "FileSystemWriter": CURRENT_DEFAULT_WRITER_DCP_VERSION,
            },
        )
