...
class TestSaveAndLoadAPI(DTensorTestBase):
    ...
    def test_auto_detect(self):
        ...
        with patch.object(dcp.FileSystemReader, "validate_checkpoint_id", return_value=False) as m1:
            with patch.object(dcp.FileSystemWriter, "validate_checkpoint_id", return_value=False) as m2:
                dcp.save(
                    model.state_dict(),
