...
class FsdpCheckpoint(DTensorTestBase):
    def _test_fsdp_checkpoint(self, process_group) -> None:
    ...
    @skip_if_lt_x_gpu(4)
    @with_temp_dir
    def test_fsdp_checkpoint_with_resharding(self):
        self._test_fsdp_checkpoint(process_group=self._create_new_dist_group())
