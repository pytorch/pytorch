...
class WorkerServerTestCUDA(TestCase):
    hw_classification = HardwareClassification.CUDA

    def test_fr_dump_file_without_rank(self, device) -> None:
        with local_worker_server() as pool:
    ...
    def test_fr_trace_json_selects_a_backend(self, device) -> None:
        with local_worker_server() as pool:
...
instantiate_device_type_tests(WorkerServerTestCUDA, globals(), only_for="cuda")
