...
class ScheduleTest(MultiProcContinousTest):
    ...
    @parametrize(
        "ScheduleClass",
        [ScheduleGPipe, Schedule1F1B, ScheduleInterleaved1F1B, ScheduleLoopedBFS, ScheduleInterleavedZeroBubble],
    )
    def test_eval_inference_mode(self, ScheduleClass):
        if ScheduleClass in [ScheduleInterleaved1F1B, ScheduleLoopedBFS, ScheduleInterleavedZeroBubble]:
