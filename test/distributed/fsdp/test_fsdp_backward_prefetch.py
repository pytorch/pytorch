...
DECODER_PARAM_FQNS = [
    ...
    "decoder.layers.{index}.self_attn.out_proj_weight",
    "decoder.layers.{index}.self_attn.out_proj_bias",
    "decoder.layers.{index}.multihead_attn.in_proj_weight",
    "decoder.layers.{index}.multihead_attn.in_proj_bias",
    "decoder.layers.{index}.multihead_attn.out_proj_weight",
    "decoder.layers.{index}.multihead_attn.out_proj_bias",
...
ENCODER_PARAM_FQNS = [
    ...
    "encoder.layers.{index}.self_attn.out_proj_weight",
    "encoder.layers.{index}.self_attn.out_proj_bias",
