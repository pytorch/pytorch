...
instantiate_device_type_tests(
    RingAttentionTestDevice, globals(), except_for="cpu"
)
instantiate_device_type_tests(
    CPFlexAttentionTest, globals(), except_for="cpu"
)
instantiate_device_type_tests(
    TestCPCustomOps, globals(), except_for="cpu"
)
instantiate_device_type_tests(
    TestSharding, globals(), except_for="cpu"
)
...
instantiate_device_type_tests(
    CPFlexAttentionTestWithLocalTensor, globals(), except_for="cpu"
)
instantiate_device_type_tests(
    TestCPCustomOpsWithLocalTensor, globals(), except_for="cpu"
)
instantiate_device_type_tests(
    TestShardingWithLocalTensor, globals(), except_for="cpu"
)
