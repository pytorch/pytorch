...
# These are ops that trigger DDEs during shard propagation (view_groups, broadcast, etc).
ops_unbacked_dtensor_dde = {
    ...
    skip("broadcast_to"),  # flaky - sometimes passes
    xfail("expand"),
    xfail("expand_as"),
    # Stack/cat family
    xfail("block_diag"),
    ...
    xfail("sort"),
    xfail("topk"),
    # View/reshape ops (DDEs in view_groups)
    xfail("as_strided"),
    xfail("as_strided", "partial_views"),
    xfail("diag"),
    xfail("diagflat"),
