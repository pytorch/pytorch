...
from torch.testing._internal.distributed._tensor.xfails.compiled import (
    xfails as compiled_xfails,
)
from torch.testing._internal.distributed._tensor.xfails.local import (
    xfails as local_xfails,
)
from torch.testing._internal.distributed._tensor.xfails.multi_threaded import (
    xfails as multi_threaded_xfails,
)
from torch.testing._internal.distributed._tensor.xfails.unbacked_dtensor import (
    xfails as unbacked_dtensor_xfails,
)
