...
class RedistributeTest(DTensorTestBase):
    ...
    def test_replicate_to_replicate_forward_backward_datatype_conversion(self):
        ...
        forward_datatypes = [torch.bfloat16, torch.bfloat16, torch.float32, torch.float32, torch.bfloat16, torch.float32, None, None]
        backward_datatypes = [torch.bfloat16, torch.float32, torch.bfloat16, torch.float32, None, None, torch.bfloat16, torch.float32]
