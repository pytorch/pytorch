...
class DistElementwiseOpsTest(DTensorOpTestBase):
    ...
    def test_masked_fill_scalar(self):
        ...
        input_tensor = torch.arange(40, dtype=torch.float32, device=self.device_type).reshape(8, 5)
        ...
        input_tensor2 = torch.arange(40, dtype=torch.float32, device=self.device_type).reshape(8, 5) - 20
        ...
        input_tensor3 = torch.arange(48, dtype=torch.float32, device=self.device_type).reshape(4, 12)
