  ...
  torch.matmul(t: f32[8, 8, 8]{a1=y}, t: f32[8, 8]{a1=x1, a2=x2})
    ...
    def test_record_function(self):
        ...
        self.assertExpectedInline(
            ...
            """\
  [record function] FWD
      aten::mm(t: f32[8, 4], t: f32[4, 2])
      aten::add.Tensor(t: f32[8, 2], 1)
      aten::sum(t: f32[8, 2])
      aten::t(t: f32[8, 4])
      aten::t(t: f32[4, 2])
      aten::detach(t: f32[4, 8])
      aten::detach(t: f32[2, 4])
    aten::ones_like(t: f32[], pin_memory=False, memory_format=torch.preserve_format)
  [record function] backward._backward_impl (dynamo_timed)
    aten::expand(t: f32[], [8, 2])
    aten::mm(t: f32[4, 8], t: f32[8, 2])
    aten::mm(t: f32[8, 2], t: f32[2, 4])
    aten::detach(t: f32[8, 4])
    aten::detach(t: f32[4, 2])""",
        )
