...
class TestInstantiator(unittest.TestCase):
    ...
    def test_instantiate_scripted_remote_module_template(self):
        ...
        num_files_before_cleanup = len(list(file_paths))
        instantiator.cleanup_generated_modules()
        dir_exists_after_cleanup = dir_path.exists()

        # The other one is "_remote_module_non_sriptable.py" generated by importing remote_module.py
        self.assertEqual(num_files_before_cleanup, 2)
        self.assertFalse(dir_exists_after_cleanup)
    ...
    def test_instantiate_non_scripted_remote_module_template(self):
        ...
        self.assertEqual(num_files_before_cleanup, 1)
        self.assertFalse(dir_exists_after_cleanup)
