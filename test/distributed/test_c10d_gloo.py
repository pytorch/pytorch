...
class RendezvousEnvTest(TestCase):
    ...
    def test_device_id_cpu(self):
        try:
            ...
            c10d.init_process_group(backend="gloo", init_method="env://", device_id=torch.device("cpu:0"))
    ...
    def test_device_id_cpu_no_index(self):
        try:
            ...
            with self.assertRaisesRegex(ValueError, "must be a device with a valid index"):
