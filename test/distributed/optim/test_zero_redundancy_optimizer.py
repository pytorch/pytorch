...
class TestZeroRedundancyOptimizerDistributedBase(TestZeroRedundancyOptimizer):
    ...
    def _test_zero_join(self, device):
        ...
        ddp_model = DDP(model, device_ids=[rank]) if device != "cpu" else DDP(model)
...
class TestZeroRedundancyOptimizerDistributed(
    TestZeroRedundancyOptimizerDistributedBase
):
    hw_classification = HardwareClassification.GENERIC
...
class TestZeroRedundancyOptimizerDistributedDevice(
    TestZeroRedundancyOptimizerDistributedBase
):
...
instantiate_device_type_tests(
    TestZeroRedundancyOptimizerDistributedDevice,
    globals(),
    except_for="cpu",
    allow_xpu=True,
)
