...
class TestCase(expecttest.TestCase):
    ...
    def assertEqual(self, x, y, prec=None, message='', allow_inf=False, allow_different_dtype=True):
        ...
        if isinstance(x, torch.Tensor) and isinstance(y, Number):
            ...
            def assertTensorsEqual(a, b):
                ...
                if not allow_different_dtype:
                    super(TestCase, self).assertIs(a.dtype, b.dtype, message)
                if a.numel() > 0:
