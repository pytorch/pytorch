...
allow_list = [
    ...
    ("aten::_foreach_mul_.ScalarList", datetime.date(2021, 2, 2)),
    ("aten::_foreach_addcdiv_.ScalarList", datetime.date(2021, 2, 2)),
    ("aten::_foreach_div.ScalarList", datetime.date(2021, 2, 2)),
    ("aten::_foreach_addcmul_.ScalarList", datetime.date(2021, 2, 2)),
    ("aten::_foreach_sub.ScalarList", datetime.date(2021, 2, 2)),
    ("aten::_foreach_add.ScalarList", datetime.date(2021, 2, 2)),
    ("aten::_foreach_sub_.ScalarList", datetime.date(2021, 2, 2)),
    ("aten::_foreach_add_.ScalarList", datetime.date(2021, 2, 2)),
    ("aten::_foreach_mul.ScalarList", datetime.date(2021, 2, 2)),
