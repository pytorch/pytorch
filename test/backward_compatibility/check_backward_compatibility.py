...
allow_list = [
    ...
    ("aten::_foreach_add", datetime.date(2021, 1, 1)),
    ("aten::_foreach_sub_", datetime.date(2021, 1, 1)),
    ("aten::_foreach_div", datetime.date(2021, 1, 1)),
    ("aten::_foreach_sub", datetime.date(2021, 1, 1)),
    ("aten::_foreach_mul_scalar_list", datetime.date(2021, 1, 10)),
    ("aten::_foreach_mul_scalar_list_", datetime.date(2021, 1, 10)),
    ...
    ("aten::_foreach_sub_scalar_list", datetime.date(2021, 1, 10)),
    ("aten::_foreach_add_scalar_list_", datetime.date(2021, 1, 10)),
    ("aten::_foreach_add_scalar_list", datetime.date(2021, 1, 10)),
    ("aten::_foreach_sub_scalar_list_", datetime.date(2021, 1, 10)),
    ("aten::_foreach_div_scalar_list", datetime.date(2021, 1, 10)),
    ("aten::_foreach_div_scalar_list_", datetime.date(2021, 1, 10)),
    ("aten::_foreach_addcmul_", datetime.date(2021, 1, 15)),
    ("aten::_foreach_addcdiv_", datetime.date(2021, 1, 15)),
    ("aten::_foreach_addcdiv", datetime.date(2021, 1, 15)),
    ("aten::_foreach_addcmul", datetime.date(2021, 1, 15)),
