...
white_list = [
    ...
    ('_batch_norm_impl_index', datetime.date(2019, 10, 30)),
    ('_batch_norm_impl_index_backward', datetime.date(2019, 10, 30)),
    ('cudnn_batch_norm', datetime.date(2019, 10, 30)),
    ('cudnn_batch_norm_backward', datetime.date(2019, 10, 30)),
]
