...
white_list = [
    ...
    ('quantized::linear_unpack', datetime.date(2020, 4, 30)),
    ('quantized::linear_prepack_fp16', datetime.date(2020, 4, 30)),
    ('quantized::linear_prepack', datetime.date(2020, 4, 30)),
    ('quantized::linear_dynamic_fp16', datetime.date(2020, 4, 30)),
    ('quantized::linear_relu_dynamic', datetime.date(2020, 4, 30)),
