...
allow_list = [
    ...
    ('aten::_convolution', datetime.date(2020, 8, 15)),
    ('aten::cudnn_convolution', datetime.date(2020, 8, 15)),
    ('aten::cudnn_convolution_transpose', datetime.date(2020, 8, 15)),
    ('aten::_convolution_double_backward', datetime.date(2020, 8, 15)),
    ('aten::cudnn_convolution_backward_input', datetime.date(2020, 8, 15)),
    ('aten::cudnn_convolution_backward', datetime.date(2020, 8, 15)),
    ('aten::cudnn_convolution_backward_weight', datetime.date(2020, 8, 15)),
    ('aten::cudnn_convolution_transpose_backward', datetime.date(2020, 8, 15)),
    ('aten::cudnn_convolution_transpose_backward_input', datetime.date(2020, 8, 15)),
    ('aten::cudnn_convolution_transpose_backward_weight', datetime.date(2020, 8, 15)),
