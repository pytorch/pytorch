...
allow_list = [
    ...
    ("aten::_foreach_addcmul_", datetime.date(2021, 2, 2)),
    ("aten::_foreach_sub", datetime.date(2021, 2, 2)),
    ("aten::_foreach_add", datetime.date(2021, 2, 2)),
    ("aten::_foreach_sub_", datetime.date(2021, 2, 2)),
    ("aten::_foreach_add_", datetime.date(2021, 2, 2)),
    ("aten::_foreach_mul", datetime.date(2021, 2, 2)),
    ("aten::_foreach_div_", datetime.date(2021, 2, 2)),
