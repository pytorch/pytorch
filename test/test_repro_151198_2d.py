...
class Model(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.pad = torch.nn.ReflectionPad2d(1)  # this fails
        # self.pad = torch.nn.ReplicationPad2d(1)  # this also fails
        # self.pad = torch.nn.CircularPad2d(1)  # this works
        # self.pad = torch.nn.ZeroPad2d(1)  # this works
