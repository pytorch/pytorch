...
def test_rand_like(self):
    ...
    result1 = f_with_generator(t)
    result2 = f_with_generator(t)
    assert torch.allclose(result1, result2), "torch.rand_like with same generator seed should be deterministic"
