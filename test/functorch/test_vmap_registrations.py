...
xfail_not_implemented = {
    ...
    "aten::special_modified_bessel_i.nu_scalar",
    "aten::special_modified_bessel_i.x_scalar",
    "aten::special_modified_bessel_k.nu_scalar",
    "aten::special_modified_bessel_k.x_scalar",
