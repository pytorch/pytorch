...
# No allow_xpu: none of these tests take a `device` parameter, so they build
# CPU tensors regardless of the instantiated device. XPU variants would just
# re-run the CPU tests.
instantiate_device_type_tests(
