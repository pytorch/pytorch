...
class TestSplitDevice(TestCase):
    """Device-parameterized tests for first-class dimension split operations."""

    hw_classification = HardwareClassification.ACCELERATOR

    def test_device_handling(self, device):
        """Test that split preserves the tensor device."""
...
instantiate_device_type_tests(
    TestSplitDevice, globals(), only_for=("cpu", "cuda", "xpu"), allow_xpu=True
)
