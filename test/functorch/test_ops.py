...
class TestOperators(TestCase):
    ...
    @skipOps('TestOperators', 'test_grad', vjp_fail.union({
        ...
        xfail('sparse.spmm_reduce', ''),  # RuntimeError: Sparse CSR tensors do not have strides
    ...
    @skipOps('TestOperators', 'test_vjpvjp', vjp_fail.union({
        ...
        xfail('sparse.spmm_reduce', ''),  # sparse tensors have no strides
