...
def forward(self, L_args_0_ : torch.Tensor, L_args_1_ : torch.Tensor):
    ...
    while_loop = torch.ops.higher_order.while_loop(cond_fn_0, body_fn_0, (l_args_0_, l_args_1_), (l__self___dec, l__self___linear_bias, l__self___linear_weight));  cond_fn_0 = body_fn_0 = l_args_0_ = l_args_1_ = l__self___dec = l__self___linear_bias = l__self___linear_weight = None
    getitem = while_loop[0]
    ...
    return (getitem, getitem_1)""",  # noqa: B950
        ...
        self.assertExpectedInline(
            ...
            """\
def forward(self, l_args_0_, l_args_1_, l__self___dec_cond_fn, l__self___linear_bias_body_fn, l__self___linear_weight_body_fn):
    sub = l_args_0_ - l__self___dec_cond_fn;  l_args_0_ = l__self___dec_cond_fn = None
    gt = sub > 0;  sub = None
    return gt""",  # noqa: B950
        )
        self.assertExpectedInline(
...
def forward(self, l_args_0_, l_args_1_, l__self___dec_cond_fn, l__self___linear_bias_body_fn, l__self___linear_weight_body_fn):
    ...
    linear = torch._C._nn.linear(l_args_1_, l__self___linear_weight_body_fn, l__self___linear_bias_body_fn);  l_args_1_ = l__self___linear_weight_body_fn = l__self___linear_bias_body_fn = None
