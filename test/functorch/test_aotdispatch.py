...
symbolic_aot_autograd_failures = {
    ...
    xfail('nn.functional.grid_sample', ''),  # RuntimeError: aten.grid_sampler_3d.default - couldn't find symbolic meta function/decomposition
    ...
    xfail('max_pool2d_with_indices_backward', ''), # Given input size: (s0xs1x2). Calculated output size: ...
