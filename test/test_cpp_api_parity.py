...
for test_params_dicts, test_instance_class in [
    ...
    module_impl_check.write_tests_to_test_class(
        TestCppApiParity, test_params_dicts, test_instance_class, parity_table, devices)
    functional_impl_check.write_tests_to_test_class(
        TestCppApiParity, test_params_dicts, test_instance_class, parity_table, devices)
