...
class testVariousModelVersions(TestCase):
    ...
    def test_load_and_run_model(self):
        ...
        jit_module_v4 = torch.jit.load(str(script_module_v4_path))
        jit_module_v5 = torch.jit.load(str(script_module_v5_path))
        mobile_module_v4 = _load_for_lite_interpreter(str(script_module_v4_path))
        mobile_module_v5 = _load_for_lite_interpreter(str(script_module_v5_path))
