...
class SerializationMixin:
    ...
    def test_serialization_zipfile_utils(self):
        ...
        def test(name_or_buffer):
            with torch.io.open_zipfile_writer(name_or_buffer) as zip_file:
                for key in data:
            ...
            with torch.io.open_zipfile_reader(name_or_buffer) as zip_file:
                for key in data:
...
class TestSerialization(TestCase, SerializationMixin):
    ...
    def test_serialization_byteorder_mark(self):
        ...
        with torch.io.open_zipfile_reader(databuffer) as zip_file:
    ...
    def test_filewriter_metadata_writing(self, filename):
        ...
        with file_creation_func() as f, file_creation_func() as g:
            ...
            with torch.io.open_file_like(f, 'rb') as opened_file:
                with torch.io.open_zipfile_reader(opened_file) as zip_file:
            ...
            with torch.io.open_zipfile_writer(g) as zip_file:
