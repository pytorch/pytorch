...
graph():
    ...
    %as_strided_default : [num_users=1] = call_function[target=torch.ops.aten.as_strided.default](args = (%b_state, [1], [1], 0), kwargs = {})
    %custom_mutator_tuple_default : [num_users=2] = call_function[target=torch.ops.DO_NOT_USE_TEST_ONLY.custom_mutator_tuple.default](args = (%x, %as_strided_default), kwargs = {})
