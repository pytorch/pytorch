...
graph():
    ...
    %add : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul, %p_p2), kwargs = {})
    %sum_1 : [num_users=1] = call_function[target=torch.ops.aten.sum.default](args = (%add,), kwargs = {})
    %access_subclass_inner_tensor_32 : [num_users=1] = call_function[target=torch.ops.higher_order.access_subclass_inner_tensor](args = (%sum_1, a), kwargs = {})
    %access_subclass_inner_tensor_37 : [num_users=1] = call_function[target=torch.ops.higher_order.access_subclass_inner_tensor](args = (%access_subclass_inner_tensor_32, b), kwargs = {})
    %add_1 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%x, %access_subclass_inner_tensor_37), kwargs = {})
    return (add_1,)""",
        )
        ep = export(m, (ref_x,))
...
graph():
    ...
    %access_subclass_inner_tensor_10 : [num_users=1] = call_function[target=torch.ops.higher_order.access_subclass_inner_tensor](args = (%add_1, elem), kwargs = {})
    %access_subclass_inner_tensor_13 : [num_users=1] = call_function[target=torch.ops.higher_order.access_subclass_inner_tensor](args = (%access_subclass_inner_tensor_10, elem), kwargs = {})
    %add_2 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%x, %access_subclass_inner_tensor_13), kwargs = {})
    return (add_2,)""",
        )
        ep = export(m, (ref_x,))
        self.assertTrue(torch.allclose(ep.module()(ref_x), ref_out))
...
graph():
    ...
    %access_subclass_inner_tensor_18 : [num_users=1] = call_function[target=torch.ops.higher_order.access_subclass_inner_tensor](args = (%add, a), kwargs = {})
    %access_subclass_inner_tensor_21 : [num_users=1] = call_function[target=torch.ops.higher_order.access_subclass_inner_tensor](args = (%access_subclass_inner_tensor_18, elem), kwargs = {})
    %add_1 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add, %access_subclass_inner_tensor_21), kwargs = {})
    %add_2 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_1, 4), kwargs = {})
    %access_subclass_inner_tensor_25 : [num_users=1] = call_function[target=torch.ops.higher_order.access_subclass_inner_tensor](args = (%add_2, a), kwargs = {})
    %access_subclass_inner_tensor_28 : [num_users=1] = call_function[target=torch.ops.higher_order.access_subclass_inner_tensor](args = (%access_subclass_inner_tensor_25, elem), kwargs = {})
    %add_3 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%x, %access_subclass_inner_tensor_28), kwargs = {})
    return (add_3,)""",
        )
        ep = export(m, (ref_x,))
        self.assertTrue(torch.allclose(ep.module()(ref_x), ref_out))
...
graph():
    ...
    %access_subclass_inner_tensor_10 : [num_users=1] = call_function[target=torch.ops.higher_order.access_subclass_inner_tensor](args = (%add_1, elem), kwargs = {})
    %access_subclass_inner_tensor_13 : [num_users=1] = call_function[target=torch.ops.higher_order.access_subclass_inner_tensor](args = (%access_subclass_inner_tensor_10, elem), kwargs = {})
    %add_2 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%access_subclass_inner_tensor_13, 4), kwargs = {})
    return (add_2,)""",
        )
        ep = export(m, (ref_x,))
        self.assertTrue(torch.allclose(ep.module()(ref_x), ref_out))
