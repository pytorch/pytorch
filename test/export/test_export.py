...
def forward(self, x):
    ...
    _batch_norm_with_update_functional = torch.ops.aten._batch_norm_with_update_functional.default(conv2d, bn_weight, bn_bias, bn_running_mean, bn_running_var, True, 0.1, 1e-05);  conv2d = bn_weight = bn_bias = None
    getitem = _batch_norm_with_update_functional[0]
    getitem_3 = _batch_norm_with_update_functional[3]
    getitem_4 = _batch_norm_with_update_functional[4];  _batch_norm_with_update_functional = None
