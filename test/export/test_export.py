...
graph():
    ...
    %lazy_load_decompositions : [num_users=0] = call_function[target=torch._functorch.vmap.lazy_load_decompositions](args = (), kwargs = {})
...
graph():
    ...
    %lazy_load_decompositions : [num_users=0] = call_function[target=torch._functorch.vmap.lazy_load_decompositions](args = (), kwargs = {})
    %_vmap_increment_nesting_in_graph : [num_users=0] = call_function[target=torch._functorch.vmap._vmap_increment_nesting_in_graph](args = (%sym_size_int_2, error), kwargs = {})
    %_add_batch_dim_in_graph : [num_users=1] = call_function[target=torch._functorch.vmap._add_batch_dim_in_graph](args = (%x, 0, 1), kwargs = {})
    %_add_batch_dim_in_graph_1 : [num_users=1] = call_function[target=torch._functorch.vmap._add_batch_dim_in_graph](args = (%y, 0, 1), kwargs = {})
    %mul : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%_add_batch_dim_in_graph, %_add_batch_dim_in_graph_1), kwargs = {})
    %add : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul, 1), kwargs = {})
    %sum_1 : [num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%add, [0]), kwargs = {})
    %_remove_batch_dim_in_graph : [num_users=1] = call_function[target=torch._functorch.vmap._remove_batch_dim_in_graph](args = (%sum_1, 1, %sym_size_int_2, 0), kwargs = {})
    %_vmap_decrement_nesting_in_graph : [num_users=0] = call_function[target=torch._functorch.vmap._vmap_decrement_nesting_in_graph](args = (), kwargs = {})
    %sum_2 : [num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%_remove_batch_dim_in_graph, [0]), kwargs = {})
    return (sum_2,)""",
        )
