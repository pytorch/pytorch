...
def forward(self, b_a_buffer, x):
    ...
    @testing.expectedFailureStrict  # Raw scan op with Python body is not strict-exportable.
    @testing.expectedFailureStrictV2  # Raw scan op with Python body is not strict-exportable.
    @testing.expectedFailureTrainingIRToRunDecomp  # Strict export runs before decomp.
    @testing.expectedFailureSerDer  # Strict export runs before serialization.
