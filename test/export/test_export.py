...
def forward(self, p_linear_weight, p_linear_bias, b_buffer, x):
    ...
    def test_dynamic_shapes_inferred_basic(self):
        ...
        def expect_error(bad_args, run_time_msg, compile_time_msg):
            ...
            ctx = nullcontext() if compile_time_msg is None else self.assertRaisesRegex(RuntimeError, compile_time_msg)
            # TODO: why is this not erroring in some cases?
            with ctx:
        ...
        expect_error(
            ...
            compile_time_msg=None,  #"Expected input.*to be >= 3, but got 2",
        )
        ...
        expect_error(
            ...
            compile_time_msg=None,  # "Expected input.*to be equal to 6, but got 7",
        )
