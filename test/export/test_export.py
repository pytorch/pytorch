...
def forward(self, x, mask):
    ...
    eq_4 = mod == 0;  mod = None
    _assert_scalar_default_2 = torch.ops.aten._assert_scalar.default(eq_4, "Runtime assertion failed for expression Eq(Mod(u0, 1548), 0) on node 'eq_4'");  eq_4 = _assert_scalar_default_2 = None
