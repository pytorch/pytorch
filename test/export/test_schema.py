...
Example(s):
    ...
    def test_schema_comparison(self):
        ...
        sig = schema.ModuleCallSignature(
            inputs=[schema.Argument.create(as_none=True), schema.Argument.create(as_sym_int=schema.SymIntArgument.create(as_name="s0"))],
            outputs=[schema.Argument.create(as_sym_int=schema.SymIntArgument.create(as_name="s1"))],
            in_spec="foo",
            out_spec="bar",
        ...
        sig_diff = schema.ModuleCallSignature(
            inputs=[schema.Argument.create(as_none=True), schema.Argument.create(as_sym_int=schema.SymIntArgument.create(as_name="s0"))],
            outputs=[schema.Argument.create(as_sym_int=schema.SymIntArgument.create(as_name="s2"))],
            in_spec="foo",
            out_spec="bar",
            forward_arg_names=["None", "symint"],
        )
