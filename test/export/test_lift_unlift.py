...
class TestLift(TestCase):
    ...
    def test_lift_basic(self):
        ...
        self.assertIn("lifted_tensor_constant0", constants)
        self.assertEqual(constants["lifted_tensor_constant0"], const_tensor)
        self.assertIn("lifted_custom_obj0", constants)
        self.assertEqual(constants["lifted_custom_obj0"], const_obj)
        ...
        self.assertEqual(lifted_tensor_placeholder.target, "lifted_tensor_constant0")
        ...
        self.assertEqual(lifted_obj_placeholder.target, "lifted_custom_obj0")
        # It should have a val equivalent to the constant
        self.assertEqual(
            lifted_obj_placeholder.meta["val"],
            CustomObjArgument(
                name="lifted_custom_obj0",
    ...
    def test_lift_nested(self):
        ...
        # The key of the constants table should match the fqn of the constant.
        self.assertIn("foo.lifted_tensor_constant0", constants)
        self.assertEqual(constants["foo.lifted_tensor_constant0"], const_tensor)
        ...
        self.assertEqual(lifted_constant_placeholder.target, "lifted_tensor_constant0")
