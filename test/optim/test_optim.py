...
class TestOptim(TestCase):
    ...
    def test_adamw(self):
        ...
        self._test_complex_2d(functools.partial(optim.AdamW, amsgrad=True))
        self._test_complex_2d(functools.partial(optim.AdamW, amsgrad=True, weight_decay=0.2))
        ...
        self._test_complex_2d(functools.partial(optim.AdamW, foreach=False, amsgrad=True, weight_decay=0.2))
        with self.assertRaisesRegex(ValueError, "Invalid weight_decay value: -1"):
