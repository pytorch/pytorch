...
class TestOptim(TestCase):
    ...
    def _multi_tensor_optimizer_configs(self):
        return [
            ...
            (optim.Adamax, dict(weight_decay=0, capturable=True)),
            (optim.Adamax, dict(weight_decay=1, capturable=True)),
            (optim.Adamax, dict(weight_decay=0, maximize=True, capturable=True)),
            (optim.Adamax, dict(weight_decay=1, maximize=True, capturable=True)),
