...
class TestProfiler(TestCase):
    ...
    def test_profiler_elapsed_time(self):
        ...
        compute_events = [e for e in events if "aten::mm" in e.name or "aten::matmul" in e.name]
        if compute_events:
    ...
    def test_profiler_with_backward_pass(self):
        ...
        self.assertTrue(any("aten::mm" in name or "aten::matmul" in name for name in event_names))
...
class TestProfilerIntegration(TestCase):
    ...
    def test_profiler_with_simple_model(self):
        ...
        event_names = [e.name for e in events]
        self.assertTrue(any("linear" in name.lower() or "addmm" in name.lower() 
    ...
    def test_profiler_table_with_model(self):
        ...
        self.assertTrue(any(keyword in table.lower() 
                           for keyword in ["linear", "addmm", "relu"]))
