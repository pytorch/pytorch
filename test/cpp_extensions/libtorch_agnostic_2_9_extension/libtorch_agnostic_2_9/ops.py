...
def test_tensor_device(t):
    ...
    """
    return torch.ops.libtorch_agnostic_2_9.test_tensor_device.default(t)
...
def my__foreach_mul_(tensors, others) -> ():
    ...
    """
    torch.ops.libtorch_agnostic_2_9.my__foreach_mul_.default(tensors, others)
...
def my__foreach_mul(tensors, others) -> list[Tensor]:
    ...
    """
    return torch.ops.libtorch_agnostic_2_9.my__foreach_mul.default(tensors, others)
...
def make_tensor_clones_and_call_foreach(t1, t2) -> list[Tensor]:
    ...
    """
    return torch.ops.libtorch_agnostic_2_9.make_tensor_clones_and_call_foreach.default(
        t1, t2
    )
...
def test_device_equality(d1, d2) -> bool:
    ...
    """
    return torch.ops.libtorch_agnostic_2_9.test_device_equality.default(d1, d2)
...
def test_device_set_index(device, index):
    ...
    """
    return torch.ops.libtorch_agnostic_2_9.test_device_set_index.default(device, index)
...
def test_device_index(device) -> int:
    ...
    """
    return torch.ops.libtorch_agnostic_2_9.test_device_index.default(device)
...
def test_device_is_cuda(device) -> bool:
    ...
    """
    return torch.ops.libtorch_agnostic_2_9.test_device_is_cuda.default(device)
...
def test_device_is_cpu(device) -> bool:
    ...
    """
    return torch.ops.libtorch_agnostic_2_9.test_device_is_cpu.default(device)
...
def test_parallel_for(size, grain_size) -> Tensor:
    ...
    """
    return torch.ops.libtorch_agnostic_2_9.test_parallel_for.default(size, grain_size)
...
def test_get_num_threads() -> int:
    ...
    """
    return torch.ops.libtorch_agnostic_2_9.test_get_num_threads.default()
...
def my_empty(size, dtype=None, device=None, pin_memory=None) -> Tensor:
    ...
    """
    return torch.ops.libtorch_agnostic_2_9.my_empty.default(
...
def my_reshape(t, shape) -> Tensor:
    ...
    """
    return torch.ops.libtorch_agnostic_2_9.my_reshape.default(t, shape)
...
def my_view(t, size) -> Tensor:
    ...
    """
    return torch.ops.libtorch_agnostic_2_9.my_view.default(t, size)
