...
class TestLazyReuseIr(TestCase):
    ...
    def testBatchNorm(self):
        ...
        for i in range(10):
            ...
            z, _, _ = torch.ops.aten.native_batch_norm(x, weight, bias, True, 0.1, 1e-5)
        ...
        for i in range(10):
            ...
            z_lazy, _, _ = torch.ops.aten.native_batch_norm(x_lazy, weight_lazy, bias_lazy, True, 0.1, 1e-5)
            torch._lazy.mark_step()
