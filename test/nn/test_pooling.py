...
"""
    ...
    @onlyNativeDeviceTypesAnd(["hpu"])  # TODO: fix on XLA
    ...
    @dtypesIfCUDA(torch.half, torch.float, torch.double)
    @dtypes(torch.float)
    @onlyNativeDeviceTypesAnd(["hpu"])  # TODO: Fails on XLA
    @gcIfJetson
    ...
    @onlyNativeDeviceTypesAnd(["hpu"])  # TODO: RuntimeError message different on XLA
