...
<<<<<<< HEAD
    TEST_WITH_ROCM, skipCUDAIf, skipMeta, onlyCUDAAndPRIVATEUSE1, \
    dtypeIfCUDAAndPRIVATEUSE1
=======
...
<<<<<<< HEAD
        ix = ix.to(TEST_DEVICE)
        out = create_embedding(TEST_DEVICE)(ix)
=======
        ix = ix.to('cuda')
...
<<<<<<< HEAD
            ...
            embedding.to(device)
            self.assertEqual(embedding.weight.device.type, device)
            embedding.to('cpu')
            self.assertEqual(embedding.weight.device.type, 'cpu')
=======
>>>>>>> aca461ede2729d856f3dbcaf506c62ed14bb0947
...
<<<<<<< HEAD
    @dtypesIfCUDAAndPRIVATEUSE1(torch.float16, torch.float64)
=======
...
<<<<<<< HEAD
    @dtypesIfCUDAAndPRIVATEUSE1(*((torch.float, torch.double, torch.bfloat16, torch.half)
=======
...
<<<<<<< HEAD
    @dtypesIfCUDAAndPRIVATEUSE1(torch.half, torch.bfloat16)
=======
...
<<<<<<< HEAD
    @dtypesIfCUDAAndPRIVATEUSE1(*itertools.product((torch.int, torch.long), (torch.int, torch.long),
=======
...
<<<<<<< HEAD
    @dtypesIfCUDAAndPRIVATEUSE1(*itertools.product((torch.int, torch.long), (torch.half, torch.float, torch.double)))
=======
