...
class PackedSequenceTest(TestCase):
    ...
    def test_pad_sequence(self):
        ...
        with self.assertRaisesRegex(RuntimeError, r'Overflow for int64'):
            rnn_utils.pad_sequence([torch.tensor([1, 2, 3]), torch.tensor([4, 5])], padding_value=torch.iinfo(torch.int64).max-1)
