...
def _load_pair(code, cache):
    ...
    since load is paths-only. Both halves go out as bytes, as _write_artifact does:
    a text-mode write would translate the newlines on Windows and load() would then
