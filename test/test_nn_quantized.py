...
class ModuleAPITest(QuantizationTestCase):
    ...
    def test_linear_api(self, batch_size, in_features, out_features, use_bias, use_fused):
        ...
        # Test JIT
        self.checkScriptable(qlinear, ref_inputs=X_q, ref_outputs=Z_ref)
    ...
    def test_conv_api(self, use_bias, use_fused):
        ...
        # JIT testing
        self.checkScriptable(conv_under_test, ref_inputs=(qX,), ref_outputs=result_reference)
    ...
    def test_pool_api(self):
        ...
        # JIT Testing
        self.checkScriptable(pool_under_test, ref_inputs=(X,), ref_outputs=qX_expect)
