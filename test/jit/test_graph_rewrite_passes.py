...
class TestGraphRewritePasses(JitTestCase):
    ...
    @unittest.skipUnless(environ.get("USE_VULKAN") == "1", "Test depends on Vulkan installation.")
    def test_vulkan_insert_pre_packed_ops(self) -> None:
        ...
        # this test fails!
        model_3 = torch.jit.script(FunctionalConv2d(conv2d_weight, conv2d_bias), [x_2])
        self.check_single_replacement(
            "aten::conv2d",
