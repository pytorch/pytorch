...
class TestAsync(JitTestCase):
    ...
    @unittest.skipIf(True, "Test is flaky: https://github.com/pytorch/pytorch/issues/29764")
    ...
    @unittest.skipIf(True, "Test is flaky: https://github.com/pytorch/pytorch/issues/29842")
