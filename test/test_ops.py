...
class TestFakeTensor(TestCase):
    ...
    def _test_fake_helper(self, device, dtype, op, context):
        ...
        for sample in samples:
            ...
            allow_dynamic_output_shape_shape_env.allow_dynamic_output_shape_ops = True

            allow_dynamic_output_shape_mode = FakeTensorMode(shape_env=allow_dynamic_output_shape_shape_env)
            ...
            def run_with_fake_mode_and_verify(fake_mode, match_results=True):
                ...
                try:
                    ...
                    self.assertTrue(mode.shape_env is None
            ...
            if name in supported_dynamic_output_op_tests:
                run_with_fake_mode_and_verify(allow_dynamic_output_shape_mode, match_results=False)
