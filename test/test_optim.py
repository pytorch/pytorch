...
class TestOptim(TestCase):
    ...
    def test_multi_tensor_optimizers(self):
        ...
        optimizer_pairs_with_flags = [
            ...
            ((optim.AdaBelief, optim._multi_tensor.AdaBelief), dict(weight_decay=1., amsgrad=True,rectify=True)),
            ((optim.AdaBelief, optim._multi_tensor.AdaBelief), dict(weight_decay=1., amsgrad=False,rectify=True)),
            ((optim.AdaBelief, optim._multi_tensor.AdaBelief), dict(weight_decay=0., amsgrad=True,rectify=True)),
            ((optim.AdaBelief, optim._multi_tensor.AdaBelief), dict(weight_decay=0., amsgrad=False,rectify=True)),
            ((optim.AdaBelief, optim._multi_tensor.AdaBelief), dict(weight_decay=1., amsgrad=True,rectify=False)),
            ((optim.AdaBelief, optim._multi_tensor.AdaBelief), dict(weight_decay=1., amsgrad=False,rectify=False)),
            ((optim.AdaBelief, optim._multi_tensor.AdaBelief), dict(weight_decay=0., amsgrad=True,rectify=False)),
            ((optim.AdaBelief, optim._multi_tensor.AdaBelief), dict(weight_decay=0., amsgrad=False,rectify=False)),
