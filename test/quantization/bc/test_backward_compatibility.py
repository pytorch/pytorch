...
# Testing utils
from torch.testing._internal.common_utils import TestCase, IS_CASCADE_LAKE
...
class TestSerialization(TestCase):
    ...
    @override_qengines
    @unittest.skipIf(IS_CASCADE_LAKE, "This test fails on Intel Cascade Lake machines. Ref: Issue 59098")
    def test_lstm(self):
