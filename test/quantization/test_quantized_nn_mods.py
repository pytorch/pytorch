...
class FunctionalAPITest(QuantizationTestCase):
    ...
    @given(batch_size=st.integers(1, 3),
           ...
           X_scale=st.floats(1.2, 1.6, width=32, exclude_min=True, exclude_max=True),
           X_zero_point=st.integers(0, 4),
           W_scale=st.lists(st.floats(0.2, 1.6, width=32, exclude_min=True, exclude_max=True), min_size=1, max_size=2),
           W_zero_point=st.lists(st.integers(-5, 5), min_size=1, max_size=2),
           Y_scale=st.floats(4.2, 5.6, width=32, exclude_min=True, exclude_max=True),
    ...
    @given(batch_size=st.integers(1, 3),
           ...
           X_zero_point=st.integers(0, 4),
           W_scale=st.lists(st.floats(0.20000000298023224, 1.6, width=32), min_size=1, max_size=2),
           W_zero_point=st.lists(st.integers(-5, 5), min_size=1, max_size=2),
