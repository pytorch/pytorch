...
print("Model #0 Evaluation accuracy on test dataset: {:2.2f}, {:2.2f}".format(top1.avg, top5.avg))
...
print("Model #1 Evaluation accuracy on test dataset (b=8, k=2): {:2.2f}, {:2.2f}".format(top1.avg, top5.avg))
...
print("Model #1 Evaluation accuracy on test dataset (b=4, k=2): {:2.2f}, {:2.2f}".format(top1.avg, top5.avg))
...
print("Model #2 Evaluation accuracy on test dataset (b=8, k=2): {:2.2f}, {:2.2f}".format(top1.avg, top5.avg))
...
top1, top5 = evaluate(prepared_model, criterion, data_loader_test)
print("Model #2 Evaluation accuracy on test dataset (b=4, k=2): {:2.2f}, {:2.2f}".format(top1.avg, top5.avg))
...
top1, top5 = evaluate(prepared_model, criterion, data_loader_test)
print("Model #3 Evaluation accuracy on test dataset (b=8, k=2): {:2.2f}, {:2.2f}".format(top1.avg, top5.avg))
...
top1, top5 = evaluate(prepared_model, criterion, data_loader_test)
print("Model #3 Evaluation accuracy on test dataset (b=4, k=2): {:2.2f}, {:2.2f}".format(top1.avg, top5.avg))
...
print("Eager mode quantized model evaluation accuracy on test dataset: {:2.2f}, {:2.2f}".format(top1.avg, top5.avg))
