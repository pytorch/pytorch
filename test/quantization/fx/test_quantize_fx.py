...
class TestQuantizeFx(QuantizationTestCase):
    ...
    def test_register_patterns(self):
        ...
        @register_quant_pattern("dummy_quant2", default_affine_fixed_qparams_range_0to1_observer)
        class DummyQuant2():
            pass

        @register_quant_pattern("dummy_quant3", default_symmetric_fixed_qparams_range_neg1to1_observer)
        class DummyQuant3():
            pass
        ...
        self.assertEqual(DEFAULT_OUTPUT_OBSERVER_MAP["dummy_quant2"], default_affine_fixed_qparams_range_0to1_observer)
        self.assertEqual(DEFAULT_OUTPUT_OBSERVER_MAP["dummy_quant3"], default_symmetric_fixed_qparams_range_neg1to1_observer)
        ...
        self.assertEqual(output_observer_map.get("dummy_quant3"), default_symmetric_fixed_qparams_range_neg1to1_observer)
