...
class TestEqualizeFx(QuantizationTestCase):
    ...
    def test_input_weight_equalization_prepare(self):
        ...
        for (M, node_occurrence) in tests:
            ...
            sample_args = (torch.randn(1, 1, 1, 1),)
            prepared = prepare_fx(m, specific_qconfig_dict, sample_args=sample_args, equalization_qconfig_dict=default_equalization_qconfig_dict)
    ...
    def test_input_weight_equalization_branching(self):
        ...
        sample_args = (torch.randn(1, 5),)
        prepared = prepare_fx(
            m, specific_qconfig_dict, sample_args=sample_args,
