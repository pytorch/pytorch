...
class TestDynamicQuantizedModule(QuantizationTestCase):
    ...
    def test_embedding_serialization(self, qemb, num_embeddings, embedding_dim, indices, offsets, set_qconfig, is_emb_bag):
    ...
    def test_embedding_bag_api(self, num_embeddings, embedding_dim, num_offsets, set_qconfig):
        ...
        self.test_embedding_serialization(qemb, num_embeddings, embedding_dim, indices, offsets, set_qconfig, is_emb_bag=True)
    ...
    def test_embedding_api(self, num_embeddings, embedding_dim, set_qconfig):
        ...
        self.assertEqual(module_out, ref)
        self.test_embedding_serialization(qemb, num_embeddings, embedding_dim, indices, None, set_qconfig=False, is_emb_bag=False)
