...
from torch.quantization import (FakeQuantize, FixedQParamsFakeQuantize,
                                HistogramObserver, MinMaxObserver,
                                MovingAverageMinMaxObserver,
                                MovingAveragePerChannelMinMaxObserver,
                                NoopObserver, PerChannelMinMaxObserver,
                                PlaceholderObserver, QConfig,
                                RecordingObserver,
...
from torch.testing._internal.common_quantization import (
    AnnotatedSingleLayerLinearModel, QuantizationTestCase,
