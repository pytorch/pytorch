...
from torch.quantization import (DeQuantStub, FixedQParamsFakeQuantize,
                                PerChannelMinMaxObserver, QConfigDynamic,
                                QuantStub, QuantType, QuantWrapper, convert,
                                ...
                                fuse_modules, get_default_qat_qconfig,
                                get_default_qconfig,
                                per_channel_dynamic_qconfig, prepare,
                                prepare_qat, quant_type_to_str,
                                quantize_dynamic)
...
from torch.testing._internal.common_quantization import (
    QuantizationTestCase, ResNetBase, RNNCellDynamicModel, RNNDynamicModel,
    run_ddp, skip_if_no_torchvision, skipIfNoFBGEMM, test_only_eval_fn,
    test_only_train_fn, train_one_epoch)
