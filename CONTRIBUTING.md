...
- [Building PyTorch with ASAN](#building-pytorch-with-asan)
  ...
  - [Why this stuff with `LD_PRELOAD` and `LIBASAN_RT`?](#why-this-stuff-with-ldpreload-and-libasanrt)
  - [Why LD_PRELOAD in the build function?](#why-ldpreload-in-the-build-function)
