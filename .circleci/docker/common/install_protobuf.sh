...
# This function installs protobuf 3.17.3
...
install_ubuntu() {
  # Ubuntu 14.04 ships with protobuf 2.5, but ONNX needs protobuf >= 3.17
...
install_centos() {
  # Centos7 ships with protobuf 2.5, but ONNX needs protobuf >= 3.17.3
