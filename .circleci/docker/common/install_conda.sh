...
if [ -n "$ANACONDA_PYTHON_VERSION" ]; then
  ...
  # only)
  # matplotlib is pinned, see: https://github.com/pytorch/pytorch/issues/41680
  as_jenkins pip install --progress-bar off pytest scipy==1.1.0 scikit-learn==0.20.3 scikit-image librosa>=0.6.2 psutil numba==0.46.0 llvmlite==0.30.0 matplotlib==3.2.2
