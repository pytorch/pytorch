...
if [ -n "$ANACONDA_PYTHON_VERSION" ]; then
  ...
  # only)
  as_jenkins pip install --progress-bar off pytest hypothesis==4.53.2 unittest-xml-reporting scipy==1.1.0 scikit-learn==0.20.3 scikit-image librosa>=0.6.2 psutil numba==0.46.0 llvmlite==0.30.0
