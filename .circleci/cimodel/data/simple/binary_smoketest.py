...
WORKFLOW_DATA = [
    ...
    SmoketestJob(
        ...
        ["conda", "3.7", "cu110"],
        None,
        "binary_windows_conda_3_7_cu110_build",
        is_master_only=False,
    ),
    SmoketestJob(
        "binary_windows_build",
    ...
    SmoketestJob(
        "binary_windows_build",
        ["libtorch", "3.7", "cu110", "debug"],
        None,
        "binary_windows_libtorch_3_7_cu110_debug_build",
        is_master_only=False,
    ),
    SmoketestJob(
        "binary_windows_build",
        ["libtorch", "3.7", "cu110", "release"],
        None,
        "binary_windows_libtorch_3_7_cu110_release_build",
        is_master_only=False,
    ),
    SmoketestJob(
        "binary_windows_test",
