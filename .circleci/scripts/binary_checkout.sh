...
retry git clone https://github.com/pytorch/pytorch.git -b 1.6 "$PYTORCH_ROOT"
pushd "$PYTORCH_ROOT"
...
retry git clone -q https://github.com/mszhanyi/builder.git -b zhanyi/disabledefener "$BUILDER_ROOT"
pushd "$BUILDER_ROOT"
