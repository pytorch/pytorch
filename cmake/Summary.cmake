...
function(caffe2_print_configuration_summary)
  ...
  if(SKBUILD)
    ...
    message(STATUS "  SKBUILD_PLATLIB_DIR   : <not a scikit-build-core build>")
  endif()
  ...
  if(${USE_ROCM})
    ...
    message(STATUS "    USE_ROCM_CK_SDPA_GFX12        : ${USE_ROCM_CK_SDPA_GFX12}")
    ...
    message(STATUS "    USE_HIPSPARSELT               : ${USE_HIPSPARSELT}")
    message(STATUS "    USE_CUFILE                    : ${USE_CUFILE}")
  endif()
  ...
  message(STATUS "  USE_LLVM_BOLT         : ${USE_LLVM_BOLT}")
  ...
  if(${USE_NCCL})
    ...
    if(${USE_NCCL_EP})
      message(STATUS "      USE_SYSTEM_NCCL_EP  : ${USE_SYSTEM_NCCL_EP}")
    endif()
  endif()
  if(${USE_ROCM})
