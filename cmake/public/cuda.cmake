...
if(MSVC AND MSVC_VERSION GREATER 1927)
  file(MAKE_DIRECTORY ${CMAKE_BINARY_DIR}/win_tmp/tmp_includes)
  file(DOWNLOAD "https://raw.githubusercontent.com/microsoft/STL/12c684bba78f9b032050526abdebf14f58ca26a3/stl/inc/cmath" "${CMAKE_BINARY_DIR}/win_tmp/tmp_includes/cmath" STATUS status)
  list(GET status 0 status_code)
  list(GET status 1 status_string)
  message("status ${status_code} ${status_string}")
  if(NOT status_code EQUAL 0)
    message(FATAL_ERROR "error downloading cmath from the STL repo")
  endif()
  file(READ "${CMAKE_BINARY_DIR}/win_tmp/tmp_includes/cmath" CMATH_CONTENT)
  message("Downloaded content:")
  message("${CMATH_CONTENT}")
