...
# by adding --use-local-env and --cl-version=xxx when needed
...
if(MSVC AND CMAKE_GENERATOR STREQUAL "Ninja" AND NOT DEFINED ENV{CUDAHOSTCXX})
  if(MSVC_TOOLSET_VERSION EQUAL 140)
    list(APPEND CUDA_NVCC_FLAGS "--use-local-env" "--cl-version=2015")
  elseif(MSVC_TOOLSET_VERSION EQUAL 141)
    list(APPEND CUDA_NVCC_FLAGS "--use-local-env" "--cl-version=2017")
  elseif(MSVC_TOOLSET_VERSION EQUAL 142)
    list(APPEND CUDA_NVCC_FLAGS "--use-local-env" "--cl-version=2019")
  endif()
