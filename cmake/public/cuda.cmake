...
if(CAFFE2_USE_CUDNN)
  ...
  message(STATUS "CAFFE2_USE_CUDNN is set to 0. Compiling without cuDNN support")
endif()
...
if(CAFFE2_USE_CUFILE)
  ...
  message(STATUS "CAFFE2_USE_CUFILE is set to 0. Compiling without cuFile support")
endif()
