...
function(torch_compile_options libname)
  ...
  if(MSVC)
    ...
    if("${libname}" STREQUAL "torch_cpu")
      list(APPEND private_compile_options -Wunused-function -Werror=unused-function)
      list(APPEND private_compile_options -Wunused-variable -Werror=unused-variable)
      if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
        list(APPEND private_compile_options -Wunused-but-set-variable -Werror=unused-but-set-variable)
      endif()
      if("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang")
        list(APPEND private_compile_options -Wunused-private-field -Werror=unused-private-field)
      endif()
    else()
