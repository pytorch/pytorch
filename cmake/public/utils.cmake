...
function(caffe2_binary_target target_name_or_src)
  if (${ARGN})
    ...
    set(__srcs "${target_name_or_src}")
  endif()

  set(__abs_srcs "")
  foreach(__src ${__srcs})
    get_filename_component(__abs_src ${__src} ABSOLUTE)
    list(APPEND __abs_srcs ${__abs_src})
  endforeach()

  if (USE_ROCM)
    set_source_files_properties(${__abs_srcs} PROPERTIES HIP_SOURCE_PROPERTY_FORMAT 1)
    hip_add_executable(${__target} ${__abs_srcs})
    set_target_properties(${__target} PROPERTIES LINK_FLAGS "-Wl,--unresolved-symbols=ignore-in-shared-libs")
  else()
    add_executable(${__target} ${__abs_srcs})
  endif()
