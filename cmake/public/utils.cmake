...
function(_link_option_supported_var flag outputvar)
  string(MAKE_C_IDENTIFIER "HAS_LINKER_${flag}" _FLAG_NAME)
  string(TOUPPER "${_FLAG_NAME}" _FLAG_NAME)
  set(${outputvar} "${_FLAG_NAME}" PARENT_SCOPE)
endfunction()

function(add_link_options_if_supported flag)
  _link_option_supported_var("${flag}" _supported)
