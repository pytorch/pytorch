...
if(NOT DEFINED ENV{ROCM_PATH})
  if(EXISTS /opt/rocm)
    ...
    find_program(HIPCONFIG_PROGRAM hipconfig)
    if(HIPCONFIG_PROGRAM)
      execute_process(COMMAND ${HIPCONFIG_PROGRAM} -R OUTPUT_VARIABLE hc_ROCM_PATH)
      if(EXISTS ${hc_ROCM_PATH})
	set(ROCM_PATH ${hc_ROCM_PATH})
      endif()
    endif()
