...
IF(HIP_FOUND)
  ...
  set(thrust_INCLUDE_DIRS ${THRUST_PATH} ${THRUST_PATH}/thrust/system/cuda/detail/cub-hip PARENT_SCOPE)
  set(rocrand_INCLUDE_DIRS ${ROCM_PATH}/include/rocrand PARENT_SCOPE)
