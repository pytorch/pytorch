...
# ---[ Check if the compiler has AVX/AVX2/AVX512 support. We don't specifically detect AVX. Instead,
# we use the presence of AVX2 to determine AVX.
if(NOT INTERN_BUILD_MOBILE)
  find_package(AVX)  # checks AVX/AVX2/AVX512
  if(CXX_AVX2_FOUND)
