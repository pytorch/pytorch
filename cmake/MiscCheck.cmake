...
if(USE_ASAN)
  if(MSVC)
    set(CAFFE2_ASAN_FLAG "-fsanitize=address")
    if(BUILD_SHARED_LIBS)
      set(CAFFE2_ASAN_LIBS clang_rt.asan_dynamic-x86_64.lib clang_rt.asan_dynamic_runtime_thunk-x86_64.lib)
    else()
      set(CAFFE2_ASAN_LIBS clang_rt.asan-x86_64.lib clang_rt.asan_cxx-x86_64.lib clang_rt.asan_dll_thunk-x86_64.lib)
    endif()
    foreach(asan_lib CAFFE2_ASAN_LIBS)
      set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} ${asan_lib} -wholearchive:${asan_lib}")
      set(CMAKE_MODULE_LINKER_FLAGS "${CMAKE_MODULE_LINKER_FLAGS} ${asan_lib} -wholearchive:${asan_lib}")
      set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} ${asan_lib} -wholearchive:${asan_lib}")
    endforeach()
  else()
