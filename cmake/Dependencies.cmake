...
if(NOT BLAS_SET_BY_USER)
  if(BUILD_ATEN)
    message(STATUS "Defaulting BLAS to MKL because BUILD_ATEN is ON")
    set(BLAS "MKL" CACHE STRING "Selected BLAS library")
  else()
    message(STATUS "Defaulting BLAS to Eigen")
...
if(BLAS STREQUAL "ATLAS")
  ...
  if(Atlas_FOUND)
    ...
    message(WARNING "Atlas could not be found. Defaulting to Eigen")
    set(BLAS "Eigen" CACHE STRING "Selected BLAS library")
  endif()
# OpenBLAS
elseif(BLAS STREQUAL "OpenBLAS")
  ...
  if(OpenBLAS_FOUND)
    ...
    message(WARNING "OpenBLAS could not be found. Defaulting to Eigen")
    set(BLAS "Eigen" CACHE STRING "Selected BLAS library")
  endif()
# MKL
elseif(BLAS STREQUAL "MKL")
  ...
  if(NOT USE_IDEEP_SET_BY_USER)
    message(STATUS "For MKL, using IDEEP by default.")
    set(USE_IDEEP ON)
  endif()
  if(NOT USE_MKLML_SET_BY_USER)
    message(STATUS "For MKL, using MKLML by default.")
    set(USE_MKLML ON)
  endif()
...
elseif(BLAS STREQUAL "vecLib")
  ...
  if(vecLib_FOUND)
    ...
    message(WARNING "vecLib could not be found. Defaulting to Eigen")
    set(BLAS "Eigen" CACHE STRING "Selected BLAS library")
  endif()
# Eigen
elseif(NOT BLAS STREQUAL "Eigen")
