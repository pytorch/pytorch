  ...
  int main() {
    ...
    return 1;
        ...
        if(NOT EXCEPTIONS_WORK)
          message(FATAL_ERROR "Detected that statically linking against CUPTI causes exceptions to stop working.  See https://github.com/pytorch/pytorch/issues/57744 for more details.  Perhaps try: USE_CUPTI_SO=1 python -m pip install -e . -v --no-build-isolation -C--global-option=--cmake")
        endif()
      endif()
