...
if(USE_XNNPACK AND NOT USE_SYSTEM_XNNPACK)
  ...
  if(NOT TARGET XNNPACK OR NOT TARGET xnnpack-microkernels-prod)
    ...
    if(CMAKE_C_COMPILER_ID STREQUAL "GNU" AND CMAKE_C_COMPILER_VERSION VERSION_GREATER_EQUAL "14")
      foreach(xnn_tgt IN ITEMS XNNPACK xnnpack-microkernels-prod xnnpack-microkernels-all)
  ...
  list(APPEND Caffe2_DEPENDENCY_LIBS XNNPACK xnnpack-microkernels-prod)
elseif(NOT TARGET XNNPACK AND USE_SYSTEM_XNNPACK)
  add_library(XNNPACK SHARED IMPORTED)
  add_library(xnnpack-microkernels-prod SHARED IMPORTED)
  find_library(XNNPACK_LIBRARY XNNPACK)
  find_library(xnnpack-microkernels-prod_LIBRARY xnnpack-microkernels-prod)
  set_property(TARGET XNNPACK PROPERTY IMPORTED_LOCATION "${XNNPACK_LIBRARY}")
  set_property(TARGET xnnpack-microkernels-prod PROPERTY IMPORTED_LOCATION "${xnnpack-microkernels-prod_LIBRARY}")
  if(NOT XNNPACK_LIBRARY OR NOT xnnpack-microkernels-prod_LIBRARY)
