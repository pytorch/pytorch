...
if(NOT BUILD_ATEN_MOBILE)
  ...
  if(PYTORCH_FOUND_HIP)
    ...
    list(APPEND HIP_COMPILE_FLAGS -fPIC)
    list(APPEND HIP_COMPILE_FLAGS -D__HIP_PLATFORM_HCC__=1)
    list(APPEND HIP_COMPILE_FLAGS -DCUDA_HAS_FP16=1)
    list(APPEND HIP_COMPILE_FLAGS -D__HIP_NO_HALF_OPERATORS__=1)
    list(APPEND HIP_COMPILE_FLAGS -D__HIP_NO_HALF_CONVERSIONS__=1)
    list(APPEND HIP_COMPILE_FLAGS -DHIP_VERSION=${HIP_VERSION_MAJOR})
    list(APPEND HIP_COMPILE_FLAGS -Wno-macro-redefined)
    list(APPEND HIP_COMPILE_FLAGS -Wno-inconsistent-missing-override)
    list(APPEND HIP_COMPILE_FLAGS -Wno-exceptions)
    list(APPEND HIP_COMPILE_FLAGS -Wno-shift-count-negative)
    list(APPEND HIP_COMPILE_FLAGS -Wno-shift-count-overflow)
    list(APPEND HIP_COMPILE_FLAGS -Wno-unused-command-line-argument)
    list(APPEND HIP_COMPILE_FLAGS -Wno-duplicate-decl-specifier)
    list(APPEND HIP_COMPILE_FLAGS -DCAFFE2_USE_MIOPEN)
    list(APPEND HIP_COMPILE_FLAGS -DROCBLAS_FP16=0)

    set(HIP_CXX_FLAGS ${HIP_COMPILE_FLAGS})
    list(APPEND HIP_CXX_FLAGS -x c++)

    set(HIP_HCC_FLAGS ${HIP_COMPILE_FLAGS})
