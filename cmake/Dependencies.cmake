...
if(USE_CUDNN)
  ...
  if(WIN32 AND CMAKE_SYSTEM_PROCESSOR MATCHES "ARM64")
    set(_cudnn_fe_tensor_hdr ${CUDNN_FRONTEND_INCLUDE_DIR}/cudnn_frontend_Tensor.h)
    file(READ "${_cudnn_fe_tensor_hdr}" _cudnn_fe_content)
    string(REPLACE "#if (CUDNN_VERSION >= 92400)" "#if (CUDNN_VERSION > 92400)"
           _cudnn_fe_patched "${_cudnn_fe_content}")
    if(NOT _cudnn_fe_patched STREQUAL _cudnn_fe_content)
      file(WRITE "${_cudnn_fe_tensor_hdr}" "${_cudnn_fe_patched}")
      message(STATUS "cudnn_frontend_Tensor.h: patched CUDNN_VERSION >= 92400 -> > 92400 (cuDNN 9.24, win_arm64)")
    endif()
  endif()
