...
elseif(BLAS STREQUAL "MKL")
  ...
  if(MKL_FOUND)
    ...
    list(APPEND Caffe2_PUBLIC_DEPENDENCY_LIBS torch::mkl)
...
# ---[ OpenMP
if(USE_OPENMP AND NOT TARGET torch::openmp)
  ...
  if(OPENMP_FOUND)
    ...
    add_library(torch::openmp INTERFACE IMPORTED)
    target_link_libraries(torch::openmp INTERFACE OpenMP::OpenMP_CXX)
    list(APPEND Caffe2_DEPENDENCY_LIBS torch::openmp)
    if(MSVC AND OpenMP_CXX_LIBRARIES MATCHES ".*libiomp5md\\.lib.*")
      target_compile_definitions(torch::openmp INTERFACE _OPENMP_NOFORCE_MANIFEST)
      target_link_options(torch::openmp INTERFACE "/NODEFAULTLIB:vcomp")
    endif()
  else()
