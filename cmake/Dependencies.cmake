...
if(USE_ASAN OR USE_TSAN)
  ...
  if(USE_ASAN)
    if(TARGET GoogleSanitizer::address)
      list(APPEND Caffe2_PUBLIC_DEPENDENCY_LIBS GoogleSanitizer::address)
    else()
    ...
    if(TARGET GoogleSanitizer::undefined)
      list(APPEND Caffe2_PUBLIC_DEPENDENCY_LIBS GoogleSanitizer::undefined)
    endif()
  endif()
  if(USE_TSAN)
    if(TARGET GoogleSanitizer::thread)
      list(APPEND Caffe2_PUBLIC_DEPENDENCY_LIBS GoogleSanitizer::thread)
    else()
