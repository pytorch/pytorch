...
# We add an interface library that will wrap around all private
# (non-transitive) libraries that caffe2_gpu will need to depend on. This is
# defined here instead of BuildVariables.cmake because otherwise cmake doesn't
# recognize this as a target that we are allowed to add dependencies to
add_library(caffe2_private_cuda_dependencies INTERFACE)
...
if(USE_OPENCV)
  ...
  if(OpenCV_FOUND)
    ...
    if (MSVC AND USE_CUDA)
      target_link_libraries(caffe2_private_cuda_dependencies INTERFACE ${OpenCV_LIBS})
    endif()
...
if(USE_CUDA)
  ...
  if(NOT CAFFE2_USE_CUDA)
    ...
    if(NOT CAFFE2_USE_CUDNN)
      caffe2_update_option(USE_CUDNN OFF)
    endif()
    if(NOT CAFFE2_USE_TENSORRT)
      caffe2_update_option(USE_TENSORRT OFF)
    endif()
  endif()
endif()
...
if(USE_NCCL)
  ...
  elseif(NOT ${CMAKE_SYSTEM_NAME} STREQUAL "Linux")
    ...
    target_link_libraries(caffe2_private_cuda_dependencies INTERFACE __caffe2_nccl)
  endif()
endif()
...
if(USE_GLOO)
  ...
  elseif(NOT CMAKE_SIZEOF_VOID_P EQUAL 8)
    ...
    if(USE_CUDA)
      target_link_libraries(caffe2_private_cuda_dependencies INTERFACE gloo_cuda)
    endif()
  endif()
endif()
...
if (NOT BUILD_ATEN_MOBILE AND BUILD_CAFFE2_OPS)
  if (CAFFE2_CMAKE_BUILDING_WITH_MAIN_REPO)
    ...
    if (USE_CUDA)
      target_link_libraries(caffe2_private_cuda_dependencies INTERFACE aten_op_header_gen)
    endif()
