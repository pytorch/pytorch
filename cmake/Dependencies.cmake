...
if(BUILD_TEST)
  ...
  # don't bleed into it. This is because MKL adds a global /opt/conda/include
  # directory, and if there's gtest installed in conda, the
  # third_party/googletest/**.cc source files would try to include headers from
  # /opt/conda/include/gtest/**.h instead of its own.
  # Once we have proper target-based include directories,
