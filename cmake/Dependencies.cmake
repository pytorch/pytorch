...
if(USE_XNNPACK AND NOT USE_SYSTEM_XNNPACK)
  ...
  if(NOT TARGET XNNPACK OR NOT TARGET microkernels-prod)
    if(CMAKE_INTERPROCEDURAL_OPTIMIZATION)
      set(XNNPACK_LIBRARY_TYPE "shared" CACHE STRING "")
    else()
    ...
    set(__caffe2_CMAKE_INTERPROCEDURAL_OPTIMIZATION ${CMAKE_INTERPROCEDURAL_OPTIMIZATION})
    ...
    set(CMAKE_INTERPROCEDURAL_OPTIMIZATION ${__caffe2_CMAKE_INTERPROCEDURAL_OPTIMIZATION})
  endif()
