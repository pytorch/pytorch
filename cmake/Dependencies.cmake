...
# --[ Find MKL
# We find MKL for MKLDNN, IDEEP, or MKLML, even if not using MKL for BLAS
if(USE_MKLDNN OR USE_MKLML OR USE_IDEEP OR BLAS STREQUAL "MKL")
  if(BLAS_SET_BY_USER)
  ...
  if(MKL_FOUND)
    ...
    message(STATUS "Could not find MKL. Excluding IDEEP and MKL operators")
    set(USE_MKLDNN OFF)
    set(USE_IDEEP OFF)
    set(USE_MKLML OFF)
