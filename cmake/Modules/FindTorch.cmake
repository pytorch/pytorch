...
find_library(CAFFE2_LIBRARYRARY caffe2
  PATHS "${PYTORCH_BUILD_PATH}/install/lib" NO_DEFAULT_PATH)
...
if (CUDA_FOUND)
  ...
  list(APPEND CAFFE2_LIBRARY -L${CUDA_TOOLKIT_ROOT_DIR}/lib64 cuda cudart)
  list(APPEND TORCH_INCLUDE_DIRS "${PYTORCH_ROOT}/aten/src/THC")
  list(APPEND TORCH_INCLUDE_DIRS "${PYTORCH_BUILD_PATH}/install/include/THC")
endif()
...
set_target_properties(Torch PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "${CAFFE2_LIBRARY};${CAFFE2_CUDA_LIBRARY}"
  CXX_STANDARD 11
)
