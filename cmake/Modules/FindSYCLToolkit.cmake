...
if("${XPU_SYCL_COMPILER}" MATCHES "dpclang")
  ...
  if(PkgConfig_FOUND)
    ...
    if(LIBSYCL_DPCPP_FOUND)
      ...
      foreach(lib ${LIBSYCL_DPCPP_LIBRARIES})
        find_library(PATH_FOR_${lib} NAMES ${lib} HINTS ${LIBSYCL_DPCPP_LIBRARY_DIRS} NO_DEFAULT_PATH)
        list(APPEND SYCL_LIBRARY ${PATH_FOR_${lib}})
      endforeach()
    endif()
  endif()
