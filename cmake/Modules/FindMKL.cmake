...
IF (USE_MKL_TBB AND USE_MKL_SEQ)
  MESSAGE(FATAL_ERROR "Only one of USE_MKL_TBB, USE_MKL_SEQ can be set at the same time")
ENDIF()
...
IF (USE_MKL_TBB)
  ...
  ELSE()
    MESSAGE(FATAL_ERROR "USE_MKL_TBB is set to true but TBB is not used")
  ENDIF()
ENDIF()
