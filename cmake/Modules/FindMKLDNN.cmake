...
#  EULER_INCLUDE_DIR     : path to euler include dir.
...
IF(CAFFE2_USE_EULER)
  SET(EULER_INCLUDE_DIR)
  SET(EULER_ROOT "${PROJECT_SOURCE_DIR}/third_party/ideep/euler")
  SET(EULER_LIB "${EULER_ROOT}/build/libel.so")
ENDIF(CAFFE2_USE_EULER)  
...
IF(CAFFE2_USE_EULER)
    ADD_DEFINITIONS(-DUSE_EULER)
  FIND_PATH(EULER_INCLUDE_DIR euler.hpp PATHS ${EULER_ROOT} PATH_SUFFIXES include)
  IF(NOT EXISTS "${EULER_LIB}")
    MESSAGE(FATAL_ERROR "Could not find eluer library! Please build and put it to ${EULER_LIB}")
    RETURN()
  ENDIF(NOT EXISTS "${EULER_LIB}")
  LIST(APPEND MKLDNN_LIBRARIES ${EULER_LIB})
  LIST(APPEND MKLDNN_INCLUDE_DIR ${EULER_INCLUDE_DIR})
ENDIF(CAFFE2_USE_EULER)  
