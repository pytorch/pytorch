...
IF(NOT MKLDNN_FOUND)
  ...
  FIND_PATH(MKLDNN_INCLUDE_DIR dnnl.hpp dnnl.h dnnl_ukernel.hpp PATHS ${MKLDNN_ROOT} PATH_SUFFIXES include/oneapi/dnnl)
  IF(NOT MKLDNN_INCLUDE_DIR)
    ...
    FIND_PATH(MKLDNN_INCLUDE_DIR dnnl.hpp dnnl.h dnnl_ukernel.hpp PATHS ${MKLDNN_ROOT} PATH_SUFFIXES include)
  ...
  SET(DNNL_EXPERIMENTAL_UKERNEL ON)
