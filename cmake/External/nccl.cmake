if(NOT __NCCL_INCLUDED)
  ...
  if(USE_SYSTEM_NCCL)
    ...
    string(REGEX REPLACE "GNU objcopy [^0-9]* ([0-9])\\.([0-9]+).*" "\\1" OBJCOPY_VERSION_MAJOR ${OBJCOPY_VERSION_STR})
    string(REGEX REPLACE "GNU objcopy[^0-9]*([0-9])\\.([0-9]+).*" "\\2" OBJCOPY_VERSION_MINOR ${OBJCOPY_VERSION_STR})
