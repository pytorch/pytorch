if(NOT __OORT_INCLUDED)
  ...
  ExternalProject_Add(oort_external
    ...
    BUILD_BYPRODUCTS "${__OORT_INSTALL_DIR}/${CMAKE_INSTALL_LIBDIR}/liboort.a"
    # INSTALL_COMMAND ${MAKE_COMMAND} install
    )
  set(OORT_FOUND TRUE)
  add_library(__caffe2_oort INTERFACE)
  add_dependencies(__caffe2_oort oort_external)
  target_link_libraries(__caffe2_oort INTERFACE ${__OORT_INSTALL_DIR}/${CMAKE_INSTALL_LIBDIR}/liboort.a)
