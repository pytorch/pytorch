...
if(INTERN_BUILD_ATEN_OPS)
  ...
  if(CXX_SVE_128_FOUND)
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DHAVE_SVE_CPU_DEFINITION -DCPU_CAPABILITY_SVE128 -DCPU_CAPABILITY_SVE -DAT_BUILD_ARM_VECSVE_WITH_SLEEF -DHAVE_SVE128_CPU_DEFINITION -DCPU_CAPABILITY=SVE128 -DHAVE_ARM_BF16_CPU_DEFINITION")
    list(APPEND CPU_CAPABILITY_NAMES "SVE128")
    if("${CMAKE_C_COMPILER_ID}" MATCHES "Clang")
        list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -O2 -march=armv9-a+sve2+fp16+fp16fml+bf16 -msve-vector-bits=128 -DCPU_CAPABILITY_SVE")
    else()
        list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -march=armv9-a+sve2+fp16+fp16fml+bf16 -msve-vector-bits=128 -DCPU_CAPABILITY_SVE")
    endif()
    message(STATUS "SVE support enabled for 128-bit vector lengths.")
  elseif(CXX_SVE_FOUND AND CXX_ARM_BF16_FOUND)
