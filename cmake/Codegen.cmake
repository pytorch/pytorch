...
if(INTERN_BUILD_ATEN_OPS)
  ...
  if(DEFINED ENV{ATEN_AVX512})
    if($ENV{ATEN_AVX512} MATCHES "TRUE")
      if(CXX_AVX512_FOUND)
        message("-- AVX512 kernels will be compiled as well.")
  ...
  if(CXX_AVX2_FOUND)
    ...
    if(CXX_AVX512VL_FOUND)
      message("-- AVX512VL found")
      set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DHAVE_AVX512_256_CPU_DEFINITION")
      list(APPEND CPU_CAPABILITY_NAMES "AVX512_256")
      if(MSVC)
        list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG}/arch:AVX512 /arch:AVX2") 
      else(MSVC)
        list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -mavx2 -mavx512vl -mavx512f -mfma ${CPU_NO_AVX256_SPLIT_FLAGS}")
      endif(MSVC)
    endif(CXX_AVX512VL_FOUND)
