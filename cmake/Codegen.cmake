...
if(INTERN_BUILD_ATEN_OPS)
  ...
  if(CXX_SVE_FOUND AND CXX_SVE128_FOUND AND CXX_ARM_BF16_FOUND)
    list(APPEND CPU_CAPABILITY_NAMES "SVE128")
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DHAVE_SVE128_CPU_DEFINITION")
    if("${CMAKE_C_COMPILER_ID}" MATCHES "Clang")
      list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -O2 -march=armv8-a+sve+bf16 -D__ARM_FEATURE_BF16 -DCPU_CAPABILITY_SVE -msve-vector-bits=128")
    else()
      list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -march=armv8-a+sve+bf16 -D__ARM_FEATURE_BF16 -DCPU_CAPABILITY_SVE -msve-vector-bits=128")
    endif()
  endif()
