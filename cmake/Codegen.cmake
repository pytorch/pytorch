...
if(INTERN_BUILD_ATEN_OPS)
  ...
  if(USE_CUDA)
    ...
    function(_BUILD_FOR_ADDITIONAL_ARCHS file archs output_file_obj)
      ...
      separate_arguments(_cmake_cxx_flags NATIVE_COMMAND "${CMAKE_CXX_FLAGS}")
      set(_file_cxx_compile_flags)
      foreach(flag IN LISTS _cmake_cxx_flags)
        if(flag MATCHES "^-[f]")
          list(APPEND _file_cxx_compile_flags "-Xcompiler" "${flag}")
        elseif(flag MATCHES "^-[OD]")
          list(APPEND _file_cxx_compile_flags "${flag}")
        endif()
      endforeach()
      ...
      set(custom_compile_command "${CMAKE_CUDA_COMPILER} -forward-unknown-to-host-compiler -fPIC ${_file_cxx_compile_flags} -Wno-deprecated-declarations")
