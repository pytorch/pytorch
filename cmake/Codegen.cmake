...
# ---[ ATen specific
  ...
  IF(C_AVX_FOUND AND USE_AVX)
    ...
    ENDIF(MSVC)
  ENDIF(C_AVX_FOUND AND USE_AVX)

  IF(C_AVX2_FOUND AND USE_AVX)
    IF(MSVC)
    ...
    ENDIF(MSVC)
  ENDIF(C_AVX2_FOUND AND USE_AVX)
  ...
  IF(CXX_AVX_FOUND AND USE_AVX)
    ...
    ENDIF(MSVC)
  ENDIF(CXX_AVX_FOUND AND USE_AVX)

  IF(CXX_AVX2_FOUND AND USE_AVX)
    ...
    ENDIF(MSVC)
  ENDIF(CXX_AVX2_FOUND AND USE_AVX)
