...
if(INTERN_BUILD_ATEN_OPS)
  ...
  if(CXX_SVE_FOUND AND CXX_ARM_BF16_FOUND)
    ...
    if("${CMAKE_C_COMPILER_ID}" MATCHES "Clang")
      list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -O2 -march=armv8.2-a+sve+bf16 -msve-vector-bits=256")
    else()
      list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -march=armv8.2-a+sve+bf16 -msve-vector-bits=256")
    endif()
    list(APPEND CPU_CAPABILITY_NAMES "SVE")
    if("${CMAKE_C_COMPILER_ID}" MATCHES "Clang")
      list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -O2 -march=armv8.2-a+sve+bf16 -msve-vector-bits=128")
    else()
      list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -march=armv8.2-a+sve+bf16 -msve-vector-bits=128")
    endif()
  endif(CXX_SVE_FOUND)
