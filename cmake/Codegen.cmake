...
if(INTERN_BUILD_ATEN_OPS)
  ...
  if(CXX_SVE_FOUND AND CXX_SVE256_FOUND)
    ...
    if (CXX_SVE256_BF16_FOUND)
        if("${CMAKE_C_COMPILER_ID}" MATCHES "Clang")
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -D__ARM_FEATURE_BF16")
            list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -O2 -march=armv8.2-a+sve+bf16 -DCPU_CAPABILITY_SVE -msve-vector-bits=256")
        else()
            list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -march=armv8.2-a+sve+bf16 -DCPU_CAPABILITY_SVE -msve-vector-bits=256")
        endif()
    else()
        if("${CMAKE_C_COMPILER_ID}" MATCHES "Clang")
