...
if (NOT BUILD_ATEN_MOBILE)
  ...
  IF(C_AVX_FOUND)
    IF(MSVC)
      set_property(SOURCE ${CMAKE_CURRENT_LIST_DIR}/../aten/src/TH/vector/AVX.cpp APPEND PROPERTY CMAKE_CXX_FLAGS "${OPT_FLAG} /arch:AVX ${CXX_AVX_FLAGS} ")
    ELSE(MSVC)
      set_property(SOURCE ${CMAKE_CURRENT_LIST_DIR}/../aten/src/TH/vector/AVX.cpp APPEND PROPERTY CMAKE_CXX_FLAGS "${OPT_FLAG} ${CXX_AVX_FLAGS} ")
    ENDIF(MSVC)
  ENDIF(C_AVX_FOUND)

  IF(C_AVX2_FOUND)
    IF(MSVC)
      set_property(SOURCE ${CMAKE_CURRENT_LIST_DIR}/../aten/src/TH/vector/AVX2.cpp APPEND PROPERTY CMAKE_CXX_FLAGS "${OPT_FLAG} /arch:AVX2 ${CXX_AVX2_FLAGS} ")
    ELSE(MSVC)
      set_property(SOURCE ${CMAKE_CURRENT_LIST_DIR}/../aten/src/TH/vector/AVX2.cpp APPEND PROPERTY CMAKE_CXX_FLAGS "${OPT_FLAG} ${CXX_AVX2_FLAGS} ")
    ENDIF(MSVC)
  ENDIF(C_AVX2_FOUND)

  IF(NOT MSVC AND NOT "${CMAKE_C_COMPILER_ID}" MATCHES "Clang")
    set_property(SOURCE ${CMAKE_CURRENT_LIST_DIR}/../aten/src/TH/THAllocator.cpp APPEND PROPERTY CMAKE_CXX_FLAGS -fno-openmp)
  ENDIF()
