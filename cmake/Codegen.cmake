...
if(INTERN_BUILD_ATEN_OPS)
  ...
  if(CXX_SVE256_FOUND AND NOT "$ENV{USE_CPU_VECTORIZATION}" STREQUAL "0")
    ...
    list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} ${CXX_ARM_SVE_BF16_FLAGS} -D__ARM_FEATURE_BF16 -msve-vector-bits=256")
    list(APPEND CPU_CAPABILITY_NAMES "SVE128")
    list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} ${CXX_ARM_SVE_BF16_FLAGS} -D__ARM_FEATURE_BF16 -msve-vector-bits=128")
  endif()
