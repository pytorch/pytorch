...
if (BUILD_ATEN)
  ...
  IF(MSVC)
    IF("${CMAKE_BUILD_TYPE}" MATCHES "Debug")
      SET(KERNEL_DEFAULT_FLAG "/fp:strict ")
      SET(VCOMP_LIB "vcompd")
    ELSE()
      SET(KERNEL_DEFAULT_FLAG "/Ox /fp:strict ")
      SET(VCOMP_LIB "vcomp")
    ENDIF()
  ELSE()
    IF("${CMAKE_BUILD_TYPE}" MATCHES "Debug")
      SET(KERNEL_DEFAULT_FLAG "-O0 -Wno-absolute-value ")
    ELSE()
      SET(KERNEL_DEFAULT_FLAG "-O3 -Wno-absolute-value ")
    ENDIF()
  ENDIF()
  
  LIST(APPEND CPU_CAPABILITY_NAMES "DEFAULT")
  IF(MSVC)
    LIST(APPEND CPU_CAPABILITY_FLAGS "${KERNEL_DEFAULT_FLAG}")
  ELSE(MSVC)
    LIST(APPEND CPU_CAPABILITY_FLAGS "${KERNEL_DEFAULT_FLAG}")
  ENDIF(MSVC)
  ...
  IF(CXX_AVX_FOUND)
    ...
    IF(MSVC)
      LIST(APPEND CPU_CAPABILITY_FLAGS "${KERNEL_DEFAULT_FLAG}/arch:AVX")
    ELSE(MSVC)
      LIST(APPEND CPU_CAPABILITY_FLAGS "${KERNEL_DEFAULT_FLAG} -mavx")
    ENDIF(MSVC)
  ENDIF(CXX_AVX_FOUND)
  ...
  IF(CXX_AVX2_FOUND)
    ...
    IF(MSVC)
      LIST(APPEND CPU_CAPABILITY_FLAGS "${KERNEL_DEFAULT_FLAG}/arch:AVX2")
    ELSE(MSVC)
      LIST(APPEND CPU_CAPABILITY_FLAGS "${KERNEL_DEFAULT_FLAG} -mavx2")
    ENDIF(MSVC)
