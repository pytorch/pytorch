...
if (NOT BUILD_ATEN_MOBILE OR BUILD_TORCH_MOBILE)
  ...
  IF(C_AVX_FOUND AND NOT ANDROID)
    IF(MSVC)
    ...
    ENDIF(MSVC)
  ENDIF(C_AVX_FOUND AND NOT ANDROID)

  IF(C_AVX2_FOUND AND NOT ANDROID)
    IF(MSVC)
    ...
    ENDIF(MSVC)
  ENDIF(C_AVX2_FOUND AND NOT ANDROID)
  ...
  IF(CXX_AVX_FOUND AND NOT ANDROID)
    ...
    ENDIF(MSVC)
  ENDIF(CXX_AVX_FOUND AND NOT ANDROID)

  IF(CXX_AVX2_FOUND AND NOT ANDROID)
    ...
    ENDIF(MSVC)
  ENDIF(CXX_AVX2_FOUND AND NOT ANDROID)
