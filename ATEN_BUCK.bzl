...
# def define_aten_targets():
    ...
    native.cxx_library(
		...
		exported_headers = subdir_glob([("QNNPACK/src", "qnnpack/*.h"),("QNNPACK/include", "*.h"),]),
		header_namespace = "",
		headers = subdir_glob([("QNNPACK/src", "**/*.c"), ("QNNPACK/src", "q8gemm_sparse/*.h"), ("QNNPACK/src", "qnnpack/*.h"), ("QNNPACK/src", "requantization/*.h")]),
		link_whole = False,
