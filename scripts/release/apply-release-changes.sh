...
sed 's#CONDA_PYTORCHBOT_TOKEN#CONDA_PYTORCHBOT_TOKEN_TEST#' .github/templates/upload.yml.j2

# Triton wheel
sed -i 's#- main#"- release/${RELEASE_VERSION}"#' .github/workflows/build-triton-wheel.yml
