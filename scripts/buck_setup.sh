...
curl $PROXY_CONFIG -L https://github.com/bazelbuild/bazel-skylib/releases/download/1.0.2/bazel-skylib-1.0.2.tar.gz|tar zx -C bazel-skylib

# glog
printf "\n[Downloading glog-0.4.0]\n"
rm -rf glog; mkdir glog
curl $PROXY_CONFIG -L https://github.com/google/glog/archive/v0.4.0.tar.gz | tar zx -C glog --strip-components 1

# ruy
printf "\n[Downloading ruy]\n"
curl $PROXY_CONFIG -L -o /tmp/ruy.zip https://github.com/google/ruy/archive/a09683b8da7164b9c5704f88aef2dc65aa583e5d.zip
