...
def neutralize(text: str, cap: int = MAX_SUMMARY) -> str:
    ...
    escaping depends on that renderer. See docs/hardened-pr-review.md § Known
    residual risk.
    """
    ...
    # nesting level: `[[Sign in](x)](//evil)` becomes `[Sign in](//evil)`.
        ...
        kept.append(
            {
                ...
                # `git checkout -b x && touch '@pytorchbot [rebase](//evil) #1.py'`
