...
def main() -> None:
    ...
    torch_package_data = [
        ...
        "*.pyi",
        "**/*.pyi",
        # MSVC writes _C's (and, if enabled, _nccl_ep's) PDB next to the
        # module at the torch/ root rather than under lib/, since they are
        # installed via `install(TARGETS _C ...)` in torch/CMakeLists.txt.
        "_C*.pdb",
        "_nccl_ep*.pdb",
        "lib/*.pdb",
        "lib/**/*.pdb",
