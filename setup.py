...
if IS_DARWIN:
    CAFFE2_LIBS = [os.path.join(lib_path, 'libcaffe2.dylib'), os.path.join(lib_path, 'libtorch.dylib')]
    if USE_CUDA:
...
if IS_WINDOWS:
    CAFFE2_LIBS = [os.path.join(lib_path, 'caffe2.lib'), os.path.join(lib_path, 'torch.lib')]
    if USE_CUDA:
