...
def mirror_inductor_external_kernels() -> None:
    ...
    paths = [
        ...
        (
            CWD
            / "torch/_inductor/kernel/vendored_templates/cutedsl/kernels/dense_gemm.py",
            CWD / "third_party/cutlass/examples/python/CuTeDSL/blackwell/dense_gemm.py",
            True,
        ),
        (
            CWD
            / "torch/_inductor/kernel/vendored_templates/cutedsl/kernels/dense_gemm_persistent.py",
            CWD
        ...
        (
            CWD
            / "torch/_inductor/kernel/vendored_templates/cutedsl/kernels/dense_gemm_software_pipeline.py",
            CWD
