...
class Repro(torch.nn.Module):
    ...
    def forward(self, convolution_12, getitem_26, getitem_27):
...
args = []
args.append(rand_strided((16, 256, 14, 14), (50176, 196, 14, 1), torch.float32, 'cuda'))  # shape (16, 256, 14, 14), stride (50176, 196, 14, 1)
args.append(rand_strided((1, 256, 1, 1), (256, 1, 1, 1), torch.float32, 'cuda'))  # shape (1, 256, 1, 1), stride (256, 1, 1, 1)
args.append(rand_strided((1, 256, 1, 1), (256, 1, 1, 1), torch.float32, 'cuda'))  # shape (1, 256, 1, 1), stride (256, 1, 1, 1)
