...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg27_1, arg28_1, arg29_1, arg30_1, arg31_1, arg32_1, arg33_1, arg34_1, arg35_1, arg36_1, arg37_1, arg38_1, arg39_1, relu_6, unsqueeze_35, mul_62):
...
args.append(rand_strided((128, 1, 1), (1, 1, 1), torch.float32, 'cuda'))  # shape (128, 1, 1), stride (1, 1, 1)
args.append(rand_strided((16, 128, 28, 28), (100352, 784, 28, 1), torch.float32, 'cuda'))  # shape (16, 128, 28, 28), stride (100352, 784, 28, 1)
