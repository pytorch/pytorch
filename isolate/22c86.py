...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1, cos):
        return (cos,)
        
args = []
args.append(rand_strided((5, 5), (5, 1), torch.float32, 'cpu'))  # shape (5, 5), stride (5, 1)
args.append(rand_strided((5, 5), (5, 1), torch.float32, 'cpu'))  # shape (5, 5), stride (5, 1)
