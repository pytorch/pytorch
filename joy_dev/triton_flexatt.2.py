...
# kernel path: /tmp/torchinductor_joydong/y4/cy4mv2fvvzyacuxayskebl3e55zjzg25uvmhyz3xqzzkmsknras3.py
...
def triton_(arg_Q, arg_K, arg_V, arg_LSE, out_ptr0):
    ...
    xindex = idx_d + (64*idx_m) + (256*idx_h) + (2048*idx_z)
...
def call(args):
    ...
    args.clear()
    assert_size_stride(arg0_1, (2, 8, 4, 64), (2048, 256, 64, 1))
    assert_size_stride(arg1_1, (2, 8, 4096, 64), (2097152, 262144, 64, 1))
    assert_size_stride(arg2_1, (2, 8, 4096, 64), (2097152, 262144, 64, 1))
    buf0 = empty_strided_cuda((2, 8, 4), (32, 4, 1), torch.float32)
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        buf1 = empty_strided_cuda((2, 8, 4, 64), (2048, 256, 64, 1), torch.float32)
        # Source Nodes: [flex_attention], Original ATen: []
        stream0 = get_raw_stream(0)
        triton_tem_fused_0.run(arg0_1, arg1_1, arg2_1, buf0, buf1, grid=torch._inductor.kernel.flex_attention.sdpa_grid(2, 8, 4, 64, meta0), stream=stream0)
        del arg0_1
        del arg1_1
        del arg2_1
    return (buf1, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((2, 8, 4, 64), (2048, 256, 64, 1), device='cuda:0', dtype=torch.float32)
