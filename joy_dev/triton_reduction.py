...
# kernel path: /tmp/torchinductor_joydong/w7/cw7zmzgzdp5ckq6pv7upp7xkbjsyeun4nqk7emwpox45smaplksk.py
...
# kernel path: /tmp/torchinductor_joydong/7y/c7y6q67ibwn4bpv2i6w4dmgvsw3pppoysvhldcj6d6xz332jp4sf.py
# Source Nodes: [sum_1], Original ATen: [aten.sum]
# sum_1 => sum_1
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_sum_1', 'mutated_arg_names': [], 'no_x_dim': False, 'backend_hash': '3d930ae76fa5e25713342ca2a1b35b7ee99023f455bffb679bcc13dbe5fe0c6e', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': False, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_red_fused_sum_0.run(arg0_1, buf0, 13, 7693, grid=grid(13), stream=stream0)
        del arg0_1
        buf1 = empty_strided_cuda((), (), torch.float32)
        # Source Nodes: [sum_1], Original ATen: [aten.sum]
        triton_per_fused_sum_1.run(buf0, buf1, 1, 13, grid=grid(1), stream=stream0)
        del buf0
    return (buf1, )
