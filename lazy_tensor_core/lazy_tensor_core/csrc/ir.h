...
class Node {
 public:
  ...
  at::ScalarType at_dtype() const { return at_dtype_; }
  const std::vector<int64_t>& at_shape() const { return at_shape_; }
 ...
 private:
  ...
  at::ScalarType at_dtype_;
  std::vector<int64_t> at_shape_;
};
