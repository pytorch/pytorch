...
std::vector<int64_t> Helpers::DropDimensions(
...
int64_t Helpers::GetCanonicalDimensionIndex(
...
int64_t Helpers::GetCanonicalPosition(
...
int64_t Helpers::GetDynamicDimension(
...
std::vector<int64_t> Helpers::MakeTransposePermutation(
