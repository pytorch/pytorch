...
static_assert(string_view("", 0).empty());
...
static_assert(
    string_view::npos ==
    string_view("abc").rfind("abcd", string_view::npos, 4));
} // namespace test_rfind_overload3
...
static_assert(
    string_view::npos ==
    string_view("").find_first_of(string_view("abc"), 100));
static_assert(
...
static_assert(
    string_view::npos ==
    string_view("abc").find_last_of(string_view("def"), 2));
...
static_assert(
    string_view::npos ==
    string_view("").find_first_not_of(string_view("a"), 1));
static_assert(
    string_view::npos ==
...
static_assert(
    string_view::npos ==
    string_view("abc").find_first_not_of("defabcas", 0, 6));
...
static_assert(
    string_view::npos ==
    string_view("abc").find_first_not_of("defabcas", 2, 6));
