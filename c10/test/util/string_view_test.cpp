...
static_assert(std::is_same<const char&, string_view::const_reference>::value, "");
static_assert(std::is_same<std::size_t, string_view::size_type>::value, "");
static_assert(std::is_same<std::ptrdiff_t, string_view::difference_type>::value, "");
}
...
namespace test_compare_overload1 {
  ...
  static_assert(0 < string_view("hello").compare(string_view("abcdefghijklmno")), "");
  static_assert(0 < string_view("hello").compare(string_view("hela")), "");
  static_assert(0 < string_view("hello").compare(string_view("helao")), "");
  static_assert(0 < string_view("hello").compare(string_view("helaobcdefgh")), "");
  ...
  static_assert(0 > string_view("hello").compare(string_view("zabcdefghijklmno")), "");
  static_assert(0 > string_view("hello").compare(string_view("helz")), "");
  static_assert(0 > string_view("hello").compare(string_view("helzo")), "");
  static_assert(0 > string_view("hello").compare(string_view("helzobcdefgh")), "");
...
namespace test_compare_overload3 {
  ...
  static_assert(0 == string_view("hello").compare(2, 2, string_view("hello"), 2, 2), "");
  static_assert(0 < string_view("hello").compare(2, 2, string_view("hello"), 2, 1), "");
  static_assert(0 > string_view("hello").compare(2, 2, string_view("hello"), 2, 3), "");
  static_assert(0 < string_view("hello").compare(2, 2, string_view("hellola"), 5, 2), "");
  static_assert(0 > string_view("hello").compare(2, 2, string_view("hellolz"), 5, 2), "");
}
...
namespace test_find_overload1 {
  ...
  static_assert(string_view::npos == string_view("").find(string_view(""), 1), "");
  ...
  static_assert(string_view::npos == string_view("ababa").find(string_view("ba"), 4), "");
  static_assert(string_view::npos == string_view("abc").find(string_view("abcd")), "");
}
...
namespace test_rfind_overload1 {
  ...
  static_assert(string_view::npos == string_view("ababa").rfind(string_view("ba"), 0), "");
  static_assert(string_view::npos == string_view("abc").rfind(string_view("abcd")), "");
}
...
namespace test_rfind_overload3 {
  ...
  static_assert(string_view::npos == string_view("abc").rfind("abcd", string_view::npos, 4), "");
}
...
namespace test_find_first_of_overload1 {
  static_assert(string_view::npos == string_view("").find_first_of(string_view("")), "");
  static_assert(string_view::npos == string_view("").find_first_of(string_view("a")), "");
  static_assert(string_view::npos == string_view("").find_first_of(string_view("abc")), "");
  static_assert(string_view::npos == string_view("abc").find_first_of(string_view("")), "");
  static_assert(string_view::npos == string_view("abc").find_first_of(string_view("d")), "");
  static_assert(string_view::npos == string_view("abc").find_first_of(string_view("def")), "");
  ...
  static_assert(string_view::npos == string_view("").find_first_of(string_view(""), 1), "");
  static_assert(string_view::npos == string_view("").find_first_of(string_view("a"), 1), "");
  static_assert(string_view::npos == string_view("").find_first_of(string_view("abc"), 100), "");
  static_assert(string_view::npos == string_view("abc").find_first_of(string_view(""), 1), "");
  static_assert(string_view::npos == string_view("abc").find_first_of(string_view("d"), 3), "");
  static_assert(string_view::npos == string_view("abc").find_first_of(string_view("def"), 2), "");

  static_assert(3 == string_view("abcabc").find_first_of(string_view("a"), 1), "");
  static_assert(4 == string_view("abcabc").find_first_of(string_view("b"), 3), "");
  static_assert(5 == string_view("abcabc").find_first_of(string_view("c"), 5), "");
  static_assert(4 == string_view("abcabc").find_first_of(string_view("bc"), 3), "");
  static_assert(4 == string_view("abcabc").find_first_of(string_view("cbd"), 4), "");
}
...
namespace test_find_first_of_overload4 {
  ...
  static_assert(string_view::npos == string_view("").find_first_of("abc", 100), "");
  static_assert(string_view::npos == string_view("abc").find_first_of("", 1), "");
  static_assert(string_view::npos == string_view("abc").find_first_of("d", 3), "");
  static_assert(string_view::npos == string_view("abc").find_first_of("def", 2), "");
...
namespace test_find_last_of_overload1 {
  static_assert(string_view::npos == string_view("").find_last_of(string_view("")), "");
  static_assert(string_view::npos == string_view("").find_last_of(string_view("a")), "");
  static_assert(string_view::npos == string_view("").find_last_of(string_view("abc")), "");
  static_assert(string_view::npos == string_view("abc").find_last_of(string_view("")), "");
  static_assert(string_view::npos == string_view("abc").find_last_of(string_view("d")), "");
  static_assert(string_view::npos == string_view("abc").find_last_of(string_view("def")), "");
  ...
  static_assert(string_view::npos == string_view("").find_last_of(string_view(""), 1), "");
  static_assert(string_view::npos == string_view("").find_last_of(string_view("a"), 0), "");
  static_assert(string_view::npos == string_view("").find_last_of(string_view("abc"), 100), "");
  static_assert(string_view::npos == string_view("abc").find_last_of(string_view(""), 1), "");
  static_assert(string_view::npos == string_view("abc").find_last_of(string_view("d"), 3), "");
  static_assert(string_view::npos == string_view("abc").find_last_of(string_view("def"), 2), "");
  ...
  static_assert(2 == string_view("abcabc").find_last_of(string_view("bc"), 3), "");
  static_assert(2 == string_view("abcabc").find_last_of(string_view("cbd"), 2), "");
}
...
namespace test_find_last_of_overload3 {
  static_assert(string_view::npos == string_view("").find_last_of("ab", string_view::npos, 0), "");
  static_assert(string_view::npos == string_view("").find_last_of("abc", string_view::npos, 1), "");
  static_assert(string_view::npos == string_view("").find_last_of("abcdef", string_view::npos, 3), "");
  static_assert(string_view::npos == string_view("abc").find_last_of("abcdef", string_view::npos, 0), "");
  static_assert(string_view::npos == string_view("abc").find_last_of("defa", string_view::npos, 1), "");
  static_assert(string_view::npos == string_view("abc").find_last_of("defcba", string_view::npos, 3), "");

  static_assert(3 == string_view("abcabc").find_last_of("abc", string_view::npos, 1), "");
  static_assert(4 == string_view("abcabc").find_last_of("bca", string_view::npos, 1), "");
  static_assert(5 == string_view("abcabc").find_last_of("cab", string_view::npos, 1), "");
  static_assert(5 == string_view("abcabc").find_last_of("bcab", string_view::npos, 2), "");
  static_assert(5 == string_view("abcabc").find_last_of("cbdac", string_view::npos, 3), "");

  static_assert(string_view::npos == string_view("").find_last_of("ab", 1, 0), "");
  static_assert(string_view::npos == string_view("").find_last_of("abc", 0, 1), "");
  static_assert(string_view::npos == string_view("").find_last_of("abcdef", 100, 3), "");
  static_assert(string_view::npos == string_view("abc").find_last_of("abcdef", 1, 0), "");
  static_assert(string_view::npos == string_view("abc").find_last_of("defa", 3, 1), "");
  static_assert(string_view::npos == string_view("abc").find_last_of("defcba", 2, 3), "");
...
namespace test_find_last_of_overload4 {
  ...
  static_assert(string_view::npos == string_view("").find_last_of("abc", 100), "");
  ...
  static_assert(string_view::npos == string_view("abc").find_last_of("def", 2), "");
...
namespace test_find_first_not_of_overload1 {
  static_assert(string_view::npos == string_view("").find_first_not_of(string_view("")), "");
  static_assert(string_view::npos == string_view("").find_first_not_of(string_view("a")), "");
  static_assert(string_view::npos == string_view("").find_first_not_of(string_view("abc")), "");
  static_assert(string_view::npos == string_view("abc").find_first_not_of(string_view("abc")), "");
  static_assert(string_view::npos == string_view("abc").find_first_not_of(string_view("acdb")), "");
  static_assert(string_view::npos == string_view("abc").find_first_not_of(string_view("defabc")), "");

  static_assert(0 == string_view("abcabc").find_first_not_of(string_view("")), "");
  static_assert(0 == string_view("abcabc").find_first_not_of(string_view("bc")), "");
  static_assert(1 == string_view("abcabc").find_first_not_of(string_view("ac")), "");
  static_assert(2 == string_view("abcabc").find_first_not_of(string_view("ab")), "");
  static_assert(1 == string_view("abcabc").find_first_not_of(string_view("a")), "");
  static_assert(1 == string_view("abcabc").find_first_not_of(string_view("da")), "");

  static_assert(string_view::npos == string_view("").find_first_not_of(string_view(""), 1), "");
  static_assert(string_view::npos == string_view("").find_first_not_of(string_view("a"), 1), "");
  static_assert(string_view::npos == string_view("").find_first_not_of(string_view("abc"), 100), "");
  static_assert(string_view::npos == string_view("abc").find_first_not_of(string_view("abc"), 1), "");
  static_assert(string_view::npos == string_view("abc").find_first_not_of(string_view("acdb"), 3), "");
  static_assert(string_view::npos == string_view("abc").find_first_not_of(string_view("defabc"), 2), "");

  static_assert(1 == string_view("abcabc").find_first_not_of(string_view(""), 1), "");
  static_assert(3 == string_view("abcabc").find_first_not_of(string_view("bc"), 1), "");
  static_assert(4 == string_view("abcabc").find_first_not_of(string_view("ac"), 4), "");
  static_assert(5 == string_view("abcabc").find_first_not_of(string_view("ab"), 5), "");
  static_assert(4 == string_view("abcabc").find_first_not_of(string_view("a"), 3), "");
  static_assert(4 == string_view("abcabc").find_first_not_of(string_view("da"), 4), "");
}
...
namespace test_find_first_not_of_overload2 {
  ...
  static_assert(string_view::npos == string_view("a").find_first_not_of('a', 1), "");
  ...
  static_assert(string_view::npos == string_view("abc").find_first_not_of('b', 3), "");
  static_assert(0 == string_view("abc").find_first_not_of('c'), "");
  static_assert(1 == string_view("abc").find_first_not_of('c', 1), "");
  static_assert(string_view::npos == string_view("abc").find_first_not_of('c', 2), "");
  static_assert(string_view::npos == string_view("abc").find_first_not_of('c', 3), "");
  static_assert(string_view::npos == string_view("abc").find_first_not_of('a', 100), "");
  ...
  static_assert(string_view::npos == string_view("ababa").find_first_not_of('a', 4), "");
  static_assert(string_view::npos == string_view("ababa").find_first_not_of('a', 5), "");
}

namespace test_find_first_not_of_overload3 {
  static_assert(string_view::npos == string_view("").find_first_not_of("ab", 0, 0), "");
  static_assert(string_view::npos == string_view("").find_first_not_of("abc", 0, 1), "");
  static_assert(string_view::npos == string_view("").find_first_not_of("abcdef", 0, 3), "");
  static_assert(string_view::npos == string_view("abc").find_first_not_of("abcdef", 0, 3), "");
  static_assert(string_view::npos == string_view("abc").find_first_not_of("acdbef", 0, 4), "");
  static_assert(string_view::npos == string_view("abc").find_first_not_of("defabcas", 0, 6), "");
  ...
  static_assert(string_view::npos == string_view("").find_first_not_of("ab", 1, 0), "");
  static_assert(string_view::npos == string_view("").find_first_not_of("abc", 1, 1), "");
  static_assert(string_view::npos == string_view("").find_first_not_of("abcdef", 100, 3), "");
  static_assert(string_view::npos == string_view("abc").find_first_not_of("abcdef", 1, 3), "");
  static_assert(string_view::npos == string_view("abc").find_first_not_of("acdbef", 3, 4), "");
  static_assert(string_view::npos == string_view("abc").find_first_not_of("defabcas", 2, 6), "");
...
namespace test_find_first_not_of_overload4 {
  ...
  static_assert(string_view::npos == string_view("").find_first_not_of("a"), "");
  static_assert(string_view::npos == string_view("").find_first_not_of("abc"), "");
  static_assert(string_view::npos == string_view("abc").find_first_not_of("abc"), "");
  static_assert(string_view::npos == string_view("abc").find_first_not_of("acdb"), "");
  static_assert(string_view::npos == string_view("abc").find_first_not_of("defabc"), "");
  ...
  static_assert(string_view::npos == string_view("").find_first_not_of("", 1), "");
  static_assert(string_view::npos == string_view("").find_first_not_of("a", 1), "");
  static_assert(string_view::npos == string_view("").find_first_not_of("abc", 100), "");
  static_assert(string_view::npos == string_view("abc").find_first_not_of("abc", 1), "");
  static_assert(string_view::npos == string_view("abc").find_first_not_of("acdb", 3), "");
  static_assert(string_view::npos == string_view("abc").find_first_not_of("defabc", 2), "");
...
namespace test_find_last_not_of_overload1 {
  static_assert(string_view::npos == string_view("").find_last_not_of(string_view("")), "");
  static_assert(string_view::npos == string_view("").find_last_not_of(string_view("a")), "");
  static_assert(string_view::npos == string_view("").find_last_not_of(string_view("abc")), "");
  static_assert(string_view::npos == string_view("abc").find_last_not_of(string_view("abc")), "");
  static_assert(string_view::npos == string_view("abc").find_last_not_of(string_view("acdb")), "");
  static_assert(string_view::npos == string_view("abc").find_last_not_of(string_view("defabc")), "");

  static_assert(5 == string_view("abcabc").find_last_not_of(string_view("")), "");
  static_assert(3 == string_view("abcabc").find_last_not_of(string_view("bc")), "");
  static_assert(4 == string_view("abcabc").find_last_not_of(string_view("ac")), "");
  static_assert(5 == string_view("abcabc").find_last_not_of(string_view("ab")), "");
  static_assert(4 == string_view("abcabc").find_last_not_of(string_view("c")), "");
  static_assert(4 == string_view("abcabc").find_last_not_of(string_view("ca")), "");

  static_assert(string_view::npos == string_view("").find_last_not_of(string_view(""), 1), "");
  static_assert(string_view::npos == string_view("").find_last_not_of(string_view("a"), 0), "");
  static_assert(string_view::npos == string_view("").find_last_not_of(string_view("abc"), 100), "");
  static_assert(string_view::npos == string_view("abc").find_last_not_of(string_view("abc"), 1), "");
  static_assert(string_view::npos == string_view("abc").find_last_not_of(string_view("acdb"), 3), "");
  static_assert(string_view::npos == string_view("abc").find_last_not_of(string_view("defabc"), 2), "");

  static_assert(4 == string_view("abcabc").find_last_not_of(string_view(""), 4), "");
  static_assert(0 == string_view("abcabc").find_last_not_of(string_view("bc"), 2), "");
  static_assert(1 == string_view("abcabc").find_last_not_of(string_view("ac"), 2), "");
  static_assert(2 == string_view("abcabc").find_last_not_of(string_view("ab"), 2), "");
  static_assert(4 == string_view("abcabc").find_last_not_of(string_view("c"), 4), "");
  static_assert(1 == string_view("abcabc").find_last_not_of(string_view("ca"), 2), "");
}
...
namespace test_find_last_not_of_overload3 {
  static_assert(string_view::npos == string_view("").find_last_not_of("ab", string_view::npos, 0), "");
  static_assert(string_view::npos == string_view("").find_last_not_of("abc", string_view::npos, 1), "");
  static_assert(string_view::npos == string_view("").find_last_not_of("abcdef", string_view::npos, 3), "");
  static_assert(string_view::npos == string_view("abc").find_last_not_of("abcdef", string_view::npos, 3), "");
  static_assert(string_view::npos == string_view("abc").find_last_not_of("acdbef", string_view::npos, 4), "");
  static_assert(string_view::npos == string_view("abc").find_last_not_of("defabcas", string_view::npos, 6), "");

  static_assert(5 == string_view("abcabc").find_last_not_of("cab", string_view::npos, 0), "");
  static_assert(3 == string_view("abcabc").find_last_not_of("bca", string_view::npos, 2), "");
  static_assert(4 == string_view("abcabc").find_last_not_of("acb", string_view::npos, 2), "");
  static_assert(5 == string_view("abcabc").find_last_not_of("abc", string_view::npos, 2), "");
  static_assert(4 == string_view("abcabc").find_last_not_of("caba", string_view::npos, 1), "");
  static_assert(4 == string_view("abcabc").find_last_not_of("cacab", string_view::npos, 2), "");

  static_assert(string_view::npos == string_view("").find_last_not_of("ab", 1, 0), "");
  static_assert(string_view::npos == string_view("").find_last_not_of("abc", 0, 1), "");
  static_assert(string_view::npos == string_view("").find_last_not_of("abcdef", 100, 3), "");
  static_assert(string_view::npos == string_view("abc").find_last_not_of("abcdef", 1, 3), "");
  static_assert(string_view::npos == string_view("abc").find_last_not_of("acdbef", 3, 4), "");
  static_assert(string_view::npos == string_view("abc").find_last_not_of("defabcas", 2, 6), "");
...
namespace test_find_last_not_of_overload4 {
  ...
  static_assert(string_view::npos == string_view("abc").find_last_not_of("abc"), "");
  static_assert(string_view::npos == string_view("abc").find_last_not_of("acdb"), "");
  static_assert(string_view::npos == string_view("abc").find_last_not_of("defabc"), "");
  ...
  static_assert(string_view::npos == string_view("").find_last_not_of("a", 0), "");
  static_assert(string_view::npos == string_view("").find_last_not_of("abc", 100), "");
  static_assert(string_view::npos == string_view("abc").find_last_not_of("abc", 1), "");
  static_assert(string_view::npos == string_view("abc").find_last_not_of("acdb", 3), "");
  static_assert(string_view::npos == string_view("abc").find_last_not_of("defabc", 2), "");
...
namespace test_hash {
  TEST(StringViewTest, testHash) {
    EXPECT_EQ(std::hash<string_view>()(string_view()), std::hash<string_view>()(""));
    EXPECT_EQ(std::hash<string_view>()(string_view("hello")), std::hash<string_view>()("hello"));
    EXPECT_NE(std::hash<string_view>()(string_view("hello")), std::hash<string_view>()(""));
  }
}
