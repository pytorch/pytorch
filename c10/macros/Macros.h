...
// Bazel does not support using system includes for libraries. For
// non-generated headers we avoid this problem because we add
// "-I.". Including this private header with quotes allows Bazel to
// locate this as designed.
