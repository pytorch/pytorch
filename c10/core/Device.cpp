...
DeviceType parse_type(const std::string& device_string) {
  ...
  TORCH_CHECK(
      false,
      "Expected one of cpu, cuda, dml, ipu, xpu, mkldnn, opengl, opencl, ideep, hip, ve, ort, mps, xla, lazy, vulkan, meta, hpu, privateuseone device type at start of device string: ",
      device_string);
}
