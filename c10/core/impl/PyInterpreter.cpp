...
#define PANIC(m)              \
  ...
  virtual void mode_state_push_trampoline(std::shared_ptr<SafePyObject> mode) const override {};
  virtual void mode_state_pop_trampoline(std::shared_ptr<SafePyObject> mode) const override {};
};
