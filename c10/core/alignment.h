...
// Defaults to 64 bytes because `std::hardware_destructive_interference_size` may vary
// across compilers or target architectures, making it unsuitable for stable ABI.
