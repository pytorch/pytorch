 ...
 */
inline int64_t size_from_dim_(int k, IntListRef dims) {
  int64_t r = 1;
...
inline int64_t size_to_dim_(int k, IntListRef dims) {
...
inline int64_t size_between_dim_(int k, int l, IntListRef dims) {
...
struct C10_API TensorImpl : public c10::intrusive_ptr_target {
 ...
 public:
   ...
   */
  virtual IntListRef sizes() const;

  /**
   * Return a reference to the strides of this tensor.  This reference remains
   * valid as long as the tensor is live and not restrided.
   */
  virtual IntListRef strides() const;
   ...
   * See Note [We regret making Variable hold a Tensor]
   */
  void set_sizes_contiguous(IntListRef new_size) {
   ...
   * See Note [We regret making Variable hold a Tensor]
   */
  void set_sizes_and_strides(IntListRef new_size, IntListRef new_stride) {
...
private:
  ...
  bool SetDims() {
    return SetDims(IntListRef{});
  }

  bool SetDims(const int64_t d0) {
    return SetDims(IntListRef{d0});
  }

  bool SetDims(const int64_t d0, const int64_t d1) {
    return SetDims(IntListRef{d0, d1});
  }

  bool SetDims(const int64_t d0, const int64_t d1, const int64_t d2) {
    return SetDims(IntListRef{d0, d1, d2});
  }

  bool SetDims(const int64_t d0, const int64_t d1, const int64_t d2, const int64_t d3) {
    return SetDims(IntListRef{d0, d1, d2, d3});
  }
