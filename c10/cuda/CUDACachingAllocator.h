...
class CUDAAllocator : public DeviceAllocator {
 public:
  ...
  virtual std::vector<StreamSegmentSize> getExpandableSegmentSizes(c10::DeviceIndex device) = 0;
...
inline std::vector<StreamSegmentSize> getExpandableSegmentSizes(c10::DeviceIndex device) {
