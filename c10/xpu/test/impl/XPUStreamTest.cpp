...
TEST(XPUStreamTest, ExternalTest) {
  ...
  at::xpu::XPUStream myStream =
      at::xpu::getStreamFromExternal(stream, 0);
...
TEST(XPUStreamTest, ExternalMultiDeviceTest) {
  ...
  at::xpu::XPUStream myStream0 =
      at::xpu::getStreamFromExternal(stream_0, 0);
  at::xpu::XPUStream myStream1 =
      at::xpu::getStreamFromExternal(stream_1, 1);
