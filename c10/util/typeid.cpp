...
CAFFE_DEFINE_PREALLOCATED_KNOWN_TYPE(11, c10::QInt)
// 12 = undefined type id
// 13 = Tensor (defined in tensor.cc)
CAFFE_DEFINE_PREALLOCATED_KNOWN_TYPE(14, std::string)
CAFFE_DEFINE_PREALLOCATED_KNOWN_TYPE(15, bool)
CAFFE_DEFINE_PREALLOCATED_KNOWN_TYPE(16, uint16_t)
CAFFE_DEFINE_PREALLOCATED_KNOWN_TYPE(17, char)
CAFFE_DEFINE_PREALLOCATED_KNOWN_TYPE(18, std::unique_ptr<std::mutex>)
CAFFE_DEFINE_PREALLOCATED_KNOWN_TYPE(19, std::unique_ptr<std::atomic<bool>>)
CAFFE_DEFINE_PREALLOCATED_KNOWN_TYPE(20, std::vector<int32_t>)
CAFFE_DEFINE_PREALLOCATED_KNOWN_TYPE(21, std::vector<int64_t>)
CAFFE_DEFINE_PREALLOCATED_KNOWN_TYPE(22, std::vector<unsigned long>)
CAFFE_DEFINE_PREALLOCATED_KNOWN_TYPE(23, bool*)
CAFFE_DEFINE_PREALLOCATED_KNOWN_TYPE(24, char*)
CAFFE_DEFINE_PREALLOCATED_KNOWN_TYPE(25, int*)

// see typeid.h for details.
CAFFE_DEFINE_PREALLOCATED_KNOWN_TYPE(26, detail::_guard_long_unique<long>);
