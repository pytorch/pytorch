...
test_libtorch() {
  if [[ "$BUILD_ENVIRONMENT" != *rocm* ]]; then
    ...
    python test/test_gtest GTest.test_api

    python test/test_gtest GTest.test_tensorexpr
    python test/test_gtest GTest.test_mobile_nnc

>>>>>>> 9131d58e5a ([wip] Add more C++ tests to Python wrapper)
