...
# NOTE: There is no intermediate Docker image between build and test phase on CircleCI,
# so we need to do this as temporary workaround until the dependencies are baked into
