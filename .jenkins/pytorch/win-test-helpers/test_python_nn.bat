...
pytorch_installation="$(dirname $(dirname $(cd /c && python -c 'import os; import torch; print(os.path.realpath(torch.__file__))')))"
python_installation="$(dirname $(dirname $(cd /c && python -c 'import os; import caffe2; print(os.path.realpath(caffe2.__file__))')))"
