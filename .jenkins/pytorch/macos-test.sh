...
test_python_all() {
  ...
  python test/run_test.py --verbose --exclude test_tensorexpr test_jit_fuser_te test_jit_legacy.py test_jit_fuser_legacy test_tensorexpr test_jit_fuser_te --determine-from="$DETERMINE_FROM"
