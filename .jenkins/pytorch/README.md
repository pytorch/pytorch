...
1. Figure out what Docker image you want.  The general template for our
   ...
   enumerated in
   [pytorch-dockerfiles](https://github.com/pytorch/pytorch/blob/main/.circleci/docker/build.sh). The dockerfile used by jenkins can be found under the `.circle` [directory](https://github.com/pytorch/pytorch/blob/main/.circleci/docker)
