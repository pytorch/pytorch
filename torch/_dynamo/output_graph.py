...
class OutputGraph(OutputGraphCommon):
    ...
    def __init__(
        ...
        # Cache for sources resolved via MRO walk. The source context is part of
        # the key because it encodes the class/MRO path used for lookup.
        ...
        self.guarded_mro_absent_keys: set[tuple[int, str, Source]] = set()
