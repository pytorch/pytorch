...
class OutputGraph(OutputGraphCommon):
    ...
    def __init__(
        ...
        # Calls that produce runtime scalar values are replaced with a single call
        # to __gen_rand_values that returns a tuple of values for each original
        # call. random_calls tracks calls such as random() and time.time();
        # random_values_var stores the name of the variable with those results.
