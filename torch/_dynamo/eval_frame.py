...
class OptimizedModule(torch.nn.Module):
    ...
    def _initialize(self):
        ...
        if (
            ...
            and skipfiles.check(inspect.getsourcefile(self._orig_mod.forward)).skipped
        ):
...
class _TorchDynamoContext:
    ...
    def __call__(self, fn):
        ...
        try:
            ...
            filename = None
        if (
            (filename is None or skipfiles.check(filename).skipped)
            and (
    ...
    **extra_kwargs,
    ...
    def inner(*args, **kwargs):
        ...
        if (
            ...
            and not skipfiles.check(inspect.getsourcefile(call_to_inspect)).skipped
        ):
