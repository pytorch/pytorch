...
class DisableContext(_TorchDynamoContext):
    ...
    def __call__(self, fn):
        ...
        # Under some circumstances (e.g. precompile) we can call @disable
        # decorator in generated bytecode and trigger recompile, so we want to
        # skip calling into any frame in this case.
        if self.wrapping:
