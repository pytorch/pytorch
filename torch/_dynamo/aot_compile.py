            ...
            if guard_scope is not None:
                ...
                if self._has_global_guards:
                    ...
                    if self._bytecode_reads_guard_scope:
                        ...
                        # returns -- is in external_refs but in neither
                        # import_sources nor used_globals, the only dicts
                        # forward_callable builds fn.__globals__ from, so its
                        # check fails unless it is bound here.
                        live = {}
