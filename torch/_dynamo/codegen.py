...
class PyCodegen:
    ...
    def make_function_with_closure(
        ...
        def gen_fn():
            # Emitting `LOAD_FAST` with names in `co_freevars` requires that in
            # the generated bytecode, these cells would keep their original
            # local names, which we ensure via
            # `NewCellVariable.root_frame_local_name`.
            for var in freevars:
