...
from .source import GlobalSource, LocalCellSource, Source, SyntheticLocalSource
        ...
        for var in self._get_modified_vars():
            ...
            if isinstance(var, variables.CellVariable):
                ...
                if var.local_name is None:
                    ...
                    cg.add_cache(var)
                    var.source = SyntheticLocalSource(cg.tempvars[var])  # type: ignore[attr-defined]
                ...
                if isinstance(
                    ...
                    cg.clear_tos()
                    var.source = SyntheticLocalSource(cg.tempvars[var])
