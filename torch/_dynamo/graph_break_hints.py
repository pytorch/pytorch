USER_ERROR = [
    "Dynamo has detected that tracing the code will result in an error. "
    "Please double check that your code doesn't contain a similar error when running eager/uncompiled.",
]
DYNAMO_BUG = [
