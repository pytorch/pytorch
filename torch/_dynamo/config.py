...
# Controls whether to construct the entire framelocals to dict for lambda
# guards. This is a temporary flag to allow quick fallback behavior in case of
# unexpected issues. Default is False, i.e., we will construct only partial
# dict, a faster version for guards.
construct_full_framelocals_dict = False
