...
# Hooks for bytecode generated by Dynamo. The hook can do some
# logging, as well as return a new code object to be used. Please
# refer to `BytecodeHook` for the hook signature.
output_bytecode_hooks: List[BytecodeHook] = []
...
def _compile(
    ...
    def compile_inner(
        ...
        for hook in output_bytecode_hooks:
