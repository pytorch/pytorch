...
class InstructionTranslatorBase(
        ...
        try:
            ...
            if name.startswith("."):
                try:
                    ...
                    unimplemented_v2(
                        gb_type="Undefined LOAD_FAST (implicit)",
                        context=name,
    ...
    def RERAISE(self, inst):
        ...
        unimplemented_v2(
            ...
            context="",
            explanation="RERAISE bytecode not supported in Python < 3.11",
            hints=[],
        )
            ...
            if exn_tab_entry:
                ...
                if type(self) is InstructionTranslator:
                    unimplemented_v2(
                        ...
                        explanation="Dynamo found no exception handler at the top-level compiled function "
                        "when encounterin an exception. Exception will propagate outside the compiled region.",
                        hints=[
        ...
        for seq in seqs:
            try:
                ...
                unimplemented_v2(
                    ...
                    context=str(seq),
                    explanation=f"{seq} cannot be unpacked into a list for the BUILD_LIST_UNPACK bytecode.",
                    hints=[*graph_break_hints.USER_ERROR],
                )
    ...
    def UNPACK_SEQUENCE(self, inst):
        ...
        if len(val) != inst.argval:
            unimplemented_v2(
                ...
                explanation=f"{seq} unpacked to a list for the UNPACK_SEQUENCE bytecode with unexpected length.",
                hints=[*graph_break_hints.DYNAMO_BUG],
            )
