...
torch_c_binding_in_graph_functions = dict.fromkeys(
    [
        ...
        "torch._C._verbose.onednn_set_verbose",
        ...
        "torch._onednn_reshape",
        "torch._onednn_transpose_",
        "torch._onednn_transpose",
...
torch_non_c_binding_in_graph_functions = dict.fromkeys(
    [
        ...
        "torch.backends.onednn.flags",
        "torch.backends.onednn.is_available",
        "torch.backends.onednn.set_flags",
