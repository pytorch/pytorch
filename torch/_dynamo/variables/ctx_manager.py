...
class ContextWrappingVariable(VariableTracker):
    ...
    def set_cleanup_hook(self, tx: "InstructionTranslator", fn: Any = None) -> None:
        if fn is None:
...
class GenericContextWrappingVariable(UserDefinedObjectVariable):
    ...
    def __init__(self, cm_obj: Any, **kwargs: Any) -> None:
...
class RepararametrizeModuleContextVariable(GenericContextWrappingVariable):
    def __init__(self, ctx_manager_vt: Any, mod: Any, **kwargs: Any) -> None:
...
class GradInplaceRequiresGradCtxManagerVariable(ContextWrappingVariable):
    ...
    def enter(self, tx: "InstructionTranslator") -> "VariableTracker":
        ...
        self.prev_state = torch._C._functorch.get_inplace_requires_grad_allowed()  # type: ignore[attr-defined]
        torch._C._functorch.set_inplace_requires_grad_allowed(enabled)  # type: ignore[attr-defined]
        self.set_cleanup_hook(
            tx,
            lambda: torch._C._functorch.set_inplace_requires_grad_allowed(  # type: ignore[attr-defined]
                self.prev_state
            ),
        )
        self.proxy = tx.output.create_node(
            "call_function",
            torch._C._functorch.set_inplace_requires_grad_allowed,  # type: ignore[attr-defined]
            (enabled,),
            {},
        )
        return variables.ConstantVariable.create(None)
...
class CatchWarningsCtxManagerVariable(ContextWrappingVariable):
    ...
    @staticmethod
    def create(
        tx: "InstructionTranslator", catch_warnings_args: Any
...
class TorchFunctionDisableVariable(ContextWrappingVariable):
    ...
    def set_cleanup_hook(
        self, tx: "InstructionTranslator", cleanup_fn: Any = None
    ) -> None:
...
class AutocastModeVariable(ContextWrappingVariable):
    @staticmethod
    def create(func: Any, args: Any, kwargs: Any) -> "AutocastModeVariable":
        assert func in [
...
class NullContextVariable(ContextWrappingVariable):
    ...
    def __init__(self, target_values: Any = None, **kwargs: Any) -> None:
...
class PreserveVersionContextVariable(ContextWrappingVariable):
    ...
    def _create_lambda_from_tensors(
        tx: "InstructionTranslator", tensors: Any
    ...
    def __init__(self, tensors: Any, prev_versions: Any, **kwargs: Any) -> None:
...
class SDPAKernelVariable(ContextWrappingVariable):
    ...
    def _backends_to_nodes(
        tx: "InstructionTranslator", backends: list[torch.nn.attention.SDPBackend]
    ) -> list[Any]:
...
class ErrorOnGraphBreakVariable(ContextWrappingVariable):
    ...
    def __init__(self, error_on_graph_break: Any, **kwargs: Any) -> None:
        super().__init__(
