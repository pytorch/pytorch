...
def while_loop_call_function_impl(
    self,
    tx: "InstructionTranslator",
    args: list[VariableTracker],
    kwargs: dict[str, VariableTracker],
    ...
    proxy_operands = tuple([operand.as_proxy() for operand in operands_seq])
    proxy_additional_inputs = tuple(
...
class WhileLoopHigherOrderVariable(TorchHigherOrderOperatorVariable):
    ...
    def _call_function(
        ...
        return while_loop_call_function_impl(
            self, tx, args, kwargs, with_checkpoint=False
        )
...
class WhileLoopWithCheckpointHigherOrderVariable(TorchHigherOrderOperatorVariable):
    ...
    def call_function(
        ...
        return while_loop_call_function_impl(
            self, tx, args, kwargs, with_checkpoint=True
        )
