            ...
            if always_restore:
                ...
                if not supports_input_mutation:
                    ...
                    if mutation_info.has_mutation:
                        ...
                        unimplemented_v2(
                            gb_type=f"Encountered input mutation during higher order op tracing for HOP",
                            context=context,
                ...
                if not supports_aliasing:
                    ...
                    if aliasing_info.has_aliasing:
                        ...
                        unimplemented_v2(
                            gb_type=f"Encountered aliasing during higher order op tracing for HOP",
                            context=context,
...
class InvokeSubgraphHigherOrderVariable(WrapHigherOrderVariable):
    ...
    def install_subgraph_in_output_graph(
        ...
        if not isinstance(fn_vt, (UnspecializedNNModuleVariable, UserFunctionVariable)):
            unimplemented_v2(
                gb_type=f"Encountered non user function variable during invoke_subgraph HOP tracing",
                context="",
