...
class TensorVariable(VariableTracker):
    ...
    def call_method(
        ...
        if constant_result:
            ...
            unimplemented(f"Tensor.{name}")
        elif name == "item" and config.capture_scalar_outputs and not config.dynamic_shapes:
            raise AssertionError("To capture_scalar_outputs, you must also set dynamic_shapes = True")
        elif name == "__len__":
