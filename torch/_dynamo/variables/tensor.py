...
class TensorVariable(VariableTracker):
    ...
    def method_backward(
        ...
        for idx, input_var in enumerate(input_vars):
            ...
            input_grad = input_var.var_getattr(tx, "grad")
            updated_grad = accumulate_grad_fn.call_function(
                tx, [input_var, input_grad, grad_i], {}
            )
            tx.output.side_effects.store_attr(input_var, "grad", updated_grad)
