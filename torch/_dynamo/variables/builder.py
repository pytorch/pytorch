...
class VariableBuilder:
    ...
    def wrap_literal(self, value: object) -> VariableTracker:
        if type(value) is int:
            ...
            # The dynamic-sources list has higher precedence over specialization control.
    ...
    def should_specialize_numpy_scalar(self, value: Any) -> bool:
        ...
        if not isinstance(value, np.floating):
            return False
        if not ConstantVariable.is_base_literal(value.item()):
            return False
...
class SourcelessBuilder:
    ...
    def create(tx: "InstructionTranslatorBase", value: Any) -> VariableTracker:
        ...
        # type: ignore[attr-defined]
            ...
            and ConstantVariable.is_base_literal(value.item())
        ):
