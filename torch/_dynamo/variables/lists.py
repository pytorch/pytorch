...
class RangeVariable(BaseListVariable):
    ...
    tp_members = {
        "start": Member(lambda s, _: s.items[0], None),
        "stop": Member(lambda s, _: s.items[1], None),
        "step": Member(lambda s, _: s.items[2], None),
    }
...
class DequeVariable(BaseListVariable):
    ...
    tp_getset = {
        "maxlen": GetSet(lambda s, _: s.maxlen, None),
    }
...
class SliceVariable(VariableTracker):
    ...
    tp_members = {
        "start": Member(lambda s, _: s.item[0], None),
        "stop": Member(lambda s, _: s.item[1], None),
        "step": Member(lambda s, _: s.item[2], None),
    }
