...
class _KinetoEvent:
    ...
    def typed_metadata(self) -> dict[str, Any]: ...
...
def _push_node_creation_hook(hook: Callable[[Any], None]) -> None: ...
def _pop_node_creation_hook() -> None: ...
...
def _get_view_attr_version(t: torch.Tensor) -> int: ...
def _unsafe_set_view_attr_version(t: torch.Tensor, version: int) -> None: ...
def _unsafe_mark_view_attr_version_stale(t: torch.Tensor) -> None: ...
def _is_same_version_counter(a: torch.Tensor, b: torch.Tensor) -> bool: ...
