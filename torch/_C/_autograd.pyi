...
# Defined in torch/csrc/autograd/profiler.h
class EventKind:
    ...
...
PushRange: EventKind = ...
PopRange: EventKind = ...
MemoryAlloc: EventKind = ...

class ProfilerEvent:
    def __init__(self, name: str, kind: EventKind, thread_id_: int, record_cuda: bool,
                 handle: int, shapes: List[List[int]]) -> None: ...
