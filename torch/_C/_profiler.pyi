...
class _CuptiMonitorModule:
    ...
    @staticmethod
    def buffer_request_callback_address(version: int = 1) -> int: ...
    @staticmethod
    def buffer_complete_callback_address(version: int = 1) -> int: ...
    @staticmethod
    def next_layout_epoch() -> int: ...
    @staticmethod
    def record_layouts(
        epoch: int,
    ) -> list[tuple[int, int, list[tuple[int, int, int]]]]: ...
    @staticmethod
    def get_completed() -> tuple[int, int, int, int, int] | None: ...
    @staticmethod
