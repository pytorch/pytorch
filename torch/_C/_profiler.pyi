...
def _cupti_approximate_time_callback_address() -> int: ...

# GIL-free CUPTI monitor buffer pool (torch/csrc/profiler/cupti_monitor_native).
def _cupti_monitor_configure_buffers(buffer_size: int) -> None: ...
def _cupti_monitor_buffer_request_callback_address(version: int = 1) -> int: ...
def _cupti_monitor_buffer_complete_callback_address(version: int = 1) -> int: ...
def _cupti_monitor_next_layout_epoch() -> int: ...
def _cupti_monitor_record_layouts(
    epoch: int,
) -> list[tuple[int, int, list[tuple[int, int, int]]]]: ...
def _cupti_monitor_get_completed() -> tuple[int, int, int, int, int] | None: ...
def _cupti_monitor_return_buffer(ptr: int) -> None: ...
def _cupti_monitor_pending_buffers() -> int: ...
def _cupti_monitor_allocated_buffers() -> int: ...
def _cupti_monitor_shutdown_buffers() -> None: ...
def _cupti_monitor_reset_buffers() -> None: ...
