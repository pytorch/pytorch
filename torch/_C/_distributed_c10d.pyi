...
class ProcessGroupNCCL2(Backend):
    ...
    def get_error(self) -> ErrorType: ...
    def _add_ephemeral_timeout(self, timeout: timedelta) -> None: ...
    def _verify_work_timeout(self, work: Work, timeout: timedelta) -> bool: ...
    def _get_grow_id(self) -> bytes: ...
    def _grow(
        self,
        new_size: int,
        grow_id: bytes | None = None,
        new_rank: int = -1,
        options: ProcessGroupNCCL.Options | None = None,
    ) -> ProcessGroupNCCL2: ...
