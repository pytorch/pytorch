...
class ProcessGroup:
    ...
    def split_group(
        ...
        group_name: _GroupName | None = None,
    ...
    def _set_group_name(self, name: _GroupName) -> None: ...
    ...
    @property
    def group_name(self) -> _GroupName: ...
    @property
...
def _resolve_process_group(group_name: _GroupName) -> ProcessGroup: ...
def _register_process_group_alias(
    alias_name: _GroupName,
    canonical_name: _GroupName,
) -> None: ...
...
def _unregister_process_group(group_name: _GroupName) -> None: ...
