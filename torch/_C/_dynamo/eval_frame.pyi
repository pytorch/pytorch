...
def set_fullgraph_graph_frame_count(value: int) -> int: ...
def set_fullgraph_skipped_frame_count(value: int) -> int: ...
def set_fullgraph_root_code(value: types.CodeType | None) -> types.CodeType | None: ...
