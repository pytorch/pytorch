...
def get_code_exec_strategy(code: types.CodeType) -> _FrameExecStrategy: ...
def get_code_exec_strategy_token(
    code: types.CodeType,
) -> tuple[_FrameExecStrategy, int]: ...
def set_code_exec_strategy_with_token(
    code: types.CodeType, strategy: _FrameExecStrategy
) -> tuple[_FrameExecStrategy, int]: ...
def compare_and_set_code_exec_strategy(
    code: types.CodeType, expected_generation: int, strategy: _FrameExecStrategy
) -> bool: ...
...
class _CacheEntryHandle:
    backend: Callable | None
    def update_diff_guard_root_manager(self, diff_guard_root_manager: Any) -> None: ...
