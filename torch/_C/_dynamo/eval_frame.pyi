...
def _get_cache_entry_count_for_region(
    code: types.CodeType, isolate_recompiles_id: int
) -> int: ...
...
def _reset_precompile_entries_for_owner(
    code: types.CodeType, isolate_recompiles_id: int, owner: object
) -> None: ...
def _debug_get_precompile_entries(code: types.CodeType) -> list[_PrecompileEntry]: ...
def _has_precompile_entries(
    code: types.CodeType, isolate_recompiles_id: int
) -> bool: ...
def _enable_precompile_cache_keys() -> None: ...
