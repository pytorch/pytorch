...
class GuardManager:
    ...
    def get_accessors(self) -> list[GuardAccessor]: ...
    def is_guarded_value_immutable(self) -> bool: ...
    def is_guarded_value_nn_module(self) -> bool: ...
    def is_guarded_value_dict(self) -> bool: ...
    def is_guarded_value_tensor(self) -> bool: ...
    ...
    def has_relational_guard(self) -> bool: ...
