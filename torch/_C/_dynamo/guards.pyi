...
class GuardManager:
    ...
    def globals_dict_manager(
        self, f_globals: Dict[str, Any], example_value
    ) -> GuardManager: ...
    def dict_getitem_manager(self, key, example_value) -> GuardManager: ...
    def global_weakref_manager(
        self, global_name: str, example_value
    ) -> GuardManager: ...
    def type_manager(self, example_value) -> GuardManager: ...
    def getattr_manager(self, attr: str, example_value) -> GuardManager: ...
    def lambda_manager(self, python_lambda, example_value) -> GuardManager: ...
