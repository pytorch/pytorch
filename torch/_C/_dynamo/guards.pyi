...
class KeyValueDictGuardManager(GuardManager):
    def get_key_manager(self, example_value) -> GuardManager: ...
    def get_value_manager(self, example_value) -> GuardManager: ...

class DictGuardManager(GuardManager):
    def get_index_manager(self, index: int) -> KeyValueDictGuardManager: ...
