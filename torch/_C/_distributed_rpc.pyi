...
class PyRRef:
    ...
    def rpc_sync(self, device_map: Dict[torch.device, torch.device] = dict(), timeout: float = _UNSET_RPC_TIMEOUT) -> Any: ...
    def rpc_async(self, device_map: Dict[torch.device, torch.device] = dict(), timeout: float = _UNSET_RPC_TIMEOUT) -> Any: ...
    def remote(self, device_map: Dict[torch.device, torch.device] = dict(), timeout: float = _UNSET_RPC_TIMEOUT) -> Any: ...
