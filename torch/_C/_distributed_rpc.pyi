...
class PyRRef:
    ...
    def _get_future(self) -> Any: ...
    def _get_profiling_future(self) -> Any: ...
    def _set_profiling_future(self) -> Any: ...
    def __repr__(self) -> str: ...
...
def _set_and_start_rpc_agent(agent: RpcAgent) -> None: ...
...
def _disable_server_process_global_profiler() -> List[Any]: ...
