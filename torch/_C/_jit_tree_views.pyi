...
# Literals
def TrueLiteral(range: SourceRange) -> Expr: ...
def FalseLiteral(range: SourceRange) -> Expr: ...
def NoneLiteral(range: SourceRange) -> Expr: ...
...
class Def(TreeView):
    def __init__(self, name: Ident, decl: Decl, body: list[Stmt]) -> None: ...
    def decl(self) -> Decl: ...
    def name(self) -> Ident: ...
