...
class TransformType(Enum):
    ...
    Torch: TransformType = ... # type: ignore[misc]
    Vmap: TransformType = ... # type: ignore[misc]
    Grad: TransformType = ... # type: ignore[misc]
    Jvp: TransformType = ... # type: ignore[misc]
    Functionalize: TransformType = ... # type: ignore[misc]

class RandomnessType(Enum):
    # Ignores needed to avoid mypy error 'enum members must be left unannotated'
    Error: TransformType = ... # type: ignore[misc]
    Same: TransformType = ... # type: ignore[misc]
    Different: TransformType = ... # type: ignore[misc]
