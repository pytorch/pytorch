...
class ExportPassBase(PassBase):
    ...
    def call(self, graph_module: fx.GraphModule) -> PassResult:
        ...
        # TODO(angelayi): Update this with the exported graph module class once
        # we combine internal/external graph_module.py
        # old_meta = get_export_meta(graph_module)
        # new_meta = get_export_meta(result.graph_module)
