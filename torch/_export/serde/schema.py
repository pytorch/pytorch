...
class ExportedProgram:
    ...
    tensorPaths: Annotated[dict[str, str], 90]
    ...
    constantPaths: Annotated[dict[str, str], 100]
...
class Model:
    ...
    # - different delegates such as "default", "aoti_sm80" and "aoti_sm90"
    programs: Annotated[dict[str, ExportedProgram], 80]
