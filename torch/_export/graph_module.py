...
class ExportedProgram:
    def __init__(
        ...
        if isinstance(root, torch.fx.GraphModule):
            ...
            # TODO: maybe we can remove this inline_constraints and just
            # directly get from shape_env.var_to_range
            self.symbol_to_range = root.meta.get("inline_constraints", {})
