...
# torch._guards must be importable without torch._dynamo. The Source subclasses
# below need dynamo only for bytecode reconstruction (codegen) and for a few
# dynamo-specific sources; those imports are deferred to call time. The generated
# bytecode still imports helpers from torch._dynamo.utils at runtime (under
# dynamo), so behavior is unchanged.
_UTILS_MODULE = "torch._dynamo.utils"


def create_binary_subscr() -> "Instruction":
    from torch._dynamo.bytecode_transformation import create_binary_subscr as _f

    return _f()


def create_build_tuple(n: int) -> "Instruction":
    from torch._dynamo.bytecode_transformation import create_build_tuple as _f

    return _f(n)


def create_call_function(nargs: int, push_null: bool) -> "list[Instruction]":
    from torch._dynamo.bytecode_transformation import create_call_function as _f

    return _f(nargs, push_null)
    ...
    def reconstruct(self, codegen: "PyCodegen") -> None:
        codegen.add_push_null(
            lambda: codegen.load_import_from(
                _UTILS_MODULE, f"call_{_esc_str(self.prop.method_name())}"
            )
        )
        codegen(self.base)
...
class ConstDictKeySource(ChainedSource):
    ...
    def reconstruct(self, codegen: "PyCodegen") -> None:
        codegen.add_push_null(
            lambda: codegen.load_import_from(_UTILS_MODULE, "dict_keys_getitem")
        )
        codegen(self.base)
        codegen.append_output(codegen.create_load_const(self.index))
...
class NonSerializableSetGetItemSource(ChainedSource):
    ...
    def reconstruct(self, codegen: "PyCodegen") -> None:
        codegen.add_push_null(
            lambda: codegen.load_import_from(_UTILS_MODULE, "set_getitem")
        )
        codegen(self.base)
        codegen.append_output(codegen.create_load_const(self.index))
        codegen.extend_output(create_call_function(2, False))
    ...
    def get_value(
        ...
        if self in cache:
            return cache[self]
        from torch._dynamo.utils import set_getitem

        value = set_getitem(self.base.get_value(globals, locals, cache), self.index)
        cache[self] = value
        return value
...
class DictSubclassGetItemSource(ChainedSource):
    ...
    def reconstruct(self, codegen: "PyCodegen") -> None:
        ...
        codegen.add_push_null(
            lambda: codegen.load_import_from(_UTILS_MODULE, "dict_getitem")
        )
...
class ListGetItemSource(GetItemSource):
    ...
    def reconstruct(self, codegen: "PyCodegen") -> None:
        ...
        codegen.add_push_null(
            lambda: codegen.load_import_from(_UTILS_MODULE, "list_getitem")
        )
...
class TupleIteratorGetItemSource(GetItemSource):
    def reconstruct(self, codegen: "PyCodegen") -> None:
        codegen.add_push_null(
            lambda: codegen.load_import_from(_UTILS_MODULE, "tuple_iterator_getitem")
        )
        codegen(self.base)
        codegen.append_output(codegen.create_load_const(self.index))
        codegen.extend_output(create_call_function(2, False))
...
class DataclassFieldsSource(ChainedSource):
    def reconstruct(self, codegen: "PyCodegen") -> None:
        codegen.add_push_null(
            lambda: codegen.load_import_from(_UTILS_MODULE, "dataclass_fields")
        )
        codegen(self.base)
        codegen.extend_output(create_call_function(1, False))
...
class TorchFunctionModeStackSource(Source):
    ...
    def reconstruct(self, codegen: "PyCodegen") -> None:
        codegen.add_push_null(
            lambda: codegen.load_import_from(
                _UTILS_MODULE, "get_torch_function_mode_stack_at"
            )
        )
...
class CurrentStreamSource(Source):
    ...
    def reconstruct(self, codegen: "PyCodegen") -> None:
        num_args = 1
        codegen.add_push_null(
            lambda: codegen.load_import_from(_UTILS_MODULE, "get_current_stream")
        )
