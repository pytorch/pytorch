...
def get_testing_overrides() -> Dict[Callable, Callable]:
    ...
    ret = {
        ...
        Tensor._nse: lambda self: -1,
        Tensor._nnz: lambda self: -1,
        Tensor._update_names: lambda self, names, inplace: -1,
        Tensor._values: lambda self: -1,
        Tensor._values_coalesce: lambda self: -1,
        Tensor.indices: lambda self, coalesce=True: -1,
        Tensor.values: lambda self, coalesce=True: -1,
        Tensor.nse: lambda self, coalesce=True: -1,
