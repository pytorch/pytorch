...
def get_testing_overrides() -> Dict[Callable, Callable]:
    ...
    ret: Dict[Callable, Callable] = {
        ...
        torch.special.jacobi_elliptic_k_cd: lambda input, k, out=None: -1,
        torch.special.jacobi_elliptic_k_cn: lambda input, k, out=None: -1,
        torch.special.jacobi_elliptic_k_cs: lambda input, k, out=None: -1,
        torch.special.jacobi_elliptic_k_dc: lambda input, k, out=None: -1,
        torch.special.jacobi_elliptic_k_dn: lambda input, k, out=None: -1,
        torch.special.jacobi_elliptic_k_ds: lambda input, k, out=None: -1,
        torch.special.jacobi_elliptic_k_nc: lambda input, k, out=None: -1,
        torch.special.jacobi_elliptic_k_nd: lambda input, k, out=None: -1,
        torch.special.jacobi_elliptic_k_ns: lambda input, k, out=None: -1,
        torch.special.jacobi_elliptic_k_sc: lambda input, k, out=None: -1,
        torch.special.jacobi_elliptic_k_sd: lambda input, k, out=None: -1,
        torch.special.jacobi_elliptic_k_sn: lambda input, k, out=None: -1,
