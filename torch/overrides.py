...
def get_testing_overrides() -> Dict[Callable, Callable]:
    ...
    ret = {
        ...
        torch.dsplit: lambda input, split_size_or_sections: -1,
        ...
        torch.hsplit: lambda input, split_size_or_sections: -1,
        ...
        torch.vsplit: lambda input, split_size_or_sections: -1,
