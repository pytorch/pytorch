...
def get_testing_overrides() -> Dict[Callable, Callable]:
    ...
    ret = {
        ...
        torch.nn.functional.gaussian_nll_loss: (lambda input, target, var, full=False, eps=1e-08, reduction='mean': -1),
        ...
        torch.gaussian_nll_loss: lambda input, target, var, full, eps, reduction: -1,
