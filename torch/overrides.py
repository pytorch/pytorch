...
def get_testing_overrides() -> dict[Callable, Callable]:
    ...
    ret: dict[Callable, Callable] = {
        ...
        torch.nn.functional.grid_sample: lambda input, grid, mode="bilinear", padding_mode="zeros", align_corners=None, pixel_coords=False, cubic_coeff_a=None: -1,
        ...
        Tensor._has_grad_dtype_override.__get__: lambda self: -1,
