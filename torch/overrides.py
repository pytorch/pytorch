...
def get_testing_overrides() -> Dict[Callable, Callable]:
    ...
    ret: Dict[Callable, Callable] = {
        ...
        torch.sym_cos: lambda input: -1,
        torch.sym_cosh: lambda input: -1,
        torch.sym_sin: lambda input: -1,
        torch.sym_sinh: lambda input: -1,
        torch.sym_tan: lambda input: -1,
        torch.sym_tanh: lambda input: -1,
        torch.sym_asin: lambda input: -1,
        torch.sym_acos: lambda input: -1,
        torch.sym_atan: lambda input: -1,
