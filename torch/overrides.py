...
def get_testing_overrides() -> Dict[Callable, Callable]:
    ...
    ret: Dict[Callable, Callable] = {
        ...
        torch.quantile: lambda input, q, interpolation='linear', dim=None, keepdim=False, out=None: -1,
        torch.nanquantile: lambda input, q, interpolation='linear', dim=None, keepdim=False, out=None: -1,
