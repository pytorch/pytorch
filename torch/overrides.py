...
def get_testing_overrides() -> Dict[Callable, Callable]:
    ...
    ret: Dict[Callable, Callable] = {
        ...
        torch.special.bessel_k0: lambda input: -1,
        torch.special.bessel_k0e: lambda input: -1,
        torch.special.bessel_k1: lambda input: -1,
        torch.special.bessel_k1e: lambda input: -1,
