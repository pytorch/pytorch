...
def get_testing_overrides() -> Dict[Callable, Callable]:
    ...
    ret: Dict[Callable, Callable] = {
        ...
        torch.special.complete_elliptic_integral_k_e: lambda input: -1,
        torch.special.complete_elliptic_integral_k_k: lambda input: -1,
        torch.special.complete_elliptic_integral_m_e: lambda input: -1,
        torch.special.complete_elliptic_integral_m_k: lambda input: -1,
