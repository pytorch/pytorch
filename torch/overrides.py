...
def get_testing_overrides() -> Dict[Callable, Callable]:
    ...
    ret: Dict[Callable, Callable] = {
        ...
        Tensor._fw_primal_copy: lambda self, level: -1,
        Tensor._conj_copy: lambda self: -1,
        Tensor._neg_view_copy: lambda self: -1,
        Tensor.as_strided_copy: lambda self, size, stride, storage_offset=None: -1,
        Tensor.diagonal_copy: lambda self, offset=0, dim1=0, dim2=1: -1,
        Tensor.expand_copy: lambda self, size, *, implicit=False: -1,
        Tensor.narrow_copy: lambda self, dim, start, length: -1,
        Tensor.permute_copy: lambda self, dims: -1,
        Tensor._reshape_alias_copy: lambda self, size, stride: -1,
        Tensor.select_copy: lambda self, dim, index: -1,
        Tensor.detach_copy: lambda self: -1,
        Tensor.slice_copy: lambda self, dim=0, start=None, end=None, step=1: -1,
        Tensor.split_copy: lambda self, split_size, dim=0: -1,
        Tensor.split_with_sizes_copy: lambda self, split_sizes, dim=0: -1,
        Tensor.squeeze_copy: lambda self: -1,
        Tensor.squeeze_copy: lambda self, dim: -1,
        Tensor.t_copy: lambda self: -1,
        Tensor.transpose_copy: lambda self, dim0, dim1: -1,
        Tensor.unsqueeze_copy: lambda self, dim: -1,
        Tensor._indices_copy: lambda self: -1,
        Tensor._values_copy: lambda self: -1,
        Tensor.indices_copy: lambda self: -1,
        Tensor.values_copy: lambda self: -1,
        Tensor.crow_indices_copy: lambda self: -1,
        Tensor.col_indices_copy: lambda self: -1,
        Tensor.unbind_copy: lambda self, dim=0: -1,
        Tensor.view_copy: lambda self, size: -1,
        Tensor.view_copy: lambda self, dtype: -1,
        Tensor.unfold_copy: lambda self, dimension, size, step: -1,
        Tensor.alias_copy: lambda self: -1,
