...
def get_testing_overrides() -> Dict[Callable, Callable]:
    ...
    ret: Dict[Callable, Callable] = {
        ...
        torch.special.modified_bessel_j0: lambda input: -1,
        torch.special.modified_bessel_j1: lambda input: -1,
        torch.special.modified_bessel_y0: lambda input: -1,
        torch.special.modified_bessel_y1: lambda input: -1,
