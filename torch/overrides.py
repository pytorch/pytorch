...
def get_testing_overrides() -> Dict[Callable, Callable]:
    ...
    ret: Dict[Callable, Callable] = {
        ...
        eps,
        cudnn_enabled: -1,
        torch.batch_norm_backward_elemt: lambda grad_out,
        input,
        mean,
        invstd,
        weight,
        ...
        sum_dy_xmu,
        count_tensor: -1,
        torch.batch_norm_backward_reduce: lambda grad_out,
        input,
        mean,
        invstd,
        weight,
        ...
        torch.batch_norm_gather_stats: lambda input,
        mean,
        invstd,
        running_mean,
        running_var,
        ...
        eps,
        count: -1,
        torch.batch_norm_gather_stats_with_counts: lambda input,
        mean,
        invstd,
        running_mean,
        running_var,
        ...
        torch.batch_norm_update_stats: lambda input,
        running_mean,
        running_var,
        momentum: -1,
        ...
        torch.concatenate: lambda tensors,
        dim=0,
        out=None: -1,  # alias for torch.concatenate
        torch.cdist: lambda x1,
        x2,
        p=2.0,
        compute_mode="use_mm_for_euclid_dist_if_necessary": -1,
        ...
        torch.choose_qparams_optimized: lambda input,
        numel,
        n_bins,
        ratio,
        bit_width: -1,
        ...
        dilation=1,
        groups=1: -1,
        torch.convolution: lambda input,
        weight,
        bias,
        stride,
        padding,
        ...
        torch.conv_transpose1d: lambda input,
        weight,
        bias=None,
        stride=1,
        padding=0,
        ...
        groups=1,
        dilation=1: -1,
        torch.conv_transpose2d: lambda input,
        weight,
        bias=None,
        stride=1,
        padding=0,
        ...
        groups=1,
        dilation=1: -1,
        torch.conv_transpose3d: lambda input,
        weight,
        bias=None,
        stride=1,
        padding=0,
        ...
        torch.cosine_embedding_loss: lambda input1,
        input2,
        target,
        margin=0,
        size_average=None,
        ...
        torch.as_strided_scatter: lambda self,
        src,
        size,
        stride,
        storage_offset=None: -1,
        ...
        torch.embedding_bag: (
            ...
            padding_idx=None: -1  # noqa: B950
        ),
        torch.empty_like: lambda input,
        dtype=None,
        layout=None,
        device=None,
        ...
        torch.fake_quantize_per_channel_affine: lambda input,
        scale,
        zero_point,
        axis,
        quant_min,
        quant_max: -1,
        torch.fake_quantize_per_tensor_affine: lambda input,
        scale,
        zero_point,
        quant_min,
        quant_max: -1,
        torch.fused_moving_avg_obs_fake_quant: (
            ...
            symmetric_quant=False: -1  # noqa: B950
        ),
        torch.fbgemm_linear_fp16_weight: lambda input, packed_weight, bias: -1,
        torch.fbgemm_linear_fp16_weight_fp32_activation: lambda input,
        packed_weight,
        bias: -1,
        torch.fbgemm_linear_int8_weight: lambda input,
        weight,
        packed,
        col_offsets,
        weight_scale,
        ...
        torch.full_like: lambda input,
        fill_value,
        out=None,
        dtype=None,
        layout=torch.strided,
        device=None,
        requires_grad=False: -1,  # noqa: B950
        torch._functional_assert_async: lambda input, msg, dep_token: -1,
        torch.lu_unpack: lambda LU_data,
        LU_pivots,
        unpack_data=True,
        ...
        torch.grid_sampler: lambda input,
        grid,
        interpolation_mode,
        padding_mode,
        align_corners: -1,
        torch.grid_sampler_2d: lambda input,
        grid,
        interpolation_mode,
        padding_mode,
        align_corners: -1,
        torch.grid_sampler_3d: lambda input,
        grid,
        interpolation_mode,
        padding_mode,
        align_corners: -1,
        torch.group_norm: lambda input,
        num_groups,
        weight=None,
        bias=None,
        eps=1e-05,
        cudnn_enabled=True: -1,
        torch.gru: lambda input,
        hx,
        params,
        has_biases,
        num_layers,
        ...
        torch.hinge_embedding_loss: lambda input,
        target,
        margin=1.0,
        size_average=None,
        reduce=None,
        reduction="mean": -1,  # noqa: B950
        torch.histc: lambda input, bins=100, min=0, max=0, out=None: -1,
        torch.histogram: lambda input,
        bins=100,
        min=None,
        max=None,
        weight=None,
        density=False,
        out=None: -1,
        torch.histogramdd: lambda input,
        bins,
        range=None,
        weight=None,
        density=False: -1,
        ...
        torch.index_reduce: lambda input,
        dim,
        index,
        source,
        reduce,
        include_input=True: -1,
        ...
        torch.istft: (
            ...
            onesided=None,
            length=None,
            return_complex=False: -1  # noqa: B950
        ),
        torch.kl_div: lambda input,
        target,
        size_average=None,
        reduce=None,
        reduction="mean",
        ...
        torch.linalg.ldl_factor_ex: lambda input,
        hermitian=False,
        check_errors=False,
        out=None: -1,
        ...
        ortho_iparams=None,
        ortho_fparams=None,
        ortho_bparams=None: -1,  # noqa: B950
        ...
        torch.margin_ranking_loss: lambda input1,
        input2,
        target,
        margin=0,
        size_average=None,
        reduce=None,
        reduction="mean": -1,  # type: ignore[attr-defined]  # noqa: B950
        ...
        torch.linalg.lu_factor_ex: lambda input,
        pivot=True,
        check_errors=False,
        out=None: -1,
        torch.linalg.lu_solve: lambda LU,
        pivots,
        B,
        left=True,
        adjoint=False,
        out=None: -1,
        torch.linalg.matmul: lambda input,
        other,
        out=None: -1,  # alias for torch.matmul
        ...
        torch.max_pool1d: lambda input,
        kernel_size,
        stride=None,
        padding=0,
        dilation=1,
        ceil_mode=False: -1,
        torch.max_pool2d: lambda input,
        kernel_size,
        stride=None,
        padding=0,
        dilation=1,
        ceil_mode=False: -1,
        torch.max_pool3d: lambda input,
        kernel_size,
        stride=None,
        padding=0,
        dilation=1,
        ...
        torch.miopen_convolution: lambda input,
        weight,
        bias,
        padding,
        stride,
        ...
        groups,
        benchmark,
        deterministic: -1,  # noqa: B950
        torch.miopen_convolution_add_relu: lambda input,
        weight,
        z,
        alpha,
        bias,
        ...
        dilation,
        groups: -1,
        torch.miopen_convolution_relu: lambda input,
        weight,
        bias,
        stride,
        padding,
        ...
        torch.native_batch_norm: lambda input,
        weight,
        bias,
        running_mean,
        running_var,
        ...
        momentum,
        eps: -1,
        torch._native_batch_norm_legit: lambda input,
        weight,
        bias,
        training,
        momentum,
        ...
        torch.native_layer_norm: lambda input,
        normalized_shape,
        weight=None,
        bias=None,
        eps=1e-05: -1,
        ...
        torch.nn.functional.adaptive_max_pool1d: lambda input,
        output_size,
        return_indices=False: -1,
        torch.nn.functional.adaptive_max_pool1d_with_indices: lambda input,
        output_size,
        return_indices=False: -1,
        torch.nn.functional.adaptive_max_pool2d: lambda input,
        output_size,
        return_indices=False: -1,
        torch.nn.functional.adaptive_max_pool2d_with_indices: lambda input,
        output_size,
        return_indices=False: -1,
        torch.nn.functional.adaptive_max_pool3d: lambda input,
        output_size,
        return_indices=False: -1,
        torch.nn.functional.adaptive_max_pool3d_with_indices: lambda input,
        output_size,
        return_indices=False: -1,
        torch.nn.functional.affine_grid: lambda theta, size, align_corners=None: -1,
        torch.nn.functional.alpha_dropout: lambda input,
        p=0.5,
        training=False,
        inplace=False: -1,
        torch.nn.functional.avg_pool2d: (
            ...
            divisor_override=None: -1  # noqa: B950
        ),
        ...
        torch.nn.functional.cross_entropy: (
            ...
            reduce=None,
            reduction="mean",
            label_smoothing=0.0: -1  # noqa: B950
        ),
        ...
        torch.nn.functional.dropout: lambda input,
        p=0.5,
        training=True,
        inplace=False: -1,
        torch.nn.functional.dropout1d: lambda input,
        p=0.5,
        training=True,
        inplace=False: -1,
        torch.nn.functional.dropout2d: lambda input,
        p=0.5,
        training=True,
        inplace=False: -1,
        torch.nn.functional.dropout3d: lambda input,
        p=0.5,
        training=True,
        inplace=False: -1,
        ...
        torch.nn.functional.feature_alpha_dropout: lambda input,
        p=0.5,
        training=False,
        inplace=False: -1,
        torch.nn.functional.fold: lambda input,
        output_size,
        kernel_size,
        dilation=1,
        padding=0,
        ...
        torch.nn.functional.fractional_max_pool2d: (
            ...
            output_ratio=None,
            return_indices=False,
            _random_samples=None: -1  # noqa: B950
        ),
        ...
        torch.nn.functional.gaussian_nll_loss: lambda input,
        target,
        var,
        full=False,
        eps=1e-06,
        ...
        torch.nn.functional.grid_sample: lambda input,
        grid,
        mode="bilinear",
        padding_mode="zeros",
        align_corners=None: -1,  # noqa: B950
        torch.nn.functional.group_norm: lambda input,
        num_groups,
        weight=None,
        bias=None,
        eps=1e-05: -1,
        ...
        torch.nn.functional.hardtanh: lambda input,
        min_val=-1.0,
        max_val=1.0,
        inplace=False: -1,
        ...
        torch.nn.functional.interpolate: (
            ...
            antialias=False: -1  # noqa: B950
        ),
        torch.nn.functional.kl_div: lambda input,
        target,
        size_average=None,
        reduce=None,
        reduction="mean",
        log_target=False: -1,  # noqa: B950
        torch.nn.functional.l1_loss: lambda input,
        target,
        size_average=None,
        reduce=None,
        reduction="mean": -1,
        torch.nn.functional.layer_norm: lambda input,
        normalized_shape,
        weight=None,
        bias=None,
        eps=1e-05: -1,
        torch.nn.functional.leaky_relu: lambda input,
        negative_slope=0.01,
        inplace=False: -1,
        torch.nn.functional.linear: lambda input, weight, bias=None: -1,
        torch.nn.functional.local_response_norm: lambda input,
        size,
        alpha=0.0001,
        beta=0.75,
        k=1.0: -1,
        torch.nn.functional.log_softmax: lambda input,
        dim=None,
        _stacklevel=3,
        dtype=None: -1,
        torch.nn.functional.logsigmoid: lambda input: -1,
        torch.nn.functional.lp_pool1d: lambda input,
        norm_type,
        kernel_size,
        stride=None,
        ceil_mode=False: -1,
        torch.nn.functional.lp_pool2d: lambda input,
        norm_type,
        kernel_size,
        stride=None,
        ceil_mode=False: -1,
        torch.nn.functional.lp_pool3d: lambda input,
        norm_type,
        kernel_size,
        stride=None,
        ceil_mode=False: -1,
        ...
        torch.nn.functional.max_unpool1d: lambda input,
        indices,
        kernel_size,
        stride=None,
        padding=0,
        output_size=None: -1,  # noqa: B950
        torch.nn.functional.max_unpool2d: lambda input,
        indices,
        kernel_size,
        stride=None,
        padding=0,
        output_size=None: -1,  # noqa: B950
        torch.nn.functional.max_unpool3d: lambda input,
        indices,
        kernel_size,
        stride=None,
        padding=0,
        output_size=None: -1,  # noqa: B950
        torch.nn.functional.mse_loss: lambda input,
        target,
        size_average=None,
        reduce=None,
        reduction="mean": -1,
        ...
        torch.nn.functional.normalize: lambda input,
        p=2,
        dim=1,
        eps=1e-12,
        out=None: -1,
        ...
        torch.nn.functional.pairwise_distance: lambda x1,
        x2,
        p=2.0,
        eps=1e-06,
        keepdim=False: -1,
        ...
        torch.nn.functional.rms_norm: lambda input,
        normalized_shape,
        weight=None,
        eps=1e-6: -1,
        torch.nn.functional.rrelu: lambda input,
        lower=0.125,
        upper=0.3333333333333333,
        training=False,
        inplace=False: -1,  # noqa: B950
        torch.nn.functional.selu: lambda input, inplace=False: -1,
        torch.nn.functional.silu: lambda input, inplace=False: -1,
        torch.nn.functional.mish: lambda input, inplace=False: -1,
        torch.nn.functional.scaled_dot_product_attention: lambda query,
        key,
        value,
        attn_mask=None,
        dropout_p=0.0: -1,
        torch.nn.functional.smooth_l1_loss: lambda input,
        target,
        size_average=None,
        reduce=None,
        reduction="mean",
        beta=1.0: -1,  # noqa: B950
        torch.nn.functional.huber_loss: lambda input,
        target,
        reduction="mean",
        delta=1.0: -1,
        torch.nn.functional.soft_margin_loss: lambda input,
        target,
        size_average=None,
        reduce=None,
        reduction="mean": -1,  # noqa: B950
        torch.nn.functional.softmax: lambda input,
        dim=None,
        _stacklevel=3,
        dtype=None: -1,
        torch.nn.functional.softmin: lambda input,
        dim=None,
        _stacklevel=3,
        dtype=None: -1,
        ...
        torch.nn.functional.threshold: lambda input,
        threshold,
        value,
        inplace=False: -1,
        ...
        torch.nn.functional.unfold: lambda input,
        kernel_size,
        dilation=1,
        padding=0,
        stride=1: -1,
        ...
        torch.nn.init.kaiming_uniform_: lambda tensor,
        a=0,
        mode="fan_in",
        nonlinearity="leaky_relu",
        generator=None: -1,  # noqa: B950
        torch.nonzero: lambda input, as_tuple=False: -1,
        torch.nonzero_static: lambda input, *, size, fill_value=-1: -1,
        torch.argwhere: lambda input: -1,
        torch.norm: lambda input,
        p="fro",
        dim=None,
        keepdim=False,
        out=None,
        dtype=None: -1,
        torch.linalg.norm: lambda input,
        ord=None,
        dim=None,
        keepdim=False,
        out=None,
        dtype=None: -1,
        torch.linalg.vector_norm: lambda input,
        ord=2,
        dim=None,
        keepdim=False,
        out=None,
        dtype=None: -1,
        torch.linalg.matrix_norm: lambda input,
        ord="fro",
        dim=(
            -2,
            -1,
        ...
        torch.nuclear_norm: lambda input,
        p="fro",
        dim=None,
        keepdim=False,
        out=None,
        ...
        torch.poisson_nll_loss: lambda input,
        target,
        log_input,
        full,
        eps,
        ...
        torch.quantile: lambda input,
        q,
        dim=None,
        keepdim=False,
        interpolation="linear",
        out=None: -1,
        torch.nanquantile: lambda input,
        q,
        dim=None,
        keepdim=False,
        interpolation="linear",
        ...
        torch.quantized_batch_norm: lambda input,
        weight,
        bias,
        mean,
        var,
        ...
        torch.rand_like: lambda input,
        dtype=None,
        layout=None,
        device=None,
        requires_grad=False: -1,
        torch.randint_like: lambda input,
        high,
        dtype=None,
        layout=torch.strided,
        device=None,
        requires_grad=False: -1,
        torch.randn_like: lambda input,
        dtype=None,
        layout=None,
        device=None,
        requires_grad=False: -1,
        ...
        torch.scatter_reduce: lambda input,
        dim,
        index,
        src,
        reduce,
        include_self=True: -1,
        torch.searchsorted: lambda sorted_sequence,
        input,
        out_int32=False,
        right=False,
        out=None: -1,
        torch._segment_reduce: lambda data,
        reduce="max",
        lengths=None,
        indices=None,
        offsets=None,
        axis=0,
        unsafe=False: -1,  # noqa: B950
        ...
        *,
        ...
        torch.stft: (
            ...
            normalized=False,
            onesided=True,
            return_complex=None: -1  # noqa: B950
        ),
        ...
        torch.triangular_solve: lambda input,
        A,
        upper=True,
        transpose=False,
        unitriangular=False: -1,
        torch.linalg.solve_triangular: lambda input,
        B,
        upper,
        left=True,
        unitriangular=False: -1,
        ...
        torch.unique: lambda input,
        sorted=True,
        return_inverse=False,
        return_counts=False,
        dim=None: -1,
        torch.unique_consecutive: lambda input,
        return_inverse=False,
        return_counts=False,
        dim=None: -1,
        ...
        Tensor._autocast_to_reduced_precision: lambda self,
        cuda_enabled,
        cpu_enabled,
        cuda_dtype,
        cpu_dtype: -1,
