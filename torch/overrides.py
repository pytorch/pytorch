...
def get_testing_overrides() -> Dict[Callable, Callable]:
    ...
    ret: Dict[Callable, Callable] = {
        ...
        torch.slice_strict_inverse: lambda input, src, dim=0, start=None, end=None, step=1: -1,
        torch.slice_strict_scatter: lambda input, src, dim=0, start=None, end=None, step=1: -1,
        ...
        torch.slice_strict: lambda self, dim=0, start=None, end=None, step=1: -1,
        torch.slice_copy: lambda self, dim=0, start=None, end=None, step=1: -1,
        torch.slice_strict_copy: lambda self, dim=0, start=None, end=None, step=1: -1,
        ...
        torch.slice_strict_scatter: lambda self, src, dim=0, start=None, end=None, step=1: -1,
