...
std::vector<std::shared_ptr<NCCLComm>>& ProcessGroupNCCL::getNCCLComm(
  ...
  // Note: these events are created with the (default) cudaEventDisableTiming flag
  // This flag provides the best performance when used with cudaStreamWaitEvent() 
  // and cudaEventQuery(). Since we here don't measure the performance using 
  // cudaEvent, this should be set.
  ncclEvents_.emplace(
