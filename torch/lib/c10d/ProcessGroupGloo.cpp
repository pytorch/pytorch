...
class AsyncBroadcastWork : public ProcessGroupGloo::AsyncWork {
 public:
  AsyncBroadcastWork(
      ...
      int rootTensor,
      uint32_t tag)
      : ProcessGroupGloo::AsyncWork("broadcast"),
        context(context),
        inputs(inputs),
        rootRank(rootRank),
...
class AsyncAllreduceWork : public ProcessGroupGloo::AsyncWork {
 public:
  AsyncAllreduceWork(
      ...
      ReduceOp reduceOp,
      uint32_t tag)
      : ProcessGroupGloo::AsyncWork("all_reduce"),
...
class AsyncReduceWork : public ProcessGroupGloo::AsyncWork {
 public:
  AsyncReduceWork(
      ...
      ReduceOp reduceOp,
      uint32_t tag)
      : ProcessGroupGloo::AsyncWork("reduce"),
        context(context),
        inputs(inputs),
        rootRank(rootRank),
        rootTensor(rootTensor),
...
class AsyncAllgatherWork : public ProcessGroupGloo::AsyncWork {
 public:
  AsyncAllgatherWork(
      ...
      std::vector<at::Tensor>& inputs,
      uint32_t tag)
      : ProcessGroupGloo::AsyncWork("all_gather"),
...
class AsyncGatherWork : public ProcessGroupGloo::AsyncWork {
 public:
  AsyncGatherWork(
      ...
      int root,
      uint32_t tag)
      : ProcessGroupGloo::AsyncWork("gather"),
        context(context),
        outputs(outputs),
        inputs(inputs),
        root(root),
...
class AsyncScatterWork : public ProcessGroupGloo::AsyncWork {
 public:
  AsyncScatterWork(
      ...
      int root,
      uint32_t tag)
      : ProcessGroupGloo::AsyncWork("scatter"),
        context(context),
        outputs(outputs),
        inputs(inputs),
        root(root),
...
class AsyncAlltoallWork : public ProcessGroupGloo::AsyncWork {
 public:
  AsyncAlltoallWork(
      ...
      uint32_t tag)
      : ProcessGroupGloo::AsyncWork("all_to_all"),
        context(context),
...
class AsyncBarrierWork : public ProcessGroupGloo::AsyncWork {
 public:
  AsyncBarrierWork(
      ...
      uint32_t tag)
      : ProcessGroupGloo::AsyncWork("barrier"),
