...
TH_API long THSTensor_(numelV)(const THSTensor *self);
TH_API long THSTensor_(numelI)(const THSTensor *self);
TH_API ptrdiff_t THSTensor_(nnz)(const THSTensor *self);
TH_API THLongStorage *THSTensor_(newSizeOf)(const THSTensor *self);
