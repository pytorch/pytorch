...
# CuTeDSL pretty-printing can throw on ScaledBasis while naming a compile, and
# the mangled name is not needed here. Still required for the CuTeDSL versions
# in _CUTEDSL_REQUIRED_VERSIONS, though not for 4.7.
