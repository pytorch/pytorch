...
def set_logs(
    *,
    ...
    Keyword args:
        ...
        graph_source (:class:`bool`):
            Whether to emit the original source code corresponding to the graph captured by TorchDynamo. Default: ``False``

        starts_line (:class:`bool`):
