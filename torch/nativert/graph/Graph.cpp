      ...
      [](auto&& arg) -> c10::IValue {
        ...
        if constexpr (is_same_v<T, None>) {
          return c10::IValue();
            ...
            is_same_v<T, int64_t> || is_same_v<T, vector<int64_t>> ||
            is_same_v<T, double> || is_same_v<T, vector<double>> ||
            is_same_v<T, string> || is_same_v<T, bool> ||
            is_same_v<T, vector<bool>> || is_same_v<T, c10::ScalarType> ||
            is_same_v<T, c10::MemoryFormat> || is_same_v<T, c10::Layout> ||
            is_same_v<T, c10::Device> || is_same_v<T, vector<string>>) {
          return arg;
