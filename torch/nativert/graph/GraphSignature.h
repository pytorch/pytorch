...
class GraphSignature {
 ...
 private:
  ...
  c10::FastMap<std::string, std::string> inputsToParameters_;
  c10::FastMap<std::string, std::string> inputsToBuffers_;
  c10::FastMap<std::string, std::string> inputsToTensorConstants_;
  c10::FastMap<std::string, std::string> inputsToCustomObjs_;
  ...
  // an iomportant assumption in nativert for weight loading and
