...
class BenchmarkRequest:
    ...
    def benchmark(
        ...
        *input_tensors: torch.Tensor,
        ...
        if debug:
            create_tensor_elapse = time.time() - start_ts  # type: ignore[possibly-undefined]  # TODO: audit
            start_ts = time.time()

        fn = self.make_run_fn(*input_tensors, output_tensor=output_tensor)

        if debug:
            load_elapse = time.time() - start_ts  # type: ignore[possibly-undefined]  # TODO: audit
            start_ts = time.time()
        ...
        if debug:
            bench_elapse = time.time() - start_ts  # type: ignore[possibly-undefined]  # TODO: audit
            log.debug(
                "InChildProcess %s: load %f, create tensor %f, bench %f",
                str(self),
                load_elapse,  # type: ignore[possibly-undefined]  # TODO: audit
                create_tensor_elapse,  # type: ignore[possibly-undefined]  # TODO: audit
                bench_elapse,
            )
        self.cleanup_run_fn()
        return out
