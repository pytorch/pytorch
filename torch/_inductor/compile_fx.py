...
def compile_fx(
    ...
    if V.aot_compilation is True:
        ...
        with V.set_fake_mode(fake_mode), compiled_autograd.disable_compiler(), context():
            return inference_compiler(unlifted_gm, example_inputs_)

    with V.set_fake_mode(fake_mode), torch._guards.tracing(
        tracing_context
    ), compiled_autograd.disable_compiler(), functorch_config.patch(unlift_effect_tokens=True):
        return aot_autograd(
