...
def estimate_nccl_collective_runtime(snode: "BaseSchedulerNode") -> float:
    ...
    ratio = (1.0 * nRanks) / nsteps  # type: ignore[possibly-undefined]  # TODO: audit
    ...
    latency += (nsteps - nInterSteps) * intraLat + nInterSteps * interLat  # type: ignore[possibly-undefined]  # TODO: audit
    # Convert us to ns
