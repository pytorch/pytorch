...
def scaled_mm_v2_constraint(
    ...
    for side in ("a", "b"):
        ...
        constrained_scales = []
        for scale, recipe in zip(scales, recipes, strict=True):
            ...
            if (
                ...
                # Native v2 DeepSeek scales are column-major on both sides;
                # padding for 128x128 is part of the scale's first dimension.
