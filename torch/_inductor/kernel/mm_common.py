...
def scale_mm_epilogue(
    *,
    ...
    Args:
        ...
        apply_scale_result: Whether the epilogue multiplies by scale_result.
    ...
    def epilogue(acc, inv_a_scale, inv_b_scale, *optional_args):
        ...
        if apply_scale_result:
            if scale_result is None:
                raise AssertionError("scale_result is required when it is applied")
            mul_acc = V.ops.mul(mul_acc, scale_result)
        return mul_acc
