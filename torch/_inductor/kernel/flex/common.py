...
def set_head_dim_values(kernel_options: dict, qk_head_dim, v_head_dim, graph_sizevars):
    """
    ...
    kernel_options.setdefault(
        "QK_HEAD_DIM_ROUNDED", next_power_of_2(qk_head_dim_static)
    )

    # V dimensions
    v_head_dim_static = graph_sizevars.guard_int(v_head_dim)
    kernel_options.setdefault("V_HEAD_DIM", v_head_dim_static)
    kernel_options.setdefault("V_HEAD_DIM_ROUNDED", next_power_of_2(v_head_dim_static))
...
# Triton code snippets for forward computation
