...
class PostGradBatchLinearFusion(BatchFusion):
    ...
    def fuse(self, graph: torch.fx.GraphModule, subset: List[torch.fx.Node]):
        ...
        for node in subset:
            ...
            batch_inputs.append(input)  # type: ignore[possibly-undefined]  # TODO: audit
            batch_weights.append(weight)  # type: ignore[possibly-undefined]  # TODO: audit
            batch_biases.append(bias)  # type: ignore[possibly-undefined]  # TODO: audit
        ...
        for i, original_mm in enumerate(batch_nodes):
            ...
            new_mm_cont = new_bias_add if has_bias else new_mm  # type: ignore[possibly-undefined]  # TODO: audit
