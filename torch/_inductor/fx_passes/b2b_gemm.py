...
def tuned_b2b_gemm(
    ...
    *,
    ...
    placeholder = create_placeholder("inner_mm", A.get_dtype(), A.get_device_or_error())
    assert isinstance(placeholder, TensorBox)
    subgraph_buffer = build_subgraph_buffer([placeholder], subgraph)
