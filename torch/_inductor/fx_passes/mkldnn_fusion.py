...
if torch._C._has_mkldnn:
    ...
    def _is_packable_linear(match):
        ...
        bf32_tf32_matmul_enabled = torch.backends.mkldnn.matmul.fp32_precision in ["bf16", "tf32"]  # type: ignore[attr-defined]
        use_bf16_tf32_for_fp32_weight = (
            bf32_tf32_matmul_enabled and weight_meta_value.dtype == torch.float32
        )
        compute_with_lp = is_lp_weight or use_bf16_tf32_for_fp32_weight
