    ...
    def qconv_weight_prepack(match: Match, *args, **kwargs):
        ...
        with graph.inserting_before(conv_node):
            ...
            if dtype == torch.bfloat16:
                graph.erase_node(convert_to_bf16)  # type: ignore[possibly-undefined]  # TODO: audit
            # Erase the dequant pattern
            ...
            if dtype == torch.bfloat16:
                graph.erase_node(weight_to_bf16_node)  # type: ignore[possibly-undefined]  # TODO: audit
        ...
        with graph.inserting_before(linear_node):
            ...
            if input_dim_exceeds_two:
                if input_contiguous:
                    ...
                    graph.erase_node(output_add_node_for_bias)  # type: ignore[possibly-undefined]  # TODO: audit
            ...
            if input_dim_exceeds_two:
                if input_contiguous:
                    ...
                    graph.erase_node(wgt_expand_node)  # type: ignore[possibly-undefined]  # TODO: audit
            if dtype == torch.bfloat16:
