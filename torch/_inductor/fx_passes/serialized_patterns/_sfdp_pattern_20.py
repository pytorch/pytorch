...
quantized_decomposed_dequantize_per_tensor_default = CallFunction(quantized_decomposed.dequantize_per_tensor.default, permute_default, Ignored(), Ignored(), Ignored(), Ignored(), Ignored())
...
quantized_decomposed_dequantize_per_tensor_default_1 = CallFunction(quantized_decomposed.dequantize_per_tensor.default, permute_default_2, Ignored(), Ignored(), Ignored(), Ignored(), Ignored())
...
quantized_decomposed_quantize_per_tensor_default = CallFunction(quantized_decomposed.quantize_per_tensor.default, div_Tensor_1, Ignored(), Ignored(), Ignored(), Ignored(), Ignored())
quantized_decomposed_dequantize_per_tensor_default_2 = CallFunction(quantized_decomposed.dequantize_per_tensor.default, quantized_decomposed_quantize_per_tensor_default, Ignored(), Ignored(), Ignored(), Ignored(), Ignored())
...
quantized_decomposed_dequantize_per_tensor_default_3 = CallFunction(quantized_decomposed.dequantize_per_tensor.default, permute_default_3, Ignored(), Ignored(), Ignored(), Ignored(), Ignored())
...
_sfdp_pattern_20_u8_inference = CallFunction(quantized_decomposed.quantize_per_tensor.default, clone_default_3, Ignored(), Ignored(), Ignored(), Ignored(), Ignored(), _users=0)
