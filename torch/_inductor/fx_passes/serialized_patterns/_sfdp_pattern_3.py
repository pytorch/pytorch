...
rand_default = CallFunction(aten.rand.default, Ignored(), dtype=Ignored(), layout=torch.strided, device=Ignored(), pin_memory=False)
permute_default = CallFunction(aten.permute.default, rand_default, Ignored())
clone_default = CallFunction(aten.clone.default, permute_default)
gt_Scalar = CallFunction(aten.gt.Scalar, clone_default, KeywordArg('dropout_p'), _users=2)
...
expand_default_1 = CallFunction(aten.expand.default, permute_default_1, Ignored())
...
permute_default_2 = CallFunction(aten.permute.default, view_default_4, Ignored())
bmm_default_2 = CallFunction(aten.bmm.default, view_default_6, permute_default_2)
...
clone_default_1 = CallFunction(aten.clone.default, mul_Tensor_3, memory_format=torch.contiguous_format)
...
mul_Tensor_4 = CallFunction(aten.mul.Tensor, clone_default_1, alias_default_1, _users=2)
...
permute_default_3 = CallFunction(aten.permute.default, view_default_1, Ignored())
bmm_default_3 = CallFunction(aten.bmm.default, view_default_8, permute_default_3)
view_default_9 = CallFunction(aten.view.default, bmm_default_3, Ignored())
permute_default_4 = CallFunction(aten.permute.default, view_default, Ignored())
bmm_default_4 = CallFunction(aten.bmm.default, permute_default_4, view_default_8)
view_default_10 = CallFunction(aten.view.default, bmm_default_4, Ignored())
permute_default_5 = CallFunction(aten.permute.default, view_default_10, Ignored())
permute_default_6 = CallFunction(aten.permute.default, view_default_3, Ignored())
bmm_default_5 = CallFunction(aten.bmm.default, permute_default_6, view_default_6)
...
mul_Tensor_3 = CallFunction(aten.mul.Tensor, view_default_7, mul_Tensor_2)
clone_default_1 = CallFunction(aten.clone.default, mul_Tensor_3, memory_format=torch.contiguous_format)
convert_element_type_default_3 = CallFunction(prims.convert_element_type.default, clone_default_1, Ignored())
