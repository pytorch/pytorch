...
permute_default_1 = CallFunction(aten.permute.default, view_default_4, CanonicalDims([0, 2, 1], 3))
...
permute_default_2 = CallFunction(aten.permute.default, view_default_1, CanonicalDims([0, 2, 1], 3))
bmm_default_3 = CallFunction(aten.bmm.default, view_default_8, permute_default_2)
view_default_9 = CallFunction(aten.view.default, bmm_default_3, Ignored())
permute_default_3 = CallFunction(aten.permute.default, view_default, CanonicalDims([0, 2, 1], 3))
bmm_default_4 = CallFunction(aten.bmm.default, permute_default_3, view_default_8)
view_default_10 = CallFunction(aten.view.default, bmm_default_4, Ignored())
permute_default_4 = CallFunction(aten.permute.default, view_default_10, CanonicalDims([0, 1, 3, 2], 4))
permute_default_5 = CallFunction(aten.permute.default, view_default_3, CanonicalDims([0, 2, 1], 3))
