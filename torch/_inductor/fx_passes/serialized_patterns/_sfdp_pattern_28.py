...
amax_default = CallFunction(aten.amax.default, mul_Tensor, CanonicalDims([3], 4), True)
...
sum_dim_IntList_1 = CallFunction(aten.sum.dim_IntList, mul_Tensor_5, CanonicalDims([3], 4), True)
