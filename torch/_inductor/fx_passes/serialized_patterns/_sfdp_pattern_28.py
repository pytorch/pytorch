...
mul_Tensor = CallFunction([aten.mul.Tensor, aten.mul.Scalar], view_default_2, KeywordArg('scale_factor'), _users=2)
...
mul_Tensor_6 = CallFunction([aten.mul.Tensor, aten.mul.Scalar], fma_default, KeywordArg('scale_factor'))
...
bmm_default = CallFunction(aten.bmm.default, view_default, view_default_1)
view_default_2 = CallFunction(aten.view.default, bmm_default, Ignored())
mul_Tensor = CallFunction([aten.mul.Tensor, aten.mul.Scalar], view_default_2, KeywordArg('scale_factor'))
...
mul_Tensor_6 = CallFunction([aten.mul.Tensor, aten.mul.Scalar], convert_element_type_default_5, KeywordArg('scale_factor'))
view_default_8 = CallFunction(aten.view.default, mul_Tensor_6, Ignored(), _users=2)
permute_default_2 = CallFunction(aten.permute.default, view_default_1, Ignored())
bmm_default_3 = CallFunction(aten.bmm.default, view_default_8, permute_default_2)
view_default_9 = CallFunction(aten.view.default, bmm_default_3, Ignored())
