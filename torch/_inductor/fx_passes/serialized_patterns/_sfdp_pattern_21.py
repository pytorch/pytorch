...
permute_default = CallFunction(aten.permute.default, KeywordArg('query'), CanonicalDims([0, 2, 1, 3], 4))
...
permute_default_1 = CallFunction(aten.permute.default, KeywordArg('key'), CanonicalDims([0, 2, 1, 3], 4))
permute_default_2 = CallFunction(aten.permute.default, permute_default_1, CanonicalDims([0, 1, 3, 2], 4))
...
amax_default = CallFunction(aten.amax.default, add_Tensor, CanonicalDims([3], 4), True)
sub_Tensor = CallFunction(aten.sub.Tensor, add_Tensor, amax_default)
exp_default = CallFunction(aten.exp.default, sub_Tensor, _users=2)
sum_dim_IntList = CallFunction(aten.sum.dim_IntList, exp_default, CanonicalDims([3], 4), True)
...
permute_default_3 = CallFunction(aten.permute.default, KeywordArg('value'), CanonicalDims([0, 2, 1, 3], 4))
...
amax_default = CallFunction(aten.amax.default, convert_element_type_default_1, CanonicalDims([3], 4), True)
