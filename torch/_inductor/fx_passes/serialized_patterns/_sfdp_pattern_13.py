...
_sfdp_pattern_13_inference = CallFunction(aten.bmm.default, div_Tensor, KeywordArg('value'))
...
_sfdp_pattern_13_inference_half = CallFunction(aten.bmm.default, convert_element_type_default_1, KeywordArg('value'))
