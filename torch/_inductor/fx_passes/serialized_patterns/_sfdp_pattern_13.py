...
bmm_default = CallFunction(aten.bmm.default, KeywordArg('query'), permute_default_1, _users=2)
...
bmm_default_2 = CallFunction(aten.bmm.default, KeywordArg('tangents_1'), permute_default_2)
...
permute_default_3 = CallFunction(aten.permute.default, permute_default_1, Ignored())
bmm_default_3 = CallFunction(aten.bmm.default, sub_Tensor_1, permute_default_3)
permute_default_4 = CallFunction(aten.permute.default, KeywordArg('query'), Ignored())
bmm_default_4 = CallFunction(aten.bmm.default, permute_default_4, sub_Tensor_1)
permute_default_5 = CallFunction(aten.permute.default, bmm_default_4, Ignored())
permute_default_6 = CallFunction(aten.permute.default, mul_Tensor_1, Ignored())
bmm_default_5 = CallFunction(aten.bmm.default, permute_default_6, KeywordArg('tangents_1'))
...
gt_Scalar = CallFunction(aten.gt.Scalar, clone_default, KeywordArg('dropout_p'), _users=2)
permute_default_1 = CallFunction(aten.permute.default, KeywordArg('key'), Ignored(), _users=2)
bmm_default = CallFunction(aten.bmm.default, KeywordArg('query'), permute_default_1)
...
permute_default_3 = CallFunction(aten.permute.default, permute_default_1, Ignored())
bmm_default_3 = CallFunction(aten.bmm.default, convert_element_type_default_5, permute_default_3)
permute_default_4 = CallFunction(aten.permute.default, KeywordArg('query'), Ignored())
bmm_default_4 = CallFunction(aten.bmm.default, permute_default_4, convert_element_type_default_5)
permute_default_5 = CallFunction(aten.permute.default, bmm_default_4, Ignored())
permute_default_6 = CallFunction(aten.permute.default, mul_Tensor_1, Ignored())
bmm_default_5 = CallFunction(aten.bmm.default, permute_default_6, KeywordArg('tangents_1'))
