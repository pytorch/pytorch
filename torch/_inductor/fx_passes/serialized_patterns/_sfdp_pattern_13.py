...
permute_default = CallFunction(aten.permute.default, KeywordArg('key'), CanonicalDims([0, 2, 1], 3))
bmm_default = CallFunction(aten.bmm.default, KeywordArg('query'), permute_default, _users=2)
amax_default = CallFunction(aten.amax.default, bmm_default, CanonicalDims([2], 3), True)
...
amax_default = CallFunction(aten.amax.default, convert_element_type_default, CanonicalDims([2], 3), True)
