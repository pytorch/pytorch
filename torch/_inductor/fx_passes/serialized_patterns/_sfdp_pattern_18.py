...
amax_default = CallFunction(aten.amax.default, where_self, CanonicalDims([3], 4), True)
...
amax_default = CallFunction(aten.amax.default, convert_element_type_default, CanonicalDims([3], 4), True)
