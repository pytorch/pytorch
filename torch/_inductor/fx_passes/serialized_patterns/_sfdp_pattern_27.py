...
amax_default = CallFunction(aten.amax.default, view_default_2, CanonicalDims([3], 4), True)
...
sum_dim_IntList_1 = CallFunction(aten.sum.dim_IntList, mul_Tensor_4, CanonicalDims([3], 4), True)
