...
div_Tensor = CallFunction([aten.div.Tensor, aten.div.Scalar], permute_default, KeywordArg('inv_scale'))
...
div_Tensor_2 = CallFunction([aten.div.Tensor, aten.div.Scalar], view_default_9, KeywordArg('inv_scale'))
