...
div_Scalar = CallFunction(aten.div.Scalar, permute_default, Ignored())
expand_default = CallFunction(aten.expand.default, div_Scalar, Ignored())
...
div_Scalar_1 = CallFunction(aten.div.Scalar, view_default_9, Ignored())
permute_default_6 = CallFunction(aten.permute.default, div_Scalar_1, Ignored())
