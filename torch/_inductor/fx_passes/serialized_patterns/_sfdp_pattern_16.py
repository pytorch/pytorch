...
mul_Scalar_1 = CallFunction(aten.mul.Scalar, convert_element_type_default_2, Ignored())
mul_Tensor_1 = CallFunction(aten.mul.Tensor, convert_element_type_default_1, mul_Scalar_1)
clone_default_3 = CallFunction(aten.clone.default, mul_Tensor_1, memory_format=torch.contiguous_format)
mul_Tensor_2 = CallFunction(aten.mul.Tensor, clone_default_3, alias_default_3, _users=2)
sum_dim_IntList_1 = CallFunction(aten.sum.dim_IntList, mul_Tensor_2, Ignored(), True)
fma_default = CallFunction(prims.fma.default, neg_default, sum_dim_IntList_1, mul_Tensor_2)
