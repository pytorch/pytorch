...
mul_Scalar = CallFunction(aten.mul.Scalar, mul_Tensor, Ignored())
expand_default_3 = CallFunction(aten.expand.default, mul_Scalar, Ignored())
...
mul_Tensor_1 = CallFunction(aten.mul.Tensor, view_default_7, mul_Scalar_1)
clone_default_3 = CallFunction(aten.clone.default, mul_Tensor_1, memory_format=torch.contiguous_format)
mul_Tensor_2 = CallFunction(aten.mul.Tensor, clone_default_3, alias_default_3, _users=2)
