...
clone_default_1 = CallFunction(aten.clone.default, mul_Tensor_4, memory_format=torch.contiguous_format)
...
mul_Tensor_5 = CallFunction(aten.mul.Tensor, clone_default_1, alias_default_1, _users=2)
