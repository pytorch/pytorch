...
mul_Scalar = CallFunction(aten.mul.Scalar, mul_Tensor_1, Ignored())
...
mul_Tensor_2 = CallFunction(aten.mul.Tensor, view_default_7, mul_Scalar_1)
clone_default = CallFunction(aten.clone.default, mul_Tensor_2, memory_format=torch.contiguous_format)
mul_Tensor_3 = CallFunction(aten.mul.Tensor, clone_default, alias_default_3, _users=2)
sum_dim_IntList_1 = CallFunction(aten.sum.dim_IntList, mul_Tensor_3, Ignored(), True)
fma_default = CallFunction(prims.fma.default, neg_default, sum_dim_IntList_1, mul_Tensor_3)
mul_Tensor_4 = CallFunction(aten.mul.Tensor, fma_default, KeywordArg('scale_factor'))
view_default_8 = CallFunction(aten.view.default, mul_Tensor_4, Ignored(), _users=2)
...
mul_Tensor_3 = CallFunction(aten.mul.Tensor, convert_element_type_default_4, convert_element_type_default_2, _users=2)
sum_dim_IntList_1 = CallFunction(aten.sum.dim_IntList, mul_Tensor_3, Ignored(), True)
fma_default = CallFunction(prims.fma.default, neg_default, sum_dim_IntList_1, mul_Tensor_3)
convert_element_type_default_5 = CallFunction(prims.convert_element_type.default, fma_default, Ignored())
mul_Tensor_4 = CallFunction(aten.mul.Tensor, convert_element_type_default_5, KeywordArg('scale_factor'))
view_default_8 = CallFunction(aten.view.default, mul_Tensor_4, Ignored(), _users=2)
permute_default_2 = CallFunction(aten.permute.default, view_default_1, Ignored())
bmm_default_3 = CallFunction(aten.bmm.default, view_default_8, permute_default_2)
view_default_9 = CallFunction(aten.view.default, bmm_default_3, Ignored())
