...
_sfdp_pattern_18_with_attn_mask_training = MultiOutputPattern([view_default_5,
  permute_default_1,
  permute_default_3,
  permute_default_6,
  permute_default_9,
...
div_Tensor = CallFunction(aten.div.Tensor, view_default_2, KeywordArg('inv_scale'))
where_self = CallFunction(aten.where.self, KeywordArg('causal_mask'), div_Tensor, KeywordArg('causal_mask_value'))
add__Tensor = CallFunction(aten.add_.Tensor, where_self, KeywordArg('attn_mask'), _users=2)
amax_default = CallFunction(aten.amax.default, add__Tensor, Ignored(), True)
sub_Tensor = CallFunction(aten.sub.Tensor, add__Tensor, amax_default)
exp_default = CallFunction(aten.exp.default, sub_Tensor, _users=2)
sum_dim_IntList = CallFunction(aten.sum.dim_IntList, exp_default, Ignored(), True)
...
bmm_default_1 = CallFunction(aten.bmm.default, view_default_3, view_default_4)
view_default_5 = CallFunction(aten.view.default, bmm_default_1, Ignored())
_sfdp_pattern_18_with_attn_mask_inference = MultiOutputPattern([view_default_5,
  permute_default_1,
  permute_default_3
])
...
view_default_11 = CallFunction(aten.view.default, bmm_default_5, Ignored())
permute_default_11 = CallFunction(aten.permute.default, view_default_11, Ignored())
_sfdp_pattern_18_with_attn_mask_half_training = MultiOutputPattern([view_default_5,
  permute_default_1,
  permute_default_3,
  permute_default_6,
  permute_default_9,
...
div_Tensor = CallFunction(aten.div.Tensor, view_default_2, KeywordArg('inv_scale'))
where_self = CallFunction(aten.where.self, KeywordArg('causal_mask'), div_Tensor, KeywordArg('causal_mask_value'))
add__Tensor = CallFunction(aten.add_.Tensor, where_self, KeywordArg('attn_mask'))
convert_element_type_default = CallFunction(prims.convert_element_type.default, add__Tensor, Ignored(), _users=2)
amax_default = CallFunction(aten.amax.default, convert_element_type_default, Ignored(), True)
sub_Tensor = CallFunction(aten.sub.Tensor, convert_element_type_default, amax_default)
exp_default = CallFunction(aten.exp.default, sub_Tensor, _users=2)
sum_dim_IntList = CallFunction(aten.sum.dim_IntList, exp_default, Ignored(), True)
...
bmm_default_1 = CallFunction(aten.bmm.default, view_default_3, view_default_4)
view_default_5 = CallFunction(aten.view.default, bmm_default_1, Ignored())
_sfdp_pattern_18_with_attn_mask_half_inference = MultiOutputPattern([view_default_5,
  permute_default_1,
  permute_default_3
])
