...
add_Tensor = CallFunction(aten.add.Tensor, div_Scalar, KeywordArg('attn_mask'), _users=2)
...
view_default_2 = CallFunction(aten.view.default, bmm_default, Ignored())
div_Scalar = CallFunction(aten.div.Scalar, view_default_2, Ignored())
add_Tensor = CallFunction(aten.add.Tensor, div_Scalar, KeywordArg('attn_mask'))
