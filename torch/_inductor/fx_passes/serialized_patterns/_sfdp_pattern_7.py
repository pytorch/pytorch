...
convert_element_type_default = CallFunction(prims.convert_element_type.default, mul_Scalar, Ignored())
...
mul_Tensor_1 = CallFunction(aten.mul.Tensor, convert_element_type_default_2, mul_Scalar_1)
...
clone_default_2 = CallFunction(aten.clone.default, div_Tensor)
...
mul_Tensor = CallFunction(aten.mul.Tensor, gt_Scalar, div_Tensor)
mul_Scalar = CallFunction(aten.mul.Scalar, mul_Tensor, Ignored())
convert_element_type_default_1 = CallFunction(prims.convert_element_type.default, mul_Scalar, Ignored())
...
div_Scalar_1 = CallFunction(aten.div.Scalar, convert_element_type_default_4, Ignored())
view_default_8 = CallFunction(aten.view.default, div_Scalar_1, Ignored(), _users=2)
permute_default_5 = CallFunction(aten.permute.default, view_default_1, Ignored())
bmm_default_3 = CallFunction(aten.bmm.default, view_default_8, permute_default_5)
view_default_9 = CallFunction(aten.view.default, bmm_default_3, Ignored())
