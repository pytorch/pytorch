...
permute_default_1 = CallFunction(aten.permute.default, KeywordArg('query'), Ignored())
expand_default = CallFunction(aten.expand.default, permute_default_1, Ignored())
clone_default_1 = CallFunction(aten.clone.default, expand_default, memory_format=torch.contiguous_format)
view_default = CallFunction(aten.view.default, clone_default_1, Ignored(), _users=2)
permute_default_2 = CallFunction(aten.permute.default, KeywordArg('key'), Ignored())
permute_default_3 = CallFunction(aten.permute.default, permute_default_2, Ignored())
expand_default_1 = CallFunction(aten.expand.default, permute_default_3, Ignored())
clone_default_2 = CallFunction(aten.clone.default, expand_default_1, memory_format=torch.contiguous_format)
view_default_1 = CallFunction(aten.view.default, clone_default_2, Ignored(), _users=2)
...
permute_default_4 = CallFunction(aten.permute.default, KeywordArg('value'), Ignored())
expand_default_3 = CallFunction(aten.expand.default, permute_default_4, Ignored())
clone_default_3 = CallFunction(aten.clone.default, expand_default_3, memory_format=torch.contiguous_format)
view_default_4 = CallFunction(aten.view.default, clone_default_3, Ignored(), _users=2)
bmm_default_1 = CallFunction(aten.bmm.default, view_default_3, view_default_4)
view_default_5 = CallFunction(aten.view.default, bmm_default_1, Ignored())
view_default_6 = CallFunction(aten.view.default, KeywordArg('tangents_1'), Ignored(), _users=2)
permute_default_5 = CallFunction(aten.permute.default, view_default_4, Ignored())
bmm_default_2 = CallFunction(aten.bmm.default, view_default_6, permute_default_5)
...
clone_default_4 = CallFunction(aten.clone.default, mul_Tensor_3, memory_format=torch.contiguous_format)
...
mul_Tensor_4 = CallFunction(aten.mul.Tensor, clone_default_4, alias_default_1, _users=2)
...
permute_default_6 = CallFunction(aten.permute.default, view_default_1, Ignored())
bmm_default_3 = CallFunction(aten.bmm.default, view_default_8, permute_default_6)
view_default_9 = CallFunction(aten.view.default, bmm_default_3, Ignored())
permute_default_7 = CallFunction(aten.permute.default, view_default_9, Ignored())
permute_default_8 = CallFunction(aten.permute.default, view_default, Ignored())
bmm_default_4 = CallFunction(aten.bmm.default, permute_default_8, view_default_8)
view_default_10 = CallFunction(aten.view.default, bmm_default_4, Ignored())
permute_default_9 = CallFunction(aten.permute.default, view_default_10, Ignored())
permute_default_10 = CallFunction(aten.permute.default, permute_default_9, Ignored())
permute_default_11 = CallFunction(aten.permute.default, view_default_3, Ignored())
bmm_default_5 = CallFunction(aten.bmm.default, permute_default_11, view_default_6)
view_default_11 = CallFunction(aten.view.default, bmm_default_5, Ignored())
permute_default_12 = CallFunction(aten.permute.default, view_default_11, Ignored())
