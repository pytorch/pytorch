...
div_Tensor = CallFunction([aten.div.Tensor, aten.div.Scalar], view_default_2, KeywordArg('inv_scale'), _users=2)
...
div_Tensor_2 = CallFunction([aten.div.Tensor, aten.div.Scalar], fma_default, KeywordArg('inv_scale'))
...
bmm_default = CallFunction(aten.bmm.default, view_default, view_default_1)
view_default_2 = CallFunction(aten.view.default, bmm_default, Ignored())
div_Tensor = CallFunction([aten.div.Tensor, aten.div.Scalar], view_default_2, KeywordArg('inv_scale'))
...
div_Tensor_2 = CallFunction([aten.div.Tensor, aten.div.Scalar], convert_element_type_default_3, KeywordArg('inv_scale'))
view_default_8 = CallFunction(aten.view.default, div_Tensor_2, Ignored(), _users=2)
permute_default_5 = CallFunction(aten.permute.default, view_default_1, Ignored())
bmm_default_3 = CallFunction(aten.bmm.default, view_default_8, permute_default_5)
view_default_9 = CallFunction(aten.view.default, bmm_default_3, Ignored())
