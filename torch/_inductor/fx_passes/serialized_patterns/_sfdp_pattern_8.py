...
div_Scalar = CallFunction(aten.div.Scalar, view_default_2, Ignored(), _users=2)
amax_default = CallFunction(aten.amax.default, div_Scalar, Ignored(), True)
sub_Tensor = CallFunction(aten.sub.Tensor, div_Scalar, amax_default)
...
div_Scalar_1 = CallFunction(aten.div.Scalar, fma_default, Ignored())
view_default_8 = CallFunction(aten.view.default, div_Scalar_1, Ignored(), _users=2)
...
bmm_default = CallFunction(aten.bmm.default, view_default, view_default_1)
view_default_2 = CallFunction(aten.view.default, bmm_default, Ignored())
div_Scalar = CallFunction(aten.div.Scalar, view_default_2, Ignored())
convert_element_type_default = CallFunction(prims.convert_element_type.default, div_Scalar, Ignored(), _users=2)
...
div_Scalar_1 = CallFunction(aten.div.Scalar, convert_element_type_default_3, Ignored())
view_default_8 = CallFunction(aten.view.default, div_Scalar_1, Ignored(), _users=2)
permute_default_5 = CallFunction(aten.permute.default, view_default_1, Ignored())
bmm_default_3 = CallFunction(aten.bmm.default, view_default_8, permute_default_5)
view_default_9 = CallFunction(aten.view.default, bmm_default_3, Ignored())
