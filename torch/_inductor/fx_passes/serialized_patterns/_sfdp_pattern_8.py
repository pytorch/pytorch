...
amax_default = CallFunction(aten.amax.default, div_Tensor, CanonicalDims([3], 4), True)
...
permute_default_4 = CallFunction(aten.permute.default, view_default_4, CanonicalDims([0, 2, 1], 3))
...
sum_dim_IntList_1 = CallFunction(aten.sum.dim_IntList, mul_Tensor, CanonicalDims([3], 4), True)
...
permute_default_5 = CallFunction(aten.permute.default, view_default_1, CanonicalDims([0, 2, 1], 3))
bmm_default_3 = CallFunction(aten.bmm.default, view_default_8, permute_default_5)
view_default_9 = CallFunction(aten.view.default, bmm_default_3, Ignored())
permute_default_6 = CallFunction(aten.permute.default, view_default_9, CanonicalDims([0, 2, 1, 3], 4))
permute_default_7 = CallFunction(aten.permute.default, view_default, CanonicalDims([0, 2, 1], 3))
bmm_default_4 = CallFunction(aten.bmm.default, permute_default_7, view_default_8)
view_default_10 = CallFunction(aten.view.default, bmm_default_4, Ignored())
permute_default_8 = CallFunction(aten.permute.default, view_default_10, CanonicalDims([0, 1, 3, 2], 4))
permute_default_9 = CallFunction(aten.permute.default, permute_default_8, CanonicalDims([0, 2, 1, 3], 4))
permute_default_10 = CallFunction(aten.permute.default, view_default_3, CanonicalDims([0, 2, 1], 3))
...
permute_default_11 = CallFunction(aten.permute.default, convert_element_type_default_3, CanonicalDims([0, 2, 1, 3], 4))
...
bmm_default_5 = CallFunction(aten.bmm.default, permute_default_10, view_default_6)
view_default_11 = CallFunction(aten.view.default, bmm_default_5, Ignored())
permute_default_11 = CallFunction(aten.permute.default, view_default_11, CanonicalDims([0, 2, 1, 3], 4))
