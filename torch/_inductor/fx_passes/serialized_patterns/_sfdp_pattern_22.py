...
permute_default_1 = CallFunction(aten.permute.default, KeywordArg('key'), CanonicalDims([0, 2, 1, 3], 4), _users=2)
...
permute_default_3 = CallFunction(aten.permute.default, KeywordArg('value'), CanonicalDims([0, 2, 1, 3], 4), _users=2)
