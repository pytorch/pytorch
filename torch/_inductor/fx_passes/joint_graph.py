...
class UniformValueConstantFolder(ConstantFolder):
    ...
    def __init__(self, gm, skip_constructors=False):
        ...
        self.node_replacements_shapes: Dict[torch.fx.Node, torch.Size] = {}
    ...
    def add_node_replacement(self, node: torch.fx.Node, tensor: torch.Tensor) -> None:
        ...
        self.node_replacements_shapes[node] = tensor.shape
    ...
    for node, value in node_replacements.items():
        ...
        with graph.inserting_after(node):
            ...
            new_node = graph.call_function(
                aten.full.default,
                args=(list(node_replacements_shapes[node]), value),
                kwargs={
