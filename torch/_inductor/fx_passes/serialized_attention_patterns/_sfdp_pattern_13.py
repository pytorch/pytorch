...
tmp_5 = CallFunction(
    aten.view.default,
    CallFunction(
        aten.expand.default, CallFunction(aten.clone.default, tmp_4), Ignored()
    ),
    Ignored(),
    _users=2,
)
...
_sfdp_pattern_13_training = MultiOutputPattern(
    [
        CallFunction(
            aten.view.default, CallFunction(aten.bmm.default, tmp_5, tmp_6), Ignored()
        ),
        CallFunction(
            aten.view.default,
            CallFunction(
                aten.bmm.default,
                tmp_9,
                CallFunction(aten.permute.default, tmp_1, Ignored()),
            ),
            Ignored(),
        ),
        CallFunction(
            ...
            CallFunction(
                ...
                CallFunction(
                    aten.bmm.default,
                    CallFunction(aten.permute.default, tmp_0, Ignored()),
                    tmp_9,
                ),
                Ignored(),
            ),
        ...
        CallFunction(
            ...
            CallFunction(
                aten.bmm.default,
                CallFunction(aten.permute.default, tmp_5, Ignored()),
                tmp_7,
            ),
            Ignored(),
        ),
...
tmp_1 = CallFunction(
    aten.exp.default,
    CallFunction(
        aten.sub.Tensor, tmp_0, CallFunction(aten.amax.default, tmp_0, Ignored(), True)
    ),
    _users=2,
)
            ...
            CallFunction(
                ...
                CallFunction(
                    ...
                    CallFunction(
                        aten.div.Tensor,
                        tmp_1,
                        CallFunction(aten.sum.dim_IntList, tmp_1, Ignored(), True),
                    ),
                ),
                Ignored(),
            ),
