...
tmp_2 = CallFunction(aten.mul.Tensor,
...
_sfdp_pattern_14_training = MultiOutputPattern([CallFunction(aten.view.default,
    CallFunction(aten.bmm.default,
      tmp_5,
      tmp_6
    ),
...
_sfdp_pattern_14_inference = CallFunction(aten.view.default,
  CallFunction(aten.bmm.default,
    CallFunction(aten.view.default,
      CallFunction(aten.expand.default,
        CallFunction(aten.clone.default,
