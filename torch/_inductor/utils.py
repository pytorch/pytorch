...
if attrs_descriptor_available:
    ...
    class instance_descriptor(AttrsDescriptor):
        def __new__(cls, *args, **kwargs):
            # Check if 'ids_of_folded_args' is an expected parameter
            expected_params = cls.__annotations__
            if "ids_of_folded_args" not in expected_params:
                # Remove it from kwargs if not expected
                kwargs.pop("ids_of_folded_args", None)
            # Call the parent class with updated args and kwargs
