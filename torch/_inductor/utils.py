...
def do_bench_using_profiling(
    ...
    from torch._inductor.runtime.benchmarking import lock_gpu, may_distort_benchmarking_result

    return may_distort_benchmarking_result(lock_gpu(_do_bench_using_profiling))(
