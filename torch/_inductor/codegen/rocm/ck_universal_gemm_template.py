...
class CKGemmTemplate(CKTemplate):
    ...
    def filter_op(self, op: "CKGemmOperation"):
        ...
        M = X_meta.size[-2]  # type: ignore[union-attr]  # type: ignore[union-attr]
        K = X_meta.size[-1]  # type: ignore[union-attr]  # type: ignore[union-attr]
        N = W_meta.size[-1]  # type: ignore[union-attr]  # type: ignore[union-attr]
