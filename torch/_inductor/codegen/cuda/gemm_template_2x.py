...
class CUTLASS2xGemmTemplate(CUTLASSTemplate):
    """
    ...
    def add_cutlass_gemm_choices(
        ...
        **extra_kwargs,
        ...
        cutlass_template = CUTLASS2xGemmTemplate(
    ...
    def layout_match(
        ...
        return CUTLASS2xGemmTemplate.cutlass_layout(torch_layout) == cutlass_layout
    ...
    def fix_op_layout(
        ...
        match_list = [
            CUTLASS2xGemmTemplate.layout_match(buf.get_layout(), op_layout)
        ...
        if a_layout is not None:
            new_op.A.layout = CUTLASS2xGemmTemplate.cutlass_layout(a_layout)
        if b_layout is not None:
            new_op.B.layout = CUTLASS2xGemmTemplate.cutlass_layout(b_layout)
        if c_layout is not None:
            new_op.C.layout = CUTLASS2xGemmTemplate.cutlass_layout(c_layout)
