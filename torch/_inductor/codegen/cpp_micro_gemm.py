...
class CppMicroGemm:
    ...
    DECLARE_KERNEL = r"""
template <bool accum, bool prefetch=false, bool horizontal_transverse=false>
...
"""
    ...
    def codegen_call(
        ...
        **kwargs_for_extra_args,
        ...
        res = IndentedBuffer()
        res.writeline(
            f"{self.name}<{value_to_cpp(accum, 'bool')}, {value_to_cpp(prefetch, 'bool')},{value_to_cpp(horizontal_transverse, 'bool')}>("
        )
        with res.indent():
