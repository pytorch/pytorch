...
pointwise_overrides_data: Dict[str, OverridesData] = dict(
    ...
    erfcx=OverridesData(
        type_promotion_kind=ELEMENTWISE_TYPE_PROMOTION_KIND.INT_TO_FLOAT,
        cpp="calc_erfcx({x})",
        triton="triton_helpers.libdevice.erfcx({x})",
        name="special_erfcx",
    ),
    ...
    i0=OverridesData(
        type_promotion_kind=ELEMENTWISE_TYPE_PROMOTION_KIND.INT_TO_FLOAT,
        cpp="calc_i0({x})",
        triton="triton_helpers.libdevice.cyl_bessel_i0({x})",
        cppvec="{x}.i0()",
        name="i0",
    ),
    i0e=OverridesData(
    ...
    i1=OverridesData(
        type_promotion_kind=ELEMENTWISE_TYPE_PROMOTION_KIND.INT_TO_FLOAT,
        cpp="calc_i1({x})",
        triton="triton_helpers.libdevice.cyl_bessel_i1({x})",
        name="special_i1",
    ),
    i1e=OverridesData(
        type_promotion_kind=ELEMENTWISE_TYPE_PROMOTION_KIND.INT_TO_FLOAT,
