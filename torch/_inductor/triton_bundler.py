...
class TritonBundler:
    ...
    def collect(
        ...
        if not TritonBundler.is_enabled():
            cls.end_compile()
            set_feature_use("pytorch/remote_cache:bundle_triton_into_fx_graph_cache_v2", False)
            return [], None
        set_feature_use("pytorch/remote_cache:bundle_triton_into_fx_graph_cache_v2", True)
