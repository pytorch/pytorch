...
def use_two_step_variance(x, axis, keepdim):
    ...
    # Welford does more work per element. Keep Welford for small reductions
    # where the speedup is limited and training gradients are more sensitive
    # to the different accumulation order, and for larger or split reductions
    # where avoiding another full pass over the data is profitable.
    axis = _validate_reduction_axis(x, axis)
    kwargs = _make_reduction_inner(
