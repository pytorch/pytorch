...
make_fallback(torch.ops.aten.acos)
make_fallback(torch.ops.aten.acosh)
make_fallback(torch.ops.aten._adaptive_avg_pool3d)
make_fallback(torch.ops.aten.adaptive_max_pool2d)
make_fallback(torch.ops.aten.adaptive_max_pool3d)
make_fallback(torch.ops.aten.addbmm)
make_fallback(torch.ops.aten.addcdiv)
make_fallback(torch.ops.aten.addmv)
make_fallback(torch.ops.aten.addr)
make_fallback(torch.ops.aten.aminmax)
make_fallback(torch.ops.aten.asin)
make_fallback(torch.ops.aten.asinh)
make_fallback(torch.ops.aten.atan)
make_fallback(torch.ops.aten.atan2)
make_fallback(torch.ops.aten.atanh)
make_fallback(torch.ops.aten.avg_pool3d)
make_fallback(torch.ops.aten.binary_cross_entropy)
make_fallback(torch.ops.aten.bitwise_and_)
make_fallback(torch.ops.aten.block_diag)
make_fallback(torch.ops.aten._cdist_forward)
make_fallback(torch.ops.aten.celu)
make_fallback(torch.ops.aten.copysign)
make_fallback(torch.ops.aten.cosh)
make_fallback(torch.ops.aten.count_nonzero)
make_fallback(torch.ops.aten.cummax)
make_fallback(torch.ops.aten.cummin)
make_fallback(torch.ops.aten.cumprod)
make_fallback(torch.ops.aten.deg2rad)
make_fallback(torch.ops.aten.diag_embed)
make_fallback(torch.ops.aten.diagonal)
make_fallback(torch.ops.aten.diagonal_copy)
make_fallback(torch.ops.aten.diagonal_scatter)
make_fallback(torch.ops.aten.digamma)
make_fallback(torch.ops.aten.dist)
make_fallback(torch.ops.aten._efficientzerotensor)
make_fallback(torch.ops.aten._embedding_bag_per_sample_weights_backward)
make_fallback(torch.ops.aten.erfc)
make_fallback(torch.ops.aten.erfinv)
make_fallback(torch.ops.aten.fmax)
make_fallback(torch.ops.aten.fmin)
make_fallback(torch.ops.aten.frac)
make_fallback(torch.ops.aten.fractional_max_pool2d)
make_fallback(torch.ops.aten.fractional_max_pool3d)
make_fallback(torch.ops.aten.frexp)
make_fallback(torch.ops.aten.geqrf)
make_fallback(torch.ops.aten.hardshrink)
make_fallback(torch.ops.aten.heaviside)
make_fallback(torch.ops.aten.histc)
make_fallback(torch.ops.aten.huber_loss)
make_fallback(torch.ops.aten.hypot)
make_fallback(torch.ops.aten.i0)
make_fallback(torch.ops.aten.igamma)
make_fallback(torch.ops.aten.igammac)
make_fallback(torch.ops.aten.isin)
make_fallback(torch.ops.aten.isneginf)
make_fallback(torch.ops.aten.isposinf)
make_fallback(torch.ops.aten.kthvalue)
make_fallback(torch.ops.aten.linalg_cholesky_ex)
make_fallback(torch.ops.aten.linalg_cross)
make_fallback(torch.ops.aten._linalg_det)
make_fallback(torch.ops.aten.linalg_householder_product)
make_fallback(torch.ops.aten.linalg_inv_ex)
make_fallback(torch.ops.aten.linalg_ldl_factor_ex)
make_fallback(torch.ops.aten.linalg_ldl_solve)
make_fallback(torch.ops.aten.linalg_lu)
make_fallback(torch.ops.aten.linalg_lu_factor_ex)
make_fallback(torch.ops.aten.linalg_lu_solve)
make_fallback(torch.ops.aten.linalg_matrix_exp)
make_fallback(torch.ops.aten.linalg_qr)
make_fallback(torch.ops.aten._linalg_slogdet)
make_fallback(torch.ops.aten._linalg_solve_ex)
make_fallback(torch.ops.aten.linalg_solve_triangular)
make_fallback(torch.ops.aten._linalg_svd)
make_fallback(torch.ops.aten.log10)
make_fallback(torch.ops.aten.logaddexp2)
make_fallback(torch.ops.aten.logcumsumexp)
make_fallback(torch.ops.aten.logical_xor)
make_fallback(torch.ops.aten.log_sigmoid_forward)
make_fallback(torch.ops.aten.logspace)
make_fallback(torch.ops.aten.lu_unpack)
make_fallback(torch.ops.aten.max_pool3d_with_indices)
make_fallback(torch.ops.aten.max_unpool2d)
make_fallback(torch.ops.aten.max_unpool3d)
make_fallback(torch.ops.aten.median)
make_fallback(torch.ops.aten.mish)
make_fallback(torch.ops.aten.mode)
make_fallback(torch.ops.aten.multilabel_margin_loss_forward)
make_fallback(torch.ops.aten.multi_margin_loss)
make_fallback(torch.ops.aten.mvlgamma)
make_fallback(torch.ops.aten.nanmedian)
make_fallback(torch.ops.aten.nansum)
make_fallback(torch.ops.aten.narrow_copy)
make_fallback(torch.ops.aten.nextafter)
make_fallback(torch.ops.aten.ormqr)
make_fallback(torch.ops.aten._pdist_forward)
make_fallback(torch.ops.aten.pixel_shuffle)
make_fallback(torch.ops.aten.pixel_unshuffle)
make_fallback(torch.ops.aten.polygamma)
make_fallback(torch.ops.aten._prelu_kernel)
make_fallback(torch.ops.aten.prod)
make_fallback(torch.ops.aten.put)
make_fallback(torch.ops.aten.rad2deg)
make_fallback(torch.ops.aten.reflection_pad1d)
make_fallback(torch.ops.aten.renorm)
make_fallback(torch.ops.aten.replication_pad1d)
make_fallback(torch.ops.aten.resize_)
make_fallback(torch.ops.aten.resize_as_)
make_fallback(torch.ops.aten.rot90)
make_fallback(torch.ops.aten.searchsorted)
make_fallback(torch.ops.aten.sinc)
make_fallback(torch.ops.aten.sinh)
make_fallback(torch.ops.aten.smooth_l1_loss)
make_fallback(torch.ops.aten.soft_margin_loss)
make_fallback(torch.ops.aten.softshrink)
make_fallback(torch.ops.aten.special_airy_ai)
make_fallback(torch.ops.aten.special_bessel_j0)
make_fallback(torch.ops.aten.special_bessel_j1)
make_fallback(torch.ops.aten.special_bessel_y0)
make_fallback(torch.ops.aten.special_bessel_y1)
make_fallback(torch.ops.aten.special_chebyshev_polynomial_t)
make_fallback(torch.ops.aten.special_chebyshev_polynomial_u)
make_fallback(torch.ops.aten.special_entr)
make_fallback(torch.ops.aten.special_erfcx)
make_fallback(torch.ops.aten.special_hermite_polynomial_h)
make_fallback(torch.ops.aten.special_hermite_polynomial_he)
make_fallback(torch.ops.aten.special_i0e)
make_fallback(torch.ops.aten.special_i1)
make_fallback(torch.ops.aten.special_i1e)
make_fallback(torch.ops.aten.special_laguerre_polynomial_l)
make_fallback(torch.ops.aten.special_log_ndtr)
make_fallback(torch.ops.aten.special_modified_bessel_i0)
make_fallback(torch.ops.aten.special_modified_bessel_i1)
make_fallback(torch.ops.aten.special_modified_bessel_k0)
make_fallback(torch.ops.aten.special_modified_bessel_k1)
make_fallback(torch.ops.aten.special_ndtri)
make_fallback(torch.ops.aten.special_scaled_modified_bessel_k0)
make_fallback(torch.ops.aten.special_scaled_modified_bessel_k1)
make_fallback(torch.ops.aten.special_spherical_bessel_j0)
make_fallback(torch.ops.aten.special_xlog1py)
make_fallback(torch.ops.aten.special_zeta)
make_fallback(torch.ops.aten.take)
make_fallback(torch.ops.aten.threshold)
make_fallback(torch.ops.aten.trace)
make_fallback(torch.ops.aten._trilinear)
make_fallback(torch.ops.aten.unfold_copy)
make_fallback(torch.ops.aten.unsafe_split)
make_fallback(torch.ops.aten.vdot)
make_fallback(torch.ops.aten.view_as_complex)
make_fallback(torch.ops.aten.view_copy)
make_fallback(torch.ops.aten.xlogy)
make_fallback(torch.ops.aten._adaptive_avg_pool3d_backward)
make_fallback(torch.ops.aten.adaptive_max_pool2d_backward)
make_fallback(torch.ops.aten.adaptive_max_pool3d_backward)
make_fallback(torch.ops.aten.avg_pool3d_backward)
make_fallback(torch.ops.aten.binary_cross_entropy_backward)
make_fallback(torch.ops.aten.bitwise_or_)
make_fallback(torch.ops.aten._cdist_backward)
make_fallback(torch.ops.aten.diagonal_backward)
make_fallback(torch.ops.aten._embedding_bag_dense_backward)
make_fallback(torch.ops.aten.fractional_max_pool2d_backward)
make_fallback(torch.ops.aten.fractional_max_pool3d_backward)
make_fallback(torch.ops.aten.hardshrink_backward)
make_fallback(torch.ops.aten.huber_loss_backward)
make_fallback(torch.ops.aten._linalg_check_errors)
make_fallback(torch.ops.aten.log_sigmoid_backward)
make_fallback(torch.ops.aten.max_pool3d_with_indices_backward)
make_fallback(torch.ops.aten.multilabel_margin_loss_backward)
make_fallback(torch.ops.aten.multi_margin_loss_backward)
make_fallback(torch.ops.aten._pdist_backward)
make_fallback(torch.ops.aten._prelu_kernel_backward)
make_fallback(torch.ops.aten.reflection_pad1d_backward)
make_fallback(torch.ops.aten.replication_pad1d_backward)
make_fallback(torch.ops.aten.smooth_l1_loss_backward)
make_fallback(torch.ops.aten.soft_margin_loss_backward)
make_fallback(torch.ops.aten.softshrink_backward)
make_fallback(torch.ops.aten.squeeze_copy)
make_fallback(torch.ops.aten.linalg_pinv.atol_rtol_tensor)
make_fallback(torch.ops.aten.segment_reduce.default)
make_fallback(torch.ops.aten._segment_reduce_backward.default)
