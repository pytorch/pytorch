...
def register_pointwise(
    ...
    fn = make_pointwise(
        ...
        override_fn_when_cuda_float64=fn_libdevice if use_libdevice_for_f64 else None,  # type: ignore[possibly-undefined]  # TODO: audit
    ...
    def fn(idx):
        ...
        for area in itertools.product(*[[-1, 0, 1] for _ in range(dim)]):
            ...
            for i in range(dim):
                ...
                outs.append(out)  # type: ignore[possibly-undefined]  # TODO: audit
                index_ranges.append(index_range)  # type: ignore[possibly-undefined]  # TODO: audit
