                ...
                with temporary_cache_dir(path):
                    ...
                    for key in loaded_cache_info.inductor_artifacts:
                        ...
                        for path in sorted(os.listdir(subdir)):
                            # paths that end with this suffix are temporary files in the
                            # middle of being generated by other processes
                            # via write_atomic. We can just ignore them.
                            if path.endswith(torch._inductor.codecache.TMP_EXTENSION):
                                continue
