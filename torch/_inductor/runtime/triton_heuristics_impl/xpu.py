...
from .common import (
    ...
    cached_autotune,
    cooperative_reduction_impl,
    filter_reduction_configs_for_determinism,
    persistent_reduction_impl,
    split_scan_impl,
    torch,
    triton_config,
)
...
@register_triton_heuristic("reduction", "xpu")
def reduction(
    size_hints,
...
@register_triton_heuristic("cooperative_reduction", "xpu")
def cooperative_reduction(
    ...
    return cooperative_reduction_impl(
        size_hints,
        reduction_hint,
        triton_meta,
        filename,
...
@register_triton_heuristic("persistent_reduction", "xpu")
def persistent_reduction(
    ...
    return persistent_reduction_impl(
        size_hints,
        reduction_hint=reduction_hint,
        triton_meta=triton_meta,
        filename=filename,
...
@register_triton_heuristic("split_scan", "xpu")
def split_scan(
    size_hints,
    reduction_hint=False,
    triton_meta=None,
