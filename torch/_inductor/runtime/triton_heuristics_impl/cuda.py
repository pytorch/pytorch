...
@register_triton_heuristic("pointwise", "hip")
def pointwise(
    size_hints,
    triton_meta,
    tile_hint=None,
...
@register_triton_heuristic("reduction", "cuda")
@register_triton_heuristic("reduction", "hip")
def reduction(
    size_hints,
...
@register_triton_heuristic("cooperative_reduction", "cuda")
@register_triton_heuristic("cooperative_reduction", "hip")
...
@register_triton_heuristic("persistent_reduction", "cuda")
@register_triton_heuristic("persistent_reduction", "hip")
...
@register_triton_heuristic("split_scan", "cuda")
@register_triton_heuristic("split_scan", "hip")
def split_scan(
    size_hints,
    reduction_hint=False,
    triton_meta=None,
