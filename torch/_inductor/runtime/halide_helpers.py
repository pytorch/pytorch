...
def philox_impl(c0, c1, c2, c3, k0, k1, n_rounds):
    ...
    if c0.type() == hl.UInt(64):
        PHILOX_KEY_A = hl.u64(0x9E3779B97F4A7C15)
        PHILOX_KEY_B = hl.u64(0xBB67AE8584CAA73B)
        PHILOX_ROUND_A = hl.u64(0xD2E7470EE14C6C93)
        PHILOX_ROUND_B = hl.u64(0xCA5A826395121157)
    else:
        PHILOX_KEY_A = hl.u32(0x9E3779B9)
        PHILOX_KEY_B = hl.u32(0xBB67AE85)
        PHILOX_ROUND_A = hl.u32(0xD2511F53)
        PHILOX_ROUND_B = hl.u32(0xCD9E8D57)
...
def randint4x(seed: hl.Expr, offsets: hl.Expr, n_rounds = 10):
    _0 = offsets * hl.u32(0)
    y = halide_philox(seed, offsets, _0, _0, _0, n_rounds)
    return y

def rand4x(seed, offsets, n_rounds = 10):
    """
    ...
    i1, i2, i3, i4 = randint4x(seed, offsets, N_ROUNDS_DEFAULT)
...
def randint(seed, offset, n_rounds = N_ROUNDS_DEFAULT):
    """
...
def rand(seed, offset, n_rounds = N_ROUNDS_DEFAULT):
    """
...
def randn(seed, offset):
    i1, i2, _, _ = randint4x(seed, offset, N_ROUNDS_DEFAULT)
    u1 = _uint_to_uniform_float(i1)
    u2 = _uint_to_uniform_float(i2)
...
def randint64(seed: hl.Expr, offsets: hl.Expr, low, high):
    r0, r1, r2, r3 = randint4x(seed, offsets)
...
def main(seed: int, offsets: list[int]):
    ...
    # y = randint4x(seed_input, offset_input, N_ROUNDS_DEFAULT) ok
    # y = rand4x(seed_input, offset_input, N_ROUNDS_DEFAULT) ok
