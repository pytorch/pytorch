...
class TritonCompileResult:
    ...
    @staticmethod
    def _serialize_packed_metadata(packed_metadata):
        ...
        if is_namedtuple(packed_metadata):
            return packed_metadata._asdict()
        else:
            return packed_metadata

    @staticmethod
    def _deserialize_packed_metadata(packed_metadata):
        if isinstance(packed_metadata, dict):
            return TritonCompileResult._kernel_metadata_cls(
                tuple(packed_metadata.keys())
            )(**packed_metadata)
        else:
            return packed_metadata
    ...
    def __getstate__(self) -> dict[str, Any]:
        ...
        kernel_state = {
            **kernel.__dict__,
            ...
            "packed_metadata": self._serialize_packed_metadata(
        ...
        kernel.__dict__.update(
            {
                **state["kernel"],
                ...
                "packed_metadata": self._deserialize_packed_metadata(packed_metadata),
            }
        )
        self.__dict__.update(state)
        self.kernel = kernel
