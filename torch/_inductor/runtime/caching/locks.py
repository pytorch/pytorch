...
def _unsafe_acquire_lock_with_timeout(lock: Lock, timeout: Optional[float] = None) -> None:
...
def _unsafe_acquire_flock_with_timeout(flock: FileLock, timeout: Optional[float]) -> None:
    ...
    try:
        ...
        raise exceptions.FileLockTimeoutError(flock, _timeout)
