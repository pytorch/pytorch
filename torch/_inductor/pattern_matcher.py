...
class Match:
    ...
    def replace_by_example(
        ...
        post_trace_fn: Optional[PostTraceFn] = None,
    ) -> None:
        ...
        with context:
            ...
            if post_trace_fn is not None:
                replacement = post_trace_fn(replacement)
            ReplacementPatternEntry.replace_with_graph(
                self,
                self.ctx.graph,
                replacement,
    ...
    def replace_with_graph(
        ...
        class Replacer(torch.fx.Interpreter):
            ...
            def get_attr(self, target, args, kwargs) -> torch.fx.Node:  # type: ignore[no-untyped-def]
                ...
                graph.owning_module.register_module(target, sub_gm)
                proxy = graph.get_attr(target)
                return proxy
