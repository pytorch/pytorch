...
aten__weight_int4pack_mm_with_scales_and_zeros = ExternKernelChoice(
    torch._weight_int4pack_mm_with_scales_and_zeros,
    "at::_weight_int4pack_mm_with_scales_and_zeros",
    has_out_variant=False,
)
    ...
    def int8pack_mm_with_scale_and_zeros(
        ...
        *,
        ...
        if (
            ...
            log.warning("No choices for GEMM, using ATen backend as fallback")
            return aten__weight_int4pack_mm_with_scales_and_zeros.bind(
                (mat1, mat2, scale), aten_layout
            ).output_node()
