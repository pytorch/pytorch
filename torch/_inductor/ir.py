...
class Loops(IRNode):
    ...
    def get_unbacked_symbol_uses(self) -> OrderedSet[Symbol]:
        return typing.cast(OrderedSet[Symbol], OrderedSet()).union(
...
class Pointwise(Loops):
    ...
    def store_output(
        ...
        indexer: Callable[[Sequence[Expr]], Never],  # FIXME: Is this ever used?
        vars: Sequence[Expr],
    ) -> OpsValue:
...
class Scan(Loops):
    ...
    def store_reduction(
        self,
        output_name: Optional[str],
        indexer: Callable[[Sequence[_IntLike]], Never],  # FIXME: Is this ever used?
        vars: Sequence[Expr],
...
class LoopBody:
    ...
    def __init__(self, fn, args, var_ranges):
        ...
        self.other = []  # FIXME: Is this ever used?
