...
class IRNode:
    ...
    def _post_init_setattr(self, attr, value):  # type: ignore[no-untyped-def]
    ...
    def common_repr(self, shorten=True):  # type: ignore[no-untyped-def]
    ...
    def str_helper(self, lines, shorten=True, multiline=True):  # type: ignore[no-untyped-def]
    ...
    def get_numel(self):  # type: ignore[no-untyped-def]
...
class Loops(IRNode):
    ...
    def __str__(self, names=("ranges",)):  # type: ignore[no-untyped-def]
    ...
    @staticmethod
    def _index(ranges, prefix=SymT.INDEX):  # type: ignore[no-untyped-def]
        return [
    ...
    def inner_fn_args(self):  # type: ignore[no-untyped-def]
        return (self._index(self.ranges),)

    @cache_on_self
    def inner_fn_str(self):  # type: ignore[no-untyped-def]
        return V.KernelFormatterHandler.ir_to_string(
            self.inner_fn, *self.inner_fn_args()
        )

    def has_large_inner_fn(self, threshold=None):  # type: ignore[no-untyped-def]
        if threshold is None:
            threshold = 0
        threshold = max(threshold, config.realize_opcount_threshold)
        return self.inner_fn_opcount().num_ops > threshold

    def inner_fn_free_unbacked_symbols(self):  # type: ignore[no-untyped-def]
...
class Pointwise(Loops):
    ...
    def store_output(self, output_name, indexer, vars):  # type: ignore[no-untyped-def]
...
class Reduction(Loops):
    ...
    def store_reduction(self, output_name, indexer, vars, reduction_vars):  # type: ignore[no-untyped-def]
        value = ops.reduction(
            self.dtype,
            self.src_dtype,
            self.reduction_type,
    ...
    def index_length(self):  # type: ignore[no-untyped-def]
    ...
    @staticmethod
    def num_splits(  # type: ignore[no-untyped-def]  # type: ignore[no-untyped-def]
        device,
        dst_dtype,
        src_dtype,
        inner_fn,
        ...
        def _is_static(x):  # type: ignore[no-untyped-def]
        ...
        def inner_reduction_splits(reduction_numel_hint, numel_hint):  # type: ignore[no-untyped-def]
            if not should_split:
                return 1
        ...
        def get_read_indices(r):  # type: ignore[no-untyped-def]
            cb = ComputedBuffer(
                name=None,
    ...
    def create(
        ...
        if reduction_numel == 0:
            ...
            def py_cnst(val):  # type: ignore[no-untyped-def]
                return (
                    bool(val)
            ...
            def const_fn(index):  # type: ignore[no-untyped-def]
    ...
    @staticmethod
    def default_accumulator(reduction_type, dtype):  # type: ignore[no-untyped-def]
    ...
    @staticmethod
    def default_value(reduction_type, dtype):  # type: ignore[no-untyped-def]
    ...
    @classmethod
    def _multilayer_wrap_loader(  # type: ignore[no-untyped-def]
        cls,
        loader,
        reduction_ranges,
        reduction_numel,
        ...
        def wrapper_fn(index, reduction_index):  # type: ignore[no-untyped-def]
    ...
    @classmethod
    def create_multilayer_helper(  # type: ignore[no-untyped-def]
        cls,
        device: torch.device,
        dst_dtype: torch.dtype,
        src_dtype: torch.dtype,
        ...
        def intermediate_fn(index, reduction_index):  # type: ignore[no-untyped-def]
    ...
    @classmethod
    def create_multilayer(  # type: ignore[no-untyped-def]
        cls,
        device: torch.device,
        dst_dtype: torch.dtype,
        src_dtype: torch.dtype,
...
class WelfordReduction(Reduction):
    ...
    @classmethod
    def create(  # type: ignore[override, no-untyped-def]
        cls,
        device: torch.device,
        dtype: torch.dtype,
    ...
    @classmethod
    def create_multilayer(  # type: ignore[override, no-untyped-def]
        cls,
        device: torch.device,
        dtype: torch.dtype,
        inner_fns: Sequence[Callable[..., Any]],
...
class Scan(Loops):
    ...
    def store_reduction(self, output_name, indexer, vars, scan_vars):  # type: ignore[no-untyped-def]
...
class Layout(IRNode):
    ...
    @staticmethod
    def is_channels_last_contiguous(shape, strides):  # type: ignore[no-untyped-def]
        ndim = len(shape)
    ...
    def is_transposed(self):  # type: ignore[no-untyped-def]
        for left, right, size in zip(
            self.stride,
    ...
    def is_stride_ordered(self, order):  # type: ignore[no-untyped-def]
...
class FlexibleLayout(Layout):
    ...
    def __init__(self, device, dtype, size, stride_order=None):  # type: ignore[no-untyped-def]
        if stride_order:
...
class NoneLayout(IRNode):
    ...
    def storage_size(self):  # type: ignore[no-untyped-def]
        return 0
...
class Buffer(IRNode):
    ...
    def should_allocate(self):  # type: ignore[no-untyped-def]
...
class TemplateBuffer(OperationBuffer):
    ...
    def __init__(self, layout, inputs, make_kernel_render):  # type: ignore[no-untyped-def]
...
class MultiTemplateBuffer(TritonTemplateBuffer):
    ...
    def finalize_as_triton_caller(self, caller: TritonTemplateCallerBase):  # type: ignore[no-untyped-def]
        assert isinstance(caller, torch._inductor.select_algorithm.TritonTemplateCaller)
...
class CppTemplateBuffer(TemplateBuffer):
    def __init__(self, layout, inputs, make_kernel_render, template, choice):  # type: ignore[no-untyped-def]
        super().__init__(layout, inputs, make_kernel_render)
        self.template = template
        self.choice = choice
...
class ExternKernel(InputsKernel):
    ...
    def codegen_comment(self, wrapper):  # type: ignore[no-untyped-def]
    ...
    def set_cpp_kernel_name(self, cpp_kernel_name: Optional[str] = None):  # type: ignore[no-untyped-def]
    ...
    def set_python_kernel_name(self, python_kernel_name: Optional[str]):  # type: ignore[no-untyped-def]
    ...
    @classmethod
    def require_strides(  # type: ignore[no-untyped-def]  # type: ignore[no-untyped-def]
        cls,
        x,
    ...
    def codegen_size_asserts(self, wrapper):  # type: ignore[no-untyped-def]
...
class UserDefinedTritonKernel(ExternKernel):
    ...
    def __init__(self, *, kernel_idx, grid, tma_descriptor_metadata, kernel_args):  # type: ignore[no-untyped-def]
        inputs = []
        kwargs = {}
        constant_args = []
...
class InplaceBernoulliFallback(ExternKernel):
    ...
    def __init__(self, op_overload, x, *constant_args):  # type: ignore[no-untyped-def]
        super().__init__(
            None,
...
class InplaceCopyFallback(ExternKernel):
    ...
    @classmethod
    def create(cls, dst, src, non_blocking: bool = False):  # type: ignore[no-untyped-def]  # type: ignore[no-untyped-def]
...
class ResizeStorageBytes(MutatingFirstArgExternKernel):
    def __init__(self, variable, new_size):  # type: ignore[no-untyped-def]
...
class SetSourceTensorKernel(ExternKernelAlloc):
    def __init__(self, self_tensor, storage_tensor):  # type: ignore[no-untyped-def]
...
class IndexPutFallback(ExternKernel):
    ...
    def __init__(self, op_overload, x, indices, values, accumulate):  # type: ignore[no-untyped-def]
...
class DynamicScalar(ExternKernel):
    ...
    def __init__(self, sym, keypath, data):  # type: ignore[no-untyped-def]
        data.realize()
        super().__init__(
...
class AssertScalar(ExternKernel):
    ...
    def __init__(self, scalar, msg):  # type: ignore[no-untyped-def]
        super().__init__(
            # Buffer(name, layotu)
            None,
...
class FallbackKernel(ExternKernelAlloc):
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        def handle_aliasing_and_mutation(info, arg):  # type: ignore[no-untyped-def]
    ...
    def codegen_unbacked_symbol_defs(self, wrapper):  # type: ignore[no-untyped-def]
...
class MultiOutput(ExternKernel):
    ...
    def __init__(self, layout, input, indices: List[Tuple[Any, ...]]):  # type: ignore[no-untyped-def]
