...
from typing import Callable, List, Optional, overload, Sequence, Tuple, Union, cast
...
def permute(a: TensorLikeType, *dims: Union[DimsSequenceType, Tuple[DimsSequenceType, ...]]) -> TensorLikeType:
