...
def _reshape_view_helper(a: TensorLikeType, *shape, allow_copy: bool) -> TensorLikeType:
    ...
    try:
        ...
        # For compile this function is only called on view operations since reshape_symint will do a clone and compose to view before calling thisGuardOnDataDependentSymNode does not show up for eager.
