...
def arange(
    ...
    *,
    ...
    if dtype == torch.int64:
        ...
        sgn = bool(xstep > 0) - bool(xstep < 0)  # type: ignore[possibly-undefined]  # TODO: audit
        length = (xend - xstart + xstep - sgn) // xstep  # type: ignore[possibly-undefined]  # TODO: audit
    else:
    ...
    if is_integer:
        return prims.iota(
            length,
            start=xstart,  # type: ignore[possibly-undefined]  # TODO: audit
            step=xstep,  # type: ignore[possibly-undefined]  # TODO: audit
            dtype=dtype,
            device=device,
            requires_grad=requires_grad,
        )
