...
def arange(
    ...
    *,
    ...
    if is_integer or builtins.all(isinstance(arg, IntLike) for arg in (start, end, step)):
    ...
    if dtype == torch.int64 or builtins.all(isinstance(arg, IntLike) for arg in (start, end, step)):
