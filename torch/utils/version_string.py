...
class VersionString(str):
    ...
    break them we have VersionString which masquerades as a str while also
    having the ability to compare against both packaging.version.Version as
    well as tuples of values, eg. (1, 2, 1)
    Examples:
        Comparing a TorchVersion object to a Version object
            VersionString('1.10.0a') > Version('1.10.0a')
        Comparing a VersionString object to a Tuple object
            VersionString('1.10.0a') > (1, 2)    # 1.2
            VersionString('1.10.0a') > (1, 2, 1) # 1.2.1
        Comparing a VersionString object against a string
            VersionString('1.10.0a') > '1.2'
            VersionString('1.10.0a') > '1.2.1'
    """
