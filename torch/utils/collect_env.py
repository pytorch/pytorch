...
def get_cudnn_version(run_lambda: RunCallable) -> Optional[str]:
...
def get_env_info() -> SystemEnv:
    ...
    return SystemEnv(
        ...
        cuda_compiled_version=str(cuda_version_str),
        ...
        cudnn_version=str(get_cudnn_version(run_lambda)),
