...
# The JIT / ninja-driven compile path lives in ``_jit``. Re-export the public
# entry points and the arch-flag helpers that ``BuildExtension`` still calls
# directly so the historical ``torch.utils.cpp_extension`` surface is intact.
