...
class IterableDataset(Dataset[T_co], metaclass=_DataPipeMeta):
    ...
    def batch(self, batch_size: int, drop_last: bool = False, wrapper_class=DataChunk): ...
    ...
    def demux(self, num_instances: int, classifier_fn: Callable[[T_co], Optional[int]], drop_none: bool = False, buffer_size: int = 1000): ...
    # Functional form of 'FilterIterDataPipe'
    def filter(self, filter_fn: Callable, fn_args: Optional[Tuple] = None, fn_kwargs: Optional[Dict] = None, drop_empty_batches: bool = True): ...
    ...
    def map(self, fn: Callable, input_col=None, output_col=None, *, fn_args: Optional[Tuple] = None, fn_kwargs: Optional[Dict] = None): ...
