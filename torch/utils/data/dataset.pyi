...
class IterableDataset(Dataset[T_co], metaclass=_DataPipeMeta):
    ...
    def collate(self, collate_fn: Callable= ...): ...
    ...
    def filter(self, filter_fn: Callable, drop_empty_batches: bool = True): ...
    ...
    def map(self, fn: Callable, input_col=None, output_col=None): ...
