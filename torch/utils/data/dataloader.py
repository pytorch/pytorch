    ...
    def __init__(
        ...
        *,
        ...
        self.pin_memory_device = (
            torch.accelerator.current_accelerator().type if self.pin_memory else None
        )
