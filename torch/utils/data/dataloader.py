    ...
    def __next__(self) -> Any:
        with torch.autograd.profiler.record_function(self._profile_name):
            ...
            if self._dataset_kind == _DatasetKind.Iterable and \
                ...
                warn_msg = (f"Length of IterableDataset {self._dataset} was reported to be {self._IterableDataset_len_called} (when accessing len(dataloader)), but {self._num_yielded} "
