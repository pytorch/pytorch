...
from . import Sampler, SequentialSampler, RandomSampler, Dataset
...
class DistributedChunkSampler(Sampler[int]):
    ...
    def get_global_worker_rank(self: Any) -> None: ...
    def set_global_worker_rank(self, global_worker_rank: Any) -> None: ...
