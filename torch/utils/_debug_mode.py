...
class DebugMode(TorchDispatchMode):
    def __init__(
        ...
        *,
        ...
        # e.g. via DebugMode(record_stack_trace=True), or torch._C._set_autograd_traceback_enabled(True).
    ...
    def __enter__(self):
        ...
        if self.record_stack_trace:
            self._prev_autograd_tb = torch._C._is_autograd_traceback_enabled()
            torch._C._set_autograd_traceback_enabled(True)
        return self
    ...
    def __exit__(self, *args):
        ...
        if self.record_stack_trace:
            torch._C._set_autograd_traceback_enabled(self._prev_autograd_tb)
