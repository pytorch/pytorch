...
# CUresult cuLaunchKernel(CUfunction f, uint gridDimX/Y/Z,
...
# struct CUlaunchConfig { uint gridDimX/Y/Z; uint blockDimX/Y/Z;
...
# __host__ cudaError_t cudaMemPrefetchAsync(const void* devPtr,
