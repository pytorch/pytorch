...
CUDA_IDENTIFIER_MAP = collections.OrderedDict(
    [
        ...
        ("cudaEventRecordDefault", ("hipEventRecordDefault", CONV_EVENT, API_RUNTIME)),
        ...
        ("cudaEventWaitDefault", ("hipEventWaitDefault", CONV_STREAM, API_RUNTIME)),
        ("cudaEventWaitExternal", ("hipEventWaitExternal", CONV_STREAM, API_RUNTIME)),
