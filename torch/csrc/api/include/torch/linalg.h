...
C10_DEPRECATED("torch::linalg::linalg_det is deprecated, use torch::linalg::det instead.")
...
C10_DEPRECATED("torch::linalg::linalg_norm is deprecated, use torch::linalg::norm instead.")
