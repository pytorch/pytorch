...
TORCH_API Tensor constant_(const Tensor& tensor, const Scalar& value);
...
/// No gradient will be recorded for this operation.
TORCH_API Tensor normal_(const Tensor& tensor, double mean = 0, double std = 1);

/// Fills the given `tensor` with ones.
/// No gradient will be recorded for this operation.
TORCH_API Tensor ones_(const Tensor& tensor);
...
/// No gradient will be recorded for this operation.
TORCH_API Tensor
uniform_(const Tensor& tensor, double low = 0, double high = 1);
...
/// No gradient will be recorded for this operation.
TORCH_API Tensor zeros_(const Tensor& tensor);
