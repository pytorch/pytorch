...
class TORCH_API TransformerDecoderImpl : public Cloneable<TransformerDecoderImpl> {
 public:
  TransformerDecoderImpl(TransformerDecoderOptions decoder_layer, int64_t num_layers)
...
/// provides, and examples of how to use `TransformerDecoder` with `torch::nn::TransformerDecoderOptions`.
