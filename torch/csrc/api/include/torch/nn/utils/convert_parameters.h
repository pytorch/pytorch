...
c10::optional<int64_t> _check_param_device(torch::Tensor& param, c10::optional<int64_t>& old_param_device);

// Convert parameters to one vector
inline torch::Tensor parameters_to_vector(std::vector<torch::Tensor>& parameters) {
...
inline void vector_to_parameters(torch::Tensor& vec, std::vector<torch::Tensor>& parameters) {
...
inline c10::optional<int64_t> _check_param_device(torch::Tensor& param, c10::optional<int64_t>& old_param_device) {
