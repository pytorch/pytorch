...
class ChunkDataset final
 ...
 private:
  ...
  // function pointer wrapper to apply custom sorting over chunk data. This is
  // considered an advanced parameter for developers who want to apply a
  // 'sorting policy' to the chunk data before sampling into minibatch.
  ...
  // perform some pre-processing (like bucketing) to the chunk data before
