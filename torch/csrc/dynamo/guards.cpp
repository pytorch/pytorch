...
struct GlobalStateGuard {
  ...
  friend void from_json(const T& json_j, GlobalStateGuard& json_t) {
    ...
    json_t._torch_function_all_disabled = json_j.at("torch_function_all_disabled");
    json_t._deterministic_algorithms = json_j.at("deterministic_algorithms");
    json_t._deterministic_algorithms_warn_only = json_j.at("deterministic_algorithms_warn_only");
    ...
    json_t._default_dtype = caffe2::TypeMeta::fromScalarType(json_j.at("default_dtype"));
  }
