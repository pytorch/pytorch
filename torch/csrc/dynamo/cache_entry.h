...
typedef struct VISIBILITY_HIDDEN CacheEntry {
  ...
  void update_diff_guard_root_manager(py::object diff_guard_root_manager);
} CacheEntry;
...
class VISIBILITY_HIDDEN CacheEntryHandle {
 public:
  ...
  void update_diff_guard_root_manager(py::object diff_guard_root_manager) const;
