...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_sort(const at::Tensor & self, int64_t dim, bool descending, at::ScalarType indices_dtype, bool dynamic_indices_dtype);
