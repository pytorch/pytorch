...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_slice_scatter_symint(const at::Tensor & self, const at::Tensor & src, int64_t dim, const c10::optional<c10::SymInt> & start, const c10::optional<c10::SymInt> & end, c10::SymInt step);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_as_strided_scatter_symint(const at::Tensor & self, const at::Tensor & src, c10::SymIntArrayRef size, c10::SymIntArrayRef stride, const c10::optional<c10::SymInt> & storage_offset);
// clang-format on
} // namespace lazy
} // namespace torch
