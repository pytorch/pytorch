...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_as_strided(const at::Tensor & self, at::IntArrayRef size, at::IntArrayRef stride, ::std::optional<int64_t> storage_offset);
