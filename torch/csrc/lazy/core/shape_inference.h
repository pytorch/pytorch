...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_block_diag(at::TensorList tensors);
...
>>>>>>> d96573c54c ([test] attempt to functionalize ops with mutable positional-only args)
