...
TORCH_API hash_t OperandHashes(const OpList& operands, const hash_t& seed);

// TODO(whc) migrating shapecache from internal TsNode detail to . 
// being used by codegen.  Might make sense to move it to Node base?
using ShapeCache = Cache<hash_t, std::vector<Shape>, HashReducer>;
TORCH_API ShapeCache* GetShapeCache();
