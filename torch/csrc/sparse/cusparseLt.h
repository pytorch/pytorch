...
#define CUSPARSELT_VERSION                                    \
  (CUSPARSELT_VER_MAJOR * 1000 + CUSPARSELT_VER_MINOR * 100 + \
...
cusparseStatus_t CUSPARSELT_API
cusparseLtGetVersion(const cusparseLtHandle_t* handle, int* version);

cusparseStatus_t CUSPARSELT_API
cusparseLtGetProperty(libraryPropertyType propertyType, int* value);
...
typedef enum { CUSPARSELT_SPARSITY_50_PERCENT } cusparseLtSparsity_t;
...
typedef enum { CUSPARSELT_MATMUL_ALG_DEFAULT } cusparseLtMatmulAlg_t;
...
cusparseStatus_t CUSPARSELT_API cusparseLtMatmulGetWorkspace(
    const cusparseLtHandle_t* handle,
    const cusparseLtMatmulPlan_t* plan,
    size_t* workspaceSize);

cusparseStatus_t CUSPARSELT_API cusparseLtMatmulPlanInit(
    const cusparseLtHandle_t* handle,
...
cusparseStatus_t CUSPARSELT_API cusparseLtMatmul(
    const cusparseLtHandle_t* handle,
    const cusparseLtMatmulPlan_t* plan,
    const void* alpha,
    const void* d_A,
...
cusparseStatus_t CUSPARSELT_API cusparseLtMatmulSearch(
    const cusparseLtHandle_t* handle,
    cusparseLtMatmulPlan_t* plan,
    const void* alpha,
    const void* d_A,
...
cusparseStatus_t CUSPARSELT_API cusparseLtSpMMAPrune(
    const cusparseLtHandle_t* handle,
    const cusparseLtMatmulDescriptor_t* matmulDescr,
    const void* d_in,
    void* d_out,
...
cusparseStatus_t CUSPARSELT_API cusparseLtSpMMAPruneCheck(
    const cusparseLtHandle_t* handle,
    const cusparseLtMatmulDescriptor_t* matmulDescr,
    const void* d_in,
    int* valid,
...
cusparseStatus_t CUSPARSELT_API cusparseLtSpMMAPrune2(
    const cusparseLtHandle_t* handle,
...
cusparseStatus_t CUSPARSELT_API cusparseLtSpMMAPruneCheck2(
    const cusparseLtHandle_t* handle,
    const cusparseLtMatDescriptor_t* sparseMatDescr,
    int isSparseA,
    cusparseOperation_t op,
...
cusparseStatus_t CUSPARSELT_API cusparseLtSpMMACompressedSize(
    const cusparseLtHandle_t* handle,
    const cusparseLtMatmulPlan_t* plan,
    size_t* compressedSize,
    size_t* compressedBufferSize);

cusparseStatus_t CUSPARSELT_API cusparseLtSpMMACompress(
    const cusparseLtHandle_t* handle,
    const cusparseLtMatmulPlan_t* plan,
    const void* d_dense,
    void* d_compressed,
...
cusparseStatus_t CUSPARSELT_API cusparseLtSpMMACompressedSize2(
    const cusparseLtHandle_t* handle,
    const cusparseLtMatDescriptor_t* sparseMatDescr,
    size_t* compressedSize,
    size_t* compressedBufferSize);

cusparseStatus_t CUSPARSELT_API cusparseLtSpMMACompress2(
    const cusparseLtHandle_t* handle,
    const cusparseLtMatDescriptor_t* sparseMatDescr,
    int isSparseA,
    cusparseOperation_t op,
