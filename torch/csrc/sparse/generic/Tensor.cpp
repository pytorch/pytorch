...
static PyObject * THSPTensor_(pynew)(PyTypeObject *type, PyObject *args, PyObject *kwargs)
{
  ...
  catch(std::exception &e) { goto invalid_arguments; } // All other cases

  return (PyObject*)self.release();

invalid_arguments:
  THPUtils_invalidArguments(args, THSPTensorStr " constructor", 5,
      "no arguments",
      "(int size)",
      "(" THSPTensorStr " view_source)",
      "(" THSPTensorStr " view_source, int offset)",
...
PyTypeObject THSPTensorType = {
  ...
  "torch._C." THSPTensorBaseStr,         /* tp_name */
...
PyTypeObject THSPTensorStatelessType = {
  PyVarObject_HEAD_INIT(NULL, 0)
  "torch._C." THSPTensorBaseStr ".stateless", /* tp_name */
