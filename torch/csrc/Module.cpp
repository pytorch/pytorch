...
static PyObject* THPModule_crashIfCsrcASAN(
    PyObject* /*module*/,
    PyObject* arg) {
  HANDLE_TH_ERRORS
  TORCH_CHECK(
...
static PyObject* THPModule_crashIfCsrcUBSAN(
    PyObject* /*module*/,
    PyObject* arg) {
  HANDLE_TH_ERRORS
  TORCH_CHECK(
...
static PyObject* THPModule_crashIfvptrUBSAN(
    PyObject* /*module*/,
    PyObject* /*noarg*/) {
...
static PyObject* THPModule_crashIfATenASAN(
    PyObject* /*module*/,
    PyObject* arg) {
  HANDLE_TH_ERRORS
  TORCH_CHECK(
...
static PyObject* THPModule_getNumThreads(
    PyObject* /*module*/,
    PyObject* /*noargs*/) {
...
static PyObject* THPModule_setDefaultDtype(
    PyObject* /*_unused*/,
    PyObject* dtype) {
  HANDLE_TH_ERRORS
...
static PyObject* THPModule_swap_tensor_impl(
    PyObject* /*_unused*/,
    PyObject* args) {
  HANDLE_TH_ERRORS
  PyObject* a_ = nullptr;
...
static PyObject* THPModule_hasDistributed(
    PyObject* /*_unused*/,
    PyObject* /*noargs*/) {
#ifdef USE_DISTRIBUTED
  Py_RETURN_TRUE;
...
static PyObject* THPModule_showConfig(
    PyObject* /*module*/,
    PyObject* /*noargs*/) {
  HANDLE_TH_ERRORS
...
static PyObject* THPModule_cxxFlags(
    PyObject* /*module*/,
    PyObject* /*noargs*/) {
  HANDLE_TH_ERRORS
...
static PyObject* THPModule_parallelInfo(
    PyObject* /*module*/,
    PyObject* /*noargs*/) {
  HANDLE_TH_ERRORS
...
template <class T>
PyObject* THPModule_toDLPackImpl(PyObject* args, PyObject* kwargs) {
  HANDLE_TH_ERRORS
...
static PyObject* THModule_getCppBacktrace(
    PyObject* /*_unused*/,
    PyObject* args) {
  HANDLE_TH_ERRORS
...
static PyObject* THPModule_setAllowTF32CuDNN(
    PyObject* /*_unused*/,
    PyObject* arg) {
  HANDLE_TH_ERRORS
  TORCH_CHECK(
...
static PyObject* THPModule_allowTF32CuDNN(
    PyObject* /*_unused*/,
    PyObject* /*noargs*/) {
  HANDLE_TH_ERRORS
...
static PyObject* THPModule_setSDPUseFlash(
    PyObject* /*_unused*/,
    PyObject* arg) {
  HANDLE_TH_ERRORS
  TORCH_CHECK(
...
static PyObject* THPModule_setSDPUseCuDNN(
    PyObject* /*_unused*/,
    PyObject* arg) {
  HANDLE_TH_ERRORS
  TORCH_CHECK(
...
static PyObject* THPModule_warnAlways(
    PyObject* /*_unused*/,
    PyObject* /*noargs*/) {
...
static PyObject* THPModule_setBenchmarkCuDNN(
    PyObject* /*_unused*/,
    PyObject* arg) {
  HANDLE_TH_ERRORS
  TORCH_CHECK(
...
static PyObject* THPModule_benchmarkCuDNN(
    PyObject* /*_unused*/,
    PyObject* /*noargs*/) {
...
static PyObject* THPModule_setFlushDenormal(
    PyObject* /*_unused*/,
    PyObject* arg) {
  HANDLE_TH_ERRORS
  TORCH_CHECK(
...
static PyObject* THPModule_getDefaultDtype(
    PyObject* /*_unused*/,
    PyObject* /*arg*/) {
  HANDLE_TH_ERRORS
...
static PyObject* THPModule_getDefaultDevice(
    PyObject* /*_unused*/,
    PyObject* /*arg*/) {
  HANDLE_TH_ERRORS
...
static PyObject* THPModule_qEngine(
    PyObject* /*_unused*/,
    PyObject* /*noargs*/) {
...
static PyObject* THPModule_getCurrentNode(
    PyObject* /*_unused*/,
    PyObject* /*noargs*/) {
  HANDLE_TH_ERRORS
