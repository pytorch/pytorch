...
PyObject* THModule_getCppBacktrace(PyObject* _unused, PyObject* args) {
  ...
  if (!PyArg_ParseTuple(args, "LL", &frames_to_skip, &maximum_number_of_frames)) {
    return nullptr;
  }
  return THPUtils_packString(c10::get_backtrace(frames_to_skip, maximum_number_of_frames, true));
  END_HANDLE_TH_ERRORS
}
...
static PyMethodDef TorchMethods[] = {
    ...
    {"_get_cpp_backtrace", THModule_getCppBacktrace, METH_O, nullptr},
