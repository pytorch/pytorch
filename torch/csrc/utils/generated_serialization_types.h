...
// checksum<<41e673492bd599cd8a4bf77cfed99deaedcefa98493243a62fa489f51b096bcc>>
// clang-format off
...
class ExternKernelNodes {
 private:
  ...
  std::optional<bool> is_oss = std::nullopt;
 ...
 public:
  ...
  const std::optional<bool>& get_is_oss() const {
    return is_oss;
  }

  void set_is_oss(std::optional<bool> def) {
    is_oss = std::move(def);
  }
...
inline void to_json(nlohmann::json& nlohmann_json_j, const ExternKernelNodes& nlohmann_json_t) {
  ...
  nlohmann_json_j["is_oss"] = nlohmann_json_t.is_oss;
}
...
inline void from_json(const nlohmann::json& nlohmann_json_j, ExternKernelNodes& nlohmann_json_t) {
  ...
  nlohmann_json_t.is_oss = nlohmann_json_j.value("is_oss", nlohmann_json_default_obj.is_oss);
}
