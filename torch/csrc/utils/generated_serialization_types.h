...
// checksum<<1adb86b37dd507911e82df917815b59f970d08641bdfa8ba0a15d9fdc7754dbf>>
// clang-format off
...
class AOTInductorModelPickleData {
 private:
  ...
  std::optional<std::string> lowered_module_name = std::nullopt;
 ...
 public:
  ...
  const std::optional<std::string>& get_lowered_module_name() const {
    return lowered_module_name;
  }

  void set_lowered_module_name(std::optional<std::string> def) {
    lowered_module_name = std::move(def);
  }
...
inline void to_json(nlohmann::json& nlohmann_json_j, const AOTInductorModelPickleData& nlohmann_json_t) {
  ...
  nlohmann_json_j["lowered_module_name"] = nlohmann_json_t.lowered_module_name;
}
...
inline void from_json(const nlohmann::json& nlohmann_json_j, AOTInductorModelPickleData& nlohmann_json_t) {
  ...
  nlohmann_json_t.lowered_module_name = nlohmann_json_j.value("lowered_module_name", nlohmann_json_default_obj.lowered_module_name);
}
