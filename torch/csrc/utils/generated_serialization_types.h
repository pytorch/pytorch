...
// checksum<<50ba8974c8e63c47ff8aa8b849d7bddf364e5fe22ed89afc7c6c967bae332c6a>>
// clang-format off
...
class ExportedProgram {
 private:
  ...
  std::optional<std::string> autocast_state = std::nullopt;
 ...
 public:
  ...
  const std::optional<std::string>& get_autocast_state() const {
    return autocast_state;
  }

  void set_autocast_state(std::optional<std::string> def) {
    autocast_state = std::move(def);
  }
...
inline void to_json(nlohmann::json& nlohmann_json_j, const ExportedProgram& nlohmann_json_t) {
  ...
  nlohmann_json_j["autocast_state"] = nlohmann_json_t.autocast_state;
}
...
inline void from_json(const nlohmann::json& nlohmann_json_j, ExportedProgram& nlohmann_json_t) {
  ...
  nlohmann_json_t.autocast_state = nlohmann_json_j.value("autocast_state", nlohmann_json_default_obj.autocast_state);
}
