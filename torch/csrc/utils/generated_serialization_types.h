...
// checksum<<053b31e50ad2c69b96a339f33e83fec38a64bafd3dd65f2494379f7780f5c586>>
// clang-format off
...
class GraphModule {
 private:
  ...
  std::unordered_map<std::string, std::string> metadata = {};
  std::unordered_map<std::string, std::vector<std::string>> treespec_namedtuple_fields = {};
 ...
 public:
  ...
  const std::unordered_map<std::string, std::vector<std::string>>& get_treespec_namedtuple_fields() const {
