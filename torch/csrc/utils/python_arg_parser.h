...
struct PythonArgs {
  ...
  inline c10::SymIntArray symintlist(int i);
...
inline c10::SymIntArray PythonArgs::symintlist(int i) {
  auto intlist = intlistWithDefault(i, signature.params[i].default_intlist);
  return c10::SymIntArray(c10::fmap(intlist, [](int64_t n) {return c10::SymInt(n); }));
}
