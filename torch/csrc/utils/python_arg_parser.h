...
struct PythonArgs {
  ...
  inline c10::optional<at::IntArrayRef> intlistOptional(int i);
...
inline c10::optional<at::IntArrayRef> PythonArgs::intlistOptional(int i) {
  if (!args[i])
    return c10::nullopt;
  return at::IntArrayRef(intlist(i));
}
