 ...
 * In the future all additional statics should be added here. This struct
 * is exposed as an object to python with the following read-only properties:
 *
 * stats.qps
 * stats.num_forwards
 ...
 *
 */
struct TORCH_API BenchmarkExecutionStats {
 ...
 */
struct TORCH_API BenchmarkConfig {
 public:
 ...
 */
class TORCH_API ThroughputBenchmark {
 public:
