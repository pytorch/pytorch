...
Tensor dispatch_zeros(const Type& type, optional<Device> device, IntListRef sizes) {
  maybe_initialize_cuda(type);
  AutoNoGIL no_gil;
  return torch::zeros(sizes, type.options(std::move(device)));
}

Tensor dispatch_ones(const Type& type, optional<Device> device, IntListRef sizes) {
  maybe_initialize_cuda(type);
  AutoNoGIL no_gil;
  return torch::ones(sizes, type.options(std::move(device)));
}

Tensor dispatch_full(const Type& type, Scalar fill_value, optional<Device> device, IntListRef sizes) {
  maybe_initialize_cuda(type);
  AutoNoGIL no_gil;
  return torch::full(sizes, fill_value, type.options(std::move(device)));
}

Tensor new_with_sizes(const Type& type, optional<Device> device, IntListRef sizes) {
  maybe_initialize_cuda(type);
  AutoNoGIL no_gil;
...
void recursive_store(char* data, IntListRef sizes, IntListRef strides, int64_t dim,
...
Tensor legacy_sparse_tensor_ctor(const Type& type, PyObject* args, PyObject* kwargs) {
  static PythonArgParser parser({
    ...
    "new(Tensor indices, Tensor values, IntListRef size, *, Device? device=None)",
    "new(IntListRef size, *, Device? device=None)",
  });
...
Tensor sparse_coo_tensor_ctor(const Type& default_type, PyObject* args, PyObject* kwargs) {
  static PythonArgParser parser({
    ...
    "sparse_coo_tensor(PyObject* indices, PyObject* values, IntListRef size, *, ScalarType dtype=None, Device? device=None, bool requires_grad=False)",
    "sparse_coo_tensor(IntListRef size, *, ScalarType dtype=None, Device? device=None, bool requires_grad=False)",
  });
...
Tensor new_empty(const Type& type, PyObject* args, PyObject* kwargs) {
  static PythonArgParser parser({
    "new_empty(IntListRef size, *, ScalarType dtype=None, Device? device=None, bool requires_grad=False)",
  }, /*traceable=*/true);
...
Tensor new_full(const Type& type, PyObject* args, PyObject* kwargs) {
  static PythonArgParser parser({
    "new_full(IntListRef size, Scalar fill_value, *, ScalarType dtype=None, Device? device=None, bool requires_grad=False)",
  }, /*traceable=*/true);
...
Tensor new_ones(const Type& type, PyObject* args, PyObject* kwargs) {
  static PythonArgParser parser({
    "new_ones(IntListRef size, *, ScalarType dtype=None, Device? device=None, bool requires_grad=False)",
  }, /*traceable=*/true);
...
Tensor new_zeros(const Type& type, PyObject* args, PyObject* kwargs) {
  static PythonArgParser parser({
    "new_zeros(IntListRef size, *, ScalarType dtype=None, Device? device=None, bool requires_grad=False)",
  }, /*traceable=*/true);
