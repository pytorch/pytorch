...
template<> struct type_caster<at::IntListRef> {
public:
  PYBIND11_TYPE_CASTER(at::IntListRef, _("at::IntListRef"));
  ...
  static handle cast(at::IntListRef src, return_value_policy /* policy */, handle /* parent */) {
