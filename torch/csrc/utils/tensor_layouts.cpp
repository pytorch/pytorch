...
void initializeLayouts() {
  ...
  PyObject *sparse_gcs_layout = THPLayout_New(at::Layout::CompressedRowSparse, "torch.sparse_gcs");
  Py_INCREF(sparse_gcs_layout);
  if (PyModule_AddObject(torch_module, "sparse_gcs", sparse_gcs_layout) != 0) {
    throw python_error();
  }
  registerLayoutObject((THPLayout*)sparse_gcs_layout, at::Layout::CompressedRowSparse);  
