...
inline Tensor dispatch__cudnn_init_dropout_state(double dropout, bool train, int64_t dropout_seed, ScalarType dtype, Layout layout, Device device, bool pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::__cudnn_init_dropout_state(dropout, train, dropout_seed, dtype, layout, device, pin_memory, requires_grad);
}
...
inline Tensor dispatch__empty_affine_quantized(IntArrayRef size, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad, double scale, int64_t zero_point, c10::optional<MemoryFormat> memory_format) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::__empty_affine_quantized(size, dtype, layout, device, pin_memory, requires_grad, scale, zero_point, memory_format);
}
inline Tensor dispatch__empty_per_channel_affine_quantized(IntArrayRef size, const Tensor & scales, const Tensor & zero_points, int64_t axis, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad, c10::optional<MemoryFormat> memory_format) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_bartlett_window(int64_t window_length, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_bartlett_window(window_length, dtype, layout, device, pin_memory, requires_grad);
}
inline Tensor dispatch_bartlett_window(int64_t window_length, bool periodic, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_bitwise_and(const Tensor & self, const Tensor & other, Tensor out) {


  pybind11::gil_scoped_release no_gil;
  return at::bitwise_and_out(out, self, other);
}
inline Tensor dispatch_bitwise_and(const Tensor & self, const Tensor & other) {


  pybind11::gil_scoped_release no_gil;
  return self.bitwise_and(other);
}
inline Tensor dispatch_bitwise_and(const Tensor & self, Scalar other, Tensor out) {


  pybind11::gil_scoped_release no_gil;
  return at::bitwise_and_out(out, self, other);
}
inline Tensor dispatch_bitwise_and(const Tensor & self, Scalar other) {
...
inline Tensor dispatch_blackman_window(int64_t window_length, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_blackman_window(window_length, dtype, layout, device, pin_memory, requires_grad);
}
inline Tensor dispatch_blackman_window(int64_t window_length, bool periodic, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_diagonal(const Tensor & self, Dimname outdim, Dimname dim1, Dimname dim2, int64_t offset) {
...
inline Tensor dispatch_empty(IntArrayRef size, c10::optional<DimnameList> names, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad, c10::optional<MemoryFormat> memory_format) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_empty(IntArrayRef size, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad, c10::optional<MemoryFormat> memory_format) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_empty(size, dtype, layout, device, pin_memory, requires_grad, memory_format);
}
inline Tensor dispatch_empty_like(const Tensor & self, ScalarType dtype, Layout layout, Device device, bool pin_memory, c10::optional<MemoryFormat> memory_format, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_empty_like(self, dtype, layout, device, pin_memory, requires_grad, memory_format);
}
...
inline Tensor dispatch_empty_strided(IntArrayRef size, IntArrayRef stride, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_eye(int64_t n, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_eye(int64_t n, int64_t m, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_floor_divide(const Tensor & input, const Tensor & other) {


  pybind11::gil_scoped_release no_gil;
  return at::floor_divide(input, other);
}
inline Tensor dispatch_floor_divide(const Tensor & input, Scalar other) {
...
inline Tensor dispatch_from_file(std::string filename, c10::optional<bool> shared, c10::optional<int64_t> size, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_from_file(filename, shared, size, dtype, layout, device, pin_memory, requires_grad);
}
inline Tensor dispatch_full(IntArrayRef size, Scalar fill_value, c10::optional<DimnameList> names, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_full(IntArrayRef size, Scalar fill_value, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_full(size, fill_value, dtype, layout, device, pin_memory, requires_grad);
}
inline Tensor dispatch_full_like(const Tensor & self, Scalar fill_value, ScalarType dtype, Layout layout, Device device, bool pin_memory, c10::optional<MemoryFormat> memory_format, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_full_like(self, fill_value, dtype, layout, device, pin_memory, requires_grad, memory_format);
}
...
inline Tensor dispatch_hamming_window(int64_t window_length, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_hamming_window(window_length, dtype, layout, device, pin_memory, requires_grad);
}
inline Tensor dispatch_hamming_window(int64_t window_length, bool periodic, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_hamming_window(window_length, periodic, dtype, layout, device, pin_memory, requires_grad);
}
inline Tensor dispatch_hamming_window(int64_t window_length, bool periodic, double alpha, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_hamming_window(window_length, periodic, alpha, dtype, layout, device, pin_memory, requires_grad);
}
inline Tensor dispatch_hamming_window(int64_t window_length, bool periodic, double alpha, double beta, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_hamming_window(window_length, periodic, alpha, beta, dtype, layout, device, pin_memory, requires_grad);
}
inline Tensor dispatch_hann_window(int64_t window_length, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_hann_window(window_length, dtype, layout, device, pin_memory, requires_grad);
}
inline Tensor dispatch_hann_window(int64_t window_length, bool periodic, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_linspace(Scalar start, Scalar end, int64_t steps, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_logical_and(const Tensor & self, const Tensor & other, Tensor out) {


  pybind11::gil_scoped_release no_gil;
  return at::logical_and_out(out, self, other);
}
inline Tensor dispatch_logical_and(const Tensor & self, const Tensor & other) {
...
inline Tensor dispatch_logical_or(const Tensor & self, const Tensor & other, Tensor out) {


  pybind11::gil_scoped_release no_gil;
  return at::logical_or_out(out, self, other);
}
inline Tensor dispatch_logical_or(const Tensor & self, const Tensor & other) {
...
inline Tensor dispatch_logspace(Scalar start, Scalar end, int64_t steps, double base, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_normal(double mean, double std, IntArrayRef size, Generator * generator, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_ones(IntArrayRef size, c10::optional<DimnameList> names, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_ones(IntArrayRef size, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_ones(size, dtype, layout, device, pin_memory, requires_grad);
}
inline Tensor dispatch_ones_like(const Tensor & self, ScalarType dtype, Layout layout, Device device, bool pin_memory, c10::optional<MemoryFormat> memory_format, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_ones_like(self, dtype, layout, device, pin_memory, requires_grad, memory_format);
}
...
inline Tensor dispatch_rand(IntArrayRef size, c10::optional<DimnameList> names, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_rand(size, names, dtype, layout, device, pin_memory, requires_grad);
}
inline Tensor dispatch_rand(IntArrayRef size, Generator * generator, c10::optional<DimnameList> names, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_rand(IntArrayRef size, Generator * generator, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_rand(IntArrayRef size, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_rand(size, dtype, layout, device, pin_memory, requires_grad);
}
inline Tensor dispatch_rand_like(const Tensor & self, ScalarType dtype, Layout layout, Device device, bool pin_memory, c10::optional<MemoryFormat> memory_format, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_rand_like(self, dtype, layout, device, pin_memory, requires_grad, memory_format);
}
...
inline Tensor dispatch_randint_like(const Tensor & self, int64_t high, ScalarType dtype, Layout layout, Device device, bool pin_memory, c10::optional<MemoryFormat> memory_format, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_randint_like(self, high, dtype, layout, device, pin_memory, requires_grad, memory_format);
}
...
inline Tensor dispatch_randint_like(const Tensor & self, int64_t low, int64_t high, ScalarType dtype, Layout layout, Device device, bool pin_memory, c10::optional<MemoryFormat> memory_format, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_randint_like(self, low, high, dtype, layout, device, pin_memory, requires_grad, memory_format);
}
...
inline Tensor dispatch_randn(IntArrayRef size, c10::optional<DimnameList> names, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_randn(size, names, dtype, layout, device, pin_memory, requires_grad);
}
inline Tensor dispatch_randn(IntArrayRef size, Generator * generator, c10::optional<DimnameList> names, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_randn(IntArrayRef size, Generator * generator, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_randn(IntArrayRef size, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_randn(size, dtype, layout, device, pin_memory, requires_grad);
}
inline Tensor dispatch_randn_like(const Tensor & self, ScalarType dtype, Layout layout, Device device, bool pin_memory, c10::optional<MemoryFormat> memory_format, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_randn_like(self, dtype, layout, device, pin_memory, requires_grad, memory_format);
}
...
inline Tensor dispatch_randperm(int64_t n, Generator * generator, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_randperm(int64_t n, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_scalar_tensor(Scalar s, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_square(const Tensor & self) {


  pybind11::gil_scoped_release no_gil;
  return self.square();
}
inline Tensor dispatch_square_(Tensor self) {
...
inline Tensor dispatch_tril_indices(int64_t row, int64_t col, int64_t offset, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_triu_indices(int64_t row, int64_t col, int64_t offset, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_zeros(IntArrayRef size, c10::optional<DimnameList> names, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
...
inline Tensor dispatch_zeros(IntArrayRef size, c10::optional<ScalarType> dtype, c10::optional<Layout> layout, c10::optional<Device> device, c10::optional<bool> pin_memory, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_zeros(size, dtype, layout, device, pin_memory, requires_grad);
}
inline Tensor dispatch_zeros_like(const Tensor & self, ScalarType dtype, Layout layout, Device device, bool pin_memory, c10::optional<MemoryFormat> memory_format, c10::optional<bool> requires_grad) {
  const auto options = TensorOptions().dtype(dtype).device(device)                     .layout(layout).pinned_memory(pin_memory).requires_grad(requires_grad);
  torch::utils::maybe_initialize_cuda(options);
  pybind11::gil_scoped_release no_gil;
  return torch::_zeros_like(self, dtype, layout, device, pin_memory, requires_grad, memory_format);
}
