...
static PyObject * THPVariable_thnn_col2im(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "thnn_col2im(Tensor input, IntList[2] output_size, IntList[2] kernel_size, IntList[2] dilation, IntList[2] padding, IntList[2] stride)",
  }, /*traceable=*/true);
...
static PyObject * THPVariable_thnn_im2col(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "thnn_im2col(Tensor input, IntList[2] kernel_size, IntList[2] dilation, IntList[2] padding, IntList[2] stride)",
  }, /*traceable=*/true);
...
static PyObject * THPVariable_upsample_bicubic2d(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "upsample_bicubic2d(Tensor input, IntList[2] output_size, bool align_corners, *, Tensor out=None)",
  }, /*traceable=*/true);
