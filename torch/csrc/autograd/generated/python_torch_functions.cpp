...
static PyObject * THPVariable__nnpack_spatial_convolution(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch__nnpack_spatial_convolution(r.tensor(0), r.tensor(1), r.tensor(2), r.intlist(3), r.intlist(4)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable__use_cudnn_ctc_loss(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch__use_cudnn_ctc_loss(r.tensor(0), r.tensor(1), r.intlist(2), r.intlist(3), r.toInt64(4)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_angle(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    if (r.isNone(1)) {
      return wrap(dispatch_angle(r.tensor(0)));
    } else {
      return wrap(dispatch_angle(r.tensor(0), r.tensor(1)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_batch_norm_elemt(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    if (r.isNone(6)) {
      ...
      return wrap(dispatch_batch_norm_elemt(r.tensor(0), r.tensor(1), r.tensor(2), r.tensor(3), r.tensor(4), r.toDouble(5), r.tensor(6)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_bitwise_and(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    if (r.isNone(2)) {
      return wrap(dispatch_bitwise_and(r.tensor(0), r.tensor(1)));
    } else {
      return wrap(dispatch_bitwise_and(r.tensor(0), r.tensor(1), r.tensor(2)));
    }
  } else if (r.idx == 1) {
    if (r.isNone(2)) {
      return wrap(dispatch_bitwise_and(r.tensor(0), r.scalar(1)));
    } else {
      return wrap(dispatch_bitwise_and(r.tensor(0), r.scalar(1), r.tensor(2)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_bitwise_xor(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    if (r.isNone(2)) {
      return wrap(dispatch_bitwise_xor(r.tensor(0), r.tensor(1)));
    } else {
      return wrap(dispatch_bitwise_xor(r.tensor(0), r.tensor(1), r.tensor(2)));
    }
  } else if (r.idx == 1) {
    if (r.isNone(2)) {
      return wrap(dispatch_bitwise_xor(r.tensor(0), r.scalar(1)));
    } else {
      return wrap(dispatch_bitwise_xor(r.tensor(0), r.scalar(1), r.tensor(2)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_can_cast(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_can_cast(r.scalartype(0), r.scalartype(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_cdist(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_cdist(r.tensor(0), r.tensor(1), r.toDouble(2), r.toInt64Optional(3)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_clone(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_clone(r.tensor(0), r.memoryformatOptional(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_conj(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    if (r.isNone(1)) {
      return wrap(dispatch_conj(r.tensor(0)));
    } else {
      return wrap(dispatch_conj(r.tensor(0), r.tensor(1)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_diagonal(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_diagonal(r.tensor(0), r.dimname(1), r.dimname(2), r.dimname(3), r.toInt64(4)));
  } else if (r.idx == 1) {
...
static PyObject * THPVariable_fake_quantize_per_channel_affine(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_fake_quantize_per_channel_affine(r.tensor(0), r.tensor(1), r.tensor(2), r.toInt64(3), r.toInt64(4), r.toInt64(5)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_floor_divide(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_floor_divide(r.tensor(0), r.tensor(1)));
  } else if (r.idx == 1) {
    return wrap(dispatch_floor_divide(r.tensor(0), r.scalar(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_imag(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    if (r.isNone(1)) {
      return wrap(dispatch_imag(r.tensor(0)));
    } else {
      return wrap(dispatch_imag(r.tensor(0), r.tensor(1)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_isfinite(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_isfinite(r.tensor(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_logical_and(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    if (r.isNone(2)) {
      return wrap(dispatch_logical_and(r.tensor(0), r.tensor(1)));
    } else {
      return wrap(dispatch_logical_and(r.tensor(0), r.tensor(1), r.tensor(2)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_logical_or(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    if (r.isNone(2)) {
      return wrap(dispatch_logical_or(r.tensor(0), r.tensor(1)));
    } else {
      return wrap(dispatch_logical_or(r.tensor(0), r.tensor(1), r.tensor(2)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_promote_types(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_promote_types(r.scalartype(0), r.scalartype(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_quantized_lstm(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_quantized_lstm(r.tensor(0), r.tensor(1), r.tensorlist(2), r.tensorlist(3), r.toBool(4), r.toInt64(5), r.toDouble(6), r.toBool(7), r.toBool(8), r.scalartypeOptional(9), r.toBool(10)));
  } else if (r.idx == 1) {
...
static PyObject * THPVariable_quantized_max_pool2d(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_quantized_max_pool2d(r.tensor(0), r.intlist(1), r.intlist(2), r.intlist(3), r.intlist(4), r.toBool(5)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_real(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    if (r.isNone(1)) {
      return wrap(dispatch_real(r.tensor(0)));
    } else {
      return wrap(dispatch_real(r.tensor(0), r.tensor(1)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_resize_as_(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_resize_as_(r.tensor(0), r.tensor(1), r.memoryformatOptional(2)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_square(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_square(r.tensor(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable_square_(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_square_(r.tensor(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
