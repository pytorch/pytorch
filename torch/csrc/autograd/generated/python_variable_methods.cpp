...
static PyObject * THPVariable_align_to(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    ...
    return wrap(dispatch_align_to(self, r.dimnamelist(0), r.toInt64(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_bitwise_and(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_bitwise_and(self, r.tensor(0)));
  } else if (r.idx == 1) {
    return wrap(dispatch_bitwise_and(self, r.scalar(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable_bitwise_and_(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_bitwise_and_(self, r.tensor(0)));
  } else if (r.idx == 1) {
    return wrap(dispatch_bitwise_and_(self, r.scalar(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_bitwise_xor(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_bitwise_xor(self, r.tensor(0)));
  } else if (r.idx == 1) {
    return wrap(dispatch_bitwise_xor(self, r.scalar(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable_bitwise_xor_(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_bitwise_xor_(self, r.tensor(0)));
  } else if (r.idx == 1) {
    return wrap(dispatch_bitwise_xor_(self, r.scalar(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_clone(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_clone(self, r.memoryformatOptional(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_diagonal(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_diagonal(self, r.dimname(0), r.dimname(1), r.dimname(2), r.toInt64(3)));
  } else if (r.idx == 1) {
...
static PyObject * THPVariable_index_fill_(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_index_fill_(self, r.dimname(0), r.tensor(1), r.tensor(2)));
  } else if (r.idx == 1) {
    return wrap(dispatch_index_fill_(self, r.toInt64(0), r.tensor(1), r.tensor(2)));
  } else if (r.idx == 2) {
    return wrap(dispatch_index_fill_(self, r.dimname(0), r.tensor(1), r.scalar(2)));
  } else if (r.idx == 3) {
...
static PyObject * THPVariable_logical_and(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_logical_and(self, r.tensor(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable_logical_and_(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_logical_and_(self, r.tensor(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_logical_or(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_logical_or(self, r.tensor(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable_logical_or_(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_logical_or_(self, r.tensor(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_resize_(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_resize_(self, r.intlist(0), r.memoryformatOptional(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable_resize_as_(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    return wrap(dispatch_resize_as_(self, r.tensor(0), r.memoryformatOptional(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
