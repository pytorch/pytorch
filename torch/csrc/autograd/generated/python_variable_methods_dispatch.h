...
inline Tensor dispatch_bitwise_and(Tensor & self, const Tensor & other) {

  pybind11::gil_scoped_release no_gil;
  return self.bitwise_and(other);
}
inline Tensor dispatch_bitwise_and(Tensor & self, Scalar other) {

  pybind11::gil_scoped_release no_gil;
  return self.bitwise_and(other);
}
inline Tensor dispatch_bitwise_and_(Tensor & self, const Tensor & other) {

  pybind11::gil_scoped_release no_gil;
  return self.bitwise_and_(other);
}
inline Tensor dispatch_bitwise_and_(Tensor & self, Scalar other) {
...
inline Tensor dispatch_square(Tensor & self) {
