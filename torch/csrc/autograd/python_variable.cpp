...
PyObject* THPVariable_Wrap(at::TensorBase var) {
  ...
  c10::optional<PyObject*> mb_obj =
      var.unsafeGetTensorImpl()->pyobj_slot()->check_pyobj(self_interpreter.get());
  c10::impl::PyInterpreterStatus status;
  if (mb_obj.has_value()) {
    auto obj = *mb_obj;
    if (obj) {
...
bool isResurrectable(THPVariable* self) {
  ...
  if (tensor.unsafeGetTensorImpl()->pyobj_slot()->check_pyobj(self_interpreter.get()) !=
...
static int THPVariable_clear(THPVariable* self) {
  ...
  if (tensor.defined()) {
    ...
    if (!self->cdata.unsafeIsBorrowed() &&
        tensor.unsafeGetTensorImpl()->pyobj_slot()->check_pyobj(self_interpreter.get()) ==
            c10::make_optional((PyObject*)self)) {
      ...
      //  c10::Error: !tensor.unsafeGetTensorImpl()->pyobj_slot()->owns_pyobj()INTERNAL ASSERT
...
static PyObject* THPVariable_NewWithVar(
  ...
  auto mb_obj = _var.unsafeGetTensorImpl()->pyobj_slot()->check_pyobj(self_interpreter.get());
  TORCH_CHECK(
...
c10::IntArrayRef ConcretePyInterpreterVTable::strides(
  ...
  c10::optional<PyObject*> mb_obj = self->pyobj_slot()->check_pyobj(getPyInterpreter());
  TORCH_CHECK(
...
static std::vector<int64_t> values_from_buffer(
  ...
  c10::optional<PyObject*> mb_obj = ptr->pyobj_slot()->check_pyobj(getPyInterpreter());
  TORCH_CHECK(
      mb_obj.has_value(), "Tensor subclass's PyInterpreter has no value");
