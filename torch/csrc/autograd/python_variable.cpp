...
PyObject *THPVariable_is_sparse_bsr(THPVariable *self, void *unused)
{
  HANDLE_TH_ERRORS
  if (check_has_torch_function((PyObject *)self)) {
    return handle_torch_function_getter(self, "is_sparse_bsr");
  }
  auto& self_ = THPVariable_Unpack(self);
  return torch::autograd::utils::wrap(self_.is_sparse_bsr());
  END_HANDLE_TH_ERRORS
}
...
static struct PyGetSetDef THPVariable_properties[] = {
  ...
  {"is_sparse_bsr", (getter)THPVariable_is_sparse_bsr, nullptr, nullptr, nullptr},
