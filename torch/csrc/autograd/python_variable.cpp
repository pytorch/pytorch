...
PyObject *THPVariable_is_dml(THPVariable *self, void *unused)
{
  HANDLE_TH_ERRORS
  if (check_has_torch_function((PyObject *)self)) {
    return handle_torch_function_getter(self, "is_dml");
  }
  auto& self_ = THPVariable_Unpack(self);
  return torch::autograd::utils::wrap(self_.is_dml());
  END_HANDLE_TH_ERRORS
}
...
static struct PyGetSetDef THPVariable_properties[] = {
    ...
    {"is_dml", (getter)THPVariable_is_dml, nullptr, nullptr, nullptr},
