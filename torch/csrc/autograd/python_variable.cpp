...
PyObject* THPVariable_is_onednn(THPVariable* self, void* unused) {
  HANDLE_TH_ERRORS
  if (check_has_torch_function((PyObject*)self)) {
    return handle_torch_function_getter(self, "is_onednn");
  }
  auto& self_ = THPVariable_Unpack(self);
  return torch::autograd::utils::wrap(self_.is_onednn());
  END_HANDLE_TH_ERRORS
}
...
static struct PyGetSetDef THPVariable_properties[] = {
    ...
    {"is_sparse_csr",
     ...
     nullptr,
     nullptr},
    {"is_mkldnn", (getter)THPVariable_is_onednn, nullptr, nullptr, nullptr}, // Will be deprecated.
    {"is_onednn", (getter)THPVariable_is_onednn, nullptr, nullptr, nullptr},
