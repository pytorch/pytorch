...
static PyObject *THPVariable_pynew(PyTypeObject *type, PyObject *args, PyObject *kwargs)
{
  ...
  auto default_type = torch::tensors::get_default_tensor_type().aten_type();
  auto default_scalar_type = static_cast<ScalarType>(torch::tensors::get_default_tensor_type().scalar_type);
