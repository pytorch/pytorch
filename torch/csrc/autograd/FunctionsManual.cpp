...
static inline std::tuple<Tensor, Tensor, Tensor> _betainc_modified_lentz_method(
  ...
  auto __continued_fraction_step =
    ...
    std::tuple<Tensor, Tensor> _fn_ret =
  ...
  auto __continued_fraction_evaluation =
    ...
    std::tuple<std::vector<Tensor>, std::vector<Tensor>, Tensor> _ret =
        __continued_fraction_step(
    ...
    std::tuple<std::vector<Tensor>, std::vector<Tensor>, Tensor> ret =
        __continued_fraction_step(
            iteration,
            _new_values,
            _new_gradients,
            _betainc_odd_partial_numerator);
...
static inline std::tuple<Tensor, Tensor> _betainc_der_continued_fraction(
  ...
  std::tuple<Tensor, Tensor, Tensor> _ret_lentz =
...
static inline std::tuple<Tensor, Tensor, Tensor> _betainc_partials(
  ...
  Tensor use_power_series =
      (((_x < _a / (_a + _b)) & (_b * _x <= one) & (_x <= point_nine_five)) |
       ((_x >= _a / (_a + _b)) & (_a * (one - _x) <= one) &
        (_x >= point_o_five)));
  std::tuple<Tensor, Tensor> ps_grads =
  ...
  std::tuple<Tensor, Tensor> cf_grads =
...
static inline std::tuple<Tensor, Tensor, Tensor> _betaincinv_partials(
  ...
  auto [g_a, g_b, g_x] = _betainc_partials(a, b, _x);
