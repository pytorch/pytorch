...
// Tensor _to_always_copy_backward(const Tensor& grad, const TensorOptions& result_options) {
//   return grad.to(
//       typeMetaToScalarType(result_options.dtype()),
//       result_options.layout(),
//       result_options.device(),
//       result_options.pinned_memory(),
//       result_options.memory_format_opt());
// }
