...
Tensor frobenius_norm_backward(Tensor grad, const Tensor& self, at::Tensor norm, const optional<IntArrayRef>& opt_dim, bool keepdim) {
  std::cout << "THIS IS BACKWARDDDD\n\n\n";
  return self;
}

Tensor frobenius_norm_backward(Tensor grad, const Tensor& self, at::Tensor norm) {
  std::cout << "THIS IS BACKWARDDDD SCALAR\n\n\n";
  return self;
}
