...
static IntListRef slicePrefix1sSize(IntListRef sizes) {
...
static void copy_to(Variable dst, const Variable& src) {
  Tensor b_src;
  IntListRef sliced_src_sizes = slicePrefix1sSize(src.sizes());
...
int THPVariable_setitem(PyObject* self, PyObject* index, PyObject* py_value) {
  ...
  IntListRef slicedValueSizes = slicePrefix1sSize(value.sizes());
