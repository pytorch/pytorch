...
static PyObject * THPVariable_arange(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    if (r.isNone(1)) {
      ...
      check_out_type_matches(r.tensor(1), r.scalartypeOptional(2), r.layout(3),
    ...
    if (r.isNone(3)) {
      ...
      check_out_type_matches(r.tensor(3), r.scalartypeOptional(4), r.layout(5),
...
static PyObject * THPVariable_full(PyObject* self, PyObject* args, PyObject* kwargs) {
  ...
  if (r.idx == 0) {
    ...
    check_out_type_matches(result, r.scalartypeOptional(3), r.layout(4),
