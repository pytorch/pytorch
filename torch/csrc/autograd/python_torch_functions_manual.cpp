...
static PyObject* THPVariable_sparse_coo_tensor(
  ...
  static PythonArgParser parser({
      ...
      "sparse_coo_tensor(PyObject* indices, PyObject* values, IntArrayRef size, *, ScalarType dtype=None, Device? device=None, bool pin_memory=False, bool check_invariants=None, bool requires_grad=False, bool is_coalesced=None)",
