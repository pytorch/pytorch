...
struct FunctionFlags {
  ...
  // roughly speaking, both is_executable and is_volatile specify whether or
  // not backwards gradient computation will be performed for a function,
  // but they differ in their precedence.
