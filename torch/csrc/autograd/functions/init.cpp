...
static PyObject *differentiableGraphBackwardRepr(PyObject *obj) {
  using T = torch::jit::detail::DifferentiableGraphBackward;
  HANDLE_TH_ERRORS
  THPCppFunction* self = (THPCppFunction*)obj;
  T *ptr = (T *)self->cdata.get();
  return PyUnicode_FromString(ptr->toString().c_str());
  END_HANDLE_TH_ERRORS
}
...
void THPAutograd_initFunctions()
{
  ...
  static PyTypeObject DifferentiableGraphBackward;
  DifferentiableGraphBackward.tp_repr = (reprfunc)differentiableGraphBackwardRepr;
  addClass<torch::jit::detail::DifferentiableGraphBackward, NoCtor>(module, DifferentiableGraphBackward, "DifferentiableGraphBackward");
