...
struct AutogradNotImplementedFallback {
public:
  AutogradNotImplementedFallback(ReturnT(*op)(Args&&...), std::string schema_string)
  ...
  ReturnT operator() (Args&&... args) {
    ...
    for_each_input_tensor([&](size_t _, size_t idx_arg, const at::Tensor& t) {
    ...
    for_each_input_tensor([&](size_t idx_tensor, size_t idx_arg, const at::Tensor& t) {
    ...
    for_each_input_tensor([&](size_t idx, size_t _, const at::Tensor& t) {
    ...
    for_each_output_tensor(outputs, [&](size_t idx_tensor, size_t idx_ret, const at::Tensor& t) {
