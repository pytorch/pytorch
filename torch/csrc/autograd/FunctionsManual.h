...
at::Tensor frobenius_norm_backward(at::Tensor grad, const at::Tensor& self, at::Tensor norm, const optional<IntArrayRef>& opt_dim, bool keepdim);
at::Tensor frobenius_norm_backward(at::Tensor grad, const at::Tensor& self, at::Tensor norm);
