...
static auto registry = torch::RegisterOperators()
  ...
  .op(torch::RegisterOperators::options()
    ...
    .kernel<decltype(VariableType::backward), &VariableType::backward>(DispatchKey::DefaultBackend))
  .op(torch::RegisterOperators::options()
    .schema("aten::set_data(Tensor(a!) self, Tensor new_data) -> ()")
    .aliasAnalysis(AliasAnalysisKind::FROM_SCHEMA)
    .kernel<decltype(VariableType::set_data), &VariableType::set_data>(DispatchKey::Math))
  .op(torch::RegisterOperators::options()
    .schema("aten::data(Tensor self) -> Tensor")
    .aliasAnalysis(AliasAnalysisKind::FROM_SCHEMA)
    .kernel<decltype(VariableType::data), &VariableType::data>(DispatchKey::Math))
  .op(torch::RegisterOperators::options()
    .schema("aten::is_leaf(Tensor self) -> bool")
    .aliasAnalysis(AliasAnalysisKind::FROM_SCHEMA)
    .kernel<decltype(VariableType::is_leaf), &VariableType::is_leaf>(DispatchKey::Math))
  .op(torch::RegisterOperators::options()
    .schema("aten::output_nr(Tensor self) -> int")
    .aliasAnalysis(AliasAnalysisKind::FROM_SCHEMA)
    .kernel<decltype(VariableType::output_nr), &VariableType::output_nr>(DispatchKey::Math))
  .op(torch::RegisterOperators::options()
    .schema("aten::_version(Tensor self) -> int")
    .aliasAnalysis(AliasAnalysisKind::FROM_SCHEMA)
    .kernel<decltype(VariableType::_version), &VariableType::_version>(DispatchKey::Math))
  .op(torch::RegisterOperators::options()
    ...
    .kernel<decltype(VariableType::requires_grad_), &VariableType::requires_grad_>(DispatchKey::DefaultBackend))
  .op(torch::RegisterOperators::options()
    .schema("aten::retain_grad(Tensor(a!) self) -> ()")
    .aliasAnalysis(AliasAnalysisKind::FROM_SCHEMA)
    .kernel<decltype(VariableType::retain_grad), &VariableType::retain_grad>(DispatchKey::Math))
  ;
