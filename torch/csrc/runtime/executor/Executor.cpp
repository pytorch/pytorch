#include "torch/csrc/runtime/executor/Executor.h"

#include <memory>

#include <c10/util/Logging.h>

#include "torch/csrc/runtime/common/AutoTimer.h"
#include "torch/csrc/runtime/common/Enumerate.h"
#include "torch/csrc/runtime/executor/ExecutionFrame.h"
#include "torch/csrc/runtime/executor/ParallelGraphExecutor.h"
#include "torch/csrc/runtime/executor/SerialGraphExecutor.h"
...
std::vector<c10::IValue> Executor::execute(
  ...
  auto outputs = graphExecutor_->executeWithPrefilledFrame(*executionFrame);
