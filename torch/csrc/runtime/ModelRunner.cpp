#include "torch/csrc/runtime/ModelRunner.h"

#include <nlohmann/json.hpp>

#include <caffe2/serialize/file_adapter.h>

#include "torch/csrc/runtime/graph/GraphPasses.h"
#include "torch/csrc/runtime/graph/Serialization.h"

namespace torch::runtime::core {
...
ModelRunner::ModelRunner(
    ...
    : ModelRunner(
          ...
          executorType,
          runtimeConfigs,
          [=](const torch::runtime::Graph&) { return placement; }) {}
