...
static PyObject* THPFInfo_eps(THPFInfo* self, void*) {
  return AT_DISPATCH_FLOATING_TYPES_AND_COMPLEX_AND_HALF(
      self->type, "epsilon", [] {
...
static PyObject* THPFInfo_max(THPFInfo* self, void*) {
  return AT_DISPATCH_FLOATING_TYPES_AND_COMPLEX_AND_HALF(self->type, "max", [] {
    return PyFloat_FromDouble(
...
static PyObject* THPFInfo_min(THPFInfo* self, void*) {
  return AT_DISPATCH_FLOATING_TYPES_AND_COMPLEX_AND_HALF(self->type, "min", [] {
    return PyFloat_FromDouble(
