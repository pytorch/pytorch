...
void py_set_default_tensor_type(PyObject* obj) {
  ...
  TORCH_CHECK_TYPE(PyTensorType_Check(obj), "invalid type object: only floating-point types are supported as the default type");
...
void py_set_default_dtype(PyObject* obj) {
  TORCH_CHECK_TYPE(THPDtype_Check(obj), "invalid dtype object: only floating-point types are supported as the default type");
