...
TORCH_API /*int*/ void recordFunctionFastStart(std::string name, c10::optional<std::string> args);
TORCH_API void recordFunctionFastStop(/*int*/);
TORCH_API void recordFunctionRepeated();
