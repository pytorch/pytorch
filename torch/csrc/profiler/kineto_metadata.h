...
void addTensorboardFields(const std::shared_ptr<torch::profiler::impl::Result>& result,
                          c10::ArrayRef<std::string> module_hierarchy,
                          c10::ArrayRef<std::string> stack);

void addGenericMetadata(std::shared_ptr<torch::profiler::impl::Result>& result,
...
void addTraceMetadata(std::vector<std::shared_ptr<torch::profiler::impl::Result>>& events,
                      const torch::profiler::impl::ProfilerConfig& config,
