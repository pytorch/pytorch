...
typedef enum _toffee_TensorProto_DataType {
    ...
    toffee_TensorProto_DataType_UINT8 = 2,
    toffee_TensorProto_DataType_INT8 = 3,
    toffee_TensorProto_DataType_UINT16 = 4,
    toffee_TensorProto_DataType_INT16 = 5,
    toffee_TensorProto_DataType_INT32 = 6,
    toffee_TensorProto_DataType_INT64 = 7,
    toffee_TensorProto_DataType_STRING = 8,
    toffee_TensorProto_DataType_BOOL = 9,
    toffee_TensorProto_DataType_FLOAT16 = 10
