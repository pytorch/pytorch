...
/// using the provided roots. This currently implements the :ref:`fast-mode-algorithm`
/// which assumes all RPC messages sent in the same distributed autograd context
...
/// before calling it.
///
/// \param context_id The autograd context id for which we should retrieve the gradients.
...
///     and often can be worked around in a much more efficient way. Usually, you need
