...
TORCH_LIBRARY(c10d, m) {
  ...
  m.def(
      "lookup_pg(Tensor useless_tensor_so_dispatch_works, int group_id) -> __torch__.torch.classes.c10d.ProcessGroup");
  m.def(
  ...
  m.def(
      "traceable_allreduce(Tensor tensor, int group_id, str reduce_op) -> Tensor");
  m.def(
