...
#include <torch/csrc/distributed/c10d/DispatchOps.h>
...
void Reducer::sync_bucket_indices(
  ...
  dispatch_broadcast(process_group_, indices_tensor_list)->wait();
  ...
  dispatch_broadcast(process_group_, bucket_sizes_tensor_list)->wait();
...
void verify_params_across_processes(
  ...
  dispatch_broadcast(process_group, vec)->wait();
