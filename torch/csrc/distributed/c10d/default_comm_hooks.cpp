...
c10::intrusive_ptr<c10::ivalue::Future> AllReduceCommHook::runHook(
  ...
  return ops::allreduce(c10::intrusive_ptr<ProcessGroup>::unsafe_reclaim_from_nonowning(state_), tensors)->getFuture();
}
...
c10::intrusive_ptr<c10::ivalue::Future> FP16CompressCommHook::runHook(
  ...
  auto allreduce_fut = ops::allreduce(c10::intrusive_ptr<ProcessGroup>::unsafe_reclaim_from_nonowning(state_), tensors)->getFuture();
