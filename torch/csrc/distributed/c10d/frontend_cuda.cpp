...
void initCustomClassBindingsNccl() {
  ...
  static const auto ProcessGroupNCCLWithUCCTorchBind =
      torch::class_<::c10d::ProcessGroupNCCLWithUCC>("dist_c10d", "ProcessGroupNCCL")
          .def_pickle(
              [](const c10::intrusive_ptr<::c10d::ProcessGroupNCCLWithUCC>& self) {
          ...
          .def(torch::init(
              [](const c10::intrusive_ptr<::c10d::Store>& store,
                 int64_t rank,
                 int64_t size,
                 c10::intrusive_ptr<::c10d::ProcessGroupNCCLWithUCC::Options> options,
                 const std::string& name) {
                auto pg = c10::make_intrusive<::c10d::ProcessGroupNCCLWithUCC>(
...
struct RealNCCLProcessGroupProvider : public NCCLProcessGroupProvider {
  c10::intrusive_ptr<ProcessGroup> get(
    ...
    auto options = ProcessGroupNCCLWithUCC::Options::create();
    options->is_high_priority_stream = false;
    options->timeout = timeout;
    return c10::make_intrusive<ProcessGroupNCCLWithUCC>(
