...
TORCH_LIBRARY_FRAGMENT(symm_mem, m) {
  ...
  m.def(
      "multimem_one_shot_all_reduce_low_latency(Tensor input, str reduce_op, str group_name) -> Tensor");
  m.def(
  ...
  m.def(
      "one_shot_all_reduce_low_latency(Tensor input, str reduce_op, str group_name) -> Tensor");
  m.def(
