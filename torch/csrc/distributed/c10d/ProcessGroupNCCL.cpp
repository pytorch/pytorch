...
c10::intrusive_ptr<Work> ProcessGroupNCCL::collective(
  ...
  return collective(
      ...
      [](std::vector<at::cuda::CUDAStream>&,
         c10::intrusive_ptr<ProcessGroupNCCL::WorkNCCL>& work) {},
      [](std::vector<at::cuda::CUDAStream>&, c10::intrusive_ptr<ProcessGroupNCCL::WorkNCCL>& work) {},
      opType,
      profilingTitle);
}
...
c10::intrusive_ptr<Work> ProcessGroupNCCL::allgather(
  ...
  if (same_size) {
    ...
    return collective(
        ...
        [&](std::vector<at::cuda::CUDAStream>& ncclStreams, c10::intrusive_ptr<ProcessGroupNCCL::WorkNCCL>& work) {
