...
constexpr uint64_t kWatchdogThreadSleepMaxMillis = 64;
constexpr uint64_t kWatchdogThreadSleepMinMillis = 1;
...
class TORCH_API ProcessGroupNCCL : public Backend {
 ...
 protected:
  ...
  uint64_t watchdogSleepMillis_ = kWatchdogThreadSleepMaxMillis << 1;
