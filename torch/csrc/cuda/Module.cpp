...
PyObject* THCPModule_canDeviceAccessPeer_wrap(
    PyObject* /*self*/,
    PyObject* args) {
  HANDLE_TH_ERRORS
...
PyObject* THCPModule_getDeviceCount_wrap(
    PyObject* /*self*/,
    PyObject* /*noargs*/) {
  HANDLE_TH_ERRORS
...
static PyObject* THCPModule_isInBadFork(
    PyObject* /*self*/,
    PyObject* /*noargs*/) {
  HANDLE_TH_ERRORS
...
PyObject* THCPModule_getCompiledVersion(
    PyObject* /*self*/,
    PyObject* /*noargs*/) {
#if defined(USE_ROCM)
...
PyObject* THCPModule_cudaHostAllocator(
    PyObject* /*_unused*/,
    PyObject* /*noargs*/) {
  HANDLE_TH_ERRORS
...
PyObject* THCPModule_getAllocatorBackend(
    PyObject* /*_unused*/,
    PyObject* /*noargs*/) {
  HANDLE_TH_ERRORS
...
PyObject* THCPModule_cudaBusyWaitForFlag(
    PyObject* /*_unused*/,
    PyObject* /*noargs*/) {
  HANDLE_TH_ERRORS {
    pybind11::gil_scoped_release no_gil;
...
PyObject* THCPModule_cudaClearFlag(
    PyObject* /*_unused*/,
    PyObject* /*noargs*/) {
  HANDLE_TH_ERRORS {
    pybind11::gil_scoped_release no_gil;
...
PyObject* THCPModule_cudaUnlockMutex(
    PyObject* /*module*/,
    PyObject* /*noargs*/) {
  auto mutex = c10::cuda::getFreeMutex();
...
PyObject* THCPModule_hostEmptyCache(
    PyObject* /*_unused*/,
    PyObject* /*noargs*/) {
  HANDLE_TH_ERRORS {
    pybind11::gil_scoped_release no_gil;
...
PyObject* THCPModule_resetPeakMemoryStats(
    PyObject* /*_unused*/,
    PyObject* arg) {
  HANDLE_TH_ERRORS
  TORCH_CHECK(
...
PyObject* THCPModule_hostMemoryStats(
    PyObject* /*_unused*/,
    PyObject* /*noargs*/) {
  HANDLE_TH_ERRORS
...
PyObject* THCPModule_cudaSetSyncDebugMode(
    PyObject* /*_unused*/,
    PyObject* arg) {
  HANDLE_TH_ERRORS
  TORCH_WARN_ONCE(
...
PyObject* THCPModule_cudaGetSyncDebugMode(
    PyObject* /*self*/,
    PyObject* /*noargs*/) {
  HANDLE_TH_ERRORS
...
// classes
static PyObject* THCPModule_initExtension(
    PyObject* /*self*/,
    PyObject* /*noargs*/) {
#if C10_ASAN_ENABLED
  TORCH_WARN(
...
PyObject* THCPModule_cuda_tunableop_enable(
    PyObject* /*_unused*/,
    PyObject* arg) {
  HANDLE_TH_ERRORS
  TORCH_CHECK(
...
PyObject* THCPModule_benchmarkLimitCuDNN(
    PyObject* /*_unused*/,
    PyObject* /*noargs*/) {
