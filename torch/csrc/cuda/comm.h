...
std::vector<at::Tensor> broadcast(const at::Tensor& tensor, at::IntListRef devices);
tensor_list2d broadcast_coalesced(at::TensorList tensors, at::IntListRef devices,
                                  size_t buffer_size);

std::vector<at::Tensor> scatter(
    const at::Tensor& tensor,
    at::IntListRef devices,
