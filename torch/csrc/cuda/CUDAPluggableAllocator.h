...
createCustomAllocator(
    std::function<void*(size_t, c10::DeviceIndex, cudaStream_t)> alloc_fn,
...
struct CUDAPluggableAllocator
  ...
  void endAllocateStreamToPool(c10::DeviceIndex device, cudaStream_t stream)
      override;
 ...
 protected:
  std::function<void*(size_t, c10::DeviceIndex, cudaStream_t)> alloc_fn_;
