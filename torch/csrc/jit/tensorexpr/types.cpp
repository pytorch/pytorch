...
AT_FORALL_SCALAR_TYPES_AND5(Bool, Half, BFloat16, Float8_e5m2, Float8_e4m3, DTYPE_DEFINE)
...
#define TYPE_CASE(_1, n) \
  case ScalarType::n:    \
    return k##n;
    AT_FORALL_SCALAR_TYPES_AND5(Bool, Half, BFloat16, Float8_e5m2, Float8_e4m3, TYPE_CASE)
