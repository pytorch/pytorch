...
#undef DTYPE_SINGLETON_ACCESSOR
  ...
  auto expr_handle_class = py::class_<tensorexpr::ExprHandle>(te, "ExprHandle")
                               ...
                               .def(py::self << py::self)
                               .def(py::self >> py::self)
                               .def("sin", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::sin(self);
                               })
                               .def("cos", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::cos(self);
                               })
                               .def("tan", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::tan(self);
                               })
                               .def("asin", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::asin(self);
                               })
                               .def("acos", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::acos(self);
                               })
                               .def("atan", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::atan(self);
                               })
                               .def("sinh", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::sinh(self);
                               })
                               .def("cosh", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::cosh(self);
                               })
                               .def("tanh", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::tanh(self);
                               })
                               .def("sigmoid", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::sigmoid(self);
                               })
                               .def("exp", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::exp(self);
                               })
                               .def("expm1", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::expm1(self);
                               })
                               .def("abs", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::abs(self);
                               })
                               .def("log", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::log(self);
                               })
                               .def("fast_log", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::fast_log(self);
                               })
                               .def("log2", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::log2(self);
                               })
                               .def("log10", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::log10(self);
                               })
                               .def("log1p", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::log1p(self);
                               })
                               .def("erf", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::erf(self);
                               })
                               .def("erfc", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::erfc(self);
                               })
                               .def("sqrt", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::sqrt(self);
                               })
                               .def("rsqrt", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::rsqrt(self);
                               })
                               .def("ceil", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::ceil(self);
                               })
                               .def("floor", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::floor(self);
                               })
                               .def("round", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::round(self);
                               })
                               .def("trunc", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::trunc(self);
                               })
                               .def("frac", [](const tensorexpr::ExprHandle& self) {
                                 return tensorexpr::frac(self);
                               })
                               .def("lgamma", [](const tensorexpr::ExprHandle& self) {
  ...
  te.def("atan2",
      [](const tensorexpr::ExprHandle& v1,
         const tensorexpr::ExprHandle& v2) {
