    ...
    R"(
        ...
        def AD_interpolate_backward(grad,
            ...
            if input_dim == 3 and mode == 'nearest':
                ...
                grad_input = torch.upsample_nearest2d_backward(grad, output_size, -1., -1., input_size)
                ...
                grad_input = torch.upsample_linear1d_backward(grad, output_size, -1., input_size, align_corners)
            elif input_dim == 4 and mode == 'bilinear':
                grad_input = torch.upsample_bilinear2d_backward(grad, output_size, -1., -1., input_size, align_corners)
            elif input_dim == 5 and mode == 'trilinear':
                grad_input = torch.upsample_trilinear3d_backward(grad, output_size, -1., -1., -1., input_size, align_corners)
            elif input_dim == 4 and mode == 'bicubic':
                grad_input = torch.upsample_bicubic2d_backward(grad, output_size, -1., -1., input_size, align_corners)
