...
c10::HashedKey<std::string> buildPushGlobalKey(std::string_view module_name, std::string_view class_name) {
  std::string key;
...
void Pickler::pushDevice(const IValue& ivalue) {
  ...
  if (it == memoized_devices_map_.end()) {
    static const c10::HashedKey<std::string>
        kTorchDevice{buildPushGlobalKey("torch", "device")};
...
void Pickler::pushLiteralSparseTensor(const at::Tensor& tensor) {
  static const c10::HashedKey<std::string>
      kTorchUtilsRebuildSparseTensor{
...
void Pickler::pushComplexDouble(const IValue& value) {
  ...
  static const c10::HashedKey<std::string>
      kBuiltinsComplex{buildPushGlobalKey("builtins", "complex")};
...
void Pickler::pushTensorReference(const IValue& ivalue) {
  static const c10::HashedKey<std::string>
      kTorchJitPickleBuildTensorFromId{
