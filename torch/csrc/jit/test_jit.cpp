...
void internedStringsTests () {
  ...
  REQUIRE(kParam == Symbol("Param"));
  REQUIRE(kReturn == Symbol("Return"));
  REQUIRE(Symbol(kReturn).toString() == std::string("Return"));
  size_t symstart = Symbol("__NEW_SYMBOL");
  REQUIRE(Symbol("What") == symstart+1);
  REQUIRE(Symbol("What2") == symstart+2);
  REQUIRE(Symbol("What") == symstart+1);
  REQUIRE(Symbol("What2") == symstart+2);
  REQUIRE(Symbol(symstart+2).toString() == std::string("What2"));
}
