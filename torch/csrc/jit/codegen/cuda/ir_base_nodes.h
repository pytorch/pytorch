...
class TORCH_CUDA_CU_API Val : public Statement {
 public:
  ...
  // NOLINTNEXTLINE(cppcoreguidelines-explicit-virtual-functions,clang-diagnostic-inconsistent-missing-override)
  virtual bool sameType(const Statement* other) override {
