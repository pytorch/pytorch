...
bool Node::isNondeterministic() const {
  static const OperatorSet nondeterministic_ops = {
      ...
      "aten::_fused_dropout(Tensor self, float p, GeneratorHolder? generator) -> (Tensor, Tensor)",
      "aten::_standard_gamma(Tensor self, GeneratorHolder? generator) -> Tensor",
      ...
      "aten::multinomial(Tensor self, int num_samples, bool replacement, *, GeneratorHolder? generator) -> Tensor",
      ...
      "aten::poisson(Tensor self, GeneratorHolder? generator) -> Tensor",
      "aten::rrelu(Tensor self, Scalar lower, Scalar upper, bool training, GeneratorHolder? generator) -> Tensor",
      "aten::rrelu_with_noise(Tensor self, Tensor noise, Scalar lower, Scalar upper, bool training, GeneratorHolder? generator) -> Tensor",
