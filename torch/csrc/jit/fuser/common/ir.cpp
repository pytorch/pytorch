...
template void Statement::dispatch(IROperExprPrinter, Statement*);
template void Statement::dispatch(IROperExprPrinter*, Statement*);
template void Val::dispatch(IROperExprPrinter, Val*);
template void Val::dispatch(IROperExprPrinter*, Val*);
template void Expr::dispatch(IROperExprPrinter, Expr*);
template void Expr::dispatch(IROperExprPrinter*, Expr*); 
