...
bool printerHasSpecialCaseFor(Symbol sym) {
  ...
  const static std::unordered_set<Symbol> handled = {
      ...
      prim::awaitable,     prim::awaitable_then, prim::ListConstruct,
      prim::DictConstruct, prim::ListUnpack,     prim::Print,
      prim::PythonOp,      prim::TupleConstruct, prim::TupleIndex,
      prim::TupleSlice,    prim::TupleUnpack,    prim::CreateObject,
      prim::GetAttr,       prim::SetAttr,        prim::CallFunction,
      prim::isinstance,    prim::unchecked_cast, prim::tolist,
