...
bool isOpSupportedInMobile(OpCode op) {
  ...
  static constexpr OpCode supported_ops_in_mobile[] {
      ...
      TUPLE_INDEX, GETITEM_T, LEN_T, TUPLE_UNPACK,
      RAISE_EXCEPTION, UNCHECKED_CAST, __IS__, UN_INITIALIZED,
      __ISNOT__, FORMAT, SIZE, DEVICE,
      DTYPE, TO_PRIM_DTYPE, APPEND_T, DIM,
      EXTEND_T, __NOT__, BOOL_TENSOR, SLICE_T,
      TO_LIST, NUM_TO_TENSOR_SCALAR, IS_CUDA, NUM_TO_TENSOR_BOOL};
  // clang-format on
