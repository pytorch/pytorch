...
const OperatorMap<std::string>& get_tensorexpr_elementwise_set() {
 ...
 static const OperatorMap<std::string> tensorexpr_elementwise_set{
      ...
      // TODO: uncomment when we support Tensor?
      // {"aten::_autocast_to_reduced_precision_optional(Tensor? self, bool cuda_enabled, bool cpu_enabled, ScalarType cuda_dtype, ScalarType cpu_dtype) -> Tensor?", "unary"},
      // {"aten::_autocast_to_full_precision_optional(Tensor? self, bool cuda_enabled, bool cpu_enabled) -> Tensor?", "unary"},
