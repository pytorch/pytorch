...
const OperatorMap<std::string>& get_tensorexpr_elementwise_set() {
 ...
 static const OperatorMap<std::string> tensorexpr_elementwise_set{
      ...
      {"aten::to.prim_Device(Tensor(a) self, Device? device, ScalarType? dtype=None, bool non_blocking=False, bool copy=False) -> Tensor(a|b)", "unary"},
      {"aten::to.prim_dtype(Tensor(a) self, ScalarType? dtype=None, bool non_blocking=False, bool copy=False) -> Tensor(a|b)", "unary"},
