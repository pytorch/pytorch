...
void ConcreteModuleTypeBuilder::addForwardHook(std::string hook_python_id) {
  forward_hook_ids.emplace_back(hook_python_id);
} 

void ConcreteModuleTypeBuilder::addForwardPreHook(std::string pre_hook_python_id) {
  forward_pre_hook_ids.emplace_back(pre_hook_python_id);
}
