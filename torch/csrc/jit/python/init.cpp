...
#define SYMNODE_BINARY(n) \
  ...
  auto symnode_class =
      py::class_<c10::SymNodeImpl, c10::SymNode>(m, "_SymNode")
          ...
          SYMNODE_UNARY2(__bool__, bool_)
          SYMNODE_UNARY2(__int__, int_)
          SYMNODE_UNARY2(__sym_int__, sym_int)
          SYMNODE_UNARY2(__sym_float__, sym_float)
          SYMNODE_BINARY(add)
          SYMNODE_BINARY(sub)
          SYMNODE_BINARY(mul)
          ...
          .def(
              "guard_int",
              [](c10::SymNode a) { return a->guard_int(nullptr, 0); })
          .def("__str__", [](c10::SymNode a) { return a->str(); })
          .def("__repr__", [](c10::SymNode a) { return a->str(); });
#endif
