    ...
    static const register_formula_for simple_unary_ops{
        {
            ...
            "aten::alpha_dropout(Tensor input, float p, bool train, int[] noise_shape) -> Tensor",
            ...
            "aten::feature_alpha_dropout(Tensor input, float p, bool train, int[] noise_shape) -> Tensor",
            "aten::feature_dropout(Tensor input, float p, bool train, int[] noise_shape) -> Tensor",
