    ...
    static const register_formula_for nn_ops_first_input_preserving{
        {
            ...
            "aten::upsample_bilinear2d(Tensor self, int[] output_size, float scales_1, float scales_2, bool align_corners) -> Tensor",
            "aten::upsample_linear1d(Tensor self, int[] output_size, float scales_1, bool align_corners) -> Tensor",
            ...
            "aten::upsample_trilinear3d(Tensor self, int[] output_size, float scales_1, float scales_2, float scales_3, bool align_corners) -> Tensor",
