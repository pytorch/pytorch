...
bool PropagateTensorShapeOnNode(Node * node, bool insert_expands) {
  ...
  static const register_formula_for nn_ops_first_input_preserving {{
    ...
    "aten::convolution(Tensor input, Tensor weight, Tensor bias, int[] stride, int[] padding, int[] dilation, bool transposed, int[] output_padding, int groups, bool wrap) -> Tensor",
