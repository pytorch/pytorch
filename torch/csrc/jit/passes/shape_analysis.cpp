 ...
 private:
  ...
  bool PropagateTensorShapeOnNode(Node* node, bool insert_expands) {
    ...
    static const register_formula_for simple_unary_ops{
        {
            ...
            "aten::bernoulli(Tensor self, *, GeneratorHolder? generator) -> Tensor",
            "aten::celu(Tensor self, Scalar alpha) -> Tensor",
            "aten::clamp(Tensor self, Scalar? min, Scalar? max) -> Tensor",
            "aten::clamp_max(Tensor self, Scalar max) -> Tensor",
            "aten::clamp_min(Tensor self, Scalar min) -> Tensor",
            "aten::alpha_dropout(Tensor input, float p, bool train) -> Tensor",
            "aten::bernoulli(Tensor self, float p, *, GeneratorHolder? generator) -> Tensor",
            ...
            "aten::normal(float mean, Tensor std, *, GeneratorHolder? generator) -> Tensor",
            "aten::normal(Tensor mean, float std, *, GeneratorHolder? generator) -> Tensor",
            ...
            "aten::rrelu(Tensor self, Scalar lower, Scalar upper, bool training, GeneratorHolder? generator) -> Tensor",
    ...
    static const register_formula_for binary_ops_strict_match{
        {
            "aten::normal(Tensor mean, Tensor std, *, GeneratorHolder? generator) -> Tensor",
