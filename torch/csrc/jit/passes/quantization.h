 ...
 */
TORCH_API void QuantFusion(std::shared_ptr<Graph>& graph, bool is_dynamic=false);
...
TORCH_API script::Module Finalize(script::Module& module, bool is_dynamic = false);
