...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda__embedding_bag_backward(AtenTensorHandle grad, AtenTensorHandle indices, AtenTensorHandle offsets, AtenTensorHandle offset2bag, AtenTensorHandle bag_size, AtenTensorHandle maximum_indices, int64_t num_weights, int32_t scale_grad_by_freq, int64_t mode, int32_t sparse, AtenTensorHandle* per_sample_weights, int64_t padding_idx, AtenTensorHandle* ret0);
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda__linalg_det(AtenTensorHandle A, AtenTensorHandle* ret0, AtenTensorHandle* ret1, AtenTensorHandle* ret2);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda__linalg_eigh(AtenTensorHandle A, const char* UPLO, int32_t compute_v, AtenTensorHandle* ret0, AtenTensorHandle* ret1);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda__linalg_slogdet(AtenTensorHandle A, AtenTensorHandle* ret0, AtenTensorHandle* ret1, AtenTensorHandle* ret2, AtenTensorHandle* ret3);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda__linalg_solve_ex(AtenTensorHandle A, AtenTensorHandle B, int32_t left, int32_t check_errors, AtenTensorHandle* ret0, AtenTensorHandle* ret1, AtenTensorHandle* ret2, AtenTensorHandle* ret3);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda__linalg_svd(AtenTensorHandle A, int32_t full_matrices, int32_t compute_uv, const char** driver, AtenTensorHandle* ret0, AtenTensorHandle* ret1, AtenTensorHandle* ret2);
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_clone(AtenTensorHandle self, int32_t* memory_format, AtenTensorHandle* ret0);
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_copy_(AtenTensorHandle self, AtenTensorHandle src, int32_t non_blocking);
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_digamma(AtenTensorHandle self, AtenTensorHandle* ret0);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_div_Tensor(AtenTensorHandle self, AtenTensorHandle other, AtenTensorHandle* ret0);
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_igamma(AtenTensorHandle self, AtenTensorHandle other, AtenTensorHandle* ret0);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_igammac(AtenTensorHandle self, AtenTensorHandle other, AtenTensorHandle* ret0);
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_linalg_cholesky_ex(AtenTensorHandle self, int32_t upper, int32_t check_errors, AtenTensorHandle* ret0, AtenTensorHandle* ret1);
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_linalg_inv_ex(AtenTensorHandle A, int32_t check_errors, AtenTensorHandle* ret0, AtenTensorHandle* ret1);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_linalg_ldl_factor_ex(AtenTensorHandle self, int32_t hermitian, int32_t check_errors, AtenTensorHandle* ret0, AtenTensorHandle* ret1, AtenTensorHandle* ret2);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_linalg_ldl_solve(AtenTensorHandle LD, AtenTensorHandle pivots, AtenTensorHandle B, int32_t hermitian, AtenTensorHandle* ret0);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_linalg_lu(AtenTensorHandle A, int32_t pivot, AtenTensorHandle* ret0, AtenTensorHandle* ret1, AtenTensorHandle* ret2);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_linalg_lu_factor_ex(AtenTensorHandle A, int32_t pivot, int32_t check_errors, AtenTensorHandle* ret0, AtenTensorHandle* ret1, AtenTensorHandle* ret2);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_linalg_lu_solve(AtenTensorHandle LU, AtenTensorHandle pivots, AtenTensorHandle B, int32_t left, int32_t adjoint, AtenTensorHandle* ret0);
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_linalg_qr(AtenTensorHandle A, const char* mode, AtenTensorHandle* ret0, AtenTensorHandle* ret1);
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_mm(AtenTensorHandle self, AtenTensorHandle mat2, AtenTensorHandle* ret0);
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_polygamma(int64_t n, AtenTensorHandle self, AtenTensorHandle* ret0);
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_special_airy_ai(AtenTensorHandle x, AtenTensorHandle* ret0);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_special_chebyshev_polynomial_t(AtenTensorHandle x, AtenTensorHandle n, AtenTensorHandle* ret0);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_special_chebyshev_polynomial_u(AtenTensorHandle x, AtenTensorHandle n, AtenTensorHandle* ret0);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_special_hermite_polynomial_h(AtenTensorHandle x, AtenTensorHandle n, AtenTensorHandle* ret0);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_special_hermite_polynomial_he(AtenTensorHandle x, AtenTensorHandle n, AtenTensorHandle* ret0);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_special_i0e(AtenTensorHandle self, AtenTensorHandle* ret0);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_special_i1e(AtenTensorHandle self, AtenTensorHandle* ret0);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_special_laguerre_polynomial_l(AtenTensorHandle x, AtenTensorHandle n, AtenTensorHandle* ret0);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_special_modified_bessel_k0(AtenTensorHandle self, AtenTensorHandle* ret0);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_special_modified_bessel_k1(AtenTensorHandle self, AtenTensorHandle* ret0);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_special_ndtri(AtenTensorHandle self, AtenTensorHandle* ret0);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_special_scaled_modified_bessel_k1(AtenTensorHandle x, AtenTensorHandle* ret0);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_special_spherical_bessel_j0(AtenTensorHandle x, AtenTensorHandle* ret0);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_special_zeta(AtenTensorHandle self, AtenTensorHandle other, AtenTensorHandle* ret0);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_squeeze_dim(AtenTensorHandle self, int64_t dim, AtenTensorHandle* ret0);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_sub_Tensor(AtenTensorHandle self, AtenTensorHandle other, double alpha, AtenTensorHandle* ret0);
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda_where_self(AtenTensorHandle condition, AtenTensorHandle self, AtenTensorHandle other, AtenTensorHandle* ret0);
