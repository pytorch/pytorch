...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda__sparse_semi_structured_mm(AtenTensorHandle mat1, AtenTensorHandle mat1_meta, AtenTensorHandle mat2, int32_t* out_dtype, AtenTensorHandle* ret0);
