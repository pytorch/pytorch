...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda__scaled_dot_product_cudnn_attention_backward_quantized_per_tensor(AtenTensorHandle grad_out, AtenTensorHandle query, AtenTensorHandle key, AtenTensorHandle value, AtenTensorHandle fp8_o, AtenTensorHandle softmax_stats, AtenTensorHandle descale_q, AtenTensorHandle descale_k, AtenTensorHandle descale_v, AtenTensorHandle descale_o, AtenTensorHandle descale_s, double scale_s, int32_t is_causal, double* scale, AtenTensorHandle* ret0, AtenTensorHandle* ret1, AtenTensorHandle* ret2);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cuda__scaled_dot_product_cudnn_attention_quantized_per_tensor(AtenTensorHandle query, AtenTensorHandle key, AtenTensorHandle value, AtenTensorHandle descale_q, AtenTensorHandle descale_k, AtenTensorHandle descale_v, double scale_s, int32_t is_causal, double* scale, AtenTensorHandle* ret0, AtenTensorHandle* ret1, AtenTensorHandle* ret2, AtenTensorHandle* ret3);
