...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cpu_native_dropout(AtenTensorHandle input, double p, int32_t* train, AtenGeneratorHandle* generator, AtenTensorHandle* ret0, AtenTensorHandle* ret1);
