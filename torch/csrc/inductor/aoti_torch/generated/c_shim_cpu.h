...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cpu__scaled_dot_product_int8(AtenTensorHandle query, AtenTensorHandle key, AtenTensorHandle value, AtenTensorHandle* attn_mask, double* scale, double dropout_p, int32_t is_causal, int64_t q_zp, double q_scale, int64_t k_zp, double k_scale, int64_t v_zp, double v_scale, int64_t a_zp, double a_scale, int64_t o_zp, double o_scale, AtenTensorHandle* ret0);
