...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_cpu_zendnn_weight_prepack_for_linear(AtenTensorHandle weight, const char* zendnn_op_name, AtenTensorHandle* ret0);
