...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_xpu__conj(AtenTensorHandle self, AtenTensorHandle* ret0);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_xpu__conj_physical(AtenTensorHandle self, AtenTensorHandle* ret0);
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_xpu_clone(AtenTensorHandle self, int32_t* memory_format, AtenTensorHandle* ret0);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_xpu_complex(AtenTensorHandle real, AtenTensorHandle imag, AtenTensorHandle* ret0);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_xpu_constant_pad_nd(AtenTensorHandle self, const int64_t* pad, int64_t pad_len_, double value, AtenTensorHandle* ret0);
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_xpu_copy(AtenTensorHandle self, AtenTensorHandle src, int32_t non_blocking, AtenTensorHandle* ret0);
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_xpu_copy_(AtenTensorHandle self, AtenTensorHandle src, int32_t non_blocking);
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_xpu_diagonal(AtenTensorHandle self, int64_t offset, int64_t dim1, int64_t dim2, AtenTensorHandle* ret0);
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_xpu_full(const int64_t* size, int64_t size_len_, double fill_value, int32_t* dtype, int32_t* layout, int32_t* device, int32_t device_index_, int32_t* pin_memory, AtenTensorHandle* ret0);
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_xpu_linalg_pinv_atol_rtol_tensor(AtenTensorHandle self, AtenTensorHandle* atol, AtenTensorHandle* rtol, int32_t hermitian, AtenTensorHandle* ret0);
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_xpu_mm(AtenTensorHandle self, AtenTensorHandle mat2, AtenTensorHandle* ret0);
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_xpu_nanmedian_dim(AtenTensorHandle self, int64_t dim, int32_t keepdim, AtenTensorHandle* ret0, AtenTensorHandle* ret1);
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_xpu_slice_scatter(AtenTensorHandle self, AtenTensorHandle src, int64_t dim, int64_t* start, int64_t* end, int64_t step, AtenTensorHandle* ret0);
