...
AOTITorchError aoti_torch_cpu__histogramdd_from_bin_cts(AtenTensorHandle self, const int64_t* bins, int64_t bins_len_, const double** range, int64_t range_len_, AtenTensorHandle* weight, int32_t density, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cpu::_histogramdd_from_bin_cts(
            *tensor_handle_to_tensor_pointer(self), pointer_to_list<int64_t>(bins, bins_len_), pointer_to_optional_list<double>(range, range_len_), pointer_to_optional<at::Tensor>(weight), density
        );
        *ret0 = new_tensor_handle(std::move(tmp_result));;
    });
}
...
AOTITorchError aoti_torch_cpu__linalg_check_errors(AtenTensorHandle info, const char* api_name, int32_t is_matrix) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
...
AOTITorchError aoti_torch_cpu__linalg_det(AtenTensorHandle A, AtenTensorHandle* ret0, AtenTensorHandle* ret1, AtenTensorHandle* ret2) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cpu::_linalg_det(
...
AOTITorchError aoti_torch_cpu__linalg_eigh(AtenTensorHandle A, const char* UPLO, int32_t compute_v, AtenTensorHandle* ret0, AtenTensorHandle* ret1) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cpu::_linalg_eigh(
...
AOTITorchError aoti_torch_cpu__linalg_slogdet(AtenTensorHandle A, AtenTensorHandle* ret0, AtenTensorHandle* ret1, AtenTensorHandle* ret2, AtenTensorHandle* ret3) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cpu::_linalg_slogdet(
            *tensor_handle_to_tensor_pointer(A)
        );
        *ret0 = new_tensor_handle(std::move(std::get<0>(tmp_result)));;
        *ret1 = new_tensor_handle(std::move(std::get<1>(tmp_result)));;
...
AOTITorchError aoti_torch_cpu__linalg_solve_ex(AtenTensorHandle A, AtenTensorHandle B, int32_t left, int32_t check_errors, AtenTensorHandle* ret0, AtenTensorHandle* ret1, AtenTensorHandle* ret2, AtenTensorHandle* ret3) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cpu::_linalg_solve_ex(
...
AOTITorchError aoti_torch_cpu__linalg_svd(AtenTensorHandle A, int32_t full_matrices, int32_t compute_uv, const char** driver, AtenTensorHandle* ret0, AtenTensorHandle* ret1, AtenTensorHandle* ret2) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cpu::_linalg_svd(
...
AOTITorchError aoti_torch_cpu__scaled_dot_product_flash_attention_for_cpu(AtenTensorHandle query, AtenTensorHandle key, AtenTensorHandle value, double dropout_p, int32_t is_causal, AtenTensorHandle* attn_mask, double* scale, AtenTensorHandle* ret0, AtenTensorHandle* ret1) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cpu::_scaled_dot_product_flash_attention_for_cpu(
            *tensor_handle_to_tensor_pointer(query), *tensor_handle_to_tensor_pointer(key), *tensor_handle_to_tensor_pointer(value), dropout_p, is_causal, pointer_to_optional<at::Tensor>(attn_mask), pointer_to_optional<double>(scale)
        );
...
AOTITorchError aoti_torch_cpu_histogram_bin_ct(AtenTensorHandle self, int64_t bins, const double** range, int64_t range_len_, AtenTensorHandle* weight, int32_t density, AtenTensorHandle* ret0, AtenTensorHandle* ret1) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cpu::histogram(
            *tensor_handle_to_tensor_pointer(self), bins, pointer_to_optional_list<double>(range, range_len_), pointer_to_optional<at::Tensor>(weight), density
        );
        *ret0 = new_tensor_handle(std::move(std::get<0>(tmp_result)));;
        *ret1 = new_tensor_handle(std::move(std::get<1>(tmp_result)));;
    });
...
AOTITorchError aoti_torch_cpu_linalg_cholesky_ex(AtenTensorHandle self, int32_t upper, int32_t check_errors, AtenTensorHandle* ret0, AtenTensorHandle* ret1) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cpu::linalg_cholesky_ex(
...
AOTITorchError aoti_torch_cpu_linalg_householder_product(AtenTensorHandle input, AtenTensorHandle tau, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cpu::linalg_householder_product(
...
AOTITorchError aoti_torch_cpu_linalg_inv_ex(AtenTensorHandle A, int32_t check_errors, AtenTensorHandle* ret0, AtenTensorHandle* ret1) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cpu::linalg_inv_ex(
...
AOTITorchError aoti_torch_cpu_linalg_ldl_factor_ex(AtenTensorHandle self, int32_t hermitian, int32_t check_errors, AtenTensorHandle* ret0, AtenTensorHandle* ret1, AtenTensorHandle* ret2) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cpu::linalg_ldl_factor_ex(
...
AOTITorchError aoti_torch_cpu_linalg_ldl_solve(AtenTensorHandle LD, AtenTensorHandle pivots, AtenTensorHandle B, int32_t hermitian, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cpu::linalg_ldl_solve(
...
AOTITorchError aoti_torch_cpu_linalg_lu(AtenTensorHandle A, int32_t pivot, AtenTensorHandle* ret0, AtenTensorHandle* ret1, AtenTensorHandle* ret2) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cpu::linalg_lu(
...
AOTITorchError aoti_torch_cpu_linalg_lu_factor_ex(AtenTensorHandle A, int32_t pivot, int32_t check_errors, AtenTensorHandle* ret0, AtenTensorHandle* ret1, AtenTensorHandle* ret2) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cpu::linalg_lu_factor_ex(
...
AOTITorchError aoti_torch_cpu_linalg_lu_solve(AtenTensorHandle LU, AtenTensorHandle pivots, AtenTensorHandle B, int32_t left, int32_t adjoint, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cpu::linalg_lu_solve(
...
AOTITorchError aoti_torch_cpu_linalg_matrix_exp(AtenTensorHandle self, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cpu::linalg_matrix_exp(
            *tensor_handle_to_tensor_pointer(self)
        );
        *ret0 = new_tensor_handle(std::move(tmp_result));;
    });
...
AOTITorchError aoti_torch_cpu_linalg_pinv_atol_rtol_tensor(AtenTensorHandle self, AtenTensorHandle* atol, AtenTensorHandle* rtol, int32_t hermitian, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
...
AOTITorchError aoti_torch_cpu_linalg_qr(AtenTensorHandle A, const char* mode, AtenTensorHandle* ret0, AtenTensorHandle* ret1) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cpu::linalg_qr(
...
AOTITorchError aoti_torch_cpu_linalg_solve_triangular(AtenTensorHandle self, AtenTensorHandle B, int32_t upper, int32_t left, int32_t unitriangular, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cpu::linalg_solve_triangular(
...
AOTITorchError aoti_torch_cpu_resize_(AtenTensorHandle self, const int64_t* size, int64_t size_len_, int32_t* memory_format, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cpu::resize__symint(
...
AOTITorchError aoti_torch_cpu_resize_as_(AtenTensorHandle self, AtenTensorHandle the_template, int32_t* memory_format, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
