...
template <>
constexpr c10::complex<float> real_impl<c10::complex<float>>(
    c10::complex<float> z) {
...
template <>
constexpr c10::complex<double> real_impl<c10::complex<double>>(
    c10::complex<double> z) {
  return c10::complex<double>(z.real(), 0.0);
}

template <>
constexpr double real_impl<c10::complex<double>, double>(
    c10::complex<double> z) {
  return z.real();
}
...
template <>
constexpr c10::complex<float> imag_impl<c10::complex<float>>(
    c10::complex<float> z) {
...
template <>
constexpr c10::complex<double> imag_impl<c10::complex<double>>(
    c10::complex<double> z) {
  return c10::complex<double>(z.imag(), 0.0);
}

template <>
constexpr double imag_impl<c10::complex<double>, double>(
    c10::complex<double> z) {
  return z.imag();
}
...
template <>
inline c10::complex<at::Half> conj_impl<c10::complex<at::Half>>(
    c10::complex<at::Half> z) {
  return c10::complex<at::Half>{z.real(), -z.imag()};
}

template <>
inline c10::complex<float> conj_impl<c10::complex<float>>(
    c10::complex<float> z) {
  return c10::complex<float>(z.real(), -z.imag());
}

template <>
inline c10::complex<double> conj_impl<c10::complex<double>>(
    c10::complex<double> z) {
