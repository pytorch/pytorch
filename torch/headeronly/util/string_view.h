...
// NOTE: basic_string_view stays defined in namespace c10 (not flipped into
// torch::headeronly) because c10/util/TypeIndex.h parses __PRETTY_FUNCTION__
// and depends on the printed type name being c10::basic_string_view<char>.
namespace c10 {
...
using c10::basic_string_view;
using c10::c10_string_view;
using c10::ends_with;
using c10::operator<<;
using c10::starts_with;
