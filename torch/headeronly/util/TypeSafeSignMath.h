...
namespace c10 {
  using torch::headeronly::is_negative;
  using torch::headeronly::signum;
  using torch::headeronly::signs_differ;
  using torch::headeronly::greater_than_max;
  using torch::headeronly::less_than_lowest;
} // namespace c10
