...
struct AtomicFPOp<torch::headeronly::Half> {
  ...
  inline __device__ torch::headeronly::Half operator()(
      torch::headeronly::Half* address,
      torch::headeronly::Half val,
      const func_t& func) {
...
struct AtomicFPOp<torch::headeronly::BFloat16> {
  template <typename func_t>
  inline __device__ torch::headeronly::BFloat16 operator()(
      torch::headeronly::BFloat16* address,
      torch::headeronly::BFloat16 val,
      const func_t& func) {
    unsigned int* address_as_ui =
        (unsigned int*)((char*)address - ((size_t)address & 2));
    unsigned int old = *address_as_ui;
...
inline __device__ torch::headeronly::Half gpuAtomicAdd(
    torch::headeronly::Half* address,
    torch::headeronly::Half val) {
#if defined(USE_ROCM) || ((defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 700)))
  return AtomicFPOp<torch::headeronly::Half>()(
      address,
      val,
...
inline __device__ torch::headeronly::BFloat16 gpuAtomicAdd(
    torch::headeronly::BFloat16* address,
    torch::headeronly::BFloat16 val) {
#if defined(USE_ROCM) || ((defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 800)))
  return AtomicFPOp<torch::headeronly::BFloat16>()(
      address,
      val,
...
inline __device__ void gpuAtomicAdd(
    torch::headeronly::complex<T>* address,
    torch::headeronly::complex<T> val) {
 ...
 */
inline __device__ torch::headeronly::Half atomicAdd(
    torch::headeronly::Half* address,
    torch::headeronly::Half val) {
  return gpuAtomicAdd(address, val);
}

inline __device__ torch::headeronly::BFloat16 atomicAdd(
    torch::headeronly::BFloat16* address,
    torch::headeronly::BFloat16 val) {
  return gpuAtomicAdd(address, val);
}
