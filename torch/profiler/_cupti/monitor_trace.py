...
def _window_to_pftrace(
    ...
    # stage) on the kernels' capture-stream lane -- never a reassigned logical lane, matching
    # the chrome path. Synthesized from the columnar window, NOT cpu_data (kineto emits no
