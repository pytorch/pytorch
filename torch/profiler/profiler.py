...
def _parse_custom_profiler_config(
    ...
    if experimental_config is None:
        return {}
    raw = experimental_config.custom_profiler_config
    if not raw:
        return {}
    try:
...
class _KinetoProfile:
    ...
    def __init__(
        ...
        *,
        ...
        self._use_cupti_monitor = (
            self._custom_profiler_config.get("backend") == "cupti_monitor"
            or bool(self._custom_profiler_config.get("cupti_monitor"))
        )
