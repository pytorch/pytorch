...
def adamw(params: List[Tensor],
          ...
          *,
          ...
          weight_decay: float,
          eps: float):
    r"""Differential Functional API that performs AdamW algorithm computation.
...
def adagrad(params: List[Tensor],
            ...
            *,
            ...
            lr_decay: float,
            eps: float):
    r"""Differential Functional API that performs Adagrad algorithm computation.
...
def rmsprop(params: List[Tensor],
            ...
            *,
            ...
            momentum: float,
            centered: bool):
    r"""Differential Functional API that performs rmsprop algorithm computation.
...
def radam(params: List[Tensor],
          ...
          *,
          ...
          weight_decay: float,
          eps: float):
    r"""Differential Functional API that performs RAdam algorithm computation.
...
def nadam(params: List[Tensor],
          ...
          *,
          ...
          eps: float):
    r"""Differential Functional API that performs NAdam algorithm computation.
