    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                grad = p.grad.data
                if grad.is_sparse:
                    raise RuntimeError('AMSGrad does not support sparse gradients, please consider SparseAMSGrad instead')
                ...
                if len(state) == 0:
                    ...
                    # Maintain maximum of all exp. moving avg. of sq. grad. values
