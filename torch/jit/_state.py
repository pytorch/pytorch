...
_jit_caching_layer: weakref.WeakKeyDictionary[Any, str] = weakref.WeakKeyDictionary()
_jit_function_overload_caching: weakref.WeakKeyDictionary[Any, List[str]] = weakref.WeakKeyDictionary()
