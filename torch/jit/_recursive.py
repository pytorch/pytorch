    ...
    def get_or_create_concrete_type(self, nn_module):
        ...
        for known_type in known_types:
            if known_type.equals(concrete_type_builder):
                print("concrete types matched!!")
                print("\n\n\n orig:")
                known_type.dump()
                print("\n\n\n matched:")
                concrete_type_builder.build().dump()
                return known_type
...
def wrap_cpp_module(cpp_module):
    ...
    #for idx, fn_name in enumerate(script_module._concrete_type.get_forward_pre_hooks()):
    #        print("name:")
    #        print(fn_name)
    #        fn = script_module._c._get_method(fn_name)
    #        script_module._forward_pre_hooks[idx] = fn

    #for idx, fn_name in enumerate(script_module._concrete_type.get_forward_hooks()):
    #    fn = script_module._c._get_method(fn_name)
