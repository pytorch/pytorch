...
def verify(model, args, loss_fn=torch.sum, devices=None):
    ...
    def run_fwd_bwd(args, force_trace=False, assert_compiled=False):
        ...
        out = model(*args)
        if assert_compiled and compiled_fn.hits == hits:  # type: ignore[possibly-undefined]  # TODO: audit
    ...
    if is_module:
        model.load_state_dict(saved_state)  # type: ignore[possibly-undefined]  # TODO: audit
