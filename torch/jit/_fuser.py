    ...
    * ``fuser3`` - enables oneDNN Graph
    ...
    try:
        ...
        if name in ["fuser1", "fuser3"]:  # NNC or oneDNN Graph
            torch._C._jit_set_profiling_executor(old_profiling_executor)  # type: ignore[possibly-undefined]  # TODO: audit
            torch._C._get_graph_executor_optimize(old_profiling_mode)  # type: ignore[possibly-undefined]  # TODO: audit
