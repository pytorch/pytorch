...
def _get_builtin_table():
    ...
    _builtin_table[id(math.fmod)] = "aten::fmod"
    _builtin_table[id(math.modf)] = "aten::modf"
    _builtin_table[id(math.acos)] = "aten::acos"
    _builtin_table[id(math.remainder)] = "aten::remainder"
