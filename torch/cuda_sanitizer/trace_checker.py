...
class TraceChecker:
    """Analyzes CSAN output for synchronization errors.

    Allows for both online and offline inspection as well as the option
    to find all errors in a file or terminate on the first one.
    """
