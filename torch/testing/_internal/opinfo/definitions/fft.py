...
python_ref_db: List[OpInfo] = [
    SpectralFuncPythonRefInfo(
        ...
        skips=(
            ...
            # TODO: check if type conversion being done by the operator is correct
            DecorateInfo(
    ...
    SpectralFuncPythonRefInfo(
        ...
        skips=(
            # _refs.fft.* functions have inconsistent behavior for empty
            # https://github.com/pytorch/pytorch/issues/105986
            DecorateInfo(unittest.expectedFailure, "TestFFT", "test_empty_fft"),
            # TODO: check if type conversion being done by the operator is correct
            DecorateInfo(
    ...
    SpectralFuncPythonRefInfo(
        ...
        skips=(
            ...
            # TODO: looks like bug on 2nd test case
            DecorateInfo(
                unittest.expectedFailure,
                "TestFFT",
                "test_fftn_invalid",
