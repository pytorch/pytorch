...
def method_tests():
    ...
    return [
        ...
        ('prod', lambda dtype, device: prod_zeros(S, [0, 1], dtype), NO_ARGS, 'zerodims2'),
        ('prod', lambda dtype, device: prod_zeros(S, [0, 2], dtype), NO_ARGS, 'zerodims1'),
        ('prod', lambda dtype, device: prod_zeros(S, [1, 2], dtype), NO_ARGS, 'zerodims0'),
        ('prod', lambda dtype, device: prod_zeros(S, [0, 1], dtype), (1,), 'zeros_dims2', (), [0]),
        ('prod', lambda dtype, device: prod_zeros(S, [0, 2], dtype), (1,), 'zeros_dims1', (), [0]),
        ('prod', lambda dtype, device: prod_zeros(S, [1, 2], dtype), (1,), 'zeros_dims0', (), [0]),
        ('prod', lambda dtype, device: prod_zeros(S, [0, 1], dtype), (1, True), 'keepdim_zeros_dims2', (), [0]),
        ('prod', lambda dtype, device: prod_zeros(S, [0, 2], dtype), (1, True), 'keepdim_zeros_dims1', (), [0]),
        ('prod', lambda dtype, device: prod_zeros(S, [1, 2], dtype), (1, True), 'keepdim_zeros_dims0', (), [0]),
        #('prod', lambda dtype, device: prod_single_zero(S).to(dtype), NO_ARGS, 'single_zero'),
