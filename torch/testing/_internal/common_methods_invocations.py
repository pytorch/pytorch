...
def method_tests():
    ...
    return [
        ...
        ('tile', (M, M, M), (M, L, S, S), 'more_reps_dims'),
        ('tile', (M, M, M), (M, L, S), 'same_reps_dims'),
        ('tile', (M, M, M), (S, L), 'less_reps_dims'),
        ('tile', (M, M, M), (), 'no_reps_dims'),
        ('tile', (), (S, S, S), 'empty_input'),
        ('tile', (M, M, M), (S, S, 0), 'zero_rep'),
        ('tril', (M, M), NO_ARGS),
        ('tril', (M, M), (2,), 'idx'),
