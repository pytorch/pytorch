...
op_db: List[OpInfo] = [
    ...
    OpInfo('nn.functional.max_pool1d',
           ...
           skips=(
               ...
               DecorateInfo(unittest.skip("Works on some configs"), 'TestNNCOpInfo', 'test_nnc_correctness', dtypes=(torch.bfloat16,)),
    ...
    OpInfo('nn.functional.bilinear',
           ...
           skips=(
               ...
               # "bmm" not implemented for 'Half'
               DecorateInfo(unittest.skip("Skipped!"), 'TestNNCOpInfo', 'test_nnc_correctness', dtypes=(torch.float16,))
           ),
           supports_forward_ad=False,
           supports_out=False),
