...
def sample_inputs_stft(op_info, device, dtype, requires_grad, **kwargs):
    ...
    yield SampleInput(mt(100), kwargs=dict(n_fft=10, return_complex=True))
    yield SampleInput(mt(100), kwargs=dict(n_fft=10, return_complex=False))
    if dtype.is_complex:
    ...
    for center in [False, True]:
        yield SampleInput(mt(10), kwargs=dict(n_fft=7, center=center,
                                              return_complex=True))
        yield SampleInput(mt((10, 100)), kwargs=dict(n_fft=16, hop_length=4,
