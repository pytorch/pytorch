...
def method_tests():
    ...
    return [
        ...
        ('sort', (S, M, S), NO_ARGS),
        ('sort', (S, M, S), (0, False, True), 'stable'),
        ('sort', (S, M, S), (1,), 'dim'),
        ('sort', (S, M, S), (1, False, True), 'dim_stable'),
        ('sort', (S, M, S), (1, True), 'dim_desc'),
        ('sort', (S, M, S), (1, True, True), 'dim_desc_stable'),
        ('sort', (), NO_ARGS, 'scalar'),
        ('sort', (), (0, False, True), 'scalar_stable'),
        ('sort', (), (0,), 'dim_scalar'),
        ('sort', (), (0, False, True), 'dim_scalar_stable'),
        ('sort', (), (0, True), 'dim_desc_scalar'),
        ('sort', (), (0, True, True), 'dim_desc_scalar_stable'),
        ('topk', (S, M, S), (3,)),
