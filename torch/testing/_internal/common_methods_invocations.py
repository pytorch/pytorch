...
def method_tests():
    ...
    return [
        ...
        ('pinverse', lambda dtype, device: random_fullrank_matrix_distinct_singular_value(S, dtype=dtype).to(device), NO_ARGS,
         '', (), NO_ARGS, [skipCPUIfNoLapack, skipCUDAIfNoMagma]),
        ('pinverse', lambda dtype, device: random_fullrank_matrix_distinct_singular_value(S, 3, dtype=dtype).to(device), NO_ARGS,
