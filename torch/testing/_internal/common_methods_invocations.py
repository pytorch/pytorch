...
def method_tests():
    ...
    return [
        ...
        # END TODO
        ('quantile', (S, S, S), (0.5,), '', (True,)),
        ('quantile', (S, S, S), (0.5, 0), 'dim', (True,), [1]),
        ('quantile', (S, S, S), (0.5, None, True), 'keepdim', (True,)),
        ('quantile', (S, S, S), (0.5, 0, True), 'keepdim_dim', (True,), [1]),
        ('quantile', (), (0.5,), 'scalar', (True,)),
        ('nanquantile', (S, S, S), (0.5,), '', (True,)),
        ('nanquantile', (S, S, S), (0.5, 0), 'dim', (True,), [1]),
        ('nanquantile', (S, S, S), (0.5, None, True), 'keepdim', (True,)),
        ('nanquantile', (S, S, S), (0.5, 0, True), 'keepdim_dim', (True,), [1]),
        ('nanquantile', (), (0.5,), 'scalar', (True,)),
