...
def method_tests():
    ...
    return [
        ...
        ('norm', (S, S), ('fro', [0, 1], True), 'fro_keepdim'),
        ('norm', (S, S), ('nuc',), 'nuc', (), NO_ARGS, [skipCPUIfNoLapack, skipCUDAIfNoMagma]),
        ('norm', (S, S), ('nuc', [0, 1], True), 'nuc_keepdim', (), NO_ARGS, [skipCPUIfNoLapack, skipCUDAIfNoMagma]),
        ...
        ('norm', (S, S, S), (2, [0, 2], True), 'matrix_keepdim_2_dim', (), NO_ARGS, [skipCPUIfNoLapack, skipCUDAIfNoMagma]),
        ('norm', (S, S, S), (1, [0, 2], True), 'matrix_keepdim_1_dim', (), NO_ARGS),
