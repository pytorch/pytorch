...
op_db: List[OpInfo] = [
    ...
    OpInfo(
        ...
        skips=(
            ...
            DecorateInfo(unittest.expectedFailure, 'TestGradients', "test_fn_fwgrad_bwgrad", dtypes=(torch.float64,)),
        ),
    ),
    ...
    OpInfo(
        ...
        supports_fwgrad_bwgrad=True,
        skips=(
            # https://github.com/pytorch/pytorch/issues/78256
            # sub does not support the combination of (complex, real) dtypes in fw over bw
