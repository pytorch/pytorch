...
def method_tests():
    ...
    return [
        ...
        ('clamp_with_tensors', (S, S, S), ((S, S, S), (S, S, S)), 'tensors', (True,)),
        ('clamp_with_tensors', (S, S, S), ((S, S, S), None), 'tensor_min', (True,)),
        ('clamp_with_tensors', (S, S, S), (None, (S, S, S)), 'tensor_max', (True,)),
        ('clamp_with_tensors', (S, S, S), ((S, S), (S, S)), 'broadcast', (True,)),
        ('clamp_with_tensors', (S, S, S), ((S, S, S), 1), 'min_tensor_max_scalar', (True,)),
        ('clamp_with_tensors', (S, S, S), (0, (S, S, S)), 'min_scalar_max_tensor', (True,)),
