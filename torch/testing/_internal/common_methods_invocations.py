...
op_db: List[OpInfo] = [
    ...
    OpInfo('__getitem__',
           ...
           skips=(
               # TODO: memory leak in tracing, likely bc of compilation unit persistence w/constant tensors
               SkipInfo('TestJit', 'test_variant_consistency_jit', dtypes=(torch.float32, torch.complex64), device_type='cuda'),
           ),
