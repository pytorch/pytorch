...
op_db: List[OpInfo] = [
    ...
    UnaryUfuncInfo(
        ...
        skips=(
            ...
            # FIXME it should be fixable, as auto_elementwise works with in-place just fine, and
            # this one is somewhat similar
            # INTERNAL ASSERT FAILED Cannot set a va lue of a forward grad if it already exists. 
