...
def method_tests():
    ...
    return [
        ...
        #     (True, [], ['aten::mul', 'aten::reciprocal'])),
        # ('pow', torch.rand(S, S, S, dtype=torch.cdouble) + 1e-3*(1+1j), (torch.rand(S, S, S, dtype=torch.cdouble) + 0.1*(1+1j),), 'complex', (True,)),
        ...
        # ('conj', (S, S, S), NO_ARGS, 'complex', (True,)),
        ...
        # ('sqrt', torch.rand(S, S, S, dtype=torch.cdouble) + 5e-4*(1+1j), NO_ARGS, 'complex', (True,)),
        ...
        # ('rsqrt', torch.rand(S, S, S, dtype=torch.cdouble) + 1e-2*(1+1j), NO_ARGS, 'complex', (True,)),
        # ('rsqrt', uniform_scalar(1e-2j, requires_grad=True), NO_ARGS, 'complex_scalar', (True,)),
        ...
        # ('mean', (S, S, S), (), 'complex_dtype', (True,), (), (), ident, {'dtype': torch.complex128}),
        # ('kthvalue', (S, S, S), (2,)),
