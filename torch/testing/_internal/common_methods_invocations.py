...
class OpInfo(object):
    ...
    def __post_init__(self):
        ...
        if self.dynamic_dtypes:
            ...
            assert isinstance(
                self.dtypesIfCUDA, opinfo_helper._dynamic_dispatch_dtypes
            ), (
...
class UnaryUfuncInfo(OpInfo):
    ...
    def __init__(
        ...
        *,
        ...
        reference_numerics_filter=None,  # Filter for singular input values for test_reference_numerics_small
        **kwargs,
    ):
...
def sample_inputs_index(op_info, device, dtype, requires_grad, **kwargs):
    ...
    for shape, alpha, include_self, reduce in product(
        shapes, alphas, include_selfs, reduces
    ):
        t = make_arg(shape)
        args = []
...
# TODO: Consolidate `i0e` with sample_inputs_elementwise_unary when `make_tensor`,
...
def sample_inputs_binary_cross_entropy_with_logits(
    ...
    def make_weight_shape_kwargs():
        ...
        for shape in ((1,), (1, S), (S), (S, S)):
            kwargs.extend(
                [
                    ((S, S), dict(reduction=reduction, weight=make(shape)))
                    for reduction in reductions
                ]
            )
        return kwargs
...
op_db: List[OpInfo] = [
    ...
    BinaryUfuncInfo(
        ...
        dtypes=all_types_and_complex_and(
            torch.chalf, torch.float16, torch.bfloat16, torch.bool
        ),
        assert_autodiffed=True,
        supports_forward_ad=True,
        supports_fwgrad_bwgrad=True,
    ...
    UnaryUfuncInfo(
        ...
        sample_inputs_func=partial(
            sample_inputs_elementwise_unary, op_kwargs={"decimals": 0}
        ),
        supports_forward_ad=True,
        supports_fwgrad_bwgrad=True,
        assert_autodiffed=False,
    ...
    UnaryUfuncInfo(
        ...
        sample_inputs_func=partial(
            sample_inputs_elementwise_unary, op_kwargs={"decimals": 3}
        ),
        skips=(
    ...
    UnaryUfuncInfo(
        ...
        skips=(
            ...
            DecorateInfo(
                ...
                "TestUnaryUfuncs",
                "test_reference_numerics_extremal",
                dtypes=[torch.complex32, torch.complex64, torch.cdouble],
            ),
            DecorateInfo(
                unittest.skip("Skipped!"),
                "TestUnaryUfuncs",
