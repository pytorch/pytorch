...
def sample_inputs_linalg_lu(op_info, device, dtype, requires_grad=False, full_rank=False, **kwargs):
...
op_db: List[OpInfo] = [
    ...
    OpInfo('linalg.lu_factor',
           ...
           check_batched_gradgrad=False,
           supports_forward_ad=True,
           sample_inputs_func=partial(sample_inputs_linalg_lu, full_rank=True),
    ...
    OpInfo('linalg.lu_factor_ex',
           ...
           check_batched_gradgrad=False,
           supports_forward_ad=True,
           sample_inputs_func=partial(sample_inputs_linalg_lu, full_rank=False),
           decorators=[skipCUDAIfNoMagmaAndNoCusolver, skipCPUIfNoLapack]),
    OpInfo('linalg.lu',
           aten_name='linalg_lu',
           op=torch.linalg.lu,
