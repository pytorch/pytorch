...
def method_tests():
    ...
    return [
        ...
        ('gather_add', (S, S), (0, gather_variable((S, S), 1, S), (M, S)), 'like_scatter_add_dim0', (), [0]),
        ('gather_add', (M, S // 2), (1, gather_variable((M, S // 2), 0, S // 2), (M, S)), 'like_scatter_add_dim1', (), [0]),
        ('gather_add', (), (0, torch.tensor(0, dtype=torch.int64), ()), 'like_scatter_add_scalar_all_dim0', (), [0]),
        ('gather_add', (S, S), (0, gather_variable((S, S), 1, S, True), (M, S)), 'like_gather_dim0', (), [0]),
        ('gather_add', (M, S // 2), (1, gather_variable((M, S // 2), 0, S // 2, True), (M, M)), 'like_gather_dim1', (), [0]),
        ('gather_add', (), (0, torch.tensor([0], dtype=torch.int64), ()), 'scalar_input', (), [0]),
        ('gather_add', (), (0, torch.tensor(0, dtype=torch.int64), (S,)), 'scalar_index', (), [0]),
        ('gather_add', (), (0, torch.tensor(0, dtype=torch.int64), ()), 'scalar_both', (), [0]),
