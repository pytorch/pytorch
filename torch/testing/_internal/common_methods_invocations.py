...
op_db: List[OpInfo] = [
    ...
    UnaryUfuncInfo('nn.functional.hardtanh',
                   ...
                   dtypes=floating_types_and(torch.int8, torch.int16, torch.int32, torch.int64, torch.bfloat16, torch.float16),
                   backward_dtypes=all_types_and(torch.bfloat16, torch.float16),
