...
def method_tests():
    ...
    return [
        ...
        ('log_matmul', (S, M), ((M, S),), "2d_2d", (True,)),
        ('log_matmul', (S, S, M), ((M, S),), "3d_2d", (True,)),
        ('log_matmul', (S, M), ((S, M, S),), "2d_3d", (True,)),
        ('log_matmul', (S, S, S, S), ((S, S, S, M),), "4d_4d", (True,)),
        ('log_matmul', (1, S, S, S), ((S, 1, S, M),), "4d_4d_broadcast", (True,)),
        ('norm', (S, S), (), 'default'),
        ('norm', (S, S), (2,), '2'),
        ('norm', (S, S), (0,), '0'),
        ('norm', (S, S), (0.5,), '0_5'),
