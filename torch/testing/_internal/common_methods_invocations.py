...
def method_tests():
    ...
    return [
        ...
        ('select', (S,), (0, 2), '1d'),
        ('nanprod', (S, S, S), NO_ARGS),
        ('nanprod', (S, S, S), (1,), 'dim', (), [0]),
        ('nanprod', (S, S, S), (1, True,), 'keepdim_dim', (), [0]),
        ('nanprod', (), NO_ARGS, 'scalar'),
        ('nanprod', (), (0,), 'scalar_dim', (), [0]),
        ('nanprod', (), (0, True,), 'scalar_keepdim_dim', (), [0]),
        ('nanprod', prod_zeros(S, [0, 1]), NO_ARGS, 'zerodims2'),
        ('nanprod', prod_zeros(S, [0, 2]), NO_ARGS, 'zerodims1'),
        ('nanprod', prod_zeros(S, [1, 2]), NO_ARGS, 'zerodims0'),
        ('nanprod', prod_zeros(S, [0, 1]), (1,), 'zeros_dims2', (), [0]),
        ('nanprod', prod_zeros(S, [0, 2]), (1,), 'zeros_dims1', (), [0]),
        ('nanprod', prod_zeros(S, [1, 2]), (1,), 'zeros_dims0', (), [0]),
