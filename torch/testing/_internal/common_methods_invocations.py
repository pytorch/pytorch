...
def method_tests():
    ...
    return [
        ...
        ('quantile', (S, S, S), (0.5,), 'linear', (), [1], NO_ARGS, ident, {'interpolation': 'linear'}),
        ('quantile', (S, S, S), (0.5,), 'lower', (), [1], NO_ARGS, ident, {'interpolation': 'lower'}),
        ('quantile', (S, S, S), (0.5,), 'higher', (), [1], NO_ARGS, ident, {'interpolation': 'higher'}),
        ('quantile', (S, S, S), (0.5,), 'midpoint', (), [1], NO_ARGS, ident, {'interpolation': 'midpoint'}),
        ('quantile', (S, S, S), (0.5,), 'nearest', (), [1], NO_ARGS, ident, {'interpolation': 'nearest'}),
        ('quantile', (), (0.5,), 'scalar'),
        ('nanquantile', (S, S, S), (0.5,)),
        ('nanquantile', (S, S, S), (0.5, 0), 'dim', (), [1]),
        ('nanquantile', (S, S, S), (0.5, None, True), 'keepdim'),
        ('nanquantile', (S, S, S), (0.5,), 'linear', (), [1], NO_ARGS, ident, {'interpolation': 'linear'}),
        ('nanquantile', (S, S, S), (0.5,), 'lower', (), [1], NO_ARGS, ident, {'interpolation': 'lower'}),
        ('nanquantile', (S, S, S), (0.5,), 'higher', (), [1], NO_ARGS, ident, {'interpolation': 'higher'}),
        ('nanquantile', (S, S, S), (0.5,), 'midpoint', (), [1], NO_ARGS, ident, {'interpolation': 'midpoint'}),
        ('nanquantile', (S, S, S), (0.5,), 'nearest', (), [1], NO_ARGS, ident, {'interpolation': 'nearest'}),
