...
dynamo_expected_failures = {
    ...
    "TestScript.test_file_line_graph",  # test_jit
    "TestScript.test_lhs_indexing_multi",  # test_jit
    "TestJit.test_constant_prop_if_inline",  # test_jit
    "TestScript.test_robust_op_resolution",  # test_jit
    "TestScript.test_script_non_tensor_args_outputs",  # test_jit
    "TestScript.test_zero_dimension_tensor_trace",  # test_jit
    "TestScript.test_tensor_dtype",  # test_jit
    "TestJit.test_diff_subgraph_clones_constants",  # test_jit
    "TestJit.test_batchnorm",  # test_jit
    "TestScript.test_ellipsis_mid_select",  # test_jit
    "TestScript.test_call_traced_fn_from_tracing_fn",  # test_jit
    "TestScript.test_loop_unroll_negative",  # test_jit
    "TestScript.test_tuple_assignments",  # test_jit
    "TestScript.test_divmod",  # test_jit
    "TestScript.test_inlined_graph",  # test_jit
    "TestScript.test_nn_GRU",  # test_jit
    "TestScript.test_unwrap_optional_builtin",  # test_jit
    "TestScript.test_if_for_in_range",  # test_jit
    "TestJit.test_script_backward",  # test_jit
    "TestScript.test_call_script_fn_from_script_fn",  # test_jit
    "TestScript.test_multiline_optional_future_refinement",  # test_jit
    "TestScript.test_shape_analysis_grad_property",  # test_jit
    "TestScript.test_tuple_str",  # test_jit
    "TestScript.test_constant_pooling_same_identity",  # test_jit
    "TestScript.test_if_is_none_dispatch",  # test_jit
    "TestScript.test_hash",  # test_jit
    "TestScript.test_list_comprehension_variable_write",  # test_jit
    "TestScript.test_return_stmt_not_at_end",  # test_jit
    "TestScript.test_error_stacktrace",  # test_jit
    "TestScript.test_op_dtype",  # test_jit
    "TestScript.test_device_kwarg",  # test_jit
    "TestJit.test_conj_transpose",  # test_jit
    "TestScript.test_annotated_script_fn",  # test_jit
    "TestScript.test_big_int_literals",  # test_jit
    "TestScript.test_python_call_non_tensor",  # test_jit
    "TestJit.test_sparse_csr_tensors",  # test_jit
    "TestScript.test_hex_literals",  # test_jit
    "TestScript.test_loop_unrolling_nested",  # test_jit
    "TestJit.test_matrix_conj_transpose",  # test_jit
    "TestScript.test_no_dtype_shape",  # test_jit
    "TestScript.test_tuple_unsortable_nested_diff_type",  # test_jit
    "TestScript.test_if_define",  # test_jit
    "TestScript.test_call_script_fn_from_script_module",  # test_jit
    "TestScript.test_parse_nested_names",  # test_jit
    "TestScript.test_torch_any",  # test_jit
    "TestJit.test_transpose",  # test_jit
    "TestScript.test_submodule_twice",  # test_jit
    "TestJitProfiler.test_profiler",  # test_jit
    "TestScript.test_infer_size",  # test_jit
    "TestJit.test_function_default_values",  # test_jit
    "TestScript.test_empty_tuple_str",  # test_jit
    "TestScript.test_ellipsis_end",  # test_jit
    "TestJit.test_python_bindings",  # test_jit
    "TestJit.test_constant_prop_aliasing_type",  # test_jit
    "TestScript.test_backend_cudnn_enabled",  # test_jit
    "TestScript.test_call_script_fn_from_tracing_fn",  # test_jit
    "TestScript.test_is_scripting_metacompile",  # test_jit
    "TestScript.test_floor_div",  # test_jit
    "TestJit.test_torch_load_zipfile_check",  # test_jit
    "TestScript.test_lhs_indexing",  # test_jit
    "TestScript.test_torch_functional_tensordot_int",  # test_jit
    "TestScript.test_type_annotate",  # test_jit
    "TestScript.test_type_call_in_script",  # test_jit
    "TestScript.test_split",  # test_jit
    "TestScript.test_shape_prop_promotion",  # test_jit
    "TestScript.test_loop_unroll_unused_counter",  # test_jit
    "TestScript.test_augmented_assign",  # test_jit
    "TestScript.test_ellipsis_const_mid_select",  # test_jit
    "TestScript.test_all",  # test_jit
    "TestScript.test_while",  # test_jit
    "TestScript.test_nested_bailouts",  # test_jit
    "TestScript.test_select_after_chunk",  # test_jit
    "TestScript.test_constant_pooling_introduce_aliasing",  # test_jit
    "TestScript.test_tensor_to_cpu",  # test_jit
    "TestScript.test_tuple_unsortable_diff_type",  # test_jit
    "TestScript.test_cat_lifts",  # test_jit
    "TestScript.test_string_print",  # test_jit
    "TestJit.test_constant_prop_print",  # test_jit
    "TestScript.test_call_python_fn_from_script_fn",  # test_jit
    "TestScript.test_function_overloads",  # test_jit
    "TestScript.test_ignored_as_value",  # test_jit
    "TestScript.test_script_chunk",  # test_jit
    "TestScript.test_view_write",  # test_jit
    "TestScript.test_no_self_arg_ignore_function",  # test_jit
    "TestJit.test_pretty_printer",  # test_jit
    "TestScript.test_file_reader_no_memory_leak",  # test_jit
    "TestJit.test_cse_not_introduce_aliasing",  # test_jit
    "TestScript.test_python_op_builtins",  # test_jit
    "TestScript.test_type_annotations_varargs",  # test_jit
    "TestScript.test_compare_two_bool_inputs",  # test_jit
    "TestJit.test_T_mT_H_mH",  # test_jit
    "TestScript.test_lhs_advanced_indexing_assignment",  # test_jit
    "TestScript.test_python_call_non_tensor_wrong",  # test_jit
    "TestScript.test_literals",  # test_jit
    "TestScript.test_type_annotation_module",  # test_jit
    "TestScript.test_early_return_fork_join",  # test_jit
    "TestScript.test_mutable_dce_loop",  # test_jit
    "TestScript.test_return_tuple",  # test_jit
    "TestScript.test_device_type",  # test_jit
    "TestScript.test_wrong_implicit_expand",  # test_jit
    "TestScript.test_lhs_indexing_increment",  # test_jit
    "TestScript.test_script_docstring",  # test_jit
    "TestScript.test_kwarg_expansion_error",  # test_jit
    "TestScript.test_sum",  # test_jit
    "TestScript.test_nn_LSTM_with_layers",  # test_jit
    "TestScript.test_desugar_module",  # test_jit
    "TestJit.test_constant_prop_if_constant",  # test_jit
    "TestScript.test_resize_input_ops",  # test_jit
    "TestScript.test_code_with_constants_restore",  # test_jit
    "TestJit.test_numel",  # test_jit
    "TestScript.test_conv_error",  # test_jit
    "TestJit.test_sparse_tensors",  # test_jit
    "TestJit.test_constant_prop_rand",  # test_jit
    "TestScript.test_early_return_rewrite",  # test_jit
    "TestScript.test_empty_like_memory_format_bc",  # test_jit
    "TestScript.test_tensor_import_export",  # test_jit
    "TestScript.test_narrow_copy",  # test_jit
    "TestJit.test_torch_sum",  # test_jit
    "TestScript.test_cpp_function_tensor_str",  # test_jit
    "TestScript.test_mutable_dce",  # test_jit
    "TestScript.test_shape_analysis_loop",  # test_jit
    "TestScript.test_unused_decorator",  # test_jit
    "TestScript.test_isinstance_dynamic",  # test_jit
    "TestScript.test_for_else",  # test_jit
    "TestScript.test_if_noelse",  # test_jit
    "TestScript.test_tensor_shape",  # test_jit
    "TestScript.test_early_return_type_refinement",  # test_jit
    "TestScript.test_for_in_tensors_nested",  # test_jit
    "TestJit.test_matrix_transpose",  # test_jit
    "TestScript.test_return",  # test_jit
    "TestScript.test_type_comments_in_body",  # test_jit
    "TestJit.test_hide_source_ranges_context_manager",  # test_jit
    "TestScript.test_grad_from_script",  # test_jit
    "TestScript.test_singleton_tuple_unpack",  # test_jit
    "TestScript.test_pickle_checkpoint_tup",  # test_jit
    "TestScript.test_for_in_range_if_ast",  # test_jit
    "TestScript.test_add_tuple_non_optional",  # test_jit
    "TestScript.test_big_float_literals",  # test_jit
    "TestScript.test_inplace_copy_script",  # test_jit
    "TestScript.test_builtin_args",  # test_jit
    "TestScript.test_str_cast",  # test_jit
    "TestScript.test_unicode_comments",  # test_jit
    "TestScript.test_string_device_implicit_conversion",  # test_jit
    "TestScript.test_fibb",  # test_jit
    "TestScript.test_python_call",  # test_jit
    "TestScript.test_where",  # test_jit
    "TestScript.test_where_method",  # test_jit
    "TestScript.test_expand",  # test_jit
    "TestJit.test_constant_prop_remove_output",  # test_jit
    "TestScript.test_error_stacktrace_interface",  # test_jit
    "TestScript.test_script_pad_sequence_pack_sequence",  # test_jit
    "TestScript.test_dict_str",  # test_jit
    "TestScript.test_logical_short_circuit",  # test_jit
    "TestJit.test_torch_complex",  # test_jit
    "TestScript.test_mypy_type_ignore",  # test_jit
    "TestScript.test_constant_pooling_none",  # test_jit
    "TestScript.test_file_line_trace",  # test_jit
    "TestScript.test_parse_tensor_constants",  # test_jit
    "TestScript.test_shape_prop_promote_scalar_arg",  # test_jit
    "TestScript.test_inplace_add",  # test_jit
    "TestScript.test_torchscript_multi_head_attn",  # test_jit
    "TestScript.test_script_get_tracing_state",  # test_jit
    "TestScript.test_multiple_assignment",  # test_jit
    "TestScript.test_add_out",  # test_jit
    "TestScript.test_python_frontend",  # test_jit
    "TestScript.test_jitter_bug",  # test_jit
    "TestScript.test_for_in_enumerate",  # test_jit
    "TestScript.test_lhs_indexing_list",  # test_jit
    "TestScript.test_tensor_grad",  # test_jit
    "TestScript.test_method_overloading",  # test_jit
    "TestScript.test_script_clamp_none",  # test_jit
    "TestScript.test_assert_is_scripting_metacompile",  # test_jit
    "TestJit.test_script_autograd_grad",  # test_jit
    "TestScript.test_tensor_to",  # test_jit
    "TestScript.test_torch_functional_tensordot_tensor",  # test_jit
    "TestScript.test_script_module_tensor_subclass_argument",  # test_jit
    "TestScript.test_torchscript_memoryformat",  # test_jit
    "TestScript.test_inlining_cleanup",  # test_jit
    "TestScript.test_isinstance_metacompile",  # test_jit
    "TestScript.test_nested_breaks",  # test_jit
    "TestScript.test_script_annotation",  # test_jit
    "TestScript.test_mutable_dce_block",  # test_jit
    "TestJit.test_einsum",  # test_jit
    "TestScript.test_type_inferred_from_empty_annotation",  # test_jit
    "TestScript.test_add_tuple_optional",  # test_jit
    "TestScript.test_addmm_grad",  # test_jit
    "TestScript.test_code_with_constants",  # test_jit
    "TestScript.test_script_optional_none",  # test_jit
    "TestScript.test_mutable_dce_graph_input",  # test_jit
    "TestScript.test_call_python_fn_from_tracing_fn",  # test_jit
    "TestScript.test_namedtuple_attr",  # test_jit
    "TestScript.test_int_cast",  # test_jit
    "TestScript.test_tuple_index_to_list",  # test_jit
    "TestScript.test_inferred_error_msg",  # test_jit
    "TestScript.test_while_write_outer_then_read",  # test_jit
    "TestScript.test_pretty_print_function",  # test_jit
    "TestScript.test_tuple_unsortable_element_type",  # test_jit
    "TestScript.test_ellipsis_const_end",  # test_jit
    "TestScript.test_type_annotations",  # test_jit
    "TestScript.test_not",  # test_jit
    "TestScript.test_canonicalize_control_outputs",  # test_jit
    "TestJit.test_constant_prop_loop_constant",  # test_jit
    "TestScript.test_namedtuple_default_values_using_factory_constructor",  # test_jit
    "TestScript.test_namedtuple_type_inference",  # test_jit
    "TestScript.test_lhs_indexing_increment_list",  # test_jit
    "TestScript.test_torch_tensor_dtype",  # test_jit
    "TestScript.test_tuple_len",  # test_jit
    "TestJit.test_script_backward_twice",  # test_jit
    "TestScript.test_unspecialized_any_binding",  # test_jit
    "TestScript.test_ellipsis_start",  # test_jit
    "TestScript.test_lower_nested_tuples",  # test_jit
    "TestScript.test_keyword",  # test_jit
    "TestScript.test_pack_unpack_state",  # test_jit
    "TestScript.test_script_method_torch_function_overload",  # test_jit
    "TestScript.test_erase_number_types",  # test_jit
    "TestScript.test_ellipsis_const_mid",  # test_jit
    "TestScript.test_ellipsis_mid",  # test_jit
    "TestJit.test_constant_prop_simple",  # test_jit
    "TestScript.test_none_type_str",  # test_jit
    "TestScript.test_block_input_grad_in_loop",  # test_jit
    "TestJit.test_attrs",  # test_jit
    "TestJit.test_element_size",  # test_jit
    "TestJit.test_script_tensor_type",  # test_jit
    "TestScript.test_number_abs",  # test_jit
    "TestScript.test_oneline_func",  # test_jit
    "TestScript.test_torch_functional_tensordot_list",  # test_jit
    "TestScript.test_loop_unrolling",  # test_jit
    "TestJit.test_constant_prop_nested",  # test_jit
    "TestScript.test_wrong_return_type",  # test_jit
    "TestScript.test_mutable_dce_list",  # test_jit
    "TestScript.test_func_call",  # test_jit
    "TestScript.test_for_in_tensors",  # test_jit
    "TestScript.test_tuple_indexing",  # test_jit
    "TestScript.test_if_supertype",  # test_jit
    "TestScript.test_is_scripting",  # test_jit
    "TestScript.test_ellipsis_const_start",  # test_jit
    "TestScript.test_namedtuple_python",  # test_jit
    "TestJit.test_constants_pkl",  # test_jit
    "TestScript.test_python_frontend_py3",  # test_jit
    "TestScript.test_ternary",  # test_jit
    "TestScript.test_tensor_data",  # test_jit
    "TestScript.test_is_after_use",  # test_jit
    "TestScript.test_tuple_to_opt_list",  # test_jit
    "TestScript.test_kwargs_error_msg",  # test_jit
    "TestScript.test_file_line_error",  # test_jit
    "TestScript.test_tensor_len",  # test_jit
    "TestJit.test_constant_prop_none",  # test_jit
    "TestScript.test_error",  # test_jit
    "TestScript.test_lazy_script",  # test_jit
    "TestScript.test_embedding_renorm_grad_error",  # test_jit
    "TestScript.test_union_to_number",  # test_jit
    "TestScript.test_if",  # test_jit
    "TestScript.test_for_in_zip",  # test_jit
    "TestScript.test_isinstance_refinement",  # test_jit
    "TestScript.test_sys_stdout_override",  # test_jit
    "TestScript.test_call_python_fn_from_script_module",  # test_jit
    "TestScript.test_intlist_args",  # test_jit
    "TestJit.test_repeat_interleave_script",  # test_jit
    "TestScript.test_torch_pow",  # test_jit
    "TestScript.test_format",  # test_jit
    "TestScript.test_bitwise_ops",  # test_jit
    "TestScript.test_for_in_range_zero_step",  # test_jit
    "TestScript.test_pybind_type_comparisons",  # test_jit
    "TestJit.test_decompose_addmm",  # test_jit
    "TestJit.test_shape_analysis_broadcast",  # test_jit
    "TestScript.test_list_python_op",  # test_jit
    "TestScript.test_multiline_string_dedents",  # test_jit
    "TestScript.test_function_compilation_caching",  # test_jit
    "TestScript.test_script_is_tracing",  # test_jit
    "TestScript.test_string_sorted",  # test_jit
    "TestScript.test_input_keyword_in_schema",  # test_jit
    "TestScript.test_file_format_serialization",  # test_jit
    "TestScript.test_assertion_optional_refinement",  # test_jit
    "TestScript.test_python_call_annotation",  # test_jit
    "TestScript.test_loop_unrolling_const",  # test_jit
    "TestScript.test_literal",  # test_jit
    "TestScript.test_mm_batching",  # test_jit
    "TestScript.test_function_overloading_isinstance",  # test_jit
    "TestScript.test_for_tuple_unpack",  # test_jit
    "TestScript.test_if_list_cat",  # test_jit
    "TestScript.test_lhs_advanced_indexing_augmented_assignment",  # test_jit
    "TestJit.test_layout",  # test_jit
    "TestScript.test_torch_functional_tensordot_tuple",  # test_jit
    "TestScript.test_unfold_zero_dim",  # test_jit
...
dynamo_skips = {
    ...
    "TestBackends.test_errors",  # known py38 fail
