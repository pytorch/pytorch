...
from torch.quantization import (DeQuantStub, PerChannelMinMaxObserver, QConfig,
                                QConfigDynamic, QuantStub, QuantType,
                                QuantWrapper, convert, default_dynamic_qconfig,
                                default_dynamic_quant_observer,
                                default_observer, default_per_channel_qconfig,
                                default_qconfig, default_weight_observer,
                                float_qparams_weight_only_qconfig,
                                get_default_qat_qconfig, get_default_qconfig,
                                propagate_qconfig_, quantize_dynamic_jit,
                                quantize_jit)
from torch.quantization.quantization_mappings import (
    get_default_dynamic_quant_module_mappings, get_default_qat_module_mappings,
