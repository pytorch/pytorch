    ...
    if HAS_FX:
        ...
        def assert_types_for_matched_subgraph_pairs(
            ...
            for k, v in expected_types.items():
                ...
                self.assertTrue(
                    types_match,
                    f'Type mismatch at {k}: expected {(exp_type_start_a, exp_type_end_a, exp_type_start_b, exp_type_end_b)}, got {(act_type_start_a, act_type_end_a, act_type_start_b, act_type_end_b)}'
                )
