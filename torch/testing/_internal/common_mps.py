...
if torch.backends.mps.is_available():
    ...
    def mps_ops_modifier(
        ...
        UNIMPLEMENTED_XFAILLIST = {
            ...
            "special.ndtri": None,
            "special.shifted_chebyshev_polynomial_t": None,
            "special.shifted_chebyshev_polynomial_u": None,
            "special.shifted_chebyshev_polynomial_v": None,
            "special.shifted_chebyshev_polynomial_w": None,
            "svd_lowrank": None,
            "symeig": None,
            "take": None,
            "to": None,
