...
if torch.backends.mps.is_available():
    ...
    def mps_ops_modifier(
        ...
        UNIMPLEMENTED_XFAILLIST: dict[str, Optional[list]] = {
            ...
            "hash_tensor": None,
            "heaviside": None,
            "index_reduceprod": None if MACOS_VERSION < 15.0 else [],
            "index_reducemean": None if MACOS_VERSION < 15.0 else [],
            "index_reduceamax": None if MACOS_VERSION < 15.0 else [],
            "index_reduceamin": None if MACOS_VERSION < 15.0 else [],
            # "kthvalue": None,
            "lcm": None,
            "linalg.cond": None,
            "linalg.eigh": None,
