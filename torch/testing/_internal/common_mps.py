...
if torch.backends.mps.is_available():
    ...
    def mps_ops_modifier(
        ...
        UNIMPLEMENTED_XFAILLIST: dict[str, Optional[list]] = {
            ...
            "ormqr": None,
            "pca_lowrank": None,
            "polar": [torch.float16, torch.bfloat16],
            "pow": [torch.bool],
            "qr": None,
            ...
            "special.bessel_j0": [torch.float16, torch.bfloat16],
            "special.bessel_j1": [torch.float16, torch.bfloat16],
            "special.bessel_y0": [torch.float16, torch.bfloat16],
            "special.bessel_y1": [torch.float16, torch.bfloat16],
            "special.chebyshev_polynomial_t": [torch.float16, torch.bfloat16],
            "special.chebyshev_polynomial_u": [torch.float16, torch.bfloat16],
            "special.chebyshev_polynomial_v": [torch.float16, torch.bfloat16],
            "special.chebyshev_polynomial_w": [torch.float16, torch.bfloat16],
            "special.erfcx": None,
            "special.hermite_polynomial_h": [torch.float16, torch.bfloat16],
            "special.hermite_polynomial_he": [torch.float16, torch.bfloat16],
            "special.laguerre_polynomial_l": None,
            "special.legendre_polynomial_p": None,
            "special.log_ndtr": None,
            "special.modified_bessel_i0": [torch.float16, torch.bfloat16],
            "special.modified_bessel_i1": [torch.float16, torch.bfloat16],
            "special.modified_bessel_k0": [torch.float16, torch.bfloat16],
            "special.modified_bessel_k1": [torch.float16, torch.bfloat16],
            "special.ndtri": None,
            "special.scaled_modified_bessel_k0": [torch.float16, torch.bfloat16],
            "special.scaled_modified_bessel_k1": [torch.float16, torch.bfloat16],
            "special.shifted_chebyshev_polynomial_t": [torch.float16, torch.bfloat16],
            "special.shifted_chebyshev_polynomial_u": [torch.float16, torch.bfloat16],
            "special.shifted_chebyshev_polynomial_v": [torch.float16, torch.bfloat16],
            "special.shifted_chebyshev_polynomial_w": [torch.float16, torch.bfloat16],
            "special.spherical_bessel_j0": [torch.float16, torch.bfloat16],
            "special.zeta": [torch.float16, torch.bfloat16],
