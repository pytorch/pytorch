...
def create_script_fn(self, method_name, func_type, output_process_fn):
    def script_fn(*args, **kwargs):
        ...
        setattr(script_fn, 'last_graph', fn.graph_for(*tensors))
        return output
    return script_fn
...
def create_traced_fn(self, fn):
    def traced_fn(*inputs, **kwargs):
        ...
        setattr(traced_fn, 'last_graph', traced.graph_for(*inputs_tensors))
        return output
    return traced_fn
...
def create_script_module(self, nn_module, constructor_args, *args, **kwargs):
    def script_module(*args, **kwargs):
        ...
        if self:
            ...
            module(*args)
        setattr(create_script_module, 'last_graph', module.graph)
        return module
