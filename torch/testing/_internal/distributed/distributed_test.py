    ...
    class _DistTestBase:
        ...
        def _test_barrier_timeout(self, group_id, timeout):
            ...
            if local_rank == 0:
                ...
                if dist._get_debug_level() == dist._DebugLevel.DETAIL:
            ...
            if expect_event and dist.get_backend() in PROFILING_SUPPORTED_BACKENDS:
                ...
                for e in events:
                    ...
                    if (
                        ...
                        and dist._get_debug_level() != dist._DebugLevel.DETAIL
                    ):
                        self.assertEqual(
                            e.input_shapes,
                            tensor_shapes,
            ...
            for i in range(2):
                ...
                if i > 0:
                    ...
                    try:
                        ...
                        if dist._get_debug_level() == dist._DebugLevel.OFF:
        ...
        def _determine_expected_error_verify_model_across_rank(self, group_to_use):
            ...
            # to be caught inline.
            is_detail_dbg_mode = (
                dist._get_debug_level() == dist._DebugLevel.DETAIL
            )
            if self.rank == 0:
        ...
        def _test_ddp_multiple_nested_unused_params_error(self, ignore_sparse):
            debug_mode_off = dist._get_debug_level() == dist._DebugLevel.OFF
