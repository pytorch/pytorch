...
@torch.jit.script
def call_rpc_with_profiling(handle: torch.classes.profiler._RecordFunctionHolder, dst_worker_name: str) -> Tensor:
...
@torch.jit.script
def call_fork_with_profiling(handle: torch.classes.profiler._RecordFunctionHolder) -> Tensor:
