...
new_module_tests = [
    ...
    dict(
        module_name='LayerNorm',
        constructor_args=([4, 5, 6], 1e-3),
        cpp_constructor_args='torch::nn::LayerNormOptions({4, 5, 6}).eps(1e-3)',
        input_size=(4, 4, 5, 6),
        cudnn=True,
        check_eval=True,
    ...
    dict(
        module_name='LayerNorm',
        constructor_args=([4, 5, 6], 1e-3, False),
        cpp_constructor_args='torch::nn::LayerNormOptions({4, 5, 6}).eps(1e-3).elementwise_affine(false)',
        input_size=(4, 4, 5, 6),
        cudnn=True,
        check_eval=True,
