        ...
        **kwargs: Any,
        ...
        error_meta = check_tensors(
            ...
            or functools.partial(
                _make_mismatch_msg,
                identifier=lambda default_identifier: f"Real components of {default_identifier.lower()}",
            ),
            **kwargs,
        )
        if error_meta:
        ...
        error_meta = check_tensors(
            ...
            or functools.partial(
                _make_mismatch_msg,
                identifier=lambda default_identifier: f"Imaginary components of {default_identifier.lower()}",
            ),
            **kwargs,
        )
        if error_meta:
