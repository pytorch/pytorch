...
def _rebuild_tensor_v2(
    storage, storage_offset, size, stride, requires_grad, backward_hooks, post_grad_accumulation_hooks, metadata=None
):
    ...
    tensor._post_grad_accumulation_hooks = post_grad_accumulation_hooks
    return tensor
