        ...
        try:
            ...
            if err.code == 300:
                ...
                warnings.warn(
                    ...
                    "refs/tags/tag_name as the ref. That might require using skip_validation=True.", stacklevel=1
                )
    ...
    if trust_repo is None:
        if not is_trusted:
            warnings.warn(
                ...
                f"confirmation if the repo is not already trusted. This will eventually be the default behaviour", stacklevel=1)
        return
...
def get_dir():
    ...
    if os.getenv('TORCH_HUB'):
        warnings.warn('TORCH_HUB is deprecated, please use env TORCH_HOME instead', stacklevel=1)
...
def _legacy_zip_load(filename: str, model_dir: str, map_location: MAP_LOCATION, weights_only: bool) -> Dict[str, Any]:
    warnings.warn('Falling back to the old format < 1.6. This support will be '
                  ...
                  'Please redo torch.save() to save it in the new zipfile format.', stacklevel=1)
...
def load_state_dict_from_url(
    ...
    if os.getenv('TORCH_MODEL_ZOO'):
        warnings.warn('TORCH_MODEL_ZOO is deprecated, please use env TORCH_HOME instead', stacklevel=1)
