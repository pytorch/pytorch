...
from .default_mappings import DEFAULT_NUMERIC_SUITE_COMPARE_MODEL_OUTPUT_ALLOW_LIST
...
def prepare_model_outputs(
    ...
    q_module,
    Logger=OutputLogger,
    allow_list=DEFAULT_NUMERIC_SUITE_COMPARE_MODEL_OUTPUT_ALLOW_LIST,
):
    ...
    prepare(q_module, inplace=True, allow_list=allow_list)
