...
DEFAULT_STATIC_QUANT_MODULE_MAPPINGS : Dict[Callable, torch.nn.Module] = {
...
DEFAULT_QAT_MODULE_MAPPINGS : Dict[Callable, torch.nn.Module] = {
...
DEFAULT_DYNAMIC_QUANT_MODULE_MAPPINGS : Dict[Callable, torch.nn.Module] = {
...
def get_default_static_quant_module_mappings() -> Dict[Callable, torch.nn.Module]:
...
def get_static_quant_module_class(
        ...
        additional_static_quant_mapping: Optional[Dict[Callable, torch.nn.Module]] = None) -> torch.nn.Module:
...
def get_dynamic_quant_module_class(
        float_module_class: Callable,
        additional_dynamic_quant_mapping: Optional[Dict[Callable, torch.nn.Module]] = None) -> torch.nn.Module:
...
def get_default_qat_module_mappings() -> Dict[Callable, torch.nn.Module]:
    ''' Get default module mapping for quantization aware training
    '''
    return DEFAULT_QAT_MODULE_MAPPINGS

def get_default_dynamic_quant_module_mappings() -> Dict[Callable, torch.nn.Module]:
