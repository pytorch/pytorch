...
def _convert_fx(
        graph_module: GraphModule, output_a_reference_model: bool,
    ...
    quantizer = Quantizer()
    quantized = quantizer.convert(graph_module, output_a_reference_model, convert_custom_config_dict, is_standalone_module)
...
def convert_fx(
        graph_module: GraphModule, output_a_reference_model: bool = False,
        convert_custom_config_dict: Dict[str, Any] = None) -> GraphModule:
    r""" Convert a calibrated or trained model to a quantized model
    Args:
        `graph_module`: A prepared and calibrated/trained model (GraphModule)
        `output_a_reference_model`: flag for whether to produce a reference quantized model,
    ...
    return _convert_fx(graph_module, output_a_reference_model, convert_custom_config_dict)
...
def _convert_standalone_module_fx(
    ...
    """
    return _convert_fx(graph_module, output_a_reference_model, convert_custom_config_dict, is_standalone_module=True)
