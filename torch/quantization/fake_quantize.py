...
class FakeQuantize(Module):
    ...
    * :attr:`dtype` specifies the quantized dtype that is being emulated with fake-quantization,
    ...
    def __init__(self, observer=MovingAverageMinMaxObserver, quant_min=0, quant_max=255, **observer_kwargs):
        ...
        # replication in DDP
        self.register_buffer('fake_quant_enabled', torch.tensor([True], dtype=torch.bool))
        self.register_buffer('observer_enabled', torch.tensor([True], dtype=torch.bool))
    ...
    def enable_fake_quant(self, enabled=True):
        self.fake_quant_enabled[0] = enabled
        return self
    ...
    def enable_observer(self, enabled=True):
        self.observer_enabled[0] = enabled
        return self
