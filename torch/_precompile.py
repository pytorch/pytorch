...
class _DynamoCapture:
    ...
    def __init__(
        ...
        *,
        ...
        dynamic: bool = False,
        trains: bool = False,
        grad_param_states: list[
            tuple[int, list[tuple[str, object]], str, bool]
        ]
        | None = None,
    ) -> None:
...
def _param_grad_inputs(
    ...
    list[tuple[int, list[tuple[str, object]], str, bool]], list[str], bool
]:
        ...
        if trains:
            ...
            try:
                ...
                if seeded and not any_grad_inputs:
                    ...
                    # what fn OBSERVED about .grad. No runtime state check is needed.
                    grad_param_states = []
            finally:
                for p in seeded:
                    p.grad = None
