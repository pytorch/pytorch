...
class _PrecompileApi:
    ...
    def __call__(
        ...
        *example_args: object,
        ...
        # Only the real capture retains graphs to render; the probe above threw
        # its lowering away, so paying for source there would be pure waste.
        session._session._keep_graphs = True
        with session:
            pass
