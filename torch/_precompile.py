...
def _capture_dynamo(
    ...
    try:
        ...
        grad_guard_sources = _user_grad_guard_sources(capture_output)
        candidates = (
            _grad_param_candidates(fn, args) if trains or grad_guard_sources else []
        )
        initially_none = {
        ...
        grad_param_states = guarded_states
        if trains:
