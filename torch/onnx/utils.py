...
from torch._C import ListType, UnionType, TensorType, _propagate_and_assign_input_shapes, _check_onnx_proto
...
def _is_constant_tensor_list(node):
    ...
    if output_type.isSubtypeOf(ListType.ofTensors()):
        return True
    if output_type.isSubtypeOf(ListType(UnionType.createOptionalOf(TensorType.get()))):
        return True
