from torch.onnx.symbolic_helper import _deny_list_in_opset
...
for deny_listed_op in deny_listed_operators:
    vars()[deny_listed_op] = _deny_list_in_opset(deny_listed_op)
