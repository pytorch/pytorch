...
from torch.onnx._internal.fx import diagnostics, dispatcher
...
def validate_op_between_ort_torch(
    ...
    result into SARIF, under the section of `dispatcher`.
    ...
    with evaluator.default_as(evaluator.ort_evaluator):
        ...
        kwargs_onnx = dispatcher.filter_incompatible_and_dtype_convert_kwargs(
            torch_kwargs
        )
        try:
