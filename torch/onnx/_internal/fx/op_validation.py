...
def validate_op_between_ort_torch(
    ...
    with evaluator.default_as(evaluator.ort_evaluator):
        ...
        function_args, function_kwargs = _tag_arguments_with_param_schemas(
...
def _tag_arguments_with_param_schemas(
    ...
    list[tuple[Any, onnxscript.values.ParamSchema]],
    dict[str, tuple[Any, onnxscript.values.ParamSchema]],
]:
    ...
    tagged_args: list[tuple[Any, onnxscript.values.ParamSchema]] = []
    tagged_kwargs: dict[str, tuple[Any, onnxscript.values.ParamSchema]] = {}
