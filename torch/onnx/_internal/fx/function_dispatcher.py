...
_ATENLIB_FUNCTIONS = {
    ...
    "aten::all_dim": ops.core.aten_all_dim,
    ...
    "aten::index_put_bool": ops.core.aten_index_put_bool,
    ...
    "aten::min_dim": ops.core.aten_min_dim,
    "aten::min_other": ops.core.aten_min_other,
    ...
    "aten::squeeze_dim": ops.core.aten_squeeze_dim,
    "aten::squeeze": ops.core.aten_squeeze,
    "aten::stack": ops.core.aten_stack,
    "aten::sub": ops.core.aten_sub,
    "aten::sum_dim_IntList": ops.core.aten_sum_dim_IntList,
