...
def _ts_graph_to_onnx_model_in_protobuf(ts_graph, ts_name_to_real_tensor, opset_version):
...
def _export(
    ...
    *args,
    ...
    onnx_model = _ts_graph_to_onnx_model_in_protobuf(ts_graph, ts_initializers, opset_version)
