...
def prelu(g, self, weight):
    ...
    assert self_rank is None or sym_help._get_tensor_rank(self) >= len(sym_help._get_tensor_sizes(weight)), "slope must be unidirectionally broadcastable to input tensor"
