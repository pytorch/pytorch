...
def get_fast_numerical_jacobian_wrt_specific_input(fn, input_idx, input, inputs, outputs, u,
                                                   eps) -> Tuple[torch.Tensor, ...]:
    ...
    jacobian_cols = compute_numerical_jacobian_cols(jvp_fn, u * eps, input.is_complex())
