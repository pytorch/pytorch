...
class emit_nvtx(object):
    ...
    **Forward-backward correlation**
    ...
    it can be difficult to correlate each backward-pass op with the forward-pass op that required it.
    ...
    **Double-backward**
    ...
    double-backward, the Function objects' ``apply()`` ranges are still tagged with the 
    stashed numbers, which can be compared to `seq` numbers from the backward pass.
