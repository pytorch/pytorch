...
def once_differentiable(fn):
    ...
    def wrapper(ctx, *args):
        ...
        requires_grad = any(torch.is_tensor(arg) and arg.requires_grad
                            for arg in args)
...
_iter_variables = _iter_filter(torch.is_tensor, condition_msg="Tensors")
_iter_variables_permissive = _iter_filter(torch.is_tensor, allow_unknown=True)
...
_map_variable_tensor = _nested_map(torch.is_tensor, lambda o: o.data,
