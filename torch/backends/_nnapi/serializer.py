...
class _NnapiSerializer:
    ...
    def add_cat(self, node):
        ...
        if in_oper.dim_order == DimOrder.CHANNELS_LAST:  # type: ignore[possibly-undefined]  # TODO: audit
    ...
    def add_upsample_nearest2d(self, node):
        ...
        if node.inputsSize() == 3:
            scale_ctype, scale_arg = self.get_constant_value(scale_jit)  # type: ignore[possibly-undefined]  # TODO: audit
        else:
            scale_h_ctype, scale_h_arg = self.get_constant_value(scale_h_jit)  # type: ignore[possibly-undefined]  # TODO: audit
            scale_w_ctype, scale_w_arg = self.get_constant_value(scale_w_jit)  # type: ignore[possibly-undefined]  # TODO: audit
