...
class cuFFTPlanCache(object):
    size = ContextProp(_C._cufft_get_plan_cache_size,
    ...
    max_size = ContextProp(_C._cufft_get_plan_cache_max_size, _C._cufft_set_plan_cache_max_size)
    clear = _C._cufft_clear_plan_cache
