    ...
    def gen_wrap_fn(self, func, args, kwargs):
        ...
        def wrap(e, device=None):
            ...
            if isinstance(e, torch.Tensor) and not isinstance(e, FakeTensor):
                ...
                elif e.device.type == "meta":
                    return converter.from_meta_and_device(
                        self, e, device or common_device
                    )
                else:
                    # This is needed because when the executed opoverload doesn't have meta
                    # device registration, the output generated by r = func(*args, **kwargs)
                    # in FakeTensorMode.__torch_dispatch__ becomes a real tensor.
                    return self.from_tensor(e)
            else:
                return e
