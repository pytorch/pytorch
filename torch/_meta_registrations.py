...
def _parse_qr_mode(mode: str) -> Tuple[bool, bool]:
    ...
    return compute_q, reduced  # type: ignore[possibly-undefined]  # TODO: audit
...
def triangular_solve_meta(
    ...
    return solution, cloned_coefficient  # type: ignore[possibly-undefined]  # TODO: audit
...
def _pad3d_common(input, padding, *, is_reflection):
    ...
    if batch_mode:
        return input.new_empty((nbatch, nplane, output_d, output_h, output_w))  # type: ignore[possibly-undefined]  # TODO: audit
    else:
