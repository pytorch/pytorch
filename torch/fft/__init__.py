...
Note:
    Supports torch.half and torch.chalf on CUDA with GPU Architecture SM53 or greater.
    However it only supports powers of 2 signal size along the dimenions of FFT.
...
Note:
    Supports torch.half and torch.chalf on CUDA with GPU Architecture SM53 or greater.
    However it only supports powers of 2 signal size along the dimenions of IFFT.
...
Note:
    ...
    However it only supports powers of 2 signal length along the dimenions of FFT.
...
Note:
    Supports torch.half and torch.chalf on CUDA with GPU Architecture SM53 or greater.
    However it only supports powers of 2 signal size along the dimenion of IFFT.
...
Note:
    Supports torch.half on CUDA with GPU Architecture SM53 or greater.
    However it only supports powers of 2 signal length along the dimenions of IFFT.
