    ...
    * adds loggers to the outputs of node_a and node_b
    ...
    for node_b in gm_b.graph.nodes:
        ...
        if (node_b_is_start_node or node_b_is_end_node):
            ...
            fqn_base_b = _maybe_get_fqn(subgraph_b.base_op_node, gm_b)  # type: ignore[possibly-undefined]  # TODO: audit
            ...
            if node_b_is_start_node:
                ...
                prev_node_c = get_normalized_nth_input(node_c, gm_b, 0)  # type: ignore[possibly-undefined]  # TODO: audit
                if should_log_inputs:
                ...
                if should_log_inputs:
                    ...
                    while get_normalized_nth_input(cur_node, gm_b, 0) != input_logger:  # type: ignore[possibly-undefined]  # TODO: audit
