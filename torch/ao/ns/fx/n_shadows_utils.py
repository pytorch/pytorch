...
class OutputProp:
    ...
    def propagate(self, *args):
        ...
        for node in self.graph.nodes:
            ...
            if isinstance(result, torch.Tensor):  # type: ignore[possibly-undefined]  # TODO: audit
...
def create_submodule_from_subgraph(
    ...
    while True:
        if cur_node_orig is first_node:
            ...
            # first node.
            cur_args_copy = [cur_node_copy]  # type: ignore[has-type, possibly-undefined]  # noqa: F821  # TODO: audit
        ...
        if cur_node_orig.op == 'call_module':
            ...
            cur_name_idx += 1
            cur_node_copy = g.call_module(mod_name, cur_args_copy, cur_kwargs_copy)  # type: ignore[possibly-undefined]  # TODO: audit

        elif cur_node_orig.op == 'call_function':
            cur_node_copy = g.call_function(
                cur_node_orig.target, cur_args_copy, cur_kwargs_copy)  # type: ignore[possibly-undefined]  # TODO: audit
