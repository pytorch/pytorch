...
def _prune_linear_helper(linear: nn.Linear) -> Tensor:
    ...
    with torch.no_grad():
        ...
        linear.weight = nn.Parameter(linear.weight[mask])  # type: ignore[possibly-undefined]  # TODO: audit
...
def _prune_conv2d_helper(conv2d: nn.Conv2d) -> Tensor:
    ...
    with torch.no_grad():
        ...
        conv2d.weight = nn.Parameter(conv2d.weight[mask])  # type: ignore[possibly-undefined]  # TODO: audit
...
def prune_conv2d_padded(conv2d_1: nn.Conv2d) -> None:
    ...
    if getattr(conv2d_1, "_bias", None) is not None:
        if (
            ...
            new_bias[mask] = conv2d_1.bias[mask]  # type: ignore[possibly-undefined]  # TODO: audit
        ...
        if (
            ...
            conv2d_1.bias.data[~mask] = 0  # type: ignore[possibly-undefined]  # TODO: audit
