...
class ConvBn1d(_ConvBnNd, nn.Conv1d):
    ...
    _FLOAT_MODULE: ClassVar[Type[nni.ConvBn1d]] = nni.ConvBn1d
    _FLOAT_CONV_MODULE: ClassVar[Type[nn.ConvBn1d]] = nn.Conv1d
...
class ConvBnReLU1d(ConvBn1d):
    ...
    _FLOAT_MODULE: ClassVar[Type[nn.Module]] = nni.ConvBnReLU1d  # type: ignore[assignment]
...
class ConvBnReLU2d(ConvBn2d):
    ...
    _FLOAT_RELU_MODULE: ClassVar[Optional[Type[nn.Module]]] = nn.ReLU  # type: ignore[assignment]
    # module class after fusing bn into conv
...
class ConvBnReLU3d(ConvBn3d):
    ...
    _FLOAT_RELU_MODULE: ClassVar[Optional[Type[nn.ReLU]]] = nn.ReLU  # type: ignore[assignment]
    # module class after fusing bn into conv
