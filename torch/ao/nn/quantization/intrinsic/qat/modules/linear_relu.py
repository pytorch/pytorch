...
class LinearReLU(nnqat.Linear, nni._FusedModule):
    ...
    Similar to `torch.ao.nn.quantization.intrinsic.LinearReLU`, with FakeQuantize modules initialized to
    default.
    ...
    def to_float(self):
        ...
        relu = torch.nn.ReLU()
        return torch.ao.nn.quantization.intrinsic.LinearReLU(linear, relu)
