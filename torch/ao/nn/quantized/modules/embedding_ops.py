...
class EmbeddingBag(Embedding):
    ...
    def from_float(cls, mod, use_precomputed_fake_quant=False):
        ...
        qembedding_bag = EmbeddingBag(
            mod.num_embeddings, mod.embedding_dim, max_norm=mod.max_norm, norm_type=mod.norm_type,
            scale_grad_by_freq=mod.scale_grad_by_freq, mode=mod.mode, sparse=mod.sparse,
            include_last_offset=mod.include_last_offset, dtype=dtype
        )
