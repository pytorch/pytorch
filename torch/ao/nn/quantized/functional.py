...
def upsample(input, size=None, scale_factor=None, mode='nearest', align_corners=None):
    ...
    .. warning::
        ...
        affects the outputs.
    """
    warnings.warn("nn.quantized.functional.upsample is deprecated. Use nn.quantized.functional.interpolate instead.", stacklevel=1)
...
def upsample_bilinear(input, size=None, scale_factor=None):
    ...
    warnings.warn("nn.quantized.functional.upsample_bilinear is deprecated. Use nn.quantized.functional.interpolate instead.", stacklevel=1)
...
def upsample_nearest(input, size=None, scale_factor=None):
    ...
    """
    # DeprecationWarning is ignored by default
    warnings.warn("nn.quantized.functional.upsample_nearest is deprecated. Use nn.quantized.functional.interpolate instead.", stacklevel=1)
