...
def reference_representation_rewrite(model: GraphModule) -> GraphModule:
    ...
    for rewrite_info in _REWRITE_INFO_LIST:
        ...
        pattern = get_aten_graph_module_for_pattern(pattern, example_inputs)  # type: ignore[arg-type, assignment]
        remove_tensor_overload_for_qdq_ops(pattern)  # type: ignore[arg-type]
        replacement = get_aten_graph_module_for_pattern(replacement, example_inputs)  # type: ignore[arg-type, assignment]
