...
from .mappings import conv_ops, conv_transpose_ops, conv_prepack_fns
        ...
        for idx, seen_op_info in qstate.idx_to_seen_op_infos.items():
            ...
            if seen_op_info.type in conv_ops or seen_op_info.type in conv_transpose_ops:
                ...
                if seen_op_info.type in conv_transpose_ops:
                    ...
                    dilation = seen_op_info.packable_nontensor_idx_to_arg[7]
                else:
                ...
                if seen_op_info.type in conv_transpose_ops:
                    packed_params = conv_prepack_fns[seen_op_info.type](
                        qweight, bias, stride, padding, output_padding, dilation, groups)
                else:
                    packed_params = conv_prepack_fns[seen_op_info.type](
