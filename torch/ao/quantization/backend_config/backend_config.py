...
class DTypeConfig:
    ...
    def get_input_dtype(self) -> Optional[torch.dtype]:
        ...
        """
        if isinstance(self.input_dtype, DTypeWithConstraints):
            return self.input_dtype.dtype
        else:
    ...
    def get_output_dtype(self) -> Optional[torch.dtype]:
        ...
        """
        if isinstance(self.output_dtype, DTypeWithConstraints):
            return self.output_dtype.dtype
        else:
    ...
    def get_weight_dtype(self) -> Optional[torch.dtype]:
        ...
        """
        if isinstance(self.weight_dtype, DTypeWithConstraints):
            return self.weight_dtype.dtype
        else:
