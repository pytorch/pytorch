...
def _get_fixed_qparams_op_configs():
    ...
    for fixed_qparam_op, output_observer in [
            (torch.nn.Hardsigmoid, default_affine_fixed_qparams_range_0to1_observer),
            (torch.nn.functional.hardsigmoid, default_affine_fixed_qparams_range_0to1_observer),
            ("hardsigmoid", default_affine_fixed_qparams_range_0to1_observer),
            ("hardsigmoid_", default_affine_fixed_qparams_range_0to1_observer),
            (torch.nn.Sigmoid, default_affine_fixed_qparams_range_0to1_observer),
            (torch.sigmoid, default_affine_fixed_qparams_range_0to1_observer),
            ("sigmoid", default_affine_fixed_qparams_range_0to1_observer),
            ("sigmoid_", default_affine_fixed_qparams_range_0to1_observer),
            (torch.nn.Tanh, default_symmetric_fixed_qparams_range_neg1to1_observer),
            (torch.tanh, default_symmetric_fixed_qparams_range_neg1to1_observer),
            ("tanh", default_symmetric_fixed_qparams_range_neg1to1_observer),
            ("tanh_", default_symmetric_fixed_qparams_range_neg1to1_observer),
            (torch.nn.Softmax, default_affine_fixed_qparams_range_0to1_observer),
    ]:
