...
from .pt2e.eval_utils import _allow_exported_model_train_eval_for_special_ops as allow_exported_model_train_eval_for_special_ops
...
__all__ = [
    ...
    "allow_exported_model_train_eval_for_special_ops",
    "no_observer_set",
