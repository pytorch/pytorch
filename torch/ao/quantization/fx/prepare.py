...
from ..qconfig import is_replay_qconfig
...
def maybe_insert_input_observer_for_arg_or_kwarg(
    ...
    if not is_standalone_module:
        ...
        is_replay_qconfig_ = is_replay_qconfig(qconfig)
        ...
        needs_obs = (
            ...
            # if qconfig is replay qconfig, we won't insert extra observer for input
            not is_replay_qconfig_
        )
                ...
                if node.op != 'output':
                    ...
                    if is_last_node_of_pattern:
                        ...
                        if maybe_output_obs_node is not None:
                            ...
                            # observer
                            if is_general_tensor_value_op or is_general_tensor_shape_op or is_replay_qconfig_:
