...
def save_state(
    ...
    observed._quantization_config = quantization_config  # type: ignore[assignment]
...
def prepare(
    ...
    save_state(model, qconfig_map, node_name_to_scope,
               prepare_custom_config_dict, equalization_qconfig_map, quantization_config, is_qat, observed_node_names)
