...
class ModelReportVisualization:
    r"""
    The ModelReportVisualization class aims to provide users a way to visualize some of the statistics
    ...
    the ModelReportVisualization class currently supports several methods of visualizing data.
    ...
    * :attr:`generated_reports` The reports generated by the ModelReport class in the structure below
    ...
    Note:
        Currently, the ModelReportVisualization class supports visualization of data generated by the
    ...
    6.) Use output of model_report.generate_report to initialize ModelReportVisualization instance
    ...
    def get_all_unique_module_fqns(self) -> Set[str]:
        ...
        they wish to use some of the filtering capabilities of the ModelReportVisualization class,
        they don't need to manually parse the generated_reports dictionary to get this information.

        Returns all the unique module fqns present in the reports the ModelReportVisualization
    ...
    def generate_table_view(self, feature: str = "", module_fqn_prefix_filter: str = "") -> Tuple[List[List[Any]], str]:
        ...
        Expected Use:
            >>> info, tabluated_str = model_report_visualization.generate_table_view(*filters)
    ...
    def generate_plot_view(self, feature: str, module_fqn_prefix_filter: str = "") -> List[List[Any]]:
        ...
        Expected Use:
            ...
            >>> info = model_report_visualization.generate_plot_view(*filters)
        """
        pass
    ...
    def generate_histogram_view(self, feature: str, module_fqn_prefix_filter: str = "") -> List[List[Any]]:
        ...
        Expected Use:
            ...
            >>> info = model_report_visualization.generate_histogram_view(*filters)
        """
        pass
