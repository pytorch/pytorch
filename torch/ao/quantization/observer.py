...
default_symmetric_fixed_qparams_range_neg1to1_observer = FixedQParamsObserver.with_args(
    scale=2.0 / 256.0, zero_point=128, dtype=torch.quint8, quant_min=0, quant_max=255)
default_affine_fixed_qparams_range_0to1_observer = FixedQParamsObserver.with_args(
...
default_symmetric_fixed_qparams_observer = default_symmetric_fixed_qparams_range_neg1to1_observer
default_affine_fixed_qparams_observer = default_affine_fixed_qparams_range_0to1_observer
