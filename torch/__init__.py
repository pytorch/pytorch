...
class DoubleStorage(LegacyStorage):
    @classproperty
    def dtype(self):
        return torch.double

class FloatStorage(LegacyStorage):
    @classproperty
    def dtype(self):
        return torch.float

class HalfStorage(LegacyStorage):
    @classproperty
    def dtype(self):
        return torch.half

class LongStorage(LegacyStorage):
    @classproperty
    def dtype(self):
        return torch.long

class IntStorage(LegacyStorage):
    @classproperty
    def dtype(self):
        return torch.int

class ShortStorage(LegacyStorage):
    @classproperty
    def dtype(self):
        return torch.short

class CharStorage(LegacyStorage):
    @classproperty
    def dtype(self):
        return torch.int8

class BoolStorage(LegacyStorage):
    @classproperty
    def dtype(self):
        return torch.bool

class BFloat16Storage(LegacyStorage):
    @classproperty
    def dtype(self):
        return torch.bfloat16

class ComplexDoubleStorage(LegacyStorage):
    @classproperty
    def dtype(self):
        return torch.cdouble

class ComplexFloatStorage(LegacyStorage):
    @classproperty
    def dtype(self):
        return torch.cfloat

class QUInt8Storage(LegacyStorage):
    @classproperty
    def dtype(self):
        return torch.quint8

class QInt8Storage(LegacyStorage):
    @classproperty
    def dtype(self):
        return torch.qint8

class QInt32Storage(LegacyStorage):
    @classproperty
    def dtype(self):
        return torch.qint32

class QUInt4x2Storage(LegacyStorage):
    @classproperty
    def dtype(self):
        return torch.quint4x2

class QUInt2x4Storage(LegacyStorage):
    @classproperty
    def dtype(self):
