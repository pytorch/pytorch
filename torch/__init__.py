...
tensors. The package also defines mathematical operations that can be performed over these tensors.
Additionally, it provides many utilities for efficient serializing of
Tensors, arbitrary types, and other useful utilities.

The torch package also has a CUDA counterpart, which enables you to run your tensor computations
