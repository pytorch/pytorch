...
tensors and defines mathematical operations on these tensors.
Additionally, it provides numerous utilities for efficient serialization
of tensors and arbitrary types, as well as other useful tools.
