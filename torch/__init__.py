...
tensors and defines mathematical operations over these tensors.Tensor 
supports basic routines for indexing, slicing, transposing, type-casting,
 resizing, sharing storage and cloning. 
