...
Tensors and arbitrary types, and other useful utilities.It provides a flexible N-dimensional array or Tensor,
supports basic routines for indexing, slicing, transposing, type-casting, resizing, sharing storage and cloning.
