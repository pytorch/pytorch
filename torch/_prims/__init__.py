...
def TensorMeta(
    ...
    *,
    ...
    shape = inferred_shape if shape is None else tuple(shape)  # type: ignore[possibly-undefined]  # TODO: audit
    strides = inferred_strides if strides is None else tuple(strides)  # type: ignore[possibly-undefined]  # TODO: audit
    dtype = inferred_dtype if dtype is None else dtype  # type: ignore[possibly-undefined]  # TODO: audit
    device = inferred_device if device is None else device  # type: ignore[possibly-undefined]  # TODO: audit
