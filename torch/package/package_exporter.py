...
class PackageExporter:
    ...
    def add_dependency(self, module_name: str, dependencies=True):
        ...
        is_selective_intern = self._check_if_selectively_interned(module_name)

        if self._can_implicitly_extern(module_name) and not is_selective_intern:
            self.dependency_graph.add_node(
    ...
    def _selective_intern(
        ...
        self.patterns[GlobGroup(include=interned_packages)] = _PatternInfo(
    ...
    def _execute_dependency_graph(self):
        ...
        for module_name, attrs in self.dependency_graph.nodes.items():
            ...
            if action == _ModuleProviderAction.EXTERN:
            ...
            elif action == _ModuleProviderAction.INTERN or _ModuleProviderAction.SELECTIVE_EXTERN:
                ...
                source = attrs["source"]
                if is_package and source and self._check_if_selectively_externed(module_name):
