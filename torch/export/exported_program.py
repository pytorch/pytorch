    ...
    try:
        for op_overload, decomp_callable in cia_ops_to_callable.items():
            ...
            if torch._C.DispatchKey.CompositeImplicitAutograd in op_overload.py_kernels:
                del op_overload.py_kernels[
                    torch._C.DispatchKey.CompositeImplicitAutograd
                ]

            op_overload.py_kernels[torch._C.DispatchKey.CompositeImplicitAutograd] = (
                decomp_callable
            )
            ...
            def _force_dispatch_to_orig_cia_callable(
                fake_tensor_mode, op, *args, **kwargs
            ):
