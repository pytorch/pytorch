...
def get_main_cpp_file(
    ...
    with ib.indent():
        ...
        with ib.indent():
            ib.writeline("torch::Device device(device_str);")
            ...
            if example_inputs_map is not None:
                ...
                for i, model_name in enumerate(model_names):
                    ...
                    with ib.indent():
                        ...
                        ib.writeline(
                            f"input_tensors{i + 1}.push_back(ivalue.toTensor());"
                        )
                    ib.writeline("}")
                    ib.newline()
...
def get_make_file(package_name: str, model_names: list[str], cuda: bool) -> str:
    ib = IndentedBuffer()
