...
__all__ = ["PT2ArchiveWriter", "PT2ArchiveReader", "is_pt2_archive_package"]


def is_pt2_archive_package(serialized_model: Union[bytes, str]) -> bool:
    """
    ...
    try:
        ...
        logger.info("Model is not a sigmoid package: %s", str(ex))
    return False
