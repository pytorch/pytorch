...
from typing import Any, TypeVar, Type, Union, cast, Dict as _Dict, Optional as _Optional
import copy
import collections
...
class _StorageBase:
    ...
    def copy_(self, source: T, non_blocking: _Optional[bool] = None) -> T: ...  # noqa: E704
    ...
    def type(self, dtype: _Optional[str] = None, non_blocking: bool = False) -> T: ...  # noqa: E704
