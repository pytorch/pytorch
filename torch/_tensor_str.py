...
def _str_intern(inp, *, tensor_contents=None):
    ...
    if grad_fn_name is None and grad_fn is not None:  # type: ignore[possibly-undefined]  # TODO: audit
    ...
    string_repr = _add_suffixes(
        prefix + tensor_str, suffixes, indent, force_newline=self.is_sparse  # type: ignore[possibly-undefined]  # TODO: audit
    )
