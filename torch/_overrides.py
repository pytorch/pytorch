...
def get_testing_overrides():
    ...
    return {
        ...
        torch.gru: (lambda input, hx, params=[], has_biases=True, num_layers=3, gropout=0.5, train=True,
                    bidirectional=True, batch_first=False, type_2=True: -1),
        ...
        torch.lstm: (lambda data, batch_sizes, hx, params=[], has_biases=True, num_layers=3, dropout=0.5, train=True,
                     bidirectional=True, type_2=True: -1),
        ...
        torch.rnn_relu: (lambda input, hx, params=[], has_biases=True, num_layers=3, dropout=0.5,
                         train=True, bidirectional=True, batch_first=False, type_2=True: -1),
        torch.rnn_relu_cell: lambda input, hx, w_ih, w_hh, b_ih=None, b_hh=None: -1,
        torch.rnn_tanh: (lambda input, hx, params=[], has_biases=True, num_layers=3, dropout=0.5,
                         train=True, bidirectional=True, batch_first=False, type_2=True: -1),
