...
def get_testing_overrides():
    ...
    return {
        ...
        torch.gru: lambda input, hx, params, has_biases, num_layers, gropout, train, bidirectional, cat_layer_fwd_bwd_states=True, batch_first=False: -1,
        ...
        torch.lstm: lambda data, batch_sizes, hx, params, has_biases, num_layers, dropout, train, bidirectional, cat_layer_fwd_bwd_states=True: -1,
        ...
        torch.miopen_rnn: (lambda input, weight, weight_stride0, hx, cx, mode, hidden_size, num_layers, batch_first,
                           dropout, train, bidirectional, cat_layer_fwd_bwd_states, batch_sizes, dropout_state: -1),
        ...
        torch.rnn_relu: lambda input, hx, params, has_biases, num_layers, dropout, train, bidirectional, cat_layer_fwd_bwd_states=True, batch_first=False: -1,
        torch.rnn_relu_cell: lambda input, hx, w_ih, w_hh, b_ih=None, b_hh=None: -1,
        torch.rnn_tanh: lambda input, hx, params, has_biases, num_layers, dropout, train, bidirectional, cat_layer_fwd_bwd_states=True, batch_first=False: -1,
