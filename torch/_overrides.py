...
def get_testing_overrides():
    ...
    return {
        ...
        torch.grid_sampler: lambda input, grid, interpolation_mode, padding_mode, align_corners, pixel_coords: -1,
        torch.grid_sampler_2d: lambda input, grid, interpolation_mode, padding_mode, align_corners, pixel_coords: -1,
        torch.grid_sampler_3d: lambda input, grid, interpolation_mode, padding_mode, align_corners, pixel_coords: -1,
        ...
        torch.nn.functional.grid_sample: (lambda input, grid, mode='bilinear', padding_mode='zeros',
                                          align_corners=None, pixel_coords=False: -1),
