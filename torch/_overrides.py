...
def get_testing_overrides():
    ...
    return {
        ...
        torch.fbgemm_pack_quantized_matrix: lambda input: -1,
        ...
        torch.median: lambda input, dim: -1,
        ...
        torch.normal: lambda mean, std=1.0, out=None: -1,
