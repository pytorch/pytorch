...
def get_testing_overrides():
    ...
    return {
        ...
        torch.norm: lambda input, p=None, dim=None, keepdim=False, out=None, dtype=None: -1,
        torch.norm_except_dim: lambda v, pow=2, dim=0: -1,
        torch.normal: lambda mean, std, out=None: -1,
        torch.nuclear_norm: lambda input, p=None, dim=None, keepdim=False, out=None, dtype=None: -1,
