...
class OutputMetadata:
    ...
    indexes_with_int: set[int] = field(default_factory=set)
    ...
    with suspend_functionalization(), disable_functional_mode():
        with disable_proxy_modes_tracing():
            ...
            for idx, fw_out in enumerate(fw_outs):
                ...
                elif isinstance(fw_out, (int, torch.SymInt)):
                    output_metadata.indexes_with_int.add(idx)
        ...
        *operands,
        ...
        for idx, o in enumerate(out):
            if o is None:
                ...
                assert idx in output_metadata.indexes_with_int
        ...
        for idx, o in enumerate(grad_outs):
            if o is None:
                assert idx in output_metadata.indexes_with_none.union(
                    output_metadata.indexes_with_int
                )
