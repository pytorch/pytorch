    ...
    def _call_impl(self, *args, **kwargs):
        ...
        try:
            ...
            for hook_id, hook in _global_forward_hooks.items():
                if hook_id in _global_forward_hooks_always_called and hook_id not in called_always_called_hooks:  # type: ignore[possibly-undefined]  # TODO: audit
                    try:
                        hook_result = hook(self, args, result)  # type: ignore[possibly-undefined]  # TODO: audit
                        if hook_result is not None:
                            result = hook_result
            ...
            for hook_id, hook in self._forward_hooks.items():
                if hook_id in self._forward_hooks_always_called and hook_id not in called_always_called_hooks:  # type: ignore[possibly-undefined]  # TODO: audit
                    try:
                        if hook_id in self._forward_hooks_with_kwargs:
                            hook_result = hook(self, args, kwargs, result)  # type: ignore[possibly-undefined]  # TODO: audit
                        else:
                            hook_result = hook(self, args, result)  # type: ignore[possibly-undefined]  # TODO: audit
                        if hook_result is not None:
                            result = hook_result
