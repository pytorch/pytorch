...
class MultiheadAttention(Module):
    ...
    Outputs:
        ...
        why_not_fast_path = F._can_use_fastpath(query,
                                                key,
                                                value,
                                                self.embed_dim,
                                                self.num_heads,
        ...
        if not why_not_fast_path:
            if not self.batch_first:
                ...
                merged_mask, mask_type = F._merge_masks(attn_mask, key_padding_mask, query, self.num_heads)
        ...
        if not self._qkv_same_embed_dim:
            attn_output, attn_output_weights = F._multi_head_attention_forward_impl(
