...
class LSTM(RNNBase):
    ...
    Attributes:
        ...
        weight_hr_l[k] : the learnable projection weights of the :math:`\text{k}^{th}` layer
            ...
            specified.
        weight_ih_l[k]_reverse: Analogous to `weight_ih_l[k]` for the backward direction.
            Only present when `bidirectional=True`.t
        weight_hh_l[k]_reverse:  Analogous to `weight_hh_l[k]` for the backward direction.
            Only present when `bidirectional=True`.
        bias_ih_l[k]_reverse:  Analogous to `bias_ih_l[k]` for the backward direction.
            Only present when `bidirectional=True`.
        bias_hh_l[k]_reverse:  Analogous to `bias_hh_l[k]` for the backward direction.
            Only present when `bidirectional=True`.
        weight_hr_l[k]_reverse:  Analogous to `weight_hr_l[k]` for the backward direction.
            Only present when `bidirectional=True`.
