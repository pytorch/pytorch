...
class Upsample(Module):
    ...
    Shape:
        ...
        - Output: :math:`(N, C, W_{out})`, :math:`(N, C, H_{out}, W_{out})`
          ...
          .. math::
              D_{out} = \lfloor D_{in} * \text{scale_factor} \rfloor \text{ or size}[-3]

              H_{out} = \lfloor H_{in} * \text{scale_factor} \rfloor \text{ or size}[-2]

              W_{out} = \lfloor W_{in} * \text{scale_factor} \rfloor \text{ or size}[-1]
...
class UpsamplingNearest2d(Upsample):
    ...
    Shape:
        ...
        - Output: :math:`(N, C, H_{out}, W_{out})` where
          ...
          .. math::
              H_{out} = \lfloor H_{in} * \text{scale_factor} \rfloor

              W_{out} = \lfloor W_{in} * \text{scale_factor} \rfloor
