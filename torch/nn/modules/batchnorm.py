...
class BatchNorm1d(_BatchNorm):
    ...
    standard-deviation is calculated via the biased estimator, equivalent to `torch.var(input, correction=0)`.
...
class BatchNorm2d(_BatchNorm):
    ...
    via the biased estimator, equivalent to `torch.var(input, correction=0)`.
