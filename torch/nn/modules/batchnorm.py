...
class _NormBase(Module):
    ...
    def extra_repr(self):
        return '{num_features}, eps={eps}, momentum={momentum}, affine={affine}, ' \
               'track_running_stats={track_running_stats}, use_scale={use_scale}'.format(
                   **self.__dict__)
...
class _BatchNorm(_NormBase):
    ...
    def __init__(self, num_features, eps=1e-5, momentum=0.1, affine=True,
                 track_running_stats=True, use_scale=True):
...
class SyncBatchNorm(_BatchNorm):
    ...
    def __init__(
        ...
        super(SyncBatchNorm, self).__init__(num_features,
                                            eps, momentum, affine, track_running_stats, use_scale)
