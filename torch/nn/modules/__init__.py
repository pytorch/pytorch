...
from .dropout import Dropout, Dropout2d, Dropout3d, AlphaDropout, Zoneout
...
__all__ = [
    ...
    'InstanceNorm2d', 'InstanceNorm3d', 'Dropout', 'Dropout2d', 'Dropout3d', 'AlphaDropout', 'Zoneout',
    'ReflectionPad1d', 'ReflectionPad2d', 'ReplicationPad2d', 'ReplicationPad1d', 'ReplicationPad3d', 'CrossMapLRN2d',
