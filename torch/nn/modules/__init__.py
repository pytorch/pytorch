...
from .loss import L1Loss, Q1Loss, NLLLoss, KLDivLoss, MSELoss, BCELoss, BCEWithLogitsLoss, NLLLoss2d, \
...
__all__ = [
    ...
    'Tanhshrink', 'RReLU', 'L1Loss', 'Q1Loss', 'NLLLoss', 'KLDivLoss', 'MSELoss', 'BCELoss', 'BCEWithLogitsLoss',
