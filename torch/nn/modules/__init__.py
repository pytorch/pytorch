...
from .batchnorm import BatchNorm1d, BatchNorm2d, BatchNorm3d, BatchNorm, SyncBatchNorm, \
    LazyBatchNorm1d, LazyBatchNorm2d, LazyBatchNorm3d, LazyBatchNorm
...
__all__ = [
    ...
    'BatchNorm3d', 'BatchNorm', 'InstanceNorm1d',
