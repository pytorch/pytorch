...
from .dropout import Dropout, Dropout2d, Dropout3d, AlphaDropout, AlphaDropout2d, AlphaDropout3d
...
__all__ = [
    ...
    'Dropout', 'Dropout2d', 'Dropout3d', 'AlphaDropout', 'AlphaDropout2d', 'AlphaDropout3d',
