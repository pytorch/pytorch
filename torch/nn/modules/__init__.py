...
from .loss import L1Loss, NLLLoss, KLDivLoss, MSELoss, BCELoss, BCEWithLogitsLoss, NLLLoss2d, \
    ...
    ObjectDetectionCoordinatesAndSizeLoss
...
__all__ = [
    ...
    'HuberLoss', 'SoftMarginLoss', 'CrossEntropyLoss', 'ObjectDetectionCoordinatesAndSizeLoss','Container', 'Sequential', 'ModuleList', 'ModuleDict',
