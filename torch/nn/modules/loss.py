...
class CrossEntropyLoss(_WeightedLoss):
    ...
    The `input` is expected to contain scores for each class. The input should not be
    normalised or converted to probabilities as it is done within the loss function.
