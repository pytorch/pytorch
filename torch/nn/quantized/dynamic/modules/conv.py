...
class Conv1d(nnq._ConvNd):
    ...
    def __init__(self,
        ...
        # Subclasses of nnq._ConvNd needs to call _init rather than __init__. See
    ...
    def from_float(cls, mod):
        ...
        """
        return nnq._ConvNd.from_float(cls, mod)


class Conv2d(nnq._ConvNd):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1,
        ...
        # Subclasses of nnq._ConvNd need to call _init rather than __init__. See
        # discussion on PR #49702
...
MOD = TypeVar('MOD', bound=nn.modules.conv.nnq._ConvNd)

class _ConvTransposeNd(nnq._ConvNd):
