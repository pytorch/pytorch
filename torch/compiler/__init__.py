...
def _is_non_strict_tracing() -> bool:
    ...
    This is set by the non-strict tracer to signal that checkpoint regions
    should skip the eager checkpoint machinery and instead just tag nodes
    with SAC metadata for later partitioning.
    """
