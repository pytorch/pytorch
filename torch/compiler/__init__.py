...
def export_python(
    *,
    ...
    With ``unsafe_reduce_overhead=True`` and an inductor backend, the artifact accepts
    an ``out=`` sequence of destination tensors. Donating the outputs also lets the
    ...
    """
    from torch._export_python import export_python as _export_python
