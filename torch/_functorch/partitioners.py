...
def _extract_fwd_bwd_modules(joint_module: fx.GraphModule, saved_values, saved_sym_nodes, *, num_fwd_outputs):
    ...
    fwd_module = fx._lazy_graph_module.get_graph_module_cls()(joint_module, fwd_graph)
    bwd_module = fx._lazy_graph_module.get_graph_module_cls()(joint_module, bwd_graph)
