...
def materialize_cpu_floating_aminmax_eq_input(
    ...
    materialized_inputs: dict[fx.Node, fx.Node] = {}
    for reduction in list(joint_graph.nodes):
        ...
        clone = materialized_inputs.get(reduction_input)
        if clone is None:
            clone = clone_reduction_input(reduction, reduction_input)
            materialized_inputs[reduction_input] = clone
