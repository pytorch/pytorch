...
class AOTAutogradCacheEntry:
    ...
    compiled_bw: CompiledBackward | None
...
class AOTAutogradCache:
    ...
    **No new guards are generated into the shape env after inductor finishes compiling**, so the guards
    ...
    def load(
        ...
        with sanitize_gm_for_cache(gm):
            ...
            try:
                ...
                entry: AOTAutogradCacheEntry | None = AOTAutogradCache._lookup(
    ...
    @staticmethod
    def _lookup(key: str, local: bool, remote: bool) -> AOTAutogradCacheEntry | None:
