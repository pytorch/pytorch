...
from .schemas import AOTConfig, SubclassMeta, TraceFn, ViewAndMutationMeta
from .utils import (
...
def _create_graph(
    f, args, args_descs, *, aot_config: AOTConfig
...
def aot_dispatch_autograd_graph(
    ...
    *,
    ...
    updated_joint_inputs_descs = subclass_tracing_info.plain_tensor_sources
