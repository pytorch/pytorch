...
class ViewAndMutationMeta:
    ...
    # compiled_autograd_output_deps[i] contains the nearest user output indices
    # that user output i depends on inside the compiled forward graph. Autograd
    # only sees compiled graph outputs as siblings of the same CompiledFunction,
    # so this lets torch.autograd.grad reject unsupported sibling-output
    # gradients with a targeted error instead of silently returning None/partial
    # grads. Runtime validation follows these edges transitively.
