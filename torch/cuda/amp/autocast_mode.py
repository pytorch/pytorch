...
class autocast(torch.autocast_mode.autocast):
    ...
    """
    def __init__(self, enabled=True, fast_dtype=torch.float16, cache_enabled=True):
        super().__init__("cuda", enabled=enabled, fast_dtype=fast_dtype, cache_enabled=cache_enabled)
