...
def _materialize_meta_module(
    ...
    try:
        ...
        warnings.warn(
            ...
            f"type {type(module)} implements a `reset_parameters()` method."  # type: ignore[possibly-undefined]  # TODO: audit
        )
        raise e
...
def _move_states_to_device(
    ...
    elif current_device == cpu_device:  # type: ignore[possibly-undefined]  # TODO: audit
        _warn_cpu_init()
