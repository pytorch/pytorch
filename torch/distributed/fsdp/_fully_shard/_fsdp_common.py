...
def _get_dim0_padded_size(tensor_size: torch.Size, dim0_factor: int) -> torch.Size:
    ...
    return torch.Size([padded_dim0]) + tensor_size[1:]  # type: ignore[return-value]
...
def _get_dim_chunked_size(
    ...
    return unchunked_size[:dim] + torch.Size([0]) + unchunked_size[dim + 1 :]  # type: ignore[return-value]
