...
class FlatParamHandle:
    ...
    def _use_sharded_flat_param(self) -> None:
        ...
        if self._use_orig_params:
            if skip_use_sharded_views:  # type: ignore[possibly-undefined]  # TODO: audit
                self._unsharded_flat_param_for_skipped_views = unsharded_flat_param  # type: ignore[possibly-undefined]  # TODO: audit
            else:
                self._use_sharded_views()
            ...
            if (
                in_forward  # type: ignore[possibly-undefined]  # TODO: audit
