...
if True:  # just to temporarily avoid reindentation
    ...
    class _MeshEnv(threading.local):
        ...
        def create_sub_mesh(
            ...
            pg_ranks_by_dim = DeviceMesh._from_layout_to_mesh_tensor(
                layout,
                root_mesh.mesh,
                cur_rank,
            )
    ...
    class DeviceMesh:
        ...
        @staticmethod
        def _from_layout_to_mesh_tensor(
            layout: _MeshLayout,
            ...
            # will be used as an index with expected mesh shape to get the actual ranks from the original mesh tensor.
            if torch.equal(
