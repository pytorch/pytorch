...
class ScheduleDualPipeV(_PipelineScheduleRuntime):
    ...
    def _calculate_single_rank_operations(self, rank) -> list[Optional[_Action]]:
        ...
        def add_action(
            ...
            computation_type: _ComputationType,
            counters: dict,
            forward_stage: Optional[int] = None,
            backward_stage: Optional[int] = None,
        ):
            ...
            if computation_type == _ComputationType.OVERLAP_F_B:
                ...
                sub_actions = (
                    ...
                    _Action(
                        backward_stage, _ComputationType.FULL_BACKWARD, backward_mb
                    ),
                )
        ...
        for i in range(step_4):
            if i == 0 and rank == num_ranks - 1:
                ...
                add_action(actions, stage0_index, _ComputationType.FORWARD, counters)
                add_action(
                    actions, stage1_index, _ComputationType.FULL_BACKWARD, counters
                )
            else:
                add_action(
                    actions,
