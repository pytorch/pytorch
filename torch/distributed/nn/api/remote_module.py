...
class _RemoteModule(nn.Module):
    ...
    def init_from_module_rref(
        ...
        """
        Besides the above constructor, a RemoteModule instance can be initialized given a module RRef,
        after the user calls ``__new__`` to create an empty instance.
        ...
        Example::
            ...
            >>>     remote_module.init_from_module_rref(remote_device, module_rref)
