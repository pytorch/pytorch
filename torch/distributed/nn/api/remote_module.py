...
class _RemoteModule(nn.Module):
    ...
    def register_forward_pre_hook(self, hook: Callable[..., None], prepend: bool = False) -> RemovableHandle:  # type: ignore[return]
        _raise_not_supported(self.register_forward_pre_hook.__name__)

    def register_forward_hook(self, hook: Callable[..., None], prepend: bool = False) -> RemovableHandle:  # type: ignore[return]
