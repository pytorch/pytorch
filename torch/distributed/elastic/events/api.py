...
class Event:
    ...
    def deserialize(data: Union[str, "Event"]) -> "Event":
        ...
        data_dict["source"] = EventSource[data_dict["source"]]  # type: ignore[possibly-undefined]  # TODO: audit
...
class RdzvEvent:
    ...
    def deserialize(data: Union[str, "RdzvEvent"]) -> "RdzvEvent":
        ...
        if isinstance(data, str):
            data_dict = json.loads(data)
        data_dict["node_state"] = NodeState[data_dict["node_state"]]  # type: ignore[possibly-undefined]  # TODO: audit
