    ...
    def wrap(f):
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                put_metric(f"{key}.duration.ms", get_elapsed_time_ms(start), group)  # type: ignore[possibly-undefined]  # TODO: audit
            return result
        ...
        def wrapper(*args, **kwargs):
            try:
                ...
                publish_metric(
                    ...
                    get_elapsed_time_ms(start_time),  # type: ignore[possibly-undefined]  # TODO: audit
                )
            return result
