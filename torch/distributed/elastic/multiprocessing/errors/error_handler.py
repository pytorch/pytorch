...
class ErrorHandler:
    ...
    def initialize(self) -> None:
        ...
        try:
            ...
            warnings.warn(f"Unable to enable fault handler. {type(e).__name__}: {e}", stacklevel=TO_BE_DETERMINED)
    ...
    def _write_error_file(self, file_path: str, error_msg: str) -> None:
        ...
        try:
            ...
            warnings.warn(f"Unable to write error to file. {type(e).__name__}: {e}", stacklevel=TO_BE_DETERMINED)
