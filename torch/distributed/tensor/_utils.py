...
from torch.distributed.tensor._dtensor_spec import DTensorSpec, TensorDimTuple
...
def _explicit_order_placements(
    ...
    shard_order: Optional[TensorDimTuple],
...
def compute_local_shape_and_global_offset(
    ...
    Args:
        ...
        shard_order (TensorDimTuple): The order in which sharding is applied to the tensor dimensions.
