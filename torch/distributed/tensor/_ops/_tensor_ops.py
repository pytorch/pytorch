...
def split_strategy(op_schema: OpSchema) -> OpStrategy:
    ...
    for strategy in input_strategy.strategies:
        ...
        input_spec = DTensorSpec(spec.mesh, placements)  # TODO: fix tensor_meta
        output_specs = tuple(
            DTensorSpec(spec.mesh, placements)
            for _ in range(len(output_size_list))  # TODO: fix tensor_meta
        )
