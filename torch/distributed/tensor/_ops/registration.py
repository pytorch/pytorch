...
from torch.distributed.tensor.placement_types import Placement, PlacementPlaceholder
...
def register_single_dim_strategy(
    ...
    [Callable[[ArgsType, KwargsType], list[list[Placement | PlacementPlaceholder]]]],
    Callable[[ArgsType, KwargsType], list[list[Placement | PlacementPlaceholder]]],
]:
    """
