...
import torch
import torch.distributed.tensor.ops
...
from torch.distributed.tensor.api import distribute_module, distribute_tensor, DTensor
from torch.distributed.tensor.ops.utils import normalize_to_torch_size
