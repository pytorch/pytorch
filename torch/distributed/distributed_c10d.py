...
def init_process_group(
    ...
    Args:
        ...
        pg_options (optional): process group options
...
def split_group(
    ...
    Args:
        ...
        pg_options (optional): Additional options need to be passed in during
...
def shrink_group(
    ...
    Args:
        ...
        pg_options (optional): Backend-specific options to apply
