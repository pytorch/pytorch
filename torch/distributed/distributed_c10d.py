...
def _coalescing_manager(
    ...
    if async_ops:
        cm.append(work)  # type: ignore[possibly-undefined]  # TODO: audit
    else:
        work.wait()  # type: ignore[possibly-undefined]  # TODO: audit
...
def gather_object(obj, object_gather_list=None, dst=0, group=None):
    ...
    gather(
        input_tensor,
        gather_list=output_tensors if my_rank == dst else None,  # type: ignore[possibly-undefined]  # TODO: audit
        dst=dst,
        group=group,
    )
    if my_rank != dst:
...
def broadcast_object_list(object_list, src=0, group=None, device=None):
    ...
    if my_rank == src:
        if len(tensor_list) == 1:  # type: ignore[possibly-undefined]  # TODO: audit
...
def scatter_object_list(
    ...
    if my_rank == src:
        max_tensor_size = max(tensor_sizes)  # type: ignore[possibly-undefined]  # TODO: audit
        for tensor in tensor_list:  # type: ignore[possibly-undefined]  # TODO: audit
    ...
    scatter(
        output_tensor,
        scatter_list=None if my_rank != src else tensor_list,  # type: ignore[possibly-undefined]  # TODO: audit
        src=src,
        group=group,
    )
    ...
    scatter(
        obj_tensor_size,
        scatter_list=None if my_rank != src else tensor_sizes,  # type: ignore[possibly-undefined]  # TODO: audit
        src=src,
        group=group,
    )
