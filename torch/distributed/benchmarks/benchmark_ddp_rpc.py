...
class HybridModel(torch.nn.Module):
    ...
    def forward(self, indices, offsets):
        ...
        emb_lookups_reshaped = emb_lookups_cat.reshape(  # type: ignore[possibly-undefined]  # TODO: audit
...
def _run_trainer(emb_rref_list, rank):
    ...
    return rank, measurements, batch_size  # type: ignore[possibly-undefined]  # TODO: audit
