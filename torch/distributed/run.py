...
def get_args_parser() -> ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=str,
        default="null",
        help="handler for logging events. Can be a special value: 'null' to (discard events), 'console' to (stream  'stdout', or 'stderr'). custom loggers can be registered via the 'torch.distributed.elastic.events.handlers",
    )
    parser.add_argument(
        "--role",
        action=env,
