    ...
    def dispatch(
        ...
        if output_sharding.output_spec is None:
            if op_call == aten.equal.default:
                ...
                dist.all_gather_object(obj_list, local_results)  # type: ignore[possibly-undefined]  # TODO: audit
        ...
        if _is_inplace_op(op_call):
            ...
            return self.wrap(local_results, output_sharding.output_spec)  # type: ignore[possibly-undefined]  # TODO: audit
