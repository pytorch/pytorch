...
class Shard(Placement):
    ...
    def _reduce_shard_tensor(
        ...
        if is_padded:
            output = self._unpad_tensor(output, pad_sizes[my_coordinate[mesh_dim]])  # type: ignore[possibly-undefined]  # TODO: audit
        return output
    ...
    def _to_replicate_tensor(
        ...
        if is_padded:
            unpad_size = full_chunk_size * num_chunks - logical_dim_size  # type: ignore[possibly-undefined]  # TODO: audit
