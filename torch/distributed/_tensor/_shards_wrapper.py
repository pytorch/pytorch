...
class LocalShardsWrapper(torch.Tensor):  # pyre-ignore[13]: pyre is bad at __new__
    ...
    def __torch_dispatch__(cls, func, types, args=(), kwargs=None):
        ...
        if func in dispatcher:
            return dispatcher[func](args, kwargs)  # pyre-ignore [29] - `Variable[_VT]` is not a function.
        else:
    ...
    def __create_write_items__(self, fqn: str, object: Any) -> List[WriteItem]:  # pyre-ignore[2]
        """
    ...
    def __create_chunk_list__(self, tensor: torch.Tensor) -> List[ChunkStorageMetadata]:
        """
