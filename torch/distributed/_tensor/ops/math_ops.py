...
for sum_op in sum_ops:
    DTensor._propagator.register_sharding_prop_rule(sum_op, sum_rule)
...
for mean_op in mean_ops:
    DTensor._propagator.register_sharding_prop_rule(mean_op, mean_rule)
...
for var_op in var_ops:
    DTensor._propagator.register_sharding_prop_rule(var_op, var_rule)
