...
def distribute_tensor_scale(mesh: DeviceMesh, op_schema: OpSchema)-> OpStrategy:    
    ...
    for op_strategy in input_tuple_strategy.childs:
        ...
        output_strategy.strategies[0].input_specs = list(output_strategy.strategies[0].input_specs)
        output_strategy.strategies[0].redistribute_cost = list(output_strategy.strategies[0].redistribute_cost)
        ...
        output_strategy.strategies[0].input_specs = tuple(output_strategy.strategies[0].input_specs)
        output_strategy.strategies[0].redistribute_cost = tuple(output_strategy.strategies[0].redistribute_cost)
