...
def empty(
    ...
    """
    params = TensorInitCommonParams(create_op='empty', dtype=dtype, layout=layout,
        requires_grad=requires_grad, pin_memory=pin_memory, memory_format=memory_format)
    return ShardedTensor(
        sharding_spec,
        *size,
        tensor_init_common_params=params,
        # dtype=dtype,
        # layout=layout,
...
def ones(
    ...
    Returns:
        A :class:`ShardedTensor` object on each rank
    """
    params = TensorInitCommonParams(create_op='ones', dtype=dtype, layout=layout,
        requires_grad=requires_grad, pin_memory=pin_memory, memory_format=memory_format)
    return ShardedTensor(
        sharding_spec,
        *size,
