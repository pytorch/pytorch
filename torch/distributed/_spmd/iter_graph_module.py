...
class IterGraph(fx.Graph):
    ...
    def node_replace_all_uses_with(
        ...
        *,
        ...
        return ret  # type: ignore[possibly-undefined]  # TODO: audit
    ...
    def functionalize_optim(self) -> None:
        ...
        for node in reversed(self.nodes):
            if node.name.startswith("output"):
                ...
                step_node = node
                self.node_add_user(optim_node, output_node)  # type: ignore[possibly-undefined]  # TODO: audit
                self.node_add_user(step_node, optim_node)  # type: ignore[possibly-undefined]  # TODO: audit
        ...
        for graph in self._all_graphs:
            for node in reversed(graph.nodes):
                if node.name.startswith("output"):
                    ...
                    step_node = node
                    optim_node.users.pop(output_node, None)  # type: ignore[possibly-undefined]  # TODO: audit
                    step_node.users.pop(optim_node, None)  # type: ignore[possibly-undefined]  # TODO: audit
