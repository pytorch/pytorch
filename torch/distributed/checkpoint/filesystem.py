    ...
    * File creation is atomic
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.no_rank_coordination: bool = False
    ...
    def set_up_storage_writer(self, is_coordinator: bool, rank: Optional[int] = None, no_rank_coordination: bool = False) -> None:
        self.rank = rank
        self.no_rank_coordination = no_rank_coordination

    def _metadata_exists(self) -> bool:
        if self.no_rank_coordination:
            ...
            # Or a global checkpoint metadata file
    ...
    def prepare_local_plan(self, plan: SavePlan) -> SavePlan:
        ...
        if self.rank and self.no_rank_coordination:
            plan = dataclasses.replace(plan, storage_data=_StoragePrefix(f"__{self.rank}_"))

        return plan

    def prepare_global_plan(self, plans: list[SavePlan]) -> list[SavePlan]:
        new_plans = [
            dataclasses.replace(plan, storage_data=_StoragePrefix(f"__{i}_")) if plan.storage_data is None else plan
    ...
    def finish(self, metadata: Metadata, results: list[list[WriteResult]]) -> None:
        ...
        tmp_filename = f"__{self.rank}{_metadata_fn}.tmp" if self.no_rank_coordination else f"{_metadata_fn}.tmp"
...
class FileSystemReader(StorageReader):
    def __init__(
        ...
        self.rank = None
        self.no_rank_coordination = False
