...
from torch.distributed.checkpoint._hf_planner import _FqnToFileMapping, _HuggingFaceLoadPlanner
        ...
        for file_name, reqs in per_file.items():
            ...
            with self.fs.create_stream(new_path, "rb") as stream:
                ...
                for req in reqs:
                    ...
                    if isinstance(planner, _HuggingFaceLoadPlanner) and planner.allow_tensor_resize:
