...
__all__ = ["ProcessGroupAwareSavePlanner", "ProcessGroupAwareLoadPlanner"]
...
def create_state_dict_copy(state_dict: Dict[str, Any]) -> Dict[str, Any]:
    ...
    for k, v in state_dict.items():
        ...
        if (
            ...
            and v._process_group != dist.group.WORLD
        ):
            pg_global_ranks = dist.get_process_group_ranks(v._process_group)
