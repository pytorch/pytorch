    ...
    *,
    ...
    Args:
        ...
        no_dist (bool):
            ...
            (Default: ``False``)
        no_rank_coordination (bool): If ``True``, this function will assume the intent is to load
    ...
    *,
    ...
    Args:
        ...
        process_group (Optional[ProcessGroup]):
            ProcessGroup to be used for cross-rank synchronization.
            (Default: ``None``)
        no_rank_coordination: Save the checkpoint without rank coordination. (Default: ``False``)
...
def _save_state_dict(
    ...
    def local_step():
        ...
        storage_writer.set_up_storage_writer(distW.is_coordinator, rank=distW.rank, no_rank_coordination=no_rank_coordination)
