...
def fully_shard(
    ...
    auto_wrap_policy: Optional[AutoWrapPolicy] = None,
    ...
    if auto_wrap_policy is not None and not isinstance(
        auto_wrap_policy, AutoWrapPolicy
    ):
        raise ValueError(f"Expects an `AutoWrapPolicy` but got {auto_wrap_policy}")
