...
# Import the existing FSDP library instead of creating a duplicate
from torch.distributed.fsdp._fully_shard._fsdp_param import lib
...
# The copy_ Functionalize implementation is already provided by the FSDP library we imported
# torch.fx.node.has_side_effect is also already set by the FSDP library
