...
class Node:
    def __init__(self, graph: 'Graph', name: str, op: str, target: Target,
        ...
        assert op in ['placeholder', 'call_method', 'call_module', 'call_function', 'get_param']
        self.op = op  # the kind of operation = placeholder|call_method|call_module|call_function|get_param
