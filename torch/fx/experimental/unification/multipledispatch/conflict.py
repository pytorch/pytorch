...
def consistent(a, b):
    ...
    if len(a) == len(b):
        ...
        return (isvariadic(cur_a) and p2 == len(b) or  # type: ignore[possibly-undefined]  # TODO: audit
                isvariadic(cur_b) and p1 == len(a))  # type: ignore[possibly-undefined]  # TODO: audit
