...
def has_symbolic_sizes_strides(elem):
    return any([isinstance(i, torch._C.SymIntNodeImpl) for i in elem.shape])
...
for method, _func in magic_methods.items():
    ...
    # this should be wrapped transparently into torch._C.SymIntNodeImpl
...
class ShapeEnv(object):
    ...
    def create_symint(self, name, val, shape_env=None):
        ...
        cpp_sym_int = torch._C.SymIntNodeImpl.new_symint(py_sym_int)  # type: ignore[attr-defined]
