...
def snapshot_fake(val: Tensor) -> Tensor | None:
...
@contextmanager
def _enable_thunkify(tracer: _ProxyTracer, *, enable: bool = True) -> Generator[None]:
    """
...
class _MakefxTracer:
    ...
    @contextmanager
    def _init_modes_from_parent(self, parent_tracer: _MakefxTracer) -> Generator[None]:
