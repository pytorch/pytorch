...
_ExtractValType = Optional[
    PySymType | _AnyScriptObjectType | BackwardState | list["_ExtractValType"] | tuple["_ExtractValType", ...] | dict[str, "_ExtractValType"] | Tensor | int | float | bool
]
...
class _ModuleStackTracer(PythonKeyTracer):
    ...
    def trace(  # type: ignore[override]
        self, root: Module | Callable, concrete_args: Optional[dict[str, object]]
    ) -> fx.Graph:
