...
class TensorRTMinimizer(net_min_base._MinimizerBase):
    ...
    def run_a(self, mod: torch.fx.GraphModule, inputs: Tuple[torch.Tensor]) -> Any:
        """
    ...
    def run_b(self, mod: torch.fx.GraphModule, inputs: Tuple[torch.Tensor]) -> Any:
        """
...
class TensorRTSplitter(splitter_base._SplitterBase):
    ...
    def _lower_model_to_backend(
        self, mod: torch.fx.GraphModule, inputs: Tuple[torch.Tensor]
    ):
        """
