...
class _MinimizerBase:
    ...
    def _run_and_compare(
        ...
        if output_names is None:
            names = [str(v) for v in result_key]  # type: ignore[possibly-undefined]  # TODO: audit

        numeric_result, bool_result = self.compare_fn(a_result, b_result, names)

        self.results[result_key] = numeric_result  # type: ignore[possibly-undefined]  # TODO: audit
