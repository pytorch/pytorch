...
def define_buck_targets(
    ...
    pt_xplat_cxx_library(
        ...
        deps = [
            ...
            ":torch_mobile_headers",
            ":torch_mobile_observer",
        ] + ([] if IS_OSS else ["fbsource//third-party/boost:boost",
        ...
        "fbsource//xplat/folly:functional_apply_tuple",
        "fbsource//xplat/folly:functional_invoke",
        "fbsource//xplat/folly:functional_partial",
        ...
        "fbsource//xplat/folly:system_thread_id",
        "fbsource//xplat/folly:system_thread_name",
