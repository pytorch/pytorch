...
THIRD_PARTY_LIBS = {
    ...
    "pthreadpool": ["//third_party/pthreadpool:pthreadpool", "//third_party:pthreadpool"],
    "pthreadpool_header": ["//third_party/pthreadpool_header:pthreadpool_header", "//third_party:pthreadpool_header"],
