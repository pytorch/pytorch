...
install_ubuntu() {
    ...
    DEB_ROCM_REPO=http://repo.radeon.com/rocm/misc/.ea/apt/.apt_2.5_RC2
    # Add rocm repository
...
install_centos() {
  ...
  echo "baseurl=http://repo.radeon.com/rocm/misc/.ea/yum/.yum_2.5_RC2" >> /etc/yum.repos.d/rocm.repo
