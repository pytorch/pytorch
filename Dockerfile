...
ENV NV_CUDNN_PACKAGE "${NV_CUDNN_PACKAGE_NAME}=${CUDNN_VERSION}-1+cuda${CUDA_VERSION_SHORT}"
ENV NV_CUDNN_PACKAGE_DEV "${NV_CUDNN_PACKAGE_NAME}-dev=${CUDNN_VERSION}-1+cuda${CUDA_VERSION_SHORT}"
